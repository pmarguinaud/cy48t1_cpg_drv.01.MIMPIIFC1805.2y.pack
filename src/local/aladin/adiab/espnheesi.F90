...
CALL SIDD(LVFE_LAPL_BC, LVERTFE, YRDYNA, YDCST, YDGEOMETRY,YDDYN,1,NFLEVG,ZSDIV,ZSVED,ZZSPSPDG,ZZSPTG,ZZSPSPG,ISPCOL)
...
CALL SIGAM(LVERTFE, YDCST, YDGEOMETRY,YDDYN,1,NFLEVG,Z12,Z11,ZZERO,ISPCOL,NFLEVG)
...
DO JSP=KSTA,KEND
  ...
  ENDDO
ENDDO
CALL SISEVE(LVERTFE, LVFE_LAPL_BC, YRDYNA,YDGEOMETRY,YDDYN,1,NFLEVG,Z21,Z22,ISPCOL)
DO JSP=KSTA,KEND
  DO JLEV=1,NFLEVG
