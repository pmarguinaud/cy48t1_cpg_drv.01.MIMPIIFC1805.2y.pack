...
IF(LNHEE) THEN
  ...
  CALL SIDD(YDMODEL%YRML_DYN%YRDYNA,YDMODEL%YRCST,YDGEOMETRY,YDDYN,KDIM,1,ZSIDL_O,ZSIVD,&
   & ZSIPDL_I,ZSITL_I,ZSISPL_I,IPROFS)
  CALL SIDD(YDMODEL%YRML_DYN%YRDYNA,YDMODEL%YRCST,YDGEOMETRY,YDDYN,KDIM,1,ZSIDM_O,ZSIVD,&
