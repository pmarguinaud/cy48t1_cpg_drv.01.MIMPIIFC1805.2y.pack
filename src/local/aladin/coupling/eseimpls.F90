...
IF(LNHEE) THEN
  ...
  CALL SIPTP(LVERTFE, YDMODEL%YRCST,YDGEOMETRY,YDDYN,KDIM,1,ZSID_I,ZSIVD_I,&
   & ZSIPD_O,ZSIT_O,ZSISP_O,IPROFS)
  CALL SIDD(LVFE_LAPL_BC, LVERTFE, YDMODEL%YRML_DYN%YRDYNA,YDMODEL%YRCST,YDGEOMETRY,YDDYN,KDIM,1,ZSIDL_O,ZSIVD,&
   & ZSIPDL_I,ZSITL_I,ZSISPL_I,IPROFS)
  CALL SIDD(LVFE_LAPL_BC, LVERTFE, YDMODEL%YRML_DYN%YRDYNA,YDMODEL%YRCST,YDGEOMETRY,YDDYN,KDIM,1,ZSIDM_O,ZSIVD,&
   & ZSIPDM_I,ZSITM_I,ZSISPM_I,IPROFS)
  CALL SISEVE(LVERTFE, LVFE_LAPL_BC, YDMODEL%YRML_DYN%YRDYNA,YDGEOMETRY,YDDYN,KDIM,1,ZSIPD9_I,ZSIVD_O,IPROFS)
!$OMP PARALLEL DO
  DO JLEV=1,NFLEVG
    DO JROF=1,KDIM
...
!$OMP PARALLEL DO
  ...
  ENDDO
!$OMP END PARALLEL DO
  CALL SILKAP(LVERTFE, LVFE_LAPL_BC, YDMODEL%YRCST,YDGEOMETRY,YDDYN,YDMODEL%YRML_DYN%YRDYNA%LNHQE_C2,KDIM,1,IPROFS,ZSIPD9_I,ZSIVD_O,PMULFAC=ZDIM)
