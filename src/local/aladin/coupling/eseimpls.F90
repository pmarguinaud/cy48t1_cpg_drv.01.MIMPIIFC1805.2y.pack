...
IF(LNHEE) THEN
  ...
  CALL SIDD(YDMODEL%YRCST,YDGEOMETRY,YDDYN,KDIM,1,ZSIDL_O,ZSIVD,&
   & ZSIPDL_I,ZSITL_I,ZSISPL_I,IPROFS)
  CALL SIDD(YDMODEL%YRCST,YDGEOMETRY,YDDYN,KDIM,1,ZSIDM_O,ZSIVD,&
   & ZSIPDM_I,ZSITM_I,ZSISPM_I,IPROFS)
  CALL SISEVE(YDGEOMETRY,YDDYN,KDIM,1,ZSIPD9_I,ZSIVD_O,IPROFS)
!$OMP PARALLEL DO
  DO JLEV=1,NFLEVG
    DO JROF=1,KDIM
...
ELSEIF(LNHQE.AND.(.NOT.YRDYNA%LNHQE_SIHYD)) THEN
  ...
  CALL SITNU(YDMODEL%YRCST,YDGEOMETRY,YDDYN,KDIM,1,ZSID_I,ZSIT_O,ZSISP_O,IPROFS)
  CALL SIGAM(YDMODEL%YRCST,YDGEOMETRY,YDDYN,KDIM,1,ZSIDL_O,ZSITL_I,ZSISPL_I,IPROFS,NFLEVG)
  CALL SIGAM(YDMODEL%YRCST,YDGEOMETRY,YDDYN,KDIM,1,ZSIDM_O,ZSITM_I,ZSISPM_I,IPROFS,NFLEVG)
!$OMP PARALLEL DO
  DO JLEV=1,NFLEVG
    DO JROF=1,KDIM
  ...
  ENDDO
!$OMP END PARALLEL DO
  CALL SILKAP(YDMODEL%YRCST,YDGEOMETRY,YDDYN,YRDYNA%LNHQE_C2,KDIM,1,IPROFS,ZSIPD9_I,ZSIVD_O,PMULFAC=ZDIM)
...
IF(LNHEE) THEN
  ...
  ENDDO
ENDIF
IF(LNHDYN.AND.(.NOT.YRDYNA%LNHQE_SIHYD)) THEN
  DO JLEV=1,NFLEVG
    DO JROF=1,KDIM
