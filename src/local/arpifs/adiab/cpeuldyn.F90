...
IF(LNHEE)THEN
  ...
  CALL SIDD(YDML_DYN%YRDYNA, YDCST, YDGEOMETRY,YDDYN,NPROMA,1,ZSIDL(KST,1),ZSIVD(KST,1),&
   & ZSIPRL(KST,1),ZSITL(KST,1),ZSISPL(KST),IPROFS)
  CALL SIDD(YDML_DYN%YRDYNA, YDCST, YDGEOMETRY,YDDYN,NPROMA,1,ZSIDM(KST,1),ZSIVD(KST,1),&
   & ZSIPRM(KST,1),ZSITM(KST,1),ZSISPM(KST),IPROFS)
  CALL SISEVE(YDML_DYN%YRDYNA,YDGEOMETRY,YDDYN,NPROMA,1,ZSIPR9(KST,1),ZSIVD(KST,1),IPROFS)
...
ELSEIF(LNHQE.AND.(.NOT.YDML_DYN%YRDYNA%LNHQE_SIHYD))THEN
  ...
  ZCOEJ=YDCST%RG*YDCST%RG/(YDCST%RD*SITR)
  CALL SITNU(YDCST, YDGEOMETRY,YDDYN,NPROMA,1,ZSID(KST,1),ZSIT(KST,1),ZSISP(KST),IPROFS)
  CALL SIGAM(YDCST, YDGEOMETRY,YDDYN,NPROMA,1,ZSIDL(KST,1),ZSITL(KST,1),ZSISPL(KST),IPROFS,NFLEVG)
  CALL SIGAM(YDCST, YDGEOMETRY,YDDYN,NPROMA,1,ZSIDM(KST,1),ZSITM(KST,1),ZSISPM(KST),IPROFS,NFLEVG)
  DO JLEV=1,NFLEVG
    DO JROF=KST,KPROF
    ...
    ENDDO
  ENDDO
  CALL SILKAP(YDCST, YDGEOMETRY,YDDYN,YDML_DYN%YRDYNA%LNHQE_C2,NPROMA,1,IPROFS,ZSIPR9(KST,1),ZSIVD(KST,1),PMULFAC=ZCOEJ)
