...
IF(LNHEE)THEN
  ...
  CALL SIDD(LVERTFE, YDML_DYN%YRDYNA, YDCST, YDGEOMETRY,YDDYN,NPROMA,1,ZSIDL(KST,1),ZSIVD(KST,1),&
   & ZSIPRL(KST,1),ZSITL(KST,1),ZSISPL(KST),IPROFS)
  CALL SIDD(LVERTFE, YDML_DYN%YRDYNA, YDCST, YDGEOMETRY,YDDYN,NPROMA,1,ZSIDM(KST,1),ZSIVD(KST,1),&
