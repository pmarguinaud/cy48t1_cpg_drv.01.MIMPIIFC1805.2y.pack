...
IF (LSPRT) THEN
  DO JLEV=1,NFLEVG
    IF (.NOT. YDML_DYN%YRDYNA%LDRY_ECMWF) THEN
      DO JROF=KST,KPROF
...
CALL SITNU(LVERTFE, YRCST,YDGEOMETRY,YDDYN,NPROMA,1,ZSID(KST,1),ZSIT(KST,1),ZSISP(KST),IPROFS)
CALL SIGAM(LVERTFE, YRCST,YDGEOMETRY,YDDYN,NPROMA,1,ZSIDL(KST,1),ZSITL(KST,1),ZSISPL(KST),IPROFS,NFLEVG)
CALL SIGAM(LVERTFE, YRCST,YDGEOMETRY,YDDYN,NPROMA,1,ZSIDM(KST,1),ZSITM(KST,1),ZSISPM(KST),IPROFS,NFLEVG)
