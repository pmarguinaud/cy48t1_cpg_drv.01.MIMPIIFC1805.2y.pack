...
#ifndef UNDEF
REAL(KIND=JPRB) :: ZPRE0L(YDGEOMETRY%YRDIM%NPROMA)                    
REAL(KIND=JPRB) :: ZPRE0M(YDGEOMETRY%YRDIM%NPROMA)                    
REAL(KIND=JPRB) :: ZNHPRE0F(YDGEOMETRY%YRDIM%NPROMNH,YDGEOMETRY%YRDIMV%NFLEVG)    
REAL(KIND=JPRB) :: ZNHPRE0H(YDGEOMETRY%YRDIM%NPROMNH,0:YDGEOMETRY%YRDIMV%NFLEVG)  
REAL(KIND=JPRB) :: ZRT0L(YDGEOMETRY%YRDIM%NPROMA,YDGEOMETRY%YRDIMV%NFLEVG)        
REAL(KIND=JPRB) :: ZRT0M(YDGEOMETRY%YRDIM%NPROMA,YDGEOMETRY%YRDIMV%NFLEVG)        
REAL(KIND=JPRB) :: ZPHI0FL(YDGEOMETRY%YRDIM%NPROMA,YDGEOMETRY%YRDIMV%NFLEVG)      
REAL(KIND=JPRB) :: ZPHI0FM(YDGEOMETRY%YRDIM%NPROMA,YDGEOMETRY%YRDIMV%NFLEVG)      
REAL(KIND=JPRB) :: ZGWFT0(YDGEOMETRY%YRDIM%NPROMA,YDGEOMETRY%YRDIMV%NFLEVG)       
REAL(KIND=JPRB) :: ZKENE0(YDGEOMETRY%YRDIM%NPROMA,YDGEOMETRY%YRDIMV%NFLEVG)       
#else
...
#ifdef UNDEF
REAL(KIND=JPRB) :: ZNHX0(YDGEOMETRY%YRDIM%NPROMA,YDGEOMETRY%YRDIMV%NFLEVG)        
REAL(KIND=JPRB) :: ZNHY0(YDGEOMETRY%YRDIM%NPROMA,0:YDGEOMETRY%YRDIMV%NFLEVG)      
REAL(KIND=JPRB) :: ZQCHA0L(YDGEOMETRY%YRDIM%NPROMNH,YDGEOMETRY%YRDIMV%NFLEVG)     
REAL(KIND=JPRB) :: ZQCHA0M(YDGEOMETRY%YRDIM%NPROMNH,YDGEOMETRY%YRDIMV%NFLEVG)     
REAL(KIND=JPRB) :: ZDBBC(YDGEOMETRY%YRDIM%NPROMNH)                    
REAL(KIND=JPRB) :: ZRDPHI(YDGEOMETRY%YRDIM%NPROMNH,YDGEOMETRY%YRDIMV%NFLEVG)            
REAL(KIND=JPRB) :: ZGWT0(YDGEOMETRY%YRDIM%NPROMNH,YDGEOMETRY%YRDIMV%NFLEVG)            
REAL(KIND=JPRB) :: ZGWS(YDGEOMETRY%YRDIM%NPROMNH)                     
REAL(KIND=JPRB) :: ZGWFL(YDGEOMETRY%YRDIM%NPROMNH,YDGEOMETRY%YRDIMV%NFLEVG)             
REAL(KIND=JPRB) :: ZGWFM(YDGEOMETRY%YRDIM%NPROMNH,YDGEOMETRY%YRDIMV%NFLEVG)            
#else
