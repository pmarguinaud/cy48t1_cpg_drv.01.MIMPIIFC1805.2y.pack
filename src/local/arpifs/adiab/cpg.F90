...
REAL(KIND=JPRB), POINTER, CONTIGUOUS :: ZATND (:,:,:)
! - miscellaneous NPROMA-dimensioned arrays.
REAL(KIND=JPRB), POINTER, CONTIGUOUS :: ZNEB(:,:)               
REAL(KIND=JPRB), POINTER, CONTIGUOUS :: ZQLI(:,:)               
REAL(KIND=JPRB), POINTER, CONTIGUOUS :: ZQICE(:,:)              
REAL(KIND=JPRB), POINTER, CONTIGUOUS :: ZQRAIN(:,:)             
REAL(KIND=JPRB), POINTER, CONTIGUOUS :: ZQSNOW(:,:)             
REAL(KIND=JPRB), POINTER, CONTIGUOUS :: ZRH(:,:)                
REAL(KIND=JPRB), POINTER, CONTIGUOUS :: ZQS(:)                       
REAL(KIND=JPRB), POINTER, CONTIGUOUS :: ZQSOL(:)                     
REAL(KIND=JPRB), POINTER, CONTIGUOUS :: ZDHSF(:)                     
REAL(KIND=JPRB), POINTER, CONTIGUOUS :: ZCLCT(:)                     
REAL(KIND=JPRB), POINTER, CONTIGUOUS :: ZLSM(:)                      
REAL(KIND=JPRB), POINTER, CONTIGUOUS :: ZTSOL(:)                     
...
ZATND  => YDCPG_TND%ZVIEW
ZNEB   => YDCPG_MISC%NEB  
ZQLI   => YDCPG_MISC%QLI  
ZQICE  => YDCPG_MISC%QICE 
ZQRAIN => YDCPG_MISC%QRAIN
ZQSNOW => YDCPG_MISC%QSNOW
ZRH    => YDCPG_MISC%RH   
ZQS    => YDCPG_MISC%QS   
ZQSOL  => YDCPG_MISC%QSOL 
ZDHSF  => YDCPG_MISC%DHSF 
ZCLCT  => YDCPG_MISC%CLCT 
ZLSM   => YDCPG_MISC%LSM  
ZTSOL  => YDCPG_MISC%TSOL 
