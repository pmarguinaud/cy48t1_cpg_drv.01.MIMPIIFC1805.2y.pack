...
CALL CPG_GP(YDGEOMETRY,YDCPG_TND,YDCPG_MISC,YDCPG_DYN0,YDCPG_DYN9,YDMF_PHYS_SURF,YDVARS,&
 ...
 & ZGPAR,PB2,&
 & PGFLT1,&
 & ZKOZO,YDCPG_MISC%QS,YDCPG_MISC%QICE,YDCPG_MISC%QLI,YDCPG_MISC%QRAIN,YDCPG_MISC%QSNOW,&
 & YDCPG_TND%ZVIEW,&
 & PEXTRA,YDDDH)
...
!*       4.4.1   Call MF unlagged physics (predictor only if PC scheme).
  ...
  CALL MF_PHYS(YDGEOMETRY,YDCPG_MISC,YDCPG_PHY0,YDCPG_PHY9,YDMF_PHYS,YDCPG_DYN0,YDCPG_DYN9,YDMF_PHYS_SURF,YDVARS,YDFIELDS%YRGMV,YDFIELDS%YRSURF,YDFIELDS%YRCFU,YDFIELDS%YRXFU,YDMODEL,&
   ...
   & PGDEOTI,PGDEOTI2,PGUEOTI,PGUEOTI2,PGEOLT,PGEOXT,&
   & PGRPROX,PGMIXP,PGFLUXC,PGRSURF,&
   & YDCPG_MISC%DHSF,YDCPG_MISC%CLCT,&
   & YDCPG_MISC%NEB,&
   & YDCPG_MISC%QICE,YDCPG_MISC%QLI,YDCPG_MISC%QS,&
   & YDCPG_MISC%RH,&
   & YDCPG_MISC%QSOL,&
...
IF (NCURRENT_ITER == 0) THEN
  CALL CPG_DIA(YDGEOMETRY,YDCPG_TND,YDCPG_MISC,YDMF_PHYS,YDCPG_DYN0,YDMF_PHYS_SURF,YDVARS,YDFIELDS%YRGMV,YDFIELDS%YRSURF,YDFIELDS%YRCFU,YDFIELDS%YRXFU,YDMODEL,IST,IEND,ISTC,IENDC,KSTGLO,IDDHI,&
   ...
   & YDCPG_MISC%CLCT,&
   & YDCPG_MISC%NEB,&
   & YDCPG_MISC%QICE,YDCPG_MISC%QLI,YDCPG_MISC%QRAIN,YDCPG_MISC%QSNOW,YDCPG_MISC%QS,PSD_XA,&
   & YDCPG_MISC%RH,&
   & ZGPAR,&
   & PSD_PF,&
   & PGMVTNDSI_DDH,PGMVTNDHD_DDH,PGFLTNDHD_DDH,YDCPG_TND%ZVIEW,&
   & ZDHCV,YDDDH,ZFTCNS)
ENDIF
...
CALL CPG_DYN(YDGEOMETRY,YDCPG_TND,YDCPG_MISC,YDCPG_DYN0,YDCPG_DYN9,YDVARS,YDFIELDS%YRGMV,&
 ...
 & KIBL,&
 & YDCPG_MISC%LSM,YDCPG_MISC%TSOL,YDCPG_MISC%QSOL,&
 & YDCPG_TND%ZVIEW,&
 & PGFL,&
 !---------------------------------------------------------------------
 ! - INPUT/OUTPUT .
