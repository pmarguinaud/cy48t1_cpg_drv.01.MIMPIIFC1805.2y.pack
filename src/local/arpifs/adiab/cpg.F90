...
SUBROUTINE CPG(YDGEOMETRY,YDCPG_DIM,YDTMP,YDCPG_TND,YDCPG_MISC,&
 & YDCPG_PHY0,YDCPG_PHY9,YDMF_PHYS,YDMF_PHYS_TMP,YDAPLPAR_TMP,YDCPG_DYN0,YDCPG_DYN9,&
...
! DDH
REAL(KIND=JPRB) :: ZDHCV(YDCPG_DIM%KLON,0:YDCPG_DIM%KFLEVG,YDMODEL%YRML_DIAG%YRMDDH%NDHCVSUN)   ! cf. PDHCV in CPG_DIA
