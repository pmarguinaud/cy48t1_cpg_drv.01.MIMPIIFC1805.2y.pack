...
#ifdef UNDEF
REAL(KIND=JPRB) :: ZW9_PHY(YDGEOMETRY%YRDIM%NPROMM,YDGEOMETRY%YRDIMV%NFLEVG)            
REAL(KIND=JPRB) :: ZPRE9_PHY(YDGEOMETRY%YRDIM%NPROMM9,0:YDGEOMETRY%YRDIMV%NFLEVG)       
REAL(KIND=JPRB) :: ZPRE9F_PHY(YDGEOMETRY%YRDIM%NPROMM9,YDGEOMETRY%YRDIMV%NFLEVG)        
...
ZW9_PHY            => YDCPG_PHY0%W
ZPRE9_PHY(1:,0:)   => YDCPG_PHY0%PRE
ZPRE9F_PHY         => YDCPG_PHY0%PREF
ZPREHYD9F_PHY      => YDCPG_PHY0%PREHYDF
ZPREHYD9_PHY(1:,0:)=> YDCPG_PHY0%PREHYD
ZXYB9_PHY          => YDCPG_PHY0%XYB%ZVIEW
