...
@PROCESS NOCHECK
#endif
SUBROUTINE CPG(YDGEOMETRY,YDCPG_DIM, YDCPG_OPTS,YDTMP,YDCPG_TND,YDCPG_SL1,YDCPG_SL2,YDCPG_MISC,&
 & YDCPG_GPAR,YDCPG_PHY0,YDCPG_PHY9,YDMF_PHYS,YDCPG_DDH,YDCPG_DYN0,YDCPG_DYN9,&
 ...
 & PGMVTNDSL_DDH,PGFLTNDSL_DDH,PTRAJ_PHYS,PTRAJ_SLAG,YDDDH,CDPART)
...
IF (CDPART (1:1) == 'X') THEN
  ...
  CALL CPG_GP(YDGEOMETRY, YDCPG_DIM, YDCPG_OPTS, YDTMP%CPG_GP, YDCPG_TND, YDCPG_MISC, YDCPG_GPAR, YDCPG_DYN0, YDCPG_DYN9, &
...
IF (CDPART (2:2) == 'X') THEN
  ...
  IF (LMPHYS.OR.LSIMPH) THEN
    ...
    IF (NCURRENT_ITER == 0) THEN  
      CALL MF_PHYS (YDGEOMETRY, YDCPG_DIM, YDCPG_OPTS, YDCPG_MISC, YDCPG_GPAR, YDCPG_PHY0, YDCPG_PHY9, YDMF_PHYS,        &
...
IF (CDPART (3:3) == 'X') THEN
  ...
  IF (NCURRENT_ITER == 0) THEN
    CALL CPG_DIA(YDGEOMETRY, YDCPG_DIM, YDCPG_OPTS, YDCPG_TND, YDCPG_MISC, YDCPG_GPAR, YDMF_PHYS, YDCPG_DYN0, YDMF_PHYS_SURF,   &
  ...
  CALL CPG_DYN(YDGEOMETRY, YDCPG_DIM, YDCPG_OPTS, YDCPG_TND, YDCPG_MISC, YDCPG_DYN0, YDCPG_DYN9, YDVARS, YDFIELDS%YRGMV, &
  ...
  IF (LDUSEPB1) THEN
    CALL CPG_PB1 (YDCPG_DIM, YDCPG_OPTS, YDMODEL, YDSL, PB1, YDCPG_SL1%ZVIEW)
  ENDIF
  ...
  CALL CPG_END(YDGEOMETRY, YDCPG_DIM, YDCPG_OPTS, YDFIELDS%YRGMV, YDFIELDS%YRSURF, YDMODEL%YRML_PHY_EC%YREPHY, YDMODEL%YRML_GCONF, &
