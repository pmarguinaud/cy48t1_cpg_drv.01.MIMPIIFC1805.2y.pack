...
@PROCESS NOCHECK
#endif
SUBROUTINE CPG(YDGEOMETRY,YDCPG_DIM,YDTMP,YDCPG_TND,YDCPG_SL1,YDCPG_SL2,YDCPG_MISC,&
...
& PGMVTNDSL_DDH, PGFLTNDSL_DDH, YDCPG_MISC%GPAR, YDCPG_SL2%ZVIEW, PGFLT1, YDCPG_MISC%KOZO, YDDDH)
...
IF( (LMPHYS.OR.LSIMPH) .AND. (NCURRENT_ITER == 0) ) THEN  
  CALL MF_PHYS (YDGEOMETRY, YDCPG_DIM, YDCPG_MISC, YDCPG_PHY0, YDCPG_PHY9, YDMF_PHYS, YDMF_PHYS_TMP, &
              ...
              & LDCONFX, PDTPHY, PGPSDT2D, PGFL, YDCPG_SL2%ZVIEW, PGMVT1, PGFLT1, PTRAJ_PHYS, YDDDH, YDCPG_SL1%ZVIEW)
ENDIF
...
IF (NCURRENT_ITER == 0) THEN
  ...
  & LDCONFX, LDDIAB, LDFSTEP, LD_DFISTEP, PGMV, PGFL, YDCPG_SL2%ZVIEW(:, MSLB2VVEL), PSD_XA, YDCPG_MISC%GPAR,     &
