...
IF (CDPART (3:3) == 'X') THEN
  ...
  !     assumed to be zero and it is ignored.
      ...
      & NFLSA, NFLEN, PTENDU=YDCPG_SL1%ZVIEW(:, ISLB1U9), PTENDV=YDCPG_SL1%ZVIEW(:, ISLB1V9), &
      & PTENDT=YDCPG_SL1%ZVIEW(:, ISLB1T9), PTENDVD=YDCPG_SL1%ZVIEW(:, ISLB1VD9), PTENDGFL=YDCPG_SL1%ZVIEW(:, ISLB1GFL9), &
      & PTENDSP=YDCPG_SL1%ZVIEW(:, MSLB1SP9), PGFLPT=PGFLPT, PGFLT1=PGFLT1, PGFL=PGFL, PGMV=PGMV, PGMVS=PGMVS)
