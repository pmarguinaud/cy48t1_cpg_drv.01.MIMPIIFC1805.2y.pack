...
!*       4.4.1   Call MF unlagged physics (predictor only if PC scheme).
  ...
  CALL MF_PHYS_PREP(YDGEOMETRY,&
   ...
   & YDCPG_DYN0%RCP%ZVIEW(:,:,YYTRCP0%M_R),YDCPG_DYN9%RCP%ZVIEW(:,:,YYTRCP9%M_CP),&
   ...
   & YDCPG_DYN0%XYB%ZVIEW,YDCPG_DYN9%XYB%ZVIEW,&
   ...
   & YDCPG_PHY0%XYB%ZVIEW,YDCPG_PHY9%XYB%ZVIEW)
  ...
  CALL MF_PHYS(YDGEOMETRY,YDCPG_PHY0,YDCPG_PHY9,YDMF_PHYS,YDCPG_DYN0,YDCPG_DYN9,YDMF_PHYS_SURF,YDVARS,YDFIELDS%YRGMV,YDFIELDS%YRSURF,YDFIELDS%YRCFU,YDFIELDS%YRXFU,YDMODEL,&
   ...
   & PGMV,PGMVS,PGFL,&
   & YDCPG_PHY0%W,YDCPG_PHY0%WL,YDCPG_PHY0%WM,YDCPG_DYN0%RCP%ZVIEW,YDCPG_DYN0%PHI,YDCPG_DYN0%PHIF,&
   & YDCPG_PHY0%PREHYD,YDCPG_PHY0%PREHYDF,YDCPG_PHY0%PRE,YDCPG_PHY0%PREF,YDCPG_PHY0%XYB%ZVIEW,&
   & YDCPG_PHY9%W,YDCPG_DYN9%RCP%ZVIEW,YDCPG_DYN9%PHI,YDCPG_DYN9%PHIF,&
   & YDCPG_PHY9%PREHYD,YDCPG_PHY9%PREHYDF,YDCPG_PHY9%PRE,YDCPG_PHY9%PREF,YDCPG_PHY9%XYB%ZVIEW,&
   & ZKOZO,PGPSDT2D,PGRADH_PHY,&
   & PFORCEU,PFORCEV,PFORCET,PFORCEQ, &
   & YDCPG_DYN0%CTY%ZVIEW,&
   & ZSLBUF1AU,PB2,&
...
IF (NCURRENT_ITER == 0) THEN
  CALL CPG_DIA(YDGEOMETRY,YDMF_PHYS,YDCPG_DYN0,YDCPG_DYN9,YDMF_PHYS_SURF,YDVARS,YDFIELDS%YRGMV,YDFIELDS%YRSURF,YDFIELDS%YRCFU,YDFIELDS%YRXFU,YDMODEL,IST,IEND,ISTC,IENDC,KSTGLO,IDDHI,&
   ...
   & KIBL,YDCPG_DYN0%OROGL,YDCPG_DYN0%OROGM,&
   & PGMV,PGFL,&
   & YDCPG_DYN0%PRE,YDCPG_DYN0%PREF,YDCPG_DYN0%XYB%ZVIEW,&
   & YDCPG_DYN0%PHI,YDCPG_DYN0%PHIF,YDCPG_DYN0%PHIFL,YDCPG_DYN0%PHIFM,YDCPG_DYN0%RCP%ZVIEW,&
   & YDCPG_DYN0%CTY%ZVIEW,PB2(1,MSLB2VVEL),YDCPG_DYN0%KENE,&
...
IF (LSLDIA .AND. (NCURRENT_ITER == NSITER)) THEN
  ...
  CALL CPDYSLDIA(YDGEOMETRY,YDCPG_DYN0,YDCPG_DYN9,YDDPHY,YDMODEL%YRML_GCONF,NPROMA,LDFSTEP,IST,IEND,NFLEVG,&
   & KIBL,&
   & YDVARS%SP%T0,YDCPG_DYN0%XYB%ZVIEW(:,:,YYTXYB0%M_DELP),YDCPG_DYN0%PREF,&
...
ELSE
  ZTSOL(IST:IEND)=YDVARS%T%T0(IST:IEND,NFLEVG)
ENDIF
...
CALL CPG_DYN(YDGEOMETRY,YDCPG_DYN0,YDCPG_DYN9,YDMF_PHYS_SURF,YDVARS,YDFIELDS%YRGMV,&
 ...
 & KIBL,YDCPG_DYN0%OROGL,YDCPG_DYN0%OROGM,&
 & YDCPG_DYN0%PRE,YDCPG_DYN0%XYB%ZVIEW(:,:,YYTXYB0%M_RDELP),YDCPG_DYN0%UVH%ZVIEW,&
 & YDCPG_DYN0%PHI,YDCPG_DYN0%PHIF,YDCPG_DYN0%RCP%ZVIEW,&
 & YDCPG_DYN0%CTY%ZVIEW,YDCPG_DYN0%KENE,&
 & ZLSM,ZTSOL,ZQSOL,&
