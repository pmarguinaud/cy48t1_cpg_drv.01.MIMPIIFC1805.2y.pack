...
@PROCESS NOCHECK
#endif
SUBROUTINE CPG(YDGEOMETRY,YDCPG_DIM,YDTMP,YDCPG_TND,YDCPG_SL1,YDCPG_MISC,&
...
IF( (LMPHYS.OR.LSIMPH) .AND. (NCURRENT_ITER == 0) ) THEN  
  CALL MF_PHYS (YDGEOMETRY, YDCPG_DIM, YDCPG_MISC, YDCPG_PHY0, YDCPG_PHY9, YDMF_PHYS, YDMF_PHYS_TMP, &
              ...
              & LDCONFX, PDTPHY, PGPSDT2D, PGFL, PB2, PGMVT1, PGFLT1, PTRAJ_PHYS, YDDDH, YDCPG_SL1%ZVIEW)
ENDIF
...
& PGMV, PGMVS, YDCPG_SL1%ZVIEW, PB2, PGMVT1, PGMVT1S, PGFLT1, PGMVTNDSI_DDH, PTRAJ_SLAG)
