...
#ifdef UNDEF
REAL(KIND=JPRB) :: ZPRE0_PHY(YDGEOMETRY%YRDIM%NPROMA,0:YDGEOMETRY%YRDIMV%NFLEVG)        
REAL(KIND=JPRB) :: ZPRE0F_PHY(YDGEOMETRY%YRDIM%NPROMA,YDGEOMETRY%YRDIMV%NFLEVG)         
REAL(KIND=JPRB) :: ZW0_PHY(YDGEOMETRY%YRDIM%NPROMM,YDGEOMETRY%YRDIMV%NFLEVG)            
REAL(KIND=JPRB) :: ZW0L_PHY(YDGEOMETRY%YRDIM%NPROMM,YDGEOMETRY%YRDIMV%NFLEVG)           
REAL(KIND=JPRB) :: ZW0M_PHY(YDGEOMETRY%YRDIM%NPROMM,YDGEOMETRY%YRDIMV%NFLEVG)           
