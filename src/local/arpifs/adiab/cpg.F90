...
@PROCESS NOCHECK
#endif
SUBROUTINE CPG(YDGEOMETRY,YDCPG_PHY0,YDCPG_PHY9,YDMF_PHYS,YDCPG_DYN0,YDCPG_DYN9,YDMF_PHYS_SURF,YDVARS,YDMODEL,YDFIELDS,&
 !---------------------------------------------------------------------
 ! - INPUT .
...
!*       4.4.1   Call MF unlagged physics (predictor only if PC scheme).
  ...
  CALL MF_PHYS(YDGEOMETRY,YDCPG_PHY0,YDCPG_PHY9,YDMF_PHYS,YDCPG_DYN0,YDCPG_DYN9,YDMF_PHYS_SURF,YDVARS,YDFIELDS%YRGMV,YDFIELDS%YRSURF,YDFIELDS%YRCFU,YDFIELDS%YRXFU,YDMODEL,&
   & IBL,KGPCOMP,IST,IEND,IGL1,IGL2,KSTGLO,&
   & LDCONFX,PDTPHY,&
   & KIBL,YDCPG_DYN0%OROGL,YDCPG_DYN0%OROGM,&
   & PGMV,PGMVS,PGFL,&
   & YDCPG_PHY0%W,YDCPG_PHY0%WL,YDCPG_PHY0%WM,ZRCP0,YDCPG_DYN0%PHI,YDCPG_DYN0%PHIF,&
   & YDCPG_PHY0%PREHYD,YDCPG_PHY0%PREHYDF,YDCPG_PHY0%PRE,YDCPG_PHY0%PREF,ZXYB0_PHY,&
   & YDCPG_PHY9%W,ZRCP9,YDCPG_DYN9%PHI,YDCPG_DYN9%PHIF,&
   & YDCPG_PHY9%PREHYD,YDCPG_PHY9%PREHYDF,YDCPG_PHY9%PRE,YDCPG_PHY9%PREF,ZXYB9_PHY,&
...
IF (NCURRENT_ITER == 0) THEN
  CALL CPG_DIA(YDGEOMETRY,YDMF_PHYS,YDCPG_DYN0,YDCPG_DYN9,YDMF_PHYS_SURF,YDVARS,YDFIELDS%YRGMV,YDFIELDS%YRSURF,YDFIELDS%YRCFU,YDFIELDS%YRXFU,YDMODEL,IST,IEND,ISTC,IENDC,KSTGLO,IDDHI,&
   ...
   & KIBL,YDCPG_DYN0%OROGL,YDCPG_DYN0%OROGM,&
   & PGMV,PGFL,&
   & YDCPG_DYN0%PRE,YDCPG_DYN0%PREF,ZXYB0,&
   & YDCPG_DYN0%PHI,YDCPG_DYN0%PHIF,YDCPG_DYN0%PHIFL,YDCPG_DYN0%PHIFM,ZRCP0,&
   & ZCTY0,PB2(1,MSLB2VVEL),YDCPG_DYN0%KENE,&
   & YDCPG_DYN0%RTL,YDCPG_DYN0%RTM,YDCPG_DYN0%PREL,YDCPG_DYN0%PREM,&
...
IF (LSLDIA .AND. (NCURRENT_ITER == NSITER)) THEN
  ...
  CALL CPDYSLDIA(YDGEOMETRY,YDCPG_DYN0,YDCPG_DYN9,YDDPHY,YDMODEL%YRML_GCONF,NPROMA,LDFSTEP,IST,IEND,NFLEVG,&
   & KIBL,&
   & PGMVS(1,YT0%MSP),ZXYB0(:,:,YYTXYB0%M_DELP),YDCPG_DYN0%PREF,&
...
CALL CPG_DYN(YDGEOMETRY,YDCPG_DYN0,YDCPG_DYN9,YDMF_PHYS_SURF,YDVARS,YDFIELDS%YRGMV,&
 ...
 & KIBL,YDCPG_DYN0%OROGL,YDCPG_DYN0%OROGM,&
 & YDCPG_DYN0%PRE,ZXYB0(:,:,YYTXYB0%M_RDELP),ZUVH0,&
 & YDCPG_DYN0%PHI,YDCPG_DYN0%PHIF,ZRCP0,&
 & ZCTY0,YDCPG_DYN0%KENE,&
 & ZLSM,ZTSOL,ZQSOL,&
 & ZATND,YDCPG_DYN0%DBBC,YDCPG_DYN0%RDPHI,YDCPG_DYN0%GWT,YDCPG_DYN9%GWT,&
 & YDCPG_DYN0%NHX,YDCPG_DYN9%NHX,YDCPG_DYN0%NHY,YDCPG_DYN9%NHY,&
 & PGFL,&
 !---------------------------------------------------------------------
 ! - INPUT/OUTPUT .
 & KSETTLOFF,PGFLPC,YDCPG_DYN0%GWS,PGMV,PGMVS,&
 & ZSLBUF1AU,PB2,PGMVT1,PGMVT1S,PGFLT1,PGMVTNDSI_DDH,PTRAJ_SLAG,YDCPG_DYN9%WRL)
