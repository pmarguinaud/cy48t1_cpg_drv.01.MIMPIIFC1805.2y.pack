...
SUBROUTINE CPG(YDGEOMETRY,YDCPG_DIM,YDTMP,YDCPG_TND,YDCPG_SL1,YDCPG_SL2,YDCPG_MISC,&
 & YDCPG_GPAR,YDCPG_PHY0,YDCPG_PHY9,YDMF_PHYS,YDMF_PHYS_TMP,YDCPG_DDH,YDCPG_DYN0,YDCPG_DYN9,&
...
& PGMVTNDSL_DDH, PGFLTNDSL_DDH, YDCPG_GPAR%ZVIEW, YDCPG_SL2%ZVIEW, PGFLT1, YDCPG_MISC%KOZO, YDDDH)
...
IF( (LMPHYS.OR.LSIMPH) .AND. (NCURRENT_ITER == 0) ) THEN  
  CALL MF_PHYS (YDGEOMETRY, YDCPG_DIM, YDCPG_MISC, YDCPG_GPAR, YDCPG_PHY0, YDCPG_PHY9, YDMF_PHYS, YDMF_PHYS_TMP, &
...
IF (NCURRENT_ITER == 0) THEN
  ...
  & LDCONFX, LDDIAB, LDFSTEP, LD_DFISTEP, PGMV, PGFL, YDCPG_SL2%ZVIEW(:, MSLB2VVEL), PSD_XA, YDCPG_GPAR%ZVIEW,     &
