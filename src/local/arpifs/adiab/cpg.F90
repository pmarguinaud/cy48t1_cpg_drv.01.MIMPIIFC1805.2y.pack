...
IF (CDPART (1:1) == 'X') THEN
  ...
  & YDCPG_DYN9, YDMF_PHYS_SURF, YDVARS, YDMODEL, YDFIELDS, PGFL, YDCPG_SL2, PGFLT1, YDCPG_MISC%KOZO, YDDDH)
...
IF (CDPART (3:3) == 'X') THEN
  ...
  & KSETTLOFF, PGFLPC, PGMV, PGMVS, YDCPG_SL1%ZVIEW, YDCPG_SL2%ZVIEW, PGMVT1, PGMVT1S, PGFLT1,    &
