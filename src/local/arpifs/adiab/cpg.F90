...
IF (LSDDH) THEN
  IF (NCURRENT_ITER == 0) CALL GPINIDDH(YDGEOMETRY,YDMDDH,YDCPG_DIM%KIDIA,YDCPG_DIM%KFDIA,YDCPG_DDH%DDHI,YDCPG_MISC%DHSF,YDCPG_DDH%DHCV,YDCPG_MISC%NEB,YDCPG_MISC%CLCT,YDCPG_DIM%KSTGLO)
  IF (LFLEXDIA.AND.LDDH_OMP) THEN
    CALL SETDDH(YDMDDH,YDDDH,YDCPG_DIM%KIDIA,YDCPG_DIM%KFDIA,NPROMA,NFLEVG,NCURRENT_ITER,YDCPG_MISC%DHSF,YDCPG_DDH%DDHI,YDCPG_DDH%AUX3D,YDCPG_DDH%AUX2D,YDCPG_DDH%AUXSM)
  ENDIF
ENDIF
...
!*       4.4.1   Call MF unlagged physics (predictor only if PC scheme).
  ...
  IF (YDMODEL%YRML_PHY_MF%YRSIMPHL%LSIMPH) THEN
    CALL MF_PHYS_SIM(YDGEOMETRY,YDCPG_DIM,YDCPG_MISC,YDCPG_PHY0,YDCPG_PHY9,YDMF_PHYS,YDMF_PHYS_TMP,YDCPG_DYN0,YDCPG_DYN9,&
     & YDMF_PHYS_SURF,YDVARS,YDFIELDS%YRGMV,YDFIELDS%YRSURF,YDFIELDS%YRCFU,YDFIELDS%YRXFU,YDMODEL,&
     & LDCONFX,PDTPHY,&
     & PGFL,&
     & YDCPG_MISC%KOZO,PGPSDT2D,&
     & ZSLBUF1AU,PB2,PGMVT1,PGFLT1,&
     & YDCPG_MISC%GPAR,&
     & PTRAJ_PHYS,YDDDH,YDCPG_MISC%FTCNS)
  ELSEIF (YDMODEL%YRML_PHY_MF%YRARPHY%LMPA) THEN
    CALL MF_PHYS_MPA(YDGEOMETRY,YDCPG_DIM,YDCPG_MISC,YDCPG_PHY0,YDCPG_PHY9,YDMF_PHYS,YDMF_PHYS_TMP,YDCPG_DYN0,YDCPG_DYN9,&
     & YDMF_PHYS_SURF,YDVARS,YDFIELDS%YRGMV,YDFIELDS%YRSURF,YDFIELDS%YRCFU,YDFIELDS%YRXFU,YDMODEL,&
     & LDCONFX,PDTPHY,&
     & PGFL,&
     & YDCPG_MISC%KOZO,PGPSDT2D,&
  ...
  ELSE
    ...
    IF (LLNEW) THEN
    CALL MF_PHYS_PAR_NEW(&
     & YDGEOMETRY,YDCPG_DIM,YDCPG_MISC,YDCPG_PHY0,YDCPG_PHY9,YDMF_PHYS,YDMF_PHYS_TMP,&
     & YDAPLPAR_TMP,YDCPG_DYN0,YDCPG_DYN9,&
     & YDMF_PHYS_SURF,YDVARS,YDFIELDS%YRGMV,YDFIELDS%YRSURF,YDFIELDS%YRCFU,YDFIELDS%YRXFU,YDMODEL,&
     & LDCONFX,PDTPHY,PGFL,YDCPG_MISC%KOZO,PGPSDT2D,ZSLBUF1AU,PB2,PGMVT1,PGFLT1,YDCPG_MISC%GPAR,PTRAJ_PHYS,YDDDH,YDCPG_MISC%FTCNS)
    ELSE
    CALL MF_PHYS_PAR(&
     & YDGEOMETRY,YDCPG_DIM,YDCPG_MISC,YDCPG_PHY0,YDCPG_PHY9,YDMF_PHYS,YDMF_PHYS_TMP,&
     & YDAPLPAR_TMP,YDCPG_DYN0,YDCPG_DYN9,&
...
IF (NCURRENT_ITER == 0) THEN
  CALL CPG_DIA(YDGEOMETRY,YDCPG_DIM,YDCPG_TND,YDCPG_MISC,YDMF_PHYS,YDCPG_DYN0,YDMF_PHYS_SURF,YDVARS,YDFIELDS%YRGMV,&
   & YDFIELDS%YRSURF,YDFIELDS%YRCFU,YDFIELDS%YRXFU,YDMODEL,YDCPG_DDH%DDHI,&
   ...
   & YDCPG_DDH%DHCV,YDDDH,YDCPG_MISC%FTCNS)
ENDIF
