...
CALL CPG_GP(YDGEOMETRY,YDTMP%CPG_GP,YDCPG_TND,YDCPG_MISC,YDCPG_DYN0,YDCPG_DYN9,YDMF_PHYS_SURF,YDVARS,&
 !---------------------------------------------------------------------
 ! - INPUT .
 & YDMODEL,YDFIELDS,LD_DFISTEP,YDCPG_DIM%KIDIA,YDCPG_DIM%KFDIA,YDCPG_DIM%KFDIE,YDCPG_DIM%KBL,YDCPG_DIM%KSTGLO,LDFSTEP,&
 & LDDIAB,PDT,PTE,&
 & YDCPG_DIM%KBL,&
 !---------------------------------------------------------------------
 ! - INPUT/OUTPUT .
...
!*       4.4.1   Call MF unlagged physics (predictor only if PC scheme).
  ...
  CALL MF_PHYS_PREP(YDGEOMETRY,&
   & YDMODEL%YRML_PHY_MF%YRARPHY,YDCPG_DIM%KIDIA,YDCPG_DIM%KFDIA,YDCPG_DIM%KBL,YDCPG_DYN0%OROGL,YDCPG_DYN0%OROGM,&
  ...
  CALL MF_PHYS(YDGEOMETRY,YDCPG_MISC,YDCPG_PHY0,YDCPG_PHY9,YDMF_PHYS,YDCPG_DYN0,YDCPG_DYN9,&
   ...
   & YDCPG_DIM%KBL,YDCPG_DIM%KGPCOMP,YDCPG_DIM%KIDIA,YDCPG_DIM%KFDIA,IGL1,IGL2,YDCPG_DIM%KSTGLO,&
   & LDCONFX,PDTPHY,&
   & YDCPG_DIM%KBL,&
   & PGFL,&
   & ZKOZO,PGPSDT2D,&
...
IF (NCURRENT_ITER == 0) THEN
  CALL CPG_DIA(YDGEOMETRY,YDCPG_TND,YDCPG_MISC,YDMF_PHYS,YDCPG_DYN0,YDMF_PHYS_SURF,YDVARS,YDFIELDS%YRGMV,&
   & YDFIELDS%YRSURF,YDFIELDS%YRCFU,YDFIELDS%YRXFU,YDMODEL,YDCPG_DIM%KIDIA,YDCPG_DIM%KFDIA,YDCPG_DIM%KIDIE,YDCPG_DIM%KFDIE,YDCPG_DIM%KSTGLO,IDDHI,&
...
CALL CPG_DYN(YDGEOMETRY,YDCPG_TND,YDCPG_MISC,YDCPG_DYN0,YDCPG_DYN9,YDVARS,YDFIELDS%YRGMV,&
 !---------------------------------------------------------------------
 ! - INPUT .
 & YDMODEL,YDCPG_DIM%KIDIA,YDCPG_DIM%KFDIA,PBETADT,PDT,&
...
CALL CPG_END(YDGEOMETRY,YDFIELDS%YRGMV,YDFIELDS%YRSURF,&
 ...
 & YDCPG_DIM%KIDIA,YDCPG_DIM%KFDIA,YDCPG_DIM%KIDIE,YDCPG_DIM%KFDIE,YDCPG_DIM%KBL,YDCPG_DIM%KSTGLO,LDCONFX,LDDIAB,&
