...
CALL YLCPG_SLB%INIT (YDFIELDS%REGISTRY, NLEV=NFLEVG, YDTPTRSLB1=YDMODEL%YRML_DYN%YRPTRSLB1)
...
!$OMP&                YLCPG_TND, YLCPG_MISC, YLCPG_TMP, YLCPG_DIM, YLMF_PHYS_TMP, YLAPLPAR_TMP, YLCPG_DDH, YLCPG_SLB)
DO JKGLO=1,KGPCOMP,NPROMA
  ...
  CALL YLCPG_SLB%UPDATE_VIEW (IBL)
  ...
  CALL CPG(YDGEOMETRY,YLCPG_DIM,YLCPG_TMP,YLCPG_TND,YLCPG_SLB,YLCPG_MISC,YLCPG_PHY0,YLCPG_PHY9,YLMF_PHYS,&
