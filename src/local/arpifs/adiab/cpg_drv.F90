...
!$OMP&  FIRSTPRIVATE (YDVARS, YLMF_PHYS_SURF, YLCPG_DYN0, YLCPG_DYN9, YLMF_PHYS)
DO JKGLO=1,KGPCOMP,NPROMA
  ...
  CALL CPG(YDGEOMETRY,YLMF_PHYS,YLCPG_DYN0,YLCPG_DYN9,YLMF_PHYS_SURF,YDVARS,YDMODEL,YDFIELDS,&
