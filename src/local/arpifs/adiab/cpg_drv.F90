...
CALL YLMF_PHYS%OUT%INIT (YDFIELDS%REGISTRY, NLEV=NFLEVG, YDDPHY=YDMODEL%YRML_PHY_G%YRDPHY, YDSURF=YDFIELDS%YRSURF)
CALL YLMF_PHYS%OPT%INIT (YDFIELDS%REGISTRY, NLEV=NFLEVG, LDMF_PHYS=LMPHYS, &
...
CALL YLMF_PHYS%FOR%INIT (YDFIELDS%REGISTRY, NLEV=NFLEVG, LDMF_PHYS=LMPHYS, &
                       & PU=PFORCEU, PV=PFORCEV, PT=PFORCET, PQ=PFORCEQ)
...
DO JKGLO=1,KGPCOMP,NPROMA
  ...
  CALL CPG(YDGEOMETRY,YLCPG_TND,YLCPG_MISC,YLCPG_PHY0,YLCPG_PHY9,YLMF_PHYS,YLCPG_DYN0,YLCPG_DYN9,&
