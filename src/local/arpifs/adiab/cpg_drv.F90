...
!$OMP&                YLCPG_TND, YLCPG_MISC, YLCPG_TMP, YLCPG_DIM, YLMF_PHYS_TMP, YLAPLPAR_TMP, YLCPG_DDH, YLCPG_SL1)
DO JKGLO=1,KGPCOMP,NPROMA
  ...
  CALL CPG(YDGEOMETRY,YLCPG_DIM,YLCPG_TMP,YLCPG_TND,YLCPG_SL1,YLCPG_MISC,YLCPG_PHY0,YLCPG_PHY9,YLMF_PHYS,&
