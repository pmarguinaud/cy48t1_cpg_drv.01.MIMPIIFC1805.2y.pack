...
CALL YLCPG_MISC%INIT (YDFIELDS%REGISTRY, YDCPG_DIM=YLCPG_DIM)
CALL YLCPG_GPAR%INIT (YDFIELDS%REGISTRY, YLCPG_DIM, YDMODEL%YRML_PHY_MF%YRPARAR)
...
!$OMP&                YLCPG_TND, YLCPG_MISC, YLCPG_TMP, YLCPG_DIM, YLMF_PHYS_TMP, YLCPG_DDH, YLCPG_SL1, YLCPG_SL2, &
!$OMP&                YLCPG_GPAR)
DO JKGLO=1,KGPCOMP,NPROMA
  ...
  CALL CPG(YDGEOMETRY,YLCPG_DIM,YLCPG_TMP,YLCPG_TND,YLCPG_SL1,YLCPG_SL2,YLCPG_MISC,&
   & YLCPG_GPAR,YLCPG_PHY0,YLCPG_PHY9,YLMF_PHYS,&
   & YLMF_PHYS_TMP,YLCPG_DDH,YLCPG_DYN0,YLCPG_DYN9,&
