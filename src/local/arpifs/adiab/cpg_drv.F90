...
CALL YLMF_PHYS%GRA%INIT (YDFIELDS%REGISTRY, YDCPG_OPTS=YLCPG_OPTS, LDMF_PHYS=LMPHYS.OR.LSIMPH, PG=PGRADIENT, &
& PERSISTENT=LLPERSISTENT)
...
REAL (KIND=JPRB) :: ZHOOK_HANDLE_LOOP, ZHOOK_HANDLE_LOOP_1
...
DO IBL = 1, YDGEOMETRY%YRDIM%NGPBLKS
  ...
  IF (LHOOK) CALL DR_HOOK('CPG_DRV:LOOP', 0, ZHOOK_HANDLE_LOOP)


  IF (LHOOK) CALL DR_HOOK('CPG_DRV:LOOP:1.1', 0, ZHOOK_HANDLE_LOOP_1)
  CALL YDVARS%CLONE_ARRAYS
  IF (LHOOK) CALL DR_HOOK('CPG_DRV:LOOP:1.1', 1, ZHOOK_HANDLE_LOOP_1)
  IF (LHOOK) CALL DR_HOOK('CPG_DRV:LOOP:1.2', 0, ZHOOK_HANDLE_LOOP_1)
  CALL YDVARS%UPDATE_VIEW (BLOCK_INDEX=IBL)
  IF (LHOOK) CALL DR_HOOK('CPG_DRV:LOOP:1.2', 1, ZHOOK_HANDLE_LOOP_1)
  IF (LHOOK) CALL DR_HOOK('CPG_DRV:LOOP:1.3', 0, ZHOOK_HANDLE_LOOP_1)
  CALL YDMF_PHYS_SURF%UPDATE_VIEW (BLOCK_INDEX=IBL)
  IF (LHOOK) CALL DR_HOOK('CPG_DRV:LOOP:1.3', 1, ZHOOK_HANDLE_LOOP_1)

  IF (LHOOK) CALL DR_HOOK('CPG_DRV:LOOP:2', 0, ZHOOK_HANDLE_LOOP_1)
  CALL YDCPG_DYN0%UPDATE_VIEW (BLOCK_INDEX=IBL)
  CALL YDCPG_DYN9%UPDATE_VIEW (BLOCK_INDEX=IBL)
  CALL YDMF_PHYS%UPDATE_VIEW (BLOCK_INDEX=IBL)
  CALL YDCPG_SL2%UPDATE_VIEW (IBL)
  IF (LHOOK) CALL DR_HOOK('CPG_DRV:LOOP:2', 1, ZHOOK_HANDLE_LOOP_1)

  IF (LHOOK) CALL DR_HOOK('CPG_DRV:LOOP:3', 0, ZHOOK_HANDLE_LOOP_1)
  IF (LLUPDATE) THEN
    ...
    CALL YDCPG_SL1%UPDATE_VIEW (IBL)
    CALL YDCPG_DDH%UPDATE_VIEW (IBL)
    LLUPDATE = .FALSE.
  ENDIF
  IF (LHOOK) CALL DR_HOOK('CPG_DRV:LOOP:3', 1, ZHOOK_HANDLE_LOOP_1)

  CALL YDCPG_BNDS%UPDATE (IBL)
  
  IF (LHOOK) CALL DR_HOOK('CPG_DRV:LOOP', 1, ZHOOK_HANDLE_LOOP)
  ...
  IF (LHOOK) CALL DR_HOOK('CPG_DRV:LOOP:4', 0, ZHOOK_HANDLE_LOOP_1)
  CALL YDVARS%RESET_ARRAYS()
  IF (LHOOK) CALL DR_HOOK('CPG_DRV:LOOP:4', 1, ZHOOK_HANDLE_LOOP_1)
