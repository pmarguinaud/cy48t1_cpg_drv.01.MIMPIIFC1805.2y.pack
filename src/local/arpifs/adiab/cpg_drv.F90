...
CALL YLCPG_TND%INIT (YDFIELDS%REGISTRY, NLEV=NFLEVG, YDTTND=YYTTND)
CALL YLCPG_MISC%INIT (YDFIELDS%REGISTRY, NLEV=NFLEVG, LDMF_PHYS=LMPHYS)
CALL YLCPG_OPT%INIT (YDFIELDS%REGISTRY, NLEV=NFLEVG, LDMF_PHYS=LMPHYS, &
                   ...
                   & PGFLUXC=PGFLUXC, PGRSURF=PGRSURF)
...
!$OMP&                YLCPG_TND, YLCPG_MISC, YLCPG_OPT)
DO JKGLO=1,KGPCOMP,NPROMA
  ...
  CALL YLCPG_OPT%UPDATE_VIEW (BLOCK_INDEX=IBL)
  ...
  CALL CPG(YDGEOMETRY,YLCPG_OPT,YLCPG_TND,YLCPG_MISC,YLCPG_PHY0,YLCPG_PHY9,YLMF_PHYS,YLCPG_DYN0,YLCPG_DYN9,&
