...
WRITE (0, '(I3," ",I3," ",A,":",I3.3," ",L1," ",L2," ",Z16.16)') ICOUNT, NSTEP, __FILE__, __LINE__, ASSOCIATED (YLMF_PHYS%OUT%F_FCQRNG), &
     & YLMF_PHYS%OUT%F_FCQRNG%OWNED, LOC(YLMF_PHYS%OUT%F_FCQRNG%DATA (1,1,1))
