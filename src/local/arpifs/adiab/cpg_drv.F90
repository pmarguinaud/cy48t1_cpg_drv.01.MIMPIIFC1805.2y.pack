...
CALL YLMF_PHYS%TMP%INIT (YDFIELDS%REGISTRY, NLEV=NFLEVG, LDMF_PHYS=LMPHYS.OR.LSIMPH, LDCONFX=LLCONFX, &
...
!$OMP&                YLCPG_TND, YLCPG_MISC, YLCPG_TMP, YLCPG_DIM)
DO JKGLO=1,KGPCOMP,NPROMA
  ...
  CALL CPG(YDGEOMETRY,YLCPG_DIM,YLCPG_TMP,YLCPG_TND,YLCPG_MISC,YLCPG_PHY0,YLCPG_PHY9,YLMF_PHYS,YLCPG_DYN0,YLCPG_DYN9,&
