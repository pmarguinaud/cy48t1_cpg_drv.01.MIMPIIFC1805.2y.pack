...
DO JKGLO = 1, KGPCOMP, YDGEOMETRY%YRDIM%NPROMA
  ...
  CALL CPG(YDGEOMETRY, YLCPG_BNDS, YLCPG_OPTS, YLCPG_TMP, YLCPG_TND, YLCPG_SL1, YLCPG_SL2,                                       &
  & YLCPG_MISC, YLCPG_GPAR, YLCPG_PHY0, YLCPG_PHY9, YLMF_PHYS, YLCPG_DDH, YLCPG_DYN0, YLCPG_DYN9,                                &
  & YLMF_PHYS_SURF, YDVARS, YDMODEL, YDFIELDS, YDSL, PGFLSLP(:, :, :, IBL), PSAVTEND(:, :, :, IBL), PGMVTNDHD_DDH(:, :, :, IBL), &
  ...
  & PGMVTNDSL_DDH(:, :, :, IBL), PGFLTNDSL_DDH(:, :, :, IBL), ZTRAJEC_PHYS, ZTRAJEC_SLAG, YDDDH, YSPP, YSPP_CONFIG, CDPART=CLPART)
