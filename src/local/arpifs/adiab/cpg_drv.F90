...
CALL YLCPG_OPTS%INIT (YDGEOMETRY, YDMODEL, YDFIELDS)
...
DO ILPART = 1, INPART
  ...
  IF (INPART == 3 .AND. ILPART == 2 .AND.  YDMODEL%YRML_PHY_MF%YRSIMPHL%LSIMPH) THEN
    ...
    CALL MF_PHYS_OPENMP (YDGEOMETRY, YLCPG_DIM, YLCPG_OPTS, YLCPG_MISC, YLCPG_GPAR, YLCPG_PHY0, YLCPG_PHY9,  &
...
DO JKGLO=1,KGPCOMP,NPROMA
  ...
  CALL CPG(YDGEOMETRY,YLCPG_DIM,YLCPG_OPTS,YLCPG_TMP,YLCPG_TND,YLCPG_SL1,YLCPG_SL2,YLCPG_MISC,&
