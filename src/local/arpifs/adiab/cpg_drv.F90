...
CALL YLMF_PHYS%OUT%INIT (YDFIELDS%REGISTRY, YDCPG_DIM=YLCPG_DIM)
CALL YLMF_PHYS%OPT%INIT (YDFIELDS%REGISTRY, YDCPG_DIM=YLCPG_DIM, LDMF_PHYS=LMPHYS.OR.LSIMPH, &
...
CALL YLMF_PHYS%FOR%INIT (YDFIELDS%REGISTRY, YDCPG_DIM=YLCPG_DIM, LDMF_PHYS=LMPHYS.OR.LSIMPH, &
                       & PU=PFORCEU, PV=PFORCEV, PT=PFORCET, PQ=PFORCEQ)
CALL YLMF_PHYS%GRA%INIT (YDFIELDS%REGISTRY, YDCPG_DIM=YLCPG_DIM, LDMF_PHYS=LMPHYS.OR.LSIMPH, PG=PGRADIENT)
CALL YLMF_PHYS%RAD%INIT (YDFIELDS%REGISTRY, YDCPG_DIM=YLCPG_DIM, LDMF_PHYS=LMPHYS.OR.LSIMPH, &
