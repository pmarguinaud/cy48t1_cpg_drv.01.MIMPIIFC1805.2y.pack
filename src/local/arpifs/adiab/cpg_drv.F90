...
USE CPG_TYPE_MOD, ONLY : CPG_DYN_TYPE, CPG_PHY_TYPE, CPG_TND_TYPE, CPG_MISC_TYPE
...
DO JKGLO=1,KGPCOMP,NPROMA
  ...
  CALL CPG(YDGEOMETRY,YLCPG_TND,YLCPG_MISC,YLCPG_PHY0,YLCPG_PHY9,YLMF_PHYS,YLCPG_DYN0,YLCPG_DYN9,YLMF_PHYS_SURF,YDVARS,YDMODEL,YDFIELDS,&
