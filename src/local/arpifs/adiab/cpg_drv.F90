...
CALL YLCPG_DIM%INIT (YDGEOMETRY, YDMODEL, YDFIELDS)
...
CALL YLAPLPAR_TMP%INIT (YDFIELDS%REGISTRY, YDCPG_DIM=YLCPG_DIM, LDMF_PHYS=LMPHYS.OR.LSIMPH, LDCONFX=LLCONFX, &
                      & YDMODEL=YDMODEL)
