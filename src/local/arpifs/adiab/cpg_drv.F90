...
INTEGER(KIND=JPIM) :: JLEV, IOFF, ING
...
IF (YLCPG_OPTS%LCONFX     .NEQV.  LLCONFX    ) CALL ABOR1 ('CPG_DRV: LCONFX   ')
IF (YLCPG_OPTS%L_DFISTEP  .NEQV.  LD_DFISTEP ) CALL ABOR1 ('CPG_DRV: L_DFISTEP')
IF (YLCPG_OPTS%LFSTEP     .NEQV.  LLFSTEP    ) CALL ABOR1 ('CPG_DRV: LFSTEP   ')
IF (YLCPG_OPTS%LDIAB      .NEQV.  LLDIAB     ) CALL ABOR1 ('CPG_DRV: LDIAB    ')
IF (YLCPG_OPTS%LSLPHY     .NEQV.  LLSLPHY    ) CALL ABOR1 ('CPG_DRV: LSLPHY   ')
IF (YLCPG_OPTS%LUSEPB1    .NEQV.  LLUSEPB1   ) CALL ABOR1 ('CPG_DRV: LUSEPB1  ')
IF (YLCPG_OPTS%ZDT        /=  ZDT            ) CALL ABOR1 ('CPG_DRV: ZDT      ')
IF (YLCPG_OPTS%ZDTPHY     /=  ZDTPHY         ) CALL ABOR1 ('CPG_DRV: ZDTPHY   ')
IF (YLCPG_OPTS%ZTE        /=  ZTE            ) CALL ABOR1 ('CPG_DRV: ZTE      ')
IF (YLCPG_OPTS%ZBETADT    /=  ZBETADT        ) CALL ABOR1 ('CPG_DRV: ZBETADT  ')
...
!$OMP &               YLCPG_MISC, YLCPG_TMP, YLCPG_DDH, YLCPG_SL1, YLCPG_SL2, YLCPG_GPAR, YLMF_PHYS, YLCPG_BNDS)
