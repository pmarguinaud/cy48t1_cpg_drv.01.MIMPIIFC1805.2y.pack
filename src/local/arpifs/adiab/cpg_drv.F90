...
CALL YLCPG_DYN0%INIT (YDFIELDS%REGISTRY, NLEV=NFLEVG, PHIF=PHIF0, PRCP=PRCP0, PREF=PRE0F, PCTY=PCTY0)
CALL YLCPG_DYN9%INIT (YDFIELDS%REGISTRY, NLEV=NFLEVG, PWRL=PWRL9)
