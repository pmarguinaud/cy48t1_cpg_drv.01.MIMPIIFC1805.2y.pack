...
WRITE (0, '(Z16.16)') LOC (PSP_RR (1, 1, 1))

WRITE (0, '(A,Z16.16)') " YDFIELDS%SURFVARS%GSP_RR%VFC%FT0%DATA (1, 1)) = ", LOC (YDFIELDS%SURFVARS%GSP_RR%VFC%FT0%DATA (1, 1))
WRITE (0, '(A,Z16.16)') " YDFIELDS%SURFVARS%GSP_RR%VFC%FT1%DATA (1, 1)) = ", LOC (YDFIELDS%SURFVARS%GSP_RR%VFC%FT1%DATA (1, 1))
WRITE (0, '(A,Z16.16)') " YDFIELDS%SURFVARS%GSP_RR%VFC%FT9%DATA (1, 1)) = ", LOC (YDFIELDS%SURFVARS%GSP_RR%VFC%FT9%DATA (1, 1))

WRITE (0, '(A,Z16.16)') " YDFIELDS%SURFVARS%GSP_RR%VIC%FT0%DATA (1, 1)) = ", LOC (YDFIELDS%SURFVARS%GSP_RR%VIC%FT0%DATA (1, 1))
WRITE (0, '(A,Z16.16)') " YDFIELDS%SURFVARS%GSP_RR%VIC%FT1%DATA (1, 1)) = ", LOC (YDFIELDS%SURFVARS%GSP_RR%VIC%FT1%DATA (1, 1))
WRITE (0, '(A,Z16.16)') " YDFIELDS%SURFVARS%GSP_RR%VIC%FT9%DATA (1, 1)) = ", LOC (YDFIELDS%SURFVARS%GSP_RR%VIC%FT9%DATA (1, 1))

WRITE (0, '(A,Z16.16)') " YDFIELDS%SURFVARS%GSP_RR%VT%FT0%DATA (1, 1))  = ", LOC (YDFIELDS%SURFVARS%GSP_RR%VT%FT0%DATA (1, 1))
WRITE (0, '(A,Z16.16)') " YDFIELDS%SURFVARS%GSP_RR%VT%FT1%DATA (1, 1))  = ", LOC (YDFIELDS%SURFVARS%GSP_RR%VT%FT1%DATA (1, 1))
WRITE (0, '(A,Z16.16)') " YDFIELDS%SURFVARS%GSP_RR%VT%FT9%DATA (1, 1))  = ", LOC (YDFIELDS%SURFVARS%GSP_RR%VT%FT9%DATA (1, 1))

WRITE (0, '(A,Z16.16)') " YDFIELDS%SURFVARS%GSP_RR%VW%FT0%DATA (1, 1))  = ", LOC (YDFIELDS%SURFVARS%GSP_RR%VW%FT0%DATA (1, 1))
WRITE (0, '(A,Z16.16)') " YDFIELDS%SURFVARS%GSP_RR%VW%FT1%DATA (1, 1))  = ", LOC (YDFIELDS%SURFVARS%GSP_RR%VW%FT1%DATA (1, 1))
WRITE (0, '(A,Z16.16)') " YDFIELDS%SURFVARS%GSP_RR%VW%FT9%DATA (1, 1))  = ", LOC (YDFIELDS%SURFVARS%GSP_RR%VW%FT9%DATA (1, 1))

ASSOCIATE (YSP_RR => YDFIELDS%YRSURF%YSP_RR)
WRITE (0, *) " YSP_RR%YFC%MP0 = ", YSP_RR%YFC%MP0
WRITE (0, *) " YSP_RR%YFC%MP1 = ", YSP_RR%YFC%MP1
WRITE (0, *) " YSP_RR%YFC%MP9 = ", YSP_RR%YFC%MP9
WRITE (0, *) " YSP_RR%YIC%MP0 = ", YSP_RR%YIC%MP0
WRITE (0, *) " YSP_RR%YIC%MP1 = ", YSP_RR%YIC%MP1
WRITE (0, *) " YSP_RR%YIC%MP9 = ", YSP_RR%YIC%MP9
WRITE (0, *) " YSP_RR%YT%MP0  = ", YSP_RR%YT%MP0
WRITE (0, *) " YSP_RR%YT%MP1  = ", YSP_RR%YT%MP1
WRITE (0, *) " YSP_RR%YT%MP9  = ", YSP_RR%YT%MP9
WRITE (0, *) " YSP_RR%YW%MP0  = ", YSP_RR%YW%MP0
WRITE (0, *) " YSP_RR%YW%MP1  = ", YSP_RR%YW%MP1
WRITE (0, *) " YSP_RR%YW%MP9  = ", YSP_RR%YW%MP9

WRITE (0, '(A,Z16.16)') " YSP_RR%YFC%MP0 = ", LOC (PSP_RR (1, YSP_RR%YFC%MP0    , 1))
WRITE (0, '(A,Z16.16)') " YSP_RR%YFC%MP1 = ", LOC (PSP_RR (1, YSP_RR%YFC%MP1    , 1))
WRITE (0, '(A,Z16.16)') " YSP_RR%YFC%MP9 = ", LOC (PSP_RR (1, YSP_RR%YFC%MP9    , 1))
WRITE (0, '(A,Z16.16)') " YSP_RR%YIC%MP0 = ", LOC (PSP_RR (1, YSP_RR%YIC%MP0    , 1))
WRITE (0, '(A,Z16.16)') " YSP_RR%YIC%MP1 = ", LOC (PSP_RR (1, YSP_RR%YIC%MP1    , 1))
WRITE (0, '(A,Z16.16)') " YSP_RR%YIC%MP9 = ", LOC (PSP_RR (1, YSP_RR%YIC%MP9    , 1))
WRITE (0, '(A,Z16.16)') " YSP_RR%YT%MP0  = ", LOC (PSP_RR (1, YSP_RR%YT%MP0     , 1))
WRITE (0, '(A,Z16.16)') " YSP_RR%YT%MP1  = ", LOC (PSP_RR (1, YSP_RR%YT%MP1     , 1))
WRITE (0, '(A,Z16.16)') " YSP_RR%YT%MP9  = ", LOC (PSP_RR (1, YSP_RR%YT%MP9     , 1))
WRITE (0, '(A,Z16.16)') " YSP_RR%YW%MP0  = ", LOC (PSP_RR (1, YSP_RR%YW%MP0     , 1))
WRITE (0, '(A,Z16.16)') " YSP_RR%YW%MP1  = ", LOC (PSP_RR (1, YSP_RR%YW%MP1     , 1))
WRITE (0, '(A,Z16.16)') " YSP_RR%YW%MP9  = ", LOC (PSP_RR (1, YSP_RR%YW%MP9     , 1))
END ASSOCIATE
#endif
...
DO JKGLO=1,KGPCOMP,NPROMA
  ...
  CALL CPG(YDGEOMETRY,YDFIELDS%SURFVARS,YDVARS,YDMODEL,YDFIELDS,&
   ...
   & PHIF0(:,:,IBL),PRCP0(:,:,:,IBL),PRE0F(:,:,IBL),PCTY0(:,:,:,IBL),PWRL9(:,:,IBL))
ENDDO
