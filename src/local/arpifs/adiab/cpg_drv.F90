...
CHARACTER (LEN=3)  :: CLCONF
INTEGER(KIND=JPIM) :: ILCONF, INCONF
...
DO JKGLO=1,KGPCOMP,NPROMA
  ...
  CALL CPG(YDGEOMETRY,YLCPG_DIM,YLCPG_TMP,YLCPG_TND,YLCPG_SL1,YLCPG_SL2,YLCPG_MISC,&
   ...
   & PGMVTNDSL_DDH(:,:,:,IBL),PGFLTNDSL_DDH(:,:,:,IBL),ZTRAJEC_PHYS,ZTRAJEC_SLAG,YDDDH, CDCONF=CLCONF)
