...
PRINT *, " YDMODEL%YRML_GCONF%YGFL%NUMFLDS = ", YDMODEL%YRML_GCONF%YGFL%NUMFLDS
PRINT *, " C_SIZEOF (YDVARS) = ", C_SIZEOF (YDVARS)
...
DO JKGLO=1,KGPCOMP,NPROMA
  ...
  CALL CPG(YDGEOMETRY,YLMF_PHYS_SURF,YDFIELDS%SURFVARS,YDVARS,YDMODEL,YDFIELDS,&
