...
CALL YLCPG_DDH%INIT (YDFIELDS%REGISTRY, NLEV=NFLEVG, YDMODEL=YDMODEL)
...
!$OMP&                YLCPG_TND, YLCPG_MISC, YLCPG_TMP, YLCPG_DIM, YLMF_PHYS_TMP, YLAPLPAR_TMP, YLCPG_DDH)
DO JKGLO=1,KGPCOMP,NPROMA
  ...
  CALL CPG(YDGEOMETRY,YLCPG_DIM,YLCPG_TMP,YLCPG_TND,YLCPG_MISC,YLCPG_PHY0,YLCPG_PHY9,YLMF_PHYS,&
