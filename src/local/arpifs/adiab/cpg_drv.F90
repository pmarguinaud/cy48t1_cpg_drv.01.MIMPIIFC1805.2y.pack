...
TYPE(MF_PHYS_TMP_TYPE) :: YLMF_PHYS_TMP
TYPE(APLPAR_TMP_TYPE)  :: YLAPLPAR_TMP
...
CALL YLCPG_DIM%INIT (YDGEOMETRY, YDMODEL)
...
CALL YLCPG_SL1%INIT (YDFIELDS%REGISTRY, NLEV=NFLEVG, YDTPTRSLB1=YDMODEL%YRML_DYN%YRPTRSLB1, YGFL=YDFIELDS%YRGFL%YGFL, YDMODEL=YDMODEL)
...
CALL YLCPG_TMP%INIT (YDFIELDS%REGISTRY, NLEV=NFLEVG)
...
CALL YLCPG_MISC%INIT (YDFIELDS%REGISTRY, YDCPG_DIM=YLCPG_DIM, YDMODEL=YDMODEL)
CALL YLMF_PHYS%DIM%INIT (YDMODEL)
CALL YLMF_PHYS%OUT%INIT (YDFIELDS%REGISTRY, NLEV=NFLEVG, YDDPHY=YDMODEL%YRML_PHY_G%YRDPHY, YDSURF=YDFIELDS%YRSURF)
CALL YLMF_PHYS%OPT%INIT (YDFIELDS%REGISTRY, NLEV=NFLEVG, LDMF_PHYS=LMPHYS.OR.LSIMPH, &
...
CALL YLMF_PHYS%FOR%INIT (YDFIELDS%REGISTRY, NLEV=NFLEVG, LDMF_PHYS=LMPHYS.OR.LSIMPH, &
                       & PU=PFORCEU, PV=PFORCEV, PT=PFORCET, PQ=PFORCEQ)
CALL YLMF_PHYS%GRA%INIT (YDFIELDS%REGISTRY, NLEV=NFLEVG, LDMF_PHYS=LMPHYS.OR.LSIMPH, &
                       & PG=PGRADIENT)
CALL YLMF_PHYS%RAD%INIT (YDFIELDS%REGISTRY, NLEV=NFLEVG, LDMF_PHYS=LMPHYS.OR.LSIMPH, &
                       & PEMTD=PEMTD, PEMTU=PEMTU, PTRSW=PTRSW, PRMOON=PRMOON)
CALL YLMF_PHYS_TMP%INIT (YDFIELDS%REGISTRY, YDCPG_DIM=YLCPG_DIM, LDMF_PHYS=LMPHYS.OR.LSIMPH, LDCONFX=LLCONFX)
CALL YLAPLPAR_TMP%INIT (YDFIELDS%REGISTRY, NLEV=NFLEVG, LDMF_PHYS=LMPHYS.OR.LSIMPH, LDCONFX=LLCONFX, &
                      & YDMODEL=YDMODEL, YDSURF=YDFIELDS%YRSURF)
...
!$OMP&                YLCPG_TND, YLCPG_MISC, YLCPG_TMP, YLCPG_DIM, YLMF_PHYS_TMP, YLAPLPAR_TMP, YLCPG_DDH, YLCPG_SL1, YLCPG_SL2)
DO JKGLO=1,KGPCOMP,NPROMA
  ...
  CALL YLMF_PHYS_TMP%UPDATE_VIEW (BLOCK_INDEX=IBL)
  CALL YLAPLPAR_TMP%UPDATE_VIEW (BLOCK_INDEX=IBL)
  ...
  CALL CPG(YDGEOMETRY,YLCPG_DIM,YLCPG_TMP,YLCPG_TND,YLCPG_SL1,YLCPG_SL2,YLCPG_MISC,YLCPG_PHY0,YLCPG_PHY9,YLMF_PHYS,&
   & YLMF_PHYS_TMP,YLAPLPAR_TMP,YLCPG_DDH,YLCPG_DYN0,YLCPG_DYN9,&
...
CALL YLMF_PHYS_TMP%FINAL
CALL YLAPLPAR_TMP%FINAL
