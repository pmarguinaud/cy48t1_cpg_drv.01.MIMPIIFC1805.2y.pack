...
@PROCESS NOCHECK
#endif
SUBROUTINE CPG_DYN(YDGEOMETRY,YDCPG_DYN0,YDCPG_DYN9,YDMF_PHYS_SURF,YDVARS,YDGMV,&
 ! --- INPUT ----------------------------------------------------------
...
!*       2.1   Semi-lagrangian dynamics (not lagged part).
  ...
  CALL LACDYN(YDGEOMETRY,YDGMV,&
   ...
   & YDCPG_DYN9%NHX,YDCPG_DYN0%NHX,YDCPG_DYN9%NHY,YDCPG_DYN0%NHY,&
   & YDCPG_DYN0%PRE,YDCPG_DYN0%XYB%RDELP,YDCPG_DYN0%CTY%ZVIEW,YDCPG_DYN0%UVH%ZVIEW,&
   & PATND,YDCPG_DYN0%DBBC,YDCPG_DYN0%RDPHI,YDCPG_DYN0%GWT,YDCPG_DYN9%GWT,PGFL,&
   ! --- INPUT/OUTPUT ---------------------------------------------------------
   & KSETTLOFF,PGMV,PGMVS,PB1(1,1),PB2(1,1),PGMVT1,&
   & PGMVT1S,YDCPG_DYN0%GWS,PGMVTNDSI,YDCPG_DYN9%WRL)
  ...
  IF ((.NOT.(LMPHYS.OR.LEPHYS)).AND.LSPHLC) THEN
    IF (LTWOTL) THEN
      CALL VDIFLCZ(YDVDF,YDVAB,YDPHLC,KST,KEND,NPROMA,NFLEVG,PDT,PLSM,&
       & YDCPG_DYN0%PHI,YDCPG_DYN0%PHIF,YDCPG_DYN0%RCP%ZVIEW(:,:,YYTRCP0%M_CP),YDCPG_DYN0%RCP%ZVIEW(:,:,YYTRCP0%M_R),YDCPG_DYN0%XYB%RDELP,&
...
!*       3.1   Dynamics with Eulerian advection treatment 
  ...
  CALL CPEULDYN(YDGEOMETRY,YDGMV,&
   ...
   & KIBL,&
   & PGFL,PTSOL,PQSOL,YDCPG_DYN0%NHX,YDCPG_DYN0%KENE,YDCPG_DYN0%CTY%ZVIEW,&
   & YDCPG_DYN0%PRE,YDCPG_DYN0%XYB%RDELP,PATND,YDCPG_DYN9%NHX,&
   ! --- INPUT/OUTPUT ---------------------------------------------
