...
@PROCESS NOCHECK
#endif
SUBROUTINE CPG_DYN(YDGEOMETRY,YDCPG_BNDS, YDCPG_OPTS,YDCPG_TND,YDCPG_MISC,YDCPG_DYN0,YDCPG_DYN9,YDVARS,YDGMV,&
 ! --- INPUT ----------------------------------------------------------
 & YDMODEL,PBETADT,PDT,&
 & PSLHDA,PSLHDD0,&
 & PGFL,&
...
!*       2.1   Semi-lagrangian dynamics (not lagged part).
  ...
  CALL LACDYN(YDGEOMETRY,YDCPG_DYN0,YDCPG_DYN9,YDGMV,&
   ! --- INPUT ----------------------------------------------------------------
   & YDMODEL,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,PBETADT,PDT,PSLHDA,PSLHDD0,&
   & YDCPG_BNDS%KBL,&
...
!*       3.1   Dynamics with Eulerian advection treatment 
  ...
  CALL CPEULDYN(YDGEOMETRY,YDGMV,&
   ! --- INPUT ----------------------------------------------------
   & YDEPHY,YGFL,YDMODEL%YRML_DYN,YDPHY,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,PBETADT,PDT,&
   & YDCPG_BNDS%KBL,&
