...
!*       2.1   Semi-lagrangian dynamics (not lagged part).
  ...
  & YDCPG_OPTS%ZBETADT, YDCPG_OPTS%ZDT, PSLHDA, PSLHDD0, YDCPG_BNDS%KBL, YDCPG_TND%ZVIEW, PGFL, KSETTLOFF, PGMV, PGMVS,     &
...
!*       2.2   Simple physics.
  ...
  IF ((.NOT.(LMPHYS.OR.LEPHYS)).AND.LSPHLC) THEN
    IF (LTWOTL) THEN
      CALL VDIFLCZ(YDVDF, YDVAB, YDPHLC, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, NPROMA, NFLEVG, YDCPG_OPTS%ZDT, YDCPG_MISC%LSM, &
