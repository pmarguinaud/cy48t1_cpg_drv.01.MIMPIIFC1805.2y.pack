...
CALL CPEULDYN(YDMODEL%YRCST, YDGEOMETRY, YDGMV, YDMODEL%YRML_PHY_EC%YREPHY, YDMODEL%YRML_GCONF%YGFL, YDMODEL%YRML_DYN, YDMODEL%YRML_PHY_MF%YRPHY, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, &
