SUBROUTINE CPG_DYN_SLG (YDGEOMETRY, YDCPG_BNDS, YDCPG_OPTS, YDCPG_TND, YDCPG_MISC, YDCPG_DYN0, YDCPG_DYN9, &
                      & YDVARS, YDCPG_SL1, YDCPG_SL2, YDGMV, YDMODEL, PSLHDA, PSLHDD0, PGFL, KSETTLOFF, PGMV, PGMVS, PB1, PB2, &
...
CALL LACDYN(YDMODEL%YRCST, YDGEOMETRY, YDVARS, YDCPG_SL1, YDCPG_SL2, YDCPG_BNDS, YDCPG_OPTS, YDCPG_TND, YDCPG_DYN0, YDCPG_DYN9, YDGMV, YDMODEL, &
