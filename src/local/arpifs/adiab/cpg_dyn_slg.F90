SUBROUTINE CPG_DYN_SLG (YDGEOMETRY, YDCPG_BNDS, YDCPG_OPTS, YDCPG_TND, YDCPG_MISC, YDCPG_DYN0, YDCPG_DYN9, &
                      & YDVARS, YDCPG_SL1, YDCPG_SL2, YDMODEL, PSLHDA, PSLHDD0, PGFL, KSETTLOFF, PGMVTNDSI)
...
& YDCPG_DYN0, YDCPG_DYN9, YDMODEL, PSLHDA, PSLHDD0, YDCPG_TND%ZVIEW, PGFL, KSETTLOFF, PGMVTNDSI)
