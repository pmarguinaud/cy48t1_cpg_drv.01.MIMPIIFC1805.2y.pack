SUBROUTINE CPG_END(YDGEOMETRY,YDCPG_BNDS, YDCPG_OPTS,YDGMV,YDSURF,&
 !---------------------------------------------------------------------
 ! - INPUT .
...
IF (LLSTR.AND.(.NOT.LAGPHY)) THEN
  IFLAG=1
  CALL GPMPFC(YDGMV,YDML_GCONF,YDDYN,NPROMA,NFLEVG,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,IFLAG,PGM,PGMV,PGMVS,PGFL)
ENDIF
