...
IF (LLSTR.AND.(.NOT.YDMODEL%YRML_PHY_EC%YREPHY%LAGPHY)) THEN
  IFLAG=1
  CALL GPMPFC_EXPL(YDCPG_OPTS%LNHDYN, YDCPG_OPTS%LNHXDER, YDCPG_OPTS%LPC_FULL, YDCPG_OPTS%LTWOTL, YDVARS, YDMODEL%YRML_GCONF, YDMODEL%YRML_DYN%YRDYN, YDGEOMETRY%YRDIM%NPROMA, YDGEOMETRY%YRDIMV%NFLEVG, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA,          &
