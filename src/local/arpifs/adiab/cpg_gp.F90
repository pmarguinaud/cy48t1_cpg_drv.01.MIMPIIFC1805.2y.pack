...
IF (NSTEP > 0.AND.LTENC) THEN
  ...
  & YDCPG_BNDS%KFDIE, YDCPG_BNDS%KSTGLO, YDVARS%SP%T0, YDVARS%SP%DL, YDVARS%SP%DM, YDVARS%SP%T9, YDVARS%SP%DL,     &
  & YDVARS%SP%DM)
ENDIF
...
IF(LLSTR) THEN
  ...
  & IFLAG, YDVARS%GEOMETRY%GM%T0, PGFL=PGFL, P0U=YDVARS%U%T0, P0V=YDVARS%V%T0, P0DIV=YDVARS%DIV%T0, P0TL=YDVARS%T%DL, &
...
IF (LNHQE) THEN
  ...
  CALL CPG_GP_NHQE(YDGEOMETRY, YDCPG_BNDS, YDCPG_OPTS, YDVARS, YDCPG_DYN0, YDCPG_DYN9, YDMODEL, YDFIELDS%YRGMV, &
  & LLGPXX, YDCPG_OPTS%LDIAB, LMPA, YDVARS%GEOMETRY%OROG%T0, Z_OROGLL_T0, Z_OROGMM_T0, Z_OROGLM_T0,             &
  & Z_GDW_T0, Z_GWHT_T0, PGFL, YDCPG_TND%ZVIEW, ZP1FORC)
ELSEIF (LNHEE) THEN
  ! * NHEE model:
  LLGPXX=.NOT.(LSLAG.AND.(NVDVAR == 4 .OR. NVDVAR == 5).AND.ND4SYS==2)
  CALL CPG_GP_NHEE(YDGEOMETRY, YDCPG_BNDS, YDCPG_OPTS, YDVARS, YDCPG_DYN0, YDCPG_DYN9, YDMODEL, YDFIELDS%YRGMV, &
  & LLGPXX, YDCPG_OPTS%LDIAB, LMPA, YDVARS%GEOMETRY%OROG%T0, Z_OROGLL_T0, Z_OROGMM_T0, Z_OROGLM_T0,             &
  & Z_GDW_T0, Z_GWHT_T0, PGFL, YDCPG_TND%ZVIEW, ZP1FORC)
ELSE
  ! * Hydrostatic model:
  ...
  CALL CPG_GP_HYD(YDGEOMETRY, YDCPG_BNDS, YDCPG_OPTS, YDVARS, YDCPG_DYN0, YDCPG_DYN9, YDMODEL, YDFIELDS%YRGMV, &
  & LLUVH, LLGPXX, YDCPG_OPTS%LDIAB, LMPA, YDVARS%GEOMETRY%OROG%T0, Z_OROGLL_T0, Z_OROGMM_T0,                  &
  & Z_OROGLM_T0, Z_GDW_T0, Z_GWHT_T0, PGFL, YDCPG_TND%ZVIEW, ZP1FORC)
ENDIF
...
CALL GPINISLB(  YDGEOMETRY, YGFL, YDDYN, YDPTRSLB2, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_OPTS%ZTE,    &
