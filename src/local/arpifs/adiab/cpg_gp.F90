...
USE YOMDYNA  , ONLY : NVDVAR, ND4SYS, LPC_FULL, LNHX, LSLHD, LGWADV
...
IF(LLSTR) THEN
  IFLAG=0
  CALL GPMPFC_EXPL(YDFIELDS%YRGMV, YDMODEL%YRML_GCONF, YDDYN, NPROMA, NFLEVG, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA,          &
