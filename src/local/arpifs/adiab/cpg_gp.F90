...
@PROCESS NOCHECK
#endif
SUBROUTINE CPG_GP(YDGEOMETRY,YDCPG_DIM, YDCPG_OPTS,YDTMP,YDCPG_TND,YDCPG_MISC,&
 & YDCPG_GPAR,YDCPG_DYN0,YDCPG_DYN9,YDMF_PHYS_SURF,YDVARS,&
 & YDMODEL,YDFIELDS,&
 !---------------------------------------------------------------------
 ! - INPUT .
...
!*     1.6   SURFACE VARIABLES.
  ...
  IF (LMSE.AND.NGPAR/=0) THEN
    YDCPG_GPAR%ZVIEW(1:NPROMA,1:NGPAR) = GPARBUF (:, :, 1+(YDCPG_DIM%KSTGLO-1)/YDGEOMETRY%YRDIM%NPROMA)
  ENDIF
...
IF (LNHQE) THEN
  ...
  CALL CPG_GP_NHQE(YDGEOMETRY,YDCPG_DIM, YDCPG_OPTS,YDTMP,YDVARS,YDCPG_DYN0,YDCPG_DYN9,YDMODEL,YDFIELDS%YRGMV,&
   !---------------------------------------------------------------------
   ! - INPUT .
   & LLGPXX,LDLDIAB,LMPA,&
   & YDOROG%OROG,&
...
ELSEIF (LNHEE) THEN
  ...
  CALL CPG_GP_NHEE(YDGEOMETRY,YDCPG_DIM, YDCPG_OPTS,YDTMP,YDVARS,YDCPG_DYN0,YDCPG_DYN9,YDMODEL,YDFIELDS%YRGMV,&
   !---------------------------------------------------------------------
   ! - INPUT .
   & LLGPXX,LDLDIAB,LMPA,&
   & YDOROG%OROG,&
...
ELSE
  ...
  CALL CPG_GP_HYD(YDGEOMETRY,YDCPG_DIM, YDCPG_OPTS,YDTMP,YDVARS,YDCPG_DYN0,YDCPG_DYN9,YDMODEL,YDFIELDS%YRGMV,&
   !---------------------------------------------------------------------
   ! - INPUT .
