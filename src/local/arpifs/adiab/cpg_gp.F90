...
IF (YDCPG_OPTS%LNHQE) THEN
  ! * NHQE model:
  LLGPXX=.NOT.(LSLAG.AND.YDCPG_OPTS%NVDVAR == 4.AND.YDCPG_OPTS%ND4SYS==2)
...
ELSEIF (YDCPG_OPTS%LNHEE) THEN
  ! * NHEE model:
  LLGPXX=.NOT.(LSLAG.AND.(YDCPG_OPTS%NVDVAR == 4 .OR. YDCPG_OPTS%NVDVAR == 5).AND.YDCPG_OPTS%ND4SYS==2)
...
CALL GPINISLB_PART1_EXPL (YDCPG_OPTS%LNHDYN, YDCPG_OPTS%LNHX, LSLAG, YDCPG_OPTS%LTWOTL, YDGEOMETRY, YGFL, YDDYN, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_OPTS%ZTE, &
...
CALL GPINISLB_PART2_EXPL (LSLAG, YDCPG_OPTS%LTWOTL, YDDYN, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_OPTS%ZTE, YDVARS)
