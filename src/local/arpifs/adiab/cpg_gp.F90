...
@PROCESS NOCHECK
#endif
SUBROUTINE CPG_GP(YDGEOMETRY,YDTMP,YDCPG_TND,YDCPG_MISC,YDCPG_DYN0,YDCPG_DYN9,YDMF_PHYS_SURF,YDVARS,&
 & YDMODEL,YDFIELDS,&
 !---------------------------------------------------------------------
 ! - INPUT .
 & LD_DFISTEP,KST,KEND,KENDC,KBL,KSTGLO,LDLFSTEP,LDLDIAB,PDT,PTE,&
 & KIBL,&
 !---------------------------------------------------------------------
 ! - INPUT/OUTPUT .
 & PGFL,&
...
CALL GPINISLB(&
 ...
 & PGWFT0=YDCPG_DYN0%GWFT,PGDW0=YDTMP%T0%GDW,PGWS0=YDCPG_DYN0%GWHT(:,NFLEVG)) 
