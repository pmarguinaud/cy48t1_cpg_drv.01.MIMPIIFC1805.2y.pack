...
IF(NCURRENT_ITER == 0) THEN
  ...
  ELSE
    ...
    & YDCPG_OPTS%LFSTEP, YDCPG_OPTS%LNHDYN, YDCPG_OPTS%NVDVAR, P0SP=YDVARS%SP%T0, P0SPL=YDVARS%SP%DL,                  &
...
IF(LLSTR) THEN
  IFLAG=0
  CALL GPMPFC_EXPL(YDCPG_OPTS%LNHDYN, YDCPG_OPTS%LNHXDER, YDCPG_OPTS%LPC_FULL, YDCPG_OPTS%LTWOTL,                      &
  & YDVARS, YDMODEL%YRML_GCONF, YDDYN, NPROMA, NFLEVG, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, IFLAG, YDVARS%GEOMETRY%GM%T0&
  & )
ENDIF

CALL GP_SPV(YDCPG_OPTS%LNHDYN, YDCPG_OPTS%LPC_FULL, YDCPG_OPTS%LTWOTL, YDGEOMETRY, YDDYN, YDSIMPHL,                &
...
CALL GPINISLB_PART1_EXPL (YDCPG_OPTS%LNHDYN, YDCPG_OPTS%LNHX, YDCPG_OPTS%LSLAG, YDCPG_OPTS%LTWOTL,         &
...
CALL GPINISLB_PART3_EXPL (YDCPG_OPTS%LGWADV, YDCPG_OPTS%LNHDYN, YDCPG_OPTS%LVERTFE, YDCPG_OPTS%LVFE_GW,                 &
