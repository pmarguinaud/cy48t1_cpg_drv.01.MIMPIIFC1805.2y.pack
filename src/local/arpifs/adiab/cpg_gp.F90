...
& YDPTRSLB2=>YDMODEL%YRML_DYN%YRPTRSLB2, YDPARAR=>YDMODEL%YRML_PHY_MF%YRPARAR,             &
...
IF (LNHQE) THEN
  ...
  & LLGPXX, YDCPG_OPTS%LDIAB, LMPA, YDVARS%GEOMETRY%OROG%T0, Z_OROGLL_T0, Z_OROGMM_T0, Z_OROGLM_T0, Z_GDW_T0,               &
  & Z_GWHT_T0, PGFL, YDCPG_TND%ZVIEW, ZP1FORC)
ELSEIF (LNHEE) THEN
  ! * NHEE model:
...
ELSE
  ...
  & LLUVH, LLGPXX, YDCPG_OPTS%LDIAB, LMPA, YDVARS%GEOMETRY%OROG%T0, Z_OROGLL_T0, Z_OROGMM_T0, Z_OROGLM_T0,                 &
