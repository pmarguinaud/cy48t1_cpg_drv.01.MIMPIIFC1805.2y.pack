...
#else
REAL(KIND=JPRB), POINTER, CONTIGUOUS :: ZPRE9L(:)
REAL(KIND=JPRB), POINTER, CONTIGUOUS :: ZPRE9M(:)
REAL(KIND=JPRB), POINTER, CONTIGUOUS :: ZGDW0(:,:)
REAL(KIND=JPRB), POINTER, CONTIGUOUS :: ZGDW9(:,:)
REAL(KIND=JPRB), POINTER, CONTIGUOUS :: ZGWHT0(:,:)
REAL(KIND=JPRB), POINTER, CONTIGUOUS :: ZGWHT9(:,:)
REAL(KIND=JPRB), POINTER, CONTIGUOUS :: ZOROGLL(:)
REAL(KIND=JPRB), POINTER, CONTIGUOUS :: ZOROGMM(:)
REAL(KIND=JPRB), POINTER, CONTIGUOUS :: ZOROGLM(:)
#endif
...
ZPRE9L         => YDCPG_DYN9%PREL       
ZPRE9M         => YDCPG_DYN9%PREM       
ZGDW0          => YDCPG_DYN0%GDW        
ZGDW9          => YDCPG_DYN9%GDW        
ZGWHT0(1:,0:)  => YDCPG_DYN0%GWHT
ZGWHT9(1:,0:)  => YDCPG_DYN9%GWHT
ZOROGLL        => YDCPG_DYN0%OROGLL      
ZOROGMM        => YDCPG_DYN0%OROGMM      
ZOROGLM        => YDCPG_DYN0%OROGLM      
...
CALL GPINISLB(&
 ...
 & PGWFT0=YDCPG_DYN0%GWFT,PGDW0=ZGDW0,PGWS0=ZGWHT0(:,NFLEVG))
