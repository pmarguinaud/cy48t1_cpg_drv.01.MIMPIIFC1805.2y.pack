...
SUBROUTINE CPG_GP(YDGEOMETRY,YDCPG_DYN0,YDCPG_DYN9,YDMF_PHYS_SURF,YDVARS,YDMODEL,YDFIELDS,&
 ...
 ! - OUTPUT .
 & POROGL,POROGM,&
 & PRE0,PRE0L,PRE0M,PRE0F,PNHPRE0F,PNHPRE0H,PUVH0,&
 & PHI0,PHIF0,PHI0FL,PHI0FM,&
 & PRCP0,PCTY0,PGWFT0,PKENE0,PRT0L,PRT0M,&
 & PRE9,PRE9F,PNHPRE9F,PNHPRE9H,&
...
IF (LNHQE) THEN
  ...
  CALL CPG_GP_NHQE(YDGEOMETRY,YDCPG_DYN0,YDCPG_DYN9,YDMODEL,YDFIELDS%YRGMV,&
   !---------------------------------------------------------------------
   ! - INPUT .
...
ELSE
  ...
  CALL CPG_GP_HYD(YDGEOMETRY,YDCPG_DYN0,YDCPG_DYN9,YDMODEL,YDFIELDS%YRGMV,&
   !---------------------------------------------------------------------
   ! - INPUT .
