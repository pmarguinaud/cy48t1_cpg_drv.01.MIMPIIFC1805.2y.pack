...
@PROCESS NOCHECK
#endif
SUBROUTINE CPG_GP(YDGEOMETRY,YDCPG_DIM,YDTMP,YDCPG_TND,YDCPG_MISC,&
...
IF (LNHQE) THEN
  ...
  CALL CPG_GP_NHQE(YDGEOMETRY,YDCPG_DIM,YDTMP,YDVARS,YDCPG_DYN0,YDCPG_DYN9,YDMODEL,YDFIELDS%YRGMV,&
   !---------------------------------------------------------------------
   ! - INPUT .
   & LLGPXX,LDLDIAB,LMPA,&
   & YDOROG%OROG,&
...
ELSEIF (LNHEE) THEN
  ...
  CALL CPG_GP_NHEE(YDGEOMETRY,YDCPG_DIM,YDTMP,YDVARS,YDCPG_DYN0,YDCPG_DYN9,YDMODEL,YDFIELDS%YRGMV,&
   !---------------------------------------------------------------------
   ! - INPUT .
   & LLGPXX,LDLDIAB,LMPA,&
   & YDOROG%OROG,&
