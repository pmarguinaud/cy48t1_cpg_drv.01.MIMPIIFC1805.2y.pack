...
IF(NCURRENT_ITER == 0) THEN
  CALL GPTF2(YDGEOMETRY,YDFIELDS%YRGMV,&
   ...
   & P0TM=YDVARS%T%DM, P0U=YDVARS%U%T0, P0V=YDVARS%V%T0, P9DIV=YDVARS%DIV%T9, P9NHX=YDVARS%NHX%T9,  &
   & P9SPD=YDVARS%SPD%T9, P9SPDL=YDVARS%SPD%DL9, P9SPDM=YDVARS%SPD%DM9, P9SVD=YDVARS%SVD%T9,  &
   & P9SVDL=YDVARS%SVD%DL9, P9SVDM=YDVARS%SVD%DM9, P9T=YDVARS%T%T9, P9TL=YDVARS%T%DL9, &
   & P9TM=YDVARS%T%DM9, P9U=YDVARS%U%T9, P9V=YDVARS%V%T9)
ENDIF
