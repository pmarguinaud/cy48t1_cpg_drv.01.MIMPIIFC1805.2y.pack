...
& YDGMV, LDUVH, LDGW, LDLDIAB, LDMPA, POROG, P_OROGLL_T0, P_OROGMM_T0, P_OROGLM_T0, P_GDW_T0,      &
...
& YDCPG_BNDS%KFDIA, YDVARS%GEOMETRY%RCORI%T0, YDVARS%GEOMETRY%GNORDL%T0, YDVARS%GEOMETRY%GNORDM%T0, Z_PSGRTL_T0, &
& Z_PSGRTM_T0, YDVARS%U%T0, YDVARS%V%T0, PATND(1, 1, YYTTND%M_TNDU), PATND(1, 1, YYTTND%M_TNDV),                 &
