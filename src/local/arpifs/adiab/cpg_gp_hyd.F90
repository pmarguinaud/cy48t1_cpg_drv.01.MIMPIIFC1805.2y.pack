...
@PROCESS NOCHECK
#endif
SUBROUTINE CPG_GP_HYD(YDGEOMETRY,YDCPG_BNDS, YDCPG_OPTS,YDTMP,YDVARS,YDCPG_DYN0,YDCPG_DYN9,YDMODEL,YDGMV,&
 !---------------------------------------------------------------------
 ! - INPUT .
...
ASSOCIATE(YDDIM=>YDGEOMETRY%YRDIM,YDDIMV=>YDGEOMETRY%YRDIMV, &
 & YDGSGEOM=>YDGEOMETRY%YRGSGEOM(YDCPG_BNDS%KBL), &
...
IF (LDGW) THEN
  LLDER=.FALSE.
  CALL GPUVS(NFLEVG,NPROMA,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,LLDER,YDVARS%U%T0,YDVARS%V%T0,YDTMP%T0%US,YDTMP%T0%VS)
ENDIF

!*     3.1.12 COMPUTES THE PRESSURE FORCE FOR THE RHS OF MOMENTUM EQN.

CALL GPGRP(YDGEOMETRY,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,&
