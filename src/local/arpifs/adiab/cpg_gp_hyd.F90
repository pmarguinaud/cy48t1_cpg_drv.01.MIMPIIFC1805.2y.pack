...
USE YOMCT0   , ONLY : LTWOTL, LSPRT, LSFORC, LRPLANE, LNHDYN
...
CALL CPG_GP_HYD_T9 (YDGEOMETRY, YDCPG_BNDS, YDCPG_OPTS, YDVARS, YDCPG_DYN0, YDMODEL, LDGW, L_RDRY_VD, Z_GPHL_T0, Z_GPHM_T0, &
