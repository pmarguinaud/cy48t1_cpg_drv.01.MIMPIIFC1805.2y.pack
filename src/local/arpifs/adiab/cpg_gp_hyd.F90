...
& YDCPG_DYN0%PHIF, YDVARS%T%T0, YDCPG_DYN0%RCP%R, YDCPG_DYN0%XYB%LNPR, YDCPG_DYN0%XYB%ALPH, YDGEOMETRY%YRVERT_GEOM&
& )
...
CALL GPGRP_EXPL(YDCPG_OPTS%LVERTFE, YDGEOMETRY, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, Z_RT_T0, YDCPG_DYN0%RTL,   &
& YDCPG_DYN0%RTM, YDCPG_DYN0%PREL, YDCPG_DYN0%PREM, YDCPG_DYN0%XYB%RTGR, YDCPG_DYN0%XYB%ALPH, PHIHL=Z_GPHL_T0, &
& PHIHM=Z_GPHM_T0, PHIFL=YDCPG_DYN0%PHIFL, PHIFM=YDCPG_DYN0%PHIFM, PSGRTL=Z_PSGRTL_T0, PSGRTM=Z_PSGRTM_T0,     &
...
IF (LDGW) THEN
  ...
  & YDVARS%V%T0, YDCPG_DYN0%UVH%UH, YDCPG_DYN0%UVH%VH, Z_NHXT_T0)
...
! Caution: must use consistent definitions of RT in ZRDT0 and ZDVER0.
  ...
  & Z_US_T0, Z_VS_T0, Z_RDT_T0, Z_DVER_T0, P_GWHT_T0, YDCPG_DYN0%GWFT)
ENDIF
...
CALL CPG_GP_HYD_T9 (YDGEOMETRY, YDCPG_BNDS, YDCPG_OPTS, YDVARS, YDCPG_DYN0, YDMODEL, LDGW, YDMODEL%YRML_DYN%YRDYNA%L_RDRY_VD, &
& Z_GPHL_T0, Z_GPHM_T0, YDCPG_DYN9, LDLDIAB, LDMPA)
