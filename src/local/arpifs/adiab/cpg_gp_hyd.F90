    ...
    DO JLEV=1,NFLEVG
      DO JROF=KST,KEND
        ZDVER0(JROF,JLEV)=-(PRCP0(JROF,JLEV,YYTRCP0%M_R)/RD)*(ZT0DIV(JROF,JLEV)&
         & +ZNHXT0(JROF,JLEV)+(1.0_JPRB-PRCP0(JROF,JLEV,YYTRCP0%M_KAP))*PCTY0(JROF,JLEV,YYTCTY0%M_VVEL))
      ENDDO
    ENDDO
  ELSE
      ...
      DO JLEV=1,NFLEVG
        DO JROF=KST,KEND
          ZDVER9(JROF,JLEV)=-(PRCP0(JROF,JLEV,YYTRCP0%M_R)/RD)*(ZT9DIV(JROF,JLEV)&
           & +ZNHXT9(JROF,JLEV)+(1.0_JPRB-PRCP0(JROF,JLEV,YYTRCP0%M_KAP))*PCTY0(JROF,JLEV,YYTCTY0%M_VVEL))
        ENDDO
      ENDDO
    ELSE
      ! dver_hyd=-(D+X+(cv/cp)(omega/prehyd))
