...
USE YOMDYNA  , ONLY : LGRADSP, LRUBC, L_RDRY_VD, LAPRXPK, NDLNPR, RHYDR0
...
CALL GPGRP_EXPL(LVERTFE, YDGEOMETRY, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, Z_RT_T0, YDCPG_DYN0%RTL, YDCPG_DYN0%RTM, YDCPG_DYN0%PREL,           &
