...
& YDGMV, LDUVH, LDGW, LDLDIAB, LDMPA, POROG, Z_OROGLL_T0, Z_OROGMM_T0, Z_OROGLM_T0, Z_GDW_T0,      &
& Z_GWHT_T0, PGFL, PATND)
...
CALL GPGRP(YDGEOMETRY, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, Z_RT_T0, YDCPG_DYN0%RTL, YDCPG_DYN0%RTM, YDCPG_DYN0%PREL,                &
