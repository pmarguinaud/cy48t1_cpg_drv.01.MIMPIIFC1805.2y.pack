...
IF(LDLDIAB.OR.YDMODEL%YRML_PHY_MF%YRSIMPHL%LSIMPH) THEN
  ...
  & YDCPG_DYN9%PHI, YDCPG_DYN9%PHIF, YDVARS%T%T9, YDCPG_DYN9%RCP%R, YDCPG_DYN9%XYB%LNPR, YDCPG_DYN9%XYB%ALPH,                &
...
! caution: must use "R" at time t.
  ...
  & Z_R0T_T9, YDVARS%U%T9, YDVARS%V%T9, Z_UVH_UH_T9, Z_UVH_VH_T9, Z_NHXT_T9)
