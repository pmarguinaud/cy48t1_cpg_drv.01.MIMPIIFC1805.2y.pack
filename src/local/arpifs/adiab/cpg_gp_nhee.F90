...
DO JLEV=1,NFLEVG
  ZRRED0(KST:KEND,JLEV)=PRCP0(KST:KEND,JLEV,YYTRCP0%M_R)/ZNHPPI0(KST:KEND,JLEV)
...
CALL GNHD3(NFLEVG,NPROMA,KST,KEND,&
 & ZT0DIV,ZNHXS,ZDVER0,PRCP0(1,1,YYTRCP0%M_R),RMAX_D3,LBOUND_D3,Z3DIVG)
...
CALL GNH_TNDLAGADIAB_SPD(YDGEOMETRY,NFLEVG,NPROMA,KST,KEND,&
 & PRCP0(1,1,YYTRCP0%M_KAP),Z3DIVG,PCTY0(1,1,YYTCTY0%M_VVEL),&
...
DO JLEV=1,NFLEVG
  DO JROF=KST,KEND
    ZRCV=1.0_JPRB/(1.0_JPRB-PRCP0(JROF,JLEV,YYTRCP0%M_KAP))-1.0_JPRB
...
!*     3.2.6 COMPUTE QUANTITIES FOR NHEE MODEL.
  ...
  DO JLEV=1,NFLEVG
    ZRRED9(KST:KEND,JLEV)=PRCP9(KST:KEND,JLEV,YYTRCP9%M_R)/ZNHPPI9(KST:KEND,JLEV)
  ENDDO
