...
CALL GNHD3(YDMODEL%YRCST, NFLEVG, NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDVARS%DIV%T0, Z_NHXS_T0, Z_DVER_T0, YDCPG_DYN0%RCP%R, &
...
IF (LNHEE_REFINE_PREH_BBC) THEN
  ...
  CALL GNHEE_REFINE_PREH(YDMODEL%YRCST, YDGEOMETRY, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_DYN0%OROGL, YDCPG_DYN0%OROGM, &
...
IF (LNHEE_SVDLAPL_FIRST) THEN
  ...
  IF (LGWADV) THEN
    ...
    CALL GNHEE_TNDLAGADIAB_GW(YDMODEL%YRCST, YDGEOMETRY, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_DYN0%OROGL, YDCPG_DYN0%OROGM, &
...
ELSE
  ...
  IF (LGWADV.AND.LVFE_GW) THEN
    CALL GNH_TNDLAGADIAB_GW(YDMODEL%YRCST, YDGEOMETRY, NFLEVG, NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, PDELP=YDCPG_DYN0%XYB%DELP, &
    ...
    ENDDO
  ELSEIF (LGWADV) THEN
    CALL GNH_TNDLAGADIAB_GW(YDMODEL%YRCST, YDGEOMETRY, NFLEVG, NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, PDEP=Z_PDEP_T0, &
  ...
  ELSE IF (LVFE_GW) THEN
    CALL GNH_TNDLAGADIAB_GW(YDMODEL%YRCST, YDGEOMETRY, NFLEVG, NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, POROGL=YDCPG_DYN0%OROGL, &
...
IF (.NOT.LGWADV) THEN
  ...
  IF (LNHEE_SVDLAPL_FIRST) THEN
    ...
    CALL GNHEE_TNDLAGADIAB_SVD(YDMODEL%YRCST, YDGEOMETRY, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_DYN0%OROGL, YDCPG_DYN0%OROGM,  &
  ...
  ELSE
    ...
    !   Dataflow may be tricky, and not always convenient to test future variable changes.
    CALL GNH_TNDLAGADIAB_SVD(YDMODEL%YRCST, YDGEOMETRY, NFLEVG, NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDVARS%U%T0, &
