...
CALL GNHPREH(YDGEOMETRY,NPROMA,NFLEVG,KST,KEND,ZT0SPD,PRE0,&
 & PXYB0(1,1,YYTXYB0%M_DELP),PXYB0(1,1,YYTXYB0%M_LNPR),ZNHPPI0,PNHPRE0F,PNHPRE0H,ZDELNHPRE0)
CALL GNHGRPRE(YDGEOMETRY,NPROMA,NFLEVG,KST,KEND,PXYB0(1,1,YYTXYB0%M_RTGR),PRE0L,PRE0M,&
...
CALL GPGEO(NPROMA,KST,KEND,NFLEVG,PHI0,PHIF0,ZT0T,&
 & ZRRED0,PXYB0(1,1,YYTXYB0%M_LNPR),PXYB0(1,1,YYTXYB0%M_ALPH),&
...
CALL GPHLWI(YDGEOMETRY%YRDIMV,NPROMA,KST,KEND,PXYB0(1,1,YYTXYB0%M_LNPR),&
 & PXYB0(1,1,YYTXYB0%M_ALPH),PUVH0(1,1,YYTHW0%M_WWI),LDVERINT=LVEREGINT)
...
IF (LNHEE_REFINE_GRP) THEN
  CALL GPFLWI(YDGEOMETRY%YRDIMV,NPROMA,KST,KEND, &
   & PXYB0(1,1,YYTXYB0%M_LNPR),PXYB0(1,1,YYTXYB0%M_ALPH),PRE0,&
   & PRE0F,PXYB0(1,1,YYTXYB0%M_DELP),ZWH2F,LDVERINT=LVEREGINT)
...
IF (LDGPXX) THEN
  ...
  ELSEIF (NVDVAR == 5) THEN
    ...
    CALL GNHEE_SVDINCR13(YDGEOMETRY,NFLEVG,NPROMA,KST,KEND,POROGL,POROGM,&
     ...
     & PLNPR=PXYB0(1,1,YYTXYB0%M_LNPR),PRT=ZRDT0,PNHPPI=ZNHPPI0,&
...
ELSEIF (NVDVAR==5) THEN
  ...
  LLGDWI=.FALSE.
  CALL GPGW(YDGEOMETRY,NFLEVG,NPROMA,KST,KEND,LLGWF0,LLGDWI,&
   & ZZERO,ZZERO,PXYB0(1,1,YYTXYB0%M_LNPR),PXYB0(1,1,YYTXYB0%M_ALPH),ZZERO,ZZERO,&
...
IF (.NOT.LGWADV) THEN
  IF (L_RDRY_VD) THEN
    ...
    DO JLEV=1,NFLEVG
      DO JROF=KST,KEND
        PRDPHI(JROF,JLEV)=1.0_JPRB/(PXYB0(JROF,JLEV,YYTXYB0%M_LNPR)*ZRTR0(JROF,JLEV))
      ENDDO
    ENDDO
  ELSE
...
IF (LNHEE_SVDLAPL_FIRST) THEN
  ...
  IF (LGWADV) THEN
    ...
    CALL GNHEE_TNDLAGADIAB_GW(YDGEOMETRY,KST,KEND,&
     ...
     & PXYB0(1,1,YYTXYB0%M_LNPR),PXYB0(1,1,YYTXYB0%M_ALPH),PRE0F,PRE0,ZPDEP0,&
...
ELSE
  ...
  IF (LGWADV.AND.LVFE_GW) THEN
    CALL GNH_TNDLAGADIAB_GW(YDGEOMETRY,NFLEVG,NPROMA,KST,KEND,&
     & PDELP=PXYB0(1,1,YYTXYB0%M_DELP),PDELNHPRE=ZDELNHPRE0,&
...
IF (.NOT.LGWADV) THEN
  ...
  IF (LNHEE_SVDLAPL_FIRST) THEN
    ...
    CALL GNHEE_TNDLAGADIAB_SVD(YDGEOMETRY,KST,KEND,&
     & POROGL,POROGM,POROGLM,POROGLL,POROGMM,&
     & PCTY0(1,0,YYTCTY0%M_EVEL),PXYB0(1,1,YYTXYB0%M_RDELP),&
     & PXYB0(1,1,YYTXYB0%M_LNPR),PXYB0(1,1,YYTXYB0%M_ALPH),PRE0F,PRE0,ZPDEP0,&
     & ZT0U,ZT0V,PUVH0(1,0,YYTHW0%M_UH),PUVH0(1,0,YYTHW0%M_VH),&
  ...
  ELSE
    ...
    CALL GNH_TNDLAGADIAB_SVD(YDGEOMETRY,NFLEVG,NPROMA,KST,KEND,&
     ...
     & ZPDEP0,PRE0,PRE0F,PXYB0(1,1,YYTXYB0%M_DELP),PXYB0(1,1,YYTXYB0%M_LNPR),&
...
!*     3.2.6 COMPUTE QUANTITIES FOR NHEE MODEL.
  ...
  CALL GNHPREH(YDGEOMETRY,NPROMA,NFLEVG,KST,KEND,ZT9SPD,PRE9,&
   & PXYB9(1,1,YYTXYB9%M_DELP),PXYB9(1,1,YYTXYB9%M_LNPR),ZNHPPI9,PNHPRE9F,PNHPRE9H,ZDELNHPRE9)
...
!*     3.2.8 COMPUTES THE GEOPOTENTIAL HEIGHT "gz" AND ITS GRADIENT.
  ...
  IF (LDLDIAB.OR.LSIMPH) THEN
    ...
    CALL GPGEO(NPROMA,KST,KEND,NFLEVG,PHI9,PHIF9,ZT9T,&
     & ZRRED9,PXYB9(1,1,YYTXYB9%M_LNPR),PXYB9(1,1,YYTXYB9%M_ALPH),&
     & YDGEOMETRY%YRVERT_GEOM)
  ENDIF
  ...
  IF (LDGPXX) THEN
    ...
    ELSEIF (NVDVAR == 5) THEN
      ...
      CALL GNHEE_SVDINCR13(YDGEOMETRY,NFLEVG,NPROMA,KST,KEND,POROGL,POROGM,&
       ...
       & PLNPR=PXYB9(1,1,YYTXYB9%M_LNPR),PRT=ZRDT9,PNHPPI=ZNHPPI9,&
       & PSVDINCR13=ZSVDINCR13)
...
!*     3.2.16 COMPUTES term [gw] or [gW].
  ...
  ELSEIF (NVDVAR==5) THEN
    ...
    LLGDWI=.FALSE.
    CALL GPGW(YDGEOMETRY,NFLEVG,NPROMA,KST,KEND,LDMPA,LLGDWI,&
     & ZZERO,ZZERO,PXYB9(1,1,YYTXYB9%M_LNPR),PXYB9(1,1,YYTXYB9%M_ALPH),ZZERO,ZZERO,&
