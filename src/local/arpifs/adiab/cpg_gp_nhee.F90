...
IF (.NOT.YDCPG_OPTS%LGWADV) THEN
  ...
  IF (YDCPG_OPTS%LNHEE_SVDLAPL_FIRST) THEN
    ...
    CALL GNHEE_TNDLAGADIAB_SVD(YDCPG_OPTS%LVFE_LAPL_BC, YDCPG_OPTS%LVERTFE, YDCPG_OPTS%NVDVAR, YDMODEL%YRCST, YDGEOMETRY, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_DYN0%OROGL, YDCPG_DYN0%OROGM,  &
