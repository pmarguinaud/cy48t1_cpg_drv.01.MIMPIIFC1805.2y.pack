...
CALL GPHLWI(YDGEOMETRY%YRDIMV,NPROMA,KST,KEND,YDCPG_DYN0%XYB%LNPR,&
 & YDCPG_DYN0%XYB%ALPH,PWW0=PUVH0(:,:,YYTHW0%M_WWI),LDVERINT=LVEREGINT)
CALL GPHLUV(YDGEOMETRY%YRDIMV,NPROMA,KST,KEND,ZT0U,ZT0V,&
          & PWWI=PUVH0(:,:,YYTHW0%M_WWI),PUH=PUVH0(:,:,YYTHW0%M_UH),PVH=PUVH0(:,:,YYTHW0%M_VH))
...
IF (LDGPXX) THEN
  CALL GPXX(YDGEOMETRY,NFLEVG,NPROMA,KST,KEND,ZGPHL,ZGPHM,PHI0FL,PHI0FM,&
   ...
   & ZT0U,ZT0V,PUVH0(:,:,YYTHW0%M_UH),PUVH0(:,:,YYTHW0%M_VH),&
  ...
  ELSEIF (NVDVAR == 5) THEN
    ...
    CALL GNHEE_SVDINCR13(YDGEOMETRY,NFLEVG,NPROMA,KST,KEND,POROGL,POROGM,&
     & PUVH0(:,:,YYTHW0%M_UH),PUVH0(:,:,YYTHW0%M_VH),&
