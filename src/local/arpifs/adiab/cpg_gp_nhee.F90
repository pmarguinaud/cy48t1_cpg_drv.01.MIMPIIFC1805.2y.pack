...
YDTMP%T0%ZERO(KST:KEND)=0.0_JPRB
...
IF (L_RDRY_VD) THEN
  ...
  YDTMP%T0%RDTL(KST:KEND,1:NFLEVG)=RD*YDVARS%T%DL(KST:KEND,1:NFLEVG)
  YDTMP%T0%RDTM(KST:KEND,1:NFLEVG)=RD*YDVARS%T%DM(KST:KEND,1:NFLEVG)
ELSE
  YDTMP%T0%RDT(KST:KEND,1:NFLEVG)=YDTMP%T0%RT(KST:KEND,1:NFLEVG)
  YDTMP%T0%RDTL(KST:KEND,1:NFLEVG)=YDCPG_DYN0%RTL(KST:KEND,1:NFLEVG)
  YDTMP%T0%RDTM(KST:KEND,1:NFLEVG)=YDCPG_DYN0%RTM(KST:KEND,1:NFLEVG)
ENDIF
...
DO JLEV=1,NFLEVG
  YDTMP%T0%RRED(KST:KEND,JLEV)=YDCPG_DYN0%RCP%R(KST:KEND,JLEV)/YDTMP%T0%NHPPI(KST:KEND,JLEV)
  YDTMP%T0%RTR(KST:KEND,JLEV)=YDTMP%T0%RRED(KST:KEND,JLEV)*YDVARS%T%T0(KST:KEND,JLEV)
ENDDO
...
ELSE
  CALL GNHEE_GRP(YDGEOMETRY,KST,KEND,&
   & YDTMP%T0%RT,YDCPG_DYN0%RTL,YDCPG_DYN0%RTM,YDCPG_DYN0%PREL,YDCPG_DYN0%PREM,YDCPG_DYN0%XYB%RDELP,YDCPG_DYN0%XYB%RTGR,YDCPG_DYN0%XYB%ALPH,YDTMP%T0%XYBDER%ZVIEW,&
...
IF (LDGPXX) THEN
  ...
  IF (NVDVAR == 3 .OR. NVDVAR == 4) THEN
    ! NHX = NHX_S
    YDCPG_DYN0%NHX(KST:KEND,1:NFLEVG)=YDTMP%T0%NHXS(KST:KEND,1:NFLEVG)
  ELSEIF (NVDVAR == 5) THEN
    ...
    YDCPG_DYN0%NHX(KST:KEND,1:NFLEVG)=YDTMP%T0%NHXS(KST:KEND,1:NFLEVG)-YDTMP%T0%SVDINCR13(KST:KEND,1:NFLEVG)
  ENDIF
ELSE
  ...
  IF (NVDVAR == 4) THEN
    ...
    ! NHX_S
    YDTMP%T0%NHXS(KST:KEND,1:NFLEVG) =YDVARS%NHX%T0(KST:KEND,1:NFLEVG)
  ELSEIF (NVDVAR == 5) THEN
    YDCPG_DYN0%NHX(KST:KEND,1:NFLEVG)=YDVARS%NHX%T0(KST:KEND,1:NFLEVG)
    ! NHX_S = NHX + (d13 - dver)
    CALL GNHEE_SVDINCR13(YDGEOMETRY,NFLEVG,NPROMA,KST,KEND,YDCPG_DYN0%OROGL,YDCPG_DYN0%OROGM,&
     ...
     & PLNPR=YDCPG_DYN0%XYB%LNPR,PRT=YDTMP%T0%RDT,PNHPPI=YDTMP%T0%NHPPI,&
     & PSVDINCR13=YDTMP%T0%SVDINCR13)
    YDTMP%T0%NHXS(KST:KEND,1:NFLEVG)=YDVARS%NHX%T0(KST:KEND,1:NFLEVG)+YDTMP%T0%SVDINCR13(KST:KEND,1:NFLEVG)
  ENDIF
ENDIF
...
IF (NVDVAR == 3) THEN
  YDTMP%T0%DVER(KST:KEND,1:NFLEVG)=YDVARS%SVD%T0(KST:KEND,1:NFLEVG)
  YDTMP%T0%DVERL(KST:KEND,1:NFLEVG)=YDVARS%SVD%DL(KST:KEND,1:NFLEVG)
  YDTMP%T0%DVERM(KST:KEND,1:NFLEVG)=YDVARS%SVD%DM(KST:KEND,1:NFLEVG)
ELSEIF (NVDVAR == 4) THEN
  YDTMP%T0%DVER(KST:KEND,1:NFLEVG)=YDVARS%SVD%T0(KST:KEND,1:NFLEVG)-YDCPG_DYN0%NHX(KST:KEND,1:NFLEVG)
  YDTMP%T0%DVERL(KST:KEND,1:NFLEVG)=YDVARS%SVD%DL(KST:KEND,1:NFLEVG)-YDVARS%NHX%DL(KST:KEND,1:NFLEVG)
  YDTMP%T0%DVERM(KST:KEND,1:NFLEVG)=YDVARS%SVD%DM(KST:KEND,1:NFLEVG)-YDVARS%NHX%DM(KST:KEND,1:NFLEVG)
ELSEIF (NVDVAR == 5) THEN
  ! d13 in ZDVERW0
  YDTMP%T0%DVERW(KST:KEND,1:NFLEVG)=YDVARS%SVD%T0(KST:KEND,1:NFLEVG)-YDCPG_DYN0%NHX(KST:KEND,1:NFLEVG)
  ! dver in ZDVER0: dver = d13 - (d13 - dver)
  CALL GNHEE_SVDINCR13(YDGEOMETRY,NFLEVG,NPROMA,KST,KEND,YDCPG_DYN0%OROGL,YDCPG_DYN0%OROGM,&
   & YDCPG_DYN0%UVH%UH,YDCPG_DYN0%UVH%VH,&
   & PLNPR=YDCPG_DYN0%XYB%LNPR,PRT=YDTMP%T0%RDT,PNHPPI=YDTMP%T0%NHPPI,&
   & PSVDINCR13=YDTMP%T0%SVDINCR13)
  YDTMP%T0%DVER(KST:KEND,1:NFLEVG)=YDTMP%T0%DVERW(KST:KEND,1:NFLEVG)-YDTMP%T0%SVDINCR13(KST:KEND,1:NFLEVG)
...
ELSEIF (NVDVAR==5) THEN
  ...
  CALL GNHGRGW(YDGEOMETRY,NPROMA,NFLEVG,KST,KEND,LLDER,&
   ...
   & YDCPG_DYN0%XYB%LNPR,YDCPG_DYN0%XYB%ALPH,YDTMP%T0%XYBDER%ZVIEW,&
   & YDTMP%T0%ZERO,YDTMP%T0%ZERO,YDTMP%T0%ZERO,YDTMP%T0%ZERO,YDTMP%T0%ZERO,YDTMP%T0%ZERO,&
   & YDTMP%T0%ZERO,YDTMP%T0%ZERO,YDTMP%T0%ZERO,YDTMP%T0%ZERO,YDTMP%T0%ZERO,&
   & YDCPG_DYN0%GWFL,YDCPG_DYN0%GWFM,YDTMP%T0%GWHL,YDTMP%T0%GWHM,&
   & LDNHEE=.TRUE.,PRNHPPI=YDTMP%T0%RNHPPI,PQCHAL=YDCPG_DYN0%QCHAL,PQCHAM=YDCPG_DYN0%QCHAM)
ENDIF
...
!*     3.2.6 COMPUTE QUANTITIES FOR NHEE MODEL.
  ...
  DO JLEV=1,NFLEVG
    YDTMP%T9%RRED(KST:KEND,JLEV)=YDCPG_DYN9%RCP%R(KST:KEND,JLEV)/YDTMP%T9%NHPPI(KST:KEND,JLEV)
  ENDDO
...
!*     3.2.13a COMPUTES TERM "NHX".
  ...
  IF (LDGPXX) THEN
    ...
    IF (NVDVAR == 3 .OR. NVDVAR == 4) THEN
      ! NHX = NHX_S
      YDCPG_DYN9%NHX(KST:KEND,1:NFLEVG)=YDTMP%T0%NHXS(KST:KEND,1:NFLEVG)
    ELSEIF (NVDVAR == 5) THEN
      ! NHX = NHX_S - (d13 - dver)
      CALL GNHEE_SVDINCR13(YDGEOMETRY,NFLEVG,NPROMA,KST,KEND,YDCPG_DYN0%OROGL,YDCPG_DYN0%OROGM,&
       & YDTMP%T9%UVH%ZVIEW(:,:,YYTHW9%M_UH),YDTMP%T9%UVH%ZVIEW(:,:,YYTHW9%M_VH),&
       & PLNPR=YDCPG_DYN9%XYB%LNPR,PRT=YDTMP%T9%RDT,PNHPPI=YDTMP%T9%NHPPI,&
       & PSVDINCR13=YDTMP%T0%SVDINCR13)
      YDCPG_DYN9%NHX(KST:KEND,1:NFLEVG)=YDTMP%T0%NHXS(KST:KEND,1:NFLEVG)-YDTMP%T0%SVDINCR13(KST:KEND,1:NFLEVG)
    ENDIF
  ELSE
    ! This case only occurs for a subset of NVDVAR= 4 or 5 cases
  ...
  IF (NVDVAR == 5 .AND. LGWADV) THEN
    CALL GPYY(YDGEOMETRY,NFLEVG,NPROMA,KST,KEND,YDCPG_DYN0%OROGL,YDCPG_DYN0%OROGM,&
     & YDTMP%T9%UVH%ZVIEW(:,:,YYTHW9%M_UH),YDTMP%T9%UVH%ZVIEW(:,:,YYTHW9%M_VH),YDCPG_DYN9%NHY)
  ELSE
...
!*     3.2.14 COMPUTES dver.
  ...
  IF (NVDVAR == 3) THEN
    YDTMP%T9%DVER(KST:KEND,1:NFLEVG)=YDVARS%SVD%T9(KST:KEND,1:NFLEVG)
  ELSEIF (NVDVAR == 4) THEN
    YDTMP%T9%DVER(KST:KEND,1:NFLEVG)=YDVARS%SVD%T9(KST:KEND,1:NFLEVG)-YDCPG_DYN9%NHX(KST:KEND,1:NFLEVG)
  ELSEIF (NVDVAR == 5) THEN
    ! d13 in ZDVERW9
    YDTMP%T9%DVERW(KST:KEND,1:NFLEVG)=YDVARS%SVD%T9(KST:KEND,1:NFLEVG)-YDCPG_DYN9%NHX(KST:KEND,1:NFLEVG)
    ! dver in ZDVER9
    CALL GNHEE_SVDINCR13(YDGEOMETRY,NFLEVG,NPROMA,KST,KEND,YDCPG_DYN0%OROGL,YDCPG_DYN0%OROGM,&
     & YDTMP%T9%UVH%ZVIEW(:,:,YYTHW9%M_UH),YDTMP%T9%UVH%ZVIEW(:,:,YYTHW9%M_VH),&
     & PLNPR=YDCPG_DYN9%XYB%LNPR,PRT=YDTMP%T9%RDT,PNHPPI=YDTMP%T9%NHPPI,&
     & PSVDINCR13=YDTMP%T0%SVDINCR13)
    YDTMP%T9%DVER(KST:KEND,1:NFLEVG)=YDTMP%T9%DVERW(KST:KEND,1:NFLEVG)-YDTMP%T0%SVDINCR13(KST:KEND,1:NFLEVG)
  ENDIF
