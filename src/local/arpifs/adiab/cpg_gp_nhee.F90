...
@PROCESS NOCHECK
#endif
SUBROUTINE CPG_GP_NHEE(YDGEOMETRY, YDCPG_BNDS, YDCPG_OPTS, YDVARS, YDCPG_DYN0, YDCPG_DYN9, &
& YDMODEL, YDGMV, LDGPXX, LDLDIAB, LDMPA, POROG, Z_OROGLL_T0, Z_OROGMM_T0, Z_OROGLM_T0, Z_GDW_T0, Z_GWHT_T0, PGFL, PATND)
...
& YDCPG_DYN0%XYB%DELP, YDCPG_DYN0%XYB%LNPR, Z_NHPPI_T0, YDCPG_DYN0%NHPREF, YDCPG_DYN0%NHPREH, Z_DELNHPRE_T0&
& )
...
& PHIFL=YDCPG_DYN0%PHIFL, PHIFM=YDCPG_DYN0%PHIFM, PHIHL=Z_GPHL_T0, PHIHM=Z_GPHM_T0, LDNHEE=.TRUE.,     &
& PRNHPPI=Z_RNHPPI_T0, PQCHAL=YDCPG_DYN0%QCHAL, PQCHAM=YDCPG_DYN0%QCHAM, PLNPRL_DER=Z_XYBDER_LNPRL_T0, &
...
& Z_VS_T0, PDIVF=YDVARS%DIV%T0, PVORF=YDVARS%VOR%T0, PUFL=YDVARS%U%DL, PVFL=YDVARS%V%DL, PUS_L=Z_US_L_T0, &
...
IF (LNHEE_REFINE_GRP) THEN
  ...
  CALL GNHEE_REFINE_GRP(YDGEOMETRY, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, Z_RT_T0, YDCPG_DYN0%RTL,                     &
  & YDCPG_DYN0%RTM, YDCPG_DYN0%PREL, YDCPG_DYN0%PREM, YDCPG_DYN0%XYB%RTGR, YDCPG_DYN0%XYB%ALPH, PRNHPPI=Z_RNHPPI_T0, &
...
ELSE
  CALL GNHEE_GRP(YDGEOMETRY, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, Z_RT_T0, YDCPG_DYN0%RTL, YDCPG_DYN0%RTM,           &
...
IF (LDGPXX) THEN
  ...
  & YDCPG_DYN0%UVH%VH, Z_NHXS_T0, PNHPPI=Z_NHPPI_T0)
...
IF (NVDVAR==3 .OR. NVDVAR==4) THEN
  ...
  IF (LGWADV.AND.LVFE_GW) THEN
    ...
    & Z_DVER_T0, Z_GWHT_T0, YDCPG_DYN0%GWFT, PRNHPPI=Z_RNHPPI_T0, PGDW=Z_GDW_T0)

    YDCPG_DYN0%GWT(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDCPG_DYN0%GWFT(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
  ELSE
    CALL GPGW(YDGEOMETRY, NFLEVG, NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, LLGWF0, LLGDWI, YDCPG_DYN0%OROGL, &
    & YDCPG_DYN0%OROGM, YDCPG_DYN0%XYB%LNPR, YDCPG_DYN0%XYB%ALPH, Z_US_T0, Z_VS_T0, Z_RDT_T0,       &
    & Z_DVER_T0, Z_GWHT_T0, YDCPG_DYN0%GWFT, PRNHPPI=Z_RNHPPI_T0)

    IF (LGWADV) YDCPG_DYN0%GWT(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=Z_GWHT_T0(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,0:NFLEVG-1)
  ENDIF

  IF (LTWOTL.AND.LRDBBC) THEN
    ! PGWS contains (gw)_surf
    YDCPG_DYN0%GWS(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA)=Z_GWHT_T0(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,NFLEVG)
  ENDIF
ELSEIF (NVDVAR==5) THEN
  ...
  LLGWF0=.TRUE.
  LLGDWI=.FALSE.
  CALL GPGW(YDGEOMETRY, NFLEVG, NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, LLGWF0, LLGDWI, Z_ZERO_T0, &
  & Z_ZERO_T0, YDCPG_DYN0%XYB%LNPR, YDCPG_DYN0%XYB%ALPH, Z_ZERO_T0, Z_ZERO_T0, Z_RDT_T0,   &
  & Z_DVERW_T0, Z_GWHT_T0, YDCPG_DYN0%GWFT, PRNHPPI=Z_RNHPPI_T0)
  IF (LGWADV) THEN
    YDCPG_DYN0%GWT(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=Z_GWHT_T0(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,0:NFLEVG-1)
  ENDIF
...
LLDER=.TRUE.
IF (NVDVAR==3 .OR. NVDVAR==4) THEN
  CALL GNHGRGW(YDGEOMETRY, NPROMA, NFLEVG, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, LLDER, Z_RDT_T0, Z_RDTL_T0,              &
  & Z_RDTM_T0, Z_DVER_T0, Z_DVERL_T0, Z_DVERM_T0, YDCPG_DYN0%XYB%LNPR, YDCPG_DYN0%XYB%ALPH,                     &
  & PUS=Z_US_T0, PVS=Z_VS_T0, PUS_L=Z_US_L_T0, PVS_L=Z_VS_L_T0, PUS_M=Z_US_M_T0,                            &
  & PVS_M=Z_VS_M_T0, POROGL=YDCPG_DYN0%OROGL, POROGM=YDCPG_DYN0%OROGM, POROGLM=Z_OROGLM_T0, POROGLL=Z_OROGLL_T0,    &
  & POROGMM=Z_OROGMM_T0, PGWFL=YDCPG_DYN0%GWFL, PGWFM=YDCPG_DYN0%GWFM, PGWHL=Z_GWHL_T0, PGWHM=Z_GWHM_T0,            &
  & LDNHEE=.TRUE., PRNHPPI=Z_RNHPPI_T0, PQCHAL=YDCPG_DYN0%QCHAL, PQCHAM=YDCPG_DYN0%QCHAM, PLNPRL_DER=Z_XYBDER_LNPRL_T0, &
  & PLNPRM_DER=Z_XYBDER_LNPRM_T0, PALPHL_DER=Z_XYBDER_ALPHL_T0, PALPHM_DER=Z_XYBDER_ALPHM_T0                        &
  & )
ELSEIF (NVDVAR==5) THEN
  ...
  CALL GNHGRGW(YDGEOMETRY, NPROMA, NFLEVG, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, LLDER, Z_RDT_T0, Z_RDTL_T0,              &
  & Z_RDTM_T0, Z_DVERW_T0, Z_DVERL_T0, Z_DVERM_T0, YDCPG_DYN0%XYB%LNPR, YDCPG_DYN0%XYB%ALPH,                    &
  & PUS=Z_ZERO_T0, PVS=Z_ZERO_T0, PUS_L=Z_ZERO_T0, PVS_L=Z_ZERO_T0, PUS_M=Z_ZERO_T0,                        &
  & PVS_M=Z_ZERO_T0, POROGL=Z_ZERO_T0, POROGM=Z_ZERO_T0, POROGLM=Z_ZERO_T0, POROGLL=Z_ZERO_T0,              &
  & POROGMM=Z_ZERO_T0, PGWFL=YDCPG_DYN0%GWFL, PGWFM=YDCPG_DYN0%GWFM, PGWHL=Z_GWHL_T0, PGWHM=Z_GWHM_T0,              &
  & LDNHEE=.TRUE., PRNHPPI=Z_RNHPPI_T0, PQCHAL=YDCPG_DYN0%QCHAL, PQCHAM=YDCPG_DYN0%QCHAM, PLNPRL_DER=Z_XYBDER_LNPRL_T0, &
  & PLNPRM_DER=Z_XYBDER_LNPRM_T0, PALPHL_DER=Z_XYBDER_ALPHL_T0, PALPHM_DER=Z_XYBDER_ALPHM_T0                        &
  & )
ENDIF
...
CALL GNHD3(NFLEVG, NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDVARS%DIV%T0, Z_NHXS_T0, Z_DVER_T0, &
& YDCPG_DYN0%RCP%R, RMAX_D3, LBOUND_D3, Z_Z3DIVG_T0)
...
IF (.NOT.LGWADV.OR.LNHEE_SVDLAPL_FIRST.OR.LNHEE_REFINE_PREH_BBC) THEN
  ...
  & YDCSGEOM%RATATH, Z_US_T0, Z_VS_T0, Z_SGRTSL_T0, Z_SGRTSM_T0, Z_TNDUS_T0, Z_TNDVS_T0  &
  & )
ENDIF
...
IF (LNHEE_REFINE_PREH_BBC) THEN
  ...
  & Z_OROGLM_T0, Z_OROGLL_T0, Z_OROGMM_T0, Z_US_T0, Z_VS_T0, YDCPG_DYN0%PREF, YDCPG_DYN0%PRE,           &
  & Z_PDEP_T0, Z_WH2F_T0, Z_PSGRTL_T0, Z_PSGRTM_T0, Z_SGRTSL_T0, Z_SGRTSM_T0,                       &
...
IF (LNHEE_SVDLAPL_FIRST) THEN
  ...
  IF (LGWADV) THEN
    ...
    & Z_OROGLM_T0, Z_OROGLL_T0, Z_OROGMM_T0, Z_US_T0, Z_VS_T0, Z_TNDUS_T0, Z_TNDVS_T0,         &
    & YDCPG_DYN0%XYB%LNPR, YDCPG_DYN0%XYB%ALPH, YDCPG_DYN0%PREF, YDCPG_DYN0%PRE, Z_PDEP_T0, PATND(1, 1, YYTTND%M_TNDGW)&
    & )
  ENDIF
ELSE
  ...
  IF (LGWADV.AND.LVFE_GW) THEN
    ...
    DO JLEV=1,NFLEVG
      DO JROF=YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA
        PATND(JROF,JLEV,YYTTND%M_TNDGW)=Z_TNDGWF_LAP_T0(JROF,JLEV)+Z_TNDGWF_OTH_T0(JROF,JLEV)
      ENDDO
    ENDDO
  ELSEIF (LGWADV) THEN
    CALL GNH_TNDLAGADIAB_GW(YDGEOMETRY, NFLEVG, NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, PDEP=Z_PDEP_T0,  &
    & PREF=YDCPG_DYN0%PREF, PREH=YDCPG_DYN0%PRE, PTNDGWH_LAP=Z_TNDGWH_LAP_T0, PTNDGWH_OTH=Z_TNDGWH_OTH_T0&
    & )
    DO JLEV=1,NFLEVG
      DO JROF=YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA
        PATND(JROF,JLEV,YYTTND%M_TNDGW)=Z_TNDGWH_LAP_T0(JROF,JLEV-1)+Z_TNDGWH_OTH_T0(JROF,JLEV-1)
      ENDDO
    ENDDO
  ELSE IF (LVFE_GW) THEN
    ...
    & POROGM=YDCPG_DYN0%OROGM, POROGLM=Z_OROGLM_T0, POROGLL=Z_OROGLL_T0, POROGMM=Z_OROGMM_T0,            &
    & PUS=Z_US_T0, PVS=Z_VS_T0, PTNDUS=Z_TNDUS_T0, PTNDVS=Z_TNDVS_T0, PDEP=Z_PDEP_T0,            &
    & PREF=YDCPG_DYN0%PREF, PREH=YDCPG_DYN0%PRE, PDELP=YDCPG_DYN0%XYB%DELP, PDELNHPRE=Z_DELNHPRE_T0,             &
    & PTNDGWH_LAP=Z_TNDGWH_LAP_T0, PTNDGWF_OTH=Z_TNDGWF_OTH_T0, PDBBC=YDCPG_DYN0%DBBC)
  ELSE
    DO JROF=YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA
    ...
    & POROGM=YDCPG_DYN0%OROGM, POROGLM=Z_OROGLM_T0, POROGLL=Z_OROGLL_T0, POROGMM=Z_OROGMM_T0,            &
    & PUS=Z_US_T0, PVS=Z_VS_T0, PTNDUS=Z_TNDUS_T0, PTNDVS=Z_TNDVS_T0, PDEP=Z_PDEP_T0,            &
    & PDEPS=Z_PDEPS_T0, PREF=YDCPG_DYN0%PREF, PREH=YDCPG_DYN0%PRE, PTNDGWH_LAP=Z_TNDGWH_LAP_T0,              &
    & PTNDGWH_OTH=Z_TNDGWH_OTH_T0, PDBBC=YDCPG_DYN0%DBBC)
  ENDIF
ENDIF
...
& Z_Z3DIVG_T0, YDCPG_DYN0%CTY%VVEL(:, 1:), PATND(1, 1, YYTTND%M_TNDPD) )
...
IF (.NOT.LGWADV) THEN
  ...
  IF (LNHEE_SVDLAPL_FIRST) THEN
    ...
    & Z_OROGLM_T0, Z_OROGLL_T0, Z_OROGMM_T0, YDCPG_DYN0%CTY%EVEL, YDCPG_DYN0%XYB%RDELP, YDCPG_DYN0%XYB%LNPR, &
    & YDCPG_DYN0%XYB%ALPH, YDCPG_DYN0%PREF, YDCPG_DYN0%PRE, Z_PDEP_T0, YDVARS%U%T0, YDVARS%V%T0,                     &
    & YDCPG_DYN0%UVH%UH, YDCPG_DYN0%UVH%VH, PATND(1, 1, YYTTND%M_TNDU), PATND(1, 1, YYTTND%M_TNDV), Z_TNDUS_T0,      &
    & Z_TNDVS_T0, YDCPG_DYN0%RDPHI, Z_GWHL_T0, Z_GWHM_T0, YDCPG_DYN0%GWFL, YDCPG_DYN0%GWFM,                  &
    & Z_DVER_T0, Z_DVERW_T0, YDVARS%DIV%T0, Z_Z3DIVG_T0, PATND(1, 1, YYTTND%M_TNDVD), YDCPG_DYN0%DBBC        &
    & )
  ELSE
    ! * rhs of (gw) eqn computed first, then Laplacian term in "dver" eqn computed.
    ...
    & YDVARS%V%T0, YDCPG_DYN0%UVH%UH, YDCPG_DYN0%UVH%VH, YDCPG_DYN0%RDPHI, Z_GWHT_T0, YDCPG_DYN0%GWFT,           &
...
DO JLEV=1,NFLEVG
  DO JROF=YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA
    ...
    PATND(JROF,JLEV,YYTTND%M_TNDT)=-ZRCV*YDVARS%T%T0(JROF,JLEV)*Z_Z3DIVG_T0(JROF,JLEV)
  ENDDO
ENDDO
...
!*     3.2.6 COMPUTE QUANTITIES FOR NHEE MODEL.
  ...
  & YDCPG_DYN9%XYB%DELP, YDCPG_DYN9%XYB%LNPR, Z_NHPPI_T9, YDCPG_DYN9%NHPREF, YDCPG_DYN9%NHPREH, Z_DELNHPRE_T9&
  & )
...
!*     3.2.13a COMPUTES TERM "NHX".
  ...
  IF (LDGPXX) THEN
    ...
    & Z_UVH_UH_T9, Z_UVH_VH_T9, Z_NHXS_T0, PNHPPI=Z_NHPPI_T0)
    IF (NVDVAR == 3 .OR. NVDVAR == 4) THEN
      ! NHX = NHX_S
      YDCPG_DYN9%NHX(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=Z_NHXS_T0(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
    ELSEIF (NVDVAR == 5) THEN
      ! NHX = NHX_S - (d13 - dver)
      CALL GNHEE_SVDINCR13(YDGEOMETRY, NFLEVG, NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_DYN0%OROGL, &
      & YDCPG_DYN0%OROGM, Z_UVH_UH_T9, Z_UVH_VH_T9, PLNPR=YDCPG_DYN9%XYB%LNPR, PRT=Z_RDT_T9,     &
      & PNHPPI=Z_NHPPI_T9, PSVDINCR13=Z_SVDINCR13_T0)
      YDCPG_DYN9%NHX(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=Z_NHXS_T0(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)-Z_SVDINCR13_T0(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
    ENDIF
  ELSE
    ! This case only occurs for a subset of NVDVAR= 4 or 5 cases
...
!*     3.2.14 COMPUTES dver.
  ...
  IF (NVDVAR == 3) THEN
    Z_DVER_T9(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDVARS%SVD%T9(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
  ELSEIF (NVDVAR == 4) THEN
    Z_DVER_T9(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDVARS%SVD%T9(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)-YDCPG_DYN9%NHX(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
  ELSEIF (NVDVAR == 5) THEN
    ! d13 in ZDVERW9
    Z_DVERW_T9(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDVARS%SVD%T9(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)-YDCPG_DYN9%NHX(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
    ! dver in ZDVER9
    CALL GNHEE_SVDINCR13(YDGEOMETRY, NFLEVG, NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_DYN0%OROGL, &
    & YDCPG_DYN0%OROGM, Z_UVH_UH_T9, Z_UVH_VH_T9, PLNPR=YDCPG_DYN9%XYB%LNPR, PRT=Z_RDT_T9,     &
    & PNHPPI=Z_NHPPI_T9, PSVDINCR13=Z_SVDINCR13_T0)
    Z_DVER_T9(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=Z_DVERW_T9(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)-Z_SVDINCR13_T0(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
  ENDIF
...
!*     3.2.16 COMPUTES term [gw] or [gW].
  ...
  ELSEIF (NVDVAR==5) THEN
    ...
    ! -- Modified W
    LLGDWI=.FALSE.
    CALL GPGW(YDGEOMETRY, NFLEVG, NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, LDMPA, LLGDWI, Z_ZERO_T0, &
    & Z_ZERO_T0, YDCPG_DYN9%XYB%LNPR, YDCPG_DYN9%XYB%ALPH, Z_ZERO_T0, Z_ZERO_T0, Z_RDT_T9,  &
