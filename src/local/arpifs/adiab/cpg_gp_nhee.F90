...
SUBROUTINE CPG_GP_NHEE(YDGEOMETRY,YDCPG_DYN0,YDCPG_DYN9,YDMODEL,YDGMV,&
 ...
 & PHI0,PHIF0,PHI0FL,PHI0FM,PCTY0,PGWFT0,PGWHT0,PGWT0,PGWS,PGWFL,PGWFM,PGDW0,PKENE0,&
 & PRT0L,PRT0M,&
...
CALL GPCTY(YDVFE,NPROMA,KST,KEND,NFLEVG,LRUBC,YDVAB,YDVETA,&
 ...
 & PSPL=PRE0L,PSPM=PRE0M,PRPREF=ZRPRE0F,PCTY=PCTY0,&
 & PDELP=YDCPG_DYN0%XYB%DELP, PLNPR=YDCPG_DYN0%XYB%LNPR, PRDELP=YDCPG_DYN0%XYB%RDELP, &
 & PALPH=YDCPG_DYN0%XYB%ALPH, PRTGR=YDCPG_DYN0%XYB%RTGR, PRPRE=YDCPG_DYN0%XYB%RPRE,  &
 & PRPP=YDCPG_DYN0%XYB%RPP)
...
IF(LGWDIAGS_ON) THEN
  CALL UPDATE_GWDIAG(YDGEOMETRY,YDMODEL%YRML_GCONF%YRRIP,NPROMA,NFLEVG,KEND,NSTEP,KSTGLO,PRE0,YDCPG_DYN0%CTY%DIVDP(:,1:))
ENDIF
...
IF ( LSFORC .AND. (LSW_FRC.OR.LSOMEGA_FRC) ) THEN
  CALL GPCTY_FORC(YDGEOMETRY,YDMODEL%YRML_GCONF,YDMODEL%YRML_PHY_MF%YRPHY2,KST,KEND, &
   & ZP1FORC,PRE0F,ZT0T,YDCPG_DYN0%RCP%R,YDCPG_DYN0%CTY%EVEL,YDCPG_DYN0%CTY%VVEL(:,1:))
ENDIF
...
IF (LNHEE_REFINE_GRP) THEN
  ...
  CALL GNHEE_REFINE_GRP(YDGEOMETRY,KST,KEND,&
   & ZRT0,PRT0L,PRT0M,PRE0L,PRE0M,YDCPG_DYN0%XYB%RTGR,YDCPG_DYN0%XYB%ALPH,ZXYBDER0,&
   & ZRNHPPI0,PQCHA0L,PQCHA0M,ZGPHL,ZGPHM,       &
   & ZPDEP0,PRE0F,PRE0,ZWH2F,&
   & ZPSGRTL,ZPSGRTM)
ELSE
  CALL GNHEE_GRP(YDGEOMETRY,KST,KEND,&
   & ZRT0,PRT0L,PRT0M,PRE0L,PRE0M,YDCPG_DYN0%XYB%RDELP,YDCPG_DYN0%XYB%RTGR,YDCPG_DYN0%XYB%ALPH,ZXYBDER0,&
