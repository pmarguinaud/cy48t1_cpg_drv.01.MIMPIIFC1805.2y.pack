...
@PROCESS NOCHECK
#endif
SUBROUTINE CPG_GP_NHEE(YDGEOMETRY,YDVARS,YDCPG_DYN0,YDCPG_DYN9,YDMODEL,YDGMV,&
 !---------------------------------------------------------------------
 ! - INPUT .
...
! CALL SC2PRG(YT0%MSGRTM,PGMV    ,ZT0SGRTM)
  ...
  ZT0NHX      => YDVARS%NHX%T0
  ZT0NHXL     => YDVARS%NHX%DL
  ZT0NHXM     => YDVARS%NHX%DM
...
! ZT0SVDL     => YDVARS%SVD%DL
! ZT0SVDM     => YDVARS%SVD%DM
! ZT0T        => YDVARS%T%T0
! ZT0TL       => YDVARS%T%DL
! ZT0TM       => YDVARS%T%DM
! ZT0U        => YDVARS%U%T0
...
CALL GNHPRE(YDGEOMETRY,NPROMA,NFLEVG,KST,KEND,ZT0SPD,YDCPG_DYN0%PREF,&
...
ENDDO
CALL GNHPREH(YDGEOMETRY,NPROMA,NFLEVG,KST,KEND,ZT0SPD,YDCPG_DYN0%PRE,&
...
CALL GNHGRPRE(YDGEOMETRY,NPROMA,NFLEVG,KST,KEND,YDCPG_DYN0%XYB%RTGR,YDCPG_DYN0%PREL,YDCPG_DYN0%PREM,&
 & YDCPG_DYN0%NHPREF,ZT0SPDL,ZT0SPDM,&
...
CALL GPHLWI(YDGEOMETRY%YRDIMV,NPROMA,KST,KEND,YDCPG_DYN0%XYB%LNPR,&
 & YDCPG_DYN0%XYB%ALPH,PWW0=YDCPG_DYN0%UVH%WWI,LDVERINT=LVEREGINT)
...
ELSE
  ...
  IF (NVDVAR == 4) THEN
    YDCPG_DYN0%NHX(KST:KEND,1:NFLEVG)=ZT0NHX(KST:KEND,1:NFLEVG)
    ! NHX_S
...
ELSEIF (NVDVAR == 4) THEN
  ZDVER0(KST:KEND,1:NFLEVG)=ZT0SVD(KST:KEND,1:NFLEVG)-YDCPG_DYN0%NHX(KST:KEND,1:NFLEVG)
...
ELSEIF (NVDVAR == 5) THEN
  ! d13 in ZDVERW0
  ZDVERW0(KST:KEND,1:NFLEVG)=ZT0SVD(KST:KEND,1:NFLEVG)-YDCPG_DYN0%NHX(KST:KEND,1:NFLEVG)
...
IF (NVDVAR==3 .OR. NVDVAR==4) THEN
  ...
  IF (LGWADV.AND.LVFE_GW) THEN
    ...
    CALL GPGW(YDGEOMETRY,NFLEVG,NPROMA,KST,KEND,LLGWF0,LLGDWI,&
     ...
     & ZRDT0,ZDVER0,YDCPG_DYN0%GWHT,YDCPG_DYN0%GWFT,PRNHPPI=ZRNHPPI0,PGDW=YDCPG_DYN0%GDW)

    YDCPG_DYN0%GWT(KST:KEND,1:NFLEVG)=YDCPG_DYN0%GWFT(KST:KEND,1:NFLEVG)
  ELSE
    CALL GPGW(YDGEOMETRY,NFLEVG,NPROMA,KST,KEND,LLGWF0,LLGDWI,&
     & YDCPG_DYN0%OROGL,YDCPG_DYN0%OROGM,YDCPG_DYN0%XYB%LNPR,YDCPG_DYN0%XYB%ALPH,ZUS0,ZVS0,&
     & ZRDT0,ZDVER0,YDCPG_DYN0%GWHT,YDCPG_DYN0%GWFT,PRNHPPI=ZRNHPPI0)
...
ELSEIF (NVDVAR==5) THEN
  ...
  CALL GPGW(YDGEOMETRY,NFLEVG,NPROMA,KST,KEND,LLGWF0,LLGDWI,&
   ...
   & ZRDT0,ZDVERW0,YDCPG_DYN0%GWHT,YDCPG_DYN0%GWFT,PRNHPPI=ZRNHPPI0)
  IF (LGWADV) THEN
    YDCPG_DYN0%GWT(KST:KEND,1:NFLEVG)=YDCPG_DYN0%GWHT(KST:KEND,0:NFLEVG-1)
  ENDIF
...
ELSE
  ...
  ELSE IF (LVFE_GW) THEN
    CALL GNH_TNDLAGADIAB_GW(YDGEOMETRY,NFLEVG,NPROMA,KST,KEND,&
     ...
     & POROGLM=YDCPG_DYN0%OROGLM,POROGLL=YDCPG_DYN0%OROGLL,POROGMM=YDCPG_DYN0%OROGMM,&
...
CALL GNH_TNDLAGADIAB_SPD(YDGEOMETRY,NFLEVG,NPROMA,KST,KEND,&
 & YDCPG_DYN0%RCP%KAP,Z3DIVG,YDCPG_DYN0%CTY%VVEL(:,1:),&
...
IF (.NOT.LGWADV) THEN
  ...
  IF (LNHEE_SVDLAPL_FIRST) THEN
    ...
    CALL GNHEE_TNDLAGADIAB_SVD(YDGEOMETRY,KST,KEND,&
     ...
     & YDCPG_DYN0%RDPHI,ZGWHL,ZGWHM,YDCPG_DYN0%GWFL,YDCPG_DYN0%GWFM,ZDVER0,ZDVERW0,ZT0DIV,Z3DIVG,&
  ...
  ELSE
    ...
    CALL GNH_TNDLAGADIAB_SVD(YDGEOMETRY,NFLEVG,NPROMA,KST,KEND,&
     & ZT0U,ZT0V,YDCPG_DYN0%UVH%UH,YDCPG_DYN0%UVH%VH,&
     & YDCPG_DYN0%RDPHI,YDCPG_DYN0%GWHT,YDCPG_DYN0%GWFT,ZGWHL,ZGWHM,YDCPG_DYN0%GWFL,YDCPG_DYN0%GWFM,ZDVER0,ZT0DIV,Z3DIVG,&
...
!*     3.2.6 COMPUTE QUANTITIES FOR NHEE MODEL.
  ...
  CALL GNHPRE(YDGEOMETRY,NPROMA,NFLEVG,KST,KEND,ZT9SPD,YDCPG_DYN9%PREF,&
  ...
  ENDDO
  CALL GNHPREH(YDGEOMETRY,NPROMA,NFLEVG,KST,KEND,ZT9SPD,YDCPG_DYN9%PRE,&
...
!*     3.2.13a COMPUTES TERM "NHX".
  ...
  ELSE
    ...
    ! useless.
    YDCPG_DYN9%NHX(KST:KEND,1:NFLEVG)=ZT9NHX(KST:KEND,1:NFLEVG)
  ENDIF
...
!*     3.2.14 COMPUTES dver.
  ...
  ELSEIF (NVDVAR == 4) THEN
    ZDVER9(KST:KEND,1:NFLEVG)=ZT9SVD(KST:KEND,1:NFLEVG)-YDCPG_DYN9%NHX(KST:KEND,1:NFLEVG)
  ELSEIF (NVDVAR == 5) THEN
    ! d13 in ZDVERW9
    ZDVERW9(KST:KEND,1:NFLEVG)=ZT9SVD(KST:KEND,1:NFLEVG)-YDCPG_DYN9%NHX(KST:KEND,1:NFLEVG)
    ! dver in ZDVER9
    CALL GNHEE_SVDINCR13(YDGEOMETRY,NFLEVG,NPROMA,KST,KEND,YDCPG_DYN0%OROGL,YDCPG_DYN0%OROGM,&
     & ZUVH9(1,0,YYTHW9%M_UH),ZUVH9(1,0,YYTHW9%M_VH),&
     & PLNPR=YDCPG_DYN9%XYB%LNPR,PRT=ZRDT9,PNHPPI=ZNHPPI9,&
...
!*     3.2.16 COMPUTES term [gw] or [gW].
  ...
  IF (NVDVAR==3 .OR. NVDVAR==4) THEN
    ...
    IF (LGWADV.AND.LVFE_GW) THEN
      ...
      CALL GPGW(YDGEOMETRY,NFLEVG,NPROMA,KST,KEND,LDMPA,LLGDWI,&
       ...
       & ZRDT9,ZDVER9,YDCPG_DYN9%GWHT,YDCPG_DYN9%GWFT,PRNHPPI=ZRNHPPI9,PGDW=YDCPG_DYN9%GDW)

      YDCPG_DYN9%GWT(KST:KEND,1:NFLEVG)=YDCPG_DYN9%GWFT(KST:KEND,1:NFLEVG)
    ELSE
      CALL GPGW(YDGEOMETRY,NFLEVG,NPROMA,KST,KEND,LDMPA,LLGDWI,&
       & YDCPG_DYN0%OROGL,YDCPG_DYN0%OROGM,YDCPG_DYN9%XYB%LNPR,YDCPG_DYN9%XYB%ALPH,ZUS9,ZVS9,&
       & ZRDT9,ZDVER9,YDCPG_DYN9%GWHT,YDCPG_DYN9%GWFT,PRNHPPI=ZRNHPPI9)
  ...
  ELSEIF (NVDVAR==5) THEN
    ...
    CALL GPGW(YDGEOMETRY,NFLEVG,NPROMA,KST,KEND,LDMPA,LLGDWI,&
     ...
     & ZRDT9,ZDVERW9,YDCPG_DYN9%GWHT,YDCPG_DYN9%GWFT,PRNHPPI=ZRNHPPI9)
