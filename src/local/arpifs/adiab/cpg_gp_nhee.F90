...
ENDDO
CALL GNHPREH(YDCPG_OPTS%LVERTFE, YDCPG_OPTS%LVFE_ECMWF, YDCPG_OPTS%NPDVAR, YDGEOMETRY, NPROMA, NFLEVG, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDVARS%SPD%T0, YDCPG_DYN0%PRE, &
& YDCPG_DYN0%XYB%DELP, YDCPG_DYN0%XYB%LNPR, Z_NHPPI_T0, YDCPG_DYN0%NHPREF, YDCPG_DYN0%NHPREH,               &
& Z_DELNHPRE_T0  )
CALL GNHGRPRE(YDCPG_OPTS%NPDVAR, YDGEOMETRY, NPROMA, NFLEVG, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_DYN0%XYB%RTGR, YDCPG_DYN0%PREL, &
...
IF (YDCPG_OPTS%LNHEE_REFINE_GRP) THEN
  ...
  CALL GNHEE_REFINE_GRP_EXPL(YDCPG_OPTS%LVERTFE, YDGEOMETRY, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, Z_RT_T0, YDCPG_DYN0%RTL, YDCPG_DYN0%RTM, &
...
ELSE
  CALL GNHEE_GRP(YDCPG_OPTS%LVERTFE, YDGEOMETRY, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, Z_RT_T0, YDCPG_DYN0%RTL, YDCPG_DYN0%RTM,       &
...
IF (LDGPXX) THEN
  ...
  ELSEIF (YDCPG_OPTS%NVDVAR == 5) THEN
    ! NHX = NHX_S - (d13 - dver)
    CALL GNHEE_SVDINCR13(YDCPG_OPTS%LVERTFE, YDCPG_OPTS%LVFE_GW, YDGEOMETRY, NFLEVG, NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_DYN0%OROGL, &
...
IF (YDCPG_OPTS%NVDVAR == 5 .AND. YDCPG_OPTS%LGWADV) THEN
  CALL GPYY(YDCPG_OPTS%LVERTFE, YDCPG_OPTS%LVFE_GW, YDGEOMETRY, NFLEVG, NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_DYN0%OROGL, YDCPG_DYN0%OROGM, &
...
ELSEIF (YDCPG_OPTS%NVDVAR==5) THEN
  ...
  LLGWF0=.TRUE.
  LLGDWI=.FALSE.
  CALL GPGW(YDCPG_OPTS%LNHDYN, YDCPG_OPTS%LVERTFE, YDCPG_OPTS%LVFE_GW, YDGEOMETRY, NFLEVG, NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, LLGWF0, LLGDWI,         &
...
LLDER=.TRUE.
IF (YDCPG_OPTS%NVDVAR==3 .OR. YDCPG_OPTS%NVDVAR==4) THEN
  CALL GNHGRGW(YDCPG_OPTS%LVERTFE, YDGEOMETRY, NPROMA, NFLEVG, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, LLDER, Z_RDT_T0,                            &
...
CALL GNHD3(YDCPG_OPTS%L_RDRY_VD, YDMODEL%YRCST, NFLEVG, NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDVARS%DIV%T0, Z_NHXS_T0, Z_DVER_T0, YDCPG_DYN0%RCP%R, &
...
IF (YDCPG_OPTS%LNHEE_REFINE_PREH_BBC) THEN
  ...
  CALL GNHEE_REFINE_PREH(YDCPG_OPTS%LVERTFE, YDCPG_OPTS%LVFE_GW, YDMODEL%YRCST, YDGEOMETRY, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_DYN0%OROGL, YDCPG_DYN0%OROGM, &
...
IF (YDCPG_OPTS%LNHEE_SVDLAPL_FIRST) THEN
  ...
  IF (YDCPG_OPTS%LGWADV) THEN
    ...
    IF (YDCPG_OPTS%LVFE_LAPL_BC.OR.YDCPG_OPTS%LVFE_GW) CALL ABOR1(' CPG_GP_NHEE 3.1.21: option not yet coded!')

    CALL GNHEE_TNDLAGADIAB_GW(YDCPG_OPTS%LVFE_GW, YDCPG_OPTS%LVFE_LAPL_BC, YDCPG_OPTS%NVDVAR, YDMODEL%YRCST, YDGEOMETRY, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_DYN0%OROGL, YDCPG_DYN0%OROGM, &
...
ELSE
  ...
  IF (YDCPG_OPTS%LGWADV.AND.YDCPG_OPTS%LVFE_GW) THEN
    CALL GNH_TNDLAGADIAB_GW(YDCPG_OPTS%LGWADV, YDCPG_OPTS%LVERTFE, YDCPG_OPTS%LVFE_ECMWF, YDCPG_OPTS%LVFE_GW, YDCPG_OPTS%LVFE_LAPL_BC, YDMODEL%YRCST, YDGEOMETRY, NFLEVG, NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, PDELP=YDCPG_DYN0%XYB%DELP, &
  ...
  ELSEIF (YDCPG_OPTS%LGWADV) THEN
    CALL GNH_TNDLAGADIAB_GW(YDCPG_OPTS%LGWADV, YDCPG_OPTS%LVERTFE, YDCPG_OPTS%LVFE_ECMWF, YDCPG_OPTS%LVFE_GW, YDCPG_OPTS%LVFE_LAPL_BC, YDMODEL%YRCST, YDGEOMETRY, NFLEVG, NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, PDEP=Z_PDEP_T0, &
  ...
  ELSE IF (YDCPG_OPTS%LVFE_GW) THEN
    CALL GNH_TNDLAGADIAB_GW(YDCPG_OPTS%LGWADV, YDCPG_OPTS%LVERTFE, YDCPG_OPTS%LVFE_ECMWF, YDCPG_OPTS%LVFE_GW, YDCPG_OPTS%LVFE_LAPL_BC, YDMODEL%YRCST, YDGEOMETRY, NFLEVG, NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, POROGL=YDCPG_DYN0%OROGL, &
...
CALL GNH_TNDLAGADIAB_SPD(YDCPG_OPTS%NPDVAR, YDGEOMETRY, NFLEVG, NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_DYN0%RCP%KAP, &
...
IF (.NOT.YDCPG_OPTS%LGWADV) THEN
  ...
  IF (YDCPG_OPTS%LNHEE_SVDLAPL_FIRST) THEN
    ...
    CALL GNHEE_TNDLAGADIAB_SVD(YDCPG_OPTS%LVEREGINT, YDCPG_OPTS%LVFE_GW,YDCPG_OPTS%LVFE_LAPL_BC, YDCPG_OPTS%LVERTFE, YDCPG_OPTS%NVDVAR, YDMODEL%YRCST, YDGEOMETRY, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_DYN0%OROGL, YDCPG_DYN0%OROGM,  &
  ...
  ELSE
    ...
    !   Dataflow may be tricky, and not always convenient to test future variable changes.
    CALL GNH_TNDLAGADIAB_SVD(YDCPG_OPTS%LVFE_GW, YDCPG_OPTS%LVFE_LAPL_BC, YDCPG_OPTS%NVDVAR, YDMODEL%YRCST, YDGEOMETRY, NFLEVG, NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDVARS%U%T0, &
...
CALL CPG_GP_NHEE_T9 (YDGEOMETRY, YDCPG_BNDS, YDCPG_OPTS, YDVARS, YDCPG_DYN0, YDMODEL, LDGPXX, YDCPG_OPTS%LGWADV, YDCPG_OPTS%LRDBBC, YDCPG_OPTS%LVERTFE, &
                   & YDCPG_OPTS%LVFE_GW, YDCPG_OPTS%L_RDRY_VD, YDCPG_OPTS%NVDVAR, Z_GPHL_T0, Z_GPHM_T0, Z_NHPPI_T0, Z_NHXS_T0, Z_SVDINCR13_T0, Z_ZERO_T0,  &
