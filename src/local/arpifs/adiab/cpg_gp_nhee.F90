...
ASSOCIATE(  YDCSGEOM=>YDGEOMETRY%YRCSGEOM(YDCPG_BNDS%KBL), YDGSGEOM=>YDGEOMETRY%YRGSGEOM(YDCPG_BNDS%KBL),       &
& YDVAB=>YDGEOMETRY%YRVAB, YDVETA=>YDGEOMETRY%YRVETA, YDVFE=>YDGEOMETRY%YRVFE, NPROMA=>YDGEOMETRY%YRDIM%NPROMA, &
& NFLEVG=>YDGEOMETRY%YRDIMV%NFLEVG)
ASSOCIATE(  YRSPEC=>YDMODEL%YRML_GCONF%YGFL%YRSPEC, YFORC=>YDMODEL%YRML_GCONF%YGFL%YFORC, NCURRENT_ITER=>YDMODEL%YRML_DYN%YRDYN%NCURRENT_ITER, &
...
YDTMP%T0%ZERO(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA)=0.0_JPRB
...
IF (L_RDRY_VD) THEN
  ...
  YDTMP%T0%RDTL(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=RD*YDVARS%T%DL(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
  YDTMP%T0%RDTM(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=RD*YDVARS%T%DM(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
ELSE
  YDTMP%T0%RDT(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDTMP%T0%RT(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
  YDTMP%T0%RDTL(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDCPG_DYN0%RTL(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
  YDTMP%T0%RDTM(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDCPG_DYN0%RTM(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
ENDIF
...
DO JLEV=1,NFLEVG
  YDTMP%T0%RRED(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,JLEV)=YDCPG_DYN0%RCP%R(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,JLEV)/YDTMP%T0%NHPPI(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,JLEV)
  YDTMP%T0%RTR(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,JLEV)=YDTMP%T0%RRED(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,JLEV)*YDVARS%T%T0(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,JLEV)
ENDDO
CALL GNHPREH(YDGEOMETRY, NPROMA, NFLEVG, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDVARS%SPD%T0, YDCPG_DYN0%PRE,        &
& YDCPG_DYN0%XYB%DELP, YDCPG_DYN0%XYB%LNPR, YDTMP%T0%NHPPI, YDCPG_DYN0%NHPREF, YDCPG_DYN0%NHPREH, YDTMP%T0%DELNHPRE&
& )
CALL GNHGRPRE(YDGEOMETRY, NPROMA, NFLEVG, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_DYN0%XYB%RTGR, YDCPG_DYN0%PREL, &
& YDCPG_DYN0%PREM, YDCPG_DYN0%NHPREF, YDVARS%SPD%DL, YDVARS%SPD%DM, YDTMP%T0%NHPREL, YDTMP%T0%NHPREM,               &
& YDTMP%T0%LNNHPREFL, YDTMP%T0%LNNHPREFM, YDCPG_DYN0%QCHAL, YDCPG_DYN0%QCHAM)
...
& YDTMP%T0%RRED, YDCPG_DYN0%XYB%LNPR, YDCPG_DYN0%XYB%ALPH, YDGEOMETRY%YRVERT_GEOM)
...
& PHIFL=YDCPG_DYN0%PHIFL, PHIFM=YDCPG_DYN0%PHIFM, PHIHL=YDTMP%T0%GPHL, PHIHM=YDTMP%T0%GPHM, LDNHEE=.TRUE.,     &
& PRNHPPI=YDTMP%T0%RNHPPI, PQCHAL=YDCPG_DYN0%QCHAL, PQCHAM=YDCPG_DYN0%QCHAM, PLNPRL_DER=YDTMP%T0%XYBDER%LNPRL, &
...
& YDTMP%T0%VS, PDIVF=YDVARS%DIV%T0, PVORF=YDVARS%VOR%T0, PUFL=YDVARS%U%DL, PVFL=YDVARS%V%DL, PUS_L=YDTMP%T0%US_L, &
& PVS_L=YDTMP%T0%VS_L, PUS_M=YDTMP%T0%US_M, PVS_M=YDTMP%T0%VS_M)
...
IF (LNHEE_REFINE_GRP) THEN
  ...
  & YDCPG_DYN0%PRE, YDCPG_DYN0%PREF, YDCPG_DYN0%XYB%DELP, YDTMP%T0%WH2F, LDVERINT=LVEREGINT)

  CALL GNHEE_REFINE_GRP(YDGEOMETRY, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDTMP%T0%RT, YDCPG_DYN0%RTL,                     &
  & YDCPG_DYN0%RTM, YDCPG_DYN0%PREL, YDCPG_DYN0%PREM, YDCPG_DYN0%XYB%RTGR, YDCPG_DYN0%XYB%ALPH, PRNHPPI=YDTMP%T0%RNHPPI, &
  & PQCHAL=YDCPG_DYN0%QCHAL, PQCHAM=YDCPG_DYN0%QCHAM, PHIHL=YDTMP%T0%GPHL, PHIHM=YDTMP%T0%GPHM, PDEP=YDTMP%T0%PDEP,      &
  & PREF=YDCPG_DYN0%PREF, PREH=YDCPG_DYN0%PRE, PWWH2F=YDTMP%T0%WH2F, PSGRTL=YDTMP%T0%PSGRTL, PSGRTM=YDTMP%T0%PSGRTM,     &
  & PALPHPLL_DER=YDTMP%T0%XYBDER%ALPHPLL, PALPHPLM_DER=YDTMP%T0%XYBDER%ALPHPLM)
ELSE
  CALL GNHEE_GRP(YDGEOMETRY, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDTMP%T0%RT, YDCPG_DYN0%RTL, YDCPG_DYN0%RTM,           &
  & YDCPG_DYN0%PREL, YDCPG_DYN0%PREM, YDCPG_DYN0%XYB%RDELP, YDCPG_DYN0%XYB%RTGR, YDCPG_DYN0%XYB%ALPH,                   &
  & PDELNHPRE=YDTMP%T0%DELNHPRE, PLNNHPREFL=YDTMP%T0%LNNHPREFL, PLNNHPREFM=YDTMP%T0%LNNHPREFM, PRNHPPI=YDTMP%T0%RNHPPI, &
  & PQCHAL=YDCPG_DYN0%QCHAL, PQCHAM=YDCPG_DYN0%QCHAM, PHIHL=YDTMP%T0%GPHL, PHIHM=YDTMP%T0%GPHM, PHIFL=YDCPG_DYN0%PHIFL, &
  & PHIFM=YDCPG_DYN0%PHIFM, PSGRTL=YDTMP%T0%PSGRTL, PSGRTM=YDTMP%T0%PSGRTM, PALPHPLL_DER=YDTMP%T0%XYBDER%ALPHPLL,       &
...
YDTMP%T0%SGRTSL(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA)=YDTMP%T0%PSGRTL(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,NFLEVG)
YDTMP%T0%SGRTSM(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA)=YDTMP%T0%PSGRTM(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,NFLEVG)
...
IF (LDGPXX) THEN
  ...
  & YDCPG_DYN0%UVH%VH, YDTMP%T0%NHXS, PNHPPI=YDTMP%T0%NHPPI)
   ! PNHXT0 always stores NHX
  IF (NVDVAR == 3 .OR. NVDVAR == 4) THEN
    ! NHX = NHX_S
    YDCPG_DYN0%NHX(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDTMP%T0%NHXS(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
  ELSEIF (NVDVAR == 5) THEN
    ! NHX = NHX_S - (d13 - dver)
    CALL GNHEE_SVDINCR13(YDGEOMETRY, NFLEVG, NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_DYN0%OROGL, &
    & YDCPG_DYN0%OROGM, YDCPG_DYN0%UVH%UH, YDCPG_DYN0%UVH%VH, PLNPR=YDCPG_DYN0%XYB%LNPR, PRT=YDTMP%T0%RDT, &
    & PNHPPI=YDTMP%T0%NHPPI, PSVDINCR13=YDTMP%T0%SVDINCR13)
    YDCPG_DYN0%NHX(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDTMP%T0%NHXS(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)-YDTMP%T0%SVDINCR13(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
  ENDIF
ELSE
  ...
  IF (NVDVAR == 4) THEN
    ...
    ! NHX_S
    YDTMP%T0%NHXS(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG) =YDVARS%NHX%T0(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
  ELSEIF (NVDVAR == 5) THEN
    YDCPG_DYN0%NHX(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDVARS%NHX%T0(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
    ! NHX_S = NHX + (d13 - dver)
    CALL GNHEE_SVDINCR13(YDGEOMETRY, NFLEVG, NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_DYN0%OROGL, &
    & YDCPG_DYN0%OROGM, YDCPG_DYN0%UVH%UH, YDCPG_DYN0%UVH%VH, PLNPR=YDCPG_DYN0%XYB%LNPR, PRT=YDTMP%T0%RDT, &
    & PNHPPI=YDTMP%T0%NHPPI, PSVDINCR13=YDTMP%T0%SVDINCR13)
    YDTMP%T0%NHXS(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDVARS%NHX%T0(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)+YDTMP%T0%SVDINCR13(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
  ENDIF
ENDIF

!*     3.1.13b COMPUTES TERM "NHY"
IF (NVDVAR == 5 .AND. LGWADV) THEN
  CALL GPYY(YDGEOMETRY, NFLEVG, NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_DYN0%OROGL, YDCPG_DYN0%OROGM, &
...
IF (NVDVAR == 3) THEN
  YDTMP%T0%DVER(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDVARS%SVD%T0(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
  YDTMP%T0%DVERL(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDVARS%SVD%DL(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
  YDTMP%T0%DVERM(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDVARS%SVD%DM(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
ELSEIF (NVDVAR == 4) THEN
  YDTMP%T0%DVER(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDVARS%SVD%T0(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)-YDCPG_DYN0%NHX(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
  YDTMP%T0%DVERL(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDVARS%SVD%DL(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)-YDVARS%NHX%DL(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
  YDTMP%T0%DVERM(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDVARS%SVD%DM(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)-YDVARS%NHX%DM(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
ELSEIF (NVDVAR == 5) THEN
  ! d13 in ZDVERW0
  YDTMP%T0%DVERW(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDVARS%SVD%T0(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)-YDCPG_DYN0%NHX(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
  ! dver in ZDVER0: dver = d13 - (d13 - dver)
  CALL GNHEE_SVDINCR13(YDGEOMETRY, NFLEVG, NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_DYN0%OROGL, &
  & YDCPG_DYN0%OROGM, YDCPG_DYN0%UVH%UH, YDCPG_DYN0%UVH%VH, PLNPR=YDCPG_DYN0%XYB%LNPR, PRT=YDTMP%T0%RDT, &
  & PNHPPI=YDTMP%T0%NHPPI, PSVDINCR13=YDTMP%T0%SVDINCR13)
  YDTMP%T0%DVER(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDTMP%T0%DVERW(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)-YDTMP%T0%SVDINCR13(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
...
IF (NVDVAR==3 .OR. NVDVAR==4) THEN
  ...
  IF (LGWADV.AND.LVFE_GW) THEN
    ...
    & YDTMP%T0%DVER, YDTMP%T0%GWHT, YDCPG_DYN0%GWFT, PRNHPPI=YDTMP%T0%RNHPPI, PGDW=YDTMP%T0%GDW)

    YDCPG_DYN0%GWT(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDCPG_DYN0%GWFT(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
  ELSE
    CALL GPGW(YDGEOMETRY, NFLEVG, NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, LLGWF0, LLGDWI, YDCPG_DYN0%OROGL, &
    & YDCPG_DYN0%OROGM, YDCPG_DYN0%XYB%LNPR, YDCPG_DYN0%XYB%ALPH, YDTMP%T0%US, YDTMP%T0%VS, YDTMP%T0%RDT,       &
    & YDTMP%T0%DVER, YDTMP%T0%GWHT, YDCPG_DYN0%GWFT, PRNHPPI=YDTMP%T0%RNHPPI)

    IF (LGWADV) YDCPG_DYN0%GWT(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDTMP%T0%GWHT(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,0:NFLEVG-1)
  ENDIF

  IF (LTWOTL.AND.LRDBBC) THEN
    ! PGWS contains (gw)_surf
    YDCPG_DYN0%GWS(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA)=YDTMP%T0%GWHT(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,NFLEVG)
  ENDIF
ELSEIF (NVDVAR==5) THEN
  ...
  LLGWF0=.TRUE.
  LLGDWI=.FALSE.
  CALL GPGW(YDGEOMETRY, NFLEVG, NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, LLGWF0, LLGDWI, YDTMP%T0%ZERO, &
  & YDTMP%T0%ZERO, YDCPG_DYN0%XYB%LNPR, YDCPG_DYN0%XYB%ALPH, YDTMP%T0%ZERO, YDTMP%T0%ZERO, YDTMP%T0%RDT,   &
  & YDTMP%T0%DVERW, YDTMP%T0%GWHT, YDCPG_DYN0%GWFT, PRNHPPI=YDTMP%T0%RNHPPI)
  IF (LGWADV) THEN
    YDCPG_DYN0%GWT(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDTMP%T0%GWHT(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,0:NFLEVG-1)
  ENDIF
...
LLDER=.TRUE.
IF (NVDVAR==3 .OR. NVDVAR==4) THEN
  CALL GNHGRGW(YDGEOMETRY, NPROMA, NFLEVG, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, LLDER, YDTMP%T0%RDT, YDTMP%T0%RDTL,              &
  & YDTMP%T0%RDTM, YDTMP%T0%DVER, YDTMP%T0%DVERL, YDTMP%T0%DVERM, YDCPG_DYN0%XYB%LNPR, YDCPG_DYN0%XYB%ALPH,                     &
  & PUS=YDTMP%T0%US, PVS=YDTMP%T0%VS, PUS_L=YDTMP%T0%US_L, PVS_L=YDTMP%T0%VS_L, PUS_M=YDTMP%T0%US_M,                            &
  & PVS_M=YDTMP%T0%VS_M, POROGL=YDCPG_DYN0%OROGL, POROGM=YDCPG_DYN0%OROGM, POROGLM=YDTMP%T0%OROGLM, POROGLL=YDTMP%T0%OROGLL,    &
  & POROGMM=YDTMP%T0%OROGMM, PGWFL=YDCPG_DYN0%GWFL, PGWFM=YDCPG_DYN0%GWFM, PGWHL=YDTMP%T0%GWHL, PGWHM=YDTMP%T0%GWHM,            &
  & LDNHEE=.TRUE., PRNHPPI=YDTMP%T0%RNHPPI, PQCHAL=YDCPG_DYN0%QCHAL, PQCHAM=YDCPG_DYN0%QCHAM, PLNPRL_DER=YDTMP%T0%XYBDER%LNPRL, &
  & PLNPRM_DER=YDTMP%T0%XYBDER%LNPRM, PALPHL_DER=YDTMP%T0%XYBDER%ALPHL, PALPHM_DER=YDTMP%T0%XYBDER%ALPHM                        &
  & )
ELSEIF (NVDVAR==5) THEN
  ...
  CALL GNHGRGW(YDGEOMETRY, NPROMA, NFLEVG, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, LLDER, YDTMP%T0%RDT, YDTMP%T0%RDTL,              &
  & YDTMP%T0%RDTM, YDTMP%T0%DVERW, YDTMP%T0%DVERL, YDTMP%T0%DVERM, YDCPG_DYN0%XYB%LNPR, YDCPG_DYN0%XYB%ALPH,                    &
  & PUS=YDTMP%T0%ZERO, PVS=YDTMP%T0%ZERO, PUS_L=YDTMP%T0%ZERO, PVS_L=YDTMP%T0%ZERO, PUS_M=YDTMP%T0%ZERO,                        &
  & PVS_M=YDTMP%T0%ZERO, POROGL=YDTMP%T0%ZERO, POROGM=YDTMP%T0%ZERO, POROGLM=YDTMP%T0%ZERO, POROGLL=YDTMP%T0%ZERO,              &
  & POROGMM=YDTMP%T0%ZERO, PGWFL=YDCPG_DYN0%GWFL, PGWFM=YDCPG_DYN0%GWFM, PGWHL=YDTMP%T0%GWHL, PGWHM=YDTMP%T0%GWHM,              &
  & LDNHEE=.TRUE., PRNHPPI=YDTMP%T0%RNHPPI, PQCHAL=YDCPG_DYN0%QCHAL, PQCHAM=YDCPG_DYN0%QCHAM, PLNPRL_DER=YDTMP%T0%XYBDER%LNPRL, &
  & PLNPRM_DER=YDTMP%T0%XYBDER%LNPRM, PALPHL_DER=YDTMP%T0%XYBDER%ALPHL, PALPHM_DER=YDTMP%T0%XYBDER%ALPHM                        &
  & )
ENDIF
...
CALL GNHD3(NFLEVG, NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDVARS%DIV%T0, YDTMP%T0%NHXS, YDTMP%T0%DVER, &
& YDCPG_DYN0%RCP%R, RMAX_D3, LBOUND_D3, YDTMP%T0%Z3DIVG)
...
IF (.NOT.LGWADV.OR.LNHEE_SVDLAPL_FIRST.OR.LNHEE_REFINE_PREH_BBC) THEN
  CALL GNH_TNDLAGADIAB_UVS(NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, LRPLANE, YDGSGEOM%RCORI, YDCSGEOM%RATATX, &
  & YDCSGEOM%RATATH, YDTMP%T0%US, YDTMP%T0%VS, YDTMP%T0%SGRTSL, YDTMP%T0%SGRTSM, YDTMP%T0%TNDUS, YDTMP%T0%TNDVS  &
  & )
ENDIF
...
IF (LNHEE_REFINE_PREH_BBC) THEN
  ...
  CALL GNHEE_REFINE_PREH(YDGEOMETRY, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_DYN0%OROGL, YDCPG_DYN0%OROGM,                &
  & YDTMP%T0%OROGLM, YDTMP%T0%OROGLL, YDTMP%T0%OROGMM, YDTMP%T0%US, YDTMP%T0%VS, YDCPG_DYN0%PREF, YDCPG_DYN0%PRE,           &
  & YDTMP%T0%PDEP, YDTMP%T0%WH2F, YDTMP%T0%PSGRTL, YDTMP%T0%PSGRTM, YDTMP%T0%SGRTSL, YDTMP%T0%SGRTSM,                       &
  & PATND(1, 1, YYTTND%M_TNDU), PATND(1, 1, YYTTND%M_TNDV), PATND(1, 1, YYTTND%M_TNDU_NOC), PATND(1, 1, YYTTND%M_TNDV_NOC), &
...
IF (LNHEE_SVDLAPL_FIRST) THEN
  ...
  IF (LGWADV) THEN
    ...
    CALL GNHEE_TNDLAGADIAB_GW(YDGEOMETRY, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_DYN0%OROGL, YDCPG_DYN0%OROGM,          &
    & YDTMP%T0%OROGLM, YDTMP%T0%OROGLL, YDTMP%T0%OROGMM, YDTMP%T0%US, YDTMP%T0%VS, YDTMP%T0%TNDUS, YDTMP%T0%TNDVS,         &
    & YDCPG_DYN0%XYB%LNPR, YDCPG_DYN0%XYB%ALPH, YDCPG_DYN0%PREF, YDCPG_DYN0%PRE, YDTMP%T0%PDEP, PATND(1, 1, YYTTND%M_TNDGW)&
    & )
  ENDIF
ELSE
  ...
  IF (LGWADV.AND.LVFE_GW) THEN
    CALL GNH_TNDLAGADIAB_GW(YDGEOMETRY, NFLEVG, NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, PDELP=YDCPG_DYN0%XYB%DELP, &
    & PDELNHPRE=YDTMP%T0%DELNHPRE, PTNDGWF_LAP=YDTMP%T0%TNDGWF_LAP, PTNDGWF_OTH=YDTMP%T0%TNDGWF_OTH)
    DO JLEV=1,NFLEVG
      DO JROF=YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA
    ...
    ENDDO
  ELSEIF (LGWADV) THEN
    CALL GNH_TNDLAGADIAB_GW(YDGEOMETRY, NFLEVG, NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, PDEP=YDTMP%T0%PDEP,  &
    & PREF=YDCPG_DYN0%PREF, PREH=YDCPG_DYN0%PRE, PTNDGWH_LAP=YDTMP%T0%TNDGWH_LAP, PTNDGWH_OTH=YDTMP%T0%TNDGWH_OTH&
    & )
    DO JLEV=1,NFLEVG
      DO JROF=YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA
  ...
  ELSE IF (LVFE_GW) THEN
    CALL GNH_TNDLAGADIAB_GW(YDGEOMETRY, NFLEVG, NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, POROGL=YDCPG_DYN0%OROGL, &
    & POROGM=YDCPG_DYN0%OROGM, POROGLM=YDTMP%T0%OROGLM, POROGLL=YDTMP%T0%OROGLL, POROGMM=YDTMP%T0%OROGMM,            &
    & PUS=YDTMP%T0%US, PVS=YDTMP%T0%VS, PTNDUS=YDTMP%T0%TNDUS, PTNDVS=YDTMP%T0%TNDVS, PDEP=YDTMP%T0%PDEP,            &
    & PREF=YDCPG_DYN0%PREF, PREH=YDCPG_DYN0%PRE, PDELP=YDCPG_DYN0%XYB%DELP, PDELNHPRE=YDTMP%T0%DELNHPRE,             &
  ...
  ELSE
    ...
    & POROGM=YDCPG_DYN0%OROGM, POROGLM=YDTMP%T0%OROGLM, POROGLL=YDTMP%T0%OROGLL, POROGMM=YDTMP%T0%OROGMM,            &
    & PUS=YDTMP%T0%US, PVS=YDTMP%T0%VS, PTNDUS=YDTMP%T0%TNDUS, PTNDVS=YDTMP%T0%TNDVS, PDEP=YDTMP%T0%PDEP,            &
    & PDEPS=YDTMP%T0%PDEPS, PREF=YDCPG_DYN0%PREF, PREH=YDCPG_DYN0%PRE, PTNDGWH_LAP=YDTMP%T0%TNDGWH_LAP,              &
    & PTNDGWH_OTH=YDTMP%T0%TNDGWH_OTH, PDBBC=YDCPG_DYN0%DBBC)
  ENDIF
ENDIF

!*     3.1.22 COMPUTES [D(pressure departure variable)/Dt].

CALL GNH_TNDLAGADIAB_SPD(YDGEOMETRY, NFLEVG, NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_DYN0%RCP%KAP, &
& YDTMP%T0%Z3DIVG, YDCPG_DYN0%CTY%VVEL(:, 1:), PATND(1, 1, YYTTND%M_TNDPD) )
...
IF (.NOT.LGWADV) THEN
  ...
  IF (LNHEE_SVDLAPL_FIRST) THEN
    ...
    CALL GNHEE_TNDLAGADIAB_SVD(YDGEOMETRY, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_DYN0%OROGL, YDCPG_DYN0%OROGM,       &
    & YDTMP%T0%OROGLM, YDTMP%T0%OROGLL, YDTMP%T0%OROGMM, YDCPG_DYN0%CTY%EVEL, YDCPG_DYN0%XYB%RDELP, YDCPG_DYN0%XYB%LNPR, &
    & YDCPG_DYN0%XYB%ALPH, YDCPG_DYN0%PREF, YDCPG_DYN0%PRE, YDTMP%T0%PDEP, YDVARS%U%T0, YDVARS%V%T0,                     &
    & YDCPG_DYN0%UVH%UH, YDCPG_DYN0%UVH%VH, PATND(1, 1, YYTTND%M_TNDU), PATND(1, 1, YYTTND%M_TNDV), YDTMP%T0%TNDUS,      &
    & YDTMP%T0%TNDVS, YDCPG_DYN0%RDPHI, YDTMP%T0%GWHL, YDTMP%T0%GWHM, YDCPG_DYN0%GWFL, YDCPG_DYN0%GWFM,                  &
    & YDTMP%T0%DVER, YDTMP%T0%DVERW, YDVARS%DIV%T0, YDTMP%T0%Z3DIVG, PATND(1, 1, YYTTND%M_TNDVD), YDCPG_DYN0%DBBC        &
    & )
  ELSE
    ! * rhs of (gw) eqn computed first, then Laplacian term in "dver" eqn computed.
    !   GNH_TNDLAGADIAB_GW must have been called above to provide ZTNDGW.. arrays.
    !   Dataflow may be tricky, and not always convenient to test future variable changes.
    CALL GNH_TNDLAGADIAB_SVD(YDGEOMETRY, NFLEVG, NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDVARS%U%T0,            &
    & YDVARS%V%T0, YDCPG_DYN0%UVH%UH, YDCPG_DYN0%UVH%VH, YDCPG_DYN0%RDPHI, YDTMP%T0%GWHT, YDCPG_DYN0%GWFT,           &
    & YDTMP%T0%GWHL, YDTMP%T0%GWHM, YDCPG_DYN0%GWFL, YDCPG_DYN0%GWFM, YDTMP%T0%DVER, YDVARS%DIV%T0, YDTMP%T0%Z3DIVG, &
    & YDTMP%T0%TNDGWH_LAP, YDTMP%T0%TNDGWH_OTH, YDTMP%T0%TNDGWF_OTH, YDTMP%T0%PDEP, YDCPG_DYN0%PRE, YDCPG_DYN0%PREF, &
    & YDCPG_DYN0%XYB%DELP, YDCPG_DYN0%XYB%LNPR, PATND(1, 1, YYTTND%M_TNDVD) )
  ENDIF
ENDIF
...
!*     3.2.6 COMPUTE QUANTITIES FOR NHEE MODEL.
  ...
  DO JLEV=1,NFLEVG
    YDTMP%T9%RRED(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,JLEV)=YDCPG_DYN9%RCP%R(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,JLEV)/YDTMP%T9%NHPPI(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,JLEV)
  ENDDO
  CALL GNHPREH(YDGEOMETRY, NPROMA, NFLEVG, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDVARS%SPD%T9, YDCPG_DYN9%PRE,        &
...
!*     3.2.8 COMPUTES THE GEOPOTENTIAL HEIGHT "gz" AND ITS GRADIENT.
  ...
  IF (LDLDIAB.OR.LSIMPH) THEN
    ...
    & YDTMP%T9%RRED, YDCPG_DYN9%XYB%LNPR, YDCPG_DYN9%XYB%ALPH, YDGEOMETRY%YRVERT_GEOM)
  ENDIF
...
!*     3.2.13a COMPUTES TERM "NHX".
  ...
  IF (LDGPXX) THEN
    ...
    & YDTMP%T9%UVH%UH, YDTMP%T9%UVH%VH, YDTMP%T0%NHXS, PNHPPI=YDTMP%T0%NHPPI)
    IF (NVDVAR == 3 .OR. NVDVAR == 4) THEN
      ! NHX = NHX_S
      YDCPG_DYN9%NHX(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDTMP%T0%NHXS(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
    ELSEIF (NVDVAR == 5) THEN
      ! NHX = NHX_S - (d13 - dver)
      CALL GNHEE_SVDINCR13(YDGEOMETRY, NFLEVG, NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_DYN0%OROGL, &
      & YDCPG_DYN0%OROGM, YDTMP%T9%UVH%UH, YDTMP%T9%UVH%VH, PLNPR=YDCPG_DYN9%XYB%LNPR, PRT=YDTMP%T9%RDT,     &
      & PNHPPI=YDTMP%T9%NHPPI, PSVDINCR13=YDTMP%T0%SVDINCR13)
      YDCPG_DYN9%NHX(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDTMP%T0%NHXS(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)-YDTMP%T0%SVDINCR13(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
    ENDIF
  ELSE
    ! This case only occurs for a subset of NVDVAR= 4 or 5 cases
  ...
  ELSE
    YDCPG_DYN9%NHY(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,0:NFLEVG) = 0.0_JPRB
  ENDIF
...
!*     3.2.14 COMPUTES dver.
  ...
  IF (NVDVAR == 3) THEN
    YDTMP%T9%DVER(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDVARS%SVD%T9(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
  ELSEIF (NVDVAR == 4) THEN
    YDTMP%T9%DVER(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDVARS%SVD%T9(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)-YDCPG_DYN9%NHX(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
  ELSEIF (NVDVAR == 5) THEN
    ! d13 in ZDVERW9
    YDTMP%T9%DVERW(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDVARS%SVD%T9(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)-YDCPG_DYN9%NHX(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
    ! dver in ZDVER9
    CALL GNHEE_SVDINCR13(YDGEOMETRY, NFLEVG, NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_DYN0%OROGL, &
    & YDCPG_DYN0%OROGM, YDTMP%T9%UVH%UH, YDTMP%T9%UVH%VH, PLNPR=YDCPG_DYN9%XYB%LNPR, PRT=YDTMP%T9%RDT,     &
    & PNHPPI=YDTMP%T9%NHPPI, PSVDINCR13=YDTMP%T0%SVDINCR13)
    YDTMP%T9%DVER(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDTMP%T9%DVERW(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)-YDTMP%T0%SVDINCR13(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
  ENDIF
...
!*     3.2.16 COMPUTES term [gw] or [gW].
  ...
  IF (NVDVAR==3 .OR. NVDVAR==4) THEN
    ...
    IF (LGWADV.AND.LVFE_GW) THEN
      ...
      & YDTMP%T9%DVER, YDTMP%T9%GWHT, YDCPG_DYN9%GWFT, PRNHPPI=YDTMP%T9%RNHPPI, PGDW=YDTMP%T9%GDW)

      YDCPG_DYN9%GWT(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDCPG_DYN9%GWFT(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
    ELSE
      CALL GPGW(YDGEOMETRY, NFLEVG, NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, LDMPA, LLGDWI, YDCPG_DYN0%OROGL, &
      & YDCPG_DYN0%OROGM, YDCPG_DYN9%XYB%LNPR, YDCPG_DYN9%XYB%ALPH, YDTMP%T9%US, YDTMP%T9%VS, YDTMP%T9%RDT,      &
      & YDTMP%T9%DVER, YDTMP%T9%GWHT, YDCPG_DYN9%GWFT, PRNHPPI=YDTMP%T9%RNHPPI)

      IF (LGWADV) YDCPG_DYN9%GWT(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDTMP%T9%GWHT(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,0:NFLEVG-1)
    ENDIF

    IF (LRDBBC) THEN
      ! PGWS contains (gw)_surf
      YDCPG_DYN0%GWS(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA)=YDTMP%T9%GWHT(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,NFLEVG)
    ENDIF
  ELSEIF (NVDVAR==5) THEN
    ! Case LVFE_GW is ignored and not coded.
    ! -- Modified W
    LLGDWI=.FALSE.
    CALL GPGW(YDGEOMETRY, NFLEVG, NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, LDMPA, LLGDWI, YDTMP%T0%ZERO, &
    & YDTMP%T0%ZERO, YDCPG_DYN9%XYB%LNPR, YDCPG_DYN9%XYB%ALPH, YDTMP%T0%ZERO, YDTMP%T0%ZERO, YDTMP%T9%RDT,  &
    & YDTMP%T9%DVERW, YDTMP%T9%GWHT, YDCPG_DYN9%GWFT, PRNHPPI=YDTMP%T9%RNHPPI)
