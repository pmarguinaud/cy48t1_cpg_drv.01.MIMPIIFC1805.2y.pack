...
CALL GNHD3(NFLEVG,NPROMA,KST,KEND,&
 & YDVARS%DIV%T0,ZNHXS,ZDVER0,YDCPG_DYN0%RCP%R,RMAX_D3,LBOUND_D3,Z3DIVG)
...
IF (.NOT.LGWADV) THEN
  ...
  IF (LNHEE_SVDLAPL_FIRST) THEN
    ...
    CALL GNHEE_TNDLAGADIAB_SVD(YDGEOMETRY,KST,KEND,&
     ...
     & YDCPG_DYN0%RDPHI,ZGWHL,ZGWHM,YDCPG_DYN0%GWFL,YDCPG_DYN0%GWFM,ZDVER0,ZDVERW0,YDVARS%DIV%T0,Z3DIVG,&
  ...
  ELSE
    ...
    CALL GNH_TNDLAGADIAB_SVD(YDGEOMETRY,NFLEVG,NPROMA,KST,KEND,&
     & YDVARS%U%T0,YDVARS%V%T0,YDCPG_DYN0%UVH%UH,YDCPG_DYN0%UVH%VH,&
     & YDCPG_DYN0%RDPHI,YDCPG_DYN0%GWHT,YDCPG_DYN0%GWFT,ZGWHL,ZGWHM,YDCPG_DYN0%GWFL,YDCPG_DYN0%GWFM,ZDVER0,YDVARS%DIV%T0,Z3DIVG,&
...
DO JLEV=1,NFLEVG
  DO JROF=KST,KEND
    ...
    PATND(JROF,JLEV,YYTTND%M_TNDT)=-ZRCV*YDVARS%T%T0(JROF,JLEV)*Z3DIVG(JROF,JLEV)
  ENDDO
ENDDO
