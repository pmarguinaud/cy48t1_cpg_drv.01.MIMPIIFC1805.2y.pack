...
IF (LDLDIAB.OR.YDMODEL%YRML_PHY_MF%YRSIMPHL%LSIMPH) THEN
  ...
  CALL GPGEO_EXPL(LVERTFE, YDGEOMETRY%YRDIM%NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDGEOMETRY%YRDIMV%NFLEVG, YDCPG_DYN9%PHI, YDCPG_DYN9%PHIF, YDVARS%T%T9, &
...
IF (KVDVAR==3 .OR. KVDVAR==4) THEN
  ...
  IF (LDGWADV.AND.LDVFE_GW) THEN
    ...
    CALL GPGW(LNHDYN, LVERTFE, LVFE_GW, YDGEOMETRY, YDGEOMETRY%YRDIMV%NFLEVG, YDGEOMETRY%YRDIM%NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, LDMPA, LLGDWI, YDCPG_DYN0%OROGL, &
...
ELSEIF (KVDVAR==5) THEN
  ...
  ! -- Modified W
  LLGDWI=.FALSE.
  CALL GPGW(LNHDYN, LVERTFE, LVFE_GW, YDGEOMETRY, YDGEOMETRY%YRDIMV%NFLEVG, YDGEOMETRY%YRDIM%NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, LDMPA, LLGDWI,          &
