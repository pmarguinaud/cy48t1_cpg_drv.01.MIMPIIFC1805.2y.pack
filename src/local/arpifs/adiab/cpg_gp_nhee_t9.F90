...
CALL GNHPRE(YDCPG_OPTS%NPDVAR, YDGEOMETRY, YDGEOMETRY%YRDIM%NPROMA, YDGEOMETRY%YRDIMV%NFLEVG, YDCPG_BNDS%KIDIA,        &
...
ENDDO
CALL GNHPREH(YDCPG_OPTS%LVERTFE, YDCPG_OPTS%LVFE_ECMWF, YDCPG_OPTS%NPDVAR, YDGEOMETRY, YDGEOMETRY%YRDIM%NPROMA,     &
