...
CALL GPRCP_PGFL(NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, NFLEVG, PGFL=PGFL, PCP=YDCPG_DYN0%RCP%CP, PR=YDCPG_DYN0%RCP%R, &
...
!*     3.2.3 COMPUTE "R", "Cp" AND "Kap=R/Cp".
  ...
  CALL GPRCP_PGFL(NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, NFLEVG, PGFL=PGFL, KGFLTYP=9, PCP=YDCPG_DYN9%RCP%CP, &
