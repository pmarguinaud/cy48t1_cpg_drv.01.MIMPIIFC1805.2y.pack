...
@PROCESS NOCHECK
#endif
SUBROUTINE CPG_GP_NHQE(YDGEOMETRY, YDCPG_BNDS, YDCPG_OPTS, YDVARS, YDCPG_DYN0, YDCPG_DYN9, &
...
CALL GPGEO(NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, NFLEVG, YDCPG_DYN0%PHI, YDCPG_DYN0%PHIF, Z_RT_T0, &
& Z_ONE_T0, YDCPG_DYN0%XYB%LNPR, YDCPG_DYN0%XYB%ALPH, YDGEOMETRY%YRVERT_GEOM)
...
IF (LGWADV.AND.LVFE_GW) THEN
  ...
  & YDCPG_DYN0%OROGM, YDCPG_DYN0%XYB%LNPR, YDCPG_DYN0%XYB%ALPH, Z_US_T0, Z_VS_T0, Z_RT_T0,        &
  & Z_DVER_T0, Z_GWHT_T0, YDCPG_DYN0%GWFT, PGDW=Z_GDW_T0)
...
& YDCPG_DYN0%RTM, Z_DVER_T0, Z_DVERL_T0, Z_DVERM_T0, YDCPG_DYN0%XYB%LNPR, YDCPG_DYN0%XYB%ALPH,              &
& PUS=Z_US_T0, PVS=Z_VS_T0, PUS_L=Z_US_L_T0, PVS_L=Z_VS_L_T0, PUS_M=Z_US_M_T0, PVS_M=Z_VS_M_T0, &
& POROGL=YDCPG_DYN0%OROGL, POROGM=YDCPG_DYN0%OROGM, POROGLM=Z_OROGLM_T0, POROGLL=Z_OROGLL_T0,                   &
& POROGMM=Z_OROGMM_T0, PGWFL=YDCPG_DYN0%GWFL, PGWFM=YDCPG_DYN0%GWFM, PGWHL=Z_GWHL_T0, PGWHM=Z_GWHM_T0,      &
& PLNPRL_DER=Z_XYBDER_LNPRL_T0, PLNPRM_DER=Z_XYBDER_LNPRM_T0, PALPHL_DER=Z_XYBDER_ALPHL_T0,                 &
...
IF (LGWADV) THEN
  ...
  & YDCPG_DYN0%XYB%LNPR, YDCPG_DYN0%XYB%ALPH, YDCPG_DYN0%PREF, YDCPG_DYN0%PRE, Z_EQCHAF_T0, YDCPG_DYN0%RCP%KAP, &
...
IF (.NOT.LGWADV) THEN
  ...
  & Z_OROGLM_T0, Z_OROGLL_T0, Z_OROGMM_T0, YDCPG_DYN0%XYB%LNPR, YDCPG_DYN0%XYB%ALPH, YDCPG_DYN0%PREF,   &
  & YDCPG_DYN0%PRE, YDVARS%U%T0, YDVARS%V%T0, YDCPG_DYN0%UVH%UH, YDCPG_DYN0%UVH%VH, Z_TNDUS_T0, Z_TNDVS_T0, &
  & Z_EQCHAF_T0, YDCPG_DYN0%RCP%KAP, YDCPG_DYN0%RDPHI, Z_GWHL_T0, Z_GWHM_T0, Z_DVER_T0,             &
...
!*     3.2.8 COMPUTES THE GEOPOTENTIAL HEIGHT "gz" AND ITS GRADIENT.
  ...
  IF((LDLDIAB.OR.LSIMPH)) THEN
    ...
    CALL GPGEO(NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, NFLEVG, YDCPG_DYN9%PHI, YDCPG_DYN9%PHIF, Z_R9T_T9, &
    & Z_ONE_T0, YDCPG_DYN9%XYB%LNPR, YDCPG_DYN9%XYB%ALPH, YDGEOMETRY%YRVERT_GEOM)
  ENDIF
...
!*     3.2.13 COMPUTES TERM "NHX".
  ...
  IF (LDGPXX) THEN
    ...
    & Z_UVH_UH_T9, Z_UVH_VH_T9, Z_NHXS_T_T9)
    ! * compute NHX_d = "divergence" part of NHX
