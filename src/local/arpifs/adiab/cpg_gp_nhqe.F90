...
ASSOCIATE(  YDCSGEOM=>YDGEOMETRY%YRCSGEOM(YDCPG_BNDS%KBL), &
...
& YDCPG_BNDS%KFDIA, YDVARS%GEOMETRY%RCORI%T0, YDVARS%GEOMETRY%GNORDL%T0, YDVARS%GEOMETRY%GNORDM%T0, Z_PSGRTL_T0, Z_PSGRTM_T0, YDVARS%U%T0,    &
...
CALL GNH_TNDLAGADIAB_UVS(NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, LRPLANE, YDVARS%GEOMETRY%RCORI%T0, YDCSGEOM%RATATX, &
