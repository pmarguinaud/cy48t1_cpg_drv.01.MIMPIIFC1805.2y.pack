...
@PROCESS NOCHECK
#endif
SUBROUTINE CPG_GP_NHQE(YDGEOMETRY, YDCPG_BNDS, YDCPG_OPTS, YDTMP, YDVARS, YDCPG_DYN0, YDCPG_DYN9, &
...
YDTMP%T0%ONE(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=1.0_JPRB
...
CALL GPRCPH(YDGEOMETRY, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_DYN0%RCP%KAP, YDTMP%T0%KAPH)
...
& PKAP=YDCPG_DYN0%RCP%KAP, PNHPREF=YDCPG_DYN0%NHPREF, PEQCHAF=YDTMP%T0%EQCHAF, PEIQCHAF=YDTMP%T0%EIQCHAF    &
& )
CALL GNHQE_PREH(YDGEOMETRY, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_DYN0%PRE, YDVARS%SPD%T0, YDCPG_DYN0%NHPREH, &
& PREF=YDCPG_DYN0%PREF, PEQCHAF=YDTMP%T0%EQCHAF, PKAPH=YDTMP%T0%KAPH, PEQCHAH=YDTMP%T0%EQCHAH)
...
CALL GPGEO(NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, NFLEVG, YDCPG_DYN0%PHI, YDCPG_DYN0%PHIF, YDTMP%T0%RT, &
& YDTMP%T0%ONE, YDCPG_DYN0%XYB%LNPR, YDCPG_DYN0%XYB%ALPH, YDGEOMETRY%YRVERT_GEOM)
...
CALL GNHQE_GRP(YDGEOMETRY, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDTMP%T0%RT, YDCPG_DYN0%RTL, YDCPG_DYN0%RTM,                 &
& YDCPG_DYN0%PREL, YDCPG_DYN0%PREM, YDCPG_DYN0%XYB%RDELP, YDCPG_DYN0%XYB%RTGR, YDCPG_DYN0%XYB%ALPH, PREHYDH=YDCPG_DYN0%PRE, &
& PQCHAF=YDVARS%SPD%T0, PQCHAL=YDCPG_DYN0%QCHAL, PQCHAM=YDCPG_DYN0%QCHAM, PEQCHAF=YDTMP%T0%EQCHAF, PEQCHAH=YDTMP%T0%EQCHAH, &
& PKAPF=YDCPG_DYN0%RCP%KAP, PKAPH=YDTMP%T0%KAPH, PHIHL=YDTMP%T0%GPHL, PHIHM=YDTMP%T0%GPHM, PHIFL=YDCPG_DYN0%PHIFL,          &
...
IF (LDGPXX) THEN
  ...
  & YDCPG_DYN0%UVH%VH, YDTMP%T0%NHXS_T)
  ...
  & YDCPG_DYN0%PREM, YDCPG_DYN0%RCP%KAP, YDTMP%T0%NHXD_T)
  ! * compute NHX
  DO JLEV=1,NFLEVG
    DO JROF=YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA
...
IF (LGWADV.AND.LVFE_GW) THEN
  ...
  & YDCPG_DYN0%OROGM, YDCPG_DYN0%XYB%LNPR, YDCPG_DYN0%XYB%ALPH, YDTMP%T0%US, YDTMP%T0%VS, YDTMP%T0%RT,        &
  & YDTMP%T0%DVER, YDTMP%T0%GWHT, YDCPG_DYN0%GWFT, PGDW=YDTMP%T0%GDW)
...
LLDER=.TRUE.
CALL GNHGRGW(YDGEOMETRY, NPROMA, NFLEVG, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, LLDER, YDTMP%T0%RT, YDCPG_DYN0%RTL,        &
& YDCPG_DYN0%RTM, YDTMP%T0%DVER, YDTMP%T0%DVERL, YDTMP%T0%DVERM, YDCPG_DYN0%XYB%LNPR, YDCPG_DYN0%XYB%ALPH,              &
& PUS=YDTMP%T0%US, PVS=YDTMP%T0%VS, PUS_L=YDTMP%T0%US_L, PVS_L=YDTMP%T0%VS_L, PUS_M=YDTMP%T0%US_M, PVS_M=YDTMP%T0%VS_M, &
& POROGL=YDCPG_DYN0%OROGL, POROGM=YDCPG_DYN0%OROGM, POROGLM=YDTMP%T0%OROGLM, POROGLL=YDTMP%T0%OROGLL,                   &
& POROGMM=YDTMP%T0%OROGMM, PGWFL=YDCPG_DYN0%GWFL, PGWFM=YDCPG_DYN0%GWFM, PGWHL=YDTMP%T0%GWHL, PGWHM=YDTMP%T0%GWHM,      &
& PLNPRL_DER=YDTMP%T0%XYBDER%LNPRL, PLNPRM_DER=YDTMP%T0%XYBDER%LNPRM, PALPHL_DER=YDTMP%T0%XYBDER%ALPHL,                 &
& PALPHM_DER=YDTMP%T0%XYBDER%ALPHM)
...
IF (LGWADV) THEN
  ...
  & YDCPG_DYN0%XYB%LNPR, YDCPG_DYN0%XYB%ALPH, YDCPG_DYN0%PREF, YDCPG_DYN0%PRE, YDTMP%T0%EQCHAF, YDCPG_DYN0%RCP%KAP, &
...
IF (.NOT.LGWADV) THEN
  ...
  & YDTMP%T0%OROGLM, YDTMP%T0%OROGLL, YDTMP%T0%OROGMM, YDCPG_DYN0%XYB%LNPR, YDCPG_DYN0%XYB%ALPH, YDCPG_DYN0%PREF,   &
  & YDCPG_DYN0%PRE, YDVARS%U%T0, YDVARS%V%T0, YDCPG_DYN0%UVH%UH, YDCPG_DYN0%UVH%VH, YDTMP%T0%TNDUS, YDTMP%T0%TNDVS, &
  & YDTMP%T0%EQCHAF, YDCPG_DYN0%RCP%KAP, YDCPG_DYN0%RDPHI, YDTMP%T0%GWHL, YDTMP%T0%GWHM, YDTMP%T0%DVER,             &
  & YDTMP%T0%NHXS_T, PATND(1, 1, YYTTND%M_TNDVD), YDCPG_DYN0%DBBC)
ENDIF
...
!*     3.2.4 COMPUTE "RT".
  ...
  YDTMP%T9%R9T(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDVARS%T%T9(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)*YDCPG_DYN9%RCP%R(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
...
!*     3.2.8 COMPUTES THE GEOPOTENTIAL HEIGHT "gz" AND ITS GRADIENT.
  ...
  IF((LDLDIAB.OR.LSIMPH)) THEN
    ...
    CALL GPGEO(NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, NFLEVG, YDCPG_DYN9%PHI, YDCPG_DYN9%PHIF, YDTMP%T9%R9T, &
    & YDTMP%T0%ONE, YDCPG_DYN9%XYB%LNPR, YDCPG_DYN9%XYB%ALPH, YDGEOMETRY%YRVERT_GEOM)
  ENDIF
...
!*     3.2.13 COMPUTES TERM "NHX".
  ...
  IF (LDGPXX) THEN
    ...
    & YDTMP%T9%UVH%UH, YDTMP%T9%UVH%VH, YDTMP%T9%NHXS_T)
    ! * compute NHX_d = "divergence" part of NHX
    CALL GNHQE_XXD(YDGEOMETRY, NFLEVG, NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDVARS%U%T9, YDVARS%V%T9, &
    & YDCPG_DYN0%XYB%LNPR, YDCPG_DYN9%XYB%RDELP, YDCPG_DYN9%XYB%ALPH, YDCPG_DYN9%XYB%RTGR, YDCPG_DYN9%PREL,  &
    & YDCPG_DYN9%PREM, YDCPG_DYN9%RCP%KAP, YDTMP%T9%NHXD_T)
    ! * compute NHX
    DO JLEV=1,NFLEVG
      DO JROF=YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA
...
!*     3.2.16 COMPUTES term [gw].
  ...
  IF (LGWADV.AND.LVFE_GW) THEN
    ...
    & YDCPG_DYN0%OROGM, YDCPG_DYN9%XYB%LNPR, YDCPG_DYN9%XYB%ALPH, YDTMP%T9%US, YDTMP%T9%VS, YDTMP%T9%R9T,      &
    & YDTMP%T9%DVER, YDTMP%T9%GWHT, YDCPG_DYN9%GWFT, PGDW=YDTMP%T9%GDW)
