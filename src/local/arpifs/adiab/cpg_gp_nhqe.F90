...
CALL GPHPRE_EXPL(YDMODEL%YRCST, NPROMA, NFLEVG, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDVAB, YDCPG_DYN0%PRE, PRESF=YDCPG_DYN0%PREF,   &
...
!*     3.2.1 COMPUTE PRE9, PXYB9, PRE9F.
  ...
  CALL GPHPRE_EXPL(YDMODEL%YRCST, NPROMA, NFLEVG, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDVAB, YDCPG_DYN9%PRE, PRESF=YDCPG_DYN9%PREF,   &
...
!*     3.2.10 COMPUTES HALF-LEVEL WINDS.
  ...
  IF (LDGPXX .AND. .NOT.LVERTFE) THEN
    ...
    CALL GPHLUV_EXPL (YDGEOMETRY%YRDIMV, NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDVARS%U%T9, YDVARS%V%T9, &
