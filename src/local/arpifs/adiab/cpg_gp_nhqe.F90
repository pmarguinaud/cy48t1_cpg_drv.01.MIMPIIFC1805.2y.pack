...
@PROCESS NOCHECK
#endif
SUBROUTINE CPG_GP_NHQE(YDGEOMETRY,YDCPG_BNDS, YDCPG_OPTS,YDTMP,YDVARS,YDCPG_DYN0,YDCPG_DYN9,YDMODEL,YDGMV,&
 !---------------------------------------------------------------------
 ! - INPUT .
...
CALL GPHLWI(YDGEOMETRY%YRDIMV,NPROMA,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,YDCPG_DYN0%XYB%LNPR,YDCPG_DYN0%XYB%ALPH,YDCPG_DYN0%UVH%WWI (1:,1:))
...
IF (LDGPXX) THEN
  ...
  CALL GNHQE_XXD(YDGEOMETRY,NFLEVG,NPROMA,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,&
...
IF (LGWADV) THEN
  ...
  CALL GNHQE_TNDLAGADIAB_GW(YDGEOMETRY,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,&
...
IF (.NOT.LGWADV) THEN
  ...
  CALL GNHQE_TNDLAGADIAB_SVD(YDGEOMETRY,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,&
   & YDCPG_DYN0%OROGL,YDCPG_DYN0%OROGM,YDTMP%T0%OROGLM,YDTMP%T0%OROGLL,YDTMP%T0%OROGMM,&
   & YDCPG_DYN0%XYB%LNPR,YDCPG_DYN0%XYB%ALPH,YDCPG_DYN0%PREF,YDCPG_DYN0%PRE,&
