...
CALL GNH_TNDLAGADIAB_UVS(NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, LRPLANE, YDVARS%GEOMETRY%RCORI%T0, YDVARS%GEOMETRY%RATATX%T0, &
& YDVARS%GEOMETRY%RATATH%T0, Z_US_T0, Z_VS_T0, Z_SGRTSL_T0, Z_SGRTSM_T0, Z_TNDUS_T0, Z_TNDVS_T0    )
