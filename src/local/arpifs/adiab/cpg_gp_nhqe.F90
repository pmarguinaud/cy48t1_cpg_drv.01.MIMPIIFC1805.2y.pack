...
&                                   )
CALL GNHQE_PREH(YDCPG_OPTS%LVERTFE, YDCPG_OPTS%NPDVAR, YDGEOMETRY, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA,          &
...
IF (LDGPXX) THEN
  ...
  CALL GNHQE_XXD(YDCPG_OPTS%LRUBC, YDCPG_OPTS%LVERTFE, YDGEOMETRY, NFLEVG, NPROMA, YDCPG_BNDS%KIDIA,            &
...
CALL CPG_GP_NHQE_T9 (YDGEOMETRY, YDCPG_BNDS, YDCPG_OPTS, YDVARS, YDCPG_DYN0, YDMODEL, LDGPXX, YDCPG_OPTS%LGWADV, &
& YDCPG_OPTS%LRDBBC, YDCPG_OPTS%LVERTFE, YDCPG_OPTS%LVFE_GW, Z_GPHL_T0, Z_GPHM_T0, Z_ONE_T0,                     &
