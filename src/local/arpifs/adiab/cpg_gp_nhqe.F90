...
& Z_PSGRTL_T0, Z_PSGRTM_T0, YDVARS%U%T0, YDVARS%V%T0, PATND(:, :, YYTTND%M_TNDU), PATND(:, :, YYTTND%M_TNDV),   &
& PATND(:, :, YYTTND%M_TNDU_NOC), PATND(:, :, YYTTND%M_TNDV_NOC))
...
IF (LGWADV) THEN
  ...
  & YDCPG_DYN0%XYB%ALPH, YDCPG_DYN0%PREF, YDCPG_DYN0%PRE, Z_EQCHAF_T0, YDCPG_DYN0%RCP%KAP, PATND(:, :, YYTTND%M_TNDGW)&
  &   )
ENDIF
...
IF (.NOT.LGWADV) THEN
  ...
  & Z_NHXS_T_T0, PATND(:, :, YYTTND%M_TNDVD), YDCPG_DYN0%DBBC)
ENDIF
...
CALL CPG_GP_NHQE_T9 (YDGEOMETRY, YDCPG_BNDS, YDVARS, YDCPG_DYN0, YDMODEL, LDGPXX, LGWADV, LLDER, LLGDWI, &
                   & LRDBBC, LVERTFE, LVFE_GW, Z_GPHL_T0, Z_GPHM_T0, Z_ONE_T0, YDCPG_DYN9, LDLDIAB, LDMPA)
