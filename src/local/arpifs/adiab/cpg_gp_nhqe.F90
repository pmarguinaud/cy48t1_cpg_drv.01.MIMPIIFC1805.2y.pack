...
USE YOMCT0   , ONLY : LTWOTL, LSPRT, LRPLANE, LSFORC, LNHDYN
...
CALL GPGEO_EXPL(LVERTFE, NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, NFLEVG, YDCPG_DYN0%PHI, YDCPG_DYN0%PHIF, &
...
CALL CPG_GP_NHQE_T9 (YDGEOMETRY, YDCPG_BNDS, YDCPG_OPTS, YDVARS, YDCPG_DYN0, YDMODEL, LDGPXX, LGWADV, &
