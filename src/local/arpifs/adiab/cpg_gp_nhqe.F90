...
CALL GPHPRE_EXPL(NPROMA, NFLEVG, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDVAB, YDCPG_DYN0%PRE, PRESF=YDCPG_DYN0%PREF,   &
...
!*     3.2.1 COMPUTE PRE9, PXYB9, PRE9F.
  ...
  CALL GPHPRE_EXPL(NPROMA, NFLEVG, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDVAB, YDCPG_DYN9%PRE, PRESF=YDCPG_DYN9%PREF,   &
