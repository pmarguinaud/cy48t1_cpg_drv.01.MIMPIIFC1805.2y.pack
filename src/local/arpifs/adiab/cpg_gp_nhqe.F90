...
CALL GNHPRE(YDCPG_OPTS%NPDVAR, YDGEOMETRY, NPROMA, NFLEVG, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDVARS%SPD%T0, YDCPG_DYN0%PREF, &
& PKAP=YDCPG_DYN0%RCP%KAP, PNHPREF=YDCPG_DYN0%NHPREF, PEQCHAF=Z_EQCHAF_T0, PEIQCHAF=Z_EIQCHAF_T0            &
&                     )
CALL GNHQE_PREH(YDCPG_OPTS%LVERTFE, YDCPG_OPTS%NPDVAR, YDGEOMETRY, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_DYN0%PRE, YDVARS%SPD%T0, YDCPG_DYN0%NHPREH, &
...
CALL GPGEO_EXPL(YDCPG_OPTS%LVERTFE, NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, NFLEVG, YDCPG_DYN0%PHI, YDCPG_DYN0%PHIF, &
...
CALL GNHQE_GRP(YDCPG_OPTS%LVERTFE, YDGEOMETRY, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, Z_RT_T0, YDCPG_DYN0%RTL, YDCPG_DYN0%RTM,                             &
...
IF (LDGPXX) THEN
  ...
  CALL GNHQE_XXD(YDCPG_OPTS%LRUBC, YDCPG_OPTS%LVERTFE, YDGEOMETRY, NFLEVG, NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDVARS%U%T0, YDVARS%V%T0, &
...
LLDER=.TRUE.
CALL GNHGRGW(YDCPG_OPTS%LVERTFE, YDGEOMETRY, NPROMA, NFLEVG, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, LLDER, Z_RT_T0, YDCPG_DYN0%RTL,           &
...
IF (YDCPG_OPTS%LGWADV) THEN
  ...
  IF (YDCPG_OPTS%LVFE_LAPL_BC.OR.YDCPG_OPTS%LVFE_GW) CALL ABOR1(' CPG_GP_NHQE 3.1.21: option not yet coded!')

  CALL GNHQE_TNDLAGADIAB_GW(YDCPG_OPTS%LVFE_GW, YDCPG_OPTS%LVFE_LAPL_BC, YDMODEL%YRCST, YDGEOMETRY, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_DYN0%OROGL, YDCPG_DYN0%OROGM,       &
  & P_OROGLM_T0, P_OROGLL_T0, P_OROGMM_T0, Z_US_T0, Z_VS_T0, Z_TNDUS_T0, Z_TNDVS_T0, YDCPG_DYN0%XYB%LNPR,             &
  & YDCPG_DYN0%XYB%ALPH, YDCPG_DYN0%PREF, YDCPG_DYN0%PRE, Z_EQCHAF_T0, YDCPG_DYN0%RCP%KAP, YDCPG_TND%TNDGW&
  &   )
ENDIF
...
IF (.NOT.YDCPG_OPTS%LGWADV) THEN
  ...
  CALL GNHQE_TNDLAGADIAB_SVD(YDCPG_OPTS%LVFE_LAPL_BC, YDCPG_OPTS%LVERTFE, YDMODEL%YRCST, YDGEOMETRY, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_DYN0%OROGL, YDCPG_DYN0%OROGM, &
  ...
  & Z_NHXS_T_T0, YDCPG_TND%TNDVD, YDCPG_DYN0%DBBC)
ENDIF
...
CALL CPG_GP_NHQE_T9 (YDGEOMETRY, YDCPG_BNDS, YDCPG_OPTS, YDVARS, YDCPG_DYN0, YDMODEL, LDGPXX, YDCPG_OPTS%LGWADV, &
                   & YDCPG_OPTS%LRDBBC, YDCPG_OPTS%LVERTFE, YDCPG_OPTS%LVFE_GW, Z_GPHL_T0, Z_GPHM_T0, Z_ONE_T0, YDCPG_DYN9, LDLDIAB, LDMPA)
