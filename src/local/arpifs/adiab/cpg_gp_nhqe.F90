...
#include "cpg_gp_nhqe_t9.intfb.h"
...
& YDCPG_DYN0%PREF, PKAP=YDCPG_DYN0%RCP%KAP, PNHPREF=YDCPG_DYN0%NHPREF, PEQCHAF=Z_EQCHAF_T0, PEIQCHAF=Z_EIQCHAF_T0&
&                                   )
CALL GNHQE_PREH(YDCPG_OPTS%LVERTFE, YDMODEL%YRML_DYN%YRDYNA%NPDVAR, YDGEOMETRY, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA,          &
& YDCPG_DYN0%PRE, YDVARS%SPD%T0, YDCPG_DYN0%NHPREH, PREF=YDCPG_DYN0%PREF, PEQCHAF=Z_EQCHAF_T0, PKAPH=Z_KAPH_T0, &
& PEQCHAH=Z_EQCHAH_T0)
...
& YDCPG_DYN0%PHIF, Z_RT_T0, Z_ONE_T0, YDCPG_DYN0%XYB%LNPR, YDCPG_DYN0%XYB%ALPH, YDGEOMETRY%YRVERT_GEOM  &
& )
...
& PLNPRL_DER=Z_XYBDER_LNPRL_T0, PLNPRM_DER=Z_XYBDER_LNPRM_T0, PALPHL_DER=Z_XYBDER_ALPHL_T0, PALPHM_DER=Z_XYBDER_ALPHM_T0&
&                                                                               )
...
CALL GNHQE_GRP(YDCPG_OPTS%LVERTFE, YDGEOMETRY, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, Z_RT_T0, YDCPG_DYN0%RTL,                         &
& YDCPG_DYN0%RTM, YDCPG_DYN0%PREL, YDCPG_DYN0%PREM, YDCPG_DYN0%XYB%RDELP, YDCPG_DYN0%XYB%RTGR, YDCPG_DYN0%XYB%ALPH,                 &
& PREHYDH=YDCPG_DYN0%PRE, PQCHAF=YDVARS%SPD%T0, PQCHAL=YDCPG_DYN0%QCHAL, PQCHAM=YDCPG_DYN0%QCHAM, PEQCHAF=Z_EQCHAF_T0,              &
& PEQCHAH=Z_EQCHAH_T0, PKAPF=YDCPG_DYN0%RCP%KAP, PKAPH=Z_KAPH_T0, PHIHL=Z_GPHL_T0, PHIHM=Z_GPHM_T0, PHIFL=YDCPG_DYN0%PHIFL,         &
...
IF (LDGPXX) THEN
  ...
  & YDVARS%V%T0, YDCPG_DYN0%UVH%UH, YDCPG_DYN0%UVH%VH, Z_NHXS_T_T0)
  ! * compute NHX_d = "divergence" part of NHX
  CALL GNHQE_XXD(YDMODEL%YRML_DYN%YRDYNA%LRUBC, YDCPG_OPTS%LVERTFE, YDGEOMETRY, NFLEVG, NPROMA, YDCPG_BNDS%KIDIA,            &
  & YDCPG_BNDS%KFDIA, YDVARS%U%T0, YDVARS%V%T0, YDCPG_DYN0%XYB%LNPR, YDCPG_DYN0%XYB%RDELP, YDCPG_DYN0%XYB%ALPH, &
  & YDCPG_DYN0%XYB%RTGR, YDCPG_DYN0%PREL, YDCPG_DYN0%PREM, YDCPG_DYN0%RCP%KAP, Z_NHXD_T_T0)
  ! * compute NHX
  DO JLEV=1,NFLEVG
    DO JROF=YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA
...
IF (YDMODEL%YRML_DYN%YRDYNA%LGWADV.AND.YDCPG_OPTS%LVFE_GW) THEN
  ...
  & YDCPG_BNDS%KFDIA, LLGWF0, LLGDWI, YDCPG_DYN0%OROGL, YDCPG_DYN0%OROGM, YDCPG_DYN0%XYB%LNPR, YDCPG_DYN0%XYB%ALPH,  &
  & Z_US_T0, Z_VS_T0, Z_RT_T0, Z_DVER_T0, P_GWHT_T0, YDCPG_DYN0%GWFT, PGDW=P_GDW_T0)

  YDCPG_DYN0%GWT(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDCPG_DYN0%GWFT(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
ELSE
  CALL GPGW(YDCPG_OPTS%LNHDYN, YDCPG_OPTS%LVERTFE, YDCPG_OPTS%LVFE_GW, YDGEOMETRY, NFLEVG, NPROMA, YDCPG_BNDS%KIDIA, &
  & YDCPG_BNDS%KFDIA, LLGWF0, LLGDWI, YDCPG_DYN0%OROGL, YDCPG_DYN0%OROGM, YDCPG_DYN0%XYB%LNPR, YDCPG_DYN0%XYB%ALPH,  &
  & Z_US_T0, Z_VS_T0, Z_RT_T0, Z_DVER_T0, P_GWHT_T0, YDCPG_DYN0%GWFT)
...
& LLDER, Z_RT_T0, YDCPG_DYN0%RTL, YDCPG_DYN0%RTM, Z_DVER_T0, Z_DVERL_T0, Z_DVERM_T0, YDCPG_DYN0%XYB%LNPR,            &
& YDCPG_DYN0%XYB%ALPH, PUS=Z_US_T0, PVS=Z_VS_T0, PUS_L=Z_US_L_T0, PVS_L=Z_VS_L_T0, PUS_M=Z_US_M_T0, PVS_M=Z_VS_M_T0, &
& POROGL=YDCPG_DYN0%OROGL, POROGM=YDCPG_DYN0%OROGM, POROGLM=P_OROGLM_T0, POROGLL=P_OROGLL_T0, POROGMM=P_OROGMM_T0,   &
& PGWFL=YDCPG_DYN0%GWFL, PGWFM=YDCPG_DYN0%GWFM, PGWHL=Z_GWHL_T0, PGWHM=Z_GWHM_T0, PLNPRL_DER=Z_XYBDER_LNPRL_T0,      &
...
IF (YDMODEL%YRML_DYN%YRDYNA%LGWADV) THEN
  ...
  IF (YDCPG_OPTS%LVFE_LAPL_BC.OR.YDCPG_OPTS%LVFE_GW) CALL ABOR1(&
                                                     & ' CPG_GP_NHQE 3.1.21: option not yet coded!')

  CALL GNHQE_TNDLAGADIAB_GW(YDCPG_OPTS%LVFE_GW, YDCPG_OPTS%LVFE_LAPL_BC, YDMODEL%YRCST, YDGEOMETRY, YDCPG_BNDS%KIDIA, &
  & YDCPG_BNDS%KFDIA, YDCPG_DYN0%OROGL, YDCPG_DYN0%OROGM, P_OROGLM_T0, P_OROGLL_T0, P_OROGMM_T0,                      &
  & Z_US_T0, Z_VS_T0, Z_TNDUS_T0, Z_TNDVS_T0, YDCPG_DYN0%XYB%LNPR, YDCPG_DYN0%XYB%ALPH, YDCPG_DYN0%PREF,              &
  & YDCPG_DYN0%PRE, Z_EQCHAF_T0, YDCPG_DYN0%RCP%KAP, YDCPG_TND%TNDGW    )
ENDIF
...
IF (.NOT.YDMODEL%YRML_DYN%YRDYNA%LGWADV) THEN
  IF (YDCPG_OPTS%LVERTFE) CALL ABOR1(' CPG_GP_NHQE 3.1.23: not yet coded case')

  CALL GNHQE_TNDLAGADIAB_SVD(YDCPG_OPTS%LVFE_LAPL_BC, YDCPG_OPTS%LVERTFE, YDMODEL%YRCST, YDGEOMETRY,            &
  & YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_DYN0%OROGL, YDCPG_DYN0%OROGM, P_OROGLM_T0, P_OROGLL_T0,           &
  & P_OROGMM_T0, YDCPG_DYN0%XYB%LNPR, YDCPG_DYN0%XYB%ALPH, YDCPG_DYN0%PREF, YDCPG_DYN0%PRE, YDVARS%U%T0,        &
  & YDVARS%V%T0, YDCPG_DYN0%UVH%UH, YDCPG_DYN0%UVH%VH, Z_TNDUS_T0, Z_TNDVS_T0, Z_EQCHAF_T0, YDCPG_DYN0%RCP%KAP, &
  & YDCPG_DYN0%RDPHI, Z_GWHL_T0, Z_GWHM_T0, Z_DVER_T0, Z_NHXS_T_T0, YDCPG_TND%TNDVD, YDCPG_DYN0%DBBC            &
  & )
ENDIF
...
CALL CPG_GP_NHQE_T9 (YDGEOMETRY, YDCPG_BNDS, YDCPG_OPTS, YDVARS, YDCPG_DYN0, YDMODEL, LDGPXX, YDMODEL%YRML_DYN%YRDYNA%LGWADV, &
& YDMODEL%YRML_DYN%YRDYNA%LRDBBC, YDCPG_OPTS%LVERTFE, YDCPG_OPTS%LVFE_GW, Z_GPHL_T0, Z_GPHM_T0, Z_ONE_T0,                     &
