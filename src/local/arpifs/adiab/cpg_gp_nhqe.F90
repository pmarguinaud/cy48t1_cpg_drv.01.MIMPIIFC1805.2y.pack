...
LLDER=.TRUE.
CALL GNHGRGW(LVERTFE, YDGEOMETRY, NPROMA, NFLEVG, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, LLDER, Z_RT_T0, YDCPG_DYN0%RTL,           &
...
IF (LGWADV) THEN
  ...
  CALL GNHQE_TNDLAGADIAB_GW(LVFE_GW, LVFE_LAPL_BC, YDMODEL%YRCST, YDGEOMETRY, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_DYN0%OROGL, YDCPG_DYN0%OROGM,       &
...
IF (.NOT.LGWADV) THEN
  ...
  CALL GNHQE_TNDLAGADIAB_SVD(YDMODEL%YRCST, YDGEOMETRY, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_DYN0%OROGL, YDCPG_DYN0%OROGM, &
