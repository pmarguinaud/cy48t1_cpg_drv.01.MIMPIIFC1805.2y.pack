...
USE YOMDYNA  , ONLY : LGWADV, LRDBBC, LGRADSP, LRUBC, NPDVAR
...
&                     )
CALL GNHQE_PREH(LVERTFE, NPDVAR, YDGEOMETRY, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_DYN0%PRE, YDVARS%SPD%T0, YDCPG_DYN0%NHPREH, &
...
CALL GNHQE_GRP(LVERTFE, YDGEOMETRY, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, Z_RT_T0, YDCPG_DYN0%RTL, YDCPG_DYN0%RTM,                             &
...
IF (LDGPXX) THEN
  ...
  CALL GNHQE_XXD(LRUBC, LVERTFE, YDGEOMETRY, NFLEVG, NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDVARS%U%T0, YDVARS%V%T0, &
...
IF (.NOT.LGWADV) THEN
  ...
  CALL GNHQE_TNDLAGADIAB_SVD(LVERTFE, YDMODEL%YRCST, YDGEOMETRY, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_DYN0%OROGL, YDCPG_DYN0%OROGM, &
