SUBROUTINE CPG_GP_NHQE_T9 (YDGEOMETRY, YDCPG_BNDS, YDCPG_OPTS, YDVARS, YDCPG_DYN0, YDMODEL, LDGPXX, LDGWADV, &
                         & LDRDBBC, LDVERTFE, LDVFE_GW, P_GPHL_T0, P_GPHM_T0, P_ONE_T0, YDCPG_DYN9, &
                         & LDLDIAB, LDMPA)
...
CALL GNHQE_PREH(YDCPG_OPTS%LVERTFE, YDCPG_OPTS%NPDVAR, YDGEOMETRY, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_DYN9%PRE, YDVARS%SPD%T9, YDCPG_DYN9%NHPREH&
&     )
...
IF((LDLDIAB.OR.YDMODEL%YRML_PHY_MF%YRSIMPHL%LSIMPH)) THEN
  ...
  CALL GPGEO_EXPL(YDCPG_OPTS%LVERTFE,YDGEOMETRY%YRDIM%NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDGEOMETRY%YRDIMV%NFLEVG, YDCPG_DYN9%PHI, YDCPG_DYN9%PHIF, &
...
IF (LDGPXX) THEN
  ...
  CALL GNHQE_XXD(YDCPG_OPTS%LRUBC, YDCPG_OPTS%LVERTFE, YDGEOMETRY, YDGEOMETRY%YRDIMV%NFLEVG, YDGEOMETRY%YRDIM%NPROMA, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDVARS%U%T9, YDVARS%V%T9, &
