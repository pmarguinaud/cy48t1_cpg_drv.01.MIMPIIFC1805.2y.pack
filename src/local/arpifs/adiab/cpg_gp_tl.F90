...
REAL(KIND=JPRB), POINTER :: ZT0L(:,:), ZT9L(:,:), ZT0I(:,:), ZT9I(:,:), ZT0R(:,:), ZT9R(:,:), ZT0S(:,:), ZT9S(:,:)
...
CALL SC2PRG(YL%MP    ,PGFL    ,ZT0L)
CALL SC2PRG(YL%MP9   ,PGFL    ,ZT9L)
CALL SC2PRG(YI%MP    ,PGFL    ,ZT0I)
CALL SC2PRG(YI%MP9   ,PGFL    ,ZT9I)
CALL SC2PRG(YR%MP    ,PGFL    ,ZT0R)
CALL SC2PRG(YR%MP9   ,PGFL    ,ZT9R)
CALL SC2PRG(YS%MP    ,PGFL    ,ZT0S)
CALL SC2PRG(YS%MP9   ,PGFL    ,ZT9S)
...
CALL GPINISLB(&
 ! --- INPUT ---------------------------------------------------------
 & YDML_DYN%YRDYNA%LGWADV, LNHDYN, YDML_DYN%YRDYNA%LNHX, LSLAG, LTWOTL, LVERTFE, LVFE_GW, &
 & YDGEOMETRY,YGFL,YDDYN,YDPTRSLB2,KST,KEND,PTE,&
 & PGFL,&
 & ZT9U,ZT9V,ZT9T,&
 & ZT9SPD,ZT9SVD,ZDUM,&
 & ZT9SP,&
