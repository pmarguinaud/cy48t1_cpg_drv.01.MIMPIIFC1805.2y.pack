SUBROUTINE CPG_PT_ULP(YDMODEL, YDGEOMETRY, YDCPG_SL1, YDVARS, YGFL,KSTART, KPROF,LDGET,KFLDN,KFLDX,  &
          & PTENDGFL, PGFLPT, PGFLT1, PGFL)
...
ZTENDGFL => YDCPG_SL1%ZVIEW(:, ISLB1GFL9:)
