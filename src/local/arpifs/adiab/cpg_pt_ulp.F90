...
REAL(KIND=JPRB),INTENT(INOUT) :: PTENDU(YDGEOMETRY%YRDIM%NPROMA,KFLDN:KFLDX)
REAL(KIND=JPRB),INTENT(INOUT) :: PTENDV(YDGEOMETRY%YRDIM%NPROMA,KFLDN:KFLDX)
REAL(KIND=JPRB),INTENT(INOUT) :: PTENDT(YDGEOMETRY%YRDIM%NPROMA,KFLDN:KFLDX)
REAL(KIND=JPRB),INTENT(INOUT) :: PTENDVD(YDGEOMETRY%YRDIM%NPROMA,KFLDN:KFLDX)
REAL(KIND=JPRB),INTENT(INOUT) :: PTENDSP(YDGEOMETRY%YRDIM%NPROMA)
...
IF (.NOT.LDGET) THEN
  ...
  ! * GMV:
  PGMV(KSTART:KPROF,1:NFLEVG,YT9%MCUPT)=YLMF_PHYS_NEXT_STATE%U(KSTART:KPROF,1:NFLEVG)
  PGMV(KSTART:KPROF,1:NFLEVG,YT9%MCVPT)=YLMF_PHYS_NEXT_STATE%V(KSTART:KPROF,1:NFLEVG)
  PGMV(KSTART:KPROF,1:NFLEVG,YT9%MCTPT)=YLMF_PHYS_NEXT_STATE%T(KSTART:KPROF,1:NFLEVG)
  IF (LNHDYN) THEN
    PGMV(KSTART:KPROF,1:NFLEVG,YT9%MCSVDPT)=YLMF_PHYS_NEXT_STATE%SVD(KSTART:KPROF,1:NFLEVG)
  ENDIF
...
IF (LDGET) THEN
  ...
  ! * GMV:
  YLMF_PHYS_NEXT_STATE%U(KSTART:KPROF,1:NFLEVG)=PGMV(KSTART:KPROF,1:NFLEVG,YT9%MCUPT)
  YLMF_PHYS_NEXT_STATE%V(KSTART:KPROF,1:NFLEVG)=PGMV(KSTART:KPROF,1:NFLEVG,YT9%MCVPT)
  YLMF_PHYS_NEXT_STATE%T(KSTART:KPROF,1:NFLEVG)=PGMV(KSTART:KPROF,1:NFLEVG,YT9%MCTPT)
  IF (LNHDYN) THEN
    YLMF_PHYS_NEXT_STATE%SVD(KSTART:KPROF,1:NFLEVG)=PGMV(KSTART:KPROF,1:NFLEVG,YT9%MCSVDPT)
  ENDIF
