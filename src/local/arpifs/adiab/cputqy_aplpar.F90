SUBROUTINE CPUTQY_APLPAR(YDMF_PHYS_NEXT_STATE, YDVARS,YDDIMV,YDGMV, YGFL,YDPTRSLB1,YDPHY,KPROMA, KST, KPROF, KFLEV, PDT, KPGFL, &
 !  Pointeurs
...
DO JLEV=1,KFLEV
  DO JROF=KST,KPROF
    YDMF_PHYS_NEXT_STATE%U (JROF, JLEV+1-YDMF_PHYS_NEXT_STATE%ILEV0) = &
  & YDMF_PHYS_NEXT_STATE%U (JROF, JLEV+1-YDMF_PHYS_NEXT_STATE%ILEV0) + PDT*PTENDU(JROF,JLEV)
    YDMF_PHYS_NEXT_STATE%V (JROF, JLEV+1-YDMF_PHYS_NEXT_STATE%ILEV0) = &
  & YDMF_PHYS_NEXT_STATE%V (JROF, JLEV+1-YDMF_PHYS_NEXT_STATE%ILEV0) + PDT*PTENDV(JROF,JLEV)
    YDMF_PHYS_NEXT_STATE%T (JROF, JLEV+1-YDMF_PHYS_NEXT_STATE%ILEV0) = &
  & YDMF_PHYS_NEXT_STATE%T (JROF, JLEV+1-YDMF_PHYS_NEXT_STATE%ILEV0) + ZDTT1(JROF,JLEV)
  ENDDO
ENDDO
...
IF(LNHDYN) THEN
  DO JLEV=1,KFLEV
    DO JROF=KST,KPROF
      YDMF_PHYS_NEXT_STATE%SVD (JROF, JLEV+1-YDMF_PHYS_NEXT_STATE%ILEV0) = &
    & YDMF_PHYS_NEXT_STATE%SVD (JROF, JLEV+1-YDMF_PHYS_NEXT_STATE%ILEV0) + PDT*PTENDD(JROF,JLEV)
    ENDDO
  ENDDO
ENDIF
