...
YDMF_PHYS_BASE_STATE, YDVARS, YDPHY,PDT, &
 !  Variables 2D Input
 & PTENDH, PTENDT, PTENDU, PTENDV, PTENDU_ZDEC, PTENDV_ZDEC, PTENDD, &
...
TYPE (MF_PHYS_BASE_STATE_TYPE), INTENT(INOUT) :: YDMF_PHYS_BASE_STATE
...
IF (YDVARS%L%LT1)     ZTDCP(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,:)=ZTDCP(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,:)+(YDVARS%L%RCP-RCPD)    *PTENDL(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,:)
IF (YDVARS%I%LT1)     ZTDCP(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,:)=ZTDCP(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,:)+(YDVARS%I%RCP-RCPD)    *PTENDI(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,:)
IF (YDVARS%S%LT1)     ZTDCP(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,:)=ZTDCP(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,:)+(YDVARS%S%RCP-RCPD)    *PTENDS(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,:)
IF (YDVARS%R%LT1)     ZTDCP(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,:)=ZTDCP(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,:)+(YDVARS%R%RCP-RCPD)    *PTENDR(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,:)
IF (YDVARS%LCONV%LT1) ZTDCP(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,:)=ZTDCP(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,:)+(YDVARS%LCONV%RCP-RCPD)*PTENDLCONV(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,:)
IF (YDVARS%ICONV%LT1) ZTDCP(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,:)=ZTDCP(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,:)+(YDVARS%ICONV%RCP-RCPD)*PTENDICONV(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,:)
IF (YDVARS%RCONV%LT1) ZTDCP(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,:)=ZTDCP(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,:)+(YDVARS%RCONV%RCP-RCPD)*PTENDRCONV(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,:)
IF (YDVARS%SCONV%LT1) ZTDCP(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,:)=ZTDCP(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,:)+(YDVARS%SCONV%RCP-RCPD)*PTENDSCONV(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,:)
IF (YDVARS%Q%LT1)     ZTDCP(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,:)=ZTDCP(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,:)+(YDVARS%Q%RCP-RCPD)    *PTENDQ(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,:)
