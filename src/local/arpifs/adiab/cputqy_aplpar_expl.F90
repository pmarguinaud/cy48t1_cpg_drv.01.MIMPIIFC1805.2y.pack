...
CALL CPUTQY0 (YDCPG_DIM, YDCPG_OPTS, YDCPG_DIM%YRVARS%U, PDT, YDMF_PHYS_NEXT_STATE%U, PTENDU)
CALL CPUTQY0 (YDCPG_DIM, YDCPG_OPTS, YDCPG_DIM%YRVARS%V, PDT, YDMF_PHYS_NEXT_STATE%V, PTENDV)
CALL CPUTQY0 (YDCPG_DIM, YDCPG_OPTS, YDCPG_DIM%YRVARS%T, 1._JPRB, YDMF_PHYS_NEXT_STATE%T, ZDTT1)

IF (LNHDYN) THEN
  CALL CPUTQY0 (YDCPG_DIM, YDCPG_OPTS, YDCPG_DIM%YRVARS%SVD, PDT, YDMF_PHYS_NEXT_STATE%SVD, PTENDD)
ENDIF

IF (YDVARS%L%LT1)     CALL CPUTQY0 (YDCPG_DIM, YDCPG_OPTS, YDCPG_DIM%YRVARS%L,     PDT, YDMF_PHYS_NEXT_STATE%L,     PTENDL)
IF (YDVARS%I%LT1)     CALL CPUTQY0 (YDCPG_DIM, YDCPG_OPTS, YDCPG_DIM%YRVARS%I,     PDT, YDMF_PHYS_NEXT_STATE%I,     PTENDI)
IF (YDVARS%S%LT1)     CALL CPUTQY0 (YDCPG_DIM, YDCPG_OPTS, YDCPG_DIM%YRVARS%S,     PDT, YDMF_PHYS_NEXT_STATE%S,     PTENDS)
IF (YDVARS%R%LT1)     CALL CPUTQY0 (YDCPG_DIM, YDCPG_OPTS, YDCPG_DIM%YRVARS%R,     PDT, YDMF_PHYS_NEXT_STATE%R,     PTENDR)
IF (YDVARS%G%LT1)     CALL CPUTQY0 (YDCPG_DIM, YDCPG_OPTS, YDCPG_DIM%YRVARS%G,     PDT, YDMF_PHYS_NEXT_STATE%G,     PTENDG)
IF (YDVARS%TKE%LT1)   CALL CPUTQY0 (YDCPG_DIM, YDCPG_OPTS, YDCPG_DIM%YRVARS%TKE,   PDT, YDMF_PHYS_NEXT_STATE%TKE,   PTENDTKE)
IF (YDVARS%EFB1%LT1)  CALL CPUTQY0 (YDCPG_DIM, YDCPG_OPTS, YDCPG_DIM%YRVARS%EFB1,  PDT, YDMF_PHYS_NEXT_STATE%EFB1,  PTENDEFB1)
IF (YDVARS%EFB2%LT1)  CALL CPUTQY0 (YDCPG_DIM, YDCPG_OPTS, YDCPG_DIM%YRVARS%EFB2,  PDT, YDMF_PHYS_NEXT_STATE%EFB2,  PTENDEFB2)
IF (YDVARS%EFB3%LT1)  CALL CPUTQY0 (YDCPG_DIM, YDCPG_OPTS, YDCPG_DIM%YRVARS%EFB3,  PDT, YDMF_PHYS_NEXT_STATE%EFB3,  PTENDEFB3)
IF (YDVARS%LCONV%LT1) CALL CPUTQY0 (YDCPG_DIM, YDCPG_OPTS, YDCPG_DIM%YRVARS%LCONV, PDT, YDMF_PHYS_NEXT_STATE%LCONV, PTENDLCONV)
IF (YDVARS%ICONV%LT1) CALL CPUTQY0 (YDCPG_DIM, YDCPG_OPTS, YDCPG_DIM%YRVARS%ICONV, PDT, YDMF_PHYS_NEXT_STATE%ICONV, PTENDICONV)
IF (YDVARS%RCONV%LT1) CALL CPUTQY0 (YDCPG_DIM, YDCPG_OPTS, YDCPG_DIM%YRVARS%RCONV, PDT, YDMF_PHYS_NEXT_STATE%RCONV, PTENDRCONV)
IF (YDVARS%SCONV%LT1) CALL CPUTQY0 (YDCPG_DIM, YDCPG_OPTS, YDCPG_DIM%YRVARS%SCONV, PDT, YDMF_PHYS_NEXT_STATE%SCONV, PTENDSCONV)
IF (YDVARS%Q%LT1)     CALL CPUTQY0 (YDCPG_DIM, YDCPG_OPTS, YDCPG_DIM%YRVARS%Q,     PDT, YDMF_PHYS_NEXT_STATE%Q,     PTENDQ)
