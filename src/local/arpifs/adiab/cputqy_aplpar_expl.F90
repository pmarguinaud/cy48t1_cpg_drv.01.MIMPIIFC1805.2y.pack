...
#include "cputqy_aplpar_expl_acctnd.intfb.h"
...
CALL CPUTQY_APLPAR_EXPL_ACCTND (YDCST, YDVARS%L%LT1,     YDCPG_OPTS, YDCPG_BNDS, YDVARS%L%RCP,     ZTDCP, PTENDL      )
CALL CPUTQY_APLPAR_EXPL_ACCTND (YDCST, YDVARS%I%LT1,     YDCPG_OPTS, YDCPG_BNDS, YDVARS%I%RCP,     ZTDCP, PTENDI      )
CALL CPUTQY_APLPAR_EXPL_ACCTND (YDCST, YDVARS%S%LT1,     YDCPG_OPTS, YDCPG_BNDS, YDVARS%S%RCP,     ZTDCP, PTENDS      )
CALL CPUTQY_APLPAR_EXPL_ACCTND (YDCST, YDVARS%R%LT1,     YDCPG_OPTS, YDCPG_BNDS, YDVARS%R%RCP,     ZTDCP, PTENDR      )
CALL CPUTQY_APLPAR_EXPL_ACCTND (YDCST, YDVARS%LCONV%LT1, YDCPG_OPTS, YDCPG_BNDS, YDVARS%LCONV%RCP, ZTDCP, PTENDLCONV  )
CALL CPUTQY_APLPAR_EXPL_ACCTND (YDCST, YDVARS%ICONV%LT1, YDCPG_OPTS, YDCPG_BNDS, YDVARS%ICONV%RCP, ZTDCP, PTENDICONV  )
CALL CPUTQY_APLPAR_EXPL_ACCTND (YDCST, YDVARS%RCONV%LT1, YDCPG_OPTS, YDCPG_BNDS, YDVARS%RCONV%RCP, ZTDCP, PTENDRCONV  )
CALL CPUTQY_APLPAR_EXPL_ACCTND (YDCST, YDVARS%SCONV%LT1, YDCPG_OPTS, YDCPG_BNDS, YDVARS%SCONV%RCP, ZTDCP, PTENDSCONV  )
CALL CPUTQY_APLPAR_EXPL_ACCTND (YDCST, YDVARS%Q%LT1,     YDCPG_OPTS, YDCPG_BNDS, YDVARS%Q%RCP,     ZTDCP, PTENDQ      )
