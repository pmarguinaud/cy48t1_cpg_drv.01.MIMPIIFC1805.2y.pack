SUBROUTINE CPUTQY_AROME(YDMODEL, YDDIMV,YDGMV, KPROMA, &
 & KSTART, KPROF, KFLEV, PDT, KPGFL, KPTR, &
 & PTEND_Q, PTEND_L, PTEND_R, PTEND_I, PTEND_S, PTEND_G, PTEND_H, &
 !  Variables 2D Input
...
REAL(KIND=JPRB),   INTENT(IN)    :: PTEND_Q (KPROMA,KFLEV)  
REAL(KIND=JPRB),   INTENT(IN)    :: PTEND_L (KPROMA,KFLEV)  
REAL(KIND=JPRB),   INTENT(IN)    :: PTEND_R (KPROMA,KFLEV)  
REAL(KIND=JPRB),   INTENT(IN)    :: PTEND_I (KPROMA,KFLEV)  
REAL(KIND=JPRB),   INTENT(IN)    :: PTEND_S (KPROMA,KFLEV)  
REAL(KIND=JPRB),   INTENT(IN)    :: PTEND_G (KPROMA,KFLEV)  
REAL(KIND=JPRB),   INTENT(IN)    :: PTEND_H (KPROMA,KFLEV)  
