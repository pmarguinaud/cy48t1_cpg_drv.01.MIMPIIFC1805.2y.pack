...
CALL CPUTQY0 (YDCPG_DIM, YDCPG_OPTS, YDCPG_DIM%YRVARS%T, PDT, YDMF_PHYS_NEXT_STATE%T, PTENDT)
...
IF (YDVARS%H%LT1)     CALL CPUTQY0 (YDCPG_DIM, YDCPG_OPTS, YDCPG_DIM%YRVARS%H,   PDT, YDMF_PHYS_NEXT_STATE%H,     PTENDH)
