...
CALL CPUTQY0 (YDCPG_BNDS, YDCPG_OPTS, YDCPG_OPTS%YRVARS_DIMS%T, PDT, YDMF_PHYS_NEXT_STATE%T, PTENDT)
...
IF (YDVARS%H%LT1)     CALL CPUTQY0 (YDCPG_BNDS, YDCPG_OPTS, YDCPG_OPTS%YRVARS_DIMS%H,   PDT, YDMF_PHYS_NEXT_STATE%H,     PTENDH)
