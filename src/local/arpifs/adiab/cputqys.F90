SUBROUTINE CPUTQYS(YDCPG_DIM, YDMF_PHYS_BASE_STATE, YDMF_PHYS_NEXT_STATE, &
 & YDSTOPH, YDPHY2, PDT, &
 !  Variables 2D Input
 & PTENDH, PTENDQ, PTENDU, PTENDV, PFORCEU, PFORCEV, PFORCET, PFORCEQ,&
 !  Variables 2D Out
 & PFDIS)
...
REAL(KIND=JPRB)   ,INTENT(INOUT) :: PTENDU(YDCPG_DIM%KLON,YDCPG_DIM%KFLEVG)
REAL(KIND=JPRB)   ,INTENT(INOUT) :: PTENDV(YDCPG_DIM%KLON,YDCPG_DIM%KFLEVG)
REAL(KIND=JPRB)   ,INTENT(IN)    :: PFORCEU(YDCPG_DIM%KLON,YDCPG_DIM%KFLEVG)
REAL(KIND=JPRB)   ,INTENT(IN)    :: PFORCEV(YDCPG_DIM%KLON,YDCPG_DIM%KFLEVG)
REAL(KIND=JPRB)   ,INTENT(IN)    :: PFORCET(YDCPG_DIM%KLON,YDCPG_DIM%KFLEVG)
REAL(KIND=JPRB)   ,INTENT(IN)    :: PFORCEQ(YDCPG_DIM%KLON,YDCPG_DIM%KFLEVG)
