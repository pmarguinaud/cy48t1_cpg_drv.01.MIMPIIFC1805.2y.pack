...
REAL(KIND=JPRB)   ,TARGET, INTENT(IN)    :: PCP(KPROMA,KFLEV) 
REAL(KIND=JPRB)   ,TARGET, INTENT(IN)    :: PDELP(KPROMA,KFLEV) 
REAL(KIND=JPRB)   ,TARGET, INTENT(IN)    :: PTT(KPROMA,KFLEV) 
REAL(KIND=JPRB)   ,TARGET, INTENT(IN)    :: PUT(KPROMA,KFLEV) 
REAL(KIND=JPRB)   ,TARGET, INTENT(IN)    :: PVT(KPROMA,KFLEV) 
