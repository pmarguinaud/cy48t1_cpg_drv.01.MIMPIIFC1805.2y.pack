SUBROUTINE CPUTQYS(YDCPG_DIM, YDMF_PHYS_BASE_STATE, YDMF_PHYS_NEXT_STATE, &
                 & YDMF_PHYS, YDSTOPH, YDPHY2, PDT, PTENDH, PTENDQ)
...
REAL(KIND=JPRB)   ,INTENT(INOUT) :: PTENDQ(YDCPG_DIM%KLON,YDCPG_DIM%KFLEVG)
...
REAL(KIND=JPRB) :: ZDTT1(YDCPG_DIM%KLON,YDCPG_DIM%KFLEVG)
