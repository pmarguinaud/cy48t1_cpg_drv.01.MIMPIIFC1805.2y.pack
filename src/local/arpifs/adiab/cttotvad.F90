...
!**** *CTTOTVAD* - Computes T from 'TV' (TV defined as RT/Rd)
...
REAL(KIND=JPRB) :: ZR   ,ZR5,ZR0

INTEGER(KIND=JPIM) :: IEND, IST, JLEV, JROF
REAL(KIND=JPRB) :: ZHOOK_HANDLE

!     ------------------------------------------------------------------
IF (LHOOK) CALL DR_HOOK('CTTOTVAD',0,ZHOOK_HANDLE)
...
END ASSOCIATE
END ASSOCIATE
IF (LHOOK) CALL DR_HOOK('CTTOTVAD',1,ZHOOK_HANDLE)
