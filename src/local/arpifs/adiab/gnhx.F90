...
IF (LNHEE) THEN
  ...
  CALL GNHPRE(YRDYNA%NPDVAR,YDGEOMETRY,KPROMA,NFLEVG,KSTART,KEND,PSPD,ZPIF,PNHPREF=ZNHPREF,&
   & PNHPPI=ZNHPPI,PRNHPPI=ZRNHPPI)

  CALL GNHGRPRE(YRDYNA%NPDVAR,YDGEOMETRY,KPROMA,NFLEVG,KSTART,KEND,ZXYB(1,1,YYTXYB%M_RTGR),ZPISL,ZPISM,&
   & ZNHPREF,PSPDL,PSPDM,&
