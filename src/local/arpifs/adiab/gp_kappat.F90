...
CALL GPHPRE_EXPL (LAPRXPK,LVERTFE,NDLNPR,RHYDR0,TOPPRES,YDCST,KPROMA,KFLEV,KSTART,KPROF,YDVAB,PRESH=ZPREH,PRESF=ZPREF,&
                & PDELP=ZXYB (:,:,YYTXYB%M_DELP ), PLNPR=ZXYB (:,:,YYTXYB%M_LNPR ), PRDELP=ZXYB (:,:,YYTXYB%M_RDELP), &
                & PALPH=ZXYB (:,:,YYTXYB%M_ALPH ), PRTGR=ZXYB (:,:,YYTXYB%M_RTGR ), PRPRE=ZXYB (:,:,YYTXYB%M_RPRE ), &
                & PRPP=ZXYB (:,:,YYTXYB%M_RPP  ))
