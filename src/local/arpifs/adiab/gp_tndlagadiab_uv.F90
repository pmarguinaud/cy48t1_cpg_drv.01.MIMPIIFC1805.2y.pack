!OCL  NOEVAL
SUBROUTINE GP_TNDLAGADIAB_UV(LDRPLANE, YDGEOMETRY, YDEPHY, YDDYN, KST, KPROF, PRCORI, PGNORDL, &
...
ASSOCIATE(NFLEVG=>DIMV%NFLEVG, RKRF=>YDDYN%RKRF, LEGWWMS=>YDEPHY%LEGWWMS, NSTTYP=>GEM%NSTTYP)
