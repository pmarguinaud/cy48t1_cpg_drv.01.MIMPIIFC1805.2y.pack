!OCL  NOEVAL
SUBROUTINE GPCTY_EXPL(LDVERTFE, YDVFE,KPROMA,KD,KF,KFLEV,LDRUBC,YDVAB,YDVETA,&
...
IF (LDRUBC.AND.LDVERTFE) CALL ABOR1('GPCTY_EXPL: BAD OPTIONS')
...
IF(.NOT.LDVERTFE) PEVEL(KD:KF,KFLEV)=0.0_JPRB
