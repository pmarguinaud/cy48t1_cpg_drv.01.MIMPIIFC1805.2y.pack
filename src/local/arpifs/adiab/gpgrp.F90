...
REAL(KIND=JPRB)   ,INTENT(IN), OPTIONAL, TARGET :: PXYBDER(YDGEOMETRY%YRDIM%NPROMA,YDGEOMETRY%YRDIMV%NFLEVG,YYTXYBDER%NDIM)
...
REAL(KIND=JPRB)   ,INTENT(IN), OPTIONAL, TARGET :: PALPHPLL(YDGEOMETRY%YRDIM%NPROMA,YDGEOMETRY%YRDIMV%NFLEVG)
REAL(KIND=JPRB)   ,INTENT(IN), OPTIONAL, TARGET :: PALPHPLM(YDGEOMETRY%YRDIM%NPROMA,YDGEOMETRY%YRDIMV%NFLEVG)

!     ------------------------------------------------------------------

INTEGER(KIND=JPIM) :: JLEV, JROF

REAL(KIND=JPRB), POINTER, CONTIGUOUS :: ZALPHPLL(:,:)
REAL(KIND=JPRB), POINTER, CONTIGUOUS :: ZALPHPLM(:,:)
...
IF (PRESENT (PXYBDER)) THEN
  ZALPHPLL => PXYBDER(:,:,YYTXYBDER%M_ALPHPLL)
  ZALPHPLM => PXYBDER(:,:,YYTXYBDER%M_ALPHPLM)
ENDIF

IF (PRESENT (PALPHPLL)) ZALPHPLL => PALPHPLL
IF (PRESENT (PALPHPLM)) ZALPHPLM => PALPHPLM
