SUBROUTINE GPGW(LDNHDYN, LDVERTFE, LDVFE_GW, YDGEOMETRY,KFLEV,KPROMA,KSTART,KEND,LDGWF,LDGDWI,POROGL,POROGM,PLNPR,PALPH,&
...
IF (PRESENT(LDVFE)) THEN
  LLVFE = LDVFE
ELSE
  LLVFE = LDVERTFE.AND.(LDVFE_GW.OR..NOT.LDNHDYN)
ENDIF
