...
IF (PRESENT (PXYB)) THEN
  CALL GPHPRE_EXPL (LAPRXPK, LVERTFE, NDLNPR, RHYDR0, TOPPRES, YRCST,KPROMA,KFLEV,K1,K2,VAB,PRESH,PRESF,&
                  ...
                  & PXYB (:,:,YYTXYB%M_RPP  ))
ELSE
  CALL GPHPRE_EXPL (LAPRXPK, LVERTFE, NDLNPR, RHYDR0, TOPPRES, YRCST,KPROMA,KFLEV,K1,K2,VAB,PRESH,&
