...
REAL(KIND=JPRB),OPTIONAL,INTENT(IN),CONTIGUOUS :: PGWFT0(:,:)
REAL(KIND=JPRB),OPTIONAL,INTENT(IN),CONTIGUOUS :: PGDW0(:,:)
REAL(KIND=JPRB),OPTIONAL,INTENT(IN),CONTIGUOUS :: PGWS0(:)
