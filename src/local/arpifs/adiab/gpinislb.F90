...
IF(YL%LACTIVE) THEN
  IF (LDSLAG.AND.LDTWOTL) THEN
    PQLI(KST:KEN,1:NFLEVG)=PL0(KST:KEN,1:NFLEVG)
  ELSE
    PQLI(KST:KEN,1:NFLEVG)=PL9(KST:KEN,1:NFLEVG)
  ENDIF
ELSE
...
IF(YI%LACTIVE) THEN
  IF (LDSLAG.AND.LDTWOTL) THEN
    PQICE(KST:KEN,1:NFLEVG)=PI0(KST:KEN,1:NFLEVG)
  ELSE
    PQICE(KST:KEN,1:NFLEVG)=PI9(KST:KEN,1:NFLEVG)
  ENDIF
ELSE
...
IF(YR%LACTIVE) THEN
   IF (LDSLAG.AND.LDTWOTL) THEN
      PQRAIN(KST:KEN,1:NFLEVG)=PR0(KST:KEN,1:NFLEVG)
   ELSE
      PQRAIN(KST:KEN,1:NFLEVG)=PR9(KST:KEN,1:NFLEVG)
   ENDIF
ELSE
...
IF(YS%LACTIVE) THEN
   IF (LDSLAG.AND.LDTWOTL) THEN
      PQSNOW(KST:KEN,1:NFLEVG)=PS0(KST:KEN,1:NFLEVG)
   ELSE
      PQSNOW(KST:KEN,1:NFLEVG)=PS9(KST:KEN,1:NFLEVG)
   ENDIF
ELSE
