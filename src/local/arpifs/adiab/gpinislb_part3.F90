SUBROUTINE GPINISLB_PART3 (LDGWADV, LDNHDYN, LDVERTFE, LDVFE_GW, YDGEOMETRY, YDPTRSLB2, KST, KEN, &
...
REAL(KIND=JPRB)   ,INTENT(IN)    :: PB2VVEL(YDGEOMETRY%YRDIM%NPROMA,YDGEOMETRY%YRDIMV%NFLEVG)
REAL(KIND=JPRB)   ,INTENT(IN)    :: PB2GWF(YDGEOMETRY%YRDIM%NPROMA,YDGEOMETRY%YRDIMV%NFLEVG)
REAL(KIND=JPRB)   ,INTENT(IN)    :: PB2GDW(YDGEOMETRY%YRDIM%NPROMA,YDGEOMETRY%YRDIMV%NFLEVG)
REAL(KIND=JPRB)   ,INTENT(IN)    :: PB2GWS(YDGEOMETRY%YRDIM%NPROMA,YDGEOMETRY%YRDIMV%NFLEVG)
