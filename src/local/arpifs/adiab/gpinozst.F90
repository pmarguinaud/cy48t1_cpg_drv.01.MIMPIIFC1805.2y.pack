...
& )
ASSOCIATE(NFLEVG=>YDDIMV%NFLEVG,   NTOZ2D=>YDDPHY%NTOZ2D, NTOZ3D=>YDDPHY%NTOZ3D, NVCLIS=>YDDPHY%NVCLIS,                 &
& NFRSTLAT=>YDMP%NFRSTLAT, NLSTLAT=>YDMP%NLSTLAT, NONL=>YDMP%NONL,   NPTRFLOFF=>YDMP%NPTRFLOFF,   TOZ2DL=>YDOZO%TOZ2DL, &
& TOZ3DBL=>YDOZO%TOZ3DBL)
! ----------------------------------------------------------------------------
