...
REAL(KIND=JPRB),OPTIONAL,TARGET,INTENT(INOUT),DIMENSION(:,:),CONTIGUOUS :: P0U, P0V, P0DIV, P0TL, P0TM, P9U, P9V, P0UL, P0VL, P0VOR, P0SPDL, P0SPDM
REAL(KIND=JPRB),OPTIONAL,TARGET,INTENT(INOUT),DIMENSION(:,:),CONTIGUOUS :: P0SVDL, P0SVDM, P0NHXL, P0NHXM, P9DIV, P9TL, P9TM, P9SPDL, P9SPDM, P9SVDL, P9SVDM
REAL(KIND=JPRB),OPTIONAL,TARGET,INTENT(INOUT),DIMENSION(:),CONTIGUOUS :: P0SPL, P0SPM, P9SPL, P9SPM
!     ------------------------------------------------------------------
