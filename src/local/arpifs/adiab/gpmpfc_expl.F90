SUBROUTINE GPMPFC_EXPL(LDNHDYN, LDNHXDER, LDPC_FULL, LDTWOTL, YDVARS, YDML_GCONF,YDDYN,KPROMA,KFLEV,KST,KEN,KFLAG,PGM,&
...
CALL GPMPFC_EXPL_PART1 (LDNHDYN, LDNHXDER, LDPC_FULL, LDTWOTL, YDML_GCONF, YDDYN, KPROMA, KFLEV, KST, KEN, ZGM, &
                      & P0U, P0V, P0DIV, P0TL, P0TM, P9U, P9V, P0UL, P0VL, P0VOR, P0SPDL, P0SPDM, &
                      & P0SVDL, P0SVDM, P0NHXL, P0NHXM, P9DIV, P9TL, P9TM, P9SPDL, P9SPDM, P9SVDL,&
                      & P9SVDM, P0SPL, P0SPM, P9SPL, P9SPM)
