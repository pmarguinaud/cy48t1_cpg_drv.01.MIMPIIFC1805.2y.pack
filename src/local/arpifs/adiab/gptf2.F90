...
ELSE
  CALL GPTF2_EXPL_3TL_PART1 (YDGEOMETRY, YDML_GCONF, YDDYN, KST, KEN, LDFSTEP, LNHDYN, YRDYNA%NVDVAR, &
  ...
  CALL GPTF2_PGFL_3TL_PART2 (YDGEOMETRY, YDML_GCONF, YDDYN, KST, KEN, LDFSTEP, PGFL)
ENDIF
