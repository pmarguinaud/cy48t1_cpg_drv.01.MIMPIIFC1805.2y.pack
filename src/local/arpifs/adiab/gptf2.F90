...
REAL(KIND=JPRB),TARGET,OPTIONAL,INTENT(INOUT),CONTIGUOUS,DIMENSION(:)   :: P0SP  , P0SPL , P0SPM , P9SP  , P9SPL , P9SPM 
REAL(KIND=JPRB),TARGET,OPTIONAL,INTENT(INOUT),CONTIGUOUS,DIMENSION(:,:) :: P0DIV , P0NHX , P0SPD , P0SPDL, P0SPDM, P0SVD , P0SVDL
REAL(KIND=JPRB),TARGET,OPTIONAL,INTENT(INOUT),CONTIGUOUS,DIMENSION(:,:) :: P0SVDM, P0T   , P0TL  , P0TM  , P0U   , P0V   , P9DIV 
REAL(KIND=JPRB),TARGET,OPTIONAL,INTENT(INOUT),CONTIGUOUS,DIMENSION(:,:) :: P9NHX , P9SPD , P9SPDL, P9SPDM, P9SVD , P9SVDL, P9SVDM
REAL(KIND=JPRB),TARGET,OPTIONAL,INTENT(INOUT),CONTIGUOUS,DIMENSION(:,:) :: P9T   , P9TL  , P9TM  , P9U   , P9V   
