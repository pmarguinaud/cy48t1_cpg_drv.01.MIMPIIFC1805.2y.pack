...
IF (LNHEE) THEN
  CALL LANHSI(YDGEOMETRY,YDGMV,YGFL,YDDYN,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,LGWADV,YDGSGEOM%RCORI,ZREDIV,PGMV,PGMVS,PGFL,&
   & ZSDIV0,ZSDIV9,ZTOD0,ZTOD9,ZGAGT0L,ZGAGT0M,ZGAGT9L,ZGAGT9M,&
   & ZSPDS0,ZSPDS9,ZLPD0,ZLPD9)
ELSEIF (LNHQE) THEN
  CALL LANHQESI(YDGEOMETRY,YDGMV,YGFL,YDDYN,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,LGWADV,YDGSGEOM%RCORI,PGMV,PGMVS,PGFL,&
   & ZSDIV0,ZSDIV9,ZTOD0,ZTOD9,ZGAGT0L,ZGAGT0M,ZGAGT9L,ZGAGT9M,&
   & ZLPD0,ZLPD9)
ELSE
  CALL LASSIE(YDGEOMETRY,YDGMV,YGFL,YDDYN,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,YDGSGEOM%RCORI,PGMV,PGMVS,PGFL,&
   & ZSDIV0,ZSDIV9,ZTOD0,ZTOD9,ZGAGT0L,ZGAGT0M,ZGAGT9L,ZGAGT9M)
ENDIF
...
IF (LGWADV) THEN
  ...
  LLGWADV=.FALSE.
  IF (LNHEE) THEN
    CALL LANHSI(YDGEOMETRY,YDGMV,YGFL,YDDYN,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,LLGWADV,YDGSGEOM%RCORI,ZREDIV,PGMV,PGMVS,PGFL,&
     & ZSDIV0,ZSDIV9,ZTOD0,ZTOD9,ZGAGT0L,ZGAGT0M,ZGAGT9L,ZGAGT9M,&
     & ZSPDS0,ZSPDS9,ZLPD0,ZLPD9)
  ELSEIF (LNHQE) THEN
    CALL LANHQESI(YDGEOMETRY,YDGMV,YGFL,YDDYN,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,LLGWADV,YDGSGEOM%RCORI,PGMV,PGMVS,PGFL,&
     & ZSDIV0,ZSDIV9,ZTOD0,ZTOD9,ZGAGT0L,ZGAGT0M,ZGAGT9L,ZGAGT9M,&
     & ZLPD0,ZLPD9)
  ENDIF
