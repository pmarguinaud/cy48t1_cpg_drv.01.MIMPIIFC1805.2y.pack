...
IF (YDMODEL%YRML_DYN%YRDYNA%LSLHD) THEN
  CALL LATTE_KAPPA(YDMODEL%YRML_DYN%YRDYNA,YDCST, YDGEOMETRY,YDVARS,YDCPG_SL1,YDCPG_SL2,YDGMV,YDDYN,YDPTRSLB2,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,ZDTS2,PSLHDA,PSLHDD0,PGMV,PGMVS,&
