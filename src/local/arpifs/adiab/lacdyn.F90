...
IF (LNHEE) THEN
  CALL LANHSI(YDMODEL%YRCST,YDGEOMETRY,YDVARS,YDCPG_BNDS,YDCPG_OPTS,YDGMV,YGFL,YDDYN,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,LGWADV,YDGSGEOM%RCORI,ZREDIV,PGMV,PGMVS,PGFL,&
   & ZSDIV0,ZSDIV9,ZTOD0,ZTOD9,ZGAGT0L,ZGAGT0M,ZGAGT9L,ZGAGT9M,&
   & ZSPDS0,ZSPDS9,ZLPD0,ZLPD9)
ELSEIF (LNHQE) THEN
  CALL LANHQESI(YDMODEL%YRCST,YDGEOMETRY,YDVARS,YDCPG_BNDS,YDCPG_OPTS,YDGMV,YGFL,YDDYN,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,LGWADV,YDGSGEOM%RCORI,PGMV,PGMVS,PGFL,&
   & ZSDIV0,ZSDIV9,ZTOD0,ZTOD9,ZGAGT0L,ZGAGT0M,ZGAGT9L,ZGAGT9M,&
   & ZLPD0,ZLPD9)
ELSE
  CALL LASSIE(YDMODEL%YRCST,YDGEOMETRY,YDVARS,YDCPG_BNDS,YDCPG_OPTS,YDGMV,YGFL,YDDYN,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,YDGSGEOM%RCORI,PGMV,PGMVS,PGFL,&
   & ZSDIV0,ZSDIV9,ZTOD0,ZTOD9,ZGAGT0L,ZGAGT0M,ZGAGT9L,ZGAGT9M)
ENDIF
...
CALL LATTEX(YDMODEL%YRCST,YDGEOMETRY,YDVARS,YDCPG_BNDS,YDCPG_OPTS,YDGMV,YDMODEL%YRML_DIAG%YRLDDH,YDMDDH,YDMODEL%YRML_GCONF,YDMODEL%YRML_DYN,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,ZDTS2,ZBT,ZBDT, &
 & ZESGP,ZESGM,&
...
CALL LATTES(YDGEOMETRY,YDGMV,YDMODEL%YRML_GCONF%YRRIP,YDMODEL%YRML_DYN,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,ZDTS2,ZBDT,ZESGP,ZESGM,&
 & YDCPG_BNDS%KBL,YDCPG_DYN0%OROGL,YDCPG_DYN0%OROGM,&
...
IF (LSLHD) THEN
  CALL LATTE_KAPPA(YDGEOMETRY,YDGMV,YDDYN,YDPTRSLB2,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,ZDTS2,PSLHDA,PSLHDD0,PGMV,PGMVS,&
...
IF (LGWADV) THEN
  ...
  LLGWADV=.FALSE.
  IF (LNHEE) THEN
    CALL LANHSI(YDMODEL%YRCST,YDGEOMETRY,YDVARS,YDCPG_BNDS,YDCPG_OPTS,YDGMV,YGFL,YDDYN,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,LLGWADV,YDGSGEOM%RCORI,ZREDIV,PGMV,PGMVS,PGFL,&
     & ZSDIV0,ZSDIV9,ZTOD0,ZTOD9,ZGAGT0L,ZGAGT0M,ZGAGT9L,ZGAGT9M,&
     & ZSPDS0,ZSPDS9,ZLPD0,ZLPD9)
  ELSEIF (LNHQE) THEN
    CALL LANHQESI(YDMODEL%YRCST,YDGEOMETRY,YDVARS,YDCPG_BNDS,YDCPG_OPTS,YDGMV,YGFL,YDDYN,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,LLGWADV,YDGSGEOM%RCORI,PGMV,PGMVS,PGFL,&
     & ZSDIV0,ZSDIV9,ZTOD0,ZTOD9,ZGAGT0L,ZGAGT0M,ZGAGT9L,ZGAGT9M,&
     & ZLPD0,ZLPD9)
  ENDIF
