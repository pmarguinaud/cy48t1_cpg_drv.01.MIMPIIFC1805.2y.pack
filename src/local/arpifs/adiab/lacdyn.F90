...
ASSOCIATE(YDDIM=>YDGEOMETRY%YRDIM,YDDIMV=>YDGEOMETRY%YRDIMV,YDGEM=>YDGEOMETRY%YRGEM, &
 &  YDDYN=>YDMODEL%YRML_DYN%YRDYN,YDEPHY=>YDMODEL%YRML_PHY_EC%YREPHY, &
...
IF ((NCURRENT_ITER == 0).OR. (&
 & NCURRENT_ITER > 0 .AND. YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND.(.NOT.YDMODEL%YRML_DYN%YRDYNA%LPC_CHEAP) )) THEN
  ...
  CALL LAVENT(YDCST, YDGEOMETRY,YDVARS,YDCPG_SL1, YDCPG_SL2, YDMODEL%YRML_GCONF%YRRIP,YDMODEL%YRML_DYN,YDMODEL%YRML_PHY_MF%YRPARAR,&
   & YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,KSETTLOFF,LL2TLFF1, &
...
IF (YDMODEL%YRML_DYN%YRDYNA%LMIXETTLS) THEN
  CALL LATTE_NL(YDCST, YDGEOMETRY,YDMODEL%YRML_DYN,YDMODEL%YRML_GCONF%YRRIP,&
   & YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,ZDTS2,ZBDT,PGMV(:,:,YT0%MU),PGMV(:,:,YT0%MV),YDCPG_DYN0%CTY%EVEL,&
...
IF (LNHDYN.AND.YDMODEL%YRML_DYN%YRDYNA%LRDBBC.AND.(.NOT.YDMODEL%YRML_DYN%YRDYNA%LGWADV)) THEN
  ...
  !     in routine LAPINEB.
  CALL LATTE_BBC(YDGEOMETRY,YDVARS,YDCPG_SL1,YDCPG_SL2,YDGMV,YDMODEL%YRML_DYN,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,ZDTS2,ZESGP,ZESGM,YDCPG_DYN0%DBBC,YDCPG_DYN0%RDPHI,&
...
IF (YDMODEL%YRML_DYN%YRDYNA%LSLHD) THEN
  CALL LATTE_KAPPA(YDMODEL%YRML_DYN%YRDYNA,YDCST, YDGEOMETRY,YDVARS,YDCPG_SL1,YDCPG_SL2,YDDYN,YDPTRSLB2,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,ZDTS2,PSLHDA,PSLHDD0,&
