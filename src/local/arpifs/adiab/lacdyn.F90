...
IF (LNHDYN.AND.YDMODEL%YRML_DYN%YRDYNA%LRDBBC.AND.(.NOT.YDMODEL%YRML_DYN%YRDYNA%LGWADV)) THEN
  ...
  !     in routine LAPINEB.
  CALL LATTE_BBC(YDGEOMETRY,YDVARS,YDCPG_SL1,YDCPG_SL2,YDMODEL%YRML_DYN,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,ZDTS2,ZESGP,ZESGM,YDCPG_DYN0%DBBC,YDCPG_DYN0%RDPHI,&
