...
CALL LATTES(YDCST, YDGEOMETRY,YDCPG_SL1,YDCPG_SL2,YDGMV,YDMODEL%YRML_GCONF%YRRIP,YDMODEL%YRML_DYN,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,ZDTS2,ZBDT,ZESGP,ZESGM,&
