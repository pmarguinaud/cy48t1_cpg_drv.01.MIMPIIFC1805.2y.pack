...
CALL LATTES(YDCST, YDGEOMETRY,YDCPG_BNDS,YDCPG_OPTS,YDVARS,YDCPG_SL1,YDCPG_SL2,YDMODEL%YRML_GCONF%YRRIP,YDMODEL%YRML_DYN,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,ZDTS2,ZBDT,ZESGP,ZESGM,&
...
IF (YDMODEL%YRML_DYN%YRDYNA%LSLHD) THEN
  CALL LATTE_KAPPA(YDMODEL%YRML_DYN%YRDYNA,YDCST, YDGEOMETRY,YDVARS,YDCPG_SL1,YDCPG_SL2,YDDYN,YDPTRSLB2,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,ZDTS2,PSLHDA,PSLHDD0,&
   & YDCPG_DYN0%UVH%ZVIEW,YDCPG_DYN0%PRE(1:,NFLEVG),YDCPG_DYN0%XYB%RDELP)
ENDIF
...
IF ((NCURRENT_ITER == 0).OR. (&
 & NCURRENT_ITER > 0 .AND. YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND.(.NOT.YDMODEL%YRML_DYN%YRDYNA%LPC_CHEAP) )) THEN
  CALL LAVABO(YDMODEL%YRML_DYN%YRDYNA,YDGEOMETRY,YDCPG_BNDS,YDCPG_OPTS,YDCPG_SL1,YGFL,YDDYN,YDPTRSLB1,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,LL2TLFF1,LSLPHY)
ENDIF
