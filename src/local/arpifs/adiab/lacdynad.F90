...
CALL LASURE(YDGEOMETRY,YDEPHY,YDML_DYN%YRDYN,YDML_DYN%YREDYN,YDPHY,KST,KPROF,PBETADT,PDT,YDGSGEOM%GMAPPA,YDGSGEOM%GM,&
...
IF (YDML_DYN%YRDYNA%LSLHD.AND.(.NOT.YDML_DYN%YRDYNA%LSLHD_STATIC)) THEN
