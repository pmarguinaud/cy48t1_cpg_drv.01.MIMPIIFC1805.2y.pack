...
ELSEIF (.NOT.LDGWADV) THEN
  ...
  CALL SIDD(YDCPG_OPTS%LVERTFE, YDDYNA,YDCST,YDGEOMETRY,YDDYN,NPROMA,1,PGAGT0L(YDCPG_BNDS%KIDIA,1),ZDUM(YDCPG_BNDS%KIDIA,1),&
   & YDVARS%SPD%DL,YDVARS%T%DL,YDVARS%SP%DL,IPROFS)
  CALL SIDD(YDCPG_OPTS%LVERTFE, YDDYNA,YDCST,YDGEOMETRY,YDDYN,NPROMA,1,PGAGT0M(YDCPG_BNDS%KIDIA,1),ZDUM(YDCPG_BNDS%KIDIA,1),&
...
IF (.NOT.LTWOTL) THEN
  ...
  ELSEIF (.NOT.LDGWADV) THEN
    ...
    ! - Computation of SI terms for momentum equation.
    CALL SIDD(YDCPG_OPTS%LVERTFE, YDDYNA,YDCST,YDGEOMETRY,YDDYN,NPROMA,1,PGAGT9L(YDCPG_BNDS%KIDIA,1),ZDUM(YDCPG_BNDS%KIDIA,1),&
     & YDVARS%SPD%DL9,YDVARS%T%DL9,YDVARS%SP%DL9,IPROFS)
    CALL SIDD(YDCPG_OPTS%LVERTFE, YDDYNA,YDCST,YDGEOMETRY,YDDYN,NPROMA,1,PGAGT9M(YDCPG_BNDS%KIDIA,1),ZDUM(YDCPG_BNDS%KIDIA,1),&
