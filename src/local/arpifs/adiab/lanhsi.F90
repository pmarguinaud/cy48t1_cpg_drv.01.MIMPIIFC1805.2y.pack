...
ELSEIF (.NOT.LDGWADV) THEN
  ...
  DO JLEV=1,NFLEVG
    ...
    ENDDO
  ENDDO
  CALL SIPTP(YDGEOMETRY,YDDYN,NPROMA,1,PGMV(YDCPG_BNDS%KIDIA,1,YT0%MDIV),ZSVDT(YDCPG_BNDS%KIDIA,1),&
  ...
  CALL SIDD(YDGEOMETRY,YDDYN,NPROMA,1,PGAGT0L(YDCPG_BNDS%KIDIA,1),ZDUM(YDCPG_BNDS%KIDIA,1),&
   & PGMV(YDCPG_BNDS%KIDIA,1,YT0%MSPDL),PGMV(YDCPG_BNDS%KIDIA,1,YT0%MTL),PGMVS(YDCPG_BNDS%KIDIA,YT0%MSPL),IPROFS)
  CALL SIDD(YDGEOMETRY,YDDYN,NPROMA,1,PGAGT0M(YDCPG_BNDS%KIDIA,1),ZDUM(YDCPG_BNDS%KIDIA,1),&
...
IF (.NOT.LTWOTL) THEN
  ...
  ELSEIF (.NOT.LDGWADV) THEN
    ...
    DO JLEV=1,NFLEVG
      ...
      ENDDO
    ENDDO
    CALL SIPTP(YDGEOMETRY,YDDYN,NPROMA,1,PGMV(YDCPG_BNDS%KIDIA,1,YT9%MDIV),ZSVDT(YDCPG_BNDS%KIDIA,1),&
     & PSPDS9(YDCPG_BNDS%KIDIA,1),PTOD9(YDCPG_BNDS%KIDIA,1),PSDIV9(YDCPG_BNDS%KIDIA),IPROFS)
    ! - Computation of SI terms for momentum equation.
    CALL SIDD(YDGEOMETRY,YDDYN,NPROMA,1,PGAGT9L(YDCPG_BNDS%KIDIA,1),ZDUM(YDCPG_BNDS%KIDIA,1),&
     & PGMV(YDCPG_BNDS%KIDIA,1,YT9%MSPDL),PGMV(YDCPG_BNDS%KIDIA,1,YT9%MTL),PGMVS(YDCPG_BNDS%KIDIA,YT9%MSPL),IPROFS)
    CALL SIDD(YDGEOMETRY,YDDYN,NPROMA,1,PGAGT9M(YDCPG_BNDS%KIDIA,1),ZDUM(YDCPG_BNDS%KIDIA,1),&
