...
USE YOMDYNA            , ONLY : LSLHD_W, LSLHD_T, LRHSVWENO
...
IF (LRHSVWENO) THEN       ! quintic interpolations
  ISEP=NVSEPC+2
ENDIF
...
CALL LAITRE_GMV_AD(YDML_DYN,YDSL%NASLB1,NPROMA,KST,KPROF,NFLEVG,NFLSA,&
 ...
 & KDEP,LVECADIN,LRPLANE,LSLHD_T,LVWENO_T,WENO_ALPHA_T,LLMOM,LLADV5,KNOWENO,&
 & KL0,PLSCAW,PRSCAW,PLSCAW5,PRSCAW5,&
...
IF(NWLAG == 3) THEN
  ...
  IF (LD2TLFF1) THEN
    ...
    CALL LAITRE_GMV_AD(YDML_DYN,YDSL%NASLB1,NPROMA,KST,KPROF,NFLEVG,NFLSA,&
     ...
     & KDEP,LVECADIN,LRPLANE,LSLHD_W,LVWENO_W,WENO_ALPHA_W,LLMOM,LLADV5,KNOWENO,&
     & KL0,PLSCAW,PRSCAW,PLSCAW5,PRSCAW5,&
