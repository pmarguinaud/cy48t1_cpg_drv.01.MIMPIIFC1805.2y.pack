...
CALL LAITRE_GMV_TL(YDML_DYN,KASLB1,NPROMA,KST,KPROF,NFLEVG,NFLSA,NFLEN,&
 & YRDYNA%LSLHD_W,LVWENO_W,WENO_ALPHA_W,LLMOM,LLADV5,KNOWENO,KL0,PLSCAW,PRSCAW,PLSCAW5,PRSCAW5,&
...
LLADV5=.FALSE.
CALL LAITRE_GMV_TL(YDML_DYN,KASLB1,NPROMA,KST,KPROF,NFLEVG,NFLSA,NFLEN,&
 & YRDYNA%LSLHD_T,LVWENO_T,WENO_ALPHA_T,LLMOM,LLADV5,KNOWENO,KL0,PLSCAW,PRSCAW,PLSCAW5,PRSCAW5,&
