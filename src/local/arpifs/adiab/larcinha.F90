...
IF (YDML_DYN%YRDYNA%LSLHD.AND.LSLHDHEAT) THEN
...
IF (YDML_DYN%YRDYNA%LCOMAD) THEN
...
IF (LRPLANE) THEN
  ...
  CALL ELASCAW(&
   ...
   & YDML_DYN%YRDYNA%LSLHD,YDML_DYN%YRDYNA%LSLHDQUAD,YDML_DYN%YRDYNA%LSLHD_OLD,YDML_DYN%YRDYNA%L3DTURB,&
   & YDML_DYN%YRDYNA%LCOMAD,YDML_DYN%YRDYNA%LCOMADH,YDML_DYN%YRDYNA%LCOMADV,NSPLTHOI,&
...
ELSE
  ...
  CALL LASCAW(&
   ...
   & NFLSA,KSTABUF,IWIS,IHOR,IWENO,KHVI,&
   & YDML_DYN%YRDYNA%LSLHD,YDML_DYN%YRDYNA%LSLHDQUAD,YDML_DYN%YRDYNA%LSLHD_OLD,YDDYN%LSLHDHEAT,YDML_DYN%YRDYNA%L3DTURB,&
   & YDML_DYN%YRDYNA%LCOMAD,YDML_DYN%YRDYNA%LCOMADH,YDML_DYN%YRDYNA%LCOMADV,NSPLTHOI,&
