...
IF (YRDYNA%LSLHD.AND.LSLHDHEAT) THEN
...
IF (LRPLANE) THEN
  ...
  CALL ELASCAW(&
   ...
   & YRDYNA%LSLHD,YRDYNA%LSLHDQUAD,YRDYNA%LSLHD_OLD,YRDYNA%L3DTURB,&
   & YRDYNA%LCOMAD,YRDYNA%LCOMADH,YRDYNA%LCOMADV,NSPLTHOI,&
...
ELSE
  ...
  CALL LASCAW(&
   ...
   & NFLSA,KSTABUF,IWIS,IHOR,IWENO,KHVI,&
   & YRDYNA%LSLHD,YRDYNA%LSLHDQUAD,YRDYNA%LSLHD_OLD,YDDYN%LSLHDHEAT,YRDYNA%L3DTURB,&
   & YRDYNA%LCOMAD,YRDYNA%LCOMADH,YRDYNA%LCOMADV,NSPLTHOI,&
