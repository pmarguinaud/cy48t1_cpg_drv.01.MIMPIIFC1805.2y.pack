SUBROUTINE LASSIE(YDCST,YDGEOMETRY,YDVARS,YDCPG_BNDS,YDCPG_OPTS,YDGMV,YGFL,YDDYN,PRCORI,PGMV,PGMVS,&
...
CALL SIGAM(YDCST,YDGEOMETRY,YDDYN,NPROMA,1,PGAGT0L(YDCPG_BNDS%KIDIA,1),PGMV(YDCPG_BNDS%KIDIA,1,YT0%MTL),PGMVS(YDCPG_BNDS%KIDIA,YT0%MSPL),&
 & IPROFS,NFLEVG)
CALL SIGAM(YDCST,YDGEOMETRY,YDDYN,NPROMA,1,PGAGT0M(YDCPG_BNDS%KIDIA,1),PGMV(YDCPG_BNDS%KIDIA,1,YT0%MTM),PGMVS(YDCPG_BNDS%KIDIA,YT0%MSPM),&
 & IPROFS,NFLEVG)
...
IF (.NOT.LTWOTL) THEN
  ...
  ! - Computation of Nabla(Gamma*T+Mu*Pi) (SI term for momentum equation).
  CALL SIGAM(YDCST,YDGEOMETRY,YDDYN,NPROMA,1,PGAGT9L(YDCPG_BNDS%KIDIA,1),PGMV(YDCPG_BNDS%KIDIA,1,YT9%MTL),PGMVS(YDCPG_BNDS%KIDIA,YT9%MSPL),&
   & IPROFS,NFLEVG)
  CALL SIGAM(YDCST,YDGEOMETRY,YDDYN,NPROMA,1,PGAGT9M(YDCPG_BNDS%KIDIA,1),PGMV(YDCPG_BNDS%KIDIA,1,YT9%MTM),PGMVS(YDCPG_BNDS%KIDIA,YT9%MSPM),&
   & IPROFS,NFLEVG)
ENDIF
