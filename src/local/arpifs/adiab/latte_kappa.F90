...
CALL GP_KAPPA(YDDYNA, YDVAB,YDDYN,NPROMA,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,NFLEVG,PDTS2,&
 ...
 & PUH0,PVH0,PRES0,YDVARS%SP%DL,YDVARS%SP%DM,&
...
IF (YDDYNA%SLHDKMIN /= YDDYNA%SLHDKREF) THEN
  ...
  CALL TROPO_TEP(YDCPG_OPTS%TOPPRES, YDCPG_OPTS%RPSTRA, YDCPG_OPTS%RPTROP, YDCPG_OPTS%LVERTFE, YDDYNA, YDCST,YDGEOMETRY,NPROMA,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,NFLEVG,&
