SUBROUTINE LATTE_KAPPA(YDDYNA, YDCST, YDGEOMETRY,YDVARS,YDCPG_SL1,YDCPG_SL2, YDCPG_BNDS, YDCPG_OPTS,YDDYN,YDPTRSLB2,PDTS2,PSLHDA,PSLHDD0,&
 & PUVH0,PRES0,PRDELP)
...
! Heat
IF (LSLHDHEAT) THEN
  CALL GP_KAPPAT(LVERTFE, TOPPRES, YDDYNA, YDCST, YDGEOMETRY,YDDYN,NPROMA,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,NFLEVG,PDTS2,&
...
IF (YDDYNA%SLHDKMIN /= YDDYNA%SLHDKREF) THEN
  ...
  CALL TROPO_TEP(RPSTRA, RPTROP, LVERTFE, YDDYNA, YDCST,YDGEOMETRY,NPROMA,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,NFLEVG,&
