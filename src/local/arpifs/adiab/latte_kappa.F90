SUBROUTINE LATTE_KAPPA(YDDYNA, YDCST, YDGEOMETRY,YDVARS,YDCPG_SL1,YDCPG_SL2,YDDYN,YDPTRSLB2,KST,KPROF,PDTS2,PSLHDA,PSLHDD0,&
 & PUVH0,PRES0,PRDELP)
...
USE YOMVERT      , ONLY : TOPPRES, LVERTFE
USE YOMCVER,ONLY: LVERTFE
USE YOMSTA       , ONLY : RPSTRA   ,RPTROP
...
! Heat
IF (LSLHDHEAT) THEN
  CALL GP_KAPPAT(LVERTFE, TOPPRES, YDDYNA, YDCST, YDGEOMETRY,YDDYN,NPROMA,KST,KPROF,NFLEVG,PDTS2,&
...
IF (YDDYNA%SLHDKMIN /= YDDYNA%SLHDKREF) THEN
  ...
  CALL TROPO_TEP(RPSTRA, RPTROP, LVERTFE, YDDYNA, YDCST,YDGEOMETRY,NPROMA,KST,KPROF,NFLEVG,&
