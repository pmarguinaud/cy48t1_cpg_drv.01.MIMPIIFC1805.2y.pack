SUBROUTINE LATTES(YDCST, YDGEOMETRY,YDGMV,YDRIP,YDML_DYN,KST,KPROF,PDTS2,PBDT,PESGP,PESGM,&
 & KIBL,POROGL,POROGM,&
...
LLCT = LPC_FULL .AND. NCURRENT_ITER > 0 ! corrector for LPC_FULL
