...
IF (YDCPG_OPTS%LTWOTL) THEN
  ...
  CALL LATTEX_DNT(YDML_DYN%YRDYNA,YDGEOMETRY,YDLDDH,YDRIP,YDDYN,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,LLSETTLSW,NWLAG,PESGP,PESGM,&
...
IF (YDCPG_OPTS%LTWOTL) THEN
  ...
  CALL LATTEX_DNT(YDML_DYN%YRDYNA,YDGEOMETRY,YDLDDH,YDRIP,YDDYN,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,YDML_DYN%YRDYNA%LSETTLS,NTLAG,PESGP,PESGM,&
...
IF (YDCPG_OPTS%LNHEE) THEN
  ...
  IF (YDCPG_OPTS%LTWOTL) THEN
    ...
    CALL LATTEX_DNT(YDML_DYN%YRDYNA,YDGEOMETRY,YDLDDH,YDRIP,YDDYN,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,YDML_DYN%YRDYNA%LSETTLS,NSPDLAG,PESGP,PESGM,&
...
IF (YDCPG_OPTS%LNHDYN.AND.(.NOT.YDML_DYN%YRDYNA%LGWADV)) THEN
  ...
  IF (YDCPG_OPTS%LTWOTL) THEN
    ...
    CALL LATTEX_DNT(YDML_DYN%YRDYNA,YDGEOMETRY,YDLDDH,YDRIP,YDDYN,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,YDML_DYN%YRDYNA%LSETTLS,NSVDLAG,PESGP,PESGM,&
