SUBROUTINE LATTEX_PGFL_3TL (YDGEOMETRY, YDCPG_BNDS, YDML_GCONF, YDML_DYN, PGFL, YDCPG_SL1, YDVARS)
...
IF (LHOOK) CALL DR_HOOK('LATTEX_PGFL_3TL',0,ZHOOK_HANDLE)
...
IF (LHOOK) CALL DR_HOOK('LATTEX_PGFL_3TL',1,ZHOOK_HANDLE)
