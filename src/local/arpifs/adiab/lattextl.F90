...
IF (LTWOTL) THEN
  ...
  CALL LATTEX_DNT(NSTEP, YDML_DYN%YRDYNA,YDGEOMETRY,YDLDDH,YDML_GCONF%YRRIP,YDDYN,KST,KPROF,LLSETTLSW,NWLAG,PESGP,PESGM,&
...
IF (LTWOTL) THEN
  ...
  CALL LATTEX_DNT(NSTEP, YDML_DYN%YRDYNA,YDGEOMETRY,YDLDDH,YDML_GCONF%YRRIP,YDDYN,KST,KPROF,YDML_DYN%YRDYNA%LSETTLS,NTLAG,PESGP,PESGM,&
