SUBROUTINE LAVABO(YDDYNA, YDGEOMETRY,YDCPG_BNDS,YDCPG_OPTS,YDCPG_SL1,YGFL,YDDYN,YDPTRSLB1,KST,KPROF,LD2TLFF1,LDSLPHY)
...
YDCPG_SL1%UR0(KST:KPROF,JLEV1)=0.0_JPRB
YDCPG_SL1%UR0(KST:KPROF,JLEV2)=0.0_JPRB
YDCPG_SL1%VR0(KST:KPROF,JLEV1)=0.0_JPRB
YDCPG_SL1%VR0(KST:KPROF,JLEV2)=0.0_JPRB
IF (LSLDP_CURV) THEN
  YDCPG_SL1%ZR0(KST:KPROF,JLEV1)=0.0_JPRB
  YDCPG_SL1%ZR0(KST:KPROF,JLEV2)=0.0_JPRB
ENDIF
YDCPG_SL1%WR0(KST:KPROF,JLEV1)=0.0_JPRB
YDCPG_SL1%WR0(KST:KPROF,JLEV2)=0.0_JPRB
IF (LSLDP_RK) THEN
  YDCPG_SL1%UR00(KST:KPROF,JLEV1)=0.0_JPRB
  YDCPG_SL1%UR00(KST:KPROF,JLEV2)=0.0_JPRB
  YDCPG_SL1%VR00(KST:KPROF,JLEV1)=0.0_JPRB
  YDCPG_SL1%VR00(KST:KPROF,JLEV2)=0.0_JPRB
  IF (LSLDP_CURV) THEN
    YDCPG_SL1%ZR00(KST:KPROF,JLEV1)=0.0_JPRB
    YDCPG_SL1%ZR00(KST:KPROF,JLEV2)=0.0_JPRB
  ENDIF
  YDCPG_SL1%WR00(KST:KPROF,JLEV1)=0.0_JPRB
  YDCPG_SL1%WR00(KST:KPROF,JLEV2)=0.0_JPRB
ENDIF
IF (LD2TLFF1) THEN
  YDCPG_SL1%UR9(KST:KPROF,JLEV1)=0.0_JPRB
  YDCPG_SL1%UR9(KST:KPROF,JLEV2)=0.0_JPRB
  YDCPG_SL1%VR9(KST:KPROF,JLEV1)=0.0_JPRB
  YDCPG_SL1%VR9(KST:KPROF,JLEV2)=0.0_JPRB
ENDIF

! * P[X]L0 and P[X]L9 for [X]=U,V,T,advected GFL:
YDCPG_SL1%U9(KST:KPROF,JLEV1)=0.0_JPRB
YDCPG_SL1%U9(KST:KPROF,JLEV2)=0.0_JPRB
YDCPG_SL1%V9(KST:KPROF,JLEV1)=0.0_JPRB
YDCPG_SL1%V9(KST:KPROF,JLEV2)=0.0_JPRB
YDCPG_SL1%T9(KST:KPROF,JLEV1)=0.0_JPRB
YDCPG_SL1%T9(KST:KPROF,JLEV2)=0.0_JPRB

CALL LAVABO_LAITVSPCQM_PART1 (YDGEOMETRY, YGFL, YDPTRSLB1, KST, KPROF, YDCPG_SL1%ZVIEW)

IF (NSPLTHOI /= 0) THEN
  YDCPG_SL1%UF9(KST:KPROF,JLEV1)=0.0_JPRB
  YDCPG_SL1%UF9(KST:KPROF,JLEV2)=0.0_JPRB
  YDCPG_SL1%VF9(KST:KPROF,JLEV1)=0.0_JPRB
  YDCPG_SL1%VF9(KST:KPROF,JLEV2)=0.0_JPRB
  YDCPG_SL1%TF9(KST:KPROF,JLEV1)=0.0_JPRB
  YDCPG_SL1%TF9(KST:KPROF,JLEV2)=0.0_JPRB
ENDIF
IF (NSPLTHOI /= 0.OR.LSPLTHOIGFL) THEN

CALL LAVABO_LAITVSPCQM_PART2 (YDGEOMETRY, YGFL, YDPTRSLB1, KST, KPROF, YDCPG_SL1%ZVIEW)

ENDIF

IF (NWLAG /= 2) THEN
  YDCPG_SL1%U0(KST:KPROF,JLEV1)=0.0_JPRB
  YDCPG_SL1%U0(KST:KPROF,JLEV2)=0.0_JPRB
  YDCPG_SL1%V0(KST:KPROF,JLEV1)=0.0_JPRB
  YDCPG_SL1%V0(KST:KPROF,JLEV2)=0.0_JPRB
ENDIF
IF (NTLAG /= 2) THEN
  YDCPG_SL1%T0(KST:KPROF,JLEV1)=0.0_JPRB
  YDCPG_SL1%T0(KST:KPROF,JLEV2)=0.0_JPRB
ENDIF

! * P[X]L0 and P[X]L9 for [X]=SPD:
IF (LNHEE) THEN
  YDCPG_SL1%PD9(KST:KPROF,JLEV1) = 0.0_JPRB
  YDCPG_SL1%PD9(KST:KPROF,JLEV2) = 0.0_JPRB
  IF (NSPDLAG /= 2) THEN
    YDCPG_SL1%PD0(KST:KPROF,JLEV1) = 0.0_JPRB
    YDCPG_SL1%PD0(KST:KPROF,JLEV2) = 0.0_JPRB
  ENDIF
ENDIF

! * P[X]L0 and P[X]L9 for [X]=SVD,NHX:
IF (LNHDYN) THEN
  YDCPG_SL1%VD9(KST:KPROF,JLEV1) = 0.0_JPRB
  YDCPG_SL1%VD9(KST:KPROF,JLEV2) = 0.0_JPRB
  IF (NSPLTHOI /= 0) THEN
    YDCPG_SL1%VDF9(KST:KPROF,JLEV1) = 0.0_JPRB
    YDCPG_SL1%VDF9(KST:KPROF,JLEV2) = 0.0_JPRB
  ENDIF
  IF (YDDYNA%NVDVAR == 4 .OR. YDDYNA%NVDVAR ==5) THEN
    YDCPG_SL1%NHX9(KST:KPROF,JLEV1) = 0.0_JPRB
    YDCPG_SL1%NHX9(KST:KPROF,JLEV2) = 0.0_JPRB
  ENDIF
  IF (NSVDLAG /= 2) THEN
    YDCPG_SL1%VD0(KST:KPROF,JLEV1) = 0.0_JPRB
    YDCPG_SL1%VD0(KST:KPROF,JLEV2) = 0.0_JPRB
  ENDIF
ENDIF

! * P[X]L0 and P[X]L9 for [X]=C (continuity equation):
IF (NVLAG == 2.OR.NVLAG == 3) THEN
  YDCPG_SL1%C9(KST:KPROF,JLEV1)=0.0_JPRB
  YDCPG_SL1%C9(KST:KPROF,JLEV2)=0.0_JPRB
  IF (YDDYNA%LSLINLC2) YDCPG_SL1%C9_SI(KST:KPROF,JLEV1)=0.0_JPRB
  IF (YDDYNA%LSLINLC2) YDCPG_SL1%C9_SI(KST:KPROF,JLEV2)=0.0_JPRB
ENDIF
...
IF( LDSLPHY ) THEN
  ...
  YDCPG_SL1%UP9(KST:KPROF,JLEV1)=0.0_JPRB
  YDCPG_SL1%UP9(KST:KPROF,JLEV2)=0.0_JPRB
  YDCPG_SL1%VP9(KST:KPROF,JLEV1)=0.0_JPRB
  YDCPG_SL1%VP9(KST:KPROF,JLEV2)=0.0_JPRB
  YDCPG_SL1%TP9(KST:KPROF,JLEV1)=0.0_JPRB
  YDCPG_SL1%TP9(KST:KPROF,JLEV2)=0.0_JPRB

CALL LAVABO_LPHY (YDGEOMETRY, YGFL, YDPTRSLB1, KST, KPROF, YDCPG_SL1%ZVIEW)

ENDIF

! * P[X]L9_SI (GMV equations):
IF (YDDYNA%LSLINL) THEN
  YDCPG_SL1%U9_SI(KST:KPROF,JLEV1)=0.0_JPRB
  YDCPG_SL1%U9_SI(KST:KPROF,JLEV2)=0.0_JPRB
  YDCPG_SL1%V9_SI(KST:KPROF,JLEV1)=0.0_JPRB
  YDCPG_SL1%V9_SI(KST:KPROF,JLEV2)=0.0_JPRB
  YDCPG_SL1%T9_SI(KST:KPROF,JLEV1)=0.0_JPRB
  YDCPG_SL1%T9_SI(KST:KPROF,JLEV2)=0.0_JPRB
  YDCPG_SL1%VD9_SI(KST:KPROF,JLEV1)=0.0_JPRB
  YDCPG_SL1%VD9_SI(KST:KPROF,JLEV2)=0.0_JPRB
  IF (LNHEE) THEN
    YDCPG_SL1%PD9_SI(KST:KPROF,JLEV1)=0.0_JPRB
    YDCPG_SL1%PD9_SI(KST:KPROF,JLEV2)=0.0_JPRB
  ENDIF
ENDIF 
