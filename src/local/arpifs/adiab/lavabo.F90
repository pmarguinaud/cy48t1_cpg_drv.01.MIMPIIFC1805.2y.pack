...
#include "lavabo_pgfl_laitvspcqm_part1.intfb.h"
#include "lavabo_expl_laitvspcqm_part1.intfb.h"
#include "lavabo_pgfl_laitvspcqm_part2.intfb.h"
#include "lavabo_expl_laitvspcqm_part2.intfb.h"
#include "lavabo_pgfl_lphy.intfb.h"
...
IF (.FALSE.) THEN
CALL LAVABO_PGFL_LAITVSPCQM_PART1 (YDGEOMETRY, YGFL, YDPTRSLB1, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_SL1)
ELSE
CALL LAVABO_EXPL_LAITVSPCQM_PART1 (YDGEOMETRY, YGFL, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_SL1)
ENDIF
...
IF (NSPLTHOI /= 0.OR.LSPLTHOIGFL) THEN
  IF (.FALSE.) THEN
  CALL LAVABO_PGFL_LAITVSPCQM_PART2 (YDGEOMETRY, YGFL, YDPTRSLB1, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_SL1)
  ELSE
  CALL LAVABO_EXPL_LAITVSPCQM_PART2 (YDGEOMETRY, YGFL, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_SL1)
  ENDIF
ENDIF
...
IF( LDSLPHY ) THEN
  ...
  IF (.FALSE.) THEN
  CALL LAVABO_PGFL_LPHY (YDGEOMETRY, YGFL, YDPTRSLB1, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_SL1)
  ELSE
  CALL LAVABO_EXPL_LPHY (YDGEOMETRY, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YGFL, YDCPG_SL1)
  ENDIF
