SUBROUTINE LAVABO_PGFL_LAITVSPCQM_PART2 (YDGEOMETRY, YGFL, YDPTRSLB1, KST, KPROF, YDCPG_SL1)
...
IF (LHOOK) CALL DR_HOOK('LAVABO_PGFL_LAITVSPCQM_PART2',0,ZHOOK_HANDLE)
...
IF (LHOOK) CALL DR_HOOK('LAVABO_PGFL_LAITVSPCQM_PART2',1,ZHOOK_HANDLE)
