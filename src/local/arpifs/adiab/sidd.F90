SUBROUTINE SIDD(YDDYNA, YDCST, YDGEOMETRY,YDDYN,KLEV,KLON,PDH,PDV,PRNH,PT,PSP,KNLON)
...
CALL SIGAM(LVERTFE, YDCST, YDGEOMETRY,YDDYN,ILEV,ILON,PDH,PT,PSP,INLON,NFLEVG)
...
CALL SIGAM(LVERTFE, YDCST, YDGEOMETRY,YDDYN,ILEV,ILON,ZW3D,PRNH,ZW2D,INLON,NFLEVG)
...
CALL SISEVE(YDDYNA,YDGEOMETRY,YDDYN,ILEV,ILON,PRNH,ZW3D,INLON)
