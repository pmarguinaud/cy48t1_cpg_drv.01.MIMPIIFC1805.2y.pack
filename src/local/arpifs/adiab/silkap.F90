SUBROUTINE SILKAP(YDCST, YDGEOMETRY,YDDYN,LDNHQE_C2,KLEV,KLON,KNLON,PIN,POUT,PMULFAC)
...
IF (LVFE_LAPL_BC) CALL ABOR1(' SILKAP: case not yet coded!!!')
...
IF (LDNHQE_C2) THEN
  ...
  CALL SINHQE_SEVE(LVFE_LAPL_BC, YDCST, YDGEOMETRY,YDDYN,KLEV,KLON,PIN,ZZ1,KNLON,LD_LSTAR=.TRUE.)

  ! * Multiply by Sstar_kap: ZZ2 = Sstar_kap ZZ1
  CALL SISKAP(YDCST, YDGEOMETRY,YDDYN,KLEV,KLON,KNLON,ZZ1,ZZ2)
