SUBROUTINE TROPO_TEP(YDCST,YDGEOMETRY,KPROMA,KSTART,KPROF,KFLEV,&
  & PSPT0,PTT0,KTROP)
...
CALL GPHPRE_EXPL (YRDYNA%LAPRXPK, LVERTFE, YRDYNA%NDLNPR, YRDYNA%RHYDR0, TOPPRES, YDCST,KPROMA,KFLEV,KSTART,KPROF,YDVAB,ZPREH,PRESF=ZPREF)
