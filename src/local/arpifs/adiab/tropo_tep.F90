SUBROUTINE TROPO_TEP(PRPSTRA, PRPTROP, LDVERTFE, YDDYNA, YDCST,YDGEOMETRY,KPROMA,KSTART,KPROF,KFLEV,&
  & PSPT0,PTT0,KTROP)
...
CALL GPHPRE_EXPL (YDDYNA%LAPRXPK, LDVERTFE, YDDYNA%NDLNPR, YDDYNA%RHYDR0, TOPPRES, YDCST,KPROMA,KFLEV,KSTART,KPROF,YDVAB,ZPREH,PRESF=ZPREF)
