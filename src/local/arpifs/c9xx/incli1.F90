...
ASSOCIATE(YDDIM=>YDGEOMETRY%YRDIM,YDDIMV=>YDGEOMETRY%YRDIMV,YDGEM=>YDGEOMETRY%YRGEM, YDMP=>YDGEOMETRY%YRMP,  &
 & YDLAP=>YDGEOMETRY%YRLAP, YDCSGLEG=>YDGEOMETRY%YRCSGLEG, YDVAB=>YDGEOMETRY%YRVAB, YDVETA=>YDGEOMETRY%YRVETA,  &
...
ASSOCIATE(NDGLG=>YDDIM%NDGLG, NDGNH=>YDDIM%NDGNH, NDLON=>YDDIM%NDLON, &
 & NSEFRE=>YDDIM%NSEFRE, NSMAX=>YDDIM%NSMAX, NSPEC2G=>YDDIM%NSPEC2G, &
 & NFLEVG=>YDDIMV%NFLEVG, &
 & NLOENG=>YDGEM%NLOENG, NMENG=>YDGEM%NMENG, NSTAGP=>YDGEM%NSTAGP, &
 & NSTTYP=>YDGEM%NSTTYP)
