...
ASSOCIATE(TMERGL=>YDPHY1%TMERGL, &
 & NDGENG=>YDDIM%NDGENG, NDGLG=>YDDIM%NDGLG, NDGNH=>YDDIM%NDGNH, &
 & NDGSAG=>YDDIM%NDGSAG, NDLON=>YDDIM%NDLON, NSEFRE=>YDDIM%NSEFRE, &
 & NSMAX=>YDDIM%NSMAX, NSPEC2G=>YDDIM%NSPEC2G, &
