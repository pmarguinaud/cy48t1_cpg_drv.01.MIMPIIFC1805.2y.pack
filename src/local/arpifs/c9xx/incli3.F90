...
ASSOCIATE(SODELX=>YDPHY1%SODELX, TMERGL=>YDPHY1%TMERGL, &
 & NDGENG=>YDGEOMETRY%YRDIM%NDGENG, NDGLG=>YDGEOMETRY%YRDIM%NDGLG, NDGSAG=>YDGEOMETRY%YRDIM%NDGSAG, &
 & NDLON=>YDGEOMETRY%YRDIM%NDLON, NSMAX=>YDGEOMETRY%YRDIM%NSMAX, &
 & NFLEVG=>YDGEOMETRY%YRDIMV%NFLEVG, LSOLV=>YDPHY%LSOLV, &
 & NHTYP=>YDGEOMETRY%YRGEM%NHTYP, NLOENG=>YDGEOMETRY%YRGEM%NLOENG, NMENG=>YDGEOMETRY%YRGEM%NMENG, &
 & NSTTYP=>YDGEOMETRY%YRGEM%NSTTYP, RLOCEN=>YDGEOMETRY%YRGEM%RLOCEN, RMUCEN=>YDGEOMETRY%YRGEM%RMUCEN, &
 & RSTRET=>YDGEOMETRY%YRGEM%RSTRET, YSP_SBD=>YDSURF%YSP_SBD)
!     ------------------------------------------------------------------
