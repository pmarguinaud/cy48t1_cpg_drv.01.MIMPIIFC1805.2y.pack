...
& )
ASSOCIATE(TMERGL=>YDPHY1%TMERGL, LSOLV=>YDPHY%LSOLV,   NDGENG=>YDDIM%NDGENG, NDGLG=>YDDIM%NDGLG, NDGSAG=>YDDIM%NDGSAG,   &
& NDLON=>YDDIM%NDLON, NSMAX=>YDDIM%NSMAX,   NFLEVG=>YDDIMV%NFLEVG,   NHTYP=>YDGEM%NHTYP, NLOENG=>YDGEM%NLOENG,           &
& NMENG=>YDGEM%NMENG,   NSTTYP=>YDGEM%NSTTYP, RLOCEN=>YDGEM%RLOCEN, RMUCEN=>YDGEM%RMUCEN,   RSTRET=>YDGEM%RSTRET,        &
