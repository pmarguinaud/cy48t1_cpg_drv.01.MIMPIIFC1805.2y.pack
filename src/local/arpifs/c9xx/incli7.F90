...
& NDLON=>YDDIM%NDLON, NSMAX=>YDDIM%NSMAX,   NFLEVG=>YDDIMV%NFLEVG,   NHTYP=>YDGEM%NHTYP, NLOENG=>YDGEM%NLOENG,    &
& NMENG=>YDGEM%NMENG,   NSTAGP=>YDGEM%NSTAGP, NSTTYP=>YDGEM%NSTTYP, RLOCEN=>YDGEM%RLOCEN,   RMUCEN=>YDGEM%RMUCEN, &
& RSTRET=>YDGEM%RSTRET)
!     ------------------------------------------------------------------
