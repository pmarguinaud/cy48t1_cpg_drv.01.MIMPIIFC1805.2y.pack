...
! R:
CALL GPRCP_QLIRSG(KPROMA,KST,KND,NFLEVG,PQ=ZGFLT0(1,1,YLPPIC%IQ),&
...
IF (LLAPA(1)) THEN
  ...
  IF (LLPBL) THEN
    ...
    ! R:
    CALL GPRCP_QLIRSG(KPROMA,KST,KND,NFLEVG,&
...
IF (KOPLEV > 0) THEN
  ...
  IF (LL_TH .OR. LL_ETH .OR. LL_IET .OR. LL_THV) THEN
    ...
    ! (using ._PP as input data).
    CALL GPRCP_QLIRSG(KPROMA,KST,KND,KOPLEV,PQ=ZGFLPP(1,1,YLPPIC%IQ),&
  ...
  IF (LL_RHO) THEN
    ...
    CALL GPRCP_QLIRSG(KPROMA,KST,KND,KOPLEV,&
     & PQ=ZGFLPP(1,1,YLPPIC%IQ),PQI=ZGFLPP(1,1,YLPPIC%II),&
