...
ASSOCIATE(TFP=>YDAFN%TFP, TFP_DYNDS=>YDAFN%TFP_DYNDS, YDVAB=>YDGEOMETRY%YRVAB, &
 ...
 & YDSPGEOM=>YDGEOMETRY%YSPGEOM, YDPHY=>YDML_PHY_MF%YRPHY, &
 & YDPHY0=>YDML_PHY_MF%YRPHY0, YDPHY2=>YDML_PHY_MF%YRPHY2, &
 & YDARPHY=>YDML_PHY_MF%YRARPHY)
ASSOCIATE(NFPCAPE=>YDNAMFPSCI%NFPCAPE, LFPCAPEX=>YDNAMFPSCI%LFPCAPEX, RENTRA=>YDNAMFPSCI%RENTRA, &
 & RMLDEP=>YDNAMFPSCI%RMLDEP, &
 & NFLEVG=>YDGEOMETRY%YRDIMV%NFLEVG, NSTOP=>YDRIP%NSTOP, YSD_VF=>YDSURF%YSD_VF, &
 & YSD_VFD=>YDSURF%YSD_VFD, YSD_VV=>YDSURF%YSD_VV, YSD_VVD=>YDSURF%YSD_VVD, &
 & YSP_RR=>YDSURF%YSP_RR, YSP_RRD=>YDSURF%YSP_RRD, YSP_SG=>YDSURF%YSP_SG, &
 & YSP_SGD=>YDSURF%YSP_SGD, LNEIGE=>YDPHY%LNEIGE,YDDIMV=>YDGEOMETRY%YRDIMV)
!     ------------------------------------------------------------------
