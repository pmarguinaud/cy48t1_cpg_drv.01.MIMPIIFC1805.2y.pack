  ...
  DO JLEV=1,KFLEV
    DO JROF=KST,KPROF
      ...
      IF (LLSLHD) THEN
        ...
        ZWD1=PCLA(JROF,JLEV,1)+SLHDKMAX*(ZWL1-PCLA(JROF,JLEV,1))
        ZWD2=PCLA(JROF,JLEV,2)+SLHDKMAX*(ZWL2-PCLA(JROF,JLEV,2))
        ZWD3=PCLA(JROF,JLEV,3)+SLHDKMAX*(ZWL3-PCLA(JROF,JLEV,3))
