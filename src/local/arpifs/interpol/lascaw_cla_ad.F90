...
!CDIR NODEP
  DO JROF=KST,KPROF
    ...
    ZWD15=PWH5(JROF,1,JLEV)+YRDYNA%SLHDKMAX*(ZWL15-PWH5(JROF,1,JLEV))
    ZWD25=PWH5(JROF,2,JLEV)+YRDYNA%SLHDKMAX*(ZWL25-PWH5(JROF,2,JLEV))
    ZWD35=PWH5(JROF,3,JLEV)+YRDYNA%SLHDKMAX*(ZWL35-PWH5(JROF,3,JLEV))
    ...
    PWH(JROF,1,JLEV)=(1._JPRB-ZSLHDKMIN)*ZWA1+(1._JPRB-YRDYNA%SLHDKMAX)*ZWD1
    PWH(JROF,2,JLEV)=(1._JPRB-ZSLHDKMIN)*ZWA2+(1._JPRB-YRDYNA%SLHDKMAX)*ZWD2
    PWH(JROF,3,JLEV)=(1._JPRB-ZSLHDKMIN)*ZWA3+(1._JPRB-YRDYNA%SLHDKMAX)*ZWD3
