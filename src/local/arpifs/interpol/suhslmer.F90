...
IF(LDEQMER) THEN
  ...
  DO JGL= KGLN,KGLX
    ...
    RSLDW(1,1,JGL)=1.0_JPRB-2.0_JPRB*SLHDEPSH
    RSLDW(1,2,JGL)=SLHDEPSH
    RSLDW(1,3,JGL)=0.0_JPRB
    RSLDW(2,1,JGL)=SLHDEPSH
    RSLDW(2,2,JGL)=1.0_JPRB-2.0_JPRB*SLHDEPSH
    RSLDW(2,3,JGL)=0.0_JPRB
    RSLDW(3,1,JGL)=0.0_JPRB
    RSLDW(3,2,JGL)=SLHDEPSH
...
ELSE
  ...
  DO JGL= KGLN,KGLX
    ...
    IF(IGLGLO >= 0.AND.IGLGLO <= NDGLG) THEN
      ...
      RSLDW(1,1,JGL)=1.0_JPRD-2.0_JPRD*SLHDEPSH*ZD4/ZD1
      RSLDW(1,2,JGL)=2.0_JPRD*SLHDEPSH*ZD4/ZD5
      RSLDW(1,3,JGL)=0.0_JPRD
      RSLDW(2,1,JGL)=2.0_JPRD*SLHDEPSH*ZD4/ZD2
      RSLDW(2,2,JGL)=1.0_JPRD-2.0_JPRD*SLHDEPSH*ZD4/ZD6
      RSLDW(2,3,JGL)=0.0_JPRD
      RSLDW(3,1,JGL)=0.0_JPRD
      RSLDW(3,2,JGL)=2.0_JPRD*SLHDEPSH*(ZD4*ZD4)/(ZD5*ZD6)
