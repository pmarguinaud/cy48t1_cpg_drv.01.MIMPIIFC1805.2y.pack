...
USE YOMDYNA  , ONLY : LSLHD, LSLHDQUAD, SLHDEPSV, LSLHDVER, LSLTVWENO, LHOISLT, &
  &                   HOISLTH, HOISLTV, LRHSVWENO
...
DO JLEV=1,NFLEVG-3
  ...
  IF (LSLHD) THEN
    IF (LSLHDVER) THEN
      YDVSLETA%VSLDW(1,1,JLEV)=1.0_JPRB-SLHDEPSV*(YDVAB%VBH(JLEV-1)+YDVAB%VBH(JLEV))*ZD4/ZD1
      YDVSLETA%VSLDW(1,2,JLEV)=SLHDEPSV*(YDVAB%VBH(JLEV-1)+YDVAB%VBH(JLEV))*ZD4/ZD5
      YDVSLETA%VSLDW(1,3,JLEV)=0.0_JPRB
      YDVSLETA%VSLDW(2,1,JLEV)=SLHDEPSV*(YDVAB%VBH(JLEV-1)+YDVAB%VBH(JLEV))*ZD4/ZD2
      YDVSLETA%VSLDW(2,2,JLEV)=1.0_JPRB-SLHDEPSV*(YDVAB%VBH(JLEV-1)+YDVAB%VBH(JLEV))*ZD4/ZD6
      YDVSLETA%VSLDW(2,3,JLEV)=0.0_JPRB
      YDVSLETA%VSLDW(3,1,JLEV)=0.0_JPRB
      YDVSLETA%VSLDW(3,2,JLEV)=SLHDEPSV*(YDVAB%VBH(JLEV-1)+YDVAB%VBH(JLEV))*(ZD4*ZD4)/(ZD5*ZD6)
      YDVSLETA%VSLDW(3,3,JLEV)=1.0_JPRB
    ELSE
      YDVSLETA%VSLDW(1,1,JLEV)=1.0_JPRB-2.0_JPRB*SLHDEPSV*ZD4/ZD1
      YDVSLETA%VSLDW(1,2,JLEV)=2.0_JPRB*SLHDEPSV*ZD4/ZD5
      YDVSLETA%VSLDW(1,3,JLEV)=0.0_JPRB
      YDVSLETA%VSLDW(2,1,JLEV)=2.0_JPRB*SLHDEPSV*ZD4/ZD2
      YDVSLETA%VSLDW(2,2,JLEV)=1.0_JPRB-2.0_JPRB*SLHDEPSV*ZD4/ZD6
      YDVSLETA%VSLDW(2,3,JLEV)=0.0_JPRB
      YDVSLETA%VSLDW(3,1,JLEV)=0.0_JPRB
      YDVSLETA%VSLDW(3,2,JLEV)=2.0_JPRB*SLHDEPSV*(ZD4*ZD4)/(ZD5*ZD6)
      YDVSLETA%VSLDW(3,3,JLEV)=1.0_JPRB
    ENDIF
  ELSE
...
DO JLEV=1,NFLEVG-3
  ...
  IF (LSLHD) THEN
    IF (LSLHDVER) THEN
      YDVSLETA%VSLDWH(1,1,JLEV)=1.0_JPRB-2.0_JPRB*SLHDEPSV*YDVAB%VBH(JLEV)*ZD4/ZD1
      YDVSLETA%VSLDWH(1,2,JLEV)=2.0_JPRB*SLHDEPSV*YDVAB%VBH(JLEV)*ZD4/ZD5
      YDVSLETA%VSLDWH(1,3,JLEV)=0.0_JPRB
      YDVSLETA%VSLDWH(2,1,JLEV)=2.0_JPRB*SLHDEPSV*YDVAB%VBH(JLEV)*ZD4/ZD2
      YDVSLETA%VSLDWH(2,2,JLEV)=1.0_JPRB-2.0_JPRB*SLHDEPSV*YDVAB%VBH(JLEV)*ZD4/ZD6
      YDVSLETA%VSLDWH(2,3,JLEV)=0.0_JPRB
      YDVSLETA%VSLDWH(3,1,JLEV)=0.0_JPRB
      YDVSLETA%VSLDWH(3,2,JLEV)=2.0_JPRB*SLHDEPSV*YDVAB%VBH(JLEV)*(ZD4*ZD4)/(ZD5*ZD6)
      YDVSLETA%VSLDWH(3,3,JLEV)=1.0_JPRB
    ELSE
      YDVSLETA%VSLDWH(1,1,JLEV)=1.0_JPRB-2.0_JPRB*SLHDEPSV*ZD4/ZD1
      YDVSLETA%VSLDWH(1,2,JLEV)=2.0_JPRB*SLHDEPSV*ZD4/ZD5
      YDVSLETA%VSLDWH(1,3,JLEV)=0.0_JPRB
      YDVSLETA%VSLDWH(2,1,JLEV)=2.0_JPRB*SLHDEPSV*ZD4/ZD2
      YDVSLETA%VSLDWH(2,2,JLEV)=1.0_JPRB-2.0_JPRB*SLHDEPSV*ZD4/ZD6
      YDVSLETA%VSLDWH(2,3,JLEV)=0.0_JPRB
      YDVSLETA%VSLDWH(3,1,JLEV)=0.0_JPRB
      YDVSLETA%VSLDWH(3,2,JLEV)=2.0_JPRB*SLHDEPSV*(ZD4*ZD4)/(ZD5*ZD6)
      YDVSLETA%VSLDWH(3,3,JLEV)=1.0_JPRB
    ENDIF
  ELSE
