...
IF (ASSOCIATED (SELF%F_PHIF)) CALL DELETE_TEMPORARY (SELF%F_PHIF) ! Should have a DELETE_FIELD_WRAP or a method handling both cases
IF (ASSOCIATED (SELF%F_RCP )) CALL DELETE_TEMPORARY (SELF%F_RCP ) ! Should have a DELETE_FIELD_WRAP or a method handling both cases
IF (ASSOCIATED (SELF%F_PREF)) CALL DELETE_TEMPORARY (SELF%F_PREF) ! Should have a DELETE_FIELD_WRAP or a method handling both cases
IF (ASSOCIATED (SELF%F_CTY )) CALL DELETE_TEMPORARY (SELF%F_CTY ) ! Should have a DELETE_FIELD_WRAP or a method handling both cases
IF (ASSOCIATED (SELF%F_WRL )) CALL DELETE_TEMPORARY (SELF%F_WRL ) ! Should have a DELETE_FIELD_WRAP or a method handling both cases
