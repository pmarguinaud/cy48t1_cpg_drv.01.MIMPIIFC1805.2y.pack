...
IF (YDTPTRSLB1%MSLB1U9 > 0) THEN
  SELF%F_U9 => CREATE_FIELD_WRAP ('U9', SELF%ZDATA (:, YDTPTRSLB1%MSLB1U9:YDTPTRSLB1%MSLB1U9+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1V9 > 0) THEN
  SELF%F_V9 => CREATE_FIELD_WRAP ('V9', SELF%ZDATA (:, YDTPTRSLB1%MSLB1V9:YDTPTRSLB1%MSLB1V9+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1T9 > 0) THEN
  SELF%F_T9 => CREATE_FIELD_WRAP ('T9', SELF%ZDATA (:, YDTPTRSLB1%MSLB1T9:YDTPTRSLB1%MSLB1T9+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1PD9 > 0) THEN
  SELF%F_PD9 => CREATE_FIELD_WRAP ('PD9', SELF%ZDATA (:, YDTPTRSLB1%MSLB1PD9:YDTPTRSLB1%MSLB1PD9+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1VD9 > 0) THEN
  SELF%F_VD9 => CREATE_FIELD_WRAP ('VD9', SELF%ZDATA (:, YDTPTRSLB1%MSLB1VD9:YDTPTRSLB1%MSLB1VD9+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1NHX9 > 0) THEN
  SELF%F_NHX9 => CREATE_FIELD_WRAP ('NHX9', SELF%ZDATA (:, YDTPTRSLB1%MSLB1NHX9:YDTPTRSLB1%MSLB1NHX9+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1UR0 > 0) THEN
  SELF%F_UR0 => CREATE_FIELD_WRAP ('UR0', SELF%ZDATA (:, YDTPTRSLB1%MSLB1UR0:YDTPTRSLB1%MSLB1UR0+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1VR0 > 0) THEN
  SELF%F_VR0 => CREATE_FIELD_WRAP ('VR0', SELF%ZDATA (:, YDTPTRSLB1%MSLB1VR0:YDTPTRSLB1%MSLB1VR0+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1ZR0 > 0) THEN
  SELF%F_ZR0 => CREATE_FIELD_WRAP ('ZR0', SELF%ZDATA (:, YDTPTRSLB1%MSLB1ZR0:YDTPTRSLB1%MSLB1ZR0+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1WR0 > 0) THEN
  SELF%F_WR0 => CREATE_FIELD_WRAP ('WR0', SELF%ZDATA (:, YDTPTRSLB1%MSLB1WR0:YDTPTRSLB1%MSLB1WR0+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1UR00 > 0) THEN
  SELF%F_UR00 => CREATE_FIELD_WRAP ('UR00', SELF%ZDATA (:, YDTPTRSLB1%MSLB1UR00:YDTPTRSLB1%MSLB1UR00+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1VR00 > 0) THEN
  SELF%F_VR00 => CREATE_FIELD_WRAP ('VR00', SELF%ZDATA (:, YDTPTRSLB1%MSLB1VR00:YDTPTRSLB1%MSLB1VR00+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1ZR00 > 0) THEN
  SELF%F_ZR00 => CREATE_FIELD_WRAP ('ZR00', SELF%ZDATA (:, YDTPTRSLB1%MSLB1ZR00:YDTPTRSLB1%MSLB1ZR00+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1WR00 > 0) THEN
  SELF%F_WR00 => CREATE_FIELD_WRAP ('WR00', SELF%ZDATA (:, YDTPTRSLB1%MSLB1WR00:YDTPTRSLB1%MSLB1WR00+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1WRA > 0) THEN
  SELF%F_WRA => CREATE_FIELD_WRAP ('WRA', SELF%ZDATA (:, YDTPTRSLB1%MSLB1WRA:YDTPTRSLB1%MSLB1WRA+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1UR9 > 0) THEN
  SELF%F_UR9 => CREATE_FIELD_WRAP ('UR9', SELF%ZDATA (:, YDTPTRSLB1%MSLB1UR9:YDTPTRSLB1%MSLB1UR9+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1VR9 > 0) THEN
  SELF%F_VR9 => CREATE_FIELD_WRAP ('VR9', SELF%ZDATA (:, YDTPTRSLB1%MSLB1VR9:YDTPTRSLB1%MSLB1VR9+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1DBBC9 > 0) THEN
  SELF%F_DBBC9 => CREATE_FIELD_WRAP ('DBBC9', SELF%ZDATA (:, YDTPTRSLB1%MSLB1DBBC9:YDTPTRSLB1%MSLB1DBBC9+NLEV+1, :),&
      & PERSISTENT=.NOT. SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1DPHI9 > 0) THEN
  SELF%F_DPHI9 => CREATE_FIELD_WRAP ('DPHI9', SELF%ZDATA (:, YDTPTRSLB1%MSLB1DPHI9:YDTPTRSLB1%MSLB1DPHI9+NLEV+1, :),&
      & PERSISTENT=.NOT. SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1GWS9 > 0) THEN
  SELF%F_GWS9 => CREATE_FIELD_WRAP ('GWS9', SELF%ZDATA (:, YDTPTRSLB1%MSLB1GWS9, :), PERSISTENT=.NOT. SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1U0 > 0) THEN
  SELF%F_U0 => CREATE_FIELD_WRAP ('U0', SELF%ZDATA (:, YDTPTRSLB1%MSLB1U0:YDTPTRSLB1%MSLB1U0+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1V0 > 0) THEN
  SELF%F_V0 => CREATE_FIELD_WRAP ('V0', SELF%ZDATA (:, YDTPTRSLB1%MSLB1V0:YDTPTRSLB1%MSLB1V0+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1T0 > 0) THEN
  SELF%F_T0 => CREATE_FIELD_WRAP ('T0', SELF%ZDATA (:, YDTPTRSLB1%MSLB1T0:YDTPTRSLB1%MSLB1T0+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1PD0 > 0) THEN
  SELF%F_PD0 => CREATE_FIELD_WRAP ('PD0', SELF%ZDATA (:, YDTPTRSLB1%MSLB1PD0:YDTPTRSLB1%MSLB1PD0+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1VD0 > 0) THEN
  SELF%F_VD0 => CREATE_FIELD_WRAP ('VD0', SELF%ZDATA (:, YDTPTRSLB1%MSLB1VD0:YDTPTRSLB1%MSLB1VD0+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1C9 > 0) THEN
  SELF%F_C9 => CREATE_FIELD_WRAP ('C9', SELF%ZDATA (:, YDTPTRSLB1%MSLB1C9:YDTPTRSLB1%MSLB1C9+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1SP9 > 0) THEN
  SELF%F_SP9 => CREATE_FIELD_WRAP ('SP9', SELF%ZDATA (:, YDTPTRSLB1%MSLB1SP9, :), PERSISTENT=.NOT. SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1SP0 > 0) THEN
  SELF%F_SP0 => CREATE_FIELD_WRAP ('SP0', SELF%ZDATA (:, YDTPTRSLB1%MSLB1SP0, :), PERSISTENT=.NOT. SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1C0 > 0) THEN
  SELF%F_C0 => CREATE_FIELD_WRAP ('C0', SELF%ZDATA (:, YDTPTRSLB1%MSLB1C0:YDTPTRSLB1%MSLB1C0+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1UP9 > 0) THEN
  SELF%F_UP9 => CREATE_FIELD_WRAP ('UP9', SELF%ZDATA (:, YDTPTRSLB1%MSLB1UP9:YDTPTRSLB1%MSLB1UP9+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1VP9 > 0) THEN
  SELF%F_VP9 => CREATE_FIELD_WRAP ('VP9', SELF%ZDATA (:, YDTPTRSLB1%MSLB1VP9:YDTPTRSLB1%MSLB1VP9+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1TP9 > 0) THEN
  SELF%F_TP9 => CREATE_FIELD_WRAP ('TP9', SELF%ZDATA (:, YDTPTRSLB1%MSLB1TP9:YDTPTRSLB1%MSLB1TP9+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1U9_SI > 0) THEN
  SELF%F_U9_SI => CREATE_FIELD_WRAP ('U9_SI', SELF%ZDATA (:, YDTPTRSLB1%MSLB1U9_SI:YDTPTRSLB1%MSLB1U9_SI+NLEV+1, :),&
      & PERSISTENT=.NOT. SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1V9_SI > 0) THEN
  SELF%F_V9_SI => CREATE_FIELD_WRAP ('V9_SI', SELF%ZDATA (:, YDTPTRSLB1%MSLB1V9_SI:YDTPTRSLB1%MSLB1V9_SI+NLEV+1, :),&
      & PERSISTENT=.NOT. SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1T9_SI > 0) THEN
  SELF%F_T9_SI => CREATE_FIELD_WRAP ('T9_SI', SELF%ZDATA (:, YDTPTRSLB1%MSLB1T9_SI:YDTPTRSLB1%MSLB1T9_SI+NLEV+1, :),&
      & PERSISTENT=.NOT. SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1PD9_SI > 0) THEN
  SELF%F_PD9_SI => CREATE_FIELD_WRAP ('PD9_SI', SELF%ZDATA (:, YDTPTRSLB1%MSLB1PD9_SI:YDTPTRSLB1%MSLB1PD9_SI+NLEV+1, :),&
      & PERSISTENT=.NOT. SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1VD9_SI > 0) THEN
  SELF%F_VD9_SI => CREATE_FIELD_WRAP ('VD9_SI', SELF%ZDATA (:, YDTPTRSLB1%MSLB1VD9_SI:YDTPTRSLB1%MSLB1VD9_SI+NLEV+1, :),&
      & PERSISTENT=.NOT. SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1C9_SI > 0) THEN
  SELF%F_C9_SI => CREATE_FIELD_WRAP ('C9_SI', SELF%ZDATA (:, YDTPTRSLB1%MSLB1C9_SI:YDTPTRSLB1%MSLB1C9_SI+NLEV+1, :),&
      & PERSISTENT=.NOT. SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1UF9 > 0) THEN
  SELF%F_UF9 => CREATE_FIELD_WRAP ('UF9', SELF%ZDATA (:, YDTPTRSLB1%MSLB1UF9:YDTPTRSLB1%MSLB1UF9+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1VF9 > 0) THEN
  SELF%F_VF9 => CREATE_FIELD_WRAP ('VF9', SELF%ZDATA (:, YDTPTRSLB1%MSLB1VF9:YDTPTRSLB1%MSLB1VF9+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1TF9 > 0) THEN
  SELF%F_TF9 => CREATE_FIELD_WRAP ('TF9', SELF%ZDATA (:, YDTPTRSLB1%MSLB1TF9:YDTPTRSLB1%MSLB1TF9+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1VDF9 > 0) THEN
  SELF%F_VDF9 => CREATE_FIELD_WRAP ('VDF9', SELF%ZDATA (:, YDTPTRSLB1%MSLB1VDF9:YDTPTRSLB1%MSLB1VDF9+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1U9_NL > 0) THEN
  SELF%F_U9_NL => CREATE_FIELD_WRAP ('U9_NL', SELF%ZDATA (:, YDTPTRSLB1%MSLB1U9_NL:YDTPTRSLB1%MSLB1U9_NL+NLEV+1, :),&
      & PERSISTENT=.NOT. SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1V9_NL > 0) THEN
  SELF%F_V9_NL => CREATE_FIELD_WRAP ('V9_NL', SELF%ZDATA (:, YDTPTRSLB1%MSLB1V9_NL:YDTPTRSLB1%MSLB1V9_NL+NLEV+1, :),&
      & PERSISTENT=.NOT. SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1T9_NL > 0) THEN
  SELF%F_T9_NL => CREATE_FIELD_WRAP ('T9_NL', SELF%ZDATA (:, YDTPTRSLB1%MSLB1T9_NL:YDTPTRSLB1%MSLB1T9_NL+NLEV+1, :),&
      & PERSISTENT=.NOT. SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1PD9_NL > 0) THEN
  SELF%F_PD9_NL => CREATE_FIELD_WRAP ('PD9_NL', SELF%ZDATA (:, YDTPTRSLB1%MSLB1PD9_NL:YDTPTRSLB1%MSLB1PD9_NL+NLEV+1, :),&
      & PERSISTENT=.NOT. SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1VD9_NL > 0) THEN
  SELF%F_VD9_NL => CREATE_FIELD_WRAP ('VD9_NL', SELF%ZDATA (:, YDTPTRSLB1%MSLB1VD9_NL:YDTPTRSLB1%MSLB1VD9_NL+NLEV+1, :),&
      & PERSISTENT=.NOT. SELF%LOWNED)
ENDIF
IF (YDTPTRSLB1%MSLB1C9_NL > 0) THEN
  SELF%F_C9_NL => CREATE_FIELD_WRAP ('C9_NL', SELF%ZDATA (:, YDTPTRSLB1%MSLB1C9_NL:YDTPTRSLB1%MSLB1C9_NL+NLEV+1, :),&
      & PERSISTENT=.NOT. SELF%LOWNED)
ENDIF

IF (YGFL%YQ%MP_SL1 > 0 .AND. YGFL%YQ%MP1 > 0) THEN
  SELF%I_Q   = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YQ%MP_SL1-1)*(NLEV+2)
ELSE
  SELF%I_Q   = -1
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YQ%MP_SL1 > 0 .AND. YGFL%YQ%MP1 > 0) THEN
    SELF%I_Q_F = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YQ%MP_SL1-1)*(NLEV+2)
  ELSE
    SELF%I_Q_F = -1
  ENDIF
ENDIF
IF (YGFL%YI%MP_SL1 > 0 .AND. YGFL%YI%MP1 > 0) THEN
  SELF%I_I   = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YI%MP_SL1-1)*(NLEV+2)
ELSE
  SELF%I_I   = -1
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YI%MP_SL1 > 0 .AND. YGFL%YI%MP1 > 0) THEN
    SELF%I_I_F = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YI%MP_SL1-1)*(NLEV+2)
  ELSE
    SELF%I_I_F = -1
  ENDIF
ENDIF
IF (YGFL%YL%MP_SL1 > 0 .AND. YGFL%YL%MP1 > 0) THEN
  SELF%I_L   = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YL%MP_SL1-1)*(NLEV+2)
ELSE
  SELF%I_L   = -1
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YL%MP_SL1 > 0 .AND. YGFL%YL%MP1 > 0) THEN
    SELF%I_L_F = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YL%MP_SL1-1)*(NLEV+2)
  ELSE
    SELF%I_L_F = -1
  ENDIF
ENDIF
IF (YGFL%YLCONV%MP_SL1 > 0 .AND. YGFL%YLCONV%MP1 > 0) THEN
  SELF%I_LCONV   = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YLCONV%MP_SL1-1)*(NLEV+2)
ELSE
  SELF%I_LCONV   = -1
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YLCONV%MP_SL1 > 0 .AND. YGFL%YLCONV%MP1 > 0) THEN
    SELF%I_LCONV_F = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YLCONV%MP_SL1-1)*(NLEV+2)
  ELSE
    SELF%I_LCONV_F = -1
  ENDIF
ENDIF
IF (YGFL%YICONV%MP_SL1 > 0 .AND. YGFL%YICONV%MP1 > 0) THEN
  SELF%I_ICONV   = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YICONV%MP_SL1-1)*(NLEV+2)
ELSE
  SELF%I_ICONV   = -1
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YICONV%MP_SL1 > 0 .AND. YGFL%YICONV%MP1 > 0) THEN
    SELF%I_ICONV_F = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YICONV%MP_SL1-1)*(NLEV+2)
  ELSE
    SELF%I_ICONV_F = -1
  ENDIF
ENDIF
IF (YGFL%YRCONV%MP_SL1 > 0 .AND. YGFL%YRCONV%MP1 > 0) THEN
  SELF%I_RCONV   = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YRCONV%MP_SL1-1)*(NLEV+2)
ELSE
  SELF%I_RCONV   = -1
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YRCONV%MP_SL1 > 0 .AND. YGFL%YRCONV%MP1 > 0) THEN
    SELF%I_RCONV_F = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YRCONV%MP_SL1-1)*(NLEV+2)
  ELSE
    SELF%I_RCONV_F = -1
  ENDIF
ENDIF
IF (YGFL%YSCONV%MP_SL1 > 0 .AND. YGFL%YSCONV%MP1 > 0) THEN
  SELF%I_SCONV   = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YSCONV%MP_SL1-1)*(NLEV+2)
ELSE
  SELF%I_SCONV   = -1
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YSCONV%MP_SL1 > 0 .AND. YGFL%YSCONV%MP1 > 0) THEN
    SELF%I_SCONV_F = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YSCONV%MP_SL1-1)*(NLEV+2)
  ELSE
    SELF%I_SCONV_F = -1
  ENDIF
ENDIF
IF (YGFL%YIRAD%MP_SL1 > 0 .AND. YGFL%YIRAD%MP1 > 0) THEN
  SELF%I_IRAD   = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YIRAD%MP_SL1-1)*(NLEV+2)
ELSE
  SELF%I_IRAD   = -1
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YIRAD%MP_SL1 > 0 .AND. YGFL%YIRAD%MP1 > 0) THEN
    SELF%I_IRAD_F = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YIRAD%MP_SL1-1)*(NLEV+2)
  ELSE
    SELF%I_IRAD_F = -1
  ENDIF
ENDIF
IF (YGFL%YLRAD%MP_SL1 > 0 .AND. YGFL%YLRAD%MP1 > 0) THEN
  SELF%I_LRAD   = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YLRAD%MP_SL1-1)*(NLEV+2)
ELSE
  SELF%I_LRAD   = -1
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YLRAD%MP_SL1 > 0 .AND. YGFL%YLRAD%MP1 > 0) THEN
    SELF%I_LRAD_F = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YLRAD%MP_SL1-1)*(NLEV+2)
  ELSE
    SELF%I_LRAD_F = -1
  ENDIF
ENDIF
IF (YGFL%YS%MP_SL1 > 0 .AND. YGFL%YS%MP1 > 0) THEN
  SELF%I_S   = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YS%MP_SL1-1)*(NLEV+2)
ELSE
  SELF%I_S   = -1
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YS%MP_SL1 > 0 .AND. YGFL%YS%MP1 > 0) THEN
    SELF%I_S_F = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YS%MP_SL1-1)*(NLEV+2)
  ELSE
    SELF%I_S_F = -1
  ENDIF
ENDIF
IF (YGFL%YR%MP_SL1 > 0 .AND. YGFL%YR%MP1 > 0) THEN
  SELF%I_R   = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YR%MP_SL1-1)*(NLEV+2)
ELSE
  SELF%I_R   = -1
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YR%MP_SL1 > 0 .AND. YGFL%YR%MP1 > 0) THEN
    SELF%I_R_F = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YR%MP_SL1-1)*(NLEV+2)
  ELSE
    SELF%I_R_F = -1
  ENDIF
ENDIF
IF (YGFL%YG%MP_SL1 > 0 .AND. YGFL%YG%MP1 > 0) THEN
  SELF%I_G   = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YG%MP_SL1-1)*(NLEV+2)
ELSE
  SELF%I_G   = -1
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YG%MP_SL1 > 0 .AND. YGFL%YG%MP1 > 0) THEN
    SELF%I_G_F = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YG%MP_SL1-1)*(NLEV+2)
  ELSE
    SELF%I_G_F = -1
  ENDIF
ENDIF
IF (YGFL%YH%MP_SL1 > 0 .AND. YGFL%YH%MP1 > 0) THEN
  SELF%I_H   = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YH%MP_SL1-1)*(NLEV+2)
ELSE
  SELF%I_H   = -1
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YH%MP_SL1 > 0 .AND. YGFL%YH%MP1 > 0) THEN
    SELF%I_H_F = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YH%MP_SL1-1)*(NLEV+2)
  ELSE
    SELF%I_H_F = -1
  ENDIF
ENDIF
IF (YGFL%YTKE%MP_SL1 > 0 .AND. YGFL%YTKE%MP1 > 0) THEN
  SELF%I_TKE   = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YTKE%MP_SL1-1)*(NLEV+2)
ELSE
  SELF%I_TKE   = -1
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YTKE%MP_SL1 > 0 .AND. YGFL%YTKE%MP1 > 0) THEN
    SELF%I_TKE_F = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YTKE%MP_SL1-1)*(NLEV+2)
  ELSE
    SELF%I_TKE_F = -1
  ENDIF
ENDIF
IF (YGFL%YTTE%MP_SL1 > 0 .AND. YGFL%YTTE%MP1 > 0) THEN
  SELF%I_TTE   = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YTTE%MP_SL1-1)*(NLEV+2)
ELSE
  SELF%I_TTE   = -1
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YTTE%MP_SL1 > 0 .AND. YGFL%YTTE%MP1 > 0) THEN
    SELF%I_TTE_F = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YTTE%MP_SL1-1)*(NLEV+2)
  ELSE
    SELF%I_TTE_F = -1
  ENDIF
ENDIF
IF (YGFL%YEFB1%MP_SL1 > 0 .AND. YGFL%YEFB1%MP1 > 0) THEN
  SELF%I_EFB1   = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YEFB1%MP_SL1-1)*(NLEV+2)
ELSE
  SELF%I_EFB1   = -1
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YEFB1%MP_SL1 > 0 .AND. YGFL%YEFB1%MP1 > 0) THEN
    SELF%I_EFB1_F = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YEFB1%MP_SL1-1)*(NLEV+2)
  ELSE
    SELF%I_EFB1_F = -1
  ENDIF
ENDIF
IF (YGFL%YEFB2%MP_SL1 > 0 .AND. YGFL%YEFB2%MP1 > 0) THEN
  SELF%I_EFB2   = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YEFB2%MP_SL1-1)*(NLEV+2)
ELSE
  SELF%I_EFB2   = -1
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YEFB2%MP_SL1 > 0 .AND. YGFL%YEFB2%MP1 > 0) THEN
    SELF%I_EFB2_F = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YEFB2%MP_SL1-1)*(NLEV+2)
  ELSE
    SELF%I_EFB2_F = -1
  ENDIF
ENDIF
IF (YGFL%YEFB3%MP_SL1 > 0 .AND. YGFL%YEFB3%MP1 > 0) THEN
  SELF%I_EFB3   = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YEFB3%MP_SL1-1)*(NLEV+2)
ELSE
  SELF%I_EFB3   = -1
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YEFB3%MP_SL1 > 0 .AND. YGFL%YEFB3%MP1 > 0) THEN
    SELF%I_EFB3_F = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YEFB3%MP_SL1-1)*(NLEV+2)
  ELSE
    SELF%I_EFB3_F = -1
  ENDIF
ENDIF
IF (YGFL%YA%MP_SL1 > 0 .AND. YGFL%YA%MP1 > 0) THEN
  SELF%I_A   = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YA%MP_SL1-1)*(NLEV+2)
ELSE
  SELF%I_A   = -1
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YA%MP_SL1 > 0 .AND. YGFL%YA%MP1 > 0) THEN
    SELF%I_A_F = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YA%MP_SL1-1)*(NLEV+2)
  ELSE
    SELF%I_A_F = -1
  ENDIF
ENDIF
IF (YGFL%YO3%MP_SL1 > 0 .AND. YGFL%YO3%MP1 > 0) THEN
  SELF%I_O3   = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YO3%MP_SL1-1)*(NLEV+2)
ELSE
  SELF%I_O3   = -1
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YO3%MP_SL1 > 0 .AND. YGFL%YO3%MP1 > 0) THEN
    SELF%I_O3_F = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YO3%MP_SL1-1)*(NLEV+2)
  ELSE
    SELF%I_O3_F = -1
  ENDIF
ENDIF
IF (YGFL%YSRC%MP_SL1 > 0 .AND. YGFL%YSRC%MP1 > 0) THEN
  SELF%I_SRC   = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YSRC%MP_SL1-1)*(NLEV+2)
ELSE
  SELF%I_SRC   = -1
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YSRC%MP_SL1 > 0 .AND. YGFL%YSRC%MP1 > 0) THEN
    SELF%I_SRC_F = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YSRC%MP_SL1-1)*(NLEV+2)
  ELSE
    SELF%I_SRC_F = -1
  ENDIF
ENDIF
IF (YGFL%YMXL%MP_SL1 > 0 .AND. YGFL%YMXL%MP1 > 0) THEN
  SELF%I_MXL   = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YMXL%MP_SL1-1)*(NLEV+2)
ELSE
  SELF%I_MXL   = -1
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YMXL%MP_SL1 > 0 .AND. YGFL%YMXL%MP1 > 0) THEN
    SELF%I_MXL_F = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YMXL%MP_SL1-1)*(NLEV+2)
  ELSE
    SELF%I_MXL_F = -1
  ENDIF
ENDIF
IF (YGFL%YSHTUR%MP_SL1 > 0 .AND. YGFL%YSHTUR%MP1 > 0) THEN
  SELF%I_SHTUR   = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YSHTUR%MP_SL1-1)*(NLEV+2)
ELSE
  SELF%I_SHTUR   = -1
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YSHTUR%MP_SL1 > 0 .AND. YGFL%YSHTUR%MP1 > 0) THEN
    SELF%I_SHTUR_F = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YSHTUR%MP_SL1-1)*(NLEV+2)
  ELSE
    SELF%I_SHTUR_F = -1
  ENDIF
ENDIF
IF (YGFL%YFQTUR%MP_SL1 > 0 .AND. YGFL%YFQTUR%MP1 > 0) THEN
  SELF%I_FQTUR   = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YFQTUR%MP_SL1-1)*(NLEV+2)
ELSE
  SELF%I_FQTUR   = -1
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YFQTUR%MP_SL1 > 0 .AND. YGFL%YFQTUR%MP1 > 0) THEN
    SELF%I_FQTUR_F = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YFQTUR%MP_SL1-1)*(NLEV+2)
  ELSE
    SELF%I_FQTUR_F = -1
  ENDIF
ENDIF
IF (YGFL%YFSTUR%MP_SL1 > 0 .AND. YGFL%YFSTUR%MP1 > 0) THEN
  SELF%I_FSTUR   = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YFSTUR%MP_SL1-1)*(NLEV+2)
ELSE
  SELF%I_FSTUR   = -1
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YFSTUR%MP_SL1 > 0 .AND. YGFL%YFSTUR%MP1 > 0) THEN
    SELF%I_FSTUR_F = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YFSTUR%MP_SL1-1)*(NLEV+2)
  ELSE
    SELF%I_FSTUR_F = -1
  ENDIF
ENDIF
IF (YGFL%YCPF%MP_SL1 > 0 .AND. YGFL%YCPF%MP1 > 0) THEN
  SELF%I_CPF   = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YCPF%MP_SL1-1)*(NLEV+2)
ELSE
  SELF%I_CPF   = -1
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YCPF%MP_SL1 > 0 .AND. YGFL%YCPF%MP1 > 0) THEN
    SELF%I_CPF_F = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YCPF%MP_SL1-1)*(NLEV+2)
  ELSE
    SELF%I_CPF_F = -1
  ENDIF
ENDIF
IF (YGFL%YSPF%MP_SL1 > 0 .AND. YGFL%YSPF%MP1 > 0) THEN
  SELF%I_SPF   = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YSPF%MP_SL1-1)*(NLEV+2)
ELSE
  SELF%I_SPF   = -1
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YSPF%MP_SL1 > 0 .AND. YGFL%YSPF%MP1 > 0) THEN
    SELF%I_SPF_F = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YSPF%MP_SL1-1)*(NLEV+2)
  ELSE
    SELF%I_SPF_F = -1
  ENDIF
ENDIF
IF (YGFL%YCVGQ%MP_SL1 > 0 .AND. YGFL%YCVGQ%MP1 > 0) THEN
  SELF%I_CVGQ   = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YCVGQ%MP_SL1-1)*(NLEV+2)
ELSE
  SELF%I_CVGQ   = -1
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YCVGQ%MP_SL1 > 0 .AND. YGFL%YCVGQ%MP1 > 0) THEN
    SELF%I_CVGQ_F = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YCVGQ%MP_SL1-1)*(NLEV+2)
  ELSE
    SELF%I_CVGQ_F = -1
  ENDIF
ENDIF
IF (YGFL%YQVA%MP_SL1 > 0 .AND. YGFL%YQVA%MP1 > 0) THEN
  SELF%I_QVA   = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YQVA%MP_SL1-1)*(NLEV+2)
ELSE
  SELF%I_QVA   = -1
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YQVA%MP_SL1 > 0 .AND. YGFL%YQVA%MP1 > 0) THEN
    SELF%I_QVA_F = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YQVA%MP_SL1-1)*(NLEV+2)
  ELSE
    SELF%I_QVA_F = -1
  ENDIF
ENDIF
IF (YGFL%YLRCH4%MP_SL1 > 0 .AND. YGFL%YLRCH4%MP1 > 0) THEN
  SELF%I_LRCH4   = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YLRCH4%MP_SL1-1)*(NLEV+2)
ELSE
  SELF%I_LRCH4   = -1
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YLRCH4%MP_SL1 > 0 .AND. YGFL%YLRCH4%MP1 > 0) THEN
    SELF%I_LRCH4_F = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YLRCH4%MP_SL1-1)*(NLEV+2)
  ELSE
    SELF%I_LRCH4_F = -1
  ENDIF
ENDIF
IF (YGFL%YPHYCTY%MP_SL1 > 0 .AND. YGFL%YPHYCTY%MP1 > 0) THEN
  SELF%I_PHYCTY   = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YPHYCTY%MP_SL1-1)*(NLEV+2)
ELSE
  SELF%I_PHYCTY   = -1
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YPHYCTY%MP_SL1 > 0 .AND. YGFL%YPHYCTY%MP1 > 0) THEN
    SELF%I_PHYCTY_F = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YPHYCTY%MP_SL1-1)*(NLEV+2)
  ELSE
    SELF%I_PHYCTY_F = -1
  ENDIF
ENDIF
IF (YGFL%YRSPEC%MP_SL1 > 0 .AND. YGFL%YRSPEC%MP1 > 0) THEN
  SELF%I_RSPEC   = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YRSPEC%MP_SL1-1)*(NLEV+2)
ELSE
  SELF%I_RSPEC   = -1
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YRSPEC%MP_SL1 > 0 .AND. YGFL%YRSPEC%MP1 > 0) THEN
    SELF%I_RSPEC_F = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YRSPEC%MP_SL1-1)*(NLEV+2)
  ELSE
    SELF%I_RSPEC_F = -1
  ENDIF
ENDIF
IF (YGFL%YSDSAT%MP_SL1 > 0 .AND. YGFL%YSDSAT%MP1 > 0) THEN
  SELF%I_SDSAT   = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YSDSAT%MP_SL1-1)*(NLEV+2)
ELSE
  SELF%I_SDSAT   = -1
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YSDSAT%MP_SL1 > 0 .AND. YGFL%YSDSAT%MP1 > 0) THEN
    SELF%I_SDSAT_F = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YSDSAT%MP_SL1-1)*(NLEV+2)
  ELSE
    SELF%I_SDSAT_F = -1
  ENDIF
ENDIF
IF (YGFL%YCVV%MP_SL1 > 0 .AND. YGFL%YCVV%MP1 > 0) THEN
  SELF%I_CVV   = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YCVV%MP_SL1-1)*(NLEV+2)
ELSE
  SELF%I_CVV   = -1
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YCVV%MP_SL1 > 0 .AND. YGFL%YCVV%MP1 > 0) THEN
    SELF%I_CVV_F = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YCVV%MP_SL1-1)*(NLEV+2)
  ELSE
    SELF%I_CVV_F = -1
  ENDIF
ENDIF
IF (YGFL%YRKTH%MP_SL1 > 0 .AND. YGFL%YRKTH%MP1 > 0) THEN
  SELF%I_RKTH   = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YRKTH%MP_SL1-1)*(NLEV+2)
ELSE
  SELF%I_RKTH   = -1
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YRKTH%MP_SL1 > 0 .AND. YGFL%YRKTH%MP1 > 0) THEN
    SELF%I_RKTH_F = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YRKTH%MP_SL1-1)*(NLEV+2)
  ELSE
    SELF%I_RKTH_F = -1
  ENDIF
ENDIF
IF (YGFL%YRKTQV%MP_SL1 > 0 .AND. YGFL%YRKTQV%MP1 > 0) THEN
  SELF%I_RKTQV   = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YRKTQV%MP_SL1-1)*(NLEV+2)
ELSE
  SELF%I_RKTQV   = -1
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YRKTQV%MP_SL1 > 0 .AND. YGFL%YRKTQV%MP1 > 0) THEN
    SELF%I_RKTQV_F = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YRKTQV%MP_SL1-1)*(NLEV+2)
  ELSE
    SELF%I_RKTQV_F = -1
  ENDIF
ENDIF
IF (YGFL%YRKTQC%MP_SL1 > 0 .AND. YGFL%YRKTQC%MP1 > 0) THEN
  SELF%I_RKTQC   = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YRKTQC%MP_SL1-1)*(NLEV+2)
ELSE
  SELF%I_RKTQC   = -1
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YRKTQC%MP_SL1 > 0 .AND. YGFL%YRKTQC%MP1 > 0) THEN
    SELF%I_RKTQC_F = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YRKTQC%MP_SL1-1)*(NLEV+2)
  ELSE
    SELF%I_RKTQC_F = -1
  ENDIF
ENDIF
IF (YGFL%YUOM%MP_SL1 > 0 .AND. YGFL%YUOM%MP1 > 0) THEN
  SELF%I_UOM   = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YUOM%MP_SL1-1)*(NLEV+2)
ELSE
  SELF%I_UOM   = -1
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YUOM%MP_SL1 > 0 .AND. YGFL%YUOM%MP1 > 0) THEN
    SELF%I_UOM_F = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YUOM%MP_SL1-1)*(NLEV+2)
  ELSE
    SELF%I_UOM_F = -1
  ENDIF
ENDIF
IF (YGFL%YUAL%MP_SL1 > 0 .AND. YGFL%YUAL%MP1 > 0) THEN
  SELF%I_UAL   = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YUAL%MP_SL1-1)*(NLEV+2)
ELSE
  SELF%I_UAL   = -1
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YUAL%MP_SL1 > 0 .AND. YGFL%YUAL%MP1 > 0) THEN
    SELF%I_UAL_F = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YUAL%MP_SL1-1)*(NLEV+2)
  ELSE
    SELF%I_UAL_F = -1
  ENDIF
ENDIF
IF (YGFL%YDOM%MP_SL1 > 0 .AND. YGFL%YDOM%MP1 > 0) THEN
  SELF%I_DOM   = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YDOM%MP_SL1-1)*(NLEV+2)
ELSE
  SELF%I_DOM   = -1
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YDOM%MP_SL1 > 0 .AND. YGFL%YDOM%MP1 > 0) THEN
    SELF%I_DOM_F = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YDOM%MP_SL1-1)*(NLEV+2)
  ELSE
    SELF%I_DOM_F = -1
  ENDIF
ENDIF
IF (YGFL%YDAL%MP_SL1 > 0 .AND. YGFL%YDAL%MP1 > 0) THEN
  SELF%I_DAL   = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YDAL%MP_SL1-1)*(NLEV+2)
ELSE
  SELF%I_DAL   = -1
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YDAL%MP_SL1 > 0 .AND. YGFL%YDAL%MP1 > 0) THEN
    SELF%I_DAL_F = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YDAL%MP_SL1-1)*(NLEV+2)
  ELSE
    SELF%I_DAL_F = -1
  ENDIF
ENDIF
IF (YGFL%YUEN%MP_SL1 > 0 .AND. YGFL%YUEN%MP1 > 0) THEN
  SELF%I_UEN   = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YUEN%MP_SL1-1)*(NLEV+2)
ELSE
  SELF%I_UEN   = -1
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YUEN%MP_SL1 > 0 .AND. YGFL%YUEN%MP1 > 0) THEN
    SELF%I_UEN_F = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YUEN%MP_SL1-1)*(NLEV+2)
  ELSE
    SELF%I_UEN_F = -1
  ENDIF
ENDIF
IF (YGFL%YUNEBH%MP_SL1 > 0 .AND. YGFL%YUNEBH%MP1 > 0) THEN
  SELF%I_UNEBH   = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YUNEBH%MP_SL1-1)*(NLEV+2)
ELSE
  SELF%I_UNEBH   = -1
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YUNEBH%MP_SL1 > 0 .AND. YGFL%YUNEBH%MP1 > 0) THEN
    SELF%I_UNEBH_F = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YUNEBH%MP_SL1-1)*(NLEV+2)
  ELSE
    SELF%I_UNEBH_F = -1
  ENDIF
ENDIF
IF (YGFL%YFSD%MP_SL1 > 0 .AND. YGFL%YFSD%MP1 > 0) THEN
  SELF%I_FSD   = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YFSD%MP_SL1-1)*(NLEV+2)
ELSE
  SELF%I_FSD   = -1
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YFSD%MP_SL1 > 0 .AND. YGFL%YFSD%MP1 > 0) THEN
    SELF%I_FSD_F = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YFSD%MP_SL1-1)*(NLEV+2)
  ELSE
    SELF%I_FSD_F = -1
  ENDIF
ENDIF
...
IF (ASSOCIATED (SELF%F_DATA)) THEN
  ...
  IF (SELF%I_Q > 0) THEN
    SELF%Q => SELF%ZVIEW (:, SELF%I_Q:SELF%I_Q+SELF%NLEV+1)
  ELSE
    SELF%Q => ZDUM2
  ENDIF
  IF (SELF%I_Q_F > 0) THEN
    SELF%Q_F => SELF%ZVIEW (:, SELF%I_Q_F:SELF%I_Q_F+SELF%NLEV+1)
  ELSE
    SELF%Q_F => ZDUM2
  ENDIF
  IF (SELF%I_I > 0) THEN
    SELF%I => SELF%ZVIEW (:, SELF%I_I:SELF%I_I+SELF%NLEV+1)
  ELSE
    SELF%I => ZDUM2
  ENDIF
  IF (SELF%I_I_F > 0) THEN
    SELF%I_F => SELF%ZVIEW (:, SELF%I_I_F:SELF%I_I_F+SELF%NLEV+1)
  ELSE
    SELF%I_F => ZDUM2
  ENDIF
  IF (SELF%I_L > 0) THEN
    SELF%L => SELF%ZVIEW (:, SELF%I_L:SELF%I_L+SELF%NLEV+1)
  ELSE
    SELF%L => ZDUM2
  ENDIF
  IF (SELF%I_L_F > 0) THEN
    SELF%L_F => SELF%ZVIEW (:, SELF%I_L_F:SELF%I_L_F+SELF%NLEV+1)
  ELSE
    SELF%L_F => ZDUM2
  ENDIF
  IF (SELF%I_LCONV > 0) THEN
    SELF%LCONV => SELF%ZVIEW (:, SELF%I_LCONV:SELF%I_LCONV+SELF%NLEV+1)
  ELSE
    SELF%LCONV => ZDUM2
  ENDIF
  IF (SELF%I_LCONV_F > 0) THEN
    SELF%LCONV_F => SELF%ZVIEW (:, SELF%I_LCONV_F:SELF%I_LCONV_F+SELF%NLEV+1)
  ELSE
    SELF%LCONV_F => ZDUM2
  ENDIF
  IF (SELF%I_ICONV > 0) THEN
    SELF%ICONV => SELF%ZVIEW (:, SELF%I_ICONV:SELF%I_ICONV+SELF%NLEV+1)
  ELSE
    SELF%ICONV => ZDUM2
  ENDIF
  IF (SELF%I_ICONV_F > 0) THEN
    SELF%ICONV_F => SELF%ZVIEW (:, SELF%I_ICONV_F:SELF%I_ICONV_F+SELF%NLEV+1)
  ELSE
    SELF%ICONV_F => ZDUM2
  ENDIF
  IF (SELF%I_RCONV > 0) THEN
    SELF%RCONV => SELF%ZVIEW (:, SELF%I_RCONV:SELF%I_RCONV+SELF%NLEV+1)
  ELSE
    SELF%RCONV => ZDUM2
  ENDIF
  IF (SELF%I_RCONV_F > 0) THEN
    SELF%RCONV_F => SELF%ZVIEW (:, SELF%I_RCONV_F:SELF%I_RCONV_F+SELF%NLEV+1)
  ELSE
    SELF%RCONV_F => ZDUM2
  ENDIF
  IF (SELF%I_SCONV > 0) THEN
    SELF%SCONV => SELF%ZVIEW (:, SELF%I_SCONV:SELF%I_SCONV+SELF%NLEV+1)
  ELSE
    SELF%SCONV => ZDUM2
  ENDIF
  IF (SELF%I_SCONV_F > 0) THEN
    SELF%SCONV_F => SELF%ZVIEW (:, SELF%I_SCONV_F:SELF%I_SCONV_F+SELF%NLEV+1)
  ELSE
    SELF%SCONV_F => ZDUM2
  ENDIF
  IF (SELF%I_IRAD > 0) THEN
    SELF%IRAD => SELF%ZVIEW (:, SELF%I_IRAD:SELF%I_IRAD+SELF%NLEV+1)
  ELSE
    SELF%IRAD => ZDUM2
  ENDIF
  IF (SELF%I_IRAD_F > 0) THEN
    SELF%IRAD_F => SELF%ZVIEW (:, SELF%I_IRAD_F:SELF%I_IRAD_F+SELF%NLEV+1)
  ELSE
    SELF%IRAD_F => ZDUM2
  ENDIF
  IF (SELF%I_LRAD > 0) THEN
    SELF%LRAD => SELF%ZVIEW (:, SELF%I_LRAD:SELF%I_LRAD+SELF%NLEV+1)
  ELSE
    SELF%LRAD => ZDUM2
  ENDIF
  IF (SELF%I_LRAD_F > 0) THEN
    SELF%LRAD_F => SELF%ZVIEW (:, SELF%I_LRAD_F:SELF%I_LRAD_F+SELF%NLEV+1)
  ELSE
    SELF%LRAD_F => ZDUM2
  ENDIF
  IF (SELF%I_S > 0) THEN
    SELF%S => SELF%ZVIEW (:, SELF%I_S:SELF%I_S+SELF%NLEV+1)
  ELSE
    SELF%S => ZDUM2
  ENDIF
  IF (SELF%I_S_F > 0) THEN
    SELF%S_F => SELF%ZVIEW (:, SELF%I_S_F:SELF%I_S_F+SELF%NLEV+1)
  ELSE
    SELF%S_F => ZDUM2
  ENDIF
  IF (SELF%I_R > 0) THEN
    SELF%R => SELF%ZVIEW (:, SELF%I_R:SELF%I_R+SELF%NLEV+1)
  ELSE
    SELF%R => ZDUM2
  ENDIF
  IF (SELF%I_R_F > 0) THEN
    SELF%R_F => SELF%ZVIEW (:, SELF%I_R_F:SELF%I_R_F+SELF%NLEV+1)
  ELSE
    SELF%R_F => ZDUM2
  ENDIF
  IF (SELF%I_G > 0) THEN
    SELF%G => SELF%ZVIEW (:, SELF%I_G:SELF%I_G+SELF%NLEV+1)
  ELSE
    SELF%G => ZDUM2
  ENDIF
  IF (SELF%I_G_F > 0) THEN
    SELF%G_F => SELF%ZVIEW (:, SELF%I_G_F:SELF%I_G_F+SELF%NLEV+1)
  ELSE
    SELF%G_F => ZDUM2
  ENDIF
  IF (SELF%I_H > 0) THEN
    SELF%H => SELF%ZVIEW (:, SELF%I_H:SELF%I_H+SELF%NLEV+1)
  ELSE
    SELF%H => ZDUM2
  ENDIF
  IF (SELF%I_H_F > 0) THEN
    SELF%H_F => SELF%ZVIEW (:, SELF%I_H_F:SELF%I_H_F+SELF%NLEV+1)
  ELSE
    SELF%H_F => ZDUM2
  ENDIF
  IF (SELF%I_TKE > 0) THEN
    SELF%TKE => SELF%ZVIEW (:, SELF%I_TKE:SELF%I_TKE+SELF%NLEV+1)
  ELSE
    SELF%TKE => ZDUM2
  ENDIF
  IF (SELF%I_TKE_F > 0) THEN
    SELF%TKE_F => SELF%ZVIEW (:, SELF%I_TKE_F:SELF%I_TKE_F+SELF%NLEV+1)
  ELSE
    SELF%TKE_F => ZDUM2
  ENDIF
  IF (SELF%I_TTE > 0) THEN
    SELF%TTE => SELF%ZVIEW (:, SELF%I_TTE:SELF%I_TTE+SELF%NLEV+1)
  ELSE
    SELF%TTE => ZDUM2
  ENDIF
  IF (SELF%I_TTE_F > 0) THEN
    SELF%TTE_F => SELF%ZVIEW (:, SELF%I_TTE_F:SELF%I_TTE_F+SELF%NLEV+1)
  ELSE
    SELF%TTE_F => ZDUM2
  ENDIF
  IF (SELF%I_EFB1 > 0) THEN
    SELF%EFB1 => SELF%ZVIEW (:, SELF%I_EFB1:SELF%I_EFB1+SELF%NLEV+1)
  ELSE
    SELF%EFB1 => ZDUM2
  ENDIF
  IF (SELF%I_EFB1_F > 0) THEN
    SELF%EFB1_F => SELF%ZVIEW (:, SELF%I_EFB1_F:SELF%I_EFB1_F+SELF%NLEV+1)
  ELSE
    SELF%EFB1_F => ZDUM2
  ENDIF
  IF (SELF%I_EFB2 > 0) THEN
    SELF%EFB2 => SELF%ZVIEW (:, SELF%I_EFB2:SELF%I_EFB2+SELF%NLEV+1)
  ELSE
    SELF%EFB2 => ZDUM2
  ENDIF
  IF (SELF%I_EFB2_F > 0) THEN
    SELF%EFB2_F => SELF%ZVIEW (:, SELF%I_EFB2_F:SELF%I_EFB2_F+SELF%NLEV+1)
  ELSE
    SELF%EFB2_F => ZDUM2
  ENDIF
  IF (SELF%I_EFB3 > 0) THEN
    SELF%EFB3 => SELF%ZVIEW (:, SELF%I_EFB3:SELF%I_EFB3+SELF%NLEV+1)
  ELSE
    SELF%EFB3 => ZDUM2
  ENDIF
  IF (SELF%I_EFB3_F > 0) THEN
    SELF%EFB3_F => SELF%ZVIEW (:, SELF%I_EFB3_F:SELF%I_EFB3_F+SELF%NLEV+1)
  ELSE
    SELF%EFB3_F => ZDUM2
  ENDIF
  IF (SELF%I_A > 0) THEN
    SELF%A => SELF%ZVIEW (:, SELF%I_A:SELF%I_A+SELF%NLEV+1)
  ELSE
    SELF%A => ZDUM2
  ENDIF
  IF (SELF%I_A_F > 0) THEN
    SELF%A_F => SELF%ZVIEW (:, SELF%I_A_F:SELF%I_A_F+SELF%NLEV+1)
  ELSE
    SELF%A_F => ZDUM2
  ENDIF
  IF (SELF%I_O3 > 0) THEN
    SELF%O3 => SELF%ZVIEW (:, SELF%I_O3:SELF%I_O3+SELF%NLEV+1)
  ELSE
    SELF%O3 => ZDUM2
  ENDIF
  IF (SELF%I_O3_F > 0) THEN
    SELF%O3_F => SELF%ZVIEW (:, SELF%I_O3_F:SELF%I_O3_F+SELF%NLEV+1)
  ELSE
    SELF%O3_F => ZDUM2
  ENDIF
  IF (SELF%I_SRC > 0) THEN
    SELF%SRC => SELF%ZVIEW (:, SELF%I_SRC:SELF%I_SRC+SELF%NLEV+1)
  ELSE
    SELF%SRC => ZDUM2
  ENDIF
  IF (SELF%I_SRC_F > 0) THEN
    SELF%SRC_F => SELF%ZVIEW (:, SELF%I_SRC_F:SELF%I_SRC_F+SELF%NLEV+1)
  ELSE
    SELF%SRC_F => ZDUM2
  ENDIF
  IF (SELF%I_MXL > 0) THEN
    SELF%MXL => SELF%ZVIEW (:, SELF%I_MXL:SELF%I_MXL+SELF%NLEV+1)
  ELSE
    SELF%MXL => ZDUM2
  ENDIF
  IF (SELF%I_MXL_F > 0) THEN
    SELF%MXL_F => SELF%ZVIEW (:, SELF%I_MXL_F:SELF%I_MXL_F+SELF%NLEV+1)
  ELSE
    SELF%MXL_F => ZDUM2
  ENDIF
  IF (SELF%I_SHTUR > 0) THEN
    SELF%SHTUR => SELF%ZVIEW (:, SELF%I_SHTUR:SELF%I_SHTUR+SELF%NLEV+1)
  ELSE
    SELF%SHTUR => ZDUM2
  ENDIF
  IF (SELF%I_SHTUR_F > 0) THEN
    SELF%SHTUR_F => SELF%ZVIEW (:, SELF%I_SHTUR_F:SELF%I_SHTUR_F+SELF%NLEV+1)
  ELSE
    SELF%SHTUR_F => ZDUM2
  ENDIF
  IF (SELF%I_FQTUR > 0) THEN
    SELF%FQTUR => SELF%ZVIEW (:, SELF%I_FQTUR:SELF%I_FQTUR+SELF%NLEV+1)
  ELSE
    SELF%FQTUR => ZDUM2
  ENDIF
  IF (SELF%I_FQTUR_F > 0) THEN
    SELF%FQTUR_F => SELF%ZVIEW (:, SELF%I_FQTUR_F:SELF%I_FQTUR_F+SELF%NLEV+1)
  ELSE
    SELF%FQTUR_F => ZDUM2
  ENDIF
  IF (SELF%I_FSTUR > 0) THEN
    SELF%FSTUR => SELF%ZVIEW (:, SELF%I_FSTUR:SELF%I_FSTUR+SELF%NLEV+1)
  ELSE
    SELF%FSTUR => ZDUM2
  ENDIF
  IF (SELF%I_FSTUR_F > 0) THEN
    SELF%FSTUR_F => SELF%ZVIEW (:, SELF%I_FSTUR_F:SELF%I_FSTUR_F+SELF%NLEV+1)
  ELSE
    SELF%FSTUR_F => ZDUM2
  ENDIF
  IF (SELF%I_CPF > 0) THEN
    SELF%CPF => SELF%ZVIEW (:, SELF%I_CPF:SELF%I_CPF+SELF%NLEV+1)
  ELSE
    SELF%CPF => ZDUM2
  ENDIF
  IF (SELF%I_CPF_F > 0) THEN
    SELF%CPF_F => SELF%ZVIEW (:, SELF%I_CPF_F:SELF%I_CPF_F+SELF%NLEV+1)
  ELSE
    SELF%CPF_F => ZDUM2
  ENDIF
  IF (SELF%I_SPF > 0) THEN
    SELF%SPF => SELF%ZVIEW (:, SELF%I_SPF:SELF%I_SPF+SELF%NLEV+1)
  ELSE
    SELF%SPF => ZDUM2
  ENDIF
  IF (SELF%I_SPF_F > 0) THEN
    SELF%SPF_F => SELF%ZVIEW (:, SELF%I_SPF_F:SELF%I_SPF_F+SELF%NLEV+1)
  ELSE
    SELF%SPF_F => ZDUM2
  ENDIF
  IF (SELF%I_CVGQ > 0) THEN
    SELF%CVGQ => SELF%ZVIEW (:, SELF%I_CVGQ:SELF%I_CVGQ+SELF%NLEV+1)
  ELSE
    SELF%CVGQ => ZDUM2
  ENDIF
  IF (SELF%I_CVGQ_F > 0) THEN
    SELF%CVGQ_F => SELF%ZVIEW (:, SELF%I_CVGQ_F:SELF%I_CVGQ_F+SELF%NLEV+1)
  ELSE
    SELF%CVGQ_F => ZDUM2
  ENDIF
  IF (SELF%I_QVA > 0) THEN
    SELF%QVA => SELF%ZVIEW (:, SELF%I_QVA:SELF%I_QVA+SELF%NLEV+1)
  ELSE
    SELF%QVA => ZDUM2
  ENDIF
  IF (SELF%I_QVA_F > 0) THEN
    SELF%QVA_F => SELF%ZVIEW (:, SELF%I_QVA_F:SELF%I_QVA_F+SELF%NLEV+1)
  ELSE
    SELF%QVA_F => ZDUM2
  ENDIF
  IF (SELF%I_LRCH4 > 0) THEN
    SELF%LRCH4 => SELF%ZVIEW (:, SELF%I_LRCH4:SELF%I_LRCH4+SELF%NLEV+1)
  ELSE
    SELF%LRCH4 => ZDUM2
  ENDIF
  IF (SELF%I_LRCH4_F > 0) THEN
    SELF%LRCH4_F => SELF%ZVIEW (:, SELF%I_LRCH4_F:SELF%I_LRCH4_F+SELF%NLEV+1)
  ELSE
    SELF%LRCH4_F => ZDUM2
  ENDIF
  IF (SELF%I_PHYCTY > 0) THEN
    SELF%PHYCTY => SELF%ZVIEW (:, SELF%I_PHYCTY:SELF%I_PHYCTY+SELF%NLEV+1)
  ELSE
    SELF%PHYCTY => ZDUM2
  ENDIF
  IF (SELF%I_PHYCTY_F > 0) THEN
    SELF%PHYCTY_F => SELF%ZVIEW (:, SELF%I_PHYCTY_F:SELF%I_PHYCTY_F+SELF%NLEV+1)
  ELSE
    SELF%PHYCTY_F => ZDUM2
  ENDIF
  IF (SELF%I_RSPEC > 0) THEN
    SELF%RSPEC => SELF%ZVIEW (:, SELF%I_RSPEC:SELF%I_RSPEC+SELF%NLEV+1)
  ELSE
    SELF%RSPEC => ZDUM2
  ENDIF
  IF (SELF%I_RSPEC_F > 0) THEN
    SELF%RSPEC_F => SELF%ZVIEW (:, SELF%I_RSPEC_F:SELF%I_RSPEC_F+SELF%NLEV+1)
  ELSE
    SELF%RSPEC_F => ZDUM2
  ENDIF
  IF (SELF%I_SDSAT > 0) THEN
    SELF%SDSAT => SELF%ZVIEW (:, SELF%I_SDSAT:SELF%I_SDSAT+SELF%NLEV+1)
  ELSE
    SELF%SDSAT => ZDUM2
  ENDIF
  IF (SELF%I_SDSAT_F > 0) THEN
    SELF%SDSAT_F => SELF%ZVIEW (:, SELF%I_SDSAT_F:SELF%I_SDSAT_F+SELF%NLEV+1)
  ELSE
    SELF%SDSAT_F => ZDUM2
  ENDIF
  IF (SELF%I_CVV > 0) THEN
    SELF%CVV => SELF%ZVIEW (:, SELF%I_CVV:SELF%I_CVV+SELF%NLEV+1)
  ELSE
    SELF%CVV => ZDUM2
  ENDIF
  IF (SELF%I_CVV_F > 0) THEN
    SELF%CVV_F => SELF%ZVIEW (:, SELF%I_CVV_F:SELF%I_CVV_F+SELF%NLEV+1)
  ELSE
    SELF%CVV_F => ZDUM2
  ENDIF
  IF (SELF%I_RKTH > 0) THEN
    SELF%RKTH => SELF%ZVIEW (:, SELF%I_RKTH:SELF%I_RKTH+SELF%NLEV+1)
  ELSE
    SELF%RKTH => ZDUM2
  ENDIF
  IF (SELF%I_RKTH_F > 0) THEN
    SELF%RKTH_F => SELF%ZVIEW (:, SELF%I_RKTH_F:SELF%I_RKTH_F+SELF%NLEV+1)
  ELSE
    SELF%RKTH_F => ZDUM2
  ENDIF
  IF (SELF%I_RKTQV > 0) THEN
    SELF%RKTQV => SELF%ZVIEW (:, SELF%I_RKTQV:SELF%I_RKTQV+SELF%NLEV+1)
  ELSE
    SELF%RKTQV => ZDUM2
  ENDIF
  IF (SELF%I_RKTQV_F > 0) THEN
    SELF%RKTQV_F => SELF%ZVIEW (:, SELF%I_RKTQV_F:SELF%I_RKTQV_F+SELF%NLEV+1)
  ELSE
    SELF%RKTQV_F => ZDUM2
  ENDIF
  IF (SELF%I_RKTQC > 0) THEN
    SELF%RKTQC => SELF%ZVIEW (:, SELF%I_RKTQC:SELF%I_RKTQC+SELF%NLEV+1)
  ELSE
    SELF%RKTQC => ZDUM2
  ENDIF
  IF (SELF%I_RKTQC_F > 0) THEN
    SELF%RKTQC_F => SELF%ZVIEW (:, SELF%I_RKTQC_F:SELF%I_RKTQC_F+SELF%NLEV+1)
  ELSE
    SELF%RKTQC_F => ZDUM2
  ENDIF
  IF (SELF%I_UOM > 0) THEN
    SELF%UOM => SELF%ZVIEW (:, SELF%I_UOM:SELF%I_UOM+SELF%NLEV+1)
  ELSE
    SELF%UOM => ZDUM2
  ENDIF
  IF (SELF%I_UOM_F > 0) THEN
    SELF%UOM_F => SELF%ZVIEW (:, SELF%I_UOM_F:SELF%I_UOM_F+SELF%NLEV+1)
  ELSE
    SELF%UOM_F => ZDUM2
  ENDIF
  IF (SELF%I_UAL > 0) THEN
    SELF%UAL => SELF%ZVIEW (:, SELF%I_UAL:SELF%I_UAL+SELF%NLEV+1)
  ELSE
    SELF%UAL => ZDUM2
  ENDIF
  IF (SELF%I_UAL_F > 0) THEN
    SELF%UAL_F => SELF%ZVIEW (:, SELF%I_UAL_F:SELF%I_UAL_F+SELF%NLEV+1)
  ELSE
    SELF%UAL_F => ZDUM2
  ENDIF
  IF (SELF%I_DOM > 0) THEN
    SELF%DOM => SELF%ZVIEW (:, SELF%I_DOM:SELF%I_DOM+SELF%NLEV+1)
  ELSE
    SELF%DOM => ZDUM2
  ENDIF
  IF (SELF%I_DOM_F > 0) THEN
    SELF%DOM_F => SELF%ZVIEW (:, SELF%I_DOM_F:SELF%I_DOM_F+SELF%NLEV+1)
  ELSE
    SELF%DOM_F => ZDUM2
  ENDIF
  IF (SELF%I_DAL > 0) THEN
    SELF%DAL => SELF%ZVIEW (:, SELF%I_DAL:SELF%I_DAL+SELF%NLEV+1)
  ELSE
    SELF%DAL => ZDUM2
  ENDIF
  IF (SELF%I_DAL_F > 0) THEN
    SELF%DAL_F => SELF%ZVIEW (:, SELF%I_DAL_F:SELF%I_DAL_F+SELF%NLEV+1)
  ELSE
    SELF%DAL_F => ZDUM2
  ENDIF
  IF (SELF%I_UEN > 0) THEN
    SELF%UEN => SELF%ZVIEW (:, SELF%I_UEN:SELF%I_UEN+SELF%NLEV+1)
  ELSE
    SELF%UEN => ZDUM2
  ENDIF
  IF (SELF%I_UEN_F > 0) THEN
    SELF%UEN_F => SELF%ZVIEW (:, SELF%I_UEN_F:SELF%I_UEN_F+SELF%NLEV+1)
  ELSE
    SELF%UEN_F => ZDUM2
  ENDIF
  IF (SELF%I_UNEBH > 0) THEN
    SELF%UNEBH => SELF%ZVIEW (:, SELF%I_UNEBH:SELF%I_UNEBH+SELF%NLEV+1)
  ELSE
    SELF%UNEBH => ZDUM2
  ENDIF
  IF (SELF%I_UNEBH_F > 0) THEN
    SELF%UNEBH_F => SELF%ZVIEW (:, SELF%I_UNEBH_F:SELF%I_UNEBH_F+SELF%NLEV+1)
  ELSE
    SELF%UNEBH_F => ZDUM2
  ENDIF
  IF (SELF%I_FSD > 0) THEN
    SELF%FSD => SELF%ZVIEW (:, SELF%I_FSD:SELF%I_FSD+SELF%NLEV+1)
  ELSE
    SELF%FSD => ZDUM2
  ENDIF
  IF (SELF%I_FSD_F > 0) THEN
    SELF%FSD_F => SELF%ZVIEW (:, SELF%I_FSD_F:SELF%I_FSD_F+SELF%NLEV+1)
  ELSE
    SELF%FSD_F => ZDUM2
  ENDIF
...
IF (YDTPTRSLB2%MSLB2DBBC1 > 0) THEN
  SELF%F_DBBC1 => CREATE_FIELD_WRAP ('DBBC1', SELF%ZDATA (:, YDTPTRSLB2%MSLB2DBBC1, :), PERSISTENT=.NOT. SELF%LOWNED)
ENDIF
IF (YDTPTRSLB2%MSLB2DPHI1 > 0) THEN
  SELF%F_DPHI1 => CREATE_FIELD_WRAP ('DPHI1', SELF%ZDATA (:, YDTPTRSLB2%MSLB2DPHI1, :), PERSISTENT=.NOT. SELF%LOWNED)
ENDIF
IF (YDTPTRSLB2%MSLB2USI > 0) THEN
  SELF%F_USI => CREATE_FIELD_WRAP ('USI', SELF%ZDATA (:, YDTPTRSLB2%MSLB2USI:YDTPTRSLB2%MSLB2USI+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB2%MSLB2VSI > 0) THEN
  SELF%F_VSI => CREATE_FIELD_WRAP ('VSI', SELF%ZDATA (:, YDTPTRSLB2%MSLB2VSI:YDTPTRSLB2%MSLB2VSI+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB2%MSLB2TSI > 0) THEN
  SELF%F_TSI => CREATE_FIELD_WRAP ('TSI', SELF%ZDATA (:, YDTPTRSLB2%MSLB2TSI:YDTPTRSLB2%MSLB2TSI+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB2%MSLB2PDSI > 0) THEN
  SELF%F_PDSI => CREATE_FIELD_WRAP ('PDSI', SELF%ZDATA (:, YDTPTRSLB2%MSLB2PDSI:YDTPTRSLB2%MSLB2PDSI+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB2%MSLB2VDSI > 0) THEN
  SELF%F_VDSI => CREATE_FIELD_WRAP ('VDSI', SELF%ZDATA (:, YDTPTRSLB2%MSLB2VDSI:YDTPTRSLB2%MSLB2VDSI+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB2%MSLB2SPSI > 0) THEN
  SELF%F_SPSI => CREATE_FIELD_WRAP ('SPSI', SELF%ZDATA (:, YDTPTRSLB2%MSLB2SPSI:YDTPTRSLB2%MSLB2SPSI+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB2%MSLB2VVEL > 0) THEN
  SELF%F_VVEL => CREATE_FIELD_WRAP ('VVEL', SELF%ZDATA (:, YDTPTRSLB2%MSLB2VVEL:YDTPTRSLB2%MSLB2VVEL+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB2%MSLB2URL > 0) THEN
  SELF%F_URL => CREATE_FIELD_WRAP ('URL', SELF%ZDATA (:, YDTPTRSLB2%MSLB2URL:YDTPTRSLB2%MSLB2URL+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB2%MSLB2VRL > 0) THEN
  SELF%F_VRL => CREATE_FIELD_WRAP ('VRL', SELF%ZDATA (:, YDTPTRSLB2%MSLB2VRL:YDTPTRSLB2%MSLB2VRL+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB2%MSLB2WRL > 0) THEN
  SELF%F_WRL => CREATE_FIELD_WRAP ('WRL', SELF%ZDATA (:, YDTPTRSLB2%MSLB2WRL:YDTPTRSLB2%MSLB2WRL+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB2%MSLB2URL5 > 0) THEN
  SELF%F_URL5 => CREATE_FIELD_WRAP ('URL5', SELF%ZDATA (:, YDTPTRSLB2%MSLB2URL5:YDTPTRSLB2%MSLB2URL5+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB2%MSLB2VRL5 > 0) THEN
  SELF%F_VRL5 => CREATE_FIELD_WRAP ('VRL5', SELF%ZDATA (:, YDTPTRSLB2%MSLB2VRL5:YDTPTRSLB2%MSLB2VRL5+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB2%MSLB2WRL5 > 0) THEN
  SELF%F_WRL5 => CREATE_FIELD_WRAP ('WRL5', SELF%ZDATA (:, YDTPTRSLB2%MSLB2WRL5:YDTPTRSLB2%MSLB2WRL5+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB2%MSLB2USI5 > 0) THEN
  SELF%F_USI5 => CREATE_FIELD_WRAP ('USI5', SELF%ZDATA (:, YDTPTRSLB2%MSLB2USI5:YDTPTRSLB2%MSLB2USI5+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB2%MSLB2VSI5 > 0) THEN
  SELF%F_VSI5 => CREATE_FIELD_WRAP ('VSI5', SELF%ZDATA (:, YDTPTRSLB2%MSLB2VSI5:YDTPTRSLB2%MSLB2VSI5+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB2%MSLB2U15 > 0) THEN
  SELF%F_U15 => CREATE_FIELD_WRAP ('U15', SELF%ZDATA (:, YDTPTRSLB2%MSLB2U15:YDTPTRSLB2%MSLB2U15+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB2%MSLB2V15 > 0) THEN
  SELF%F_V15 => CREATE_FIELD_WRAP ('V15', SELF%ZDATA (:, YDTPTRSLB2%MSLB2V15:YDTPTRSLB2%MSLB2V15+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB2%MSLB2T15 > 0) THEN
  SELF%F_T15 => CREATE_FIELD_WRAP ('T15', SELF%ZDATA (:, YDTPTRSLB2%MSLB2T15:YDTPTRSLB2%MSLB2T15+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB2%MSLB2Q15 > 0) THEN
  SELF%F_Q15 => CREATE_FIELD_WRAP ('Q15', SELF%ZDATA (:, YDTPTRSLB2%MSLB2Q15:YDTPTRSLB2%MSLB2Q15+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB2%MSLB2KAPPA > 0) THEN
  SELF%F_KAPPA => CREATE_FIELD_WRAP ('KAPPA', SELF%ZDATA (:, YDTPTRSLB2%MSLB2KAPPA:YDTPTRSLB2%MSLB2KAPPA+NLEV+1, :),&
      & PERSISTENT=.NOT. SELF%LOWNED)
ENDIF
IF (YDTPTRSLB2%MSLB2KAPPAT > 0) THEN
  SELF%F_KAPPAT => CREATE_FIELD_WRAP ('KAPPAT', SELF%ZDATA (:, YDTPTRSLB2%MSLB2KAPPAT:YDTPTRSLB2%MSLB2KAPPAT+NLEV+1, :),&
      & PERSISTENT=.NOT. SELF%LOWNED)
ENDIF
IF (YDTPTRSLB2%MSLB2KAPPAM > 0) THEN
  SELF%F_KAPPAM => CREATE_FIELD_WRAP ('KAPPAM', SELF%ZDATA (:, YDTPTRSLB2%MSLB2KAPPAM:YDTPTRSLB2%MSLB2KAPPAM+NLEV+1, :),&
      & PERSISTENT=.NOT. SELF%LOWNED)
ENDIF
IF (YDTPTRSLB2%MSLB2KAPPAH > 0) THEN
  SELF%F_KAPPAH => CREATE_FIELD_WRAP ('KAPPAH', SELF%ZDATA (:, YDTPTRSLB2%MSLB2KAPPAH:YDTPTRSLB2%MSLB2KAPPAH+NLEV+1, :),&
      & PERSISTENT=.NOT. SELF%LOWNED)
ENDIF
IF (YDTPTRSLB2%MSLB2KAPPA5 > 0) THEN
  SELF%F_KAPPA5 => CREATE_FIELD_WRAP ('KAPPA5', SELF%ZDATA (:, YDTPTRSLB2%MSLB2KAPPA5:YDTPTRSLB2%MSLB2KAPPA5+NLEV+1, :),&
      & PERSISTENT=.NOT. SELF%LOWNED)
ENDIF
IF (YDTPTRSLB2%MSLB2KAPPAT5 > 0) THEN
  SELF%F_KAPPAT5 => CREATE_FIELD_WRAP ('KAPPAT5', SELF%ZDATA (:, YDTPTRSLB2%MSLB2KAPPAT5:YDTPTRSLB2%MSLB2KAPPAT5+NLEV+1, :),&
      & PERSISTENT=.NOT. SELF%LOWNED)
ENDIF
IF (YDTPTRSLB2%MSLB2GWF > 0) THEN
  SELF%F_GWF => CREATE_FIELD_WRAP ('GWF', SELF%ZDATA (:, YDTPTRSLB2%MSLB2GWF:YDTPTRSLB2%MSLB2GWF+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB2%MSLB2GDW > 0) THEN
  SELF%F_GDW => CREATE_FIELD_WRAP ('GDW', SELF%ZDATA (:, YDTPTRSLB2%MSLB2GDW:YDTPTRSLB2%MSLB2GDW+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB2%MSLB2GWS > 0) THEN
  SELF%F_GWS => CREATE_FIELD_WRAP ('GWS', SELF%ZDATA (:, YDTPTRSLB2%MSLB2GWS:YDTPTRSLB2%MSLB2GWS+NLEV+1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ENDIF
IF (YDTPTRSLB2%MSLB2STDDISU > 0) THEN
  SELF%F_STDDISU => CREATE_FIELD_WRAP ('STDDISU', SELF%ZDATA (:, YDTPTRSLB2%MSLB2STDDISU:YDTPTRSLB2%MSLB2STDDISU+NLEV+1, :),&
      & PERSISTENT=.NOT. SELF%LOWNED)
ENDIF
IF (YDTPTRSLB2%MSLB2STDDISV > 0) THEN
  SELF%F_STDDISV => CREATE_FIELD_WRAP ('STDDISV', SELF%ZDATA (:, YDTPTRSLB2%MSLB2STDDISV:YDTPTRSLB2%MSLB2STDDISV+NLEV+1, :),&
      & PERSISTENT=.NOT. SELF%LOWNED)
ENDIF
IF (YDTPTRSLB2%MSLB2STDDISW > 0) THEN
  SELF%F_STDDISW => CREATE_FIELD_WRAP ('STDDISW', SELF%ZDATA (:, YDTPTRSLB2%MSLB2STDDISW:YDTPTRSLB2%MSLB2STDDISW+NLEV+1, :),&
      & PERSISTENT=.NOT. SELF%LOWNED)
ENDIF
