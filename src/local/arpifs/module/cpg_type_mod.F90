...
SELF%I_DBBC1 = YDTPTRSLB2%MSLB2DBBC1
SELF%I_DPHI1 = YDTPTRSLB2%MSLB2DPHI1
SELF%I_USI = YDTPTRSLB2%MSLB2USI
SELF%I_VSI = YDTPTRSLB2%MSLB2VSI
SELF%I_TSI = YDTPTRSLB2%MSLB2TSI
SELF%I_PDSI = YDTPTRSLB2%MSLB2PDSI
SELF%I_VDSI = YDTPTRSLB2%MSLB2VDSI
SELF%I_SPSI = YDTPTRSLB2%MSLB2SPSI
SELF%I_VVEL = YDTPTRSLB2%MSLB2VVEL
SELF%I_URL = YDTPTRSLB2%MSLB2URL
SELF%I_VRL = YDTPTRSLB2%MSLB2VRL
SELF%I_WRL = YDTPTRSLB2%MSLB2WRL
SELF%I_URL5 = YDTPTRSLB2%MSLB2URL5
SELF%I_VRL5 = YDTPTRSLB2%MSLB2VRL5
SELF%I_WRL5 = YDTPTRSLB2%MSLB2WRL5
SELF%I_USI5 = YDTPTRSLB2%MSLB2USI5
SELF%I_VSI5 = YDTPTRSLB2%MSLB2VSI5
SELF%I_U15 = YDTPTRSLB2%MSLB2U15
SELF%I_V15 = YDTPTRSLB2%MSLB2V15
SELF%I_T15 = YDTPTRSLB2%MSLB2T15
SELF%I_Q15 = YDTPTRSLB2%MSLB2Q15
SELF%I_KAPPA = YDTPTRSLB2%MSLB2KAPPA
SELF%I_KAPPAT = YDTPTRSLB2%MSLB2KAPPAT
SELF%I_KAPPAM = YDTPTRSLB2%MSLB2KAPPAM
SELF%I_KAPPAH = YDTPTRSLB2%MSLB2KAPPAH
SELF%I_KAPPA5 = YDTPTRSLB2%MSLB2KAPPA5
SELF%I_KAPPAT5 = YDTPTRSLB2%MSLB2KAPPAT5
SELF%I_GWF = YDTPTRSLB2%MSLB2GWF
SELF%I_GDW = YDTPTRSLB2%MSLB2GDW
SELF%I_GWS = YDTPTRSLB2%MSLB2GWS
SELF%I_STDDISU = YDTPTRSLB2%MSLB2STDDISU
SELF%I_STDDISV = YDTPTRSLB2%MSLB2STDDISV
SELF%I_STDDISW = YDTPTRSLB2%MSLB2STDDISW
...
IF (ASSOCIATED (SELF%F_DATA)) THEN
  SELF%ZVIEW => SELF%F_DATA%GET_VIEW (BLOCK_INDEX)
  IF (SELF%I_DBBC1 > 0) THEN
    SELF%DBBC1 => SELF%ZVIEW (:, SELF%I_DBBC1)
  ELSE
    SELF%DBBC1 => ZDUM1
  ENDIF
  IF (SELF%I_DPHI1 > 0) THEN
    SELF%DPHI1 => SELF%ZVIEW (:, SELF%I_DPHI1)
  ELSE
    SELF%DPHI1 => ZDUM1
  ENDIF
  IF (SELF%I_USI > 0) THEN
    SELF%USI => SELF%ZVIEW (:, SELF%I_USI:SELF%I_USI+SELF%NLEV+1)
  ELSE
    SELF%USI => ZDUM2
  ENDIF
  IF (SELF%I_VSI > 0) THEN
    SELF%VSI => SELF%ZVIEW (:, SELF%I_VSI:SELF%I_VSI+SELF%NLEV+1)
  ELSE
    SELF%VSI => ZDUM2
  ENDIF
  IF (SELF%I_TSI > 0) THEN
    SELF%TSI => SELF%ZVIEW (:, SELF%I_TSI:SELF%I_TSI+SELF%NLEV+1)
  ELSE
    SELF%TSI => ZDUM2
  ENDIF
  IF (SELF%I_PDSI > 0) THEN
    SELF%PDSI => SELF%ZVIEW (:, SELF%I_PDSI:SELF%I_PDSI+SELF%NLEV+1)
  ELSE
    SELF%PDSI => ZDUM2
  ENDIF
  IF (SELF%I_VDSI > 0) THEN
    SELF%VDSI => SELF%ZVIEW (:, SELF%I_VDSI:SELF%I_VDSI+SELF%NLEV+1)
  ELSE
    SELF%VDSI => ZDUM2
  ENDIF
  IF (SELF%I_SPSI > 0) THEN
    SELF%SPSI => SELF%ZVIEW (:, SELF%I_SPSI:SELF%I_SPSI+SELF%NLEV+1)
  ELSE
    SELF%SPSI => ZDUM2
  ENDIF
  IF (SELF%I_VVEL > 0) THEN
    SELF%VVEL => SELF%ZVIEW (:, SELF%I_VVEL:SELF%I_VVEL+SELF%NLEV+1)
  ELSE
    SELF%VVEL => ZDUM2
  ENDIF
  IF (SELF%I_URL > 0) THEN
    SELF%URL => SELF%ZVIEW (:, SELF%I_URL:SELF%I_URL+SELF%NLEV+1)
  ELSE
    SELF%URL => ZDUM2
  ENDIF
  IF (SELF%I_VRL > 0) THEN
    SELF%VRL => SELF%ZVIEW (:, SELF%I_VRL:SELF%I_VRL+SELF%NLEV+1)
  ELSE
    SELF%VRL => ZDUM2
  ENDIF
  IF (SELF%I_WRL > 0) THEN
    SELF%WRL => SELF%ZVIEW (:, SELF%I_WRL:SELF%I_WRL+SELF%NLEV+1)
  ELSE
    SELF%WRL => ZDUM2
  ENDIF
  IF (SELF%I_URL5 > 0) THEN
    SELF%URL5 => SELF%ZVIEW (:, SELF%I_URL5:SELF%I_URL5+SELF%NLEV+1)
  ELSE
    SELF%URL5 => ZDUM2
  ENDIF
  IF (SELF%I_VRL5 > 0) THEN
    SELF%VRL5 => SELF%ZVIEW (:, SELF%I_VRL5:SELF%I_VRL5+SELF%NLEV+1)
  ELSE
    SELF%VRL5 => ZDUM2
  ENDIF
  IF (SELF%I_WRL5 > 0) THEN
    SELF%WRL5 => SELF%ZVIEW (:, SELF%I_WRL5:SELF%I_WRL5+SELF%NLEV+1)
  ELSE
    SELF%WRL5 => ZDUM2
  ENDIF
  IF (SELF%I_USI5 > 0) THEN
    SELF%USI5 => SELF%ZVIEW (:, SELF%I_USI5:SELF%I_USI5+SELF%NLEV+1)
  ELSE
    SELF%USI5 => ZDUM2
  ENDIF
  IF (SELF%I_VSI5 > 0) THEN
    SELF%VSI5 => SELF%ZVIEW (:, SELF%I_VSI5:SELF%I_VSI5+SELF%NLEV+1)
  ELSE
    SELF%VSI5 => ZDUM2
  ENDIF
  IF (SELF%I_U15 > 0) THEN
    SELF%U15 => SELF%ZVIEW (:, SELF%I_U15:SELF%I_U15+SELF%NLEV+1)
  ELSE
    SELF%U15 => ZDUM2
  ENDIF
  IF (SELF%I_V15 > 0) THEN
    SELF%V15 => SELF%ZVIEW (:, SELF%I_V15:SELF%I_V15+SELF%NLEV+1)
  ELSE
    SELF%V15 => ZDUM2
  ENDIF
  IF (SELF%I_T15 > 0) THEN
    SELF%T15 => SELF%ZVIEW (:, SELF%I_T15:SELF%I_T15+SELF%NLEV+1)
  ELSE
    SELF%T15 => ZDUM2
  ENDIF
  IF (SELF%I_Q15 > 0) THEN
    SELF%Q15 => SELF%ZVIEW (:, SELF%I_Q15:SELF%I_Q15+SELF%NLEV+1)
  ELSE
    SELF%Q15 => ZDUM2
  ENDIF
  IF (SELF%I_KAPPA > 0) THEN
    SELF%KAPPA => SELF%ZVIEW (:, SELF%I_KAPPA:SELF%I_KAPPA+SELF%NLEV+1)
  ELSE
    SELF%KAPPA => ZDUM2
  ENDIF
  IF (SELF%I_KAPPAT > 0) THEN
    SELF%KAPPAT => SELF%ZVIEW (:, SELF%I_KAPPAT:SELF%I_KAPPAT+SELF%NLEV+1)
  ELSE
    SELF%KAPPAT => ZDUM2
  ENDIF
  IF (SELF%I_KAPPAM > 0) THEN
    SELF%KAPPAM => SELF%ZVIEW (:, SELF%I_KAPPAM:SELF%I_KAPPAM+SELF%NLEV+1)
  ELSE
    SELF%KAPPAM => ZDUM2
  ENDIF
  IF (SELF%I_KAPPAH > 0) THEN
    SELF%KAPPAH => SELF%ZVIEW (:, SELF%I_KAPPAH:SELF%I_KAPPAH+SELF%NLEV+1)
  ELSE
    SELF%KAPPAH => ZDUM2
  ENDIF
  IF (SELF%I_KAPPA5 > 0) THEN
    SELF%KAPPA5 => SELF%ZVIEW (:, SELF%I_KAPPA5:SELF%I_KAPPA5+SELF%NLEV+1)
  ELSE
    SELF%KAPPA5 => ZDUM2
  ENDIF
  IF (SELF%I_KAPPAT5 > 0) THEN
    SELF%KAPPAT5 => SELF%ZVIEW (:, SELF%I_KAPPAT5:SELF%I_KAPPAT5+SELF%NLEV+1)
  ELSE
    SELF%KAPPAT5 => ZDUM2
  ENDIF
  IF (SELF%I_GWF > 0) THEN
    SELF%GWF => SELF%ZVIEW (:, SELF%I_GWF:SELF%I_GWF+SELF%NLEV+1)
  ELSE
    SELF%GWF => ZDUM2
  ENDIF
  IF (SELF%I_GDW > 0) THEN
    SELF%GDW => SELF%ZVIEW (:, SELF%I_GDW:SELF%I_GDW+SELF%NLEV+1)
  ELSE
    SELF%GDW => ZDUM2
  ENDIF
  IF (SELF%I_GWS > 0) THEN
    SELF%GWS => SELF%ZVIEW (:, SELF%I_GWS:SELF%I_GWS+SELF%NLEV+1)
  ELSE
    SELF%GWS => ZDUM2
  ENDIF
  IF (SELF%I_STDDISU > 0) THEN
    SELF%STDDISU => SELF%ZVIEW (:, SELF%I_STDDISU:SELF%I_STDDISU+SELF%NLEV+1)
  ELSE
    SELF%STDDISU => ZDUM2
  ENDIF
  IF (SELF%I_STDDISV > 0) THEN
    SELF%STDDISV => SELF%ZVIEW (:, SELF%I_STDDISV:SELF%I_STDDISV+SELF%NLEV+1)
  ELSE
    SELF%STDDISV => ZDUM2
  ENDIF
  IF (SELF%I_STDDISW > 0) THEN
    SELF%STDDISW => SELF%ZVIEW (:, SELF%I_STDDISW:SELF%I_STDDISW+SELF%NLEV+1)
  ELSE
    SELF%STDDISW => ZDUM2
  ENDIF
