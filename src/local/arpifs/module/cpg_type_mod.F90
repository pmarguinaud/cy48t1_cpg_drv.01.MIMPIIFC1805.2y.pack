...
SELF%F_DATA => CREATE_FIELD_WRAP ('CPG_XYBDER_TYPE', SELF%ZDATA, PERSISTENT=LLPERSISTENT)

SELF%F_LNPRL => CREATE_FIELD_WRAP ('LNPRL', SELF%ZDATA (:, :, YDTXYBDER%M_LNPRL, :), PERSISTENT=LLPERSISTENT)
SELF%F_LNPRM => CREATE_FIELD_WRAP ('LNPRM', SELF%ZDATA (:, :, YDTXYBDER%M_LNPRM, :), PERSISTENT=LLPERSISTENT)
SELF%F_ALPHL => CREATE_FIELD_WRAP ('ALPHL', SELF%ZDATA (:, :, YDTXYBDER%M_ALPHL, :), PERSISTENT=LLPERSISTENT)
SELF%F_ALPHM => CREATE_FIELD_WRAP ('ALPHM', SELF%ZDATA (:, :, YDTXYBDER%M_ALPHM, :), PERSISTENT=LLPERSISTENT)
SELF%F_ALPHPLL => CREATE_FIELD_WRAP ('ALPHPLL', SELF%ZDATA (:, :, YDTXYBDER%M_ALPHPLL, :), PERSISTENT=LLPERSISTENT)
SELF%F_ALPHPLM => CREATE_FIELD_WRAP ('ALPHPLM', SELF%ZDATA (:, :, YDTXYBDER%M_ALPHPLM, :), PERSISTENT=LLPERSISTENT)
SELF%F_COEFD => CREATE_FIELD_WRAP ('COEFD', SELF%ZDATA (:, :, YDTXYBDER%M_COEFD, :), PERSISTENT=LLPERSISTENT)
SELF%F_COEFA => CREATE_FIELD_WRAP ('COEFA', SELF%ZDATA (:, :, YDTXYBDER%M_COEFA, :), PERSISTENT=LLPERSISTENT)
SELF%F_COEFAPL => CREATE_FIELD_WRAP ('COEFAPL', SELF%ZDATA (:, :, YDTXYBDER%M_COEFAPL, :), PERSISTENT=LLPERSISTENT)
...
SELF%F_DATA => CREATE_FIELD_WRAP ('CPG_XYB_TYPE', SELF%ZDATA, PERSISTENT=LLPERSISTENT)

SELF%F_DELP => CREATE_FIELD_WRAP ('DELP', SELF%ZDATA (:, :, YDTXYB%M_DELP, :), PERSISTENT=LLPERSISTENT)
SELF%F_RDELP => CREATE_FIELD_WRAP ('RDELP', SELF%ZDATA (:, :, YDTXYB%M_RDELP, :), PERSISTENT=LLPERSISTENT)
SELF%F_LNPR => CREATE_FIELD_WRAP ('LNPR', SELF%ZDATA (:, :, YDTXYB%M_LNPR, :), PERSISTENT=LLPERSISTENT)
SELF%F_ALPH => CREATE_FIELD_WRAP ('ALPH', SELF%ZDATA (:, :, YDTXYB%M_ALPH, :), PERSISTENT=LLPERSISTENT)
SELF%F_RTGR => CREATE_FIELD_WRAP ('RTGR', SELF%ZDATA (:, :, YDTXYB%M_RTGR, :), PERSISTENT=LLPERSISTENT)
SELF%F_RPRE => CREATE_FIELD_WRAP ('RPRE', SELF%ZDATA (:, :, YDTXYB%M_RPRE, :), PERSISTENT=LLPERSISTENT)
SELF%F_RPP => CREATE_FIELD_WRAP ('RPP', SELF%ZDATA (:, :, YDTXYB%M_RPP, :), PERSISTENT=LLPERSISTENT)
...
SELF%F_DATA => CREATE_FIELD_WRAP ('CPG_HWIND_TYPE', SELF%ZDATA, PERSISTENT=LLPERSISTENT)

SELF%F_UH => CREATE_FIELD_WRAP ('UH', SELF%ZDATA (:, :, YDTHWIND%M_UH, :), PERSISTENT=LLPERSISTENT)
SELF%F_VH => CREATE_FIELD_WRAP ('VH', SELF%ZDATA (:, :, YDTHWIND%M_VH, :), PERSISTENT=LLPERSISTENT)
SELF%F_WWI => CREATE_FIELD_WRAP ('WWI', SELF%ZDATA (:, :, YDTHWIND%M_WWI, :), PERSISTENT=LLPERSISTENT)
...
SELF%F_DATA => CREATE_FIELD_WRAP ('CPG_RCP_TYPE', SELF%ZDATA, PERSISTENT=LLPERSISTENT)

SELF%F_CP => CREATE_FIELD_WRAP ('CP', SELF%ZDATA (:, :, YDTRCP%M_CP, :), PERSISTENT=LLPERSISTENT)
SELF%F_R => CREATE_FIELD_WRAP ('R', SELF%ZDATA (:, :, YDTRCP%M_R, :), PERSISTENT=LLPERSISTENT)
SELF%F_KAP => CREATE_FIELD_WRAP ('KAP', SELF%ZDATA (:, :, YDTRCP%M_KAP, :), PERSISTENT=LLPERSISTENT)
...
SELF%F_DATA => CREATE_FIELD_WRAP ('CPG_CTY_TYPE', SELF%ZDATA, PERSISTENT=LLPERSISTENT)

SELF%F_EVEL => CREATE_FIELD_WRAP ('EVEL', SELF%ZDATA (:, :, YDTCTY%M_EVEL, :), PERSISTENT=LLPERSISTENT)
SELF%F_VVEL => CREATE_FIELD_WRAP ('VVEL', SELF%ZDATA (:, :, YDTCTY%M_VVEL, :), PERSISTENT=LLPERSISTENT)
SELF%F_PSDIV => CREATE_FIELD_WRAP ('PSDIV', SELF%ZDATA (:, :, YDTCTY%M_PSDIV, :), PERSISTENT=LLPERSISTENT)
SELF%F_PSDVBC => CREATE_FIELD_WRAP ('PSDVBC', SELF%ZDATA (:, :, YDTCTY%M_PSDVBC, :), PERSISTENT=LLPERSISTENT)
SELF%F_DIVDP => CREATE_FIELD_WRAP ('DIVDP', SELF%ZDATA (:, :, YDTCTY%M_DIVDP, :), PERSISTENT=LLPERSISTENT)
...
SELF%F_DATA => CREATE_FIELD_WRAP ('CPG_TND_TYPE', SELF%ZDATA, PERSISTENT=LLPERSISTENT)

SELF%F_TNDU => CREATE_FIELD_WRAP ('TNDU', SELF%ZDATA (:, :, YDTTND%M_TNDU, :), PERSISTENT=LLPERSISTENT)
SELF%F_TNDV => CREATE_FIELD_WRAP ('TNDV', SELF%ZDATA (:, :, YDTTND%M_TNDV, :), PERSISTENT=LLPERSISTENT)
SELF%F_TNDU_NOC => CREATE_FIELD_WRAP ('TNDU_NOC', SELF%ZDATA (:, :, YDTTND%M_TNDU_NOC, :), PERSISTENT=LLPERSISTENT)
SELF%F_TNDV_NOC => CREATE_FIELD_WRAP ('TNDV_NOC', SELF%ZDATA (:, :, YDTTND%M_TNDV_NOC, :), PERSISTENT=LLPERSISTENT)
SELF%F_TNDT => CREATE_FIELD_WRAP ('TNDT', SELF%ZDATA (:, :, YDTTND%M_TNDT, :), PERSISTENT=LLPERSISTENT)
SELF%F_TNDPD => CREATE_FIELD_WRAP ('TNDPD', SELF%ZDATA (:, :, YDTTND%M_TNDPD, :), PERSISTENT=LLPERSISTENT)
SELF%F_TNDVD => CREATE_FIELD_WRAP ('TNDVD', SELF%ZDATA (:, :, YDTTND%M_TNDVD, :), PERSISTENT=LLPERSISTENT)
SELF%F_TNDGW => CREATE_FIELD_WRAP ('TNDGW', SELF%ZDATA (:, :, YDTTND%M_TNDGW, :), PERSISTENT=LLPERSISTENT)
...
SELF%F_DATA => CREATE_FIELD_WRAP ('CPG_GPAR_TYPE', SELF%ZDATA, PERSISTENT=LLPERSISTENT)

IF (YDTPARAR%MINPRR > 0) THEN
  SELF%F_INPRR => CREATE_FIELD_WRAP ('INPRR', SELF%ZDATA (:, YDTPARAR%MINPRR, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_INPRR => NULL ()
ENDIF
IF (YDTPARAR%MINPRS > 0) THEN
  SELF%F_INPRS => CREATE_FIELD_WRAP ('INPRS', SELF%ZDATA (:, YDTPARAR%MINPRS, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_INPRS => NULL ()
ENDIF
IF (YDTPARAR%MINPRG > 0) THEN
  SELF%F_INPRG => CREATE_FIELD_WRAP ('INPRG', SELF%ZDATA (:, YDTPARAR%MINPRG, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_INPRG => NULL ()
ENDIF
IF (YDTPARAR%MACPRR > 0) THEN
  SELF%F_ACPRR => CREATE_FIELD_WRAP ('ACPRR', SELF%ZDATA (:, YDTPARAR%MACPRR, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_ACPRR => NULL ()
ENDIF
IF (YDTPARAR%MACPRS > 0) THEN
  SELF%F_ACPRS => CREATE_FIELD_WRAP ('ACPRS', SELF%ZDATA (:, YDTPARAR%MACPRS, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_ACPRS => NULL ()
ENDIF
IF (YDTPARAR%MACPRG > 0) THEN
  SELF%F_ACPRG => CREATE_FIELD_WRAP ('ACPRG', SELF%ZDATA (:, YDTPARAR%MACPRG, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_ACPRG => NULL ()
ENDIF
...
IF (YDTPARAR%MRAIN > 0) THEN
  SELF%F_RAIN => CREATE_FIELD_WRAP ('RAIN', SELF%ZDATA (:, YDTPARAR%MRAIN, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_RAIN => NULL ()
ENDIF
IF (YDTPARAR%MSNOW > 0) THEN
  SELF%F_SNOW => CREATE_FIELD_WRAP ('SNOW', SELF%ZDATA (:, YDTPARAR%MSNOW, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_SNOW => NULL ()
ENDIF
IF (YDTPARAR%MGZ0 > 0) THEN
  SELF%F_GZ0 => CREATE_FIELD_WRAP ('GZ0', SELF%ZDATA (:, YDTPARAR%MGZ0, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_GZ0 => NULL ()
ENDIF
IF (YDTPARAR%MGZ0H > 0) THEN
  SELF%F_GZ0H => CREATE_FIELD_WRAP ('GZ0H', SELF%ZDATA (:, YDTPARAR%MGZ0H, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_GZ0H => NULL ()
ENDIF
IF (YDTPARAR%MVQS > 0) THEN
  SELF%F_VQS => CREATE_FIELD_WRAP ('VQS', SELF%ZDATA (:, YDTPARAR%MVQS, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_VQS => NULL ()
ENDIF
IF (YDTPARAR%MVTS > 0) THEN
  SELF%F_VTS => CREATE_FIELD_WRAP ('VTS', SELF%ZDATA (:, YDTPARAR%MVTS, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_VTS => NULL ()
ENDIF
IF (YDTPARAR%MVEMIS > 0) THEN
  SELF%F_VEMIS => CREATE_FIELD_WRAP ('VEMIS', SELF%ZDATA (:, YDTPARAR%MVEMIS, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_VEMIS => NULL ()
ENDIF
IF (YDTPARAR%MSWDIR > 0) THEN
  SELF%F_SWDIR => CREATE_FIELD_WRAP ('SWDIR', SELF%ZDATA (:, YDTPARAR%MSWDIR:YDTPARAR%MSWDIR+YDCPG_DIM%KSW-1, :),&
      & PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_SWDIR => NULL ()
ENDIF
IF (YDTPARAR%MSWDIF > 0) THEN
  SELF%F_SWDIF => CREATE_FIELD_WRAP ('SWDIF', SELF%ZDATA (:, YDTPARAR%MSWDIF:YDTPARAR%MSWDIF+YDCPG_DIM%KSW-1, :),&
      & PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_SWDIF => NULL ()
ENDIF
IF (YDTPARAR%MLSM > 0) THEN
  SELF%F_LSM => CREATE_FIELD_WRAP ('LSM', SELF%ZDATA (:, YDTPARAR%MLSM, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_LSM => NULL ()
ENDIF
IF (YDTPARAR%MCD > 0) THEN
  SELF%F_CD => CREATE_FIELD_WRAP ('CD', SELF%ZDATA (:, YDTPARAR%MCD, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_CD => NULL ()
ENDIF
