...
ELSE
  SELF%F_DATA => CREATE_TEMPORARY ('CPG_HWIND_TYPE', GEOM=REGISTRY%GEOM, NLEV=NLEV, NDIM=YDTHWIND%NDIM, PERSISTENT=PERSISTENT)
ENDIF
...
ELSE
  SELF%F_DATA => CREATE_TEMPORARY ('CPG_CTY_TYPE', GEOM=REGISTRY%GEOM, NLEV=NLEV, NDIM=YDTCTY%NDIM, PERSISTENT=PERSISTENT)
ENDIF
...
SUBROUTINE CPG_SL1_TYPE_INIT (SELF, REGISTRY, NLEV, YDTPTRSLB1, PERSISTENT, PTPTRSLB1)
...
SUBROUTINE CPG_SL2_TYPE_INIT (SELF, REGISTRY, NLEV, YDTPTRSLB2, PERSISTENT, PTPTRSLB2)
...
LOGICAL, OPTIONAL,                  INTENT (IN)    :: PERSISTENT
REAL (KIND=JPRB), OPTIONAL, TARGET, INTENT (IN)    :: PTPTRSLB2 (:, :, :)

IF (PRESENT (PTPTRSLB2)) THEN
  SELF%ZDATA => PTPTRSLB2
  SELF%LOWNED = .FALSE.
ELSE
  ALLOCATE (SELF%ZDATA (REGISTRY%NPROMA, YDTPTRSLB2%NFLDSLB2, REGISTRY%NBLOCKS))
  SELF%LOWNED = .TRUE.
ENDIF
