...
CONTAINS
  ...
  PROCEDURE :: INIT_STACK => CPG_XYBDER_TYPE_INIT_STACK
  PROCEDURE :: ALLOC_STACK => CPG_XYBDER_TYPE_ALLOC_STACK
  PROCEDURE :: UPDATE_VIEW_STACK => CPG_XYBDER_TYPE_UPDATE_VIEW_STACK
  PROCEDURE :: SIZE_STACK => CPG_XYBDER_TYPE_SIZE_STACK
...
CONTAINS
  ...
  PROCEDURE :: INIT_STACK => CPG_XYB_TYPE_INIT_STACK
  PROCEDURE :: ALLOC_STACK => CPG_XYB_TYPE_ALLOC_STACK
  PROCEDURE :: UPDATE_VIEW_STACK => CPG_XYB_TYPE_UPDATE_VIEW_STACK
  PROCEDURE :: SIZE_STACK => CPG_XYB_TYPE_SIZE_STACK
...
CONTAINS
  ...
  PROCEDURE :: INIT_STACK => CPG_HWIND_TYPE_INIT_STACK
  PROCEDURE :: ALLOC_STACK => CPG_HWIND_TYPE_ALLOC_STACK
  PROCEDURE :: UPDATE_VIEW_STACK => CPG_HWIND_TYPE_UPDATE_VIEW_STACK
  PROCEDURE :: SIZE_STACK => CPG_HWIND_TYPE_SIZE_STACK
...
CONTAINS
  ...
  PROCEDURE :: INIT_STACK => CPG_RCP_TYPE_INIT_STACK
  PROCEDURE :: ALLOC_STACK => CPG_RCP_TYPE_ALLOC_STACK
  PROCEDURE :: UPDATE_VIEW_STACK => CPG_RCP_TYPE_UPDATE_VIEW_STACK
  PROCEDURE :: SIZE_STACK => CPG_RCP_TYPE_SIZE_STACK
...
CONTAINS
  ...
  PROCEDURE :: INIT_STACK => CPG_CTY_TYPE_INIT_STACK
  PROCEDURE :: ALLOC_STACK => CPG_CTY_TYPE_ALLOC_STACK
  PROCEDURE :: UPDATE_VIEW_STACK => CPG_CTY_TYPE_UPDATE_VIEW_STACK
  PROCEDURE :: SIZE_STACK => CPG_CTY_TYPE_SIZE_STACK
...
CONTAINS
  ...
  PROCEDURE :: INIT_STACK => CPG_TND_TYPE_INIT_STACK
  PROCEDURE :: ALLOC_STACK => CPG_TND_TYPE_ALLOC_STACK
  PROCEDURE :: UPDATE_VIEW_STACK => CPG_TND_TYPE_UPDATE_VIEW_STACK
  PROCEDURE :: SIZE_STACK => CPG_TND_TYPE_SIZE_STACK
...
CONTAINS
  ...
  PROCEDURE :: INIT_STACK => CPG_GP_T_TMP_TYPE_INIT_STACK
  PROCEDURE :: ALLOC_STACK => CPG_GP_T_TMP_TYPE_ALLOC_STACK
  PROCEDURE :: UPDATE_VIEW_STACK => CPG_GP_T_TMP_TYPE_UPDATE_VIEW_STACK
  PROCEDURE :: SIZE_STACK => CPG_GP_T_TMP_TYPE_SIZE_STACK
...
CONTAINS
  ...
  PROCEDURE :: INIT_STACK => CPG_GP_TMP_TYPE_INIT_STACK
  PROCEDURE :: ALLOC_STACK => CPG_GP_TMP_TYPE_ALLOC_STACK
  PROCEDURE :: UPDATE_VIEW_STACK => CPG_GP_TMP_TYPE_UPDATE_VIEW_STACK
  PROCEDURE :: SIZE_STACK => CPG_GP_TMP_TYPE_SIZE_STACK
...
TYPE CPG_DYN_TYPE
  ...
  INTEGER (KIND=JPIB) :: ISIZE = 0
  REAL(KIND=JPRB), POINTER :: PHIF_ALL (:, :, :) => NULL ()
  REAL(KIND=JPRB), POINTER :: PREF_ALL (:, :, :) => NULL ()
  REAL(KIND=JPRB), POINTER :: WRL_ALL (:, :, :) => NULL ()
  REAL(KIND=JPRB), POINTER :: RCP_ALL (:, :, :, :) => NULL ()
  REAL(KIND=JPRB), POINTER :: CTY_ALL (:, :, :, :) => NULL ()
...
CONTAINS
  ...
  PROCEDURE :: INIT_STACK => CPG_DYN_TYPE_INIT_STACK
  PROCEDURE :: ALLOC_STACK => CPG_DYN_TYPE_ALLOC_STACK
  PROCEDURE :: UPDATE_VIEW_STACK => CPG_DYN_TYPE_UPDATE_VIEW_STACK
  PROCEDURE :: SIZE_STACK => CPG_DYN_TYPE_SIZE_STACK
...
CONTAINS
  ...
  PROCEDURE :: INIT_STACK => CPG_PHY_TYPE_INIT_STACK
  PROCEDURE :: ALLOC_STACK => CPG_PHY_TYPE_ALLOC_STACK
  PROCEDURE :: UPDATE_VIEW_STACK => CPG_PHY_TYPE_UPDATE_VIEW_STACK
  PROCEDURE :: SIZE_STACK => CPG_PHY_TYPE_SIZE_STACK
...
CONTAINS
  ...
  PROCEDURE :: INIT_STACK => CPG_MISC_TYPE_INIT_STACK
  PROCEDURE :: ALLOC_STACK => CPG_MISC_TYPE_ALLOC_STACK
  PROCEDURE :: UPDATE_VIEW_STACK => CPG_MISC_TYPE_UPDATE_VIEW_STACK
  PROCEDURE :: SIZE_STACK => CPG_MISC_TYPE_SIZE_STACK
...
CONTAINS
  ...
  PROCEDURE :: INIT_STACK => CPG_SL1_TYPE_INIT_STACK
  PROCEDURE :: ALLOC_STACK => CPG_SL1_TYPE_ALLOC_STACK
  PROCEDURE :: UPDATE_VIEW_STACK => CPG_SL1_TYPE_UPDATE_VIEW_STACK
  PROCEDURE :: SIZE_STACK => CPG_SL1_TYPE_SIZE_STACK
...
CONTAINS
  ...
  PROCEDURE :: INIT_STACK => CPG_SL2_TYPE_INIT_STACK
  PROCEDURE :: ALLOC_STACK => CPG_SL2_TYPE_ALLOC_STACK
  PROCEDURE :: UPDATE_VIEW_STACK => CPG_SL2_TYPE_UPDATE_VIEW_STACK
  PROCEDURE :: SIZE_STACK => CPG_SL2_TYPE_SIZE_STACK
...
SUBROUTINE CPG_XYBDER_TYPE_INIT_STACK (SELF, REGISTRY, NLEV, YDTXYBDER, PTXYBDER)
...
SELF%ISIZE = MALIGN (JPRB * REGISTRY%GEOM%YRDIM%NPROMA * (NLEV) * YDTXYBDER%NDIM)

  SELF%IP_LNPRL = YDTXYBDER%M_LNPRL
  SELF%IP_LNPRM = YDTXYBDER%M_LNPRM
  SELF%IP_ALPHL = YDTXYBDER%M_ALPHL
  SELF%IP_ALPHM = YDTXYBDER%M_ALPHM
  SELF%IP_ALPHPLL = YDTXYBDER%M_ALPHPLL
  SELF%IP_ALPHPLM = YDTXYBDER%M_ALPHPLM
  SELF%IP_COEFD = YDTXYBDER%M_COEFD
  SELF%IP_COEFA = YDTXYBDER%M_COEFA
  SELF%IP_COEFAPL = YDTXYBDER%M_COEFAPL

END SUBROUTINE CPG_XYBDER_TYPE_INIT_STACK

SUBROUTINE CPG_XYBDER_TYPE_ALLOC_STACK (SELF, REGISTRY, NLEV, YDTXYBDER, PTXYBDER, YDSTACK)
...
IF (SELF%LSTACK) THEN
  CALL YDSTACK%ALLOC (SELF%ZDATA, [REGISTRY%GEOM%YRDIM%NPROMA, NLEV, YDTXYBDER%NDIM, 1])

  SELF%ZVIEW  => SELF%ZDATA (:, :, :, 1) 

  SELF%LNPRL  => SELF%ZDATA (:, :, SELF%IP_LNPRL, 1)
  SELF%LNPRM  => SELF%ZDATA (:, :, SELF%IP_LNPRM, 1)
  SELF%ALPHL  => SELF%ZDATA (:, :, SELF%IP_ALPHL, 1)
  SELF%ALPHM  => SELF%ZDATA (:, :, SELF%IP_ALPHM, 1)
  SELF%ALPHPLL  => SELF%ZDATA (:, :, SELF%IP_ALPHPLL, 1)
  SELF%ALPHPLM  => SELF%ZDATA (:, :, SELF%IP_ALPHPLM, 1)
  SELF%COEFD  => SELF%ZDATA (:, :, SELF%IP_COEFD, 1)
  SELF%COEFA  => SELF%ZDATA (:, :, SELF%IP_COEFA, 1)
  SELF%COEFAPL  => SELF%ZDATA (:, :, SELF%IP_COEFAPL, 1)

ENDIF

END SUBROUTINE CPG_XYBDER_TYPE_ALLOC_STACK

SUBROUTINE CPG_XYBDER_TYPE_UPDATE_VIEW_STACK (SELF, BLOCK_INDEX)

CLASS (CPG_XYBDER_TYPE)         :: SELF
INTEGER(KIND=JPIM), INTENT (IN)   :: BLOCK_INDEX

IF (.NOT. SELF%LSTACK) THEN


  SELF%ZVIEW  => SELF%ZDATA (:, :, :, BLOCK_INDEX)

  SELF%LNPRL  => SELF%ZDATA (:, :, SELF%IP_LNPRL, BLOCK_INDEX)
  SELF%LNPRM  => SELF%ZDATA (:, :, SELF%IP_LNPRM, BLOCK_INDEX)
  SELF%ALPHL  => SELF%ZDATA (:, :, SELF%IP_ALPHL, BLOCK_INDEX)
  SELF%ALPHM  => SELF%ZDATA (:, :, SELF%IP_ALPHM, BLOCK_INDEX)
  SELF%ALPHPLL  => SELF%ZDATA (:, :, SELF%IP_ALPHPLL, BLOCK_INDEX)
  SELF%ALPHPLM  => SELF%ZDATA (:, :, SELF%IP_ALPHPLM, BLOCK_INDEX)
  SELF%COEFD  => SELF%ZDATA (:, :, SELF%IP_COEFD, BLOCK_INDEX)
  SELF%COEFA  => SELF%ZDATA (:, :, SELF%IP_COEFA, BLOCK_INDEX)
  SELF%COEFAPL  => SELF%ZDATA (:, :, SELF%IP_COEFAPL, BLOCK_INDEX)

ENDIF

END SUBROUTINE CPG_XYBDER_TYPE_UPDATE_VIEW_STACK

INTEGER (KIND=JPIB) FUNCTION CPG_XYBDER_TYPE_SIZE_STACK (SELF)

CLASS (CPG_XYBDER_TYPE)         :: SELF

CPG_XYBDER_TYPE_SIZE_STACK = SELF%ISIZE

END FUNCTION CPG_XYBDER_TYPE_SIZE_STACK
...
SUBROUTINE CPG_XYB_TYPE_INIT_STACK (SELF, REGISTRY, NLEV, YDTXYB, PTXYB)
...
SELF%ISIZE = MALIGN (JPRB * REGISTRY%GEOM%YRDIM%NPROMA * (NLEV) * YDTXYB%NDIM)

  SELF%IP_DELP = YDTXYB%M_DELP
  SELF%IP_RDELP = YDTXYB%M_RDELP
  SELF%IP_LNPR = YDTXYB%M_LNPR
  SELF%IP_ALPH = YDTXYB%M_ALPH
  SELF%IP_RTGR = YDTXYB%M_RTGR
  SELF%IP_RPRE = YDTXYB%M_RPRE
  SELF%IP_RPP = YDTXYB%M_RPP

END SUBROUTINE CPG_XYB_TYPE_INIT_STACK

SUBROUTINE CPG_XYB_TYPE_ALLOC_STACK (SELF, REGISTRY, NLEV, YDTXYB, PTXYB, YDSTACK)
...
IF (SELF%LSTACK) THEN
  CALL YDSTACK%ALLOC (SELF%ZDATA, [REGISTRY%GEOM%YRDIM%NPROMA, NLEV, YDTXYB%NDIM, 1])

  SELF%ZVIEW  => SELF%ZDATA (:, :, :, 1) 

  SELF%DELP  => SELF%ZDATA (:, :, SELF%IP_DELP, 1)
  SELF%RDELP  => SELF%ZDATA (:, :, SELF%IP_RDELP, 1)
  SELF%LNPR  => SELF%ZDATA (:, :, SELF%IP_LNPR, 1)
  SELF%ALPH  => SELF%ZDATA (:, :, SELF%IP_ALPH, 1)
  SELF%RTGR  => SELF%ZDATA (:, :, SELF%IP_RTGR, 1)
  SELF%RPRE  => SELF%ZDATA (:, :, SELF%IP_RPRE, 1)
  SELF%RPP  => SELF%ZDATA (:, :, SELF%IP_RPP, 1)

ENDIF

END SUBROUTINE CPG_XYB_TYPE_ALLOC_STACK

SUBROUTINE CPG_XYB_TYPE_UPDATE_VIEW_STACK (SELF, BLOCK_INDEX)
...
IF (.NOT. SELF%LSTACK) THEN
  ...
  SELF%DELP  => SELF%ZDATA (:, :, SELF%IP_DELP, BLOCK_INDEX)
  SELF%RDELP  => SELF%ZDATA (:, :, SELF%IP_RDELP, BLOCK_INDEX)
  SELF%LNPR  => SELF%ZDATA (:, :, SELF%IP_LNPR, BLOCK_INDEX)
  SELF%ALPH  => SELF%ZDATA (:, :, SELF%IP_ALPH, BLOCK_INDEX)
  SELF%RTGR  => SELF%ZDATA (:, :, SELF%IP_RTGR, BLOCK_INDEX)
  SELF%RPRE  => SELF%ZDATA (:, :, SELF%IP_RPRE, BLOCK_INDEX)
  SELF%RPP  => SELF%ZDATA (:, :, SELF%IP_RPP, BLOCK_INDEX)

ENDIF

END SUBROUTINE CPG_XYB_TYPE_UPDATE_VIEW_STACK

INTEGER (KIND=JPIB) FUNCTION CPG_XYB_TYPE_SIZE_STACK (SELF)

CLASS (CPG_XYB_TYPE)         :: SELF

CPG_XYB_TYPE_SIZE_STACK = SELF%ISIZE

END FUNCTION CPG_XYB_TYPE_SIZE_STACK
...
SUBROUTINE CPG_HWIND_TYPE_INIT_STACK (SELF, REGISTRY, NLEV, YDTHWIND, PTHWIND)
...
SELF%ISIZE = MALIGN (JPRB * REGISTRY%GEOM%YRDIM%NPROMA * (NLEV+1) * YDTHWIND%NDIM)

  SELF%IP_UH = YDTHWIND%M_UH
  SELF%IP_VH = YDTHWIND%M_VH
  SELF%IP_WWI = YDTHWIND%M_WWI

END SUBROUTINE CPG_HWIND_TYPE_INIT_STACK

SUBROUTINE CPG_HWIND_TYPE_ALLOC_STACK (SELF, REGISTRY, NLEV, YDTHWIND, PTHWIND, YDSTACK)
...
IF (SELF%LSTACK) THEN
  CALL YDSTACK%ALLOC (SELF%ZDATA, [REGISTRY%GEOM%YRDIM%NPROMA, NLEV+1, YDTHWIND%NDIM, 1])

  SELF%ZVIEW (1:,0:, 1:) => SELF%ZDATA (:, :, :, 1) 

  SELF%UH (1:,0:) => SELF%ZDATA (:, :, SELF%IP_UH, 1)
  SELF%VH (1:,0:) => SELF%ZDATA (:, :, SELF%IP_VH, 1)
  SELF%WWI (1:,0:) => SELF%ZDATA (:, :, SELF%IP_WWI, 1)

ENDIF

END SUBROUTINE CPG_HWIND_TYPE_ALLOC_STACK

SUBROUTINE CPG_HWIND_TYPE_UPDATE_VIEW_STACK (SELF, BLOCK_INDEX)
...
IF (.NOT. SELF%LSTACK) THEN
  ...
  SELF%ZVIEW (1:,0:, 1:) => SELF%ZDATA (:, :, :, BLOCK_INDEX)

  SELF%UH (1:,0:) => SELF%ZDATA (:, :, SELF%IP_UH, BLOCK_INDEX)
  SELF%VH (1:,0:) => SELF%ZDATA (:, :, SELF%IP_VH, BLOCK_INDEX)
  SELF%WWI (1:,0:) => SELF%ZDATA (:, :, SELF%IP_WWI, BLOCK_INDEX)

ENDIF

END SUBROUTINE CPG_HWIND_TYPE_UPDATE_VIEW_STACK

INTEGER (KIND=JPIB) FUNCTION CPG_HWIND_TYPE_SIZE_STACK (SELF)

CLASS (CPG_HWIND_TYPE)         :: SELF

CPG_HWIND_TYPE_SIZE_STACK = SELF%ISIZE

END FUNCTION CPG_HWIND_TYPE_SIZE_STACK
...
SUBROUTINE CPG_RCP_TYPE_INIT_STACK (SELF, REGISTRY, NLEV, YDTRCP, PTRCP)
...
SELF%ISIZE = MALIGN (JPRB * REGISTRY%GEOM%YRDIM%NPROMA * (NLEV) * YDTRCP%NDIM)

  SELF%IP_CP = YDTRCP%M_CP
  SELF%IP_R = YDTRCP%M_R
  SELF%IP_KAP = YDTRCP%M_KAP

END SUBROUTINE CPG_RCP_TYPE_INIT_STACK

SUBROUTINE CPG_RCP_TYPE_ALLOC_STACK (SELF, REGISTRY, NLEV, YDTRCP, PTRCP, YDSTACK)
...
IF (SELF%LSTACK) THEN
  CALL YDSTACK%ALLOC (SELF%ZDATA, [REGISTRY%GEOM%YRDIM%NPROMA, NLEV, YDTRCP%NDIM, 1])

  SELF%ZVIEW  => SELF%ZDATA (:, :, :, 1) 

  SELF%CP  => SELF%ZDATA (:, :, SELF%IP_CP, 1)
  SELF%R  => SELF%ZDATA (:, :, SELF%IP_R, 1)
  SELF%KAP  => SELF%ZDATA (:, :, SELF%IP_KAP, 1)

ENDIF

END SUBROUTINE CPG_RCP_TYPE_ALLOC_STACK

SUBROUTINE CPG_RCP_TYPE_UPDATE_VIEW_STACK (SELF, BLOCK_INDEX)
...
IF (.NOT. SELF%LSTACK) THEN
  ...
  SELF%CP  => SELF%ZDATA (:, :, SELF%IP_CP, BLOCK_INDEX)
  SELF%R  => SELF%ZDATA (:, :, SELF%IP_R, BLOCK_INDEX)
  SELF%KAP  => SELF%ZDATA (:, :, SELF%IP_KAP, BLOCK_INDEX)

ENDIF

END SUBROUTINE CPG_RCP_TYPE_UPDATE_VIEW_STACK

INTEGER (KIND=JPIB) FUNCTION CPG_RCP_TYPE_SIZE_STACK (SELF)

CLASS (CPG_RCP_TYPE)         :: SELF

CPG_RCP_TYPE_SIZE_STACK = SELF%ISIZE

END FUNCTION CPG_RCP_TYPE_SIZE_STACK
...
SUBROUTINE CPG_CTY_TYPE_INIT_STACK (SELF, REGISTRY, NLEV, YDTCTY, PTCTY)
...
SELF%ISIZE = MALIGN (JPRB * REGISTRY%GEOM%YRDIM%NPROMA * (NLEV+1) * YDTCTY%NDIM)

  SELF%IP_EVEL = YDTCTY%M_EVEL
  SELF%IP_VVEL = YDTCTY%M_VVEL
  SELF%IP_PSDIV = YDTCTY%M_PSDIV
  SELF%IP_PSDVBC = YDTCTY%M_PSDVBC
  SELF%IP_DIVDP = YDTCTY%M_DIVDP

END SUBROUTINE CPG_CTY_TYPE_INIT_STACK

SUBROUTINE CPG_CTY_TYPE_ALLOC_STACK (SELF, REGISTRY, NLEV, YDTCTY, PTCTY, YDSTACK)
...
IF (SELF%LSTACK) THEN
  CALL YDSTACK%ALLOC (SELF%ZDATA, [REGISTRY%GEOM%YRDIM%NPROMA, NLEV+1, YDTCTY%NDIM, 1])

  SELF%ZVIEW (1:,0:, 1:) => SELF%ZDATA (:, :, :, 1) 

  SELF%EVEL (1:,0:) => SELF%ZDATA (:, :, SELF%IP_EVEL, 1)
  SELF%VVEL (1:,0:) => SELF%ZDATA (:, :, SELF%IP_VVEL, 1)
  SELF%PSDIV (1:,0:) => SELF%ZDATA (:, :, SELF%IP_PSDIV, 1)
  SELF%PSDVBC (1:,0:) => SELF%ZDATA (:, :, SELF%IP_PSDVBC, 1)
  SELF%DIVDP (1:,0:) => SELF%ZDATA (:, :, SELF%IP_DIVDP, 1)

ENDIF

END SUBROUTINE CPG_CTY_TYPE_ALLOC_STACK

SUBROUTINE CPG_CTY_TYPE_UPDATE_VIEW_STACK (SELF, BLOCK_INDEX)
...
IF (.NOT. SELF%LSTACK) THEN
  ...
  SELF%EVEL (1:,0:) => SELF%ZDATA (:, :, SELF%IP_EVEL, BLOCK_INDEX)
  SELF%VVEL (1:,0:) => SELF%ZDATA (:, :, SELF%IP_VVEL, BLOCK_INDEX)
  SELF%PSDIV (1:,0:) => SELF%ZDATA (:, :, SELF%IP_PSDIV, BLOCK_INDEX)
  SELF%PSDVBC (1:,0:) => SELF%ZDATA (:, :, SELF%IP_PSDVBC, BLOCK_INDEX)
  SELF%DIVDP (1:,0:) => SELF%ZDATA (:, :, SELF%IP_DIVDP, BLOCK_INDEX)

ENDIF

END SUBROUTINE CPG_CTY_TYPE_UPDATE_VIEW_STACK

INTEGER (KIND=JPIB) FUNCTION CPG_CTY_TYPE_SIZE_STACK (SELF)

CLASS (CPG_CTY_TYPE)         :: SELF

CPG_CTY_TYPE_SIZE_STACK = SELF%ISIZE

END FUNCTION CPG_CTY_TYPE_SIZE_STACK
...
SUBROUTINE CPG_TND_TYPE_INIT_STACK (SELF, REGISTRY, NLEV, YDTTND, PTTND)
...
SELF%ISIZE = MALIGN (JPRB * REGISTRY%GEOM%YRDIM%NPROMA * (NLEV) * YDTTND%NDIM)

  SELF%IP_TNDU = YDTTND%M_TNDU
  SELF%IP_TNDV = YDTTND%M_TNDV
  SELF%IP_TNDU_NOC = YDTTND%M_TNDU_NOC
  SELF%IP_TNDV_NOC = YDTTND%M_TNDV_NOC
  SELF%IP_TNDT = YDTTND%M_TNDT
  SELF%IP_TNDPD = YDTTND%M_TNDPD
  SELF%IP_TNDVD = YDTTND%M_TNDVD
  SELF%IP_TNDGW = YDTTND%M_TNDGW

END SUBROUTINE CPG_TND_TYPE_INIT_STACK

SUBROUTINE CPG_TND_TYPE_ALLOC_STACK (SELF, REGISTRY, NLEV, YDTTND, PTTND, YDSTACK)
...
IF (SELF%LSTACK) THEN
  CALL YDSTACK%ALLOC (SELF%ZDATA, [REGISTRY%GEOM%YRDIM%NPROMA, NLEV, YDTTND%NDIM, 1])

  SELF%ZVIEW  => SELF%ZDATA (:, :, :, 1) 

  SELF%TNDU  => SELF%ZDATA (:, :, SELF%IP_TNDU, 1)
  SELF%TNDV  => SELF%ZDATA (:, :, SELF%IP_TNDV, 1)
  SELF%TNDU_NOC  => SELF%ZDATA (:, :, SELF%IP_TNDU_NOC, 1)
  SELF%TNDV_NOC  => SELF%ZDATA (:, :, SELF%IP_TNDV_NOC, 1)
  SELF%TNDT  => SELF%ZDATA (:, :, SELF%IP_TNDT, 1)
  SELF%TNDPD  => SELF%ZDATA (:, :, SELF%IP_TNDPD, 1)
  SELF%TNDVD  => SELF%ZDATA (:, :, SELF%IP_TNDVD, 1)
  SELF%TNDGW  => SELF%ZDATA (:, :, SELF%IP_TNDGW, 1)

ENDIF

END SUBROUTINE CPG_TND_TYPE_ALLOC_STACK

SUBROUTINE CPG_TND_TYPE_UPDATE_VIEW_STACK (SELF, BLOCK_INDEX)
...
IF (.NOT. SELF%LSTACK) THEN
  ...
  SELF%TNDU  => SELF%ZDATA (:, :, SELF%IP_TNDU, BLOCK_INDEX)
  SELF%TNDV  => SELF%ZDATA (:, :, SELF%IP_TNDV, BLOCK_INDEX)
  SELF%TNDU_NOC  => SELF%ZDATA (:, :, SELF%IP_TNDU_NOC, BLOCK_INDEX)
  SELF%TNDV_NOC  => SELF%ZDATA (:, :, SELF%IP_TNDV_NOC, BLOCK_INDEX)
  SELF%TNDT  => SELF%ZDATA (:, :, SELF%IP_TNDT, BLOCK_INDEX)
  SELF%TNDPD  => SELF%ZDATA (:, :, SELF%IP_TNDPD, BLOCK_INDEX)
  SELF%TNDVD  => SELF%ZDATA (:, :, SELF%IP_TNDVD, BLOCK_INDEX)
  SELF%TNDGW  => SELF%ZDATA (:, :, SELF%IP_TNDGW, BLOCK_INDEX)

ENDIF

END SUBROUTINE CPG_TND_TYPE_UPDATE_VIEW_STACK

INTEGER (KIND=JPIB) FUNCTION CPG_TND_TYPE_SIZE_STACK (SELF)

CLASS (CPG_TND_TYPE)         :: SELF

CPG_TND_TYPE_SIZE_STACK = SELF%ISIZE

END FUNCTION CPG_TND_TYPE_SIZE_STACK
...
SUBROUTINE CPG_GP_T_TMP_TYPE_INIT_STACK (SELF &
                                & , KT  &
                                & , REGISTRY &
                                & , NLEV &
                           &)
...
!PRINT *, "GDW", SELF%ISIZE
IF (LNHDYN) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "GWHT", SELF%ISIZE
SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 0 + 1))

!PRINT *, "OROGLL", SELF%ISIZE
IF (LNHDYN.AND.LLT0) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB)
ENDIF

!PRINT *, "OROGMM", SELF%ISIZE
IF (LNHDYN.AND.LLT0) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB)
ENDIF

!PRINT *, "OROGLM", SELF%ISIZE
IF (LNHDYN.AND.LLT0) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB)
ENDIF

!PRINT *, "DELNHPRE", SELF%ISIZE
IF (LNHEE) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "DPHYCTY", SELF%ISIZE
IF (LLT0.AND.(.NOT.LNHDYN)) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "DVER", SELF%ISIZE
SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))

!PRINT *, "DVERL", SELF%ISIZE
IF (LLT0.AND.LNHDYN) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "DVERM", SELF%ISIZE
IF (LLT0.AND.LNHDYN) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "DVERW", SELF%ISIZE
IF (LNHEE) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "EIQCHAF", SELF%ISIZE
IF (LLT0.AND.LNHQE) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "EQCHAF", SELF%ISIZE
IF (LLT0.AND.LNHQE) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "EQCHAH", SELF%ISIZE
IF (LLT0.AND.LNHQE) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 0 + 1))
ENDIF

!PRINT *, "GPHL", SELF%ISIZE
IF (LLT0) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 0 + 1))
ENDIF

!PRINT *, "GPHM", SELF%ISIZE
IF (LLT0) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 0 + 1))
ENDIF

!PRINT *, "GWHL", SELF%ISIZE
IF (LLT0.AND.LNHDYN) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 0 + 1))
ENDIF

!PRINT *, "GWHM", SELF%ISIZE
IF (LLT0.AND.LNHDYN) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 0 + 1))
ENDIF

!PRINT *, "KAPH", SELF%ISIZE
IF (LLT0.AND.LNHQE) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 0 + 1))
ENDIF

!PRINT *, "LNNHPREFL", SELF%ISIZE
IF (LLT0.AND.LNHEE) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "LNNHPREFM", SELF%ISIZE
IF (LLT0.AND.LNHEE) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "NHPPI", SELF%ISIZE
IF (LNHEE) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "NHPREL", SELF%ISIZE
IF (LLT0.AND.LNHEE) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "NHPREM", SELF%ISIZE
IF (LLT0.AND.LNHEE) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "NHXD_T", SELF%ISIZE
IF (LNHQE) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "NHXS", SELF%ISIZE
IF (LLT0.AND.LNHEE) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "NHXS_T", SELF%ISIZE
IF (LNHQE) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "NHXT", SELF%ISIZE
IF ((.NOT.LNHDYN)) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "PDEP", SELF%ISIZE
IF (LNHEE) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "PDEPS", SELF%ISIZE
IF (LLT0.AND.LNHEE) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB)
ENDIF

!PRINT *, "PSGRTL", SELF%ISIZE
IF (LLT0) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "PSGRTM", SELF%ISIZE
IF (LLT0) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "R0T", SELF%ISIZE
IF (.NOT.LLT0) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "R9T", SELF%ISIZE
IF ((.NOT.LLT0).AND.LNHQE) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "RDT", SELF%ISIZE
IF ((.NOT.LNHDYN).OR.LNHEE) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "RDTL", SELF%ISIZE
IF (LLT0.AND.LNHEE) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "RDTM", SELF%ISIZE
IF (LLT0.AND.LNHEE) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "RNHPPI", SELF%ISIZE
IF (LNHEE) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "RPREF", SELF%ISIZE
IF (LLT0) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "RRED", SELF%ISIZE
IF (LNHEE) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF
...
!PRINT *, "RTR", SELF%ISIZE
IF (LLT0.AND.LNHEE) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "SGRTL", SELF%ISIZE
IF (LLT0) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "SGRTM", SELF%ISIZE
IF (LLT0) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "SGRTSL", SELF%ISIZE
IF (LLT0.AND.LNHDYN) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB)
ENDIF

!PRINT *, "SGRTSM", SELF%ISIZE
IF (LLT0.AND.LNHDYN) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB)
ENDIF

!PRINT *, "SVDINCR13", SELF%ISIZE
IF (LLT0.AND.LNHEE) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "TNDGWF_LAP", SELF%ISIZE
IF (LLT0.AND.LNHEE) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "TNDGWF_OTH", SELF%ISIZE
IF (LLT0.AND.LNHEE) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "TNDGWH_LAP", SELF%ISIZE
IF (LLT0.AND.LNHEE) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 0 + 1))
ENDIF

!PRINT *, "TNDGWH_OTH", SELF%ISIZE
IF (LLT0.AND.LNHEE) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 0 + 1))
ENDIF

!PRINT *, "TNDUS", SELF%ISIZE
IF (LLT0.AND.LNHDYN) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB)
ENDIF

!PRINT *, "TNDVS", SELF%ISIZE
IF (LLT0.AND.LNHDYN) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB)
ENDIF
...
!PRINT *, "US_L", SELF%ISIZE
IF (LLT0.AND.LNHDYN) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB)
ENDIF

!PRINT *, "US_M", SELF%ISIZE
IF (LLT0.AND.LNHDYN) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB)
ENDIF
...
!PRINT *, "VS_L", SELF%ISIZE
IF (LLT0.AND.LNHDYN) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB)
ENDIF

!PRINT *, "VS_M", SELF%ISIZE
IF (LLT0.AND.LNHDYN) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB)
ENDIF

!PRINT *, "Z3DIVG", SELF%ISIZE
IF (LLT0.AND.LNHEE) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "WH2F", SELF%ISIZE
IF (LLT0.AND.LNHEE) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1) * (2 - 1 + 1))
ENDIF

!PRINT *, "ZERO", SELF%ISIZE
IF (LLT0.AND.LNHEE) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB)
ENDIF

!PRINT *, "ONE", SELF%ISIZE
IF (LLT0.AND.LNHQE) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "XYBDER", SELF%ISIZE
IF (LLT0) THEN
  CALL SELF%XYBDER%INIT_STACK (REGISTRY, NLEV, YLTXYBDER)
  SELF%ISIZE = SELF%ISIZE + SELF%XYBDER%SIZE_STACK ()
ENDIF

!PRINT *, "UVH", SELF%ISIZE
IF (.NOT.LLT0) THEN
  CALL SELF%UVH%INIT_STACK (REGISTRY, NLEV, YLTHW)
  SELF%ISIZE = SELF%ISIZE + SELF%UVH%SIZE_STACK ()
ENDIF


END SUBROUTINE CPG_GP_T_TMP_TYPE_INIT_STACK

SUBROUTINE CPG_GP_T_TMP_TYPE_ALLOC_STACK (SELF &
                                & , KT  &
                                & , REGISTRY &
                                & , NLEV &
                                &, YDSTACK &
...
!PRINT *, "GDW", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LNHDYN) THEN
    CALL YDSTACK%ALLOC (SELF%GDW, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "GWHT", YDSTACK%IPTR-70785, YDSTACK%IPTR
  CALL YDSTACK%ALLOC (SELF%GWHT, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 0])

!PRINT *, "OROGLL", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LNHDYN.AND.LLT0) THEN
    CALL YDSTACK%ALLOC (SELF%OROGLL, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA], KLBDS=[1])
ENDIF

!PRINT *, "OROGMM", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LNHDYN.AND.LLT0) THEN
    CALL YDSTACK%ALLOC (SELF%OROGMM, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA], KLBDS=[1])
ENDIF

!PRINT *, "OROGLM", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LNHDYN.AND.LLT0) THEN
    CALL YDSTACK%ALLOC (SELF%OROGLM, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA], KLBDS=[1])
ENDIF

!PRINT *, "DELNHPRE", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LNHEE) THEN
    CALL YDSTACK%ALLOC (SELF%DELNHPRE, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "DPHYCTY", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0.AND.(.NOT.LNHDYN)) THEN
    CALL YDSTACK%ALLOC (SELF%DPHYCTY, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "DVER", YDSTACK%IPTR-70785, YDSTACK%IPTR
  CALL YDSTACK%ALLOC (SELF%DVER, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])

!PRINT *, "DVERL", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0.AND.LNHDYN) THEN
    CALL YDSTACK%ALLOC (SELF%DVERL, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "DVERM", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0.AND.LNHDYN) THEN
    CALL YDSTACK%ALLOC (SELF%DVERM, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "DVERW", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LNHEE) THEN
    CALL YDSTACK%ALLOC (SELF%DVERW, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "EIQCHAF", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0.AND.LNHQE) THEN
    CALL YDSTACK%ALLOC (SELF%EIQCHAF, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "EQCHAF", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0.AND.LNHQE) THEN
    CALL YDSTACK%ALLOC (SELF%EQCHAF, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "EQCHAH", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0.AND.LNHQE) THEN
    CALL YDSTACK%ALLOC (SELF%EQCHAH, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 0])
ENDIF

!PRINT *, "GPHL", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0) THEN
    CALL YDSTACK%ALLOC (SELF%GPHL, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 0])
ENDIF

!PRINT *, "GPHM", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0) THEN
    CALL YDSTACK%ALLOC (SELF%GPHM, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 0])
ENDIF

!PRINT *, "GWHL", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0.AND.LNHDYN) THEN
    CALL YDSTACK%ALLOC (SELF%GWHL, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 0])
ENDIF

!PRINT *, "GWHM", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0.AND.LNHDYN) THEN
    CALL YDSTACK%ALLOC (SELF%GWHM, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 0])
ENDIF

!PRINT *, "KAPH", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0.AND.LNHQE) THEN
    CALL YDSTACK%ALLOC (SELF%KAPH, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 0])
ENDIF

!PRINT *, "LNNHPREFL", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0.AND.LNHEE) THEN
    CALL YDSTACK%ALLOC (SELF%LNNHPREFL, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "LNNHPREFM", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0.AND.LNHEE) THEN
    CALL YDSTACK%ALLOC (SELF%LNNHPREFM, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "NHPPI", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LNHEE) THEN
    CALL YDSTACK%ALLOC (SELF%NHPPI, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "NHPREL", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0.AND.LNHEE) THEN
    CALL YDSTACK%ALLOC (SELF%NHPREL, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "NHPREM", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0.AND.LNHEE) THEN
    CALL YDSTACK%ALLOC (SELF%NHPREM, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "NHXD_T", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LNHQE) THEN
    CALL YDSTACK%ALLOC (SELF%NHXD_T, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "NHXS", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0.AND.LNHEE) THEN
    CALL YDSTACK%ALLOC (SELF%NHXS, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "NHXS_T", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LNHQE) THEN
    CALL YDSTACK%ALLOC (SELF%NHXS_T, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "NHXT", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF ((.NOT.LNHDYN)) THEN
    CALL YDSTACK%ALLOC (SELF%NHXT, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "PDEP", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LNHEE) THEN
    CALL YDSTACK%ALLOC (SELF%PDEP, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "PDEPS", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0.AND.LNHEE) THEN
    CALL YDSTACK%ALLOC (SELF%PDEPS, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA], KLBDS=[1])
ENDIF

!PRINT *, "PSGRTL", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0) THEN
    CALL YDSTACK%ALLOC (SELF%PSGRTL, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "PSGRTM", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0) THEN
    CALL YDSTACK%ALLOC (SELF%PSGRTM, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "R0T", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (.NOT.LLT0) THEN
    CALL YDSTACK%ALLOC (SELF%R0T, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "R9T", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF ((.NOT.LLT0).AND.LNHQE) THEN
    CALL YDSTACK%ALLOC (SELF%R9T, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "RDT", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF ((.NOT.LNHDYN).OR.LNHEE) THEN
    CALL YDSTACK%ALLOC (SELF%RDT, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "RDTL", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0.AND.LNHEE) THEN
    CALL YDSTACK%ALLOC (SELF%RDTL, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "RDTM", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0.AND.LNHEE) THEN
    CALL YDSTACK%ALLOC (SELF%RDTM, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "RNHPPI", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LNHEE) THEN
    CALL YDSTACK%ALLOC (SELF%RNHPPI, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "RPREF", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0) THEN
    CALL YDSTACK%ALLOC (SELF%RPREF, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "RRED", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LNHEE) THEN
    CALL YDSTACK%ALLOC (SELF%RRED, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "RT", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0) THEN
    CALL YDSTACK%ALLOC (SELF%RT, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "RTR", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0.AND.LNHEE) THEN
    CALL YDSTACK%ALLOC (SELF%RTR, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "SGRTL", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0) THEN
    CALL YDSTACK%ALLOC (SELF%SGRTL, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "SGRTM", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0) THEN
    CALL YDSTACK%ALLOC (SELF%SGRTM, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "SGRTSL", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0.AND.LNHDYN) THEN
    CALL YDSTACK%ALLOC (SELF%SGRTSL, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA], KLBDS=[1])
ENDIF

!PRINT *, "SGRTSM", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0.AND.LNHDYN) THEN
    CALL YDSTACK%ALLOC (SELF%SGRTSM, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA], KLBDS=[1])
ENDIF

!PRINT *, "SVDINCR13", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0.AND.LNHEE) THEN
    CALL YDSTACK%ALLOC (SELF%SVDINCR13, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "TNDGWF_LAP", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0.AND.LNHEE) THEN
    CALL YDSTACK%ALLOC (SELF%TNDGWF_LAP, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "TNDGWF_OTH", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0.AND.LNHEE) THEN
    CALL YDSTACK%ALLOC (SELF%TNDGWF_OTH, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "TNDGWH_LAP", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0.AND.LNHEE) THEN
    CALL YDSTACK%ALLOC (SELF%TNDGWH_LAP, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 0])
ENDIF

!PRINT *, "TNDGWH_OTH", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0.AND.LNHEE) THEN
    CALL YDSTACK%ALLOC (SELF%TNDGWH_OTH, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 0])
ENDIF

!PRINT *, "TNDUS", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0.AND.LNHDYN) THEN
    CALL YDSTACK%ALLOC (SELF%TNDUS, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA], KLBDS=[1])
ENDIF

!PRINT *, "TNDVS", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0.AND.LNHDYN) THEN
    CALL YDSTACK%ALLOC (SELF%TNDVS, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA], KLBDS=[1])
ENDIF

!PRINT *, "US", YDSTACK%IPTR-70785, YDSTACK%IPTR
  CALL YDSTACK%ALLOC (SELF%US, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA], KLBDS=[1])

!PRINT *, "US_L", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0.AND.LNHDYN) THEN
    CALL YDSTACK%ALLOC (SELF%US_L, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA], KLBDS=[1])
ENDIF

!PRINT *, "US_M", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0.AND.LNHDYN) THEN
    CALL YDSTACK%ALLOC (SELF%US_M, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA], KLBDS=[1])
ENDIF

!PRINT *, "VS", YDSTACK%IPTR-70785, YDSTACK%IPTR
  CALL YDSTACK%ALLOC (SELF%VS, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA], KLBDS=[1])

!PRINT *, "VS_L", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0.AND.LNHDYN) THEN
    CALL YDSTACK%ALLOC (SELF%VS_L, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA], KLBDS=[1])
ENDIF

!PRINT *, "VS_M", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0.AND.LNHDYN) THEN
    CALL YDSTACK%ALLOC (SELF%VS_M, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA], KLBDS=[1])
ENDIF

!PRINT *, "Z3DIVG", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0.AND.LNHEE) THEN
    CALL YDSTACK%ALLOC (SELF%Z3DIVG, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "WH2F", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0.AND.LNHEE) THEN
    CALL YDSTACK%ALLOC (SELF%WH2F, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV, 2], KLBDS=[1, 1, 1])
ENDIF

!PRINT *, "ZERO", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0.AND.LNHEE) THEN
    CALL YDSTACK%ALLOC (SELF%ZERO, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA], KLBDS=[1])
ENDIF

!PRINT *, "ONE", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0.AND.LNHQE) THEN
    CALL YDSTACK%ALLOC (SELF%ONE, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "XYBDER", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0) THEN
  CALL SELF%XYBDER%ALLOC_STACK (REGISTRY, NLEV, YLTXYBDER, YDSTACK=YDSTACK)
ENDIF

!PRINT *, "UVH", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (.NOT.LLT0) THEN
  CALL SELF%UVH%ALLOC_STACK (REGISTRY, NLEV, YLTHW, YDSTACK=YDSTACK)
ENDIF


END SUBROUTINE CPG_GP_T_TMP_TYPE_ALLOC_STACK

SUBROUTINE CPG_GP_T_TMP_TYPE_UPDATE_VIEW_STACK (SELF, BLOCK_INDEX)

CLASS (CPG_GP_T_TMP_TYPE)                    :: SELF
INTEGER (KIND=JPIM), INTENT (IN)    :: BLOCK_INDEX

CALL SELF%XYBDER%UPDATE_VIEW_STACK (BLOCK_INDEX)
CALL SELF%UVH%UPDATE_VIEW_STACK (BLOCK_INDEX)

END SUBROUTINE CPG_GP_T_TMP_TYPE_UPDATE_VIEW_STACK

INTEGER (KIND=JPIB) FUNCTION CPG_GP_T_TMP_TYPE_SIZE_STACK (SELF)

CLASS (CPG_GP_T_TMP_TYPE)         :: SELF

CPG_GP_T_TMP_TYPE_SIZE_STACK = SELF%ISIZE

END FUNCTION CPG_GP_T_TMP_TYPE_SIZE_STACK
...
SUBROUTINE CPG_GP_TMP_TYPE_INIT_STACK (SELF &
                                & , REGISTRY &
                                & , NLEV &
                           &)
...
!PRINT *, "T0", SELF%ISIZE
CALL SELF%T0%INIT_STACK (0, REGISTRY, NLEV)
SELF%ISIZE = SELF%ISIZE + SELF%T0%SIZE_STACK ()

!PRINT *, "T9", SELF%ISIZE
CALL SELF%T9%INIT_STACK (9, REGISTRY, NLEV)
SELF%ISIZE = SELF%ISIZE + SELF%T9%SIZE_STACK ()


END SUBROUTINE CPG_GP_TMP_TYPE_INIT_STACK

SUBROUTINE CPG_GP_TMP_TYPE_ALLOC_STACK (SELF &
                                & , REGISTRY &
                                & , NLEV &
                                &, YDSTACK &
                           &)
...
!PRINT *, "T0", YDSTACK%IPTR-70785, YDSTACK%IPTR
CALL SELF%T0%ALLOC_STACK (0, REGISTRY, NLEV, YDSTACK=YDSTACK)

!PRINT *, "T9", YDSTACK%IPTR-70785, YDSTACK%IPTR
CALL SELF%T9%ALLOC_STACK (9, REGISTRY, NLEV, YDSTACK=YDSTACK)


END SUBROUTINE CPG_GP_TMP_TYPE_ALLOC_STACK

SUBROUTINE CPG_GP_TMP_TYPE_UPDATE_VIEW_STACK (SELF, BLOCK_INDEX)

CLASS (CPG_GP_TMP_TYPE)                    :: SELF
INTEGER (KIND=JPIM), INTENT (IN)    :: BLOCK_INDEX

CALL SELF%T0%UPDATE_VIEW_STACK (BLOCK_INDEX)
CALL SELF%T9%UPDATE_VIEW_STACK (BLOCK_INDEX)

END SUBROUTINE CPG_GP_TMP_TYPE_UPDATE_VIEW_STACK

INTEGER (KIND=JPIB) FUNCTION CPG_GP_TMP_TYPE_SIZE_STACK (SELF)

CLASS (CPG_GP_TMP_TYPE)         :: SELF

CPG_GP_TMP_TYPE_SIZE_STACK = SELF%ISIZE

END FUNCTION CPG_GP_TMP_TYPE_SIZE_STACK
...
SUBROUTINE CPG_DYN_TYPE_INIT_STACK (SELF &
                                & , KT  &
                                & , REGISTRY &
                                & , NLEV &
                           &, PHIF &
...
!PRINT *, "OROGL", SELF%ISIZE
IF (LLT0) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB)
ENDIF

!PRINT *, "OROGM", SELF%ISIZE
IF (LLT0) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB)
ENDIF

!PRINT *, "PHI", SELF%ISIZE
SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 0 + 1))

!PRINT *, "PRE", SELF%ISIZE
SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 0 + 1))

!PRINT *, "PHIF", SELF%ISIZE
IF (PRESENT (PHIF)) THEN
ELSE
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "PREF", SELF%ISIZE
IF (PRESENT (PREF)) THEN
ELSE
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "WRL", SELF%ISIZE
IF (PRESENT (PWRL)) THEN
ENDIF

!PRINT *, "PREL", SELF%ISIZE
SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB)

!PRINT *, "PREM", SELF%ISIZE
SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB)

!PRINT *, "NHY", SELF%ISIZE
SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 0 + 1))

!PRINT *, "GWFT", SELF%ISIZE
SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))

!PRINT *, "KENE", SELF%ISIZE
IF (LLT0) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "NHX", SELF%ISIZE
SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))

!PRINT *, "PHIFL", SELF%ISIZE
IF (LLT0) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "PHIFM", SELF%ISIZE
IF (LLT0) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "RTL", SELF%ISIZE
IF (LLT0) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "RTM", SELF%ISIZE
IF (LLT0) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "RCP", SELF%ISIZE
CALL SELF%RCP%INIT_STACK (REGISTRY, NLEV, YLTRCP, PRCP)
IF (.NOT. PRESENT (PRCP)) THEN
  SELF%ISIZE = SELF%ISIZE + SELF%RCP%SIZE_STACK ()
ENDIF

!PRINT *, "CTY", SELF%ISIZE
IF (LLT0) THEN
  CALL SELF%CTY%INIT_STACK (REGISTRY, NLEV, YLTCTY, PCTY)
IF (.NOT. PRESENT (PCTY)) THEN
    SELF%ISIZE = SELF%ISIZE + SELF%CTY%SIZE_STACK ()
ENDIF
ENDIF
...
!PRINT *, "XYB", SELF%ISIZE
CALL SELF%XYB%INIT_STACK (REGISTRY, NLEV, YLTXYB)
SELF%ISIZE = SELF%ISIZE + SELF%XYB%SIZE_STACK ()

!PRINT *, "DBBC", SELF%ISIZE
IF (LNHDYN .AND. LLT0) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB)
ENDIF

!PRINT *, "GWS", SELF%ISIZE
IF (LNHDYN .AND. LLT0) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB)
ENDIF

!PRINT *, "GWFL", SELF%ISIZE
IF (LNHDYN .AND. LLT0) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "GWFM", SELF%ISIZE
IF (LNHDYN .AND. LLT0) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "GWT", SELF%ISIZE
IF (LNHDYN) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "NHPREF", SELF%ISIZE
IF (LNHDYN) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "NHPREH", SELF%ISIZE
IF (LNHDYN) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 0 + 1))
ENDIF

!PRINT *, "QCHAL", SELF%ISIZE
IF (LNHDYN .AND. LLT0) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "QCHAM", SELF%ISIZE
IF (LNHDYN .AND. LLT0) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF

!PRINT *, "RDPHI", SELF%ISIZE
IF (LNHDYN .AND. LLT0) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF


END SUBROUTINE CPG_DYN_TYPE_INIT_STACK

SUBROUTINE CPG_DYN_TYPE_ALLOC_STACK (SELF &
                                & , KT  &
                                & , REGISTRY &
                                & , NLEV &
                                &, PHIF &
...
!PRINT *, "OROGL", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0) THEN
    CALL YDSTACK%ALLOC (SELF%OROGL, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA], KLBDS=[1])
ENDIF

!PRINT *, "OROGM", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0) THEN
    CALL YDSTACK%ALLOC (SELF%OROGM, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA], KLBDS=[1])
ENDIF

!PRINT *, "PHI", YDSTACK%IPTR-70785, YDSTACK%IPTR
  CALL YDSTACK%ALLOC (SELF%PHI, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 0])

!PRINT *, "PRE", YDSTACK%IPTR-70785, YDSTACK%IPTR
  CALL YDSTACK%ALLOC (SELF%PRE, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 0])

!PRINT *, "PHIF", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (PRESENT (PHIF)) THEN
 SELF%PHIF_ALL  => PHIF 
ELSE
  CALL YDSTACK%ALLOC (SELF%PHIF, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "PREF", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (PRESENT (PREF)) THEN
 SELF%PREF_ALL  => PREF 
ELSE
  CALL YDSTACK%ALLOC (SELF%PREF, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "WRL", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (PRESENT (PWRL)) THEN
 SELF%WRL_ALL  => PWRL 
ENDIF

!PRINT *, "PREL", YDSTACK%IPTR-70785, YDSTACK%IPTR
  CALL YDSTACK%ALLOC (SELF%PREL, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA], KLBDS=[1])

!PRINT *, "PREM", YDSTACK%IPTR-70785, YDSTACK%IPTR
  CALL YDSTACK%ALLOC (SELF%PREM, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA], KLBDS=[1])

!PRINT *, "NHY", YDSTACK%IPTR-70785, YDSTACK%IPTR
  CALL YDSTACK%ALLOC (SELF%NHY, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 0])

!PRINT *, "GWFT", YDSTACK%IPTR-70785, YDSTACK%IPTR
  CALL YDSTACK%ALLOC (SELF%GWFT, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])

!PRINT *, "KENE", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0) THEN
    CALL YDSTACK%ALLOC (SELF%KENE, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "NHX", YDSTACK%IPTR-70785, YDSTACK%IPTR
  CALL YDSTACK%ALLOC (SELF%NHX, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])

!PRINT *, "PHIFL", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0) THEN
    CALL YDSTACK%ALLOC (SELF%PHIFL, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "PHIFM", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0) THEN
    CALL YDSTACK%ALLOC (SELF%PHIFM, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "RTL", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0) THEN
    CALL YDSTACK%ALLOC (SELF%RTL, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "RTM", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0) THEN
    CALL YDSTACK%ALLOC (SELF%RTM, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "RCP", YDSTACK%IPTR-70785, YDSTACK%IPTR
CALL SELF%RCP%ALLOC_STACK (REGISTRY, NLEV, YLTRCP, PRCP, YDSTACK)

!PRINT *, "CTY", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLT0) THEN
  CALL SELF%CTY%ALLOC_STACK (REGISTRY, NLEV, YLTCTY, PCTY, YDSTACK)
ENDIF
...
!PRINT *, "XYB", YDSTACK%IPTR-70785, YDSTACK%IPTR
CALL SELF%XYB%ALLOC_STACK (REGISTRY, NLEV, YLTXYB, YDSTACK=YDSTACK)

!PRINT *, "DBBC", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LNHDYN .AND. LLT0) THEN
    CALL YDSTACK%ALLOC (SELF%DBBC, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA], KLBDS=[1])
ENDIF

!PRINT *, "GWS", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LNHDYN .AND. LLT0) THEN
    CALL YDSTACK%ALLOC (SELF%GWS, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA], KLBDS=[1])
ENDIF

!PRINT *, "GWFL", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LNHDYN .AND. LLT0) THEN
    CALL YDSTACK%ALLOC (SELF%GWFL, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "GWFM", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LNHDYN .AND. LLT0) THEN
    CALL YDSTACK%ALLOC (SELF%GWFM, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "GWT", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LNHDYN) THEN
    CALL YDSTACK%ALLOC (SELF%GWT, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "NHPREF", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LNHDYN) THEN
    CALL YDSTACK%ALLOC (SELF%NHPREF, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "NHPREH", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LNHDYN) THEN
    CALL YDSTACK%ALLOC (SELF%NHPREH, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 0])
ENDIF

!PRINT *, "QCHAL", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LNHDYN .AND. LLT0) THEN
    CALL YDSTACK%ALLOC (SELF%QCHAL, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "QCHAM", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LNHDYN .AND. LLT0) THEN
    CALL YDSTACK%ALLOC (SELF%QCHAM, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "RDPHI", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LNHDYN .AND. LLT0) THEN
    CALL YDSTACK%ALLOC (SELF%RDPHI, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF


END SUBROUTINE CPG_DYN_TYPE_ALLOC_STACK

SUBROUTINE CPG_DYN_TYPE_UPDATE_VIEW_STACK (SELF, BLOCK_INDEX)

CLASS (CPG_DYN_TYPE)                    :: SELF
INTEGER (KIND=JPIM), INTENT (IN)    :: BLOCK_INDEX

IF (ASSOCIATED (SELF%PHIF_ALL)) THEN
  SELF%PHIF  => SELF%PHIF_ALL (:, :, BLOCK_INDEX)
ENDIF
IF (ASSOCIATED (SELF%PREF_ALL)) THEN
  SELF%PREF  => SELF%PREF_ALL (:, :, BLOCK_INDEX)
ENDIF
IF (ASSOCIATED (SELF%WRL_ALL)) THEN
  SELF%WRL  => SELF%WRL_ALL (:, :, BLOCK_INDEX)
ENDIF
CALL SELF%RCP%UPDATE_VIEW_STACK (BLOCK_INDEX)
CALL SELF%CTY%UPDATE_VIEW_STACK (BLOCK_INDEX)
CALL SELF%UVH%UPDATE_VIEW_STACK (BLOCK_INDEX)
CALL SELF%XYB%UPDATE_VIEW_STACK (BLOCK_INDEX)

END SUBROUTINE CPG_DYN_TYPE_UPDATE_VIEW_STACK

INTEGER (KIND=JPIB) FUNCTION CPG_DYN_TYPE_SIZE_STACK (SELF)

CLASS (CPG_DYN_TYPE)         :: SELF

CPG_DYN_TYPE_SIZE_STACK = SELF%ISIZE

END FUNCTION CPG_DYN_TYPE_SIZE_STACK
...
SUBROUTINE CPG_PHY_TYPE_INIT_STACK (SELF &
                                & , KT  &
                                & , REGISTRY &
                                & , NLEV &
                                & , LDMF_PHYS &
...
!PRINT *, "PREHYD", SELF%ISIZE
IF (LLMF_PHYS) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 0 + 1))
ENDIF

!PRINT *, "PREHYDF", SELF%ISIZE
IF (LLMF_PHYS) THEN
  SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (NLEV - 1 + 1))
ENDIF
...
!PRINT *, "XYB", SELF%ISIZE
IF (LLMF_PHYS) THEN
  CALL SELF%XYB%INIT_STACK (REGISTRY, NLEV, YLTXYB_PHY)
  SELF%ISIZE = SELF%ISIZE + SELF%XYB%SIZE_STACK ()
ENDIF


END SUBROUTINE CPG_PHY_TYPE_INIT_STACK

SUBROUTINE CPG_PHY_TYPE_ALLOC_STACK (SELF &
                                & , KT  &
                                & , REGISTRY &
                                & , NLEV &
                                & , LDMF_PHYS &
...
!PRINT *, "PREHYD", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLMF_PHYS) THEN
    CALL YDSTACK%ALLOC (SELF%PREHYD, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 0])
ENDIF

!PRINT *, "PREHYDF", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLMF_PHYS) THEN
    CALL YDSTACK%ALLOC (SELF%PREHYDF, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "WL", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLMF_PHYS) THEN
    CALL YDSTACK%ALLOC (SELF%WL, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "WM", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLMF_PHYS) THEN
    CALL YDSTACK%ALLOC (SELF%WM, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "W", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLMF_PHYS) THEN
    CALL YDSTACK%ALLOC (SELF%W, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, NLEV], KLBDS=[1, 1])
ENDIF

!PRINT *, "XYB", YDSTACK%IPTR-70785, YDSTACK%IPTR
IF (LLMF_PHYS) THEN
  CALL SELF%XYB%ALLOC_STACK (REGISTRY, NLEV, YLTXYB_PHY, YDSTACK=YDSTACK)
ENDIF


END SUBROUTINE CPG_PHY_TYPE_ALLOC_STACK

SUBROUTINE CPG_PHY_TYPE_UPDATE_VIEW_STACK (SELF, BLOCK_INDEX)
...
END SUBROUTINE CPG_PHY_TYPE_UPDATE_VIEW_STACK

INTEGER (KIND=JPIB) FUNCTION CPG_PHY_TYPE_SIZE_STACK (SELF)

CLASS (CPG_PHY_TYPE)         :: SELF

CPG_PHY_TYPE_SIZE_STACK = SELF%ISIZE

END FUNCTION CPG_PHY_TYPE_SIZE_STACK
...
SUBROUTINE CPG_MISC_TYPE_INIT_STACK (SELF &
                                & , REGISTRY &
                                & , YDCPG_OPTS &
                           &)
...
!PRINT *, "NEB", SELF%ISIZE
SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (YDCPG_OPTS%KFLEVG - 1 + 1))

!PRINT *, "QLI", SELF%ISIZE
SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (YDCPG_OPTS%KFLEVG - 1 + 1))

!PRINT *, "QICE", SELF%ISIZE
SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (YDCPG_OPTS%KFLEVG - 1 + 1))

!PRINT *, "QRAIN", SELF%ISIZE
SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (YDCPG_OPTS%KFLEVG - 1 + 1))

!PRINT *, "QSNOW", SELF%ISIZE
SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (YDCPG_OPTS%KFLEVG - 1 + 1))
...
!PRINT *, "QSOL", SELF%ISIZE
SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB)

!PRINT *, "DHSF", SELF%ISIZE
SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB)

!PRINT *, "CLCT", SELF%ISIZE
SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB)

!PRINT *, "LSM", SELF%ISIZE
SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB)

!PRINT *, "TSOL", SELF%ISIZE
SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB)

!PRINT *, "FTCNS", SELF%ISIZE
SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (YDCPG_OPTS%KFLEVG - 0 + 1) * (6 - 1 + 1))

!PRINT *, "KOZO", SELF%ISIZE
SELF%ISIZE = SELF%ISIZE + MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * JPRB * (YDCPG_OPTS%KFLEVG - 0 + 1) * (YDCPG_OPTS%KVCLIS - 1 + 1))


END SUBROUTINE CPG_MISC_TYPE_INIT_STACK

SUBROUTINE CPG_MISC_TYPE_ALLOC_STACK (SELF &
                                & , REGISTRY &
                                & , YDCPG_OPTS &
                                &, YDSTACK &
                           &)
...
!PRINT *, "NEB", YDSTACK%IPTR-70785, YDSTACK%IPTR
  CALL YDSTACK%ALLOC (SELF%NEB, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG], KLBDS=[1, 1])

!PRINT *, "QLI", YDSTACK%IPTR-70785, YDSTACK%IPTR
  CALL YDSTACK%ALLOC (SELF%QLI, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG], KLBDS=[1, 1])

!PRINT *, "QICE", YDSTACK%IPTR-70785, YDSTACK%IPTR
  CALL YDSTACK%ALLOC (SELF%QICE, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG], KLBDS=[1, 1])

!PRINT *, "QRAIN", YDSTACK%IPTR-70785, YDSTACK%IPTR
  CALL YDSTACK%ALLOC (SELF%QRAIN, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG], KLBDS=[1, 1])

!PRINT *, "QSNOW", YDSTACK%IPTR-70785, YDSTACK%IPTR
  CALL YDSTACK%ALLOC (SELF%QSNOW, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG], KLBDS=[1, 1])

!PRINT *, "RH", YDSTACK%IPTR-70785, YDSTACK%IPTR
  CALL YDSTACK%ALLOC (SELF%RH, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG], KLBDS=[1, 1])

!PRINT *, "QS", YDSTACK%IPTR-70785, YDSTACK%IPTR
  CALL YDSTACK%ALLOC (SELF%QS, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA], KLBDS=[1])

!PRINT *, "QSOL", YDSTACK%IPTR-70785, YDSTACK%IPTR
  CALL YDSTACK%ALLOC (SELF%QSOL, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA], KLBDS=[1])

!PRINT *, "DHSF", YDSTACK%IPTR-70785, YDSTACK%IPTR
  CALL YDSTACK%ALLOC (SELF%DHSF, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA], KLBDS=[1])

!PRINT *, "CLCT", YDSTACK%IPTR-70785, YDSTACK%IPTR
  CALL YDSTACK%ALLOC (SELF%CLCT, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA], KLBDS=[1])

!PRINT *, "LSM", YDSTACK%IPTR-70785, YDSTACK%IPTR
  CALL YDSTACK%ALLOC (SELF%LSM, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA], KLBDS=[1])

!PRINT *, "TSOL", YDSTACK%IPTR-70785, YDSTACK%IPTR
  CALL YDSTACK%ALLOC (SELF%TSOL, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA], KLBDS=[1])

!PRINT *, "FTCNS", YDSTACK%IPTR-70785, YDSTACK%IPTR
  CALL YDSTACK%ALLOC (SELF%FTCNS, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG, 6], KLBDS=[1, 0, 1])

!PRINT *, "KOZO", YDSTACK%IPTR-70785, YDSTACK%IPTR
  CALL YDSTACK%ALLOC (SELF%KOZO, KUBDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KVCLIS], KLBDS=[1, 0, 1])


END SUBROUTINE CPG_MISC_TYPE_ALLOC_STACK

SUBROUTINE CPG_MISC_TYPE_UPDATE_VIEW_STACK (SELF, BLOCK_INDEX)

CLASS (CPG_MISC_TYPE)                    :: SELF
INTEGER (KIND=JPIM), INTENT (IN)    :: BLOCK_INDEX


END SUBROUTINE CPG_MISC_TYPE_UPDATE_VIEW_STACK

INTEGER (KIND=JPIB) FUNCTION CPG_MISC_TYPE_SIZE_STACK (SELF)

CLASS (CPG_MISC_TYPE)         :: SELF

CPG_MISC_TYPE_SIZE_STACK = SELF%ISIZE

END FUNCTION CPG_MISC_TYPE_SIZE_STACK
...
SUBROUTINE CPG_SL1_TYPE_INIT_STACK (SELF, REGISTRY, NLEV, YDTPTRSLB1 &
                                & , YDMODEL &
                                & , YGFL &
                                & , PB1) 
...
SELF%ISIZE = MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * YDTPTRSLB1%NFLDSLB1 * INT (KIND (PB1), JPIB))

END SUBROUTINE CPG_SL1_TYPE_INIT_STACK
...
SUBROUTINE CPG_SL1_TYPE_UPDATE_VIEW_STACK (SELF, BLOCK_INDEX, REGISTRY, NLEV, YDTPTRSLB1 &
                                & , YDMODEL &
                                & , YGFL &
                                & , PB1)
...
IF (PRESENT (PB1)) THEN
  ...
  JFLD = YDTPTRSLB1%MSLB1U9
  IF (YDTPTRSLB1%MSLB1U9 > 0) THEN
    SELF%U9 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%U9 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1V9
  IF (YDTPTRSLB1%MSLB1V9 > 0) THEN
    SELF%V9 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%V9 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1T9
  IF (YDTPTRSLB1%MSLB1T9 > 0) THEN
    SELF%T9 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%T9 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1PD9
  IF (YDTPTRSLB1%MSLB1PD9 > 0) THEN
    SELF%PD9 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%PD9 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1VD9
  IF (YDTPTRSLB1%MSLB1VD9 > 0) THEN
    SELF%VD9 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%VD9 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1NHX9
  IF (YDTPTRSLB1%MSLB1NHX9 > 0) THEN
    SELF%NHX9 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%NHX9 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1UR0
  IF (YDTPTRSLB1%MSLB1UR0 > 0) THEN
    SELF%UR0 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%UR0 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1VR0
  IF (YDTPTRSLB1%MSLB1VR0 > 0) THEN
    SELF%VR0 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%VR0 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1ZR0
  IF (YDTPTRSLB1%MSLB1ZR0 > 0) THEN
    SELF%ZR0 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%ZR0 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1WR0
  IF (YDTPTRSLB1%MSLB1WR0 > 0) THEN
    SELF%WR0 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%WR0 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1UR00
  IF (YDTPTRSLB1%MSLB1UR00 > 0) THEN
    SELF%UR00 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%UR00 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1VR00
  IF (YDTPTRSLB1%MSLB1VR00 > 0) THEN
    SELF%VR00 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%VR00 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1ZR00
  IF (YDTPTRSLB1%MSLB1ZR00 > 0) THEN
    SELF%ZR00 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%ZR00 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1WR00
  IF (YDTPTRSLB1%MSLB1WR00 > 0) THEN
    SELF%WR00 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%WR00 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1WRA
  IF (YDTPTRSLB1%MSLB1WRA > 0) THEN
    SELF%WRA (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%WRA (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1UR9
  IF (YDTPTRSLB1%MSLB1UR9 > 0) THEN
    SELF%UR9 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%UR9 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1VR9
  IF (YDTPTRSLB1%MSLB1VR9 > 0) THEN
    SELF%VR9 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%VR9 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1DBBC9
  IF (YDTPTRSLB1%MSLB1DBBC9 > 0) THEN
    SELF%DBBC9 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%DBBC9 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1DPHI9
  IF (YDTPTRSLB1%MSLB1DPHI9 > 0) THEN
    SELF%DPHI9 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%DPHI9 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1GWS9
  IF (YDTPTRSLB1%MSLB1GWS9 > 0) THEN
    SELF%GWS9          => SELF%ZDATA (:, JFLD, BLOCK_INDEX)
  ELSE
    SELF%GWS9          => ZDUM1
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1U0
  IF (YDTPTRSLB1%MSLB1U0 > 0) THEN
    SELF%U0 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%U0 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1V0
  IF (YDTPTRSLB1%MSLB1V0 > 0) THEN
    SELF%V0 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%V0 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1T0
  IF (YDTPTRSLB1%MSLB1T0 > 0) THEN
    SELF%T0 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%T0 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1PD0
  IF (YDTPTRSLB1%MSLB1PD0 > 0) THEN
    SELF%PD0 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%PD0 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1VD0
  IF (YDTPTRSLB1%MSLB1VD0 > 0) THEN
    SELF%VD0 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%VD0 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1C9
  IF (YDTPTRSLB1%MSLB1C9 > 0) THEN
    SELF%C9 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%C9 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1SP9
  IF (YDTPTRSLB1%MSLB1SP9 > 0) THEN
    SELF%SP9          => SELF%ZDATA (:, JFLD, BLOCK_INDEX)
  ELSE
    SELF%SP9          => ZDUM1
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1SP0
  IF (YDTPTRSLB1%MSLB1SP0 > 0) THEN
    SELF%SP0          => SELF%ZDATA (:, JFLD, BLOCK_INDEX)
  ELSE
    SELF%SP0          => ZDUM1
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1C0
  IF (YDTPTRSLB1%MSLB1C0 > 0) THEN
    SELF%C0 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%C0 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1UP9
  IF (YDTPTRSLB1%MSLB1UP9 > 0) THEN
    SELF%UP9 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%UP9 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1VP9
  IF (YDTPTRSLB1%MSLB1VP9 > 0) THEN
    SELF%VP9 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%VP9 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1TP9
  IF (YDTPTRSLB1%MSLB1TP9 > 0) THEN
    SELF%TP9 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%TP9 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1U9_SI
  IF (YDTPTRSLB1%MSLB1U9_SI > 0) THEN
    SELF%U9_SI (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%U9_SI (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1V9_SI
  IF (YDTPTRSLB1%MSLB1V9_SI > 0) THEN
    SELF%V9_SI (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%V9_SI (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1T9_SI
  IF (YDTPTRSLB1%MSLB1T9_SI > 0) THEN
    SELF%T9_SI (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%T9_SI (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1PD9_SI
  IF (YDTPTRSLB1%MSLB1PD9_SI > 0) THEN
    SELF%PD9_SI (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%PD9_SI (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1VD9_SI
  IF (YDTPTRSLB1%MSLB1VD9_SI > 0) THEN
    SELF%VD9_SI (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%VD9_SI (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1C9_SI
  IF (YDTPTRSLB1%MSLB1C9_SI > 0) THEN
    SELF%C9_SI (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%C9_SI (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1UF9
  IF (YDTPTRSLB1%MSLB1UF9 > 0) THEN
    SELF%UF9 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%UF9 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1VF9
  IF (YDTPTRSLB1%MSLB1VF9 > 0) THEN
    SELF%VF9 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%VF9 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1TF9
  IF (YDTPTRSLB1%MSLB1TF9 > 0) THEN
    SELF%TF9 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%TF9 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1VDF9
  IF (YDTPTRSLB1%MSLB1VDF9 > 0) THEN
    SELF%VDF9 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%VDF9 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1U9_NL
  IF (YDTPTRSLB1%MSLB1U9_NL > 0) THEN
    SELF%U9_NL (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%U9_NL (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1V9_NL
  IF (YDTPTRSLB1%MSLB1V9_NL > 0) THEN
    SELF%V9_NL (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%V9_NL (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1T9_NL
  IF (YDTPTRSLB1%MSLB1T9_NL > 0) THEN
    SELF%T9_NL (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%T9_NL (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1PD9_NL
  IF (YDTPTRSLB1%MSLB1PD9_NL > 0) THEN
    SELF%PD9_NL (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%PD9_NL (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1VD9_NL
  IF (YDTPTRSLB1%MSLB1VD9_NL > 0) THEN
    SELF%VD9_NL (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%VD9_NL (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1C9_NL
  IF (YDTPTRSLB1%MSLB1C9_NL > 0) THEN
    SELF%C9_NL (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%C9_NL (1:, 0:) => ZDUM2
  ENDIF

  IF (YGFL%YQ%MP_SL1 > 0 .AND. YGFL%YQ%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YQ%MP_SL1-1)*(SELF%NLEV+2)
    SELF%Q => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%Q => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
    IF (YGFL%YQ%MP_SL1 > 0 .AND. YGFL%YQ%MP1 > 0) THEN
      JFLD = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YQ%MP_SL1-1)*(SELF%NLEV+2)
      SELF%Q_F => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
    ELSE
      SELF%Q_F => ZDUM2
    ENDIF
  ENDIF
  IF (YGFL%YI%MP_SL1 > 0 .AND. YGFL%YI%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YI%MP_SL1-1)*(SELF%NLEV+2)
    SELF%I => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%I => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
    IF (YGFL%YI%MP_SL1 > 0 .AND. YGFL%YI%MP1 > 0) THEN
      JFLD = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YI%MP_SL1-1)*(SELF%NLEV+2)
      SELF%I_F => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
    ELSE
      SELF%I_F => ZDUM2
    ENDIF
  ENDIF
  IF (YGFL%YL%MP_SL1 > 0 .AND. YGFL%YL%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YL%MP_SL1-1)*(SELF%NLEV+2)
    SELF%L => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%L => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
    IF (YGFL%YL%MP_SL1 > 0 .AND. YGFL%YL%MP1 > 0) THEN
      JFLD = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YL%MP_SL1-1)*(SELF%NLEV+2)
      SELF%L_F => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
    ELSE
      SELF%L_F => ZDUM2
    ENDIF
  ENDIF
  IF (YGFL%YLCONV%MP_SL1 > 0 .AND. YGFL%YLCONV%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YLCONV%MP_SL1-1)*(SELF%NLEV+2)
    SELF%LCONV => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%LCONV => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
    IF (YGFL%YLCONV%MP_SL1 > 0 .AND. YGFL%YLCONV%MP1 > 0) THEN
      JFLD = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YLCONV%MP_SL1-1)*(SELF%NLEV+2)
      SELF%LCONV_F => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
    ELSE
      SELF%LCONV_F => ZDUM2
    ENDIF
  ENDIF
  IF (YGFL%YICONV%MP_SL1 > 0 .AND. YGFL%YICONV%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YICONV%MP_SL1-1)*(SELF%NLEV+2)
    SELF%ICONV => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%ICONV => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
    IF (YGFL%YICONV%MP_SL1 > 0 .AND. YGFL%YICONV%MP1 > 0) THEN
      JFLD = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YICONV%MP_SL1-1)*(SELF%NLEV+2)
      SELF%ICONV_F => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
    ELSE
      SELF%ICONV_F => ZDUM2
    ENDIF
  ENDIF
  IF (YGFL%YRCONV%MP_SL1 > 0 .AND. YGFL%YRCONV%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YRCONV%MP_SL1-1)*(SELF%NLEV+2)
    SELF%RCONV => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%RCONV => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
    IF (YGFL%YRCONV%MP_SL1 > 0 .AND. YGFL%YRCONV%MP1 > 0) THEN
      JFLD = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YRCONV%MP_SL1-1)*(SELF%NLEV+2)
      SELF%RCONV_F => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
    ELSE
      SELF%RCONV_F => ZDUM2
    ENDIF
  ENDIF
  IF (YGFL%YSCONV%MP_SL1 > 0 .AND. YGFL%YSCONV%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YSCONV%MP_SL1-1)*(SELF%NLEV+2)
    SELF%SCONV => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%SCONV => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
    IF (YGFL%YSCONV%MP_SL1 > 0 .AND. YGFL%YSCONV%MP1 > 0) THEN
      JFLD = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YSCONV%MP_SL1-1)*(SELF%NLEV+2)
      SELF%SCONV_F => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
    ELSE
      SELF%SCONV_F => ZDUM2
    ENDIF
  ENDIF
  IF (YGFL%YIRAD%MP_SL1 > 0 .AND. YGFL%YIRAD%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YIRAD%MP_SL1-1)*(SELF%NLEV+2)
    SELF%IRAD => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%IRAD => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
    IF (YGFL%YIRAD%MP_SL1 > 0 .AND. YGFL%YIRAD%MP1 > 0) THEN
      JFLD = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YIRAD%MP_SL1-1)*(SELF%NLEV+2)
      SELF%IRAD_F => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
    ELSE
      SELF%IRAD_F => ZDUM2
    ENDIF
  ENDIF
  IF (YGFL%YLRAD%MP_SL1 > 0 .AND. YGFL%YLRAD%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YLRAD%MP_SL1-1)*(SELF%NLEV+2)
    SELF%LRAD => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%LRAD => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
    IF (YGFL%YLRAD%MP_SL1 > 0 .AND. YGFL%YLRAD%MP1 > 0) THEN
      JFLD = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YLRAD%MP_SL1-1)*(SELF%NLEV+2)
      SELF%LRAD_F => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
    ELSE
      SELF%LRAD_F => ZDUM2
    ENDIF
  ENDIF
  IF (YGFL%YS%MP_SL1 > 0 .AND. YGFL%YS%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YS%MP_SL1-1)*(SELF%NLEV+2)
    SELF%S => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%S => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
    IF (YGFL%YS%MP_SL1 > 0 .AND. YGFL%YS%MP1 > 0) THEN
      JFLD = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YS%MP_SL1-1)*(SELF%NLEV+2)
      SELF%S_F => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
    ELSE
      SELF%S_F => ZDUM2
    ENDIF
  ENDIF
  IF (YGFL%YR%MP_SL1 > 0 .AND. YGFL%YR%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YR%MP_SL1-1)*(SELF%NLEV+2)
    SELF%R => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%R => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
    IF (YGFL%YR%MP_SL1 > 0 .AND. YGFL%YR%MP1 > 0) THEN
      JFLD = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YR%MP_SL1-1)*(SELF%NLEV+2)
      SELF%R_F => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
    ELSE
      SELF%R_F => ZDUM2
    ENDIF
  ENDIF
  IF (YGFL%YG%MP_SL1 > 0 .AND. YGFL%YG%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YG%MP_SL1-1)*(SELF%NLEV+2)
    SELF%G => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%G => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
    IF (YGFL%YG%MP_SL1 > 0 .AND. YGFL%YG%MP1 > 0) THEN
      JFLD = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YG%MP_SL1-1)*(SELF%NLEV+2)
      SELF%G_F => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
    ELSE
      SELF%G_F => ZDUM2
    ENDIF
  ENDIF
  IF (YGFL%YH%MP_SL1 > 0 .AND. YGFL%YH%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YH%MP_SL1-1)*(SELF%NLEV+2)
    SELF%H => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%H => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
    IF (YGFL%YH%MP_SL1 > 0 .AND. YGFL%YH%MP1 > 0) THEN
      JFLD = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YH%MP_SL1-1)*(SELF%NLEV+2)
      SELF%H_F => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
    ELSE
      SELF%H_F => ZDUM2
    ENDIF
  ENDIF
  IF (YGFL%YTKE%MP_SL1 > 0 .AND. YGFL%YTKE%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YTKE%MP_SL1-1)*(SELF%NLEV+2)
    SELF%TKE => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%TKE => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
    IF (YGFL%YTKE%MP_SL1 > 0 .AND. YGFL%YTKE%MP1 > 0) THEN
      JFLD = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YTKE%MP_SL1-1)*(SELF%NLEV+2)
      SELF%TKE_F => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
    ELSE
      SELF%TKE_F => ZDUM2
    ENDIF
  ENDIF
  IF (YGFL%YTTE%MP_SL1 > 0 .AND. YGFL%YTTE%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YTTE%MP_SL1-1)*(SELF%NLEV+2)
    SELF%TTE => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%TTE => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
    IF (YGFL%YTTE%MP_SL1 > 0 .AND. YGFL%YTTE%MP1 > 0) THEN
      JFLD = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YTTE%MP_SL1-1)*(SELF%NLEV+2)
      SELF%TTE_F => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
    ELSE
      SELF%TTE_F => ZDUM2
    ENDIF
  ENDIF
  IF (YGFL%YEFB1%MP_SL1 > 0 .AND. YGFL%YEFB1%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YEFB1%MP_SL1-1)*(SELF%NLEV+2)
    SELF%EFB1 => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%EFB1 => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
    IF (YGFL%YEFB1%MP_SL1 > 0 .AND. YGFL%YEFB1%MP1 > 0) THEN
      JFLD = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YEFB1%MP_SL1-1)*(SELF%NLEV+2)
      SELF%EFB1_F => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
    ELSE
      SELF%EFB1_F => ZDUM2
    ENDIF
  ENDIF
  IF (YGFL%YEFB2%MP_SL1 > 0 .AND. YGFL%YEFB2%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YEFB2%MP_SL1-1)*(SELF%NLEV+2)
    SELF%EFB2 => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%EFB2 => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
    IF (YGFL%YEFB2%MP_SL1 > 0 .AND. YGFL%YEFB2%MP1 > 0) THEN
      JFLD = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YEFB2%MP_SL1-1)*(SELF%NLEV+2)
      SELF%EFB2_F => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
    ELSE
      SELF%EFB2_F => ZDUM2
    ENDIF
  ENDIF
  IF (YGFL%YEFB3%MP_SL1 > 0 .AND. YGFL%YEFB3%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YEFB3%MP_SL1-1)*(SELF%NLEV+2)
    SELF%EFB3 => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%EFB3 => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
    IF (YGFL%YEFB3%MP_SL1 > 0 .AND. YGFL%YEFB3%MP1 > 0) THEN
      JFLD = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YEFB3%MP_SL1-1)*(SELF%NLEV+2)
      SELF%EFB3_F => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
    ELSE
      SELF%EFB3_F => ZDUM2
    ENDIF
  ENDIF
  IF (YGFL%YA%MP_SL1 > 0 .AND. YGFL%YA%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YA%MP_SL1-1)*(SELF%NLEV+2)
    SELF%A => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%A => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
    IF (YGFL%YA%MP_SL1 > 0 .AND. YGFL%YA%MP1 > 0) THEN
      JFLD = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YA%MP_SL1-1)*(SELF%NLEV+2)
      SELF%A_F => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
    ELSE
      SELF%A_F => ZDUM2
    ENDIF
  ENDIF
  IF (YGFL%YO3%MP_SL1 > 0 .AND. YGFL%YO3%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YO3%MP_SL1-1)*(SELF%NLEV+2)
    SELF%O3 => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%O3 => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
    IF (YGFL%YO3%MP_SL1 > 0 .AND. YGFL%YO3%MP1 > 0) THEN
      JFLD = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YO3%MP_SL1-1)*(SELF%NLEV+2)
      SELF%O3_F => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
    ELSE
      SELF%O3_F => ZDUM2
    ENDIF
  ENDIF
  IF (YGFL%YSRC%MP_SL1 > 0 .AND. YGFL%YSRC%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YSRC%MP_SL1-1)*(SELF%NLEV+2)
    SELF%SRC => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%SRC => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
    IF (YGFL%YSRC%MP_SL1 > 0 .AND. YGFL%YSRC%MP1 > 0) THEN
      JFLD = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YSRC%MP_SL1-1)*(SELF%NLEV+2)
      SELF%SRC_F => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
    ELSE
      SELF%SRC_F => ZDUM2
    ENDIF
  ENDIF
  IF (YGFL%YMXL%MP_SL1 > 0 .AND. YGFL%YMXL%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YMXL%MP_SL1-1)*(SELF%NLEV+2)
    SELF%MXL => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%MXL => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
    IF (YGFL%YMXL%MP_SL1 > 0 .AND. YGFL%YMXL%MP1 > 0) THEN
      JFLD = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YMXL%MP_SL1-1)*(SELF%NLEV+2)
      SELF%MXL_F => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
    ELSE
      SELF%MXL_F => ZDUM2
    ENDIF
  ENDIF
  IF (YGFL%YSHTUR%MP_SL1 > 0 .AND. YGFL%YSHTUR%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YSHTUR%MP_SL1-1)*(SELF%NLEV+2)
    SELF%SHTUR => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%SHTUR => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
    IF (YGFL%YSHTUR%MP_SL1 > 0 .AND. YGFL%YSHTUR%MP1 > 0) THEN
      JFLD = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YSHTUR%MP_SL1-1)*(SELF%NLEV+2)
      SELF%SHTUR_F => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
    ELSE
      SELF%SHTUR_F => ZDUM2
    ENDIF
  ENDIF
  IF (YGFL%YFQTUR%MP_SL1 > 0 .AND. YGFL%YFQTUR%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YFQTUR%MP_SL1-1)*(SELF%NLEV+2)
    SELF%FQTUR => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%FQTUR => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
    IF (YGFL%YFQTUR%MP_SL1 > 0 .AND. YGFL%YFQTUR%MP1 > 0) THEN
      JFLD = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YFQTUR%MP_SL1-1)*(SELF%NLEV+2)
      SELF%FQTUR_F => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
    ELSE
      SELF%FQTUR_F => ZDUM2
    ENDIF
  ENDIF
  IF (YGFL%YFSTUR%MP_SL1 > 0 .AND. YGFL%YFSTUR%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YFSTUR%MP_SL1-1)*(SELF%NLEV+2)
    SELF%FSTUR => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%FSTUR => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
    IF (YGFL%YFSTUR%MP_SL1 > 0 .AND. YGFL%YFSTUR%MP1 > 0) THEN
      JFLD = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YFSTUR%MP_SL1-1)*(SELF%NLEV+2)
      SELF%FSTUR_F => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
    ELSE
      SELF%FSTUR_F => ZDUM2
    ENDIF
  ENDIF
  IF (YGFL%YCPF%MP_SL1 > 0 .AND. YGFL%YCPF%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YCPF%MP_SL1-1)*(SELF%NLEV+2)
    SELF%CPF => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%CPF => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
    IF (YGFL%YCPF%MP_SL1 > 0 .AND. YGFL%YCPF%MP1 > 0) THEN
      JFLD = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YCPF%MP_SL1-1)*(SELF%NLEV+2)
      SELF%CPF_F => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
    ELSE
      SELF%CPF_F => ZDUM2
    ENDIF
  ENDIF
  IF (YGFL%YSPF%MP_SL1 > 0 .AND. YGFL%YSPF%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YSPF%MP_SL1-1)*(SELF%NLEV+2)
    SELF%SPF => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%SPF => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
    IF (YGFL%YSPF%MP_SL1 > 0 .AND. YGFL%YSPF%MP1 > 0) THEN
      JFLD = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YSPF%MP_SL1-1)*(SELF%NLEV+2)
      SELF%SPF_F => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
    ELSE
      SELF%SPF_F => ZDUM2
    ENDIF
  ENDIF
  IF (YGFL%YCVGQ%MP_SL1 > 0 .AND. YGFL%YCVGQ%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YCVGQ%MP_SL1-1)*(SELF%NLEV+2)
    SELF%CVGQ => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%CVGQ => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
    IF (YGFL%YCVGQ%MP_SL1 > 0 .AND. YGFL%YCVGQ%MP1 > 0) THEN
      JFLD = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YCVGQ%MP_SL1-1)*(SELF%NLEV+2)
      SELF%CVGQ_F => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
    ELSE
      SELF%CVGQ_F => ZDUM2
    ENDIF
  ENDIF
  IF (YGFL%YQVA%MP_SL1 > 0 .AND. YGFL%YQVA%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YQVA%MP_SL1-1)*(SELF%NLEV+2)
    SELF%QVA => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%QVA => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
    IF (YGFL%YQVA%MP_SL1 > 0 .AND. YGFL%YQVA%MP1 > 0) THEN
      JFLD = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YQVA%MP_SL1-1)*(SELF%NLEV+2)
      SELF%QVA_F => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
    ELSE
      SELF%QVA_F => ZDUM2
    ENDIF
  ENDIF
  IF (YGFL%YLRCH4%MP_SL1 > 0 .AND. YGFL%YLRCH4%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YLRCH4%MP_SL1-1)*(SELF%NLEV+2)
    SELF%LRCH4 => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%LRCH4 => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
    IF (YGFL%YLRCH4%MP_SL1 > 0 .AND. YGFL%YLRCH4%MP1 > 0) THEN
      JFLD = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YLRCH4%MP_SL1-1)*(SELF%NLEV+2)
      SELF%LRCH4_F => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
    ELSE
      SELF%LRCH4_F => ZDUM2
    ENDIF
  ENDIF
  IF (YGFL%YPHYCTY%MP_SL1 > 0 .AND. YGFL%YPHYCTY%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YPHYCTY%MP_SL1-1)*(SELF%NLEV+2)
    SELF%PHYCTY => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%PHYCTY => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
    IF (YGFL%YPHYCTY%MP_SL1 > 0 .AND. YGFL%YPHYCTY%MP1 > 0) THEN
      JFLD = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YPHYCTY%MP_SL1-1)*(SELF%NLEV+2)
      SELF%PHYCTY_F => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
    ELSE
      SELF%PHYCTY_F => ZDUM2
    ENDIF
  ENDIF
  IF (YGFL%YRSPEC%MP_SL1 > 0 .AND. YGFL%YRSPEC%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YRSPEC%MP_SL1-1)*(SELF%NLEV+2)
    SELF%RSPEC => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%RSPEC => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
    IF (YGFL%YRSPEC%MP_SL1 > 0 .AND. YGFL%YRSPEC%MP1 > 0) THEN
      JFLD = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YRSPEC%MP_SL1-1)*(SELF%NLEV+2)
      SELF%RSPEC_F => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
    ELSE
      SELF%RSPEC_F => ZDUM2
    ENDIF
  ENDIF
  IF (YGFL%YSDSAT%MP_SL1 > 0 .AND. YGFL%YSDSAT%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YSDSAT%MP_SL1-1)*(SELF%NLEV+2)
    SELF%SDSAT => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%SDSAT => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
    IF (YGFL%YSDSAT%MP_SL1 > 0 .AND. YGFL%YSDSAT%MP1 > 0) THEN
      JFLD = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YSDSAT%MP_SL1-1)*(SELF%NLEV+2)
      SELF%SDSAT_F => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
    ELSE
      SELF%SDSAT_F => ZDUM2
    ENDIF
  ENDIF
  IF (YGFL%YCVV%MP_SL1 > 0 .AND. YGFL%YCVV%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YCVV%MP_SL1-1)*(SELF%NLEV+2)
    SELF%CVV => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%CVV => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
    IF (YGFL%YCVV%MP_SL1 > 0 .AND. YGFL%YCVV%MP1 > 0) THEN
      JFLD = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YCVV%MP_SL1-1)*(SELF%NLEV+2)
      SELF%CVV_F => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
    ELSE
      SELF%CVV_F => ZDUM2
    ENDIF
  ENDIF
  IF (YGFL%YRKTH%MP_SL1 > 0 .AND. YGFL%YRKTH%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YRKTH%MP_SL1-1)*(SELF%NLEV+2)
    SELF%RKTH => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%RKTH => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
    IF (YGFL%YRKTH%MP_SL1 > 0 .AND. YGFL%YRKTH%MP1 > 0) THEN
      JFLD = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YRKTH%MP_SL1-1)*(SELF%NLEV+2)
      SELF%RKTH_F => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
    ELSE
      SELF%RKTH_F => ZDUM2
    ENDIF
  ENDIF
  IF (YGFL%YRKTQV%MP_SL1 > 0 .AND. YGFL%YRKTQV%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YRKTQV%MP_SL1-1)*(SELF%NLEV+2)
    SELF%RKTQV => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%RKTQV => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
    IF (YGFL%YRKTQV%MP_SL1 > 0 .AND. YGFL%YRKTQV%MP1 > 0) THEN
      JFLD = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YRKTQV%MP_SL1-1)*(SELF%NLEV+2)
      SELF%RKTQV_F => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
    ELSE
      SELF%RKTQV_F => ZDUM2
    ENDIF
  ENDIF
  IF (YGFL%YRKTQC%MP_SL1 > 0 .AND. YGFL%YRKTQC%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YRKTQC%MP_SL1-1)*(SELF%NLEV+2)
    SELF%RKTQC => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%RKTQC => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
    IF (YGFL%YRKTQC%MP_SL1 > 0 .AND. YGFL%YRKTQC%MP1 > 0) THEN
      JFLD = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YRKTQC%MP_SL1-1)*(SELF%NLEV+2)
      SELF%RKTQC_F => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
    ELSE
      SELF%RKTQC_F => ZDUM2
    ENDIF
  ENDIF
  IF (YGFL%YUOM%MP_SL1 > 0 .AND. YGFL%YUOM%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YUOM%MP_SL1-1)*(SELF%NLEV+2)
    SELF%UOM => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%UOM => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
    IF (YGFL%YUOM%MP_SL1 > 0 .AND. YGFL%YUOM%MP1 > 0) THEN
      JFLD = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YUOM%MP_SL1-1)*(SELF%NLEV+2)
      SELF%UOM_F => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
    ELSE
      SELF%UOM_F => ZDUM2
    ENDIF
  ENDIF
  IF (YGFL%YUAL%MP_SL1 > 0 .AND. YGFL%YUAL%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YUAL%MP_SL1-1)*(SELF%NLEV+2)
    SELF%UAL => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%UAL => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
    IF (YGFL%YUAL%MP_SL1 > 0 .AND. YGFL%YUAL%MP1 > 0) THEN
      JFLD = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YUAL%MP_SL1-1)*(SELF%NLEV+2)
      SELF%UAL_F => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
    ELSE
      SELF%UAL_F => ZDUM2
    ENDIF
  ENDIF
  IF (YGFL%YDOM%MP_SL1 > 0 .AND. YGFL%YDOM%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YDOM%MP_SL1-1)*(SELF%NLEV+2)
    SELF%DOM => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%DOM => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
    IF (YGFL%YDOM%MP_SL1 > 0 .AND. YGFL%YDOM%MP1 > 0) THEN
      JFLD = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YDOM%MP_SL1-1)*(SELF%NLEV+2)
      SELF%DOM_F => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
    ELSE
      SELF%DOM_F => ZDUM2
    ENDIF
  ENDIF
  IF (YGFL%YDAL%MP_SL1 > 0 .AND. YGFL%YDAL%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YDAL%MP_SL1-1)*(SELF%NLEV+2)
    SELF%DAL => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%DAL => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
    IF (YGFL%YDAL%MP_SL1 > 0 .AND. YGFL%YDAL%MP1 > 0) THEN
      JFLD = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YDAL%MP_SL1-1)*(SELF%NLEV+2)
      SELF%DAL_F => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
    ELSE
      SELF%DAL_F => ZDUM2
    ENDIF
  ENDIF
  IF (YGFL%YUEN%MP_SL1 > 0 .AND. YGFL%YUEN%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YUEN%MP_SL1-1)*(SELF%NLEV+2)
    SELF%UEN => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%UEN => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
    IF (YGFL%YUEN%MP_SL1 > 0 .AND. YGFL%YUEN%MP1 > 0) THEN
      JFLD = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YUEN%MP_SL1-1)*(SELF%NLEV+2)
      SELF%UEN_F => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
    ELSE
      SELF%UEN_F => ZDUM2
    ENDIF
  ENDIF
  IF (YGFL%YUNEBH%MP_SL1 > 0 .AND. YGFL%YUNEBH%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YUNEBH%MP_SL1-1)*(SELF%NLEV+2)
    SELF%UNEBH => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%UNEBH => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
    IF (YGFL%YUNEBH%MP_SL1 > 0 .AND. YGFL%YUNEBH%MP1 > 0) THEN
      JFLD = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YUNEBH%MP_SL1-1)*(SELF%NLEV+2)
      SELF%UNEBH_F => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
    ELSE
      SELF%UNEBH_F => ZDUM2
    ENDIF
  ENDIF
  IF (YGFL%YFSD%MP_SL1 > 0 .AND. YGFL%YFSD%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YFSD%MP_SL1-1)*(SELF%NLEV+2)
    SELF%FSD => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%FSD => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
    IF (YGFL%YFSD%MP_SL1 > 0 .AND. YGFL%YFSD%MP1 > 0) THEN
      JFLD = YDTPTRSLB1%MSLB1GFLF9 + (YGFL%YFSD%MP_SL1-1)*(SELF%NLEV+2)
      SELF%FSD_F => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
    ELSE
      SELF%FSD_F => ZDUM2
    ENDIF
  ENDIF
...
END SUBROUTINE CPG_SL1_TYPE_UPDATE_VIEW_STACK

INTEGER (KIND=JPIB) FUNCTION CPG_SL1_TYPE_SIZE_STACK (SELF)

CLASS (CPG_SL1_TYPE) :: SELF

CPG_SL1_TYPE_SIZE_STACK = SELF%ISIZE

END FUNCTION

SUBROUTINE CPG_SL1_TYPE_ALLOC_STACK (SELF, REGISTRY, NLEV, YDTPTRSLB1 &
                                & , YDMODEL &
                                & , YGFL &
                                & , PB1 &
                                & , YDSTACK)
...
IF (.NOT. PRESENT (PB1)) THEN

  CALL YDSTACK%ALLOC (SELF%ZDATA, [REGISTRY%GEOM%YRDIM%NPROMA, YDTPTRSLB1%NFLDSLB1, 1])
  SELF%ZVIEW => SELF%ZDATA (:,:,1)

  JFLD = YDTPTRSLB1%MSLB1U9
  IF (YDTPTRSLB1%MSLB1U9 > 0) THEN
    SELF%U9 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%U9 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1V9
  IF (YDTPTRSLB1%MSLB1V9 > 0) THEN
    SELF%V9 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%V9 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1T9
  IF (YDTPTRSLB1%MSLB1T9 > 0) THEN
    SELF%T9 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%T9 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1PD9
  IF (YDTPTRSLB1%MSLB1PD9 > 0) THEN
    SELF%PD9 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%PD9 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1VD9
  IF (YDTPTRSLB1%MSLB1VD9 > 0) THEN
    SELF%VD9 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%VD9 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1NHX9
  IF (YDTPTRSLB1%MSLB1NHX9 > 0) THEN
    SELF%NHX9 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%NHX9 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1UR0
  IF (YDTPTRSLB1%MSLB1UR0 > 0) THEN
    SELF%UR0 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%UR0 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1VR0
  IF (YDTPTRSLB1%MSLB1VR0 > 0) THEN
    SELF%VR0 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%VR0 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1ZR0
  IF (YDTPTRSLB1%MSLB1ZR0 > 0) THEN
    SELF%ZR0 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%ZR0 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1WR0
  IF (YDTPTRSLB1%MSLB1WR0 > 0) THEN
    SELF%WR0 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%WR0 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1UR00
  IF (YDTPTRSLB1%MSLB1UR00 > 0) THEN
    SELF%UR00 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%UR00 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1VR00
  IF (YDTPTRSLB1%MSLB1VR00 > 0) THEN
    SELF%VR00 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%VR00 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1ZR00
  IF (YDTPTRSLB1%MSLB1ZR00 > 0) THEN
    SELF%ZR00 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%ZR00 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1WR00
  IF (YDTPTRSLB1%MSLB1WR00 > 0) THEN
    SELF%WR00 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%WR00 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1WRA
  IF (YDTPTRSLB1%MSLB1WRA > 0) THEN
    SELF%WRA (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%WRA (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1UR9
  IF (YDTPTRSLB1%MSLB1UR9 > 0) THEN
    SELF%UR9 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%UR9 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1VR9
  IF (YDTPTRSLB1%MSLB1VR9 > 0) THEN
    SELF%VR9 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%VR9 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1DBBC9
  IF (YDTPTRSLB1%MSLB1DBBC9 > 0) THEN
    SELF%DBBC9 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%DBBC9 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1DPHI9
  IF (YDTPTRSLB1%MSLB1DPHI9 > 0) THEN
    SELF%DPHI9 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%DPHI9 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1GWS9
  IF (YDTPTRSLB1%MSLB1GWS9 > 0) THEN
    SELF%GWS9          => SELF%ZDATA (:, JFLD,             1)
  ELSE
    SELF%GWS9          => ZDUM1
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1U0
  IF (YDTPTRSLB1%MSLB1U0 > 0) THEN
    SELF%U0 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%U0 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1V0
  IF (YDTPTRSLB1%MSLB1V0 > 0) THEN
    SELF%V0 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%V0 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1T0
  IF (YDTPTRSLB1%MSLB1T0 > 0) THEN
    SELF%T0 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%T0 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1PD0
  IF (YDTPTRSLB1%MSLB1PD0 > 0) THEN
    SELF%PD0 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%PD0 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1VD0
  IF (YDTPTRSLB1%MSLB1VD0 > 0) THEN
    SELF%VD0 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%VD0 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1C9
  IF (YDTPTRSLB1%MSLB1C9 > 0) THEN
    SELF%C9 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%C9 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1SP9
  IF (YDTPTRSLB1%MSLB1SP9 > 0) THEN
    SELF%SP9          => SELF%ZDATA (:, JFLD,             1)
  ELSE
    SELF%SP9          => ZDUM1
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1SP0
  IF (YDTPTRSLB1%MSLB1SP0 > 0) THEN
    SELF%SP0          => SELF%ZDATA (:, JFLD,             1)
  ELSE
    SELF%SP0          => ZDUM1
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1C0
  IF (YDTPTRSLB1%MSLB1C0 > 0) THEN
    SELF%C0 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%C0 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1UP9
  IF (YDTPTRSLB1%MSLB1UP9 > 0) THEN
    SELF%UP9 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%UP9 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1VP9
  IF (YDTPTRSLB1%MSLB1VP9 > 0) THEN
    SELF%VP9 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%VP9 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1TP9
  IF (YDTPTRSLB1%MSLB1TP9 > 0) THEN
    SELF%TP9 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%TP9 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1U9_SI
  IF (YDTPTRSLB1%MSLB1U9_SI > 0) THEN
    SELF%U9_SI (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%U9_SI (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1V9_SI
  IF (YDTPTRSLB1%MSLB1V9_SI > 0) THEN
    SELF%V9_SI (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%V9_SI (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1T9_SI
  IF (YDTPTRSLB1%MSLB1T9_SI > 0) THEN
    SELF%T9_SI (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%T9_SI (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1PD9_SI
  IF (YDTPTRSLB1%MSLB1PD9_SI > 0) THEN
    SELF%PD9_SI (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%PD9_SI (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1VD9_SI
  IF (YDTPTRSLB1%MSLB1VD9_SI > 0) THEN
    SELF%VD9_SI (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%VD9_SI (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1C9_SI
  IF (YDTPTRSLB1%MSLB1C9_SI > 0) THEN
    SELF%C9_SI (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%C9_SI (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1UF9
  IF (YDTPTRSLB1%MSLB1UF9 > 0) THEN
    SELF%UF9 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%UF9 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1VF9
  IF (YDTPTRSLB1%MSLB1VF9 > 0) THEN
    SELF%VF9 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%VF9 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1TF9
  IF (YDTPTRSLB1%MSLB1TF9 > 0) THEN
    SELF%TF9 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%TF9 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1VDF9
  IF (YDTPTRSLB1%MSLB1VDF9 > 0) THEN
    SELF%VDF9 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%VDF9 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1U9_NL
  IF (YDTPTRSLB1%MSLB1U9_NL > 0) THEN
    SELF%U9_NL (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%U9_NL (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1V9_NL
  IF (YDTPTRSLB1%MSLB1V9_NL > 0) THEN
    SELF%V9_NL (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%V9_NL (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1T9_NL
  IF (YDTPTRSLB1%MSLB1T9_NL > 0) THEN
    SELF%T9_NL (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%T9_NL (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1PD9_NL
  IF (YDTPTRSLB1%MSLB1PD9_NL > 0) THEN
    SELF%PD9_NL (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%PD9_NL (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1VD9_NL
  IF (YDTPTRSLB1%MSLB1VD9_NL > 0) THEN
    SELF%VD9_NL (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%VD9_NL (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB1%MSLB1C9_NL
  IF (YDTPTRSLB1%MSLB1C9_NL > 0) THEN
    SELF%C9_NL (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%C9_NL (1:, 0:) => ZDUM2
  ENDIF
  ...
  IF (YGFL%YQ%MP_SL1 > 0 .AND. YGFL%YQ%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YQ%MP_SL1-1)*(SELF%NLEV+2)
    SELF%Q (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%Q          => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  ...
  IF (YGFL%YI%MP_SL1 > 0 .AND. YGFL%YI%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YI%MP_SL1-1)*(SELF%NLEV+2)
    SELF%I (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%I          => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  ...
  IF (YGFL%YL%MP_SL1 > 0 .AND. YGFL%YL%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YL%MP_SL1-1)*(SELF%NLEV+2)
    SELF%L (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%L          => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  ...
  IF (YGFL%YLCONV%MP_SL1 > 0 .AND. YGFL%YLCONV%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YLCONV%MP_SL1-1)*(SELF%NLEV+2)
    SELF%LCONV (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%LCONV          => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  ...
  IF (YGFL%YICONV%MP_SL1 > 0 .AND. YGFL%YICONV%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YICONV%MP_SL1-1)*(SELF%NLEV+2)
    SELF%ICONV (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%ICONV          => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  ...
  IF (YGFL%YRCONV%MP_SL1 > 0 .AND. YGFL%YRCONV%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YRCONV%MP_SL1-1)*(SELF%NLEV+2)
    SELF%RCONV (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%RCONV          => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  ...
  IF (YGFL%YSCONV%MP_SL1 > 0 .AND. YGFL%YSCONV%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YSCONV%MP_SL1-1)*(SELF%NLEV+2)
    SELF%SCONV (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%SCONV          => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  ...
  IF (YGFL%YIRAD%MP_SL1 > 0 .AND. YGFL%YIRAD%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YIRAD%MP_SL1-1)*(SELF%NLEV+2)
    SELF%IRAD (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%IRAD          => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  ...
  IF (YGFL%YLRAD%MP_SL1 > 0 .AND. YGFL%YLRAD%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YLRAD%MP_SL1-1)*(SELF%NLEV+2)
    SELF%LRAD (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%LRAD          => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  ...
  IF (YGFL%YS%MP_SL1 > 0 .AND. YGFL%YS%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YS%MP_SL1-1)*(SELF%NLEV+2)
    SELF%S (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%S          => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  ...
  IF (YGFL%YR%MP_SL1 > 0 .AND. YGFL%YR%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YR%MP_SL1-1)*(SELF%NLEV+2)
    SELF%R (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%R          => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  ...
  IF (YGFL%YG%MP_SL1 > 0 .AND. YGFL%YG%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YG%MP_SL1-1)*(SELF%NLEV+2)
    SELF%G (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%G          => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  ...
  IF (YGFL%YH%MP_SL1 > 0 .AND. YGFL%YH%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YH%MP_SL1-1)*(SELF%NLEV+2)
    SELF%H (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%H          => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  ...
  IF (YGFL%YTKE%MP_SL1 > 0 .AND. YGFL%YTKE%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YTKE%MP_SL1-1)*(SELF%NLEV+2)
    SELF%TKE (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%TKE          => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  ...
  IF (YGFL%YTTE%MP_SL1 > 0 .AND. YGFL%YTTE%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YTTE%MP_SL1-1)*(SELF%NLEV+2)
    SELF%TTE (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%TTE          => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  ...
  IF (YGFL%YEFB1%MP_SL1 > 0 .AND. YGFL%YEFB1%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YEFB1%MP_SL1-1)*(SELF%NLEV+2)
    SELF%EFB1 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%EFB1          => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  ...
  IF (YGFL%YEFB2%MP_SL1 > 0 .AND. YGFL%YEFB2%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YEFB2%MP_SL1-1)*(SELF%NLEV+2)
    SELF%EFB2 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%EFB2          => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  ...
  IF (YGFL%YEFB3%MP_SL1 > 0 .AND. YGFL%YEFB3%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YEFB3%MP_SL1-1)*(SELF%NLEV+2)
    SELF%EFB3 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%EFB3          => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  ...
  IF (YGFL%YA%MP_SL1 > 0 .AND. YGFL%YA%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YA%MP_SL1-1)*(SELF%NLEV+2)
    SELF%A (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%A          => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  ...
  IF (YGFL%YO3%MP_SL1 > 0 .AND. YGFL%YO3%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YO3%MP_SL1-1)*(SELF%NLEV+2)
    SELF%O3 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%O3          => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  ...
  IF (YGFL%YSRC%MP_SL1 > 0 .AND. YGFL%YSRC%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YSRC%MP_SL1-1)*(SELF%NLEV+2)
    SELF%SRC (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%SRC          => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  ...
  IF (YGFL%YMXL%MP_SL1 > 0 .AND. YGFL%YMXL%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YMXL%MP_SL1-1)*(SELF%NLEV+2)
    SELF%MXL (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%MXL          => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  ...
  IF (YGFL%YSHTUR%MP_SL1 > 0 .AND. YGFL%YSHTUR%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YSHTUR%MP_SL1-1)*(SELF%NLEV+2)
    SELF%SHTUR (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%SHTUR          => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  ...
  IF (YGFL%YFQTUR%MP_SL1 > 0 .AND. YGFL%YFQTUR%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YFQTUR%MP_SL1-1)*(SELF%NLEV+2)
    SELF%FQTUR (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%FQTUR          => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  ...
  IF (YGFL%YFSTUR%MP_SL1 > 0 .AND. YGFL%YFSTUR%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YFSTUR%MP_SL1-1)*(SELF%NLEV+2)
    SELF%FSTUR (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%FSTUR          => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  ...
  IF (YGFL%YCPF%MP_SL1 > 0 .AND. YGFL%YCPF%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YCPF%MP_SL1-1)*(SELF%NLEV+2)
    SELF%CPF (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%CPF          => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  ...
  IF (YGFL%YSPF%MP_SL1 > 0 .AND. YGFL%YSPF%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YSPF%MP_SL1-1)*(SELF%NLEV+2)
    SELF%SPF (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%SPF          => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  ...
  IF (YGFL%YCVGQ%MP_SL1 > 0 .AND. YGFL%YCVGQ%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YCVGQ%MP_SL1-1)*(SELF%NLEV+2)
    SELF%CVGQ (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%CVGQ          => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  ...
  IF (YGFL%YQVA%MP_SL1 > 0 .AND. YGFL%YQVA%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YQVA%MP_SL1-1)*(SELF%NLEV+2)
    SELF%QVA (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%QVA          => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  ...
  IF (YGFL%YLRCH4%MP_SL1 > 0 .AND. YGFL%YLRCH4%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YLRCH4%MP_SL1-1)*(SELF%NLEV+2)
    SELF%LRCH4 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%LRCH4          => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  ...
  IF (YGFL%YPHYCTY%MP_SL1 > 0 .AND. YGFL%YPHYCTY%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YPHYCTY%MP_SL1-1)*(SELF%NLEV+2)
    SELF%PHYCTY (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%PHYCTY          => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  ...
  IF (YGFL%YRSPEC%MP_SL1 > 0 .AND. YGFL%YRSPEC%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YRSPEC%MP_SL1-1)*(SELF%NLEV+2)
    SELF%RSPEC (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%RSPEC          => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  ...
  IF (YGFL%YSDSAT%MP_SL1 > 0 .AND. YGFL%YSDSAT%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YSDSAT%MP_SL1-1)*(SELF%NLEV+2)
    SELF%SDSAT (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%SDSAT          => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  ...
  IF (YGFL%YCVV%MP_SL1 > 0 .AND. YGFL%YCVV%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YCVV%MP_SL1-1)*(SELF%NLEV+2)
    SELF%CVV (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%CVV          => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  ...
  IF (YGFL%YRKTH%MP_SL1 > 0 .AND. YGFL%YRKTH%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YRKTH%MP_SL1-1)*(SELF%NLEV+2)
    SELF%RKTH (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%RKTH          => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  ...
  IF (YGFL%YRKTQV%MP_SL1 > 0 .AND. YGFL%YRKTQV%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YRKTQV%MP_SL1-1)*(SELF%NLEV+2)
    SELF%RKTQV (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%RKTQV          => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  ...
  IF (YGFL%YRKTQC%MP_SL1 > 0 .AND. YGFL%YRKTQC%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YRKTQC%MP_SL1-1)*(SELF%NLEV+2)
    SELF%RKTQC (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%RKTQC          => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  ...
  IF (YGFL%YUOM%MP_SL1 > 0 .AND. YGFL%YUOM%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YUOM%MP_SL1-1)*(SELF%NLEV+2)
    SELF%UOM (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%UOM          => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  ...
  IF (YGFL%YUAL%MP_SL1 > 0 .AND. YGFL%YUAL%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YUAL%MP_SL1-1)*(SELF%NLEV+2)
    SELF%UAL (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%UAL          => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  ...
  IF (YGFL%YDOM%MP_SL1 > 0 .AND. YGFL%YDOM%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YDOM%MP_SL1-1)*(SELF%NLEV+2)
    SELF%DOM (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%DOM          => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  ...
  IF (YGFL%YDAL%MP_SL1 > 0 .AND. YGFL%YDAL%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YDAL%MP_SL1-1)*(SELF%NLEV+2)
    SELF%DAL (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%DAL          => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  ...
  IF (YGFL%YUEN%MP_SL1 > 0 .AND. YGFL%YUEN%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YUEN%MP_SL1-1)*(SELF%NLEV+2)
    SELF%UEN (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%UEN          => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  ...
  IF (YGFL%YUNEBH%MP_SL1 > 0 .AND. YGFL%YUNEBH%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YUNEBH%MP_SL1-1)*(SELF%NLEV+2)
    SELF%UNEBH (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%UNEBH          => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  ...
  IF (YGFL%YFSD%MP_SL1 > 0 .AND. YGFL%YFSD%MP1 > 0) THEN
    JFLD = YDTPTRSLB1%MSLB1GFL9  + (YGFL%YFSD%MP_SL1-1)*(SELF%NLEV+2)
    SELF%FSD (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%FSD          => ZDUM2
  ENDIF
  IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
...
END SUBROUTINE CPG_SL1_TYPE_ALLOC_STACK
...
SUBROUTINE CPG_SL2_TYPE_INIT_STACK (SELF, REGISTRY, NLEV, YDTPTRSLB2 &
                                & , PB2) 
...
SELF%ISIZE = MALIGN (REGISTRY%GEOM%YRDIM%NPROMA * YDTPTRSLB2%NFLDSLB2 * INT (KIND (PB2), JPIB))

END SUBROUTINE CPG_SL2_TYPE_INIT_STACK
...
SUBROUTINE CPG_SL2_TYPE_UPDATE_VIEW_STACK (SELF, BLOCK_INDEX, REGISTRY, NLEV, YDTPTRSLB2 &
                                & , PB2)
...
IF (PRESENT (PB2)) THEN
  ...
  JFLD = YDTPTRSLB2%MSLB2DBBC1
  IF (YDTPTRSLB2%MSLB2DBBC1 > 0) THEN
    SELF%DBBC1          => SELF%ZDATA (:, JFLD, BLOCK_INDEX)
  ELSE
    SELF%DBBC1          => ZDUM1
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2DPHI1
  IF (YDTPTRSLB2%MSLB2DPHI1 > 0) THEN
    SELF%DPHI1          => SELF%ZDATA (:, JFLD, BLOCK_INDEX)
  ELSE
    SELF%DPHI1          => ZDUM1
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2USI
  IF (YDTPTRSLB2%MSLB2USI > 0) THEN
    SELF%USI (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%USI (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2VSI
  IF (YDTPTRSLB2%MSLB2VSI > 0) THEN
    SELF%VSI (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%VSI (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2TSI
  IF (YDTPTRSLB2%MSLB2TSI > 0) THEN
    SELF%TSI (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%TSI (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2PDSI
  IF (YDTPTRSLB2%MSLB2PDSI > 0) THEN
    SELF%PDSI (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%PDSI (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2VDSI
  IF (YDTPTRSLB2%MSLB2VDSI > 0) THEN
    SELF%VDSI (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%VDSI (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2SPSI
  IF (YDTPTRSLB2%MSLB2SPSI > 0) THEN
    SELF%SPSI (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%SPSI (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2VVEL
  IF (YDTPTRSLB2%MSLB2VVEL > 0) THEN
    SELF%VVEL (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%VVEL (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2URL
  IF (YDTPTRSLB2%MSLB2URL > 0) THEN
    SELF%URL (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%URL (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2VRL
  IF (YDTPTRSLB2%MSLB2VRL > 0) THEN
    SELF%VRL (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%VRL (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2WRL
  IF (YDTPTRSLB2%MSLB2WRL > 0) THEN
    SELF%WRL (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%WRL (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2URL5
  IF (YDTPTRSLB2%MSLB2URL5 > 0) THEN
    SELF%URL5 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%URL5 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2VRL5
  IF (YDTPTRSLB2%MSLB2VRL5 > 0) THEN
    SELF%VRL5 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%VRL5 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2WRL5
  IF (YDTPTRSLB2%MSLB2WRL5 > 0) THEN
    SELF%WRL5 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%WRL5 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2USI5
  IF (YDTPTRSLB2%MSLB2USI5 > 0) THEN
    SELF%USI5 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%USI5 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2VSI5
  IF (YDTPTRSLB2%MSLB2VSI5 > 0) THEN
    SELF%VSI5 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%VSI5 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2U15
  IF (YDTPTRSLB2%MSLB2U15 > 0) THEN
    SELF%U15 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%U15 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2V15
  IF (YDTPTRSLB2%MSLB2V15 > 0) THEN
    SELF%V15 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%V15 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2T15
  IF (YDTPTRSLB2%MSLB2T15 > 0) THEN
    SELF%T15 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%T15 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2Q15
  IF (YDTPTRSLB2%MSLB2Q15 > 0) THEN
    SELF%Q15 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%Q15 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2KAPPA
  IF (YDTPTRSLB2%MSLB2KAPPA > 0) THEN
    SELF%KAPPA (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%KAPPA (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2KAPPAT
  IF (YDTPTRSLB2%MSLB2KAPPAT > 0) THEN
    SELF%KAPPAT (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%KAPPAT (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2KAPPAM
  IF (YDTPTRSLB2%MSLB2KAPPAM > 0) THEN
    SELF%KAPPAM (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%KAPPAM (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2KAPPAH
  IF (YDTPTRSLB2%MSLB2KAPPAH > 0) THEN
    SELF%KAPPAH (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%KAPPAH (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2KAPPA5
  IF (YDTPTRSLB2%MSLB2KAPPA5 > 0) THEN
    SELF%KAPPA5 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%KAPPA5 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2KAPPAT5
  IF (YDTPTRSLB2%MSLB2KAPPAT5 > 0) THEN
    SELF%KAPPAT5 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%KAPPAT5 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2GWF
  IF (YDTPTRSLB2%MSLB2GWF > 0) THEN
    SELF%GWF (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%GWF (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2GDW
  IF (YDTPTRSLB2%MSLB2GDW > 0) THEN
    SELF%GDW (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%GDW (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2GWS
  IF (YDTPTRSLB2%MSLB2GWS > 0) THEN
    SELF%GWS (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%GWS (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2STDDISU
  IF (YDTPTRSLB2%MSLB2STDDISU > 0) THEN
    SELF%STDDISU (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%STDDISU (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2STDDISV
  IF (YDTPTRSLB2%MSLB2STDDISV > 0) THEN
    SELF%STDDISV (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%STDDISV (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2STDDISW
  IF (YDTPTRSLB2%MSLB2STDDISW > 0) THEN
    SELF%STDDISW (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+SELF%NLEV+1, BLOCK_INDEX)
  ELSE
    SELF%STDDISW (1:, 0:) => ZDUM2
  ENDIF


ENDIF

END SUBROUTINE CPG_SL2_TYPE_UPDATE_VIEW_STACK

INTEGER (KIND=JPIB) FUNCTION CPG_SL2_TYPE_SIZE_STACK (SELF)

CLASS (CPG_SL2_TYPE) :: SELF

CPG_SL2_TYPE_SIZE_STACK = SELF%ISIZE

END FUNCTION

SUBROUTINE CPG_SL2_TYPE_ALLOC_STACK (SELF, REGISTRY, NLEV, YDTPTRSLB2 &
                                & , PB2 &
                                & , YDSTACK)
USE STACK_MOD, ONLY : STACK
USE PTRSLB2, ONLY : TPTRSLB2
...
IF (.NOT. PRESENT (PB2)) THEN

  CALL YDSTACK%ALLOC (SELF%ZDATA, [REGISTRY%GEOM%YRDIM%NPROMA, YDTPTRSLB2%NFLDSLB2, 1])
  SELF%ZVIEW => SELF%ZDATA (:,:,1)

  JFLD = YDTPTRSLB2%MSLB2DBBC1
  IF (YDTPTRSLB2%MSLB2DBBC1 > 0) THEN
    SELF%DBBC1          => SELF%ZDATA (:, JFLD,             1)
  ELSE
    SELF%DBBC1          => ZDUM1
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2DPHI1
  IF (YDTPTRSLB2%MSLB2DPHI1 > 0) THEN
    SELF%DPHI1          => SELF%ZDATA (:, JFLD,             1)
  ELSE
    SELF%DPHI1          => ZDUM1
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2USI
  IF (YDTPTRSLB2%MSLB2USI > 0) THEN
    SELF%USI (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%USI (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2VSI
  IF (YDTPTRSLB2%MSLB2VSI > 0) THEN
    SELF%VSI (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%VSI (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2TSI
  IF (YDTPTRSLB2%MSLB2TSI > 0) THEN
    SELF%TSI (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%TSI (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2PDSI
  IF (YDTPTRSLB2%MSLB2PDSI > 0) THEN
    SELF%PDSI (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%PDSI (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2VDSI
  IF (YDTPTRSLB2%MSLB2VDSI > 0) THEN
    SELF%VDSI (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%VDSI (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2SPSI
  IF (YDTPTRSLB2%MSLB2SPSI > 0) THEN
    SELF%SPSI (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%SPSI (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2VVEL
  IF (YDTPTRSLB2%MSLB2VVEL > 0) THEN
    SELF%VVEL (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%VVEL (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2URL
  IF (YDTPTRSLB2%MSLB2URL > 0) THEN
    SELF%URL (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%URL (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2VRL
  IF (YDTPTRSLB2%MSLB2VRL > 0) THEN
    SELF%VRL (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%VRL (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2WRL
  IF (YDTPTRSLB2%MSLB2WRL > 0) THEN
    SELF%WRL (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%WRL (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2URL5
  IF (YDTPTRSLB2%MSLB2URL5 > 0) THEN
    SELF%URL5 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%URL5 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2VRL5
  IF (YDTPTRSLB2%MSLB2VRL5 > 0) THEN
    SELF%VRL5 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%VRL5 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2WRL5
  IF (YDTPTRSLB2%MSLB2WRL5 > 0) THEN
    SELF%WRL5 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%WRL5 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2USI5
  IF (YDTPTRSLB2%MSLB2USI5 > 0) THEN
    SELF%USI5 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%USI5 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2VSI5
  IF (YDTPTRSLB2%MSLB2VSI5 > 0) THEN
    SELF%VSI5 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%VSI5 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2U15
  IF (YDTPTRSLB2%MSLB2U15 > 0) THEN
    SELF%U15 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%U15 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2V15
  IF (YDTPTRSLB2%MSLB2V15 > 0) THEN
    SELF%V15 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%V15 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2T15
  IF (YDTPTRSLB2%MSLB2T15 > 0) THEN
    SELF%T15 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%T15 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2Q15
  IF (YDTPTRSLB2%MSLB2Q15 > 0) THEN
    SELF%Q15 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%Q15 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2KAPPA
  IF (YDTPTRSLB2%MSLB2KAPPA > 0) THEN
    SELF%KAPPA (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%KAPPA (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2KAPPAT
  IF (YDTPTRSLB2%MSLB2KAPPAT > 0) THEN
    SELF%KAPPAT (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%KAPPAT (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2KAPPAM
  IF (YDTPTRSLB2%MSLB2KAPPAM > 0) THEN
    SELF%KAPPAM (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%KAPPAM (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2KAPPAH
  IF (YDTPTRSLB2%MSLB2KAPPAH > 0) THEN
    SELF%KAPPAH (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%KAPPAH (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2KAPPA5
  IF (YDTPTRSLB2%MSLB2KAPPA5 > 0) THEN
    SELF%KAPPA5 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%KAPPA5 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2KAPPAT5
  IF (YDTPTRSLB2%MSLB2KAPPAT5 > 0) THEN
    SELF%KAPPAT5 (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%KAPPAT5 (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2GWF
  IF (YDTPTRSLB2%MSLB2GWF > 0) THEN
    SELF%GWF (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%GWF (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2GDW
  IF (YDTPTRSLB2%MSLB2GDW > 0) THEN
    SELF%GDW (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%GDW (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2GWS
  IF (YDTPTRSLB2%MSLB2GWS > 0) THEN
    SELF%GWS (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%GWS (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2STDDISU
  IF (YDTPTRSLB2%MSLB2STDDISU > 0) THEN
    SELF%STDDISU (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%STDDISU (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2STDDISV
  IF (YDTPTRSLB2%MSLB2STDDISV > 0) THEN
    SELF%STDDISV (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%STDDISV (1:, 0:) => ZDUM2
  ENDIF
  JFLD = YDTPTRSLB2%MSLB2STDDISW
  IF (YDTPTRSLB2%MSLB2STDDISW > 0) THEN
    SELF%STDDISW (1:, 0:) => SELF%ZDATA (:, JFLD:JFLD+NLEV+1, 1)
  ELSE
    SELF%STDDISW (1:, 0:) => ZDUM2
  ENDIF
...
END SUBROUTINE CPG_SL2_TYPE_ALLOC_STACK
