...
!>REAL (KIND=JPRB)                      :: GPAR (NPROMA, 1:YDMODEL%YRML_PHY_MF%YRPARAR%NGPAR+1)
...
SELF%F_NEB => CREATE_TEMPORARY ("NEB", GEOM=REGISTRY%GEOM, NLEV=YDCPG_DIM%KFLEVG, PERSISTENT=PERSISTENT)

SELF%F_QLI => CREATE_TEMPORARY ("QLI", GEOM=REGISTRY%GEOM, NLEV=YDCPG_DIM%KFLEVG, PERSISTENT=PERSISTENT)

SELF%F_QICE => CREATE_TEMPORARY ("QICE", GEOM=REGISTRY%GEOM, NLEV=YDCPG_DIM%KFLEVG, PERSISTENT=PERSISTENT)

SELF%F_QRAIN => CREATE_TEMPORARY ("QRAIN", GEOM=REGISTRY%GEOM, NLEV=YDCPG_DIM%KFLEVG, PERSISTENT=PERSISTENT)

SELF%F_QSNOW => CREATE_TEMPORARY ("QSNOW", GEOM=REGISTRY%GEOM, NLEV=YDCPG_DIM%KFLEVG, PERSISTENT=PERSISTENT)

SELF%F_RH => CREATE_TEMPORARY ("RH", GEOM=REGISTRY%GEOM, NLEV=YDCPG_DIM%KFLEVG, PERSISTENT=PERSISTENT)
...
SELF%F_FTCNS => CREATE_TEMPORARY ("FTCNS", GEOM=REGISTRY%GEOM, NLEV=YDCPG_DIM%KFLEVG+1, NDIM=6, PERSISTENT=PERSISTENT)

SELF%F_KOZO => CREATE_TEMPORARY ("KOZO", GEOM=REGISTRY%GEOM, NLEV=YDCPG_DIM%KFLEVG+1, NDIM=YDCPG_DIM%KVCLIS, PERSISTENT=PERSISTENT)
