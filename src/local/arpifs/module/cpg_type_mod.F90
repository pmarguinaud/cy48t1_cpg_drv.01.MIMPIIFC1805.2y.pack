...
TYPE CPG_DDH_TYPE
  ...
  REAL(KIND=JPRB), POINTER, CONTIGUOUS :: AUX3D_ (:,:,:,:) => NULL ()
  
  REAL(KIND=JPRB), POINTER, CONTIGUOUS :: AUX2D (:,:)      => NULL ()
  REAL(KIND=JPRB), POINTER, CONTIGUOUS :: AUX2D_ (:,:,:)   => NULL ()
...
SUBROUTINE CPG_DDH_TYPE_INIT (SELF, REGISTRY, NLEV, PERSISTENT, YDMODEL)
