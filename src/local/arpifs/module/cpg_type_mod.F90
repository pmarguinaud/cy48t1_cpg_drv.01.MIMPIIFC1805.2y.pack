...
IF (ASSOCIATED (SELF%F_DATA)) THEN
  ...
  IF (SELF%I_Q > 0) THEN
    SELF%Q => SELF%ZVIEW (:, SELF%I_C9_NL:SELF%I_C9_NL+SELF%NLEV+1)
  ELSE
    SELF%Q => ZDUM2
  ENDIF
  IF (SELF%I_I > 0) THEN
    SELF%I => SELF%ZVIEW (:, SELF%I_C9_NL:SELF%I_C9_NL+SELF%NLEV+1)
  ELSE
    SELF%I => ZDUM2
  ENDIF
  IF (SELF%I_L > 0) THEN
    SELF%L => SELF%ZVIEW (:, SELF%I_C9_NL:SELF%I_C9_NL+SELF%NLEV+1)
  ELSE
    SELF%L => ZDUM2
  ENDIF
  IF (SELF%I_LCONV > 0) THEN
    SELF%LCONV => SELF%ZVIEW (:, SELF%I_C9_NL:SELF%I_C9_NL+SELF%NLEV+1)
  ELSE
    SELF%LCONV => ZDUM2
  ENDIF
  IF (SELF%I_ICONV > 0) THEN
    SELF%ICONV => SELF%ZVIEW (:, SELF%I_C9_NL:SELF%I_C9_NL+SELF%NLEV+1)
  ELSE
    SELF%ICONV => ZDUM2
  ENDIF
  IF (SELF%I_RCONV > 0) THEN
    SELF%RCONV => SELF%ZVIEW (:, SELF%I_C9_NL:SELF%I_C9_NL+SELF%NLEV+1)
  ELSE
    SELF%RCONV => ZDUM2
  ENDIF
  IF (SELF%I_SCONV > 0) THEN
    SELF%SCONV => SELF%ZVIEW (:, SELF%I_C9_NL:SELF%I_C9_NL+SELF%NLEV+1)
  ELSE
    SELF%SCONV => ZDUM2
  ENDIF
  IF (SELF%I_IRAD > 0) THEN
    SELF%IRAD => SELF%ZVIEW (:, SELF%I_C9_NL:SELF%I_C9_NL+SELF%NLEV+1)
  ELSE
    SELF%IRAD => ZDUM2
  ENDIF
  IF (SELF%I_LRAD > 0) THEN
    SELF%LRAD => SELF%ZVIEW (:, SELF%I_C9_NL:SELF%I_C9_NL+SELF%NLEV+1)
  ELSE
    SELF%LRAD => ZDUM2
  ENDIF
  IF (SELF%I_S > 0) THEN
    SELF%S => SELF%ZVIEW (:, SELF%I_C9_NL:SELF%I_C9_NL+SELF%NLEV+1)
  ELSE
    SELF%S => ZDUM2
  ENDIF
  IF (SELF%I_R > 0) THEN
    SELF%R => SELF%ZVIEW (:, SELF%I_C9_NL:SELF%I_C9_NL+SELF%NLEV+1)
  ELSE
    SELF%R => ZDUM2
  ENDIF
  IF (SELF%I_G > 0) THEN
    SELF%G => SELF%ZVIEW (:, SELF%I_C9_NL:SELF%I_C9_NL+SELF%NLEV+1)
  ELSE
    SELF%G => ZDUM2
  ENDIF
  IF (SELF%I_H > 0) THEN
    SELF%H => SELF%ZVIEW (:, SELF%I_C9_NL:SELF%I_C9_NL+SELF%NLEV+1)
  ELSE
    SELF%H => ZDUM2
  ENDIF
  IF (SELF%I_TKE > 0) THEN
    SELF%TKE => SELF%ZVIEW (:, SELF%I_C9_NL:SELF%I_C9_NL+SELF%NLEV+1)
  ELSE
    SELF%TKE => ZDUM2
  ENDIF
  IF (SELF%I_TTE > 0) THEN
    SELF%TTE => SELF%ZVIEW (:, SELF%I_C9_NL:SELF%I_C9_NL+SELF%NLEV+1)
  ELSE
    SELF%TTE => ZDUM2
  ENDIF
  IF (SELF%I_EFB1 > 0) THEN
    SELF%EFB1 => SELF%ZVIEW (:, SELF%I_C9_NL:SELF%I_C9_NL+SELF%NLEV+1)
  ELSE
    SELF%EFB1 => ZDUM2
  ENDIF
  IF (SELF%I_EFB2 > 0) THEN
    SELF%EFB2 => SELF%ZVIEW (:, SELF%I_C9_NL:SELF%I_C9_NL+SELF%NLEV+1)
  ELSE
    SELF%EFB2 => ZDUM2
  ENDIF
  IF (SELF%I_EFB3 > 0) THEN
    SELF%EFB3 => SELF%ZVIEW (:, SELF%I_C9_NL:SELF%I_C9_NL+SELF%NLEV+1)
  ELSE
    SELF%EFB3 => ZDUM2
  ENDIF
  IF (SELF%I_A > 0) THEN
    SELF%A => SELF%ZVIEW (:, SELF%I_C9_NL:SELF%I_C9_NL+SELF%NLEV+1)
  ELSE
    SELF%A => ZDUM2
  ENDIF
  IF (SELF%I_O3 > 0) THEN
    SELF%O3 => SELF%ZVIEW (:, SELF%I_C9_NL:SELF%I_C9_NL+SELF%NLEV+1)
  ELSE
    SELF%O3 => ZDUM2
  ENDIF
  IF (SELF%I_SRC > 0) THEN
    SELF%SRC => SELF%ZVIEW (:, SELF%I_C9_NL:SELF%I_C9_NL+SELF%NLEV+1)
  ELSE
    SELF%SRC => ZDUM2
  ENDIF
  IF (SELF%I_MXL > 0) THEN
    SELF%MXL => SELF%ZVIEW (:, SELF%I_C9_NL:SELF%I_C9_NL+SELF%NLEV+1)
  ELSE
    SELF%MXL => ZDUM2
  ENDIF
  IF (SELF%I_SHTUR > 0) THEN
    SELF%SHTUR => SELF%ZVIEW (:, SELF%I_C9_NL:SELF%I_C9_NL+SELF%NLEV+1)
  ELSE
    SELF%SHTUR => ZDUM2
  ENDIF
  IF (SELF%I_FQTUR > 0) THEN
    SELF%FQTUR => SELF%ZVIEW (:, SELF%I_C9_NL:SELF%I_C9_NL+SELF%NLEV+1)
  ELSE
    SELF%FQTUR => ZDUM2
  ENDIF
  IF (SELF%I_FSTUR > 0) THEN
    SELF%FSTUR => SELF%ZVIEW (:, SELF%I_C9_NL:SELF%I_C9_NL+SELF%NLEV+1)
  ELSE
    SELF%FSTUR => ZDUM2
  ENDIF
  IF (SELF%I_CPF > 0) THEN
    SELF%CPF => SELF%ZVIEW (:, SELF%I_C9_NL:SELF%I_C9_NL+SELF%NLEV+1)
  ELSE
    SELF%CPF => ZDUM2
  ENDIF
  IF (SELF%I_SPF > 0) THEN
    SELF%SPF => SELF%ZVIEW (:, SELF%I_C9_NL:SELF%I_C9_NL+SELF%NLEV+1)
  ELSE
    SELF%SPF => ZDUM2
  ENDIF
  IF (SELF%I_CVGQ > 0) THEN
    SELF%CVGQ => SELF%ZVIEW (:, SELF%I_C9_NL:SELF%I_C9_NL+SELF%NLEV+1)
  ELSE
    SELF%CVGQ => ZDUM2
  ENDIF
  IF (SELF%I_QVA > 0) THEN
    SELF%QVA => SELF%ZVIEW (:, SELF%I_C9_NL:SELF%I_C9_NL+SELF%NLEV+1)
  ELSE
    SELF%QVA => ZDUM2
  ENDIF
  IF (SELF%I_LRCH4 > 0) THEN
    SELF%LRCH4 => SELF%ZVIEW (:, SELF%I_C9_NL:SELF%I_C9_NL+SELF%NLEV+1)
  ELSE
    SELF%LRCH4 => ZDUM2
  ENDIF
  IF (SELF%I_PHYCTY > 0) THEN
    SELF%PHYCTY => SELF%ZVIEW (:, SELF%I_C9_NL:SELF%I_C9_NL+SELF%NLEV+1)
  ELSE
    SELF%PHYCTY => ZDUM2
  ENDIF
  IF (SELF%I_RSPEC > 0) THEN
    SELF%RSPEC => SELF%ZVIEW (:, SELF%I_C9_NL:SELF%I_C9_NL+SELF%NLEV+1)
  ELSE
    SELF%RSPEC => ZDUM2
  ENDIF
  IF (SELF%I_SDSAT > 0) THEN
    SELF%SDSAT => SELF%ZVIEW (:, SELF%I_C9_NL:SELF%I_C9_NL+SELF%NLEV+1)
  ELSE
    SELF%SDSAT => ZDUM2
  ENDIF
  IF (SELF%I_CVV > 0) THEN
    SELF%CVV => SELF%ZVIEW (:, SELF%I_C9_NL:SELF%I_C9_NL+SELF%NLEV+1)
  ELSE
    SELF%CVV => ZDUM2
  ENDIF
  IF (SELF%I_RKTH > 0) THEN
    SELF%RKTH => SELF%ZVIEW (:, SELF%I_C9_NL:SELF%I_C9_NL+SELF%NLEV+1)
  ELSE
    SELF%RKTH => ZDUM2
  ENDIF
  IF (SELF%I_RKTQV > 0) THEN
    SELF%RKTQV => SELF%ZVIEW (:, SELF%I_C9_NL:SELF%I_C9_NL+SELF%NLEV+1)
  ELSE
    SELF%RKTQV => ZDUM2
  ENDIF
  IF (SELF%I_RKTQC > 0) THEN
    SELF%RKTQC => SELF%ZVIEW (:, SELF%I_C9_NL:SELF%I_C9_NL+SELF%NLEV+1)
  ELSE
    SELF%RKTQC => ZDUM2
  ENDIF
  IF (SELF%I_UOM > 0) THEN
    SELF%UOM => SELF%ZVIEW (:, SELF%I_C9_NL:SELF%I_C9_NL+SELF%NLEV+1)
  ELSE
    SELF%UOM => ZDUM2
  ENDIF
  IF (SELF%I_UAL > 0) THEN
    SELF%UAL => SELF%ZVIEW (:, SELF%I_C9_NL:SELF%I_C9_NL+SELF%NLEV+1)
  ELSE
    SELF%UAL => ZDUM2
  ENDIF
  IF (SELF%I_DOM > 0) THEN
    SELF%DOM => SELF%ZVIEW (:, SELF%I_C9_NL:SELF%I_C9_NL+SELF%NLEV+1)
  ELSE
    SELF%DOM => ZDUM2
  ENDIF
  IF (SELF%I_DAL > 0) THEN
    SELF%DAL => SELF%ZVIEW (:, SELF%I_C9_NL:SELF%I_C9_NL+SELF%NLEV+1)
  ELSE
    SELF%DAL => ZDUM2
  ENDIF
  IF (SELF%I_UEN > 0) THEN
    SELF%UEN => SELF%ZVIEW (:, SELF%I_C9_NL:SELF%I_C9_NL+SELF%NLEV+1)
  ELSE
    SELF%UEN => ZDUM2
  ENDIF
  IF (SELF%I_UNEBH > 0) THEN
    SELF%UNEBH => SELF%ZVIEW (:, SELF%I_C9_NL:SELF%I_C9_NL+SELF%NLEV+1)
  ELSE
    SELF%UNEBH => ZDUM2
  ENDIF
  IF (SELF%I_FSD > 0) THEN
    SELF%FSD => SELF%ZVIEW (:, SELF%I_C9_NL:SELF%I_C9_NL+SELF%NLEV+1)
  ELSE
    SELF%FSD => ZDUM2
  ENDIF
