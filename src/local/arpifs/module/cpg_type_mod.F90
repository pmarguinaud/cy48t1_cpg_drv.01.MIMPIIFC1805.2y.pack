...
SUBROUTINE CPG_GPAR_TYPE_INIT (SELF, YDCPG_DIM, REGISTRY, YDTPARAR, PERSISTENT, PTPARAR)
...
SELF%F_DATA => CREATE_FIELD_WRAP ('CPG_GPAR_TYPE', SELF%ZDATA, PERSISTENT=.NOT. SELF%LOWNED)

IF (YDTPARAR%MINPRR > 0) THEN
  SELF%F_INPRR => CREATE_FIELD_WRAP ('INPRR', SELF%ZDATA (:, YDTPARAR%MINPRR, :), PERSISTENT=.NOT. SELF%LOWNED)
ELSE
  SELF%F_INPRR => NULL ()
ENDIF
IF (YDTPARAR%MINPRS > 0) THEN
  SELF%F_INPRS => CREATE_FIELD_WRAP ('INPRS', SELF%ZDATA (:, YDTPARAR%MINPRS, :), PERSISTENT=.NOT. SELF%LOWNED)
ELSE
  SELF%F_INPRS => NULL ()
ENDIF
IF (YDTPARAR%MINPRG > 0) THEN
  SELF%F_INPRG => CREATE_FIELD_WRAP ('INPRG', SELF%ZDATA (:, YDTPARAR%MINPRG, :), PERSISTENT=.NOT. SELF%LOWNED)
ELSE
  SELF%F_INPRG => NULL ()
ENDIF
IF (YDTPARAR%MACPRR > 0) THEN
  SELF%F_ACPRR => CREATE_FIELD_WRAP ('ACPRR', SELF%ZDATA (:, YDTPARAR%MACPRR, :), PERSISTENT=.NOT. SELF%LOWNED)
ELSE
  SELF%F_ACPRR => NULL ()
ENDIF
IF (YDTPARAR%MACPRS > 0) THEN
  SELF%F_ACPRS => CREATE_FIELD_WRAP ('ACPRS', SELF%ZDATA (:, YDTPARAR%MACPRS, :), PERSISTENT=.NOT. SELF%LOWNED)
ELSE
  SELF%F_ACPRS => NULL ()
ENDIF
IF (YDTPARAR%MACPRG > 0) THEN
  SELF%F_ACPRG => CREATE_FIELD_WRAP ('ACPRG', SELF%ZDATA (:, YDTPARAR%MACPRG, :), PERSISTENT=.NOT. SELF%LOWNED)
ELSE
  SELF%F_ACPRG => NULL ()
ENDIF
IF (YDTPARAR%MALBDIR > 0) THEN
  SELF%F_ALBDIR => CREATE_FIELD_WRAP ('ALBDIR', SELF%ZDATA (:, YDTPARAR%MALBDIR:YDTPARAR%MALBDIR+YDCPG_DIM%KSW-1, :),&
      & PERSISTENT=.NOT. SELF%LOWNED)
ELSE
  SELF%F_ALBDIR => NULL ()
ENDIF
IF (YDTPARAR%MALBSCA > 0) THEN
  SELF%F_ALBSCA => CREATE_FIELD_WRAP ('ALBSCA', SELF%ZDATA (:, YDTPARAR%MALBSCA:YDTPARAR%MALBSCA+YDCPG_DIM%KSW-1, :),&
      & PERSISTENT=.NOT. SELF%LOWNED)
ELSE
  SELF%F_ALBSCA => NULL ()
ENDIF
IF (YDTPARAR%MRAIN > 0) THEN
  SELF%F_RAIN => CREATE_FIELD_WRAP ('RAIN', SELF%ZDATA (:, YDTPARAR%MRAIN, :), PERSISTENT=.NOT. SELF%LOWNED)
ELSE
  SELF%F_RAIN => NULL ()
ENDIF
IF (YDTPARAR%MSNOW > 0) THEN
  SELF%F_SNOW => CREATE_FIELD_WRAP ('SNOW', SELF%ZDATA (:, YDTPARAR%MSNOW, :), PERSISTENT=.NOT. SELF%LOWNED)
ELSE
  SELF%F_SNOW => NULL ()
ENDIF
IF (YDTPARAR%MGZ0 > 0) THEN
  SELF%F_GZ0 => CREATE_FIELD_WRAP ('GZ0', SELF%ZDATA (:, YDTPARAR%MGZ0, :), PERSISTENT=.NOT. SELF%LOWNED)
ELSE
  SELF%F_GZ0 => NULL ()
ENDIF
IF (YDTPARAR%MGZ0H > 0) THEN
  SELF%F_GZ0H => CREATE_FIELD_WRAP ('GZ0H', SELF%ZDATA (:, YDTPARAR%MGZ0H, :), PERSISTENT=.NOT. SELF%LOWNED)
ELSE
  SELF%F_GZ0H => NULL ()
ENDIF
IF (YDTPARAR%MVQS > 0) THEN
  SELF%F_VQS => CREATE_FIELD_WRAP ('VQS', SELF%ZDATA (:, YDTPARAR%MVQS, :), PERSISTENT=.NOT. SELF%LOWNED)
ELSE
  SELF%F_VQS => NULL ()
ENDIF
IF (YDTPARAR%MVTS > 0) THEN
  SELF%F_VTS => CREATE_FIELD_WRAP ('VTS', SELF%ZDATA (:, YDTPARAR%MVTS, :), PERSISTENT=.NOT. SELF%LOWNED)
ELSE
  SELF%F_VTS => NULL ()
ENDIF
IF (YDTPARAR%MVEMIS > 0) THEN
  SELF%F_VEMIS => CREATE_FIELD_WRAP ('VEMIS', SELF%ZDATA (:, YDTPARAR%MVEMIS, :), PERSISTENT=.NOT. SELF%LOWNED)
ELSE
  SELF%F_VEMIS => NULL ()
ENDIF
IF (YDTPARAR%MSWDIR > 0) THEN
  SELF%F_SWDIR => CREATE_FIELD_WRAP ('SWDIR', SELF%ZDATA (:, YDTPARAR%MSWDIR:YDTPARAR%MSWDIR+YDCPG_DIM%KSW-1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ELSE
  SELF%F_SWDIR => NULL ()
ENDIF
IF (YDTPARAR%MSWDIF > 0) THEN
  SELF%F_SWDIF => CREATE_FIELD_WRAP ('SWDIF', SELF%ZDATA (:, YDTPARAR%MSWDIF:YDTPARAR%MSWDIF+YDCPG_DIM%KSW-1, :), PERSISTENT=.NOT.&
      & SELF%LOWNED)
ELSE
  SELF%F_SWDIF => NULL ()
ENDIF
IF (YDTPARAR%MLSM > 0) THEN
  SELF%F_LSM => CREATE_FIELD_WRAP ('LSM', SELF%ZDATA (:, YDTPARAR%MLSM, :), PERSISTENT=.NOT. SELF%LOWNED)
ELSE
  SELF%F_LSM => NULL ()
ENDIF
IF (YDTPARAR%MCD > 0) THEN
  SELF%F_CD => CREATE_FIELD_WRAP ('CD', SELF%ZDATA (:, YDTPARAR%MCD, :), PERSISTENT=.NOT. SELF%LOWNED)
ELSE
  SELF%F_CD => NULL ()
ENDIF
