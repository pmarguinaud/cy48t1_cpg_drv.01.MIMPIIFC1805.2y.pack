...
IF (ASSOCIATED (SELF%F_OROGL)) SELF%OROGL  => SELF%F_OROGL%GET_VIEW (BLOCK_INDEX)
IF (ASSOCIATED (SELF%F_OROGM)) SELF%OROGM  => SELF%F_OROGM%GET_VIEW (BLOCK_INDEX)
IF (ASSOCIATED (SELF%F_OROGLL)) SELF%OROGLL  => SELF%F_OROGLL%GET_VIEW (BLOCK_INDEX)
IF (ASSOCIATED (SELF%F_OROGMM)) SELF%OROGMM  => SELF%F_OROGMM%GET_VIEW (BLOCK_INDEX)
IF (ASSOCIATED (SELF%F_OROGLM)) SELF%OROGLM  => SELF%F_OROGLM%GET_VIEW (BLOCK_INDEX)
IF (ASSOCIATED (SELF%F_GDW)) SELF%GDW  => SELF%F_GDW%GET_VIEW (BLOCK_INDEX)
IF (ASSOCIATED (SELF%F_GWHT)) SELF%GWHT (1:,0:) => SELF%F_GWHT%GET_VIEW (BLOCK_INDEX)
...
IF (ASSOCIATED (SELF%F_NHPREH)) SELF%NHPREH (1:,0:) => SELF%F_NHPREH%GET_VIEW (BLOCK_INDEX)
...
IF (ASSOCIATED (SELF%F_PRE)) SELF%PRE (1:,0:) => SELF%F_PRE%GET_VIEW (BLOCK_INDEX)
IF (ASSOCIATED (SELF%F_PREF)) SELF%PREF  => SELF%F_PREF%GET_VIEW (BLOCK_INDEX)
IF (ASSOCIATED (SELF%F_PREHYD)) SELF%PREHYD (1:,0:) => SELF%F_PREHYD%GET_VIEW (BLOCK_INDEX)
IF (ASSOCIATED (SELF%F_PREHYDF)) SELF%PREHYDF  => SELF%F_PREHYDF%GET_VIEW (BLOCK_INDEX)
IF (ASSOCIATED (SELF%F_WL)) SELF%WL  => SELF%F_WL%GET_VIEW (BLOCK_INDEX)
IF (ASSOCIATED (SELF%F_WM)) SELF%WM  => SELF%F_WM%GET_VIEW (BLOCK_INDEX)
IF (ASSOCIATED (SELF%F_W)) SELF%W  => SELF%F_W%GET_VIEW (BLOCK_INDEX)
CALL SELF%XYB%UPDATE_VIEW (BLOCK_INDEX)
