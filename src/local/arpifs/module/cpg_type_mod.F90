...
CONTAINS
  PROCEDURE :: INIT => CPG_OPT_TYPE_INIT
  PROCEDURE :: UPDATE_VIEW => CPG_OPT_TYPE_UPDATE_VIEW
  PROCEDURE :: FINAL => CPG_OPT_TYPE_FINAL
END TYPE CPG_OPT_TYPE
...
SUBROUTINE CPG_OPT_TYPE_INIT (SELF &
                                & , REGISTRY &
                                & , NLEV &
                                & , PERSISTENT &
                                & , LDMF_PHYS &
...
END SUBROUTINE CPG_OPT_TYPE_INIT

SUBROUTINE CPG_OPT_TYPE_UPDATE_VIEW (SELF, BLOCK_INDEX)
...
END SUBROUTINE CPG_OPT_TYPE_UPDATE_VIEW

SUBROUTINE CPG_OPT_TYPE_FINAL (SELF)
CLASS (CPG_OPT_TYPE)         :: SELF
...
END SUBROUTINE CPG_OPT_TYPE_FINAL
