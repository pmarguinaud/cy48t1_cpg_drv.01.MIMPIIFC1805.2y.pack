...
SELF%F_DATA => CREATE_FIELD_WRAP ('PB1', SELF%ZDATA, PERSISTENT=LLPERSISTENT)

IF (YDTPTRSLB1%MSLB1U9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1U9
  SELF%F_U9 => CREATE_FIELD_WRAP ('U9', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_U9 => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1V9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1V9
  SELF%F_V9 => CREATE_FIELD_WRAP ('V9', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_V9 => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1T9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1T9
  SELF%F_T9 => CREATE_FIELD_WRAP ('T9', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_T9 => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1PD9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1PD9
  SELF%F_PD9 => CREATE_FIELD_WRAP ('PD9', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_PD9 => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1VD9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1VD9
  SELF%F_VD9 => CREATE_FIELD_WRAP ('VD9', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_VD9 => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1NHX9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1NHX9
  SELF%F_NHX9 => CREATE_FIELD_WRAP ('NHX9', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_NHX9 => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1UR0 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1UR0
  SELF%F_UR0 => CREATE_FIELD_WRAP ('UR0', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_UR0 => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1VR0 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1VR0
  SELF%F_VR0 => CREATE_FIELD_WRAP ('VR0', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_VR0 => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1ZR0 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1ZR0
  SELF%F_ZR0 => CREATE_FIELD_WRAP ('ZR0', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_ZR0 => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1WR0 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1WR0
  SELF%F_WR0 => CREATE_FIELD_WRAP ('WR0', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_WR0 => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1UR00 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1UR00
  SELF%F_UR00 => CREATE_FIELD_WRAP ('UR00', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_UR00 => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1VR00 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1VR00
  SELF%F_VR00 => CREATE_FIELD_WRAP ('VR00', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_VR00 => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1ZR00 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1ZR00
  SELF%F_ZR00 => CREATE_FIELD_WRAP ('ZR00', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_ZR00 => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1WR00 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1WR00
  SELF%F_WR00 => CREATE_FIELD_WRAP ('WR00', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_WR00 => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1WRA > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1WRA
  SELF%F_WRA => CREATE_FIELD_WRAP ('WRA', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_WRA => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1UR9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1UR9
  SELF%F_UR9 => CREATE_FIELD_WRAP ('UR9', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_UR9 => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1VR9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1VR9
  SELF%F_VR9 => CREATE_FIELD_WRAP ('VR9', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_VR9 => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1DBBC9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1DBBC9
  SELF%F_DBBC9 => CREATE_FIELD_WRAP ('DBBC9', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_DBBC9 => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1DPHI9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1DPHI9
  SELF%F_DPHI9 => CREATE_FIELD_WRAP ('DPHI9', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_DPHI9 => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1GWS9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1GWS9
  SELF%F_GWS9 => CREATE_FIELD_WRAP ('GWS9', SELF%ZDATA (:, JFLD, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_GWS9 => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1U0 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1U0
  SELF%F_U0 => CREATE_FIELD_WRAP ('U0', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_U0 => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1V0 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1V0
  SELF%F_V0 => CREATE_FIELD_WRAP ('V0', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_V0 => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1T0 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1T0
  SELF%F_T0 => CREATE_FIELD_WRAP ('T0', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_T0 => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1PD0 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1PD0
  SELF%F_PD0 => CREATE_FIELD_WRAP ('PD0', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_PD0 => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1VD0 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1VD0
  SELF%F_VD0 => CREATE_FIELD_WRAP ('VD0', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_VD0 => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1C9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1C9
  SELF%F_C9 => CREATE_FIELD_WRAP ('C9', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_C9 => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1SP9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1SP9
  SELF%F_SP9 => CREATE_FIELD_WRAP ('SP9', SELF%ZDATA (:, JFLD, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_SP9 => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1SP0 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1SP0
  SELF%F_SP0 => CREATE_FIELD_WRAP ('SP0', SELF%ZDATA (:, JFLD, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_SP0 => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1C0 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1C0
  SELF%F_C0 => CREATE_FIELD_WRAP ('C0', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_C0 => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1UP9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1UP9
  SELF%F_UP9 => CREATE_FIELD_WRAP ('UP9', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_UP9 => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1VP9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1VP9
  SELF%F_VP9 => CREATE_FIELD_WRAP ('VP9', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_VP9 => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1TP9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1TP9
  SELF%F_TP9 => CREATE_FIELD_WRAP ('TP9', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_TP9 => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1U9_SI > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1U9_SI
  SELF%F_U9_SI => CREATE_FIELD_WRAP ('U9_SI', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_U9_SI => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1V9_SI > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1V9_SI
  SELF%F_V9_SI => CREATE_FIELD_WRAP ('V9_SI', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_V9_SI => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1T9_SI > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1T9_SI
  SELF%F_T9_SI => CREATE_FIELD_WRAP ('T9_SI', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_T9_SI => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1PD9_SI > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1PD9_SI
  SELF%F_PD9_SI => CREATE_FIELD_WRAP ('PD9_SI', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_PD9_SI => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1VD9_SI > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1VD9_SI
  SELF%F_VD9_SI => CREATE_FIELD_WRAP ('VD9_SI', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_VD9_SI => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1C9_SI > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1C9_SI
  SELF%F_C9_SI => CREATE_FIELD_WRAP ('C9_SI', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_C9_SI => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1UF9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1UF9
  SELF%F_UF9 => CREATE_FIELD_WRAP ('UF9', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_UF9 => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1VF9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1VF9
  SELF%F_VF9 => CREATE_FIELD_WRAP ('VF9', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_VF9 => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1TF9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1TF9
  SELF%F_TF9 => CREATE_FIELD_WRAP ('TF9', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_TF9 => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1VDF9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1VDF9
  SELF%F_VDF9 => CREATE_FIELD_WRAP ('VDF9', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_VDF9 => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1U9_NL > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1U9_NL
  SELF%F_U9_NL => CREATE_FIELD_WRAP ('U9_NL', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_U9_NL => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1V9_NL > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1V9_NL
  SELF%F_V9_NL => CREATE_FIELD_WRAP ('V9_NL', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_V9_NL => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1T9_NL > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1T9_NL
  SELF%F_T9_NL => CREATE_FIELD_WRAP ('T9_NL', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_T9_NL => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1PD9_NL > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1PD9_NL
  SELF%F_PD9_NL => CREATE_FIELD_WRAP ('PD9_NL', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_PD9_NL => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1VD9_NL > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1VD9_NL
  SELF%F_VD9_NL => CREATE_FIELD_WRAP ('VD9_NL', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_VD9_NL => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1C9_NL > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1C9_NL
  SELF%F_C9_NL => CREATE_FIELD_WRAP ('C9_NL', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_C9_NL => NULL ()
ENDIF
...
IF (YGFL%YQ%MP_SL1 > 0 .AND. YGFL%YQ%MP1 > 0) THEN
  ...
  SELF%F_Q => CREATE_FIELD_WRAP ('Q', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_Q => NULL ()
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YQ%MP_SL1 > 0 .AND. YGFL%YQ%MP1 > 0) THEN
    ...
    SELF%F_Q_F => CREATE_FIELD_WRAP ('Q_F', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
  ELSE
    SELF%F_Q_F => NULL ()
  ENDIF
ENDIF
IF (YGFL%YI%MP_SL1 > 0 .AND. YGFL%YI%MP1 > 0) THEN
  ...
  SELF%F_I => CREATE_FIELD_WRAP ('I', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_I => NULL ()
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YI%MP_SL1 > 0 .AND. YGFL%YI%MP1 > 0) THEN
    ...
    SELF%F_I_F => CREATE_FIELD_WRAP ('I_F', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
  ELSE
    SELF%F_I_F => NULL ()
  ENDIF
ENDIF
IF (YGFL%YL%MP_SL1 > 0 .AND. YGFL%YL%MP1 > 0) THEN
  ...
  SELF%F_L => CREATE_FIELD_WRAP ('L', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_L => NULL ()
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YL%MP_SL1 > 0 .AND. YGFL%YL%MP1 > 0) THEN
    ...
    SELF%F_L_F => CREATE_FIELD_WRAP ('L_F', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
  ELSE
    SELF%F_L_F => NULL ()
  ENDIF
ENDIF
IF (YGFL%YLCONV%MP_SL1 > 0 .AND. YGFL%YLCONV%MP1 > 0) THEN
  ...
  SELF%F_LCONV => CREATE_FIELD_WRAP ('LCONV', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_LCONV => NULL ()
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YLCONV%MP_SL1 > 0 .AND. YGFL%YLCONV%MP1 > 0) THEN
    ...
    SELF%F_LCONV_F => CREATE_FIELD_WRAP ('LCONV_F', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
  ELSE
    SELF%F_LCONV_F => NULL ()
  ENDIF
ENDIF
IF (YGFL%YICONV%MP_SL1 > 0 .AND. YGFL%YICONV%MP1 > 0) THEN
  ...
  SELF%F_ICONV => CREATE_FIELD_WRAP ('ICONV', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_ICONV => NULL ()
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YICONV%MP_SL1 > 0 .AND. YGFL%YICONV%MP1 > 0) THEN
    ...
    SELF%F_ICONV_F => CREATE_FIELD_WRAP ('ICONV_F', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
  ELSE
    SELF%F_ICONV_F => NULL ()
  ENDIF
ENDIF
IF (YGFL%YRCONV%MP_SL1 > 0 .AND. YGFL%YRCONV%MP1 > 0) THEN
  ...
  SELF%F_RCONV => CREATE_FIELD_WRAP ('RCONV', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_RCONV => NULL ()
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YRCONV%MP_SL1 > 0 .AND. YGFL%YRCONV%MP1 > 0) THEN
    ...
    SELF%F_RCONV_F => CREATE_FIELD_WRAP ('RCONV_F', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
  ELSE
    SELF%F_RCONV_F => NULL ()
  ENDIF
ENDIF
IF (YGFL%YSCONV%MP_SL1 > 0 .AND. YGFL%YSCONV%MP1 > 0) THEN
  ...
  SELF%F_SCONV => CREATE_FIELD_WRAP ('SCONV', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_SCONV => NULL ()
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YSCONV%MP_SL1 > 0 .AND. YGFL%YSCONV%MP1 > 0) THEN
    ...
    SELF%F_SCONV_F => CREATE_FIELD_WRAP ('SCONV_F', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
  ELSE
    SELF%F_SCONV_F => NULL ()
  ENDIF
ENDIF
IF (YGFL%YIRAD%MP_SL1 > 0 .AND. YGFL%YIRAD%MP1 > 0) THEN
  ...
  SELF%F_IRAD => CREATE_FIELD_WRAP ('IRAD', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_IRAD => NULL ()
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YIRAD%MP_SL1 > 0 .AND. YGFL%YIRAD%MP1 > 0) THEN
    ...
    SELF%F_IRAD_F => CREATE_FIELD_WRAP ('IRAD_F', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
  ELSE
    SELF%F_IRAD_F => NULL ()
  ENDIF
ENDIF
IF (YGFL%YLRAD%MP_SL1 > 0 .AND. YGFL%YLRAD%MP1 > 0) THEN
  ...
  SELF%F_LRAD => CREATE_FIELD_WRAP ('LRAD', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_LRAD => NULL ()
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YLRAD%MP_SL1 > 0 .AND. YGFL%YLRAD%MP1 > 0) THEN
    ...
    SELF%F_LRAD_F => CREATE_FIELD_WRAP ('LRAD_F', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
  ELSE
    SELF%F_LRAD_F => NULL ()
  ENDIF
ENDIF
IF (YGFL%YS%MP_SL1 > 0 .AND. YGFL%YS%MP1 > 0) THEN
  ...
  SELF%F_S => CREATE_FIELD_WRAP ('S', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_S => NULL ()
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YS%MP_SL1 > 0 .AND. YGFL%YS%MP1 > 0) THEN
    ...
    SELF%F_S_F => CREATE_FIELD_WRAP ('S_F', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
  ELSE
    SELF%F_S_F => NULL ()
  ENDIF
ENDIF
IF (YGFL%YR%MP_SL1 > 0 .AND. YGFL%YR%MP1 > 0) THEN
  ...
  SELF%F_R => CREATE_FIELD_WRAP ('R', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_R => NULL ()
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YR%MP_SL1 > 0 .AND. YGFL%YR%MP1 > 0) THEN
    ...
    SELF%F_R_F => CREATE_FIELD_WRAP ('R_F', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
  ELSE
    SELF%F_R_F => NULL ()
  ENDIF
ENDIF
IF (YGFL%YG%MP_SL1 > 0 .AND. YGFL%YG%MP1 > 0) THEN
  ...
  SELF%F_G => CREATE_FIELD_WRAP ('G', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_G => NULL ()
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YG%MP_SL1 > 0 .AND. YGFL%YG%MP1 > 0) THEN
    ...
    SELF%F_G_F => CREATE_FIELD_WRAP ('G_F', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
  ELSE
    SELF%F_G_F => NULL ()
  ENDIF
ENDIF
IF (YGFL%YH%MP_SL1 > 0 .AND. YGFL%YH%MP1 > 0) THEN
  ...
  SELF%F_H => CREATE_FIELD_WRAP ('H', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_H => NULL ()
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YH%MP_SL1 > 0 .AND. YGFL%YH%MP1 > 0) THEN
    ...
    SELF%F_H_F => CREATE_FIELD_WRAP ('H_F', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
  ELSE
    SELF%F_H_F => NULL ()
  ENDIF
ENDIF
IF (YGFL%YTKE%MP_SL1 > 0 .AND. YGFL%YTKE%MP1 > 0) THEN
  ...
  SELF%F_TKE => CREATE_FIELD_WRAP ('TKE', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_TKE => NULL ()
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YTKE%MP_SL1 > 0 .AND. YGFL%YTKE%MP1 > 0) THEN
    ...
    SELF%F_TKE_F => CREATE_FIELD_WRAP ('TKE_F', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
  ELSE
    SELF%F_TKE_F => NULL ()
  ENDIF
ENDIF
IF (YGFL%YTTE%MP_SL1 > 0 .AND. YGFL%YTTE%MP1 > 0) THEN
  ...
  SELF%F_TTE => CREATE_FIELD_WRAP ('TTE', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_TTE => NULL ()
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YTTE%MP_SL1 > 0 .AND. YGFL%YTTE%MP1 > 0) THEN
    ...
    SELF%F_TTE_F => CREATE_FIELD_WRAP ('TTE_F', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
  ELSE
    SELF%F_TTE_F => NULL ()
  ENDIF
ENDIF
IF (YGFL%YEFB1%MP_SL1 > 0 .AND. YGFL%YEFB1%MP1 > 0) THEN
  ...
  SELF%F_EFB1 => CREATE_FIELD_WRAP ('EFB1', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_EFB1 => NULL ()
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YEFB1%MP_SL1 > 0 .AND. YGFL%YEFB1%MP1 > 0) THEN
    ...
    SELF%F_EFB1_F => CREATE_FIELD_WRAP ('EFB1_F', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
  ELSE
    SELF%F_EFB1_F => NULL ()
  ENDIF
ENDIF
IF (YGFL%YEFB2%MP_SL1 > 0 .AND. YGFL%YEFB2%MP1 > 0) THEN
  ...
  SELF%F_EFB2 => CREATE_FIELD_WRAP ('EFB2', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_EFB2 => NULL ()
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YEFB2%MP_SL1 > 0 .AND. YGFL%YEFB2%MP1 > 0) THEN
    ...
    SELF%F_EFB2_F => CREATE_FIELD_WRAP ('EFB2_F', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
  ELSE
    SELF%F_EFB2_F => NULL ()
  ENDIF
ENDIF
IF (YGFL%YEFB3%MP_SL1 > 0 .AND. YGFL%YEFB3%MP1 > 0) THEN
  ...
  SELF%F_EFB3 => CREATE_FIELD_WRAP ('EFB3', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_EFB3 => NULL ()
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YEFB3%MP_SL1 > 0 .AND. YGFL%YEFB3%MP1 > 0) THEN
    ...
    SELF%F_EFB3_F => CREATE_FIELD_WRAP ('EFB3_F', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
  ELSE
    SELF%F_EFB3_F => NULL ()
  ENDIF
ENDIF
IF (YGFL%YA%MP_SL1 > 0 .AND. YGFL%YA%MP1 > 0) THEN
  ...
  SELF%F_A => CREATE_FIELD_WRAP ('A', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_A => NULL ()
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YA%MP_SL1 > 0 .AND. YGFL%YA%MP1 > 0) THEN
    ...
    SELF%F_A_F => CREATE_FIELD_WRAP ('A_F', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
  ELSE
    SELF%F_A_F => NULL ()
  ENDIF
ENDIF
IF (YGFL%YO3%MP_SL1 > 0 .AND. YGFL%YO3%MP1 > 0) THEN
  ...
  SELF%F_O3 => CREATE_FIELD_WRAP ('O3', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_O3 => NULL ()
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YO3%MP_SL1 > 0 .AND. YGFL%YO3%MP1 > 0) THEN
    ...
    SELF%F_O3_F => CREATE_FIELD_WRAP ('O3_F', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
  ELSE
    SELF%F_O3_F => NULL ()
  ENDIF
ENDIF
IF (YGFL%YSRC%MP_SL1 > 0 .AND. YGFL%YSRC%MP1 > 0) THEN
  ...
  SELF%F_SRC => CREATE_FIELD_WRAP ('SRC', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_SRC => NULL ()
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YSRC%MP_SL1 > 0 .AND. YGFL%YSRC%MP1 > 0) THEN
    ...
    SELF%F_SRC_F => CREATE_FIELD_WRAP ('SRC_F', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
  ELSE
    SELF%F_SRC_F => NULL ()
  ENDIF
ENDIF
IF (YGFL%YMXL%MP_SL1 > 0 .AND. YGFL%YMXL%MP1 > 0) THEN
  ...
  SELF%F_MXL => CREATE_FIELD_WRAP ('MXL', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_MXL => NULL ()
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YMXL%MP_SL1 > 0 .AND. YGFL%YMXL%MP1 > 0) THEN
    ...
    SELF%F_MXL_F => CREATE_FIELD_WRAP ('MXL_F', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
  ELSE
    SELF%F_MXL_F => NULL ()
  ENDIF
ENDIF
IF (YGFL%YSHTUR%MP_SL1 > 0 .AND. YGFL%YSHTUR%MP1 > 0) THEN
  ...
  SELF%F_SHTUR => CREATE_FIELD_WRAP ('SHTUR', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_SHTUR => NULL ()
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YSHTUR%MP_SL1 > 0 .AND. YGFL%YSHTUR%MP1 > 0) THEN
    ...
    SELF%F_SHTUR_F => CREATE_FIELD_WRAP ('SHTUR_F', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
  ELSE
    SELF%F_SHTUR_F => NULL ()
  ENDIF
ENDIF
IF (YGFL%YFQTUR%MP_SL1 > 0 .AND. YGFL%YFQTUR%MP1 > 0) THEN
  ...
  SELF%F_FQTUR => CREATE_FIELD_WRAP ('FQTUR', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_FQTUR => NULL ()
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YFQTUR%MP_SL1 > 0 .AND. YGFL%YFQTUR%MP1 > 0) THEN
    ...
    SELF%F_FQTUR_F => CREATE_FIELD_WRAP ('FQTUR_F', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
  ELSE
    SELF%F_FQTUR_F => NULL ()
  ENDIF
ENDIF
IF (YGFL%YFSTUR%MP_SL1 > 0 .AND. YGFL%YFSTUR%MP1 > 0) THEN
  ...
  SELF%F_FSTUR => CREATE_FIELD_WRAP ('FSTUR', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_FSTUR => NULL ()
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YFSTUR%MP_SL1 > 0 .AND. YGFL%YFSTUR%MP1 > 0) THEN
    ...
    SELF%F_FSTUR_F => CREATE_FIELD_WRAP ('FSTUR_F', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
  ELSE
    SELF%F_FSTUR_F => NULL ()
  ENDIF
ENDIF
IF (YGFL%YCPF%MP_SL1 > 0 .AND. YGFL%YCPF%MP1 > 0) THEN
  ...
  SELF%F_CPF => CREATE_FIELD_WRAP ('CPF', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_CPF => NULL ()
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YCPF%MP_SL1 > 0 .AND. YGFL%YCPF%MP1 > 0) THEN
    ...
    SELF%F_CPF_F => CREATE_FIELD_WRAP ('CPF_F', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
  ELSE
    SELF%F_CPF_F => NULL ()
  ENDIF
ENDIF
IF (YGFL%YSPF%MP_SL1 > 0 .AND. YGFL%YSPF%MP1 > 0) THEN
  ...
  SELF%F_SPF => CREATE_FIELD_WRAP ('SPF', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_SPF => NULL ()
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YSPF%MP_SL1 > 0 .AND. YGFL%YSPF%MP1 > 0) THEN
    ...
    SELF%F_SPF_F => CREATE_FIELD_WRAP ('SPF_F', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
  ELSE
    SELF%F_SPF_F => NULL ()
  ENDIF
ENDIF
IF (YGFL%YCVGQ%MP_SL1 > 0 .AND. YGFL%YCVGQ%MP1 > 0) THEN
  ...
  SELF%F_CVGQ => CREATE_FIELD_WRAP ('CVGQ', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_CVGQ => NULL ()
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YCVGQ%MP_SL1 > 0 .AND. YGFL%YCVGQ%MP1 > 0) THEN
    ...
    SELF%F_CVGQ_F => CREATE_FIELD_WRAP ('CVGQ_F', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
  ELSE
    SELF%F_CVGQ_F => NULL ()
  ENDIF
ENDIF
IF (YGFL%YQVA%MP_SL1 > 0 .AND. YGFL%YQVA%MP1 > 0) THEN
  ...
  SELF%F_QVA => CREATE_FIELD_WRAP ('QVA', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_QVA => NULL ()
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YQVA%MP_SL1 > 0 .AND. YGFL%YQVA%MP1 > 0) THEN
    ...
    SELF%F_QVA_F => CREATE_FIELD_WRAP ('QVA_F', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
  ELSE
    SELF%F_QVA_F => NULL ()
  ENDIF
ENDIF
IF (YGFL%YLRCH4%MP_SL1 > 0 .AND. YGFL%YLRCH4%MP1 > 0) THEN
  ...
  SELF%F_LRCH4 => CREATE_FIELD_WRAP ('LRCH4', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_LRCH4 => NULL ()
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YLRCH4%MP_SL1 > 0 .AND. YGFL%YLRCH4%MP1 > 0) THEN
    ...
    SELF%F_LRCH4_F => CREATE_FIELD_WRAP ('LRCH4_F', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
  ELSE
    SELF%F_LRCH4_F => NULL ()
  ENDIF
ENDIF
IF (YGFL%YPHYCTY%MP_SL1 > 0 .AND. YGFL%YPHYCTY%MP1 > 0) THEN
  ...
  SELF%F_PHYCTY => CREATE_FIELD_WRAP ('PHYCTY', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_PHYCTY => NULL ()
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YPHYCTY%MP_SL1 > 0 .AND. YGFL%YPHYCTY%MP1 > 0) THEN
    ...
    SELF%F_PHYCTY_F => CREATE_FIELD_WRAP ('PHYCTY_F', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
  ELSE
...
IF (YGFL%YRSPEC%MP_SL1 > 0 .AND. YGFL%YRSPEC%MP1 > 0) THEN
  ...
  SELF%F_RSPEC => CREATE_FIELD_WRAP ('RSPEC', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_RSPEC => NULL ()
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YRSPEC%MP_SL1 > 0 .AND. YGFL%YRSPEC%MP1 > 0) THEN
    ...
    SELF%F_RSPEC_F => CREATE_FIELD_WRAP ('RSPEC_F', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
  ELSE
    SELF%F_RSPEC_F => NULL ()
  ENDIF
ENDIF
IF (YGFL%YSDSAT%MP_SL1 > 0 .AND. YGFL%YSDSAT%MP1 > 0) THEN
  ...
  SELF%F_SDSAT => CREATE_FIELD_WRAP ('SDSAT', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_SDSAT => NULL ()
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YSDSAT%MP_SL1 > 0 .AND. YGFL%YSDSAT%MP1 > 0) THEN
    ...
    SELF%F_SDSAT_F => CREATE_FIELD_WRAP ('SDSAT_F', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
  ELSE
    SELF%F_SDSAT_F => NULL ()
  ENDIF
ENDIF
IF (YGFL%YCVV%MP_SL1 > 0 .AND. YGFL%YCVV%MP1 > 0) THEN
  ...
  SELF%F_CVV => CREATE_FIELD_WRAP ('CVV', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_CVV => NULL ()
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YCVV%MP_SL1 > 0 .AND. YGFL%YCVV%MP1 > 0) THEN
    ...
    SELF%F_CVV_F => CREATE_FIELD_WRAP ('CVV_F', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
  ELSE
    SELF%F_CVV_F => NULL ()
  ENDIF
ENDIF
IF (YGFL%YRKTH%MP_SL1 > 0 .AND. YGFL%YRKTH%MP1 > 0) THEN
  ...
  SELF%F_RKTH => CREATE_FIELD_WRAP ('RKTH', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_RKTH => NULL ()
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YRKTH%MP_SL1 > 0 .AND. YGFL%YRKTH%MP1 > 0) THEN
    ...
    SELF%F_RKTH_F => CREATE_FIELD_WRAP ('RKTH_F', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
  ELSE
    SELF%F_RKTH_F => NULL ()
  ENDIF
ENDIF
IF (YGFL%YRKTQV%MP_SL1 > 0 .AND. YGFL%YRKTQV%MP1 > 0) THEN
  ...
  SELF%F_RKTQV => CREATE_FIELD_WRAP ('RKTQV', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_RKTQV => NULL ()
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YRKTQV%MP_SL1 > 0 .AND. YGFL%YRKTQV%MP1 > 0) THEN
    ...
    SELF%F_RKTQV_F => CREATE_FIELD_WRAP ('RKTQV_F', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
  ELSE
    SELF%F_RKTQV_F => NULL ()
  ENDIF
ENDIF
IF (YGFL%YRKTQC%MP_SL1 > 0 .AND. YGFL%YRKTQC%MP1 > 0) THEN
  ...
  SELF%F_RKTQC => CREATE_FIELD_WRAP ('RKTQC', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_RKTQC => NULL ()
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YRKTQC%MP_SL1 > 0 .AND. YGFL%YRKTQC%MP1 > 0) THEN
    ...
    SELF%F_RKTQC_F => CREATE_FIELD_WRAP ('RKTQC_F', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
  ELSE
    SELF%F_RKTQC_F => NULL ()
  ENDIF
ENDIF
IF (YGFL%YUOM%MP_SL1 > 0 .AND. YGFL%YUOM%MP1 > 0) THEN
  ...
  SELF%F_UOM => CREATE_FIELD_WRAP ('UOM', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_UOM => NULL ()
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YUOM%MP_SL1 > 0 .AND. YGFL%YUOM%MP1 > 0) THEN
    ...
    SELF%F_UOM_F => CREATE_FIELD_WRAP ('UOM_F', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
  ELSE
    SELF%F_UOM_F => NULL ()
  ENDIF
ENDIF
IF (YGFL%YUAL%MP_SL1 > 0 .AND. YGFL%YUAL%MP1 > 0) THEN
  ...
  SELF%F_UAL => CREATE_FIELD_WRAP ('UAL', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_UAL => NULL ()
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YUAL%MP_SL1 > 0 .AND. YGFL%YUAL%MP1 > 0) THEN
    ...
    SELF%F_UAL_F => CREATE_FIELD_WRAP ('UAL_F', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
  ELSE
    SELF%F_UAL_F => NULL ()
  ENDIF
ENDIF
IF (YGFL%YDOM%MP_SL1 > 0 .AND. YGFL%YDOM%MP1 > 0) THEN
  ...
  SELF%F_DOM => CREATE_FIELD_WRAP ('DOM', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_DOM => NULL ()
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YDOM%MP_SL1 > 0 .AND. YGFL%YDOM%MP1 > 0) THEN
    ...
    SELF%F_DOM_F => CREATE_FIELD_WRAP ('DOM_F', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
  ELSE
    SELF%F_DOM_F => NULL ()
  ENDIF
ENDIF
IF (YGFL%YDAL%MP_SL1 > 0 .AND. YGFL%YDAL%MP1 > 0) THEN
  ...
  SELF%F_DAL => CREATE_FIELD_WRAP ('DAL', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_DAL => NULL ()
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YDAL%MP_SL1 > 0 .AND. YGFL%YDAL%MP1 > 0) THEN
    ...
    SELF%F_DAL_F => CREATE_FIELD_WRAP ('DAL_F', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
  ELSE
    SELF%F_DAL_F => NULL ()
  ENDIF
ENDIF
IF (YGFL%YUEN%MP_SL1 > 0 .AND. YGFL%YUEN%MP1 > 0) THEN
  ...
  SELF%F_UEN => CREATE_FIELD_WRAP ('UEN', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_UEN => NULL ()
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YUEN%MP_SL1 > 0 .AND. YGFL%YUEN%MP1 > 0) THEN
    ...
    SELF%F_UEN_F => CREATE_FIELD_WRAP ('UEN_F', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
  ELSE
    SELF%F_UEN_F => NULL ()
  ENDIF
ENDIF
IF (YGFL%YUNEBH%MP_SL1 > 0 .AND. YGFL%YUNEBH%MP1 > 0) THEN
  ...
  SELF%F_UNEBH => CREATE_FIELD_WRAP ('UNEBH', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_UNEBH => NULL ()
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YUNEBH%MP_SL1 > 0 .AND. YGFL%YUNEBH%MP1 > 0) THEN
    ...
    SELF%F_UNEBH_F => CREATE_FIELD_WRAP ('UNEBH_F', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
  ELSE
    SELF%F_UNEBH_F => NULL ()
  ENDIF
ENDIF
IF (YGFL%YFSD%MP_SL1 > 0 .AND. YGFL%YFSD%MP1 > 0) THEN
  ...
  SELF%F_FSD => CREATE_FIELD_WRAP ('FSD', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_FSD => NULL ()
ENDIF
IF (YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) THEN
  IF (YGFL%YFSD%MP_SL1 > 0 .AND. YGFL%YFSD%MP1 > 0) THEN
    ...
    SELF%F_FSD_F => CREATE_FIELD_WRAP ('FSD_F', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
  ELSE
    SELF%F_FSD_F => NULL ()
  ENDIF
ENDIF
...
SELF%F_DATA => CREATE_FIELD_WRAP ('PB2', SELF%ZDATA, PERSISTENT=LLPERSISTENT)

IF (YDTPTRSLB2%MSLB2DBBC1 > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2DBBC1
  SELF%F_DBBC1 => CREATE_FIELD_WRAP ('DBBC1', SELF%ZDATA (:, JFLD, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_DBBC1 => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2DPHI1 > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2DPHI1
  SELF%F_DPHI1 => CREATE_FIELD_WRAP ('DPHI1', SELF%ZDATA (:, JFLD, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_DPHI1 => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2USI > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2USI
  SELF%F_USI => CREATE_FIELD_WRAP ('USI', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_USI => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2VSI > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2VSI
  SELF%F_VSI => CREATE_FIELD_WRAP ('VSI', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_VSI => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2TSI > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2TSI
  SELF%F_TSI => CREATE_FIELD_WRAP ('TSI', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_TSI => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2PDSI > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2PDSI
  SELF%F_PDSI => CREATE_FIELD_WRAP ('PDSI', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_PDSI => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2VDSI > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2VDSI
  SELF%F_VDSI => CREATE_FIELD_WRAP ('VDSI', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_VDSI => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2SPSI > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2SPSI
  SELF%F_SPSI => CREATE_FIELD_WRAP ('SPSI', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_SPSI => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2VVEL > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2VVEL
  SELF%F_VVEL => CREATE_FIELD_WRAP ('VVEL', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_VVEL => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2URL > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2URL
  SELF%F_URL => CREATE_FIELD_WRAP ('URL', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_URL => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2VRL > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2VRL
  SELF%F_VRL => CREATE_FIELD_WRAP ('VRL', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_VRL => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2WRL > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2WRL
  SELF%F_WRL => CREATE_FIELD_WRAP ('WRL', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_WRL => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2URL5 > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2URL5
  SELF%F_URL5 => CREATE_FIELD_WRAP ('URL5', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_URL5 => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2VRL5 > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2VRL5
  SELF%F_VRL5 => CREATE_FIELD_WRAP ('VRL5', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_VRL5 => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2WRL5 > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2WRL5
  SELF%F_WRL5 => CREATE_FIELD_WRAP ('WRL5', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_WRL5 => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2USI5 > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2USI5
  SELF%F_USI5 => CREATE_FIELD_WRAP ('USI5', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_USI5 => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2VSI5 > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2VSI5
  SELF%F_VSI5 => CREATE_FIELD_WRAP ('VSI5', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_VSI5 => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2U15 > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2U15
  SELF%F_U15 => CREATE_FIELD_WRAP ('U15', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_U15 => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2V15 > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2V15
  SELF%F_V15 => CREATE_FIELD_WRAP ('V15', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_V15 => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2T15 > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2T15
  SELF%F_T15 => CREATE_FIELD_WRAP ('T15', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_T15 => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2Q15 > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2Q15
  SELF%F_Q15 => CREATE_FIELD_WRAP ('Q15', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_Q15 => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2KAPPA > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2KAPPA
  SELF%F_KAPPA => CREATE_FIELD_WRAP ('KAPPA', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_KAPPA => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2KAPPAT > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2KAPPAT
  SELF%F_KAPPAT => CREATE_FIELD_WRAP ('KAPPAT', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_KAPPAT => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2KAPPAM > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2KAPPAM
  SELF%F_KAPPAM => CREATE_FIELD_WRAP ('KAPPAM', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_KAPPAM => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2KAPPAH > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2KAPPAH
  SELF%F_KAPPAH => CREATE_FIELD_WRAP ('KAPPAH', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_KAPPAH => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2KAPPA5 > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2KAPPA5
  SELF%F_KAPPA5 => CREATE_FIELD_WRAP ('KAPPA5', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_KAPPA5 => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2KAPPAT5 > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2KAPPAT5
  SELF%F_KAPPAT5 => CREATE_FIELD_WRAP ('KAPPAT5', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_KAPPAT5 => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2GWF > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2GWF
  SELF%F_GWF => CREATE_FIELD_WRAP ('GWF', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_GWF => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2GDW > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2GDW
  SELF%F_GDW => CREATE_FIELD_WRAP ('GDW', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_GDW => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2GWS > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2GWS
  SELF%F_GWS => CREATE_FIELD_WRAP ('GWS', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_GWS => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2STDDISU > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2STDDISU
  SELF%F_STDDISU => CREATE_FIELD_WRAP ('STDDISU', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_STDDISU => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2STDDISV > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2STDDISV
  SELF%F_STDDISV => CREATE_FIELD_WRAP ('STDDISV', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_STDDISV => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2STDDISW > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2STDDISW
  SELF%F_STDDISW => CREATE_FIELD_WRAP ('STDDISW', SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_STDDISW => NULL ()
ENDIF
