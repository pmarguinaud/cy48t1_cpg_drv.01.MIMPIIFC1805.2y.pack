...
TYPE FIELD_2D
  ...
  INTEGER(KIND=JPIM) :: LBOUNDS (2) = [1, 1]
...
TYPE FIELD_3D
  ...
  INTEGER(KIND=JPIM) :: LBOUNDS (3) = [1, 1, 1]
...
TYPE FIELD_4D
  ...
  INTEGER(KIND=JPIM) :: LBOUNDS (4) = [1, 1, 1, 1]
...
TYPE FIELD_5D
  ...
  INTEGER(KIND=JPIM) :: LBOUNDS (5) = [1, 1, 1, 1, 1]
...
INTERFACE ALLOCATE_FIELD
  MODULE PROCEDURE :: ALLOCATE_FIELD_2D
  MODULE PROCEDURE :: ALLOCATE_FIELD_3D
  MODULE PROCEDURE :: ALLOCATE_FIELD_4D
  MODULE PROCEDURE :: ALLOCATE_FIELD_5D
  ...
  MODULE PROCEDURE :: ALLOCATE_FIELD_LOG2D
  MODULE PROCEDURE :: ALLOCATE_FIELD_LOG3D
  MODULE PROCEDURE :: ALLOCATE_FIELD_LOG4D
  MODULE PROCEDURE :: ALLOCATE_FIELD_LOG5D
END INTERFACE
...
CONTAINS
  ...
  FUNCTION FIELD_2D_WRAP(DATA, PERSISTENT, LBOUNDS) RESULT(SELF)
    ! Create FIELD object by wrapping existing data
  ...
  FUNCTION FIELD_3D_WRAP(DATA, PERSISTENT, LBOUNDS) RESULT(SELF)
    ! Create FIELD object by wrapping existing data
  ...
  FUNCTION FIELD_4D_WRAP(DATA, PERSISTENT, LBOUNDS) RESULT(SELF)
    ! Create FIELD object by wrapping existing data
  ...
  FUNCTION FIELD_5D_WRAP(DATA, PERSISTENT, LBOUNDS) RESULT(SELF)
    ! Create FIELD object by wrapping existing data
  ...
  FUNCTION FIELD_INT2D_WRAP(DATA, PERSISTENT, LBOUNDS) RESULT(SELF)
    ! Create FIELD object by wrapping existing data
  ...
  FUNCTION FIELD_INT3D_WRAP(DATA, PERSISTENT, LBOUNDS) RESULT(SELF)
    ! Create FIELD object by wrapping existing data
  ...
  FUNCTION FIELD_INT4D_WRAP(DATA, PERSISTENT, LBOUNDS) RESULT(SELF)
    ! Create FIELD object by wrapping existing data
  ...
  FUNCTION FIELD_INT5D_WRAP(DATA, PERSISTENT, LBOUNDS) RESULT(SELF)
    ! Create FIELD object by wrapping existing data
  ...
  FUNCTION FIELD_LOG2D_WRAP(DATA, PERSISTENT, LBOUNDS) RESULT(SELF)
    ! Create FIELD object by wrapping existing data
  ...
  FUNCTION FIELD_LOG3D_WRAP(DATA, PERSISTENT, LBOUNDS) RESULT(SELF)
    ! Create FIELD object by wrapping existing data
  ...
  FUNCTION FIELD_LOG4D_WRAP(DATA, PERSISTENT, LBOUNDS) RESULT(SELF)
    ! Create FIELD object by wrapping existing data
  ...
  FUNCTION FIELD_LOG5D_WRAP(DATA, PERSISTENT, LBOUNDS) RESULT(SELF)
    ! Create FIELD object by wrapping existing data
  ...
  FUNCTION FIELD_2D_WRAP_PACKED(DATA, IDX, LBOUNDS) RESULT(SELF)
  ...
  FUNCTION FIELD_3D_WRAP_PACKED(DATA, IDX, LBOUNDS) RESULT(SELF)
    ! Create FIELD object packed in a multi-field buffer by storing a
    ! contiguous pointer to existing data and an index.
    TYPE(FIELD_3D), TARGET :: SELF
    REAL(KIND=JPRB), TARGET, INTENT(IN) :: DATA(:,:,:,:)
  ...
  FUNCTION FIELD_4D_WRAP_PACKED(DATA, IDX, LBOUNDS) RESULT(SELF)
    ! Create FIELD object packed in a multi-field buffer by storing a
    ! contiguous pointer to existing data and an index.
    TYPE(FIELD_4D), TARGET :: SELF
    REAL(KIND=JPRB), TARGET, INTENT(IN) :: DATA(:,:,:,:,:)
  ...
  FUNCTION FIELD_5D_WRAP_PACKED(DATA, IDX, LBOUNDS) RESULT(SELF)
    ! Create FIELD object packed in a multi-field buffer by storing a
    ! contiguous pointer to existing data and an index.
    TYPE(FIELD_5D), TARGET :: SELF
    REAL(KIND=JPRB), TARGET, INTENT(IN) :: DATA(:,:,:,:,:,:)
  ...
  FUNCTION FIELD_INT2D_WRAP_PACKED(DATA, IDX, LBOUNDS) RESULT(SELF)
    ! Create FIELD object packed in a multi-field buffer by storing a
    ! contiguous pointer to existing data and an index.
    TYPE(FIELD_INT2D), TARGET :: SELF
    INTEGER(KIND=JPIM), TARGET, INTENT(IN) :: DATA(:,:,:)
  ...
  FUNCTION FIELD_INT3D_WRAP_PACKED(DATA, IDX, LBOUNDS) RESULT(SELF)
    ! Create FIELD object packed in a multi-field buffer by storing a
    ! contiguous pointer to existing data and an index.
    TYPE(FIELD_INT3D), TARGET :: SELF
    INTEGER(KIND=JPIM), TARGET, INTENT(IN) :: DATA(:,:,:,:)
  ...
  FUNCTION FIELD_INT4D_WRAP_PACKED(DATA, IDX, LBOUNDS) RESULT(SELF)
    ! Create FIELD object packed in a multi-field buffer by storing a
    ! contiguous pointer to existing data and an index.
    TYPE(FIELD_INT4D), TARGET :: SELF
    INTEGER(KIND=JPIM), TARGET, INTENT(IN) :: DATA(:,:,:,:,:)
  ...
  FUNCTION FIELD_INT5D_WRAP_PACKED(DATA, IDX, LBOUNDS) RESULT(SELF)
    ! Create FIELD object packed in a multi-field buffer by storing a
    ! contiguous pointer to existing data and an index.
    TYPE(FIELD_INT5D), TARGET :: SELF
    INTEGER(KIND=JPIM), TARGET, INTENT(IN) :: DATA(:,:,:,:,:,:)
  ...
  FUNCTION FIELD_LOG2D_WRAP_PACKED(DATA, IDX, LBOUNDS) RESULT(SELF)
    ! Create FIELD object packed in a multi-field buffer by storing a
    ! contiguous pointer to existing data and an index.
    TYPE(FIELD_LOG2D), TARGET :: SELF
    LOGICAL, TARGET, INTENT(IN) :: DATA(:,:,:)
  ...
  FUNCTION FIELD_LOG3D_WRAP_PACKED(DATA, IDX, LBOUNDS) RESULT(SELF)
    ! Create FIELD object packed in a multi-field buffer by storing a
    ! contiguous pointer to existing data and an index.
    TYPE(FIELD_LOG3D), TARGET :: SELF
    LOGICAL, TARGET, INTENT(IN) :: DATA(:,:,:,:)
  ...
  FUNCTION FIELD_LOG4D_WRAP_PACKED(DATA, IDX, LBOUNDS) RESULT(SELF)
    ! Create FIELD object packed in a multi-field buffer by storing a
    ! contiguous pointer to existing data and an index.
    TYPE(FIELD_LOG4D), TARGET :: SELF
    LOGICAL, TARGET, INTENT(IN) :: DATA(:,:,:,:,:)
  ...
  FUNCTION FIELD_LOG5D_WRAP_PACKED(DATA, IDX, LBOUNDS) RESULT(SELF)
    ! Create FIELD object packed in a multi-field buffer by storing a
    ! contiguous pointer to existing data and an index.
    TYPE(FIELD_LOG5D), TARGET :: SELF
    LOGICAL, TARGET, INTENT(IN) :: DATA(:,:,:,:,:,:)
  ...
  SUBROUTINE ALLOCATE_FIELD_2D (SELF, SHAPE, NBLOCKS, PERSISTENT, LBOUNDS) 
    ...
    SELF%BASE_PTR => NULL()
    SELF%FIDX = -1
  END SUBROUTINE ALLOCATE_FIELD_2D

  FUNCTION FIELD_2D_ALLOCATE(SHAPE, NBLOCKS, PERSISTENT, LBOUNDS) RESULT(SELF)
    ...
    CALL ALLOCATE_FIELD_2D (SELF, SHAPE, NBLOCKS, PERSISTENT, LBOUNDS)

  END FUNCTION FIELD_2D_ALLOCATE

  SUBROUTINE ALLOCATE_FIELD_3D (SELF, SHAPE, NBLOCKS, PERSISTENT, LBOUNDS) 
    ! Create FIELD object by explicitly allocating new data
    !
    ! Please note that SHAPE is the conceptual shape without the block dimension
    TYPE(FIELD_3D), TARGET :: SELF
    ...
    SELF%BASE_PTR => NULL()
    SELF%FIDX = -1
  END SUBROUTINE ALLOCATE_FIELD_3D

  FUNCTION FIELD_3D_ALLOCATE(SHAPE, NBLOCKS, PERSISTENT, LBOUNDS) RESULT(SELF)
    ! WARNING : Using this function kills performance when the %DATA member is allocated
    TYPE(FIELD_3D), TARGET :: SELF
    INTEGER(KIND=JPIM), INTENT(IN) :: SHAPE(2)
    INTEGER(KIND=JPIM), INTENT(IN), OPTIONAL :: NBLOCKS
    ...
    CALL ALLOCATE_FIELD_3D (SELF, SHAPE, NBLOCKS, PERSISTENT, LBOUNDS)

  END FUNCTION FIELD_3D_ALLOCATE

  SUBROUTINE ALLOCATE_FIELD_4D (SELF, SHAPE, NBLOCKS, PERSISTENT, LBOUNDS) 
    ! Create FIELD object by explicitly allocating new data
    !
    ! Please note that SHAPE is the conceptual shape without the block dimension
    TYPE(FIELD_4D), TARGET :: SELF
    ...
    SELF%BASE_PTR => NULL()
    SELF%FIDX = -1
  END SUBROUTINE ALLOCATE_FIELD_4D

  FUNCTION FIELD_4D_ALLOCATE(SHAPE, NBLOCKS, PERSISTENT, LBOUNDS) RESULT(SELF)
    ! WARNING : Using this function kills performance when the %DATA member is allocated
    TYPE(FIELD_4D), TARGET :: SELF
    INTEGER(KIND=JPIM), INTENT(IN) :: SHAPE(3)
    INTEGER(KIND=JPIM), INTENT(IN), OPTIONAL :: NBLOCKS
    ...
    CALL ALLOCATE_FIELD_4D (SELF, SHAPE, NBLOCKS, PERSISTENT, LBOUNDS)

  END FUNCTION FIELD_4D_ALLOCATE

  SUBROUTINE ALLOCATE_FIELD_5D (SELF, SHAPE, NBLOCKS, PERSISTENT, LBOUNDS) 
    ! Create FIELD object by explicitly allocating new data
    !
    ! Please note that SHAPE is the conceptual shape without the block dimension
    TYPE(FIELD_5D), TARGET :: SELF
    ...
    SELF%BASE_PTR => NULL()
    SELF%FIDX = -1
  END SUBROUTINE ALLOCATE_FIELD_5D

  FUNCTION FIELD_5D_ALLOCATE(SHAPE, NBLOCKS, PERSISTENT, LBOUNDS) RESULT(SELF)
    ! WARNING : Using this function kills performance when the %DATA member is allocated
    TYPE(FIELD_5D), TARGET :: SELF
    INTEGER(KIND=JPIM), INTENT(IN) :: SHAPE(4)
    INTEGER(KIND=JPIM), INTENT(IN), OPTIONAL :: NBLOCKS
    ...
    CALL ALLOCATE_FIELD_5D (SELF, SHAPE, NBLOCKS, PERSISTENT, LBOUNDS)

  END FUNCTION FIELD_5D_ALLOCATE

  SUBROUTINE ALLOCATE_FIELD_INT2D (SELF, SHAPE, NBLOCKS, PERSISTENT, LBOUNDS) 
    ! Create FIELD object by explicitly allocating new data
    !
    ! Please note that SHAPE is the conceptual shape without the block dimension
    TYPE(FIELD_INT2D), TARGET :: SELF
    ...
    SELF%BASE_PTR => NULL()
    SELF%FIDX = -1
  END SUBROUTINE ALLOCATE_FIELD_INT2D

  FUNCTION FIELD_INT2D_ALLOCATE(SHAPE, NBLOCKS, PERSISTENT, LBOUNDS) RESULT(SELF)
    ! WARNING : Using this function kills performance when the %DATA member is allocated
    TYPE(FIELD_INT2D), TARGET :: SELF
    INTEGER(KIND=JPIM), INTENT(IN) :: SHAPE(1)
    INTEGER(KIND=JPIM), INTENT(IN), OPTIONAL :: NBLOCKS
    ...
    CALL ALLOCATE_FIELD_INT2D (SELF, SHAPE, NBLOCKS, PERSISTENT, LBOUNDS)

  END FUNCTION FIELD_INT2D_ALLOCATE

  SUBROUTINE ALLOCATE_FIELD_INT3D (SELF, SHAPE, NBLOCKS, PERSISTENT, LBOUNDS) 
    ! Create FIELD object by explicitly allocating new data
    !
    ! Please note that SHAPE is the conceptual shape without the block dimension
    TYPE(FIELD_INT3D), TARGET :: SELF
    ...
    SELF%BASE_PTR => NULL()
    SELF%FIDX = -1
  END SUBROUTINE ALLOCATE_FIELD_INT3D

  FUNCTION FIELD_INT3D_ALLOCATE(SHAPE, NBLOCKS, PERSISTENT, LBOUNDS) RESULT(SELF)
    ! WARNING : Using this function kills performance when the %DATA member is allocated
    TYPE(FIELD_INT3D), TARGET :: SELF
    INTEGER(KIND=JPIM), INTENT(IN) :: SHAPE(2)
    INTEGER(KIND=JPIM), INTENT(IN), OPTIONAL :: NBLOCKS
    ...
    CALL ALLOCATE_FIELD_INT3D (SELF, SHAPE, NBLOCKS, PERSISTENT, LBOUNDS)

  END FUNCTION FIELD_INT3D_ALLOCATE

  SUBROUTINE ALLOCATE_FIELD_INT4D (SELF, SHAPE, NBLOCKS, PERSISTENT, LBOUNDS) 
    ! Create FIELD object by explicitly allocating new data
    !
    ! Please note that SHAPE is the conceptual shape without the block dimension
    TYPE(FIELD_INT4D), TARGET :: SELF
    ...
    SELF%BASE_PTR => NULL()
    SELF%FIDX = -1
  END SUBROUTINE ALLOCATE_FIELD_INT4D

  FUNCTION FIELD_INT4D_ALLOCATE(SHAPE, NBLOCKS, PERSISTENT, LBOUNDS) RESULT(SELF)
    ! WARNING : Using this function kills performance when the %DATA member is allocated
    TYPE(FIELD_INT4D), TARGET :: SELF
    INTEGER(KIND=JPIM), INTENT(IN) :: SHAPE(3)
    INTEGER(KIND=JPIM), INTENT(IN), OPTIONAL :: NBLOCKS
    ...
    CALL ALLOCATE_FIELD_INT4D (SELF, SHAPE, NBLOCKS, PERSISTENT, LBOUNDS)

  END FUNCTION FIELD_INT4D_ALLOCATE

  SUBROUTINE ALLOCATE_FIELD_INT5D (SELF, SHAPE, NBLOCKS, PERSISTENT, LBOUNDS) 
    ! Create FIELD object by explicitly allocating new data
    !
    ! Please note that SHAPE is the conceptual shape without the block dimension
    TYPE(FIELD_INT5D), TARGET :: SELF
    ...
    SELF%BASE_PTR => NULL()
    SELF%FIDX = -1
  END SUBROUTINE ALLOCATE_FIELD_INT5D

  FUNCTION FIELD_INT5D_ALLOCATE(SHAPE, NBLOCKS, PERSISTENT, LBOUNDS) RESULT(SELF)
    ! WARNING : Using this function kills performance when the %DATA member is allocated
    TYPE(FIELD_INT5D), TARGET :: SELF
    INTEGER(KIND=JPIM), INTENT(IN) :: SHAPE(4)
    INTEGER(KIND=JPIM), INTENT(IN), OPTIONAL :: NBLOCKS
    ...
    CALL ALLOCATE_FIELD_INT5D (SELF, SHAPE, NBLOCKS, PERSISTENT, LBOUNDS)

  END FUNCTION FIELD_INT5D_ALLOCATE

  SUBROUTINE ALLOCATE_FIELD_LOG2D (SELF, SHAPE, NBLOCKS, PERSISTENT, LBOUNDS) 
    ! Create FIELD object by explicitly allocating new data
    !
    ! Please note that SHAPE is the conceptual shape without the block dimension
    TYPE(FIELD_LOG2D), TARGET :: SELF
    ...
    SELF%BASE_PTR => NULL()
    SELF%FIDX = -1
  END SUBROUTINE ALLOCATE_FIELD_LOG2D

  FUNCTION FIELD_LOG2D_ALLOCATE(SHAPE, NBLOCKS, PERSISTENT, LBOUNDS) RESULT(SELF)
    ! WARNING : Using this function kills performance when the %DATA member is allocated
    TYPE(FIELD_LOG2D), TARGET :: SELF
    INTEGER(KIND=JPIM), INTENT(IN) :: SHAPE(1)
    INTEGER(KIND=JPIM), INTENT(IN), OPTIONAL :: NBLOCKS
    ...
    CALL ALLOCATE_FIELD_LOG2D (SELF, SHAPE, NBLOCKS, PERSISTENT, LBOUNDS)

  END FUNCTION FIELD_LOG2D_ALLOCATE

  SUBROUTINE ALLOCATE_FIELD_LOG3D (SELF, SHAPE, NBLOCKS, PERSISTENT, LBOUNDS) 
    ! Create FIELD object by explicitly allocating new data
    !
    ! Please note that SHAPE is the conceptual shape without the block dimension
    TYPE(FIELD_LOG3D), TARGET :: SELF
    ...
    SELF%BASE_PTR => NULL()
    SELF%FIDX = -1
  END SUBROUTINE ALLOCATE_FIELD_LOG3D

  FUNCTION FIELD_LOG3D_ALLOCATE(SHAPE, NBLOCKS, PERSISTENT, LBOUNDS) RESULT(SELF)
    ! WARNING : Using this function kills performance when the %DATA member is allocated
    TYPE(FIELD_LOG3D), TARGET :: SELF
    INTEGER(KIND=JPIM), INTENT(IN) :: SHAPE(2)
    INTEGER(KIND=JPIM), INTENT(IN), OPTIONAL :: NBLOCKS
    ...
    CALL ALLOCATE_FIELD_LOG3D (SELF, SHAPE, NBLOCKS, PERSISTENT, LBOUNDS)

  END FUNCTION FIELD_LOG3D_ALLOCATE

  SUBROUTINE ALLOCATE_FIELD_LOG4D (SELF, SHAPE, NBLOCKS, PERSISTENT, LBOUNDS) 
    ! Create FIELD object by explicitly allocating new data
    !
    ! Please note that SHAPE is the conceptual shape without the block dimension
    TYPE(FIELD_LOG4D), TARGET :: SELF
    ...
    SELF%BASE_PTR => NULL()
    SELF%FIDX = -1
  END SUBROUTINE ALLOCATE_FIELD_LOG4D

  FUNCTION FIELD_LOG4D_ALLOCATE(SHAPE, NBLOCKS, PERSISTENT, LBOUNDS) RESULT(SELF)
    ! WARNING : Using this function kills performance when the %DATA member is allocated
    TYPE(FIELD_LOG4D), TARGET :: SELF
    INTEGER(KIND=JPIM), INTENT(IN) :: SHAPE(3)
    INTEGER(KIND=JPIM), INTENT(IN), OPTIONAL :: NBLOCKS
    ...
    CALL ALLOCATE_FIELD_LOG4D (SELF, SHAPE, NBLOCKS, PERSISTENT, LBOUNDS)

  END FUNCTION FIELD_LOG4D_ALLOCATE

  SUBROUTINE ALLOCATE_FIELD_LOG5D (SELF, SHAPE, NBLOCKS, PERSISTENT, LBOUNDS) 
    ! Create FIELD object by explicitly allocating new data
    !
    ! Please note that SHAPE is the conceptual shape without the block dimension
    TYPE(FIELD_LOG5D), TARGET :: SELF
    ...
    SELF%BASE_PTR => NULL()
    SELF%FIDX = -1
  END SUBROUTINE ALLOCATE_FIELD_LOG5D

  FUNCTION FIELD_LOG5D_ALLOCATE(SHAPE, NBLOCKS, PERSISTENT, LBOUNDS) RESULT(SELF)
    ! WARNING : Using this function kills performance when the %DATA member is allocated
    TYPE(FIELD_LOG5D), TARGET :: SELF
    INTEGER(KIND=JPIM), INTENT(IN) :: SHAPE(4)
    INTEGER(KIND=JPIM), INTENT(IN), OPTIONAL :: NBLOCKS
    ...
    CALL ALLOCATE_FIELD_LOG5D (SELF, SHAPE, NBLOCKS, PERSISTENT, LBOUNDS)
  ...
  SUBROUTINE FIELD_2D_UPDATE_VIEW(SELF, BLOCK_INDEX, BLOCK_SIZE, ZERO)
    ...
    IF (SELF%ACTIVE .AND. SELF%OWNED) THEN
      SELF%VIEW (SELF%LBOUNDS(1):) => SELF%DATA(:,IDX)
    ELSEIF (SELF%ACTIVE .AND. .NOT. SELF%OWNED) THEN
      SELF%VIEW (SELF%LBOUNDS(1):) => SELF%PTR(:,IDX)
    END IF
  ...
  SUBROUTINE FIELD_3D_UPDATE_VIEW(SELF, BLOCK_INDEX, BLOCK_SIZE, ZERO)
    ...
    IF (SELF%THREAD_BUFFER) IDX = OML_MY_THREAD()
    IF (SELF%ACTIVE .AND. SELF%OWNED) THEN
      SELF%VIEW (SELF%LBOUNDS(1):, SELF%LBOUNDS(2):) => SELF%DATA(:,:,IDX)
    ELSEIF (SELF%ACTIVE .AND. .NOT. SELF%OWNED) THEN
      SELF%VIEW (SELF%LBOUNDS(1):, SELF%LBOUNDS(2):) => SELF%PTR(:,:,IDX)
    END IF
  ...
  SUBROUTINE FIELD_4D_UPDATE_VIEW(SELF, BLOCK_INDEX, BLOCK_SIZE, ZERO)
    ...
    IF (SELF%THREAD_BUFFER) IDX = OML_MY_THREAD()
    IF (SELF%ACTIVE .AND. SELF%OWNED) THEN
      SELF%VIEW (SELF%LBOUNDS(1):, SELF%LBOUNDS(2):, SELF%LBOUNDS(3):) => SELF%DATA(:,:,:,IDX)
    ELSEIF (SELF%ACTIVE .AND. .NOT. SELF%OWNED) THEN
      SELF%VIEW (SELF%LBOUNDS(1):, SELF%LBOUNDS(2):, SELF%LBOUNDS(3):) => SELF%PTR(:,:,:,IDX)
    END IF
  ...
  SUBROUTINE FIELD_5D_UPDATE_VIEW(SELF, BLOCK_INDEX, BLOCK_SIZE, ZERO)
    ...
    IF (SELF%THREAD_BUFFER) IDX = OML_MY_THREAD()
    IF (SELF%ACTIVE .AND. SELF%OWNED) THEN
      SELF%VIEW (SELF%LBOUNDS(1):, SELF%LBOUNDS(2):, SELF%LBOUNDS(3):, SELF%LBOUNDS(4):) => SELF%DATA(:,:,:,:,IDX)
    ELSEIF (SELF%ACTIVE .AND. .NOT. SELF%OWNED) THEN
      SELF%VIEW (SELF%LBOUNDS(1):, SELF%LBOUNDS(2):, SELF%LBOUNDS(3):, SELF%LBOUNDS(4):) => SELF%PTR(:,:,:,:,IDX)
    END IF
  ...
  SUBROUTINE FIELD_2D_EXTRACT_VIEW(SELF, VIEW_PTR, BLOCK_INDEX, BLOCK_SIZE, ZERO)
    ...
    IF (SELF%THREAD_BUFFER) IDX = OML_MY_THREAD()
    IF (SELF%ACTIVE .AND. SELF%OWNED) THEN
      VIEW_PTR (SELF%LBOUNDS(1):)  => SELF%DATA(:,IDX)
    ELSEIF (SELF%ACTIVE .AND. .NOT. SELF%OWNED) THEN
      VIEW_PTR (SELF%LBOUNDS(1):) => SELF%PTR(:,IDX)
    ELSE
      VIEW_PTR (SELF%LBOUNDS(1):) => SELF%VIEW  ! Set to NaN'd field buffer
    END IF
  ...
  SUBROUTINE FIELD_3D_EXTRACT_VIEW(SELF, VIEW_PTR, BLOCK_INDEX, BLOCK_SIZE, ZERO)
    ...
    IF (SELF%THREAD_BUFFER) IDX = OML_MY_THREAD()
    IF (SELF%ACTIVE .AND. SELF%OWNED) THEN
      VIEW_PTR (SELF%LBOUNDS(1):, SELF%LBOUNDS(2):)  => SELF%DATA(:,:,IDX)
    ELSEIF (SELF%ACTIVE .AND. .NOT. SELF%OWNED) THEN
      VIEW_PTR (SELF%LBOUNDS(1):, SELF%LBOUNDS(2):) => SELF%PTR(:,:,IDX)
    ELSE
      VIEW_PTR (SELF%LBOUNDS(1):, SELF%LBOUNDS(2):) => SELF%VIEW  ! Set to NaN'd field buffer
    END IF
  ...
  SUBROUTINE FIELD_4D_EXTRACT_VIEW(SELF, VIEW_PTR, BLOCK_INDEX, BLOCK_SIZE, ZERO)
    ...
    IF (SELF%THREAD_BUFFER) IDX = OML_MY_THREAD()
    IF (SELF%ACTIVE .AND. SELF%OWNED) THEN
      VIEW_PTR (SELF%LBOUNDS(1):, SELF%LBOUNDS(2):, SELF%LBOUNDS(3):)  => SELF%DATA(:,:,:,IDX)
    ELSEIF (SELF%ACTIVE .AND. .NOT. SELF%OWNED) THEN
      VIEW_PTR (SELF%LBOUNDS(1):, SELF%LBOUNDS(2):, SELF%LBOUNDS(3):) => SELF%PTR(:,:,:,IDX)
    ELSE
      VIEW_PTR (SELF%LBOUNDS(1):, SELF%LBOUNDS(2):, SELF%LBOUNDS(3):) => SELF%VIEW  ! Set to NaN'd field buffer
    END IF
  ...
  SUBROUTINE FIELD_5D_EXTRACT_VIEW(SELF, VIEW_PTR, BLOCK_INDEX, BLOCK_SIZE, ZERO)
    ...
    IF (SELF%THREAD_BUFFER) IDX = OML_MY_THREAD()
    IF (SELF%ACTIVE .AND. SELF%OWNED) THEN
      VIEW_PTR (SELF%LBOUNDS(1):, SELF%LBOUNDS(2):, SELF%LBOUNDS(3):, SELF%LBOUNDS(4):)  => SELF%DATA(:,:,:,:,IDX)
    ELSEIF (SELF%ACTIVE .AND. .NOT. SELF%OWNED) THEN
      VIEW_PTR (SELF%LBOUNDS(1):, SELF%LBOUNDS(2):, SELF%LBOUNDS(3):, SELF%LBOUNDS(4):) => SELF%PTR(:,:,:,:,IDX)
    ELSE
      VIEW_PTR (SELF%LBOUNDS(1):, SELF%LBOUNDS(2):, SELF%LBOUNDS(3):, SELF%LBOUNDS(4):) => SELF%VIEW  ! Set to NaN'd field buffer
    END IF
...
!$acc enter data create(SELF%DATA)
  ...
  FUNCTION FIELD_2D_GET_DEVICE_DATA(SELF) RESULT(DEVPTR)
    ...
    IF (SELF%OWNED) THEN
      DEVPTR (SELF%LBOUNDS(1):, SELF%LBOUNDS(2):) => SELF%DATA
    ELSE
      DEVPTR (SELF%LBOUNDS(1):, SELF%LBOUNDS(2):) => SELF%DEVPTR
    END IF
  ...
  FUNCTION FIELD_3D_GET_DEVICE_DATA(SELF) RESULT(DEVPTR)
    ...
    IF (SELF%OWNED) THEN
      DEVPTR (SELF%LBOUNDS(1):, SELF%LBOUNDS(2):, SELF%LBOUNDS(3):) => SELF%DATA
    ELSE
      DEVPTR (SELF%LBOUNDS(1):, SELF%LBOUNDS(2):, SELF%LBOUNDS(3):) => SELF%DEVPTR
    END IF
  ...
  FUNCTION FIELD_4D_GET_DEVICE_DATA(SELF) RESULT(DEVPTR)
    ...
    IF (SELF%OWNED) THEN
      DEVPTR (SELF%LBOUNDS(1):, SELF%LBOUNDS(2):, SELF%LBOUNDS(3):, SELF%LBOUNDS(4):) => SELF%DATA
    ELSE
      DEVPTR (SELF%LBOUNDS(1):, SELF%LBOUNDS(2):, SELF%LBOUNDS(3):, SELF%LBOUNDS(4):) => SELF%DEVPTR
    END IF
  ...
  FUNCTION FIELD_5D_GET_DEVICE_DATA(SELF) RESULT(DEVPTR)
    ...
    IF (SELF%OWNED) THEN
      DEVPTR (SELF%LBOUNDS(1):, SELF%LBOUNDS(2):, SELF%LBOUNDS(3):, SELF%LBOUNDS(4):, SELF%LBOUNDS(5):) => SELF%DATA
    ELSE
      DEVPTR (SELF%LBOUNDS(1):, SELF%LBOUNDS(2):, SELF%LBOUNDS(3):, SELF%LBOUNDS(4):, SELF%LBOUNDS(5):) => SELF%DEVPTR
    END IF
