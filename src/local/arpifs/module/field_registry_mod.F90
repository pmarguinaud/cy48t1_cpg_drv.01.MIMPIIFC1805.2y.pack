...
USE FIELD_MODULE, ONLY: FIELD_2D, FIELD_INT2D, FIELD_LOG2D, FIELD_3D, FIELD_4D, FIELD_2D_EMPTY, FIELD_3D_EMPTY, FIELD_4D_EMPTY
...
INTERFACE CREATE_TEMPORARY
  MODULE PROCEDURE CREATE_TEMPORARY_2D, CREATE_TEMPORARY_3D, CREATE_TEMPORARY_4D
