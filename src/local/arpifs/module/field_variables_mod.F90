...
TYPE GEOMETRY_VARIABLES
  ...
  TYPE(VARIABLE_2D) :: OROGLL
  TYPE(VARIABLE_2D) :: OROGMM
  TYPE(VARIABLE_2D) :: OROGLM
  TYPE(VARIABLE_2D) :: RCOLON
  TYPE(VARIABLE_2D) :: RSILON
  TYPE(VARIABLE_2D) :: RINDX
  TYPE(VARIABLE_2D) :: RINDY
  TYPE(VARIABLE_2D) :: RATATH
  TYPE(VARIABLE_2D) :: RATATX
...
TYPE FIELD_VARIABLES
  ...
  TYPE(VARIABLE_3D) :: CSPDNL  ! 
  TYPE(VARIABLE_3D) :: CSPNL  ! 
  TYPE(VARIABLE_3D) :: CSVDPT  ! 
  TYPE(VARIABLE_3D) :: CTNL  ! 
  TYPE(VARIABLE_3D) :: CTPT  ! 
  TYPE(VARIABLE_3D) :: CUNL  ! 
  TYPE(VARIABLE_3D) :: CUPT  ! 
  TYPE(VARIABLE_3D) :: CVNL  ! 
  TYPE(VARIABLE_3D) :: CVPT  ! 
  TYPE(VARIABLE_3D) :: CVWVNL  ! 
  TYPE(VARIABLE_3D) :: DPHI  ! 
  TYPE(VARIABLE_3D) :: EDOT  ! 
  TYPE(VARIABLE_3D) :: GW  ! 
  TYPE(VARIABLE_3D) :: NHX  ! 
  TYPE(VARIABLE_3D) :: NHY  ! 
  TYPE(VARIABLE_3D) :: SGRTL  ! 
  TYPE(VARIABLE_3D) :: SGRTM  ! 
  TYPE(VARIABLE_3D) :: SPDNL  ! 
  TYPE(VARIABLE_3D) :: SPDNL_SI  ! 
  TYPE(VARIABLE_3D) :: SPNL  ! 
  TYPE(VARIABLE_3D) :: SPNL_SI  ! 
  TYPE(VARIABLE_3D) :: SVDNL_SI  ! 
  TYPE(VARIABLE_3D) :: TNL  ! 
  TYPE(VARIABLE_3D) :: TNL_SI  ! 
  TYPE(VARIABLE_3D) :: UNL  ! 
  TYPE(VARIABLE_3D) :: UNL_SI  ! 
  TYPE(VARIABLE_3D) :: VNL  ! 
  TYPE(VARIABLE_3D) :: VNL_SI  ! 
  TYPE(VARIABLE_3D) :: VWVNL  ! 
  TYPE(VARIABLE_2D) :: SP  ! Surface pressure
  TYPE(VARIABLE_2D) :: SPNL2  ! 
  TYPE(VARIABLE_2D) :: PREHYDS  ! 
  TYPE(VARIABLE_2D) :: DBBC  ! 
  TYPE(VARIABLE_2D) :: CSPPT  ! 
  TYPE(VARIABLE_2D) :: CSPNL2  ! 
  TYPE(VARIABLE_2D) :: CSPRHS  ! 
  TYPE(VARIABLE_2D) :: GWS  ! 
