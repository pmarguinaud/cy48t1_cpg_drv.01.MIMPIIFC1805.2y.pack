...
IF (PRESENT (PGFL)) THEN
  CALL SC2PRG (1, YDMODEL%YRML_GCONF%YGFL%YCHEM(:)%MP , YDMODEL%YRML_GCONF%YGFL%NCHEM,    PGFL, ZP1CHEM0, LDDUMM=.TRUE.)    !  YDVARS%CHEM(1)%T0
  CALL SC2PRG (1, YDMODEL%YRML_GCONF%YGFL%YCHEM(:)%MP9, YDMODEL%YRML_GCONF%YGFL%NCHEM,    PGFL, ZP1CHEM9, LDDUMM=.TRUE.)    !  YDVARS%CHEM(1)%T9
  CALL SC2PRG (1, YDMODEL%YRML_GCONF%YGFL%YLIMA(:)%MP , YDMODEL%YRML_GCONF%YGFL%NLIMA,    PGFL, ZP1LIMA0, LDDUMM=.TRUE.)    !  YDVARS%LIMA(1)%T0
  CALL SC2PRG (1, YDMODEL%YRML_GCONF%YGFL%YLIMA(:)%MP9, YDMODEL%YRML_GCONF%YGFL%NLIMA,    PGFL, ZP1LIMA9, LDDUMM=.TRUE.)    !  YDVARS%LIMA(1)%T9
  CALL SC2PRG (1, YDMODEL%YRML_GCONF%YGFL%YEXT(:)%MP  , YDMODEL%YRML_GCONF%YGFL%NGFL_EXT, PGFL, ZP1EXT0 , LDDUMM=.TRUE.)    !  YDVARS%EXT(1)%T0
  CALL SC2PRG (1, YDMODEL%YRML_GCONF%YGFL%YEXT(:)%MP9 , YDMODEL%YRML_GCONF%YGFL%NGFL_EXT, PGFL, ZP1EXT9 , LDDUMM=.TRUE.)    !  YDVARS%EXT(1)%T9

  CALL SC2PRG (1, YDMODEL%YRML_GCONF%YGFL%YNOGW(:)%MP , PGFL ,ZP1NOGW0, LDDUMM=.TRUE.)    !  YDVARS%NOGW(1)%T0
  CALL SC2PRG (1, YDMODEL%YRML_GCONF%YGFL%YNOGW(:)%MP9, PGFL ,ZP1NOGW9, LDDUMM=.TRUE.)    !  YDVARS%NOGW(1)%T9 
  CALL SC2PRG (2, YDMODEL%YRML_GCONF%YGFL%YNOGW(:)%MP , PGFL ,ZP2NOGW0, LDDUMM=.TRUE.)    !  YDVARS%NOGW(2)%T0
  CALL SC2PRG (2, YDMODEL%YRML_GCONF%YGFL%YNOGW(:)%MP9, PGFL ,ZP2NOGW9, LDDUMM=.TRUE.)    !  YDVARS%NOGW(2)%T9 
ENDIF
