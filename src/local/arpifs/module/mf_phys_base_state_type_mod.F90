...
!>REAL (KIND=JPRB)                      :: F (NPROMA, YDCPG_DIM%YRSURF%YSP_GSP_SG)
  TYPE (FIELD_3D), POINTER :: F_F => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: A (:,:) => NULL ()
!>REAL (KIND=JPRB)                      :: A (NPROMA, YDCPG_DIM%YRSURF%YSP_GSP_SG)
  TYPE (FIELD_3D), POINTER :: F_A => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: R (:,:) => NULL ()
!>REAL (KIND=JPRB)                      :: R (NPROMA, YDCPG_DIM%YRSURF%YSP_GSP_SG)
...
!>REAL (KIND=JPRB)                      :: Q (NPROMA, YDCPG_DIM%YRSURF%YSP_GSP_SB)
  TYPE (FIELD_3D), POINTER :: F_Q => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: TL (:,:) => NULL ()
!>REAL (KIND=JPRB)                      :: TL (NPROMA, YDCPG_DIM%YRSURF%YSP_GSP_SB)
  TYPE (FIELD_3D), POINTER :: F_TL => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: T (:,:) => NULL ()
!>REAL (KIND=JPRB)                      :: T (NPROMA, YDCPG_DIM%YRSURF%YSP_GSP_SB)
