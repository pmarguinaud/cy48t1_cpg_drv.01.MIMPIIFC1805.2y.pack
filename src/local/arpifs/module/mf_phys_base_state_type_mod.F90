...
IF (LTWOTL) THEN
  ...
  SELF%CVV => YDVARS%CVV%T0
  SELF%F_CVV => YDVARS%CVV%FT0
  SELF%DIV => YDVARS%DIV%T0
  SELF%F_DIV => YDVARS%DIV%FT0
  SELF%EFB1 => YDVARS%EFB1%T0
  SELF%F_EFB1 => YDVARS%EFB1%FT0
  SELF%EFB2 => YDVARS%EFB2%T0
  SELF%F_EFB2 => YDVARS%EFB2%FT0
  SELF%EFB3 => YDVARS%EFB3%T0
...
ELSE
  ...
  SELF%CVV => YDVARS%CVV%T9
  SELF%F_CVV => YDVARS%CVV%FT9
  SELF%DIV => YDVARS%DIV%T9
  SELF%F_DIV => YDVARS%DIV%FT9
  SELF%EFB1 => YDVARS%EFB1%T9
  SELF%F_EFB1 => YDVARS%EFB1%FT9
  SELF%EFB2 => YDVARS%EFB2%T9
  SELF%F_EFB2 => YDVARS%EFB2%FT9
  SELF%EFB3 => YDVARS%EFB3%T9
