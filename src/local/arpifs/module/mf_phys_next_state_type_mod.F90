...
!>REAL (KIND=JPRB)                      :: U (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_U => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: V (:, :) => NULL ()
!>REAL (KIND=JPRB)                      :: V (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_V => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: T (:, :) => NULL ()
!>REAL (KIND=JPRB)                      :: T (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_T => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: SVD (:, :) => NULL ()
!>REAL (KIND=JPRB)                      :: SVD (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
...
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: Q (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_Q => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: I (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: I (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_I => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: L (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: L (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_L => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: LCONV (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: LCONV (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_LCONV => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: ICONV (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: ICONV (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_ICONV => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: RCONV (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: RCONV (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_RCONV => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: SCONV (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: SCONV (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_SCONV => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: IRAD (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: IRAD (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_IRAD => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: LRAD (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: LRAD (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_LRAD => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: S (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: S (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_S => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: R (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: R (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_R => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: G (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: G (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_G => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: H (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: H (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_H => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: TKE (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: TKE (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_TKE => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: TTE (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: TTE (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_TTE => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: EFB1 (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: EFB1 (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_EFB1 => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: EFB2 (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: EFB2 (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_EFB2 => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: EFB3 (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: EFB3 (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_EFB3 => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: A (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: A (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_A => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: O3 (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: O3 (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_O3 => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: SRC (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: SRC (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_SRC => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: MXL (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: MXL (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_MXL => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: SHTUR (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: SHTUR (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_SHTUR => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: FQTUR (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: FQTUR (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_FQTUR => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: FSTUR (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: FSTUR (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_FSTUR => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: CPF (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: CPF (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_CPF => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: SPF (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: SPF (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_SPF => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: CVGQ (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: CVGQ (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_CVGQ => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: QVA (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: QVA (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_QVA => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: LRCH4 (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: LRCH4 (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_LRCH4 => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: PHYCTY (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: PHYCTY (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_PHYCTY => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: RSPEC (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: RSPEC (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_RSPEC => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: SDSAT (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: SDSAT (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_SDSAT => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: CVV (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: CVV (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_CVV => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: RKTH (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: RKTH (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_RKTH => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: RKTQV (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: RKTQV (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_RKTQV => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: RKTQC (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: RKTQC (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_RKTQC => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: UOM (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: UOM (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_UOM => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: UAL (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: UAL (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_UAL => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: DOM (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: DOM (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_DOM => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: DAL (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: DAL (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_DAL => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: UEN (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: UEN (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_UEN => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: UNEBH (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: UNEBH (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_UNEBH => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: FSD (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: FSD (NPROMA,YDCPG_DIM%ILEVT1I:YDCPG_DIM%ILEVT1F)
