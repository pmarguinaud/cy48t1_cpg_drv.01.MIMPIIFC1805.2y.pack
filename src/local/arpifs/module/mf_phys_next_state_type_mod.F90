...
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: Q (NPROMA,YDCPG_DIM%VARS%Q%ILEVT1I:YDCPG_DIM%VARS%Q%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_Q => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: I (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: I (NPROMA,YDCPG_DIM%VARS%I%ILEVT1I:YDCPG_DIM%VARS%I%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_I => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: L (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: L (NPROMA,YDCPG_DIM%VARS%L%ILEVT1I:YDCPG_DIM%VARS%L%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_L => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: LCONV (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: LCONV (NPROMA,YDCPG_DIM%VARS%LCONV%ILEVT1I:YDCPG_DIM%VARS%LCONV%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_LCONV => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: ICONV (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: ICONV (NPROMA,YDCPG_DIM%VARS%ICONV%ILEVT1I:YDCPG_DIM%VARS%ICONV%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_ICONV => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: RCONV (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: RCONV (NPROMA,YDCPG_DIM%VARS%RCONV%ILEVT1I:YDCPG_DIM%VARS%RCONV%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_RCONV => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: SCONV (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: SCONV (NPROMA,YDCPG_DIM%VARS%SCONV%ILEVT1I:YDCPG_DIM%VARS%SCONV%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_SCONV => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: IRAD (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: IRAD (NPROMA,YDCPG_DIM%VARS%IRAD%ILEVT1I:YDCPG_DIM%VARS%IRAD%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_IRAD => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: LRAD (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: LRAD (NPROMA,YDCPG_DIM%VARS%LRAD%ILEVT1I:YDCPG_DIM%VARS%LRAD%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_LRAD => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: S (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: S (NPROMA,YDCPG_DIM%VARS%S%ILEVT1I:YDCPG_DIM%VARS%S%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_S => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: R (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: R (NPROMA,YDCPG_DIM%VARS%R%ILEVT1I:YDCPG_DIM%VARS%R%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_R => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: G (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: G (NPROMA,YDCPG_DIM%VARS%G%ILEVT1I:YDCPG_DIM%VARS%G%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_G => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: H (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: H (NPROMA,YDCPG_DIM%VARS%H%ILEVT1I:YDCPG_DIM%VARS%H%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_H => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: TKE (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: TKE (NPROMA,YDCPG_DIM%VARS%TKE%ILEVT1I:YDCPG_DIM%VARS%TKE%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_TKE => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: TTE (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: TTE (NPROMA,YDCPG_DIM%VARS%TTE%ILEVT1I:YDCPG_DIM%VARS%TTE%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_TTE => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: EFB1 (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: EFB1 (NPROMA,YDCPG_DIM%VARS%EFB1%ILEVT1I:YDCPG_DIM%VARS%EFB1%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_EFB1 => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: EFB2 (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: EFB2 (NPROMA,YDCPG_DIM%VARS%EFB2%ILEVT1I:YDCPG_DIM%VARS%EFB2%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_EFB2 => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: EFB3 (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: EFB3 (NPROMA,YDCPG_DIM%VARS%EFB3%ILEVT1I:YDCPG_DIM%VARS%EFB3%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_EFB3 => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: A (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: A (NPROMA,YDCPG_DIM%VARS%A%ILEVT1I:YDCPG_DIM%VARS%A%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_A => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: O3 (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: O3 (NPROMA,YDCPG_DIM%VARS%O3%ILEVT1I:YDCPG_DIM%VARS%O3%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_O3 => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: SRC (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: SRC (NPROMA,YDCPG_DIM%VARS%SRC%ILEVT1I:YDCPG_DIM%VARS%SRC%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_SRC => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: MXL (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: MXL (NPROMA,YDCPG_DIM%VARS%MXL%ILEVT1I:YDCPG_DIM%VARS%MXL%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_MXL => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: SHTUR (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: SHTUR (NPROMA,YDCPG_DIM%VARS%SHTUR%ILEVT1I:YDCPG_DIM%VARS%SHTUR%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_SHTUR => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: FQTUR (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: FQTUR (NPROMA,YDCPG_DIM%VARS%FQTUR%ILEVT1I:YDCPG_DIM%VARS%FQTUR%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_FQTUR => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: FSTUR (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: FSTUR (NPROMA,YDCPG_DIM%VARS%FSTUR%ILEVT1I:YDCPG_DIM%VARS%FSTUR%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_FSTUR => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: CPF (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: CPF (NPROMA,YDCPG_DIM%VARS%CPF%ILEVT1I:YDCPG_DIM%VARS%CPF%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_CPF => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: SPF (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: SPF (NPROMA,YDCPG_DIM%VARS%SPF%ILEVT1I:YDCPG_DIM%VARS%SPF%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_SPF => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: CVGQ (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: CVGQ (NPROMA,YDCPG_DIM%VARS%CVGQ%ILEVT1I:YDCPG_DIM%VARS%CVGQ%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_CVGQ => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: QVA (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: QVA (NPROMA,YDCPG_DIM%VARS%QVA%ILEVT1I:YDCPG_DIM%VARS%QVA%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_QVA => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: LRCH4 (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: LRCH4 (NPROMA,YDCPG_DIM%VARS%LRCH4%ILEVT1I:YDCPG_DIM%VARS%LRCH4%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_LRCH4 => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: PHYCTY (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: PHYCTY (NPROMA,YDCPG_DIM%VARS%PHYCTY%ILEVT1I:YDCPG_DIM%VARS%PHYCTY%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_PHYCTY => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: RSPEC (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: RSPEC (NPROMA,YDCPG_DIM%VARS%RSPEC%ILEVT1I:YDCPG_DIM%VARS%RSPEC%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_RSPEC => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: SDSAT (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: SDSAT (NPROMA,YDCPG_DIM%VARS%SDSAT%ILEVT1I:YDCPG_DIM%VARS%SDSAT%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_SDSAT => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: CVV (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: CVV (NPROMA,YDCPG_DIM%VARS%CVV%ILEVT1I:YDCPG_DIM%VARS%CVV%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_CVV => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: RKTH (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: RKTH (NPROMA,YDCPG_DIM%VARS%RKTH%ILEVT1I:YDCPG_DIM%VARS%RKTH%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_RKTH => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: RKTQV (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: RKTQV (NPROMA,YDCPG_DIM%VARS%RKTQV%ILEVT1I:YDCPG_DIM%VARS%RKTQV%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_RKTQV => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: RKTQC (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: RKTQC (NPROMA,YDCPG_DIM%VARS%RKTQC%ILEVT1I:YDCPG_DIM%VARS%RKTQC%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_RKTQC => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: UOM (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: UOM (NPROMA,YDCPG_DIM%VARS%UOM%ILEVT1I:YDCPG_DIM%VARS%UOM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_UOM => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: UAL (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: UAL (NPROMA,YDCPG_DIM%VARS%UAL%ILEVT1I:YDCPG_DIM%VARS%UAL%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_UAL => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: DOM (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: DOM (NPROMA,YDCPG_DIM%VARS%DOM%ILEVT1I:YDCPG_DIM%VARS%DOM%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_DOM => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: DAL (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: DAL (NPROMA,YDCPG_DIM%VARS%DAL%ILEVT1I:YDCPG_DIM%VARS%DAL%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_DAL => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: UEN (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: UEN (NPROMA,YDCPG_DIM%VARS%UEN%ILEVT1I:YDCPG_DIM%VARS%UEN%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_UEN => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: UNEBH (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: UNEBH (NPROMA,YDCPG_DIM%VARS%UNEBH%ILEVT1I:YDCPG_DIM%VARS%UNEBH%ILEVT1F)
  TYPE (FIELD_3D), POINTER :: F_UNEBH => NULL ()
  REAL (KIND=JPRB), POINTER, CONTIGUOUS :: FSD (:, :) => NULL ()
!>REAL (KIND=JPRB), POINTER, CONTIGUOUS :: FSD (NPROMA,YDCPG_DIM%VARS%FSD%ILEVT1I:YDCPG_DIM%VARS%FSD%ILEVT1F)
...
IF (ASSOCIATED (SELF%F_V)) THEN
  SELF%U (1:, SELF%DIMS%V%ILEVT1I:) => SELF%F_V%GET_VIEW (BLOCK_INDEX)
ENDIF

IF (ASSOCIATED (SELF%F_T)) THEN
  SELF%U (1:, SELF%DIMS%T%ILEVT1I:) => SELF%F_T%GET_VIEW (BLOCK_INDEX)
ENDIF

IF (ASSOCIATED (SELF%F_SVD)) THEN
  SELF%U (1:, SELF%DIMS%SVD%ILEVT1I:) => SELF%F_SVD%GET_VIEW (BLOCK_INDEX)
ENDIF
