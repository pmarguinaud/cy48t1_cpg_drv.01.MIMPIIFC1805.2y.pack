...
IF (LDT0) THEN
  ...
  IF (ASSOCIATED (P1EXT0 )) SELF%P1EXT  => ZP1EXT0
  IF (ASSOCIATED (P1CHEM0)) SELF%P1CHEM => ZP1CHEM0
  IF (ASSOCIATED (P1NOGW0)) SELF%P1NOGW => ZP1NOGW0
  IF (ASSOCIATED (P2NOGW0)) SELF%P2NOGW => ZP2NOGW0
  IF (ASSOCIATED (P1LIMA0)) SELF%P1LIMA => ZP1LIMA0
...
ELSE
  ...
  IF (ASSOCIATED (P1EXT9 )) SELF%P1EXT  => ZP1EXT9
  IF (ASSOCIATED (P1CHEM9)) SELF%P1CHEM => ZP1CHEM9
  IF (ASSOCIATED (P1NOGW9)) SELF%P1NOGW => ZP1NOGW9
  IF (ASSOCIATED (P2NOGW9)) SELF%P2NOGW => ZP2NOGW9
  IF (ASSOCIATED (P1LIMA9)) SELF%P1LIMA => ZP1LIMA9
