...
!>REAL (KIND=JPRB)                      :: FCHSP (NPROMA, 1:YDCPG_DIM%YRSURF%YSP_SBD%NLEVS)
...
SELF%F_FCHSP => CREATE_TEMPORARY ("FCHSP", GEOM=REGISTRY%GEOM, NLEV=YDCPG_DIM%YRSURF%YSP_SBD%NLEVS, PERSISTENT=PERSISTENT)
