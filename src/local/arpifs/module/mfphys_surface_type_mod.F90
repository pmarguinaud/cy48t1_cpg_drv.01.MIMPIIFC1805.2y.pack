...
MODULE MFPHYS_SURFACE_TYPE_MOD
...
CONTAINS
  PROCEDURE :: INIT => MFPHYS_SURF_TYPE_INIT
  PROCEDURE :: UPDATE_VIEW => MFPHYS_SURF_TYPE_UPDATE_VIEW
  PROCEDURE :: SET9TO0 => MFPHYS_SURF_TYPE_SET9TO0
  PROCEDURE :: SET1TO9 => MFPHYS_SURF_TYPE_SET1TO9
  PROCEDURE :: SET1TO0 => MFPHYS_SURF_TYPE_SET1TO0
  PROCEDURE :: SET0TO1 => MFPHYS_SURF_TYPE_SET0TO1
  PROCEDURE :: PHTFILT => MFPHYS_SURF_TYPE_PHTFILT
  PROCEDURE :: FINAL => MFPHYS_SURF_TYPE_FINAL
END TYPE MFPHYS_SURF_TYPE


CONTAINS

  SUBROUTINE MFPHYS_SURF_TYPE_INIT(SELF, SURFVARS)
    CLASS(MFPHYS_SURF_TYPE) :: SELF
  ...
  END SUBROUTINE MFPHYS_SURF_TYPE_INIT

  SUBROUTINE MFPHYS_SURF_TYPE_UPDATE_VIEW(SELF, BLOCK_INDEX)
  ...
  END SUBROUTINE MFPHYS_SURF_TYPE_UPDATE_VIEW

  SUBROUTINE MFPHYS_SURF_TYPE_SET9TO0(SELF)
  ...
  END SUBROUTINE MFPHYS_SURF_TYPE_SET9TO0

  SUBROUTINE MFPHYS_SURF_TYPE_SET1TO9(SELF)
    ! Field update operation for timestepping schemes
    CLASS(MFPHYS_SURF_TYPE) :: SELF
  ...
  END SUBROUTINE MFPHYS_SURF_TYPE_SET1TO9

  SUBROUTINE MFPHYS_SURF_TYPE_SET1TO0(SELF)
    ! Field update operation for timestepping schemes
    CLASS(MFPHYS_SURF_TYPE) :: SELF
  ...
  END SUBROUTINE MFPHYS_SURF_TYPE_SET1TO0

  SUBROUTINE MFPHYS_SURF_TYPE_SET0TO1(SELF)
    ! Field update operation for timestepping schemes
    CLASS(MFPHYS_SURF_TYPE) :: SELF
  ...
  END SUBROUTINE MFPHYS_SURF_TYPE_SET0TO1

  SUBROUTINE MFPHYS_SURF_TYPE_PHTFILT(SELF, YDDYN)
    ! Field update operation for timestepping schemes
    CLASS(MFPHYS_SURF_TYPE) :: SELF
  ...
  END SUBROUTINE MFPHYS_SURF_TYPE_PHTFILT

  SUBROUTINE MFPHYS_SURF_TYPE_FINAL(SELF)
    ! Finalize underlying field storage
    CLASS(MFPHYS_SURF_TYPE) :: SELF

  END SUBROUTINE MFPHYS_SURF_TYPE_FINAL

END MODULE MFPHYS_SURFACE_TYPE_MOD
