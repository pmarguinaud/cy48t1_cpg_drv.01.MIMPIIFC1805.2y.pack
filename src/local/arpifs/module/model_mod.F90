...
!YRRO              => SELF%YRRO
YRCST             => SELF%YRCST
YRDYNA            => SELF%YRML_DYN%YRDYNA
YRTHF             => SELF%YRML_PHY_EC%YRTHF
...
USE YOMCST,       ONLY : TCST_INIT
USE YOETHF,       ONLY : TTHF_INIT
...
SELF%YRML_PHY_EC%YRTHF = TTHF_INIT ()
