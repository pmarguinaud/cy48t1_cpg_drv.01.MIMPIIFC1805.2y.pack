...
!>REAL(KIND=JPRB)          :: PT_T0 (YDCPG_OPTS%KLON, YDCPG_OPTS%YRSURF_DIMS%YSP_SBD%NLEVS)
!>REAL(KIND=JPRB)          :: PT_T1 (YDCPG_OPTS%KLON, YDCPG_OPTS%YRSURF_DIMS%YSP_SBD%NLEVS)
!>REAL(KIND=JPRB)          :: PT_T9 (YDCPG_OPTS%KLON, YDCPG_OPTS%YRSURF_DIMS%YSP_SBD%NLEVS)
...
!>REAL(KIND=JPRB)          :: PQ_T0 (YDCPG_OPTS%KLON, YDCPG_OPTS%YRSURF_DIMS%YSP_SBD%NLEVS)
!>REAL(KIND=JPRB)          :: PQ_T1 (YDCPG_OPTS%KLON, YDCPG_OPTS%YRSURF_DIMS%YSP_SBD%NLEVS)
!>REAL(KIND=JPRB)          :: PQ_T9 (YDCPG_OPTS%KLON, YDCPG_OPTS%YRSURF_DIMS%YSP_SBD%NLEVS)
...
!>REAL(KIND=JPRB)          :: PTL_T0 (YDCPG_OPTS%KLON, YDCPG_OPTS%YRSURF_DIMS%YSP_SBD%NLEVS)
!>REAL(KIND=JPRB)          :: PTL_T1 (YDCPG_OPTS%KLON, YDCPG_OPTS%YRSURF_DIMS%YSP_SBD%NLEVS)
!>REAL(KIND=JPRB)          :: PTL_T9 (YDCPG_OPTS%KLON, YDCPG_OPTS%YRSURF_DIMS%YSP_SBD%NLEVS)
...
!>REAL(KIND=JPRB)          :: PF_T0 (YDCPG_OPTS%KLON, YDCPG_OPTS%YRSURF_DIMS%YSP_SGD%NLEVS)
!>REAL(KIND=JPRB)          :: PF_T1 (YDCPG_OPTS%KLON, YDCPG_OPTS%YRSURF_DIMS%YSP_SGD%NLEVS)
!>REAL(KIND=JPRB)          :: PF_T9 (YDCPG_OPTS%KLON, YDCPG_OPTS%YRSURF_DIMS%YSP_SGD%NLEVS)
  REAL(KIND=JPRB), POINTER :: PA_T0(:,:)   ! snow albedo
  REAL(KIND=JPRB), POINTER :: PA_T1(:,:)   ! snow albedo
  REAL(KIND=JPRB), POINTER :: PA_T9(:,:)   ! snow albedo
!>REAL(KIND=JPRB)          :: PA_T0 (YDCPG_OPTS%KLON, YDCPG_OPTS%YRSURF_DIMS%YSP_SGD%NLEVS)
!>REAL(KIND=JPRB)          :: PA_T1 (YDCPG_OPTS%KLON, YDCPG_OPTS%YRSURF_DIMS%YSP_SGD%NLEVS)
!>REAL(KIND=JPRB)          :: PA_T9 (YDCPG_OPTS%KLON, YDCPG_OPTS%YRSURF_DIMS%YSP_SGD%NLEVS)
...
!>REAL(KIND=JPRB)          :: PR_T0 (YDCPG_OPTS%KLON, YDCPG_OPTS%YRSURF_DIMS%YSP_SGD%NLEVS)
!>REAL(KIND=JPRB)          :: PR_T1 (YDCPG_OPTS%KLON, YDCPG_OPTS%YRSURF_DIMS%YSP_SGD%NLEVS)
!>REAL(KIND=JPRB)          :: PR_T9 (YDCPG_OPTS%KLON, YDCPG_OPTS%YRSURF_DIMS%YSP_SGD%NLEVS)
...
!>REAL(KIND=JPRB)          :: PT_T0 (YDCPG_OPTS%KLON, YDCPG_OPTS%YRSURF_DIMS%YSP_SGD%NLEVS)
!>REAL(KIND=JPRB)          :: PT_T1 (YDCPG_OPTS%KLON, YDCPG_OPTS%YRSURF_DIMS%YSP_SGD%NLEVS)
!>REAL(KIND=JPRB)          :: PT_T9 (YDCPG_OPTS%KLON, YDCPG_OPTS%YRSURF_DIMS%YSP_SGD%NLEVS)
...
!>REAL(KIND=JPRB)          :: PW_T0 (YDCPG_OPTS%KLON, YDCPG_OPTS%YRSURF_DIMS%YSP_SGD%NLEVS)
!>REAL(KIND=JPRB)          :: PW_T1 (YDCPG_OPTS%KLON, YDCPG_OPTS%YRSURF_DIMS%YSP_SGD%NLEVS)
!>REAL(KIND=JPRB)          :: PW_T9 (YDCPG_OPTS%KLON, YDCPG_OPTS%YRSURF_DIMS%YSP_SGD%NLEVS)
  REAL(KIND=JPRB), POINTER :: PGROUP(:,:,:)
...
!>REAL(KIND=JPRB)          :: PLICT_T0 (YDCPG_OPTS%KLON)
!>REAL(KIND=JPRB)          :: PLICT_T1 (YDCPG_OPTS%KLON)
!>REAL(KIND=JPRB)          :: PLICT_T9 (YDCPG_OPTS%KLON)
...
!>REAL(KIND=JPRB)          :: PLMLT_T0 (YDCPG_OPTS%KLON)
!>REAL(KIND=JPRB)          :: PLMLT_T1 (YDCPG_OPTS%KLON)
!>REAL(KIND=JPRB)          :: PLMLT_T9 (YDCPG_OPTS%KLON)
...
!>REAL(KIND=JPRB)          :: PLTLT_T0 (YDCPG_OPTS%KLON)
!>REAL(KIND=JPRB)          :: PLTLT_T1 (YDCPG_OPTS%KLON)
!>REAL(KIND=JPRB)          :: PLTLT_T9 (YDCPG_OPTS%KLON)
...
!>REAL(KIND=JPRB)          :: PLBLT_T0 (YDCPG_OPTS%KLON)
!>REAL(KIND=JPRB)          :: PLBLT_T1 (YDCPG_OPTS%KLON)
!>REAL(KIND=JPRB)          :: PLBLT_T9 (YDCPG_OPTS%KLON)
...
!>REAL(KIND=JPRB)          :: PLSHF_T0 (YDCPG_OPTS%KLON)
!>REAL(KIND=JPRB)          :: PLSHF_T1 (YDCPG_OPTS%KLON)
!>REAL(KIND=JPRB)          :: PLSHF_T9 (YDCPG_OPTS%KLON)
...
!>REAL(KIND=JPRB)          :: PLICD_T0 (YDCPG_OPTS%KLON)
!>REAL(KIND=JPRB)          :: PLICD_T1 (YDCPG_OPTS%KLON)
!>REAL(KIND=JPRB)          :: PLICD_T9 (YDCPG_OPTS%KLON)
...
!>REAL(KIND=JPRB)          :: PLMLD_T0 (YDCPG_OPTS%KLON)
!>REAL(KIND=JPRB)          :: PLMLD_T1 (YDCPG_OPTS%KLON)
!>REAL(KIND=JPRB)          :: PLMLD_T9 (YDCPG_OPTS%KLON)
  REAL(KIND=JPRB), POINTER :: PGROUP(:,:)
...
!>REAL(KIND=JPRB)          :: PT_T0 (YDCPG_OPTS%KLON)
!>REAL(KIND=JPRB)          :: PT_T1 (YDCPG_OPTS%KLON)
!>REAL(KIND=JPRB)          :: PT_T9 (YDCPG_OPTS%KLON)
...
!>REAL(KIND=JPRB)          :: PW_T0 (YDCPG_OPTS%KLON)
!>REAL(KIND=JPRB)          :: PW_T1 (YDCPG_OPTS%KLON)
!>REAL(KIND=JPRB)          :: PW_T9 (YDCPG_OPTS%KLON)
...
!>REAL(KIND=JPRB)          :: PFC_T0 (YDCPG_OPTS%KLON)
!>REAL(KIND=JPRB)          :: PFC_T1 (YDCPG_OPTS%KLON)
!>REAL(KIND=JPRB)          :: PFC_T9 (YDCPG_OPTS%KLON)
...
!>REAL(KIND=JPRB)          :: PIC_T0 (YDCPG_OPTS%KLON)
!>REAL(KIND=JPRB)          :: PIC_T1 (YDCPG_OPTS%KLON)
!>REAL(KIND=JPRB)          :: PIC_T9 (YDCPG_OPTS%KLON)
...
!>REAL(KIND=JPRB)          :: PFP1_T0 (YDCPG_OPTS%KLON)
!>REAL(KIND=JPRB)          :: PFP1_T1 (YDCPG_OPTS%KLON)
!>REAL(KIND=JPRB)          :: PFP1_T9 (YDCPG_OPTS%KLON)
  REAL(KIND=JPRB), POINTER :: PGROUP(:,:)
...
!>REAL(KIND=JPRB)          :: PTCLS_T0 (YDCPG_OPTS%KLON)
!>REAL(KIND=JPRB)          :: PTCLS_T1 (YDCPG_OPTS%KLON)
!>REAL(KIND=JPRB)          :: PTCLS_T9 (YDCPG_OPTS%KLON)
...
!>REAL(KIND=JPRB)          :: PHUCLS_T0 (YDCPG_OPTS%KLON)
!>REAL(KIND=JPRB)          :: PHUCLS_T1 (YDCPG_OPTS%KLON)
!>REAL(KIND=JPRB)          :: PHUCLS_T9 (YDCPG_OPTS%KLON)
...
!>REAL(KIND=JPRB)          :: PUCLS_T0 (YDCPG_OPTS%KLON)
!>REAL(KIND=JPRB)          :: PUCLS_T1 (YDCPG_OPTS%KLON)
!>REAL(KIND=JPRB)          :: PUCLS_T9 (YDCPG_OPTS%KLON)
...
!>REAL(KIND=JPRB)          :: PVCLS_T0 (YDCPG_OPTS%KLON)
!>REAL(KIND=JPRB)          :: PVCLS_T1 (YDCPG_OPTS%KLON)
!>REAL(KIND=JPRB)          :: PVCLS_T9 (YDCPG_OPTS%KLON)
...
!>REAL(KIND=JPRB)          :: PNUCLS_T0 (YDCPG_OPTS%KLON)
!>REAL(KIND=JPRB)          :: PNUCLS_T1 (YDCPG_OPTS%KLON)
!>REAL(KIND=JPRB)          :: PNUCLS_T9 (YDCPG_OPTS%KLON)
...
!>REAL(KIND=JPRB)          :: PNVCLS_T0 (YDCPG_OPTS%KLON)
!>REAL(KIND=JPRB)          :: PNVCLS_T1 (YDCPG_OPTS%KLON)
!>REAL(KIND=JPRB)          :: PNVCLS_T9 (YDCPG_OPTS%KLON)
  REAL(KIND=JPRB), POINTER :: PGROUP(:,:)
...
!>REAL(KIND=JPRB)          :: PTO_T0 (YDCPG_OPTS%KLON, YDCPG_OPTS%YRSURF_DIMS%YSP_OMD%NLEVS)
!>REAL(KIND=JPRB)          :: PTO_T1 (YDCPG_OPTS%KLON, YDCPG_OPTS%YRSURF_DIMS%YSP_OMD%NLEVS)
!>REAL(KIND=JPRB)          :: PTO_T9 (YDCPG_OPTS%KLON, YDCPG_OPTS%YRSURF_DIMS%YSP_OMD%NLEVS)
  REAL(KIND=JPRB), POINTER :: PSO_T0(:,:)   ! salinity
  REAL(KIND=JPRB), POINTER :: PSO_T1(:,:)   ! salinity
  REAL(KIND=JPRB), POINTER :: PSO_T9(:,:)   ! salinity
!>REAL(KIND=JPRB)          :: PSO_T0 (YDCPG_OPTS%KLON, YDCPG_OPTS%YRSURF_DIMS%YSP_OMD%NLEVS)
!>REAL(KIND=JPRB)          :: PSO_T1 (YDCPG_OPTS%KLON, YDCPG_OPTS%YRSURF_DIMS%YSP_OMD%NLEVS)
!>REAL(KIND=JPRB)          :: PSO_T9 (YDCPG_OPTS%KLON, YDCPG_OPTS%YRSURF_DIMS%YSP_OMD%NLEVS)
  REAL(KIND=JPRB), POINTER :: PUO_T0(:,:)   ! U velocity
  REAL(KIND=JPRB), POINTER :: PUO_T1(:,:)   ! U velocity
  REAL(KIND=JPRB), POINTER :: PUO_T9(:,:)   ! U velocity
!>REAL(KIND=JPRB)          :: PUO_T0 (YDCPG_OPTS%KLON, YDCPG_OPTS%YRSURF_DIMS%YSP_OMD%NLEVS)
!>REAL(KIND=JPRB)          :: PUO_T1 (YDCPG_OPTS%KLON, YDCPG_OPTS%YRSURF_DIMS%YSP_OMD%NLEVS)
!>REAL(KIND=JPRB)          :: PUO_T9 (YDCPG_OPTS%KLON, YDCPG_OPTS%YRSURF_DIMS%YSP_OMD%NLEVS)
  REAL(KIND=JPRB), POINTER :: PVO_T0(:,:)   ! V velocity
  REAL(KIND=JPRB), POINTER :: PVO_T1(:,:)   ! V velocity
  REAL(KIND=JPRB), POINTER :: PVO_T9(:,:)   ! V velocity
!>REAL(KIND=JPRB)          :: PVO_T0 (YDCPG_OPTS%KLON, YDCPG_OPTS%YRSURF_DIMS%YSP_OMD%NLEVS)
!>REAL(KIND=JPRB)          :: PVO_T1 (YDCPG_OPTS%KLON, YDCPG_OPTS%YRSURF_DIMS%YSP_OMD%NLEVS)
!>REAL(KIND=JPRB)          :: PVO_T9 (YDCPG_OPTS%KLON, YDCPG_OPTS%YRSURF_DIMS%YSP_OMD%NLEVS)
  REAL(KIND=JPRB), POINTER :: PGROUP(:,:,:)
