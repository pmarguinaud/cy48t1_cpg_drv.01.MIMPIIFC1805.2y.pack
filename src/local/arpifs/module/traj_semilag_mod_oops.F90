...
IF (YRDYNA%LSLHD.AND.(.NOT.YRDYNA%LSLHD_STATIC) .AND.  .NOT. (ASSOCIATED(SELF%PKAPPA5 )))&
     & WRITE(0,*) 'WTF isnt semilag traj PKAPPA5) allocated in blk ',KBLKNUM
IF (YRDYNA%LSLHD.AND.(.NOT.YRDYNA%LSLHD_STATIC) .AND. YDDYN%LSLHDHEAT .AND.  .NOT. (ASSOCIATED(SELF%PKAPPAT5))) &
