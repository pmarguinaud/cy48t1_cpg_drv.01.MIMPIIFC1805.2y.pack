...
CALL GNHPRE(NPDVAR,YDGEOMETRY,KPROMA,NFLEVG,KSTART,KEND,PSPD,ZPIF,PNHPREF=ZNHPREF,PNHPPI=ZNHPPI,PRNHPPI=ZRNHPPI)
...
CALL GNHGRPRE(NPDVAR,YDGEOMETRY,KPROMA,NFLEVG,KSTART,KEND,ZXYB(:,:,YYTXYB%M_RTGR),ZPISL,ZPISM,&
