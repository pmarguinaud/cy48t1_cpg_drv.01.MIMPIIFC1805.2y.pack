...
CONTAINS
  ...
  FUNCTION VARIABLE_2D_INIT(NAME, CNAME, IGRBCODE, LACTIVE, LADV, LT1, LT9, LPH9, LDL, LDM, LDL9, LDM9) RESULT(SELF)
    ...
    LOGICAL, OPTIONAL, INTENT(IN) :: LACTIVE, LADV, LT1, LT9, LPH9, LDL, LDM, LDL9, LDM9
  ...
  FUNCTION VARIABLE_3D_INIT(NAME, CNAME, IGRBCODE, LACTIVE, LADV, LT1, LT9, LPH9, LDL, LDM, LDL9, LDM9) RESULT(SELF)
    ! Templated constructor that creates new instances
  ...
  FUNCTION VARIABLE_4D_INIT(NAME, CNAME, IGRBCODE, LACTIVE, LADV, LT1, LT9, LPH9, LDL, LDM, LDL9, LDM9) RESULT(SELF)
    ! Templated constructor that creates new instances
