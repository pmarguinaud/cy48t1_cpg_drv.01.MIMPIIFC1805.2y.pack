...
IF (LNHDYN.AND.LNHX) YDELBC_FIELDS%MGMV0(YDELBC_FIELDS%YYTGMVCPL%MNHX)=YDGMV%YT0%MNHX
IF (NCONF /= 701) THEN
...
IF (LNHDYN.AND.LNHX) YDELBC_FIELDS%MGMV1(YDELBC_FIELDS%YYTGMVCPL%MNHX)=YDGMV%YT1%MNHX
...
IF (LNHDYN.AND.LNHX) YDELBC_FIELDS%CCFIELD_GMV(YDELBC_FIELDS%YYTGMVCPL%MNHX)='LSCGRAD_NHXX'
