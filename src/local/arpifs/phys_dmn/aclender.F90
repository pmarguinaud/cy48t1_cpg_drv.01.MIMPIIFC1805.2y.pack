...
! Calcul de R, Cp et L humide 
     ...
     ZCPH(JLON,JLEV) = YDCST%RCPD*(1.0_JPRB-ZQV(JLON,JLEV)-ZQL(JLON,JLEV))+YDCST%RCPV*ZQV(JLON,JLEV)+YDCST%RCW*ZQL(JLON,JLEV)
...
!  Limitation par ALMAVE comme dans ACBL89
      ...
      ZGLMINF(JLON,JLEV)  = MIN(YDCST%RG*ALMAVE, ZGLKARMN)
