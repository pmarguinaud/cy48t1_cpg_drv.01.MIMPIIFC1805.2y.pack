...
ASSOCIATE(RQICRSN=>YDPHY0%RQICRSN, TSPHY=>YDPHY2%TSPHY,   NTPLUI=>YDTOPH%NTPLUI,   LMICROTL=>YDSIMPHL%LMICROTL, &
& LCOLLECTL=>YDSIMPHL%LCOLLECTL,   LNEBCVPPKF=>YDSIMPHL%LNEBCVPPKF, LIGELREPRO=>YDSIMPHL%LIGELREPRO,            &
& RMODULQCPROG=>YDSIMPHL%RMODULQCPROG, LTRAJCOND=>YDSIMPHL%LTRAJCOND,   LPROCLDTL=>YDSIMPHL%LPROCLDTL           &
& )
ZPFPEVPL5(:,:)=0.0
ZPFPEVPN5(:,:)=0.0
