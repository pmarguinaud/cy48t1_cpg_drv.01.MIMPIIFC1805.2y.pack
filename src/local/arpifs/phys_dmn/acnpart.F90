...
IF ( LWMOCLOUD ) THEN
  ...
  CALL CLOUD_COVER_WMO(YDCST,YDML_PHY_MF,KIDIA,KFDIA,KLON,KTDIA,KLEV,ZDECRDRED,ZWMXOV,PDECRD,PNEB,PAPHI,PAPRSF,PCLCH,PCLCM,PCLCL)

ELSE

  ! high/medium/low cloud cover according to fixed model levels
  CALL CLOUD_COVER(YDCST,YDML_PHY_MF,KIDIA,KFDIA,KLON,KTDIA,KLEV,ZDECRDRED,ZWMXOV,KTDIA,NTSHM,PDECRD,PNEB,PAPRSF,PCLCH)  ! high
  CALL CLOUD_COVER(YDCST,YDML_PHY_MF,KIDIA,KFDIA,KLON,KTDIA,KLEV,ZDECRDRED,ZWMXOV,NTSHM+1,NTSML,PDECRD,PNEB,PAPRSF,PCLCM)  ! medium
  CALL CLOUD_COVER(YDCST,YDML_PHY_MF,KIDIA,KFDIA,KLON,KTDIA,KLEV,ZDECRDRED,ZWMXOV,NTSML+1,KLEV,PDECRD,PNEB,PAPRSF,PCLCL)  ! low

ENDIF

! total cloud cover
CALL CLOUD_COVER(YDCST,YDML_PHY_MF,KIDIA,KFDIA,KLON,KTDIA,KLEV,ZDECRDRED,ZWMXOV,KTDIA,KLEV,PDECRD,PNEB,PAPRSF,PCLCT)

! convective cloud cover
IF ( PRESENT(PCLCC) ) THEN
  CALL CLOUD_COVER(YDCST,YDML_PHY_MF,KIDIA,KFDIA,KLON,KTDIA,KLEV,ZDECRDRED,ZWMXOV,KTDIA,KLEV,PDECRD,PNEBC,PAPRSF,PCLCC)
ENDIF
...
IF ( LRNUMX.AND.(LACPANMX.OR.LRNUEXP) ) THEN
  ...
  CALL CLOUD_COVER(YDCST,YDML_PHY_MF,KIDIA,KFDIA,KLON,KTDIA,KLEV,ZDECRDRED,ZWMXOV,KTDIA,KLEV,PDECRD,PNEB ,PAPRSF,PCLCT_RAD)
ELSE
  PCLCT_RAD(:)=PCLCT(:)
ENDIF
...
SUBROUTINE CLOUD_COVER(YDCST,YDML_PHY_MF,KIDIA,KFDIA,KLON,KTDIA,KLEV,PDECRDRED,PWMXOV,KL1,KL2,PDECRD,PNEB,PAPRSF,PCLC)
...
! high/medium/low cloud cover according to WMO heights
SUBROUTINE CLOUD_COVER_WMO(YDCST,YDML_PHY_MF,KIDIA,KFDIA,KLON,KTDIA,KLEV,PDECRDRED,PWMXOV,PDECRD,PNEB,PAPHI,PAPRSF,PCLCH,PCLCM,PCLCL)
