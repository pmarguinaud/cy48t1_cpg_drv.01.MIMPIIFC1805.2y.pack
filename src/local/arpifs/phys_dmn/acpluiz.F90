!-----------------------------------------------------------------------
SUBROUTINE ACPLUIZ( YDML_PHY_MF,KIDIA, KFDIA, KLON, KTDIA, KLEV,&
 !-----------------------------------------------------------------------
 ! - INPUT -
...
CALL ACMICRO ( YDML_PHY_MF, KIDIA, KFDIA, KLON, KTDIA, KLEV,&
...
CALL ADVPRCS ( YDML_PHY_MF, KIDIA, KFDIA, KLON, KTDIA, KLEV,&
