...
@PROCESS NOCHECK
#endif
SUBROUTINE APL_AROME(YDMF_PHYS_BASE_STATE, YDMF_PHYS_NEXT_STATE, YDGEOMETRY, YDCPG_DIM, YDCPG_OPTS, &
& YDCPG_MISC, YDCPG_GPAR, YDCPG_PHY0, YDCPG_PHY9, YDMF_PHYS, YDCPG_DYN0, YDCPG_DYN9, &
& YDMF_PHYS_SURF, YDCPG_SL1, YDVARS, YDGMV, YDSURF, YDCFU, YDXFU, YDMODEL, LDCONFX, &
& PDTPHY, PGFL, PGP2DSDT, PGMVT1, PGFLT1, PTRAJ_PHYS, YDDDH)
...
USE CPG_TYPE_MOD       , ONLY : CPG_MISC_TYPE, CPG_GPAR_TYPE, CPG_SL1_TYPE
...
REAL(KIND=JPRB) :: ZRHODJM__(YDCPG_DIM%KFDIA,0:YDCPG_OPTS%KFLEVG+1),      ZRHODREFM__(YDCPG_DIM%KFDIA,0:YDCPG_OPTS%KFLEVG+1),   ZPABSM__(YDCPG_DIM%KFDIA,0:YDCPG_OPTS%KFLEVG+1)
REAL(KIND=JPRB) :: ZUM__(YDCPG_DIM%KFDIA,0:YDCPG_OPTS%KFLEVG+1),          ZVM__(YDCPG_DIM%KFDIA,0:YDCPG_OPTS%KFLEVG+1),         ZTHM__(YDCPG_DIM%KFDIA,0:YDCPG_OPTS%KFLEVG+1)
REAL(KIND=JPRB) :: ZUS__(YDCPG_DIM%KFDIA,0:YDCPG_OPTS%KFLEVG+1),          ZVS__(YDCPG_DIM%KFDIA,0:YDCPG_OPTS%KFLEVG+1),         ZWS__(YDCPG_DIM%KFDIA,0:YDCPG_OPTS%KFLEVG+1)
REAL(KIND=JPRB) :: ZTKES_OUT__(YDCPG_DIM%KFDIA,0:YDCPG_OPTS%KFLEVG+1),    ZMF_UP__(YDCPG_DIM%KFDIA,0:YDCPG_OPTS%KFLEVG+1),      ZTHVREFM__(YDCPG_DIM%KFDIA,0:YDCPG_OPTS%KFLEVG+1)  ! thetav de l etat
REAL(KIND=JPRB) :: ZTENDU_TURB__(YDCPG_DIM%KFDIA,0:YDCPG_OPTS%KFLEVG+1),  ZTENDV_TURB__(YDCPG_DIM%KFDIA,0:YDCPG_OPTS%KFLEVG+1), ZTENDTHL_TURB__(YDCPG_DIM%KFDIA,0:YDCPG_OPTS%KFLEVG+1)
REAL(KIND=JPRB) :: ZTENDRT_TURB__(YDCPG_DIM%KFDIA,0:YDCPG_OPTS%KFLEVG+1), ZTKEM__(YDCPG_DIM%KFDIA,0:YDCPG_OPTS%KFLEVG+1),       ZSRCS__(YDCPG_DIM%KFDIA,0:YDCPG_OPTS%KFLEVG+1) 
REAL(KIND=JPRB) :: ZSIGS__(YDCPG_DIM%KFDIA,0:YDCPG_OPTS%KFLEVG+1),        ZEDR__(YDCPG_DIM%KFDIA,0:YDCPG_OPTS%KFLEVG+1)
! THE DDH budgets
REAL(KIND=JPRB) :: ZDP__(YDCPG_DIM%KFDIA,0:YDCPG_OPTS%KFLEVG+1),          ZTP__(YDCPG_DIM%KFDIA,0:YDCPG_OPTS%KFLEVG+1),         ZTPMF__(YDCPG_DIM%KFDIA,0:YDCPG_OPTS%KFLEVG+1)
REAL(KIND=JPRB) :: ZTDIFF__(YDCPG_DIM%KFDIA,0:YDCPG_OPTS%KFLEVG+1),       ZTDISS__(YDCPG_DIM%KFDIA,0:YDCPG_OPTS%KFLEVG+1)
! length scales for momentum and heat for mnh level definitions in case LHARATU=TRUE
REAL(KIND=JPRB) :: ZLENGTHM__(YDCPG_DIM%KFDIA,0:YDCPG_OPTS%KFLEVG+1), ZLENGTHH__(YDCPG_DIM%KFDIA,0:YDCPG_OPTS%KFLEVG+1)

REAL(KIND=JPRB), POINTER :: ZTHS__(:,:)
! horizontal gradients and diagnostics
REAL(KIND=JPRB) :: ZTURB3D__(YDCPG_DIM%KFDIA,0:YDCPG_OPTS%KFLEVG+1,YDMODEL%YRML_PHY_MF%YRARPHY%NGRADIENTS)
...
REAL(KIND=JPRB), TARGET  :: ZTHSWAP__(YDCPG_DIM%KFDIA,0:YDCPG_OPTS%KFLEVG+1),        ZTHSAVE__(YDCPG_DIM%KFDIA,0:YDCPG_OPTS%KFLEVG+1)
REAL(KIND=JPRB), TARGET  :: ZFLXZTHVMF_SUM__(YDCPG_DIM%KFDIA,0:YDCPG_OPTS%KFLEVG+1), ZWM__(YDCPG_DIM%KFDIA,0:YDCPG_OPTS%KFLEVG+1)


! Updraft characteristics for Meso-NH world (input of ARO_SHALLOW_MF)
REAL(KIND=JPRB) :: ZTHETAL_UP_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG), ZTHETAV_UP_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG), ZZFRAC_UP_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG)
REAL(KIND=JPRB) :: ZRT_UP_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG),     ZRC_UP_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG),     ZRI_UP_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG)
REAL(KIND=JPRB) :: ZZU_UP_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG),     ZZV_UP_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG),     ZZW_UP_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG)
REAL(KIND=JPRB) :: ZZRV_UP_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG),    ZTKES_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG),      ZZZ_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG)
REAL(KIND=JPRB) :: ZDZZ_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG),       ZZZ_F_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG),      ZDZZ_F_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG)
REAL(KIND=JPRB) :: ZCIT_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG),       ZMFM_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG),       ZEXNREFM_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG)
REAL(KIND=JPRB) :: ZSIGM_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG),      ZNEBMNH_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG),    ZEVAP_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG)
! additions for MF scheme (Pergaud et al)
REAL(KIND=JPRB) :: ZSIGMF_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG),     ZRC_MF_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG),     ZRI_MF_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG)
REAL(KIND=JPRB) :: ZCF_MF_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG),     ZAERD_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG),      ZCVTENDT_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG)
REAL(KIND=JPRB) :: ZCVTENDRV_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG),  ZCVTENDRC_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG),  ZCVTENDRI_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG)
REAL(KIND=JPRB) :: ZMFS_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG),       ZTHLS_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG),      ZRTS_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG)
REAL(KIND=JPRB) :: ZMFUS_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG),      ZMFVS_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG),      ZDEPTH_HEIGHT_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG)

REAL(KIND=JPRB), TARGET :: ZFLXZTHVMF_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG)
...
REAL(KIND=JPRB), TARGET :: ZRSWAP_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG,YDMODEL%YRML_PHY_MF%YRPARAR%NRR)
REAL(KIND=JPRB), TARGET :: ZRSAVE_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG,YDMODEL%YRML_PHY_MF%YRPARAR%NRR)

REAL(KIND=JPRB), POINTER  :: ZPTRWNU_(:,:), ZTHSIN_(:,:)
REAL(KIND=JPRB), TARGET :: ZWNU_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG)
...
REAL(KIND=JPRB), TARGET :: ZSVSWAP_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG,YDMODEL%YRML_GCONF%YGFL%NGFL_EXT)
REAL(KIND=JPRB), TARGET :: ZSVSAVE_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG,YDMODEL%YRML_GCONF%YGFL%NGFL_EXT)

REAL(KIND=JPRB) :: ZSVXXX_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG,YDMODEL%YRML_GCONF%YGFL%NGFL_EXT)
...
REAL(KIND=JPRB), TARGET :: ZSVMSWAP_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG,YDMODEL%YRML_GCONF%YGFL%NGFL_EXT) 
REAL(KIND=JPRB), TARGET :: ZSVMSAVE_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG,YDMODEL%YRML_GCONF%YGFL%NGFL_EXT)
...
REAL(KIND=JPRB), TARGET :: ZLIMASWAP_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG,YDMODEL%YRML_GCONF%YGFL%NLIMA)
REAL(KIND=JPRB), TARGET :: ZLIMASAVE_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG,YDMODEL%YRML_GCONF%YGFL%NLIMA)

REAL(KIND=JPRB) :: ZLIMAM_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG,YDMODEL%YRML_GCONF%YGFL%NLIMA)
...
REAL(KIND=JPRB) :: ZTENDSV_TURBLIMA_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG,YDMODEL%YRML_GCONF%YGFL%NLIMA) ! LIMA

! For radiation scheme
REAL(KIND=JPRB) :: ZRM_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG,YDMODEL%YRML_PHY_MF%YRPARAR%NRR)
REAL(KIND=JPRB) :: ZPFPR_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG,YDMODEL%YRML_PHY_MF%YRPARAR%NRR)

REAL(KIND=JPRB) :: ZPEZDIAG_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG,YDMODEL%YRML_GCONF%YGFL%NGFL_EZDIAG)
...
REAL(KIND=JPRB) :: ZPIZA_DST_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG,YDMODEL%YRML_PHY_MF%YRPARAR%NSWB_MNH)
! Assymetry factor for dust (points,lev,wvl) :
REAL(KIND=JPRB) :: ZCGA_DST_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG,YDMODEL%YRML_PHY_MF%YRPARAR%NSWB_MNH)
! tau/tau_{550} dust (points,lev,wvl) :
REAL(KIND=JPRB) :: ZTAUREL_DST_(YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG,YDMODEL%YRML_PHY_MF%YRPARAR%NSWB_MNH)
...
ASSOCIATE(YDDIM=>YDGEOMETRY%YRDIM, YDGEM=>YDGEOMETRY%YRGEM, YDSTA=>YDGEOMETRY%YRSTA, &
...
& YSP_SBD=>YDSURF%YSP_SBD, LEDR=>YDPHY%LEDR, LAGPHY=>YDEPHY%LAGPHY, YLIMA=>YGFL%YLIMA, LSPSDT => YSPPT_CONFIG%LSPSDT)
...
IF (LLDIAB) THEN
  ...
  IF (LL_SAVE_PHSURF) THEN
    CALL MF_PHYS_SAVE_PHSURF_PART1 (YDCPG_DIM, YDCPG_OPTS, ZSAV_DDAL, ZSAV_DDOM, ZSAV_ENTCH, ZSAV_FHPS,                             &
    & ZSAV_GZ0F, ZSAV_GZ0HF, ZSAV_HV, ZSAV_PBLH, ZSAV_QSH, ZSAV_UDAL, ZSAV_UDGRO, ZSAV_UDOM,                            &
...
CALL APL_AROME_CALC_IPGFL (YDGEOMETRY, YDCPG_DIM, YDCPG_OPTS, YDMODEL, IPGFL)
...
DO JRR=1,NRR
  DO JLEV=1,YDCPG_OPTS%KFLEVG
    ZTENDRA(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,JLEV,JRR)=0.0_JPRB
  ENDDO
ENDDO
DO JGFL=1,NGFL_EXT
  DO JLEV=1,YDCPG_OPTS%KFLEVG
...
ELSE
  ...
  !test TKE > 0.
  IF (MINVAL(ZTKEM(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)) <= 0._JPRB) THEN
...
IF (LMICRO.OR.LTURB.OR.LLMSE.OR.LKFBCONV) THEN
 ...
 ! vent horizontal et TKE
  ...
  IF (LOSIGMAS) THEN
    DO JLEV = 1, YDCPG_OPTS%KFLEVG 
      ZSIGM_(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,JLEV)= YDMF_PHYS_BASE_STATE%SRC(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,JLEV)
    ENDDO
  ENDIF
  ...
  IF ( LKFBCONV.AND.LOSUBG_COND.AND..NOT.LOSIGMAS) THEN
    DO JLEV = 1, YDCPG_OPTS%KFLEVG 
      ZMFM_(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,JLEV)=YDMF_PHYS_BASE_STATE%SRC(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,JLEV) 
    ENDDO
  ENDIF
...
IF (LFLEXDIA) THEN
  !save tendencies
  ZTENDTBAK(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)=ZTENDT(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)
  DO JR=1,NRR
    ZTENDRBAK(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG,JR)=ZTENDRA(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG,JR)
  ENDDO
ENDIF
...
IF (LMICRO) THEN
  ...
  IF (LMFSHAL .AND. (CMF_CLOUD=='DIRE'.OR.CMF_CLOUD=='BIGA')) THEN
    ...
    ELSE
      ...
      ENDDO
    ENDIF
    ZP1EZDIAG(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG,1:3)=0._JPRB
  ENDIF
  ...
  ZTHS__(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)=ZTHSIN_(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)
  ZRS_(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG,1:NRR)=ZRSIN_(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG,1:NRR)

  IF (CMICRO == 'LIMA') THEN

    CALL SWAP_LIMAS
    ! for now a copy is needed (see below, inside). I don't like than :-( REK
    ZLIMAS_(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG,1:NLIMA)=ZLIMASIN_(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG,1:NLIMA)

    CALL ARO_ADJUST_LIMA (YDCPG_OPTS%KFLEVG, IKU, IKL, YDCPG_DIM%KFDIA, YDCPG_OPTS%KFLEVG, NRR, NLIMA,                 &
    & YDCPG_OPTS%KSTEP+1, LOSUBG_COND, LOSIGMAS, LOCND2, ZDT, VSIGQSAT, ZZZ_F_, ZRHODJM__(:, 1:YDCPG_OPTS%KFLEVG),     &
  ...
  ELSE
    ...
    CALL ARO_ADJUST (YDCPG_OPTS%KFLEVG, IKU, IKL, YDCPG_DIM%KFDIA, YDCPG_OPTS%KFLEVG, NRR, NGFL_EZDIAG,                   &
    & CFRAC_ICE_ADJUST, LOSUBG_COND, LOSIGMAS, CMICRO, LOCND2, ZDT, VSIGQSAT, ZZZ_F_, ZRHODJM__(:, 1:YDCPG_OPTS%KFLEVG), &
    & ZEXNREFM_, ZPABSM__(:, 1:YDCPG_OPTS%KFLEVG), ZTHM__(:, 1:YDCPG_OPTS%KFLEVG), ZRM_, ZSIGM_, ZMFM_,                   &
    & ZRC_MF_, ZRI_MF_, ZCF_MF_, ZTHS__(:, 1:YDCPG_OPTS%KFLEVG), ZRS_, ZSRCS__(:, 1:YDCPG_OPTS%KFLEVG),                   &
  ...
  IF (NRR==7) THEN
    ...
    ENDDO
  ELSE
    ZQHM(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)=0._JPRB
  ENDIF
  ...
  CALL GPRCP(YDCPG_OPTS%KLON, YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA, YDCPG_OPTS%KFLEVG, PQ=ZQVM, PQI=ZQIM, PQL=ZQCM, &
  ...
  ZAPHIM(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG)=YDMF_PHYS_BASE_STATE%YCPG_DYN%PHI(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG)
  CALL GPGEO(YDCPG_OPTS%KLON, YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA, YDCPG_OPTS%KFLEVG, ZAPHIM, ZAPHIFM,          &
...
ELSE
  ...
  ZTM (YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)=YDMF_PHYS_BASE_STATE%T(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)
  ZRHM(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)=YDMF_PHYS_BASE_STATE%YCPG_DYN%RCP%R(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)
  ZQVM(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)=YDMF_PHYS_BASE_STATE%Q(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)
  ZQIM(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)=YDMF_PHYS_BASE_STATE%I(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)
  ZQCM(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)=YDMF_PHYS_BASE_STATE%L(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)
  ZQRM(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)=YDMF_PHYS_BASE_STATE%R(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)
  ZQSM(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)=YDMF_PHYS_BASE_STATE%S(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)
  ZQGM(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)=YDMF_PHYS_BASE_STATE%G(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)
  IF (NRR==7) THEN
    ZQHM(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)=YDMF_PHYS_BASE_STATE%H(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)
  ELSE
    ZQHM(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)=0._JPRB
  ENDIF
  ZCPM(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,YDCPG_OPTS%KTDIA:YDCPG_OPTS%KFLEVG)=YDMF_PHYS_BASE_STATE%YCPG_DYN%RCP%CP(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,YDCPG_OPTS%KTDIA:YDCPG_OPTS%KFLEVG)
  ZAPHIM(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,0:YDCPG_OPTS%KFLEVG)=YDMF_PHYS_BASE_STATE%YCPG_DYN%PHI(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,0:YDCPG_OPTS%KFLEVG)
  ZAPHIFM(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)=YDMF_PHYS_BASE_STATE%YCPG_DYN%PHIF(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)
  ZZZ_(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)=YDMF_PHYS_BASE_STATE%YCPG_DYN%PHI(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)*ZINVG
  !initialisation of PCLFS outside LMICRO to be zero in case LMICRO=F
  YDVARS%A%T1(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)=0._JPRB
...
! specific to new data flow for diagnostics
  IF (LDDH_OMP) THEN
    ...
    CALL ARO_SUINTBUDGET_OMP(YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KSTEP, ZCON1, ZCON2, ZCON3, &
    & YDDDH)
  ELSE
    ! missing interface !!! REK
    CALL ARO_SUINTBUDGET(YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KSTEP, YDCPG_DIM%KFDIA, ZQDM, &
    & ZEXNREFM_, YDMF_PHYS_BASE_STATE%YCPG_DYN%RCP%CP)
  ENDIF
ENDIF
...
!     --------------------------------------------------------------------
IF (LRDUST) THEN
  ZP1EZDIAG(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG,IOFF_MFSHAL:NGFL_EZDIAG)=0.0_JPRB
  ...
  CALL SWAP_SVM
  ! input dust scalar concentration in ppp from
  CALL ARO_MNHDUST (IKL, YDCPG_DIM%KFDIA, YDCPG_OPTS%KFLEVG, NGFL_EXT, PDTPHY, ZSVMIN_, ZZZ_, ZDZZ_, ZPABSM__(:, 1:YDCPG_OPTS%KFLEVG), &
  & ZTHM__(:, 1:YDCPG_OPTS%KFLEVG), ZRHODREFM__(:, 1:YDCPG_OPTS%KFLEVG), NSWB_MNH, YDCPG_OPTS%KSTEP+1,                                  &
  & ZSVM_, ZPIZA_DST_, ZCGA_DST_, ZTAUREL_DST_, ZAERD_, IEZDIAG_CHEM, ZPEZDIAG_(:, :, IOFF_MFSHAL:NGFL_EZDIAG)                       &
  &                                                                                                                                         )
  ZP1EZDIAG(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG,IOFF_MFSHAL:NGFL_EZDIAG)=ZPEZDIAG_(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG,IOFF_MFSHAL:NGFL_EZDIAG)
! return to tendency
  DO JGFL=1, NGFL_EXT
    DO JLEV = 1,YDCPG_OPTS%KFLEVG
      DO JLON = YDCPG_DIM%KIDIA,YDCPG_DIM%KFDIA
...
IF (LSFORCS) THEN   ! <== Surface forcing for MUSC
  ...
  ZTSURF(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA) = YDMF_PHYS_BASE_STATE%T(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG)
  ZTN(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA)    = YDMF_PHYS_BASE_STATE%T(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG)
  ZQS(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA)    = YDMF_PHYS_BASE_STATE%Q(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG)
  DO JLON=YDCPG_DIM%KIDIA,YDCPG_DIM%KFDIA
...
!* Compute PBL-diagnostics
   ...
   ZCAPE(:)=0._JPRB
   ZDCAPE(:)=0._JPRB
  CALL ACCLDIA(YDXFU, YDPHY, YDMODEL%YRML_PHY_MF%YRPHY2, YDTOPH, YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA, YDCPG_OPTS%KLON,                               &
  & YDCPG_OPTS%KFLEVG, YDMF_PHYS%OUT%UCLS, YDMF_PHYS%OUT%VCLS, YDMF_PHYS_BASE_STATE%U(:, 1:YDCPG_OPTS%KFLEVG),                                          &
...
IF (LRAYFM.OR.LRAY) THEN
  ...
  CALL ACTQSAT ( YDPHY, YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA, YDCPG_OPTS%KLON, NTQSAT, YDCPG_OPTS%KFLEVG, YDMF_PHYS_BASE_STATE%YCPG_PHY%PREF, &
...
!              ZALBP(JLON,JSW)=PALBIN(JLON)+ZSALBCOR
  ...
  ELSE
    ...
    ZTSURF(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA)=ZTM(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG)
  ENDIF !LLMSE EMIS
  ...
  IF (LRAY.AND.NRAY == 2.AND.LRADFLEX.AND.LRSTAER) THEN
    ...
    ZAER(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KTDIA-1,1)=0._JPRB
    ...
    DO JLEV=YDCPG_OPTS%KTDIA,YDCPG_OPTS%KFLEVG
      ...
      ZAEO=ZAEN
    ENDDO
    ZAER(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG,2:6)=0._JPRB
  ...
  ELSE
    ...
    IF (LRDUST) THEN
      ...
      ZAER(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG,3) = ZAERD_(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)
    ENDIF
  ...
  IF (NOZOCL == 1) THEN
    ! as in IFS
    CALL RADOZC(YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA, YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, 1, YDCPG_OPTS%KLON, &
  ...
  ELSEIF (NOZOCL == 2) THEN
    ...
    CALL SUOZON(YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA, YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, ZQO3, .FALSE., YDMF_PHYS_BASE_STATE%YCPG_PHY%PRE, &
...
ENDIF
 ...
 IF (LRAYFM) THEN
   ...
   IF (MOD(YDCPG_OPTS%KSTEP,NRADFR) == 0) THEN 
     ...
     & YDCPG_OPTS%KSW, ZALBD, ZALBP, YDMF_PHYS_BASE_STATE%YCPG_PHY%PRE, YDMF_PHYS_BASE_STATE%YCPG_PHY%PREF, YDVARS%A%T1,     &
     & ZQO3, ZAER, YDMF_PHYS_BASE_STATE%YCPG_PHY%XYB%DELP, ZEMIS, ZRDG_MU0M, ZQV, ZQSAT, ZQICE, ZQLIQ,                 &
     & ZQSM, ZQRM, YDMF_PHYS_SURF%GSD_VF%PLSM, ZTM, ZTSURF, YDMF_PHYS%RAD%EMTD,              &
     ...
     & ZTRSODIF, ZPIZA_DST_, ZCGA_DST_, ZTAUREL_DST_, ZAERINDS, YDVARS%GEOMETRY%GELAM%T0, YDVARS%GEOMETRY%GEMU%T0, YDCPG_GPAR%SWDIR,  &
     & YDCPG_GPAR%SWDIF, ZRDG_MU0LU, ZALBD1, ZFRSOLU, ZGP2DSPP, ZP1EZDIAG)
   ELSE
     IF (LLMSE) THEN 
       DO JSW=1,NSW 
   ...
   & ZTENT, YDMF_PHYS%RAD%TRSW, ZTRSOD, ZTSURF, PDTPHY, ZTRSODIR, ZTRSODIF, ZALBD, ZALBP, ZFRSO,                  &
...
& YDMF_PHYS_BASE_STATE%YCPG_DYN%PHI, YDMF_PHYS_BASE_STATE%YCPG_DYN%PHIF, YDMF_PHYS_BASE_STATE%YCPG_PHY%PREF, ZDECRD,         &
  ...
  ELSE
    ...
    IF (NAER >= 1) THEN
      IF (YSD_VAD%NUMFLDS >= 4) THEN
        ...
        & YDCPG_OPTS%KFLEVG, YDMF_PHYS_BASE_STATE%YCPG_PHY%PRE, YDMF_PHYS_BASE_STATE%YCPG_PHY%PREF, ZTM, ZTSURF,                     &
...
!+++ End of redundant input preparations for ACRANEB
  ...
  ZQCO2(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)=QCO2
  ...
  & NTRADI, YDCPG_OPTS%KFLEVG, IJN, YDCPG_OPTS%KSTEP, YDCFU%NFRRC, YDMF_PHYS_BASE_STATE%YCPG_PHY%PRE, YDMF_PHYS_BASE_STATE%YCPG_PHY%PREF, &
  & YDMF_PHYS_BASE_STATE%YCPG_DYN%RCP%CP, YDMF_PHYS_BASE_STATE%YCPG_DYN%RCP%R, YDMF_PHYS_BASE_STATE%YCPG_PHY%XYB%DELP,                       &
  & ZNEB0, ZQV, ZQCO2, ZQICE, ZQLIQ, ZQO3, YDMF_PHYS_BASE_STATE%T, ZALBD1, ZALBP1, ZEMIS, YDVARS%GEOMETRY%GELAM%T0,                          &
  & YDVARS%GEOMETRY%GEMU%T0, ZRDG_MU0, ZRDG_MU0LU, ZTSURF, ZDECRD, ZCLCT_RAD, YDMF_PHYS%OPT%GDEOSI, YDMF_PHYS%OPT%GUEOSI,               &
  & YDMF_PHYS%OPT%GMU0, YDMF_PHYS%OPT%GMU0_MIN, YDMF_PHYS%OPT%GMU0_MAX, YDMF_PHYS%OPT%GDEOTI, YDMF_PHYS%OPT%GDEOTI2,          &
  & YDMF_PHYS%OPT%GUEOTI, YDMF_PHYS%OPT%GUEOTI2, YDMF_PHYS%OPT%GEOLT, YDMF_PHYS%OPT%GEOXT, YDMF_PHYS%OPT%GRPROX,              &
  & YDMF_PHYS%OPT%GMIXP, YDMF_PHYS%OPT%GFLUXC, YDMF_PHYS%OPT%GRSURF, YDMF_PHYS_SURF%GSD_VD%PSUND,                             &
...
IF (LFLEXDIA) THEN
  CALL ARO_STARTBU( YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA, YDCPG_OPTS%KFLEVG, NRR, NGFL_EXT, ZRHODJM__(:, 1:YDCPG_OPTS%KFLEVG),     &
...
IF(LKFBCONV) THEN
  ...
  & YDCPG_OPTS%KFLEVG, YDVARS%GEOMETRY%GM%T0(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA), ZPABSM__(:, 1:YDCPG_OPTS%KFLEVG),                                  &
  & ZZZ_F_, ZTM(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA, :), ZRM_(:, :, 1), ZRM_(:, :, 2), ZRM_(:, :, 4), ZRHODREFM__(:, 1:YDCPG_OPTS%KFLEVG), &
  & ZUM__(:, 1:YDCPG_OPTS%KFLEVG), ZVM__(:, 1:YDCPG_OPTS%KFLEVG), ZWM__(:, 1:YDCPG_OPTS%KFLEVG), ZMFS_,                                  &
  ...
  IF (LOSUBG_COND.AND..NOT.LOSIGMAS) THEN
    YDVARS%SRC%T1(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)=ZMFS_(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)
  ENDIF
  IF(MOD(YDCPG_OPTS%KSTEP+1,NPRINTFR)==0) THEN
    ...
    ENDDO
  ENDIF
  CALL ARO_CONVBU(YDCPG_DIM%KFDIA, YDCPG_OPTS%KFLEVG, NRR, ZRHODJM__(:, 1:YDCPG_OPTS%KFLEVG), ZRS_, ZTHS__(:, 1:YDCPG_OPTS%KFLEVG), &
...
!$OMP CRITICAL (ARO_GROUND_PARAM_LOCK)
    ...
    IF (LLMSE_PARAM) THEN
      CALL ARO_GROUND_PARAM( YDCPG_DIM%KBL, YDCPG_OPTS%KGPCOMP, YDCPG_DIM%KFDIA, YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA,                                                &
      & YDCPG_OPTS%KSTEP, NRR, NSW, NGFL_EXT, NDGUNG, NDGUXG, NDLUNG, NDLUXG, LSURFEX_KFROM, LMPA,                                                                &
      & CCOUPLING, LLXFUMSE, NINDAT, ZRHGMT, ZSTATI, RSOVR, RCODEC, RSIDEC, YDVARS%GEOMETRY%RINDX%T0(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA),                                     &
      & YDVARS%GEOMETRY%RINDY%T0(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA), ZUM__(:, IKB), ZVM__(:, IKB), ZTM(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA, YDCPG_OPTS%KFLEVG),                   &
      & ZRM_(:, IKB, 1), ZSVMB_, RCARDI, ZRHODREFM__(:, IKB), ZPABSM__(:, IKB), YDMF_PHYS_BASE_STATE%YCPG_PHY%PRE(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA, YDCPG_OPTS%KFLEVG), &
      & ZDTMSE, ZDEPTH_HEIGHT_(:, IKB), ZZS_, XZSEPS, ZRDG_MU0(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA), ZRDG_MU0N(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA),                     &
      & YDVARS%GEOMETRY%GELAM%T0(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA), YDVARS%GEOMETRY%GEMU%T0(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA),                                                         &
      & XSW_BANDS, ZINPRR_NOTINCR_, ZINPRS_NOTINCR_, ZINPRG_NOTINCR_, YDMF_PHYS%OUT%FRTHDS(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA),                                     &
      & ZZS_FSWDIF(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA, 1:NSW), ZZS_FSWDIR(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA, 1:NSW),                                                  &
      & ZCFAQ_, ZCFATH_, ZCFAU_, ZCFBQ_, ZCFBTH_, ZCFBU_, ZCFBV_, ZSFTH_, ZSFRV_, ZSFSV_, ZSFCO2_,                                                               &
      & ZSFU_, ZSFV_, ZALBP(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA, 1:NSW), ZALBD(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA, 1:NSW),                                              &
      & ZEMIS(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA), ZTSURF(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA), YDMF_PHYS%OUT%FRTH(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA, YDCPG_OPTS%KFLEVG, 1)&
      &   )
...
!ZSFRV_(KIDIA:KFDIA) = 0._JPRB
    ...
    IF (LLMSE_DIAG) THEN
      ...
      CALL ARO_GROUND_DIAG( YDCPG_DIM%KBL, YDCPG_OPTS%KGPCOMP, YDCPG_DIM%KFDIA, YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA,                     &
      & YDCPG_OPTS%KFLEVG, IKL, NDGUNG, NDGUXG, NDLUNG, NDLUXG, LSURFEX_KFROM, ZZS_, ZSFRV_, ZUM__(:, IKTB:IKTE),                     &
      & ZVM__(:, IKTB:IKTE), ZDEPTH_HEIGHT_(:, IKTB:IKTE), YDMF_PHYS%OUT%FRTH(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA, YDCPG_OPTS%KFLEVG, 1), &
      & YDMF_PHYS%OUT%FRSO(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA, YDCPG_OPTS%KFLEVG, 1), YDVARS%GEOMETRY%RINDX%T0(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA),   &
      & YDVARS%GEOMETRY%RINDY%T0(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA), ZQS(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA), ZGZ0_,                                &
      ...
      CALL ARO_GROUND_DIAG_2ISBA( YDCPG_DIM%KBL, YDCPG_OPTS%KGPCOMP, YDCPG_DIM%KFDIA, YDCPG_DIM%KIDIA,                                     &
      & YDCPG_DIM%KFDIA, NDGUNG, NDGUXG, NDLUNG, NDLUXG, LSURFEX_KFROM, YDVARS%GEOMETRY%RINDX%T0(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA),                  &
      & YDVARS%GEOMETRY%RINDY%T0(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA), YDMF_PHYS_SURF%GSD_VF%PLSM, ZDUMMY1,                                             &
...
!* Compute PBL-diagnostics
   ...
   CALL ACVISIH(YDVISI, YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA, YDCPG_OPTS%KLON, YDCPG_OPTS%KTDIA, YDCPG_OPTS%KFLEVG, &
   & YDMF_PHYS_BASE_STATE%YCPG_DYN%PHI, YDMF_PHYS_BASE_STATE%YCPG_DYN%PHIF, YDMF_PHYS_BASE_STATE%YCPG_PHY%PREF, ZTM,        &
...
IF (LMFSHAL) THEN
  IF (CMF_UPDRAFT=='DUAL') THEN
    ...
    IF (LHARATU) THEN
      ...
      ENDDO
      IF (MAXVAL(ZTKEM(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)) > 3300._JPRB) THEN
        DO JLEV=1, YDCPG_OPTS%KFLEVG
          DO JLON = YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA
    ...
    & YDMODEL%YRML_PHY_EC%YREPHY, YDPARAR, YDCPG_OPTS%KSTEP, YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA, YDCPG_OPTS%KLON, &
    & YDCPG_OPTS%KFLEVG, INDRAFT, PDTPHY, YDMF_PHYS_BASE_STATE%U, YDMF_PHYS_BASE_STATE%V, ZTM, ZQVM, ZQCM, ZQIM,         &
    & YDVARS%A%T1, YDMF_PHYS_BASE_STATE%YCPG_PHY%PRE, YDMF_PHYS_BASE_STATE%YCPG_PHY%PREF, ZAPHIFM, ZAPHIM,              &
  ...
  DO JDRAFT=IDRAFT,3
    ...
    CALL ARO_SHALLOW_MF (KKL=IKL, KLON=YDCPG_DIM%KFDIA, KLEV=YDCPG_OPTS%KFLEVG, KRR=NRR, KRRL=NRRL, KRRI=NRRI,                  &
    & KSV=NGFL_EXT, HMF_UPDRAFT=CMF_UPDRAFT, HMF_CLOUD=CMF_CLOUD, HFRAC_ICE=CFRAC_ICE_SHALLOW_MF, OMIXUV=LMIXUV,               &
    & ONOMIXLG=.FALSE., KSV_LGBEG=0, KSV_LGEND=0, KTCOUNT=YDCPG_OPTS%KSTEP+1, PTSTEP=ZDT, PZZ=ZZZ_, PZZF=ZZZ_F_,                &
    & PDZZF=ZDZZ_F_, PRHODJ=ZRHODJM__(:, 1:YDCPG_OPTS%KFLEVG), PRHODREF=ZRHODREFM__(:, 1:YDCPG_OPTS%KFLEVG),                     &
    ...
    IF (JDRAFT > IDRAFT) THEN
      ! Add increment
      ZFLXZTHVMF_SUM__(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)=ZFLXZTHVMF_SUM__(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)+ZFLXZTHVMF_(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)
    ENDIF
...
IF (LTURB) THEN
  ...
  IF (NGFL_EXT /=0 ) THEN
    ZSVSIN_(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG,1:NGFL_EXT)=ZSVS_(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG,1:NGFL_EXT)
  ENDIF
...
! KSV_TURB, ZSFTURB, ZTURBM, ZTURBS, ZTENDSV_TURB
  CALL ARO_TURB_MNH(KKA=IKA, KKU=IKU, KKL=IKL, KLON=YDCPG_DIM%KFDIA, KLEV=YDCPG_OPTS%KFLEVG, KRR=NRR,                 &
...
!!$  ENDIF
  ...
  IF (LFLEXDIA) THEN
    ...
    ENDDO
    IF (LDDH_OMP) THEN
      CALL NEW_ADD_FIELD_3D(YDMODEL%YRML_DIAG%YRMDDH, ZDP__(:, 1:YDCPG_OPTS%KFLEVG), 'TKEPRDY', YDDDH&
      &           )
      CALL NEW_ADD_FIELD_3D(YDMODEL%YRML_DIAG%YRMDDH, ZTP__(:, 1:YDCPG_OPTS%KFLEVG), 'TKEPRTH', YDDDH&
      &           )
      ...
      & YDDDH)
    ELSE
      CALL ADD_FIELD_3D(YLDDH, ZDP__(:, 1:YDCPG_OPTS%KFLEVG), 'TKEPRDY', 'T', 'ARO', .TRUE., .TRUE.)
      CALL ADD_FIELD_3D(YLDDH, ZTP__(:, 1:YDCPG_OPTS%KFLEVG), 'TKEPRTH', 'T', 'ARO', .TRUE., .TRUE.)
      CALL ADD_FIELD_3D(YLDDH, ZTPMF__(:, 1:YDCPG_OPTS%KFLEVG), 'TKEPRTHMF', 'T', 'ARO', .TRUE., &
      & .TRUE.)
      CALL ADD_FIELD_3D(YLDDH, ZTDIFF__(:, 1:YDCPG_OPTS%KFLEVG), 'TKEDIFF', 'T', 'ARO', .TRUE., &
      & .TRUE.)
      CALL ADD_FIELD_3D(YLDDH, ZTDISS__(:, 1:YDCPG_OPTS%KFLEVG), 'TKEDISS', 'T', 'ARO', .TRUE., &
      & .TRUE.)
    ENDIF
  ENDIF 
...
IF (LMICRO) THEN
  ...
  IF (CMICRO == 'LIMA') THEN
    ...
    IF (LTURB) THEN
      DO JLON=YDCPG_DIM%KIDIA,YDCPG_DIM%KFDIA
        ...
        ENDDO
      ENDDO
      ZPTRWNU_ => ZWNU_(1:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)
    ELSE
      ZPTRWNU_ => ZWM__(1:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)
    ENDIF
    CALL ARO_LIMA(YDCPG_OPTS%KFLEVG, IKU, IKL, YDCPG_DIM%KFDIA, YDCPG_OPTS%KFLEVG, NRR, NLIMA, YDCPG_OPTS%KSTEP+1,           &
    ...
    &            )
  ELSE
    CALL ARO_RAIN_ICE (YDCPG_OPTS%KFLEVG, IKU, IKL, YDCPG_DIM%KFDIA, YDCPG_OPTS%KFLEVG, NRR, YDCPG_OPTS%KSTEP+1,                  &
    & NSPLITR, NGFL_EZDIAG, LOSUBG_COND, CSUBG_AUCV_RC, LOSEDIC, CSEDIM, CMICRO, ZDT, ZDZZ_, ZRHODJM__(:, 1:YDCPG_OPTS%KFLEVG), &
    & ZRHODREFM__(:, 1:YDCPG_OPTS%KFLEVG), ZEXNREFM_, ZPABSM__(:, 1:YDCPG_OPTS%KFLEVG), ZTHM__(:, 1:YDCPG_OPTS%KFLEVG),           &
  ...
  IF (LRDEPOS) THEN
    ...
    ! Swapp because IN and OUT will be needed simultaneously
    CALL SWAP_SVM
    CALL ARO_RAINAERO(YDCPG_DIM%KFDIA, YDCPG_OPTS%KFLEVG, NGFL_EXT, NRR, PDTPHY, ZSVMIN_, ZZZ_, ZPABSM__(:, 1:YDCPG_OPTS%KFLEVG), &
...
IF (LNUDGLH.AND.YDCPG_OPTS%KSTEP == NSTARTNUDGLH.AND.NSTARTNUDGLH > 0) THEN
  ...
  CALL NUDGLHPRECIP(YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA, YDCPG_OPTS%KLON, ZACPRR_(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA), &
...
IF (LNUDGLH.AND.YDCPG_OPTS%KSTEP > NSTARTNUDGLH.AND.YDCPG_OPTS%KSTEP <= NSTOPNUDGLH) THEN
  ...
  IF(MOD(ISTEP+1,NINTNUDGLH)==0) THEN
    CALL NUDGLHPREP(YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA, YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, ZTENDTT, YDCPG_DIM%KBL&
    &           )
  ENDIF
  ! LHN step
  IF(MOD(ISTEP,NINTNUDGLH)==0) THEN
    ...
    CALL NUDGLH(NGPTOT, NPROMA, NGPBLKS, YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA, YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG,                                                &
    & ZACPRR_(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA), ZACPRS_(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA), ZACPRG_(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA),                         &
    & ZTENDTT(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA, 1:YDCPG_OPTS%KFLEVG), JLHSTEP, YDCPG_DIM%KBL, ZEXNREFM_(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA, 1:YDCPG_OPTS%KFLEVG), &
    & .TRUE., LLHN(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA, 1:YDCPG_OPTS%KFLEVG), ZPABSM__(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA, 1:YDCPG_OPTS%KFLEVG),                     &
    & ZDT, ZTHM__(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA, 1:YDCPG_OPTS%KFLEVG), ZRM_(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA, 1:YDCPG_OPTS%KFLEVG, :),                       &
    & ZQDM(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA, 1:YDCPG_OPTS%KFLEVG), ZTEND_Q(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA, 1:YDCPG_OPTS%KFLEVG),                            &
    & NRR, LNUDGLHNREAD)
  ...
  ELSEIF(MOD(ISTEP,NINTNUDGLH)<NTAUNUDGLH.AND.MOD(ISTEP,NINTNUDGLH)>0 &
    ...
    & ZACPRR_(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA), ZACPRS_(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA), ZACPRG_(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA),                         &
    & ZTENDTT(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA, 1:YDCPG_OPTS%KFLEVG), JLHSTEP, YDCPG_DIM%KBL, ZEXNREFM_(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA, 1:YDCPG_OPTS%KFLEVG), &
    & .FALSE., LLHN(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA, 1:YDCPG_OPTS%KFLEVG), ZPABSM__(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA, 1:YDCPG_OPTS%KFLEVG),                    &
    & ZDT, ZTHM__(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA, 1:YDCPG_OPTS%KFLEVG), ZRM_(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA, 1:YDCPG_OPTS%KFLEVG, :),                       &
    & ZQDM(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA, 1:YDCPG_OPTS%KFLEVG), ZTEND_Q(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA, 1:YDCPG_OPTS%KFLEVG),                            &
    & NRR, LNUDGLHNREAD)
    !IF(MYPROC==1) WRITE(NULOUT,*)'calling LH successful - convert TH to T and
...
IF (LUSECHEM) THEN
  ...
  ENDDO
  IEZDIAG_CHEM=NGFL_EZDIAG-IOFF_MFSHAL+1
  CALL ARO_MNHC(ZSVSIN_, ZRHODREFM__(:, 1:YDCPG_OPTS%KFLEVG), PDTPHY, ZTHM__(:, 1:YDCPG_OPTS%KFLEVG), ZPABSM__(:, 1:YDCPG_OPTS%KFLEVG),     &
  & ZRM_, ZLAT_, ZLON_, ZALB_UV_, ZZS_, ZZENITH_, ZZZ_, IYEAR, IMONTH, IDAY, REAL(RHGMT, JPRB)+PDTPHY/2._JPRB,                           &
  & YDCPG_DIM%KFDIA, YDCPG_OPTS%KFLEVG, NGFL_EXT, NRR, YDCPG_OPTS%KSTEP+1, NULOUT, IEZDIAG_CHEM, ZPEZDIAG_(:, :, IOFF_MFSHAL:NGFL_EZDIAG), &
  & ZSVS_ )
...
IF(LSPSDT) THEN
  ...
  ZDUMMY(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)=0.0_JPRB               ! Dummy nonphys tendency for compatibility with ecmwf stochphy
  CALL SPPTEN (YDMODEL%YRML_PHY_EC%YRECLDP, YGFL, YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA, YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG,          &
  & 1, PDTPHY, PTSL=YDMF_PHYS_BASE_STATE%T, PQSL=YDMF_PHYS_BASE_STATE%Q, PA=YDVARS%A%T1, PAP=YDMF_PHYS_BASE_STATE%YCPG_PHY%PREF,              &
  & PAPH=YDMF_PHYS_BASE_STATE%YCPG_PHY%PRE, PDYN_U=ZDUMMY, PDYN_V=ZDUMMY, PDYN_T=ZDUMMY, PDYN_Q=ZDUMMY, PUNP_U=YDMF_PHYS%OUT%TENDU, &
  & PUNP_V=YDMF_PHYS%OUT%TENDV, PUNP_T=ZTENDT, PUNP_Q=ZTEND_Q, PMULNOISE=PGP2DSDT(1, 1, 1), PTENU=YDMF_PHYS%OUT%TENDU, &
  & PTENV=YDMF_PHYS%OUT%TENDV, PTENT=ZTENDT, PTENQ=ZTEND_Q )    ! Out: (u,v,t,qv) total perturbed tendencies
ENDIF
...
IF (LFLASH) THEN
  ...
  CALL DIAGFLASH(YDCFU, YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA, YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KSTEP, &
  & ZQCM, ZQIM, ZQRM, ZQSM, ZQGM, ZQHM, YDMF_PHYS_BASE_STATE%YCPG_PHY%XYB%DELP, ZTM, YDMF_PHYS_BASE_STATE%YCPG_PHY%W,  &
...
IF (LINTFLEX) THEN
  ...
  CALL APL_AROME2INTFLEX(YGFL, YDPARAR, YDPHY, YDCPG_OPTS%KLON, YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA, YDCPG_OPTS%KFLEVG, &
  & PDTPHY, YDMF_PHYS_BASE_STATE%YCPG_PHY%XYB%RDELP, YDMF_PHYS_BASE_STATE%U, YDMF_PHYS_BASE_STATE%V, YDMF_PHYS_BASE_STATE%T,           &
  & YDCPG_GPAR%VTS, YDMF_PHYS_BASE_STATE%YCPG_DYN%RCP%CP, ZFPR, LLRAD, YDMF_PHYS%OUT%FRTH, YDMF_PHYS%OUT%FRSO,          &
  & YDMF_PHYS%OUT%TENDU, YDMF_PHYS%OUT%TENDV, ZTENDT, ZTENDRA, ZTENDTKE, ZTENDEXT, YLPROCSET)
ENDIF
...
CALL PPWETPOINT(YDPHY, YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA, YDCPG_OPTS%KLON, YDMF_PHYS_BASE_STATE%YCPG_PHY%PRE(:, YDCPG_OPTS%KFLEVG), &
...
IF (LDPRECIPS.OR.LDPRECIPS2) THEN
  ...
  DO JLEV=1,YDCPG_OPTS%KFLEVG
      CALL PPWETPOINT(YDPHY, YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA, YDCPG_OPTS%KLON, YDMF_PHYS_BASE_STATE%YCPG_PHY%PREF(:, JLEV), &
  ...
  IF (LDPRECIPS) THEN
   ...
   CALL DPRECIPS(YDPRECIPS, YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA, YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDVARS%GEOMETRY%OROG%T0,                               &
   & YDMF_PHYS%OUT%TPWCLS, YDMF_PHYS%OUT%DIAGH, YDMF_PHYS_BASE_STATE%YCPG_DYN%PHIF, ZDZZ, ZTPW, ZQCM, YDMF_PHYS%OUT%FPLSL(:, YDCPG_OPTS%KFLEVG), &
   & YDMF_PHYS%OUT%FPLSN(:, YDCPG_OPTS%KFLEVG), YDMF_PHYS%OUT%FPLSG(:, YDCPG_OPTS%KFLEVG), ZPRC_DPRECIPS(:, NDTPRECCUR)                      &
   &                                                                     )
  ENDIF
  ...
  IF (LDPRECIPS2) THEN
   ...
   CALL DPRECIPS(YDPRECIPS, YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA, YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDVARS%GEOMETRY%OROG%T0,                               &
   & YDMF_PHYS%OUT%TPWCLS, YDMF_PHYS%OUT%DIAGH, YDMF_PHYS_BASE_STATE%YCPG_DYN%PHIF, ZDZZ, ZTPW, ZQCM, YDMF_PHYS%OUT%FPLSL(:, YDCPG_OPTS%KFLEVG), &
   & YDMF_PHYS%OUT%FPLSN(:, YDCPG_OPTS%KFLEVG), YDMF_PHYS%OUT%FPLSG(:, YDCPG_OPTS%KFLEVG), ZPRC_DPRECIPS2(:, NDTPRECCUR2)                    &
   &                                                           )
...
IF(LNHDYN) THEN
  ...
  IF (LGWADV) THEN
    ZTENDD(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)=ZGWT1(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)
  ELSE

    ! * Provide the appropriate version of (RT) at t+dt for GNHGW2SVDAROME:
    IF (L_RDRY_VD) THEN
      ! Use Rd because "dver" is currently defined with Rd.
      ZRTT1(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)=RD*ZTT1(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)
    ELSE
    ...
    ! * Do conversion:
    IF (LSLAG.AND.LTWOTL) THEN
      CALL GNHGW2SVDAROME(YDGEOMETRY, YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA, YDCPG_PHY0%PREHYDF, YDCPG_PHY0%XYB%LNPR, ZRTT1, YDCPG_PHY0%PREF, ZGWT1, ZTENDD)  
    ELSE
      CALL GNHGW2SVDAROME(YDGEOMETRY, YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA, YDCPG_PHY9%PREHYDF, YDCPG_PHY9%XYB%LNPR, ZRTT1, YDCPG_PHY9%PREF, ZGWT1, ZTENDD)  
    ENDIF
...
IF ( LINTFLEX ) THEN
  ...
  & YDMF_PHYS_BASE_STATE%YCPG_DYN%RCP%CP, YDMF_PHYS_BASE_STATE%U, YDMF_PHYS_BASE_STATE%V, YDMF_PHYS_BASE_STATE%T, YDMF_PHYS_BASE_STATE%YGSP_RR%T, &
  ...
  CALL CPUTQY(YDGEOMETRY%YRDIMV, YDGMV, YGFL, YDPTRSLB1, YDPHY, YDCPG_OPTS%KLON, YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA, &
  & YDCPG_OPTS%KFLEVG, PDTPHY, IPGFL, ISLB1T9, ISLB1U9, ISLB1V9, ISLB1VD9, ISLB1GFL9, ZTENDH, ZTENDT,              &
  & YDMF_PHYS%OUT%TENDU, YDMF_PHYS%OUT%TENDV, ZTENDU, ZTENDV, ZTENDD, ZTENDGFL, YDMF_PHYS_BASE_STATE%YCPG_DYN%RCP%CP,  &
  & YDMF_PHYS_BASE_STATE%YCPG_PHY%XYB%DELP, YDMF_PHYS_BASE_STATE%T, YDMF_PHYS_BASE_STATE%U, YDMF_PHYS_BASE_STATE%V, YDCPG_SL1%ZVIEW,              &
  & PGMVT1, PGFLT1, YDMF_PHYS%OUT%FDIS)    
   
ELSE

  ! start ZTENDGFLR at 1 because it is dimensionned (:,:,0:n)
  CALL CPUTQY_AROME_EXPL (YDMF_PHYS_NEXT_STATE, YDVARS, YDMODEL, YDGEOMETRY%YRDIMV, YDCPG_DIM, YDCPG_OPTS,  &
  & PDTPHY, ZTEND_Q, ZTEND_L, ZTEND_R, ZTEND_I, ZTEND_S, ZTEND_G, ZTEND_H, ZTENDTKE, &
  & ZTENDT, YDMF_PHYS%OUT%TENDU, YDMF_PHYS%OUT%TENDV, ZTENDD)
  CALL CPUTQY_AROME_LOOP (YDMODEL, YDGEOMETRY%YRDIMV, YDGMV, YDCPG_DIM, YDCPG_OPTS,  &
  & PDTPHY, IPGFL, IPTR, ZTENDGFLR(:, :, 1:), YDCPG_SL1%ZVIEW, PGMVT1, PGFLT1)
ENDIF
...
IF (LLDIAB) THEN
  IF (LL_SAVE_PHSURF) THEN
    CALL MF_PHYS_SAVE_PHSURF_PART2 (YDCPG_DIM, YDCPG_OPTS, ZSAV_DDAL, ZSAV_DDOM, ZSAV_ENTCH, ZSAV_FHPS,                             &
    & ZSAV_GZ0F, ZSAV_GZ0HF, ZSAV_HV, ZSAV_PBLH, ZSAV_QSH, ZSAV_UDAL, ZSAV_UDGRO, ZSAV_UDOM,                            &
    & ZSAV_UNEBH, YDMF_PHYS_SURF%GSD_VF%PZ0F, YDMF_PHYS_SURF%GSD_VH%PPBLH, YDMF_PHYS_SURF%GSD_VH%PQSH,                  &
    & YDMF_PHYS_SURF%GSD_VH%PSPSH, YDMF_PHYS_SURF%GSD_VK%PUDGRO, YDMF_PHYS_SURF%GSD_VV%PHV, YDMF_PHYS_SURF%GSD_VV%PZ0H, &
    & YDVARS%DAL%T0, YDVARS%DOM%T0, YDVARS%UAL%T0, YDVARS%UEN%T0, YDVARS%UNEBH%T0, YDVARS%UOM%T0,                       &
...
IF(LGSCM.OR.LMUSCLFA) THEN
  ...
  & YDVARS%GEOMETRY%GECLO%T0, YDVARS%GEOMETRY%GESLO%T0, ZRDG_CVGQ, ZRDG_LCVQ, ZRDG_MU0               )
ENDIF
