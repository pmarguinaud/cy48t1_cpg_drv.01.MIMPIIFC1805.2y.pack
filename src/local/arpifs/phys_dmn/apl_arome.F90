...
ELSE
  ...
  CALL CPUTQY_AROME_EXPL (YLMF_PHYS_NEXT_STATE, YDVARS, YDMODEL, YDGEOMETRY%YRDIMV, YDCPG_DIM,  &
  ...
  CALL CPUTQY_AROME_LOOP (YDMODEL, YDGEOMETRY%YRDIMV, YDGMV, YDCPG_DIM,  &
