...
ASSOCIATE(YDDIM=>YDGEOMETRY%YRDIM,YDGEM=>YDGEOMETRY%YRGEM, &
 ...
 & YDOROG=>YDGEOMETRY%YROROG(YDCPG_DIM%KBL), YDSTA=>YDGEOMETRY%YRSTA, YDPHY=>YDMODEL%YRML_PHY_MF%YRPHY, &
...
!* Compute PBL-diagnostics
  ...
  CALL ACCLDIA(YDXFU,YDPHY,YDMODEL%YRML_PHY_MF%YRPHY2,YDTOPH,YDCPG_DIM%KIDIA,YDCPG_DIM%KFDIA,YDCPG_DIM%KLON,YDCPG_DIM%KFLEVG,YDMF_PHYS%OUT%UCLS,&
   & YDMF_PHYS%OUT%VCLS,YDMF_PHYS_STATE%U(:,1:YDCPG_DIM%KFLEVG),YDMF_PHYS_STATE%V(:,1:YDCPG_DIM%KFLEVG),ZCAPE,ZDCAPE,ZTKEM(:,1:YDCPG_DIM%KFLEVG),YDMF_PHYS_STATE%YCPG_DYN%PHIF(:,1:YDCPG_DIM%KFLEVG),YDOROG%OROG,&
...
IF (LDPRECIPS.OR.LDPRECIPS2) THEN
  ...
  IF (LDPRECIPS) THEN
   ...
   CALL DPRECIPS(YDPRECIPS,YDCPG_DIM%KIDIA,YDCPG_DIM%KFDIA,YDCPG_DIM%KLON,YDCPG_DIM%KFLEVG,YDOROG%OROG,YDMF_PHYS%OUT%TPWCLS,YDMF_PHYS%OUT%DIAGH,YDMF_PHYS_STATE%YCPG_DYN%PHIF,&
