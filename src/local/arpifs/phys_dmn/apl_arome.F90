...
SUBROUTINE APL_AROME(YDGEOMETRY,YDCPG_DIM,YDMF_PHYS_STATE,YDCPG_MISC,YDMF_PHYS,YDMF_PHYS_SURF,YDVARS,YDSURF, YDCFU, YDXFU, YDMODEL, &
 & KTDIA  , &
...
REAL(KIND=JPRB)   ,INTENT(OUT)   :: PEDR(YDCPG_DIM%KLON,YDCPG_DIM%KFLEVG)
...
ELSE
  ...
  ELSE
    ZQHM(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_DIM%KFLEVG)=0._JPRB
  ENDIF
  ZCPM(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,KTDIA:YDCPG_DIM%KFLEVG)=YDMF_PHYS_STATE%YCPG_DYN%RCP%CP(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,KTDIA:YDCPG_DIM%KFLEVG)
...
!              ZALBP(JLON,JSW)=PALBIN(JLON)+ZSALBCOR
  ...
  IF (LRAY.AND.NRAY == 2.AND.LRADFLEX.AND.LRSTAER) THEN
    ...
    ZAER(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:KTDIA-1,1)=0._JPRB
...
!* Compute PBL-diagnostics
   ...
   CALL ACVISIH(YDVISI,YDCPG_DIM%KIDIA,YDCPG_DIM%KFDIA,YDCPG_DIM%KLON,KTDIA,YDCPG_DIM%KFLEVG,YDMF_PHYS_STATE%YCPG_DYN%PHI,YDMF_PHYS_STATE%YCPG_DYN%PHIF,YDMF_PHYS_STATE%YCPG_PHY%PREF,&
...
!!$  ENDIF
  ...
  DO JLEV = 1 , YDCPG_DIM%KFLEVG
     PEDR(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,JLEV)=ZEDR__(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,JLEV)
  ENDDO
...
IF (LDPRECIPS.OR.LDPRECIPS2) THEN
  ...
  IF (LDPRECIPS) THEN
   ...
   CALL DPRECIPS(YDPRECIPS,YDCPG_DIM%KIDIA,YDCPG_DIM%KFDIA,YDCPG_DIM%KLON,YDCPG_DIM%KFLEVG,POROG,YDMF_PHYS%OUT%TPWCLS,YDMF_PHYS%OUT%DIAGH,YDMF_PHYS_STATE%YCPG_DYN%PHIF,&
      & ZDZZ,ZTPW,ZQCM,YDMF_PHYS%OUT%FPLSL(:,YDCPG_DIM%KFLEVG),YDMF_PHYS%OUT%FPLSN(:,YDCPG_DIM%KFLEVG),YDMF_PHYS%OUT%FPLSG(:,YDCPG_DIM%KFLEVG),YDMF_PHYS%TMP%PRC%DPRECIPS(:,NDTPRECCUR))
  ENDIF
  ...
  IF (LDPRECIPS2) THEN
   ...
   CALL DPRECIPS(YDPRECIPS,YDCPG_DIM%KIDIA,YDCPG_DIM%KFDIA,YDCPG_DIM%KLON,YDCPG_DIM%KFLEVG,POROG,YDMF_PHYS%OUT%TPWCLS,YDMF_PHYS%OUT%DIAGH,YDMF_PHYS_STATE%YCPG_DYN%PHIF,&
      & ZDZZ,ZTPW,ZQCM,YDMF_PHYS%OUT%FPLSL(:,YDCPG_DIM%KFLEVG),YDMF_PHYS%OUT%FPLSN(:,YDCPG_DIM%KFLEVG),YDMF_PHYS%OUT%FPLSG(:,YDCPG_DIM%KFLEVG),YDMF_PHYS%TMP%PRC%DPRECIPS2(:,NDTPRECCUR2))
