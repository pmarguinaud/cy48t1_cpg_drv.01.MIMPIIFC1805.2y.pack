...
REAL(KIND=JPRB)   ,INTENT(OUT)   :: PSPSG(KLON,YDSURF%YSP_SGD%NLEVS)
REAL(KIND=JPRB)   ,INTENT(OUT)   :: PSPSGR(KLON,YDSURF%YSP_SGD%NLEVS) 
...
!ZSFRV_(KIDIA:KFDIA) = 0._JPRB
    ...
    IF (LLMSE_DIAG) THEN
      ...
      CALL ARO_GROUND_DIAG_2ISBA( KBL, KGPCOMP, &
       ...
       & NDGUNG, NDGUXG, NDLUNG, NDLUXG, LSURFEX_KFROM, &
       & PINDX(KIDIA:KFDIA), PINDY(KIDIA:KFDIA), &
       & PLSM, ZDUMMY1, ZDUMMY1, ZDUMMY1, ZTSURF(KIDIA:KFDIA), PSPSG, &
       & ZDUMMY1(KIDIA:KFDIA), ZDUMMY1(KIDIA:KFDIA), ZDUMMY1(KIDIA:KFDIA), &
       & ZDUMMY1(KIDIA:KFDIA), ZDUMMY1(KIDIA:KFDIA), ZDUMMY1(KIDIA:KFDIA), &
       & ZDUMMY1(KIDIA:KFDIA), PSPSGR, ZDUMMY1 )
