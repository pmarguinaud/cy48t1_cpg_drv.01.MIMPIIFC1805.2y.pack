SUBROUTINE APL_AROME_CALC_IPTR (YDMODEL, KEFB1, KEFB2, KEFB3, KPTR, KPTREXT, KPTRLIMA, KPTRTKE, KPTR_CONT, KRR)
...
INTEGER(KIND=JPIM), INTENT (OUT) :: KPTREXT,KPTR_CONT,KEFB1,KEFB2,KEFB3
...
IF (YDMODEL%YRML_GCONF%YGFL%YQ%LACTIVE) THEN
  KPTR(YDMODEL%YRML_GCONF%YGFL%YQ%MP1) = KPTR_CONT ; KPTR_CONT = KPTR_CONT+1
ENDIF   
IF (YDMODEL%YRML_GCONF%YGFL%YL%LACTIVE) THEN
  KPTR(YDMODEL%YRML_GCONF%YGFL%YL%MP1) = KPTR_CONT ; KPTR_CONT = KPTR_CONT+1
ENDIF   
IF (YDMODEL%YRML_GCONF%YGFL%YR%LACTIVE) THEN
  KPTR(YDMODEL%YRML_GCONF%YGFL%YR%MP1) = KPTR_CONT ; KPTR_CONT = KPTR_CONT+1
ENDIF   
IF (YDMODEL%YRML_GCONF%YGFL%YI%LACTIVE) THEN
  KPTR(YDMODEL%YRML_GCONF%YGFL%YI%MP1) = KPTR_CONT ; KPTR_CONT = KPTR_CONT+1
ENDIF   
IF (YDMODEL%YRML_GCONF%YGFL%   &
& YS%LACTIVE) THEN
  KPTR(YDMODEL%YRML_GCONF%YGFL%   &
& YS%MP1) = KPTR_CONT ; KPTR_CONT = KPTR_CONT+1
ENDIF   
IF (YDMODEL%YRML_GCONF%YGFL%YG%LACTIVE) THEN
  KPTR(YDMODEL%YRML_GCONF%YGFL%YG%MP1) = KPTR_CONT ; KPTR_CONT = KPTR_CONT+1
ENDIF   
IF (YDMODEL%YRML_GCONF%YGFL%YH%LACTIVE) THEN
  KPTR(YDMODEL%YRML_GCONF%YGFL%YH%MP1) = KPTR_CONT ; KPTR_CONT = KPTR_CONT+1
ENDIF   

! * ZTENDTKE   
IF (YDMODEL%YRML_GCONF%YGFL%YTKE%LACTIVE) THEN
  KPTR(YDMODEL%YRML_GCONF%YGFL%YTKE%MP1) = KPTR_CONT ; KPTR_CONT = KPTR_CONT+1
...
IF (YDMODEL%YRML_GCONF%YGFL%YEFB1%LACTIVE) THEN
  KPTR(YDMODEL%YRML_GCONF%YGFL%YEFB1%MP1) = KPTR_CONT ; KPTR_CONT = KPTR_CONT+1
  KEFB1 = KPTR(YDMODEL%YRML_GCONF%YGFL%YEFB1%MP1)
ELSE
  KEFB1 = 0
ENDIF   
IF (YDMODEL%YRML_GCONF%YGFL%YEFB2%LACTIVE) THEN
  KPTR(YDMODEL%YRML_GCONF%YGFL%YEFB2%MP1) = KPTR_CONT ; KPTR_CONT = KPTR_CONT+1
  KEFB2 = KPTR(YDMODEL%YRML_GCONF%YGFL%YEFB2%MP1)
ELSE
  KEFB2 = 0
ENDIF
IF (YDMODEL%YRML_GCONF%YGFL%YEFB3%LACTIVE) THEN   
  KPTR(YDMODEL%YRML_GCONF%YGFL%YEFB3%MP1) = KPTR_CONT ; KPTR_CONT = KPTR_CONT+1
...
IF (YDMODEL%YRML_GCONF%YGFL%NGFL_EXT > 0) THEN
  DO JGFL=1,YDMODEL%YRML_GCONF%YGFL%NGFL_EXT
    IF (YDMODEL%YRML_GCONF%YGFL%YEXT(JGFL)%LACTIVE) THEN   
      KPTR(YDMODEL%YRML_GCONF%YGFL%YEXT(JGFL)%MP1)=KPTR_CONT
      KPTR_CONT = KPTR_CONT+1   
    ENDIF
  ENDDO  
...
IF (YDMODEL%YRML_GCONF%YGFL%NLIMA > 0) THEN
  DO JGFL=1,YDMODEL%YRML_GCONF%YGFL%NLIMA
    IF (YDMODEL%YRML_GCONF%YGFL%YLIMA(JGFL)%LACTIVE) THEN   
      KPTR(YDMODEL%YRML_GCONF%YGFL%YLIMA(JGFL)%MP1)=KPTR_CONT
      KPTR_CONT = KPTR_CONT+1   
    ENDIF
  ENDDO  
