...
& LLHMT, ZCDROV, ZCEROV, ZCHROV, ZDPHIT, ZDPHIV, ZDSA_RS, ZFLU_CD, ZFLU_CDN, ZFLU_CH,    &
& ZFLU_QSATS)
...
& YDMF_PHYS, YDCPG_DYN0, YDMODEL, YDDDH, INLAB_CVPP, INND, ZCDROV, ZCDROV_SAVE, ZCHROV, ZCHROV_SAVE, &
& ZCOEFN, ZCONDCVPPI, ZCONDCVPPL, ZDIFCVPPQ, ZDIFCVPPS, ZEPS, ZFLU_CD, ZFLU_CH, ZKQLROV, ZKQROV,     &
& ZKTROV, ZKTROV_SAVE, ZKUROV, ZKUROV_SAVE, ZMSC_LSCPE, ZNBVNO, ZNEBS, ZNEBS0, ZNEB_CVPP, ZNLAB,     &
& ZNLABCVP, ZPFL_FPLCH, ZPFL_FTKE, ZPFL_FTKEI, ZPRODTH_CVPP, ZQI, ZQIC, ZQL, ZQLC, ZQLIS, ZQLIS0,    &
& ZQLI_CVPP, ZQV, ZTKE1, ZTPRDY, ZXTROV, ZXUROV)
...
& YDMODEL, ZALBD, ZALBP, ZEPS0, ZFLU_EMIS, ZFLU_NEIJ, ZMERL, ZRDG_MU0)

CALL APL_ARPEGE_AEROSOLS_FOR_RADIATION (YDMF_PHYS_BASE_STATE, YDCPG_DIM, YDMF_PHYS_SURF, YDMODEL, &
& ZAEDES, ZAELAN, ZAER, ZAERINDS, ZAESEA, ZAESOO, ZAESUL, ZAEVOL)

CALL APL_ARPEGE_CLOUDINESS (YDMF_PHYS_BASE_STATE, YDCPG_DIM, YDCPG_MISC, YDMF_PHYS, YDVARS, YDMODEL, &
& LLREDPR, ZAIPCMT, ZBLH, ZCLCT_RAD, ZDECRD, ZFLU_QSAT, ZHUC, ZICEFR1, ZMSC_QW, ZNEBC0, ZNEBCH,      &
& ZNEBS, ZNEBS0, ZNEB_CVPP, ZPFL_FPLCH, ZQI, ZQL, ZQLIS, ZQLIS0, ZQLI_CVP, ZQLI_CVPP, ZQSATS, ZQV,   &
& ZRH, ZRHCRI, ZUNEBH, ZVETAF)
  
CALL APL_ARPEGE_RADIATION (YDMF_PHYS_BASE_STATE, YDGEOMETRY, YDCPG_DIM, YDCPG_MISC, YDCPG_GPAR,    &
& YDMF_PHYS, YDMF_PHYS_SURF, YDVARS, YDMODEL, ZAER, ZAERINDS, ZALB, ZALBD, ZALBP, ZCEMTR, ZCTRSO,  &
& ZDSRP, ZFLU_EMIS, ZFLU_QSAT, ZFRSODS, ZFSDNN, ZFSDNV, ZQO3, ZQR, ZQS, ZQV, ZRDG_MU0, ZRDG_MU0LU, &
& ZRDG_MU0M, ZSDUR, ZSFSWDIF, ZSFSWDIR, ZSUDU, ZTENT, ZTRSOD, ZTRSODIF, ZTRSODIR)
...
& ZTENDH, YDMF_PHYS%OUT%TENDU, YDMF_PHYS%OUT%TENDV, ZTENDU, ZTENDV, ZTENDD, ZTENDEFB1,        &
