...
REAL(KIND=JPRB) :: ZAEN, ZEPS, ZEPS0, ZEPSNEB, ZEPSO3
...
CALL APL_ARPEGE_ATMOSPHERE_UPDATE (YDMF_PHYS_BASE_STATE, YDMF_PHYS_NEXT_STATE, YDGEOMETRY, YDCPG_DIM, YDCPG_MISC, YDMF_PHYS, YDCPG_DYN0, YDMF_PHYS_SURF, YDVARS, YDSURF, YDMODEL, LDCONFX, PDTPHY, YDDDH, ZDIFEXT, ZDSA_CPS, ZMSC_FRMQ, ZPFL_FEFB1, ZPFL_FEFB2, ZPFL_FEFB3, ZPFL_FTKE, ZPFL_FTKEI, ZRDG_CVGQ, ZRDG_LCVQ, ZRDG_MU0)
