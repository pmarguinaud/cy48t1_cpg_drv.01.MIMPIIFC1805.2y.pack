...
CALL APL_ARPEGE_CLOUDINESS (YDMF_PHYS_BASE_STATE, YDCPG_DIM, YDCPG_MISC, YDMF_PHYS, YDVARS, YDMODEL, LLREDPR, ZAIPCMT, ZBLH, ZCLCT_RAD, ZDECRD, ZFLU_QSAT, ZHUC, ZICEFR1, ZMSC_QW, ZNEBC0, ZNEBCH, ZNEBS, ZNEBS0, ZNEB_CVPP, ZPFL_FPLCH, ZQI, ZQL, ZQLIS, ZQLIS0, ZQLI_CVP, ZQLI_CVPP, ZQSATS, ZQV, ZRH, ZRHCRI, ZUNEBH, ZVETAF)
