...
& YDMF_PHYS, YDCPG_DYN0, YDMODEL, YDDDH, INLAB_CVPP, ZCDROV, ZCHROV, &
& ZCOEFN, ZCONDCVPPI, ZCONDCVPPL, ZDIFCVPPQ, ZDIFCVPPS, ZEPS, ZFLU_CD, ZFLU_CH, ZKQLROV, ZKQROV,     &
& ZKTROV, ZKUROV, ZMSC_LSCPE, ZNBVNO, ZNEBS, ZNEBS0, ZNEB_CVPP, &
& ZPFL_FPLCH, ZPFL_FTKE, ZPFL_FTKEI, ZPRODTH_CVPP, ZQI, ZQIC, ZQL, ZQLC, ZQLIS, ZQLIS0,    &
& ZQLI_CVPP, ZQV, ZTKE1, ZXTROV, ZXUROV)
