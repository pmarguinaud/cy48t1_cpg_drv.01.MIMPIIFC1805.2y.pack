...
CALL APL_ARPEGE_INIT (YDGEOMETRY, YDMODEL%YRCST, YDMF_PHYS_BASE_STATE, YDCPG_BNDS, YDCPG_OPTS, YDCPG_MISC, &
...
CALL APL_ARPEGE_OCEANIC_FLUXES (YDGEOMETRY, YDMF_PHYS_BASE_STATE, YDCPG_BNDS, YDCPG_OPTS, YDMF_PHYS,  &
& YDMF_PHYS_SURF, YDMODEL, LLHMT, ZCDROV, ZCEROV, ZCHROV, ZDPHIT, ZDPHIV, ZDSA_RS, ZFLU_CD, ZFLU_CDN, &
& ZFLU_CH, ZFLU_QSATS)


CALL APL_WIND_GUST (YDGEOMETRY, YDMF_PHYS_BASE_STATE, YDCPG_BNDS, YDCPG_OPTS, YDMF_PHYS, YDVARS, &
