...
IF ((.NOT.LMSE)) THEN
  ...
  & PAPHI, PAPHIF, PAPRS, PAPRSF, YDMF_PHYS_BASE_STATE%Q, PT, PU, PV, ZDPHIT, ZDPHIV, YDMF_PHYS%OUT%GZ0,         &
  & YDMF_PHYS_SURF%GSD_VF%PLSM, ZFLU_QSATS, ZCRTI, YDMF_PHYS_BASE_STATE%YGSP_RR%T, LLHMT, ZFLU_CD,               &
  & ZFLU_CDN, ZCDROV, ZCE, ZCEROV, ZFLU_CH, ZCHROV, YDMF_PHYS%OUT%QCLS, YDMF_PHYS%OUT%RHCLS, YDMF_PHYS%OUT%TCLS, &
