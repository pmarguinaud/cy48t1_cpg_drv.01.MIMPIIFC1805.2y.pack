...
& NDPSFI=>YDPHY%NDPSFI, LRRGUST=>YDPHY%LRRGUST, LEDR=>YDPHY%LEDR, NTPLUI=>YDTOPH%NTPLUI, &
& XMINLM=>YDPHY0%XMINLM, HUTIL2=>YDPHY0%HUTIL2, HUTIL1=>YDPHY0%HUTIL1,                 &
...
& ZFPLS(:, YDCPG_OPTS%KFLEVG), ZFPLSG(:, YDCPG_OPTS%KFLEVG), ZPRC_DPRECIPS2(:, YDCPG_OPTS%NDTPRECCUR2))
