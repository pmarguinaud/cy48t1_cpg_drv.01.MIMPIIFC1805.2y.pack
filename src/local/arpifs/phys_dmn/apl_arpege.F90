...
& YDVARS, YDMODEL, LLREDPR, ZAIPCMT, ZBLH, ZDECRD, ZFLU_QSAT, YDMODEL%YRML_PHY_MF%YRPHY0%RHUC, ZMSC_QW, &
& ZNEBC0, ZNEBCH, ZNEBS, ZNEBS0, ZNEB_CVPP, ZPFL_FPLCH, ZQI, ZQL, ZQLIS, ZQLIS0, ZQLI_CVP, ZQLI_CVPP,   &
& ZQV, ZUNEBH, YDSTA%SVETAF)
...
& ZQLI_CVPP, ZQR, ZQS, ZQV, ZSEDIQI, ZSEDIQL, ZTENHA, ZTENQVA, YDSTA%SVETAF)
