...
DO JLEV=1,YDCPG_OPTS%KFLEVG
  ...
  & YDMF_PHYS_BASE_STATE%Q(:, JLEV), YDMF_PHYS_BASE_STATE%L(:, JLEV), YDMF_PHYS_BASE_STATE%I(:, JLEV), ZTW(:, JLEV))
ENDDO
...
DO JLEV = 1,YDCPG_OPTS%KFLEVG
  DO JLON = YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA
    ZZZ(JLON,JLEV)=PAPHI(JLON,JLEV)*ZINVG
  ENDDO
ENDDO
...
DO JLON = YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA
  ZDZZ(JLON,1)=PAPHI(JLON,0)*ZINVG-ZZZ(JLON,1)
ENDDO
...
& YDCPG_MISC, YDMF_PHYS, YDCPG_DYN0, YDMF_PHYS_SURF, YDVARS, YDMODEL, YDCPG_OPTS%LCONFX, YDCPG_OPTS%ZDTPHY,        &
& YDDDH, ZDIFEXT, ZDSA_CPS, ZMSC_FRMQ, ZPFL_FEFB1, ZPFL_FEFB2, ZPFL_FEFB3, ZPFL_FTKE, ZPFL_FTKEI)
