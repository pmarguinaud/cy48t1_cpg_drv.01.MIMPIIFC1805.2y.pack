...
& LRAFTKE=>YDPHY2%LRAFTKE, HVCLS=>YDPHY2%HVCLS, HTCLS=>YDPHY2%HTCLS, RII0=>YDPHY3%RII0, NDLUNG=>YDDIM%NDLUNG,              &
& NDGUNG=>YDDIM%NDGUNG, NDLUXG=>YDDIM%NDLUXG, NDGUXG=>YDDIM%NDGUXG, LSURFEX_KFROM=>YDARPHY%LSURFEX_KFROM,                  &
& YA=>YGFL%YA, YIRAD=>YGFL%YIRAD, YLRAD=>YGFL%YLRAD, LHUCN=>YDPHY%LHUCN, LSTRAS=>YDPHY%LSTRAS, LSOLV=>YDPHY%LSOLV,         &
& NSWB_MNH=>YDPARAR%NSWB_MNH, NTDRME=>YDTOPH%NTDRME, NTDRAG=>YDTOPH%NTDRAG, RMESOQ=>YDTOPH%RMESOQ, RMESOT=>YDTOPH%RMESOT,  &
& RMESOU=>YDTOPH%RMESOU, NTQSAT=>YDTOPH%NTQSAT, NSW=>YDERAD%NSW, LMCC03=>YDMCC%LMCC03, RHGMT=>YDRIP%RHGMT,                 &
...
CALL APL_ARPEGE_INIT (YDMF_PHYS_BASE_STATE, YDCPG_DIM, YDCPG_MISC, YDMF_PHYS, YDMF_PHYS_SURF, YDVARS, &
...
CALL APL_ARPEGE_INIT_SURFEX (YDMF_PHYS_BASE_STATE, YDGEOMETRY, YDCPG_DIM, YDCPG_MISC, YDCPG_GPAR, &
...
CALL APL_WIND_GUST (YDMF_PHYS_BASE_STATE, YDCPG_DIM, YDMF_PHYS, YDVARS, YDXFU, YDMODEL, IMOC_CLPH, &
& ZBLH, ZDCAPE)
...
CALL APL_ARPEGE_ATMOSPHERE_UPDATE (YDMF_PHYS_BASE_STATE, YDMF_PHYS_NEXT_STATE, YDGEOMETRY, YDCPG_DIM, &
& YDCPG_MISC, YDMF_PHYS, YDCPG_DYN0, YDMF_PHYS_SURF, YDVARS, YDSURF, YDMODEL, LDCONFX, PDTPHY, YDDDH, &
& ZDIFEXT, ZDSA_CPS, ZMSC_FRMQ, ZPFL_FEFB1, ZPFL_FEFB2, ZPFL_FEFB3, ZPFL_FTKE, ZPFL_FTKEI, ZRDG_CVGQ, &
& ZRDG_LCVQ, ZRDG_MU0)
