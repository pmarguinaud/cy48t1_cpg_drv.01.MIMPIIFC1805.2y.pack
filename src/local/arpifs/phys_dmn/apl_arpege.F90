...
& YDSURF, YDCFU, YDXFU, YDMODEL, LDCONFX, PDTPHY, YDDDH)
...
IF(LGCHECKMV) CALL CHECKMV(YDRIP, YDPHY0, YDPHY2, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_OPTS%KLON,       &
              & YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KSTEP, PAPHI, PAPHIF, PAPRS, PAPRSF, YDVARS%GEOMETRY%GELAM%T0, &
...
CALL APL_ARPEGE_INIT (YDMF_PHYS_BASE_STATE, YDCPG_BNDS, YDCPG_OPTS, YDCPG_MISC, YDMF_PHYS,            &
...
CALL APL_WIND_GUST (YDMF_PHYS_BASE_STATE, YDCPG_BNDS, YDCPG_OPTS, YDMF_PHYS, YDVARS, YDXFU, YDMODEL, &
...
& YDCPG_GPAR, YDMF_PHYS, YDMF_PHYS_SURF, YDVARS, YDMODEL, LDCONFX, ZALBD, ZALBP, ZALPHA1, ZCDROV,    &
...
& LDCONFX, PDTPHY, YDDDH, ZDIFEXT, ZDSA_CPS, ZMSC_FRMQ, ZPFL_FEFB1, ZPFL_FEFB2, ZPFL_FEFB3,           &
...
& YDSURF, YDMODEL, LDCONFX, PDTPHY, ZDSA_C1, ZDSA_C2, ZFLU_FEVI, ZFLU_VEG)
...
IF(LNUDG)THEN
  ...
  & YDMF_PHYS_NEXT_STATE%U (:, 1:YDCPG_OPTS%KFLEVG), YDMF_PHYS_NEXT_STATE%V (:, 1:YDCPG_OPTS%KFLEVG),                              &
  & YDMF_PHYS_NEXT_STATE%SP, YDVARS%T%T0, YDVARS%Q%T0, YDVARS%U%T0, YDVARS%V%T0, YDCPG_PHY0%PREHYD(:, YDCPG_OPTS%KFLEVG),          &
  & YDVARS%GEOMETRY%GM%T0, YDMF_PHYS_SURF%GSD_VF%PLSM)
ENDIF
