SUBROUTINE APL_ARPEGE_AEROSOLS_FOR_RADIATION (YDMF_PHYS_BASE_STATE, YDCPG_DIM, YDCPG_OPTS, YDMF_PHYS_SURF, &
& YDMODEL, PAER, PAERINDS)
...
REAL(KIND=JPRB) :: ZAESEA(YDCPG_DIM%KLON) 
REAL(KIND=JPRB) :: ZAELAN(YDCPG_DIM%KLON) 
REAL(KIND=JPRB) :: ZAESOO(YDCPG_DIM%KLON) 
REAL(KIND=JPRB) :: ZAEDES(YDCPG_DIM%KLON)
REAL(KIND=JPRB) :: ZAESUL(YDCPG_DIM%KLON)
REAL(KIND=JPRB) :: ZAEVOL(YDCPG_DIM%KLON)
