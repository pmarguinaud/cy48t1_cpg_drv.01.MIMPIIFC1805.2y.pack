...
& YDCPG_DIM, YDCPG_OPTS, YDCPG_MISC, YDMF_PHYS, YDCPG_DYN0, YDMF_PHYS_SURF, YDVARS, YDSURF, YDMODEL, LDCONFX, &
...
CALL CPUTQY_APLPAR_EXPL(YDCPG_DIM, YDCPG_OPTS, YDMF_PHYS_NEXT_STATE, YDMF_PHYS_BASE_STATE, YDVARS, YDMODEL%YRML_PHY_MF%YRPHY, &
