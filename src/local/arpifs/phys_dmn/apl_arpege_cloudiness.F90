SUBROUTINE APL_ARPEGE_CLOUDINESS (YDMF_PHYS_BASE_STATE, YDCPG_BNDS, YDCPG_OPTS, YDCPG_MISC, YDMF_PHYS, YDVARS,   &
...
REAL(KIND=JPRB),                INTENT(IN)    :: PHUC(YDCPG_OPTS%KFLEVG)
...
CALL ACNEBCOND ( YDMODEL%YRML_GCONF%YRRIP, YDMODEL%YRML_PHY_MF, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_OPTS%KLON,  &
& YDMODEL%YRML_PHY_MF%YRTOPH%NTPLUI, YDCPG_OPTS%KFLEVG, LDREDPR, PHUC, PVETAF, YDMF_PHYS_BASE_STATE%YCPG_DYN%PHI,   &
...
IF(YDMODEL%YRML_PHY_MF%YRPHY%LNEBN) THEN
  CALL ACNEBN ( YDMODEL%YRML_PHY_MF, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_OPTS%KLON, YDMODEL%YRML_PHY_MF%YRTOPH%NTNEBU, &
...
CALL ACNPART(YDMODEL%YRML_PHY_MF, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_OPTS%KLON, YDMODEL%YRML_PHY_MF%YRTOPH%NTNEBU,            &
