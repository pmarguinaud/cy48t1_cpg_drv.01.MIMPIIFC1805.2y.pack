...
& YDMODEL, LDREDPR, PAIPCMT, PBLH, PCLCT_RAD, PDECRD, PFLU_QSAT, PHUC, PICEFR1, PMSC_QW, PNEBC0,      &
& PNEBCH, PNEBS, PNEBS0, PNEB_CVPP, PPFL_FPLCH, PQI, PQL, PQLIS, PQLIS0, PQLI_CVP, PQLI_CVPP, PQSATS, &
& PQV, PRH, PRHCRI, PUNEBH, PVETAF)
...
& PCLCT_RAD, PCLCC=YDMF_PHYS%OUT%CLCC, PNEBC=PNEBC0, PTOPC=YDMF_PHYS%OUT%CTOP)  
