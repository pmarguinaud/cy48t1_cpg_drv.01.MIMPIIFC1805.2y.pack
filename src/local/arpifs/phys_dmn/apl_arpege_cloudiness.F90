...
& YDMODEL%YRML_PHY_MF%YRTOPH%NTPLUI, YDCPG_OPTS%KFLEVG, LDREDPR, YDMODEL%YRML_PHY_MF%YRPHY0%RHUC, YDSTA, YDMF_PHYS_BASE_STATE%YCPG_DYN%PHI, &
...
IF(YDMODEL%YRML_PHY_MF%YRPHY%LNEBN) THEN
  ...
  & YDMODEL%YRML_PHY_MF%YRPHY0%RHUC, YDSTA%SVETAF)
