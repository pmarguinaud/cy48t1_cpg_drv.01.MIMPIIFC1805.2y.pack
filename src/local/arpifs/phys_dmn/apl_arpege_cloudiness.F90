...
CALL ACNEBCOND (YDMODEL%YRCST, YDMODEL%YRML_GCONF%YRRIP, YDMODEL%YRML_PHY_MF, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA,           &
& YDCPG_OPTS%KLON, YDMODEL%YRML_PHY_MF%YRTOPH%NTPLUI, YDCPG_OPTS%KFLEVG, LDREDPR, YDSTA, YDMF_PHYS_BASE_STATE%YCPG_DYN%PHI, &
& YDMF_PHYS_BASE_STATE%YCPG_DYN%PHIF, YDMF_PHYS_BASE_STATE%YCPG_PHY%PREHYDF, YDMF_PHYS_BASE_STATE%YCPG_DYN%RCP%CP,          &
& YDMF_PHYS_BASE_STATE%YCPG_DYN%RCP%R, YDMF_PHYS_BASE_STATE%YCPG_PHY%XYB%DELP, YDCPG_MISC%RH, PBLH, PQV, PQI, PQL, PMSC_QW, &
& YDMF_PHYS_BASE_STATE%T, PNEBCH, YDVARS%GEOMETRY%GM%T0, YDMF_PHYS_BASE_STATE%YGSP_RR%T, PQLIS, PNEBS, ZRHCRI, ZRH, ZQSATS, &
& ZICEFR1, PQLIS0, PNEBS0)
...
& PDECRD, YDCPG_MISC%NEB, YDMF_PHYS%OUT%CLCH, YDMF_PHYS%OUT%CLCM, YDMF_PHYS%OUT%CLCL, YDCPG_MISC%CLCT, ZCLCT_RAD,                         &
& PCLCC=YDMF_PHYS%OUT%CLCC, PNEBC=PNEBC0, PTOPC=YDMF_PHYS%OUT%CTOP)  
