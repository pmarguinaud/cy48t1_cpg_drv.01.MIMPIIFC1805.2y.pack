SUBROUTINE APL_ARPEGE_DEEP_CONVECTION (YDMF_PHYS_BASE_STATE, YDGEOMETRY, YDCPG_DIM, YDCPG_OPTS, YDMF_PHYS, &
& YDCPG_DYN0, YDMF_PHYS_SURF, YDVARS, YDCFU, YDMODEL, PFPCOR, PQV, PTENHA, PTENQVA, PTENT)
...
IF(YDCFU%LFLASH) THEN
  ...
  ZGAW(:)=0._JPRB
  CALL CULIGHT   ( YDMODEL%YRML_PHY_EC%YREPHY, YDMODEL%YRML_GCONF%YGFL, YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA,                      &
  & YDCPG_DIM%KLON, YDCPG_DIM%KFLEVG, ZGAW, ZGAW, YDMF_PHYS_BASE_STATE%YCPG_PHY%PREHYDF, YDMF_PHYS_BASE_STATE%YCPG_PHY%PREHYD, &
