SUBROUTINE APL_ARPEGE_DEEP_CONVECTION (YDMF_PHYS_BASE_STATE, YDGEOMETRY, YDCPG_BNDS, YDCPG_OPTS, YDMF_PHYS, &
...
IF(YDCFU%LFLASH) THEN
  ...
  ZGAW(:)=0._JPRB
  CALL CULIGHT   ( YDMODEL%YRML_PHY_EC%YREPHY, YDMODEL%YRML_GCONF%YGFL, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA,                      &
