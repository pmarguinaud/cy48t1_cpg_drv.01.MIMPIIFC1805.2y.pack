...
& YDMF_PHYS, YDCPG_DYN0, YDMF_PHYS_SURF, YDVARS, YDCFU, YDMODEL, PFPCOR, PQV, PTENHA, PTENQVA, PTENT&
& )
...
CALL CUCALLN_MF   (YDMODEL%YRML_PHY_EC%YRTHF, YDMODEL%YRCST, YDMODEL%YRML_PHY_RAD%YRERAD, YDMODEL%YRML_PHY_SLIN,           &
& YDMODEL%YRML_PHY_EC, YDMODEL%YRML_GCONF%YGFL,                                                                            &
...
IF(YDCFU%LFLASH) THEN
  ...
  ZGAW(:)=0._JPRB
  CALL CULIGHT   (YDMODEL%YRML_PHY_EC%YRTHF, YDMODEL%YRCST, YDMODEL%YRML_PHY_EC%YREPHY, YDMODEL%YRML_GCONF%YGFL,                 &
