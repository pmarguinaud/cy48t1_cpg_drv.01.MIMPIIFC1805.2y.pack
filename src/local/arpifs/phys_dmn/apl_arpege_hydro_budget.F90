SUBROUTINE APL_ARPEGE_HYDRO_BUDGET (YDMF_PHYS_BASE_STATE, YDCPG_DIM, YDCPG_GPAR, YDMF_PHYS, YDMF_PHYS_SURF, YDSURF, YDMODEL, &
& PC3, PCN, PDSA_C1, PDSA_C2, PFLU_FEVI, PFLU_NEIJ, PFLU_VEG, PFPLSL, PFPLSN, PWFC, PWLMX, PWPMX, PWSEQ, PWSMX)
...
ELSE
  IF ( YDMODEL%YRML_PHY_MF%YRPHY%LSOLV ) THEN
    ...
    & YDSURF%YSP_SBD%NLEVS, YDMF_PHYS%OUT%FPLCL, YDMF_PHYS%OUT%FPLCN, PFPLSL, PFPLSN, YDMF_PHYS%OUT%FRSO, YDMF_PHYS%OUT%FRTH, &
    & PDSA_C1, PDSA_C2, PC3, PCN, YDMF_PHYS%OUT%CT, YDMF_PHYS_SURF%GSD_VV%PD2, YDMF_PHYS%OUT%FEVV, YDMF_PHYS%OUT%FTR,  &
    & YDMF_PHYS_SURF%GSD_VV%PLAI, PFLU_NEIJ, PFLU_VEG, PWFC, PWPMX, YDMF_PHYS_BASE_STATE%YGSP_RR%FC,                   &
