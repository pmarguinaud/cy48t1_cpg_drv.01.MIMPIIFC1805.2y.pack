...
& YDMF_PHYS_SURF, YDSURF, YDMODEL, PC3, PCN, PDSA_C1, PDSA_C2, PFLU_FEVI, PFLU_NEIJ, PFLU_VEG, &
...
ELSE
  IF ( YDMODEL%YRML_PHY_MF%YRPHY%LSOLV ) THEN
    ...
    & YDSURF%YSP_SBD%NLEVS, YDMF_PHYS%OUT%FPLCL, YDMF_PHYS%OUT%FPLCN, PFPLSL, PFPLSN, YDMF_PHYS%OUT%FRSO,               &
