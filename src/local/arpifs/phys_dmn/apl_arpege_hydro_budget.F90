SUBROUTINE APL_ARPEGE_HYDRO_BUDGET (YDMF_PHYS_BASE_STATE, YDCPG_BNDS, YDCPG_OPTS, YDCPG_GPAR, YDMF_PHYS,    &
...
ELSE
  IF ( YDMODEL%YRML_PHY_MF%YRPHY%LSOLV ) THEN
    ...
    & YDCPG_OPTS%YRSURF_DIMS%YSP_SBD%NLEVS, YDMF_PHYS%OUT%FPLCL, YDMF_PHYS%OUT%FPLCN, PFPLSL, PFPLSN, YDMF_PHYS%OUT%FRSO,               &
