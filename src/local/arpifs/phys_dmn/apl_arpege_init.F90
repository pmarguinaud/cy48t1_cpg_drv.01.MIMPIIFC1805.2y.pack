SUBROUTINE APL_ARPEGE_INIT (YDMF_PHYS_BASE_STATE, YDCPG_BNDS, YDCPG_OPTS, YDCPG_MISC, YDMF_PHYS, YDMF_PHYS_SURF, &
...
ELSE
  CALL SUOZON(YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, PQO3, .FALSE., YDMF_PHYS_BASE_STATE%YCPG_PHY%PREHYD, &
