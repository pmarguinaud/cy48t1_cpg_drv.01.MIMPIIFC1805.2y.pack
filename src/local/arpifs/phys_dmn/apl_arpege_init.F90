SUBROUTINE APL_ARPEGE_INIT (YDMF_PHYS_BASE_STATE, YDCPG_DIM, YDCPG_OPTS, YDCPG_MISC, YDMF_PHYS, YDMF_PHYS_SURF, &
...
ELSE
  CALL SUOZON(YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA, YDCPG_DIM%KLON, YDCPG_DIM%KFLEVG, PQO3, .FALSE., YDMF_PHYS_BASE_STATE%YCPG_PHY%PREHYD, &
  & YDMF_PHYS_BASE_STATE%YCPG_PHY%XYB%RDELP, YDMODEL%YRML_PHY_MF%YRPHY%LO3ABC, YDMF_PHYS_SURF%GSD_VC%PGROUP                            &
  & )
ENDIF
