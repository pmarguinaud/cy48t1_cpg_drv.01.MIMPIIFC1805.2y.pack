SUBROUTINE APL_ARPEGE_INIT_SURFEX (YDMF_PHYS_BASE_STATE, YDGEOMETRY, YDCPG_BNDS, YDCPG_OPTS, YDCPG_MISC, &
...
!
IF (YDMODEL%YRML_PHY_MF%YRARPHY%LMSE.AND.YDCPG_OPTS%KSTEP == 0) THEN
  ...
  & YDMODEL%YRML_PHY_MF%YRARPHY%LSURFEX_KFROM, YDMF_PHYS%OUT%GZ0(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA), YDMF_PHYS%OUT%GZ0H(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA)&
  & )
ENDIF
