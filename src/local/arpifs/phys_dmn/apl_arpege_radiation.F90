SUBROUTINE APL_ARPEGE_RADIATION (YDMF_PHYS_BASE_STATE, YDGEOMETRY, YDCPG_DIM, YDCPG_OPTS, YDCPG_MISC, YDCPG_GPAR, &
...
& YDCPG_DIM%KFDIA, YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDMF_PHYS_BASE_STATE%YCPG_PHY%PREHYD, PFLU_EMIS,          &
...
IF(YDMODEL%YRML_PHY_MF%YRPHY0%GRSO < 1._JPRB) CALL ACRSO(YDMODEL%YRML_PHY_MF%YRPHY0, YDCPG_DIM%KIDIA,                                 &
                                              & YDCPG_DIM%KFDIA, YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KTDIA,                   &
