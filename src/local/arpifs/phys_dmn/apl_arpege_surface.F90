...
& YDMF_PHYS, YDMF_PHYS_SURF, YDVARS, YDSURF, YDMODEL, LDCONFX, PALBD, PALBP, PALPHA1, PCDROV, PCEROV, &
...
ELSEIF (.NOT.YDMODEL%YRML_PHY_MF%YRARPHY%LMSE) THEN
  ...
  & YDCPG_DIM%KLON, YDCPG_DIM%KTDIA, YDCPG_DIM%KFLEVG, YDSURF%YSP_SBD%NLEVS, YDMF_PHYS_BASE_STATE%YCPG_DYN%PHI,                &
