...
USE YOMCT0             , ONLY : LCALLSFX, LSFORCS
...
IF ( YDMODEL%YRML_PHY_MF%YRARPHY%LMSE.AND.LCALLSFX ) THEN
  ...
  DO JLON=YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA
    ...
    ZDEPTH_HEIGHT(JLON,:)=(YDMF_PHYS_BASE_STATE%YCPG_DYN%PHIF(JLON,:)-YDMF_PHYS_BASE_STATE%YCPG_DYN%PHI(JLON,YDCPG_OPTS%KFLEVG))/YDCST%RG
...
CALL ACDIFV2 (LSFORCS, YDMODEL%YRCST, YDMODEL%YRML_GCONF%YGFL, YDMODEL%YRML_PHY_MF, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_OPTS%KLON,&
