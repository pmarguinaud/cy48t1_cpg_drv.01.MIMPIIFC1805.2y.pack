...
IF (.NOT.YDMODEL%YRML_PHY_MF%YRARPHY%LMSE) THEN
  ...
  & YDSURF%YSP_SBD%NLEVS, PDTPHY, YDMF_PHYS%OUT%FPLCL, YDMF_PHYS%OUT%FPLSL, YDMF_PHYS%OUT%FPLCN,                          &
  ...
  & YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA, YDSURF%YSP_SBD%NLEVS, PDTPHY, ZTDS_TDTS, ZTDS_TDTP, ZTDS_TDWS,                      &
