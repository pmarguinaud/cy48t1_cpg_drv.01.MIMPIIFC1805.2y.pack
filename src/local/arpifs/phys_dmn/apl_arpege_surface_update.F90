...
!=PARALLEL
  ...
  & PDSA_C1, PDSA_C2, YDMF_PHYS%OUT%FCHSP, YDMF_PHYS%OUT%FCLL, YDMF_PHYS  %OUT%FCLN, YDMF_PHYS%OUT%FCS,                   &
  ...
  & YDCPG_OPTS%KLON, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_OPTS%YRSURF_DIMS%YSP_SBD%NLEVS, PDTPHY, ZTDS_TDTS,          &
  ...
  & YDMF_PHYS_SURF%GSP_RR%PIC_T1, YDMF_PHYS_SURF%GSP_SB%PQ_T1, YDMF_PHYS_SURF%GSP_SB%PTL_T1, YDMF_PHYS_SURF%GSP_RR%PFC_T1, &
