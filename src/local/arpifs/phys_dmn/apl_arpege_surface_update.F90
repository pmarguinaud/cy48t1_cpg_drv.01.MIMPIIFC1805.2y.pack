...
IF (.NOT.YDMODEL%YRML_PHY_MF%YRARPHY%LMSE) THEN
  ...
  CALL CPWTS(YDCPG_OPTS, YDMODEL%YRML_AOC%YRMCC, YDMODEL%YRML_PHY_MF%YRPHY, YDMODEL%YRML_PHY_MF%YRPHY1, YDCPG_OPTS%KLON,   &
  & YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_OPTS%YRSURF_DIMS%YSP_SBD%NLEVS, PDTPHY, ZTDS_TDTS,                           &
