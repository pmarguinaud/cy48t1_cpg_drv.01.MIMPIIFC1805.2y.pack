SUBROUTINE APL_ARPEGE_SURFACE_UPDATE (YDCPG_DIM, YDCPG_OPTS, YDCPG_GPAR, YDMF_PHYS, YDMF_PHYS_SURF, YDSURF, &
...
IF (.NOT.YDMODEL%YRML_PHY_MF%YRARPHY%LMSE) THEN
  ...
  & YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA, YDCPG_OPTS%YRSURF_DIMS%YSP_SBD%NLEVS, PDTPHY, ZTDS_TDTS, ZTDS_TDTP, ZTDS_TDWS,                      &
