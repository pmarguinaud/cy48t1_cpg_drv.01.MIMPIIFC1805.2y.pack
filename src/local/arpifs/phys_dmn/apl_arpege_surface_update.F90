...
IF (.NOT.YDMODEL%YRML_PHY_MF%YRARPHY%LMSE) THEN
  ...
  & YDCPG_DIM%YRSURF%YSP_SBD%NLEVS, PDTPHY, YDMF_PHYS%OUT%FPLCL, YDMF_PHYS%OUT%FPLSL, YDMF_PHYS%OUT%FPLCN,                          &
  ...
  CALL CPWTS(YDSURF, YDMODEL%YRML_AOC%YRMCC, YDMODEL%YRML_PHY_MF%YRPHY, YDMODEL%YRML_PHY_MF%YRPHY1, YDCPG_DIM%KLON,       &
  & YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA, YDCPG_DIM%YRSURF%YSP_SBD%NLEVS, PDTPHY, ZTDS_TDTS, ZTDS_TDTP, ZTDS_TDWS,                      &
