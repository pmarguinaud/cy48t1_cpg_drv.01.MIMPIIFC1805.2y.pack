SUBROUTINE APL_WIND_GUST (YDMF_PHYS_BASE_STATE, YDCPG_BNDS, YDCPG_OPTS, YDMF_PHYS, YDVARS, YDXFU, YDMODEL, KMOC_CLPH, PBLH, PDCAPE)
...
IF (YDMODEL%YRML_PHY_MF%YRPHY2%LRAFTKE) THEN
  ...
  PDCAPE(:)=0._JPRB
  CALL ACCLDIA(YDXFU, YDMODEL%YRML_PHY_MF%YRPHY, YDMODEL%YRML_PHY_MF%YRPHY2, YDMODEL%YRML_PHY_MF%YRTOPH, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG,       &
