...
IF (NDPSFI == 1) THEN
  CALL CPMVVPS(YDVAB,YDCPG_DIM%KLON,YDCPG_DIM%KIDIA,YDCPG_DIM%KFDIA,YDCPG_DIM%KFLEVG,PDTPHY,&
   & YDAPLPAR_TMP%PFL%FP,YLMF_PHYS_BASE_STATE%YCPG_PHY%PREHYD(:,YDCPG_DIM%KFLEVG),YDMF_PHYS%OUT%FEVL,YDMF_PHYS%OUT%FEVN,&
...
IF (L3DTURB) THEN
  DO JLEV=1,YDCPG_DIM%KFLEVG
    YDCPG_SL2%KAPPAM (YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA, JLEV) = YDAPLPAR_TMP%KUR%KUROV_H(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,JLEV)
    YDCPG_SL2%KAPPAH (YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA, JLEV) = YDAPLPAR_TMP%KUR%KTROV_H(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,JLEV)
  ENDDO
ENDIF
