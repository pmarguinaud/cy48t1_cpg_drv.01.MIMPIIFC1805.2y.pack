...
& YDMF_PHYS_TMP, YDAPLPAR_TMP, YDCPG_DYN0, YDCPG_DYN9, YDMF_PHYS_SURF, YDCPG_SL1, YDCPG_SL2, YDVARS, YDGMV, YDSURF, YDCFU, &
& YDXFU, YDMODEL, LDCONFX, PDTPHY, PGFL, PKOZO, PGP2DSDT, PGMVT1, PGFLT1, PGPAR,           &
...
IF (LTWOTL) THEN
  ...
  IF (LAJUCV) THEN
    ...
    DO JLEV=1,YDCPG_DIM%KFLEVG
      DO JROF=YDCPG_DIM%KIDIA,YDCPG_DIM%KFDIA
        YDCPG_SL1%ZVIEW(JROF,ISLB1T9+JLEV-NFLSA)=YDCPG_SL1%ZVIEW(JROF,ISLB1T9+JLEV-NFLSA)+YDAPLPAR_TMP%ADJ%DTAJU(JROF,JLEV)
      ENDDO
    ENDDO
  ENDIF
ELSE
  ...
  IF (LSLAG) THEN
    ...
    IF (LTWOTL) THEN
      CALL CPOZO (YDCPG_DIM%KLON,YDCPG_DIM%KIDIA,YDCPG_DIM%KFDIA,YDCPG_DIM%KFLEVG,PDTPHY,YDMF_PHYS%OUT%FCHOZ,&
       & YDCPG_SL1%ZVIEW(:,ISLB1GFL9+IPO3+1-NFLSA:),YDCPG_PHY0%XYB%RDELP)  
    ELSE
      CALL CPOZO (YDCPG_DIM%KLON,YDCPG_DIM%KIDIA,YDCPG_DIM%KFDIA,YDCPG_DIM%KFLEVG,PDTPHY,YDMF_PHYS%OUT%FCHOZ,&
       & YDCPG_SL1%ZVIEW(:,ISLB1GFL9+IPO3+1-NFLSA:),YDCPG_PHY9%XYB%RDELP)  
    ENDIF
  ELSE
    CALL CPOZO (YDCPG_DIM%KLON,YDCPG_DIM%KIDIA,YDCPG_DIM%KFDIA,YDCPG_DIM%KFLEVG,PDTPHY,YDMF_PHYS%OUT%FCHOZ,&
...
IF (NDPSFI == 1) THEN
  IF (LSLAG .AND. LTWOTL) THEN
    CALL CPMVVPS(YDVAB,YDCPG_DIM%KLON,YDCPG_DIM%KIDIA,YDCPG_DIM%KFDIA,YDCPG_DIM%KFLEVG,PDTPHY,&
     ...
     & YDCPG_DYN0%CTY%EVEL,YDCPG_DYN0%CTY%PSDVBC,YDCPG_SL1%ZVIEW(:,MSLB1SP9))
...
IF (LSLAG) CALL CP_PTRSLB1(YDMODEL%YRML_DYN%YRDYN,YDPTRSLB1,ISLB1U9,ISLB1V9,ISLB1T9,ISLB1VD9,ISLB1GFL9)
CALL CPUTQY_APLPAR(YDVARS, YDGEOMETRY%YRDIMV, YDGMV, YGFL, YDPTRSLB1, YDPHY, YDCPG_DIM%KLON, YDCPG_DIM%KIDIA, &
...
& YDMF_PHYS%OUT%TENDV, ZTENDU, ZTENDV, ZTENDD, ZTENDGFL, &
& ZPTENDEFB11, ZPTENDEFB21, ZPTENDEFB31, ZPTENDG1, ZPTENDICONV1, ZPTENDI1, ZPTENDLCONV1, &
& ZPTENDL1, ZPTENDQ1, ZPTENDRCONV1, ZPTENDR1, ZPTENDSCONV1, ZPTENDS1, ZPTENDTKE1, &
& YLMF_PHYS_STATE%YCPG_DYN%RCP%CP,          &
& YLMF_PHYS_STATE%YCPG_PHY%XYB%DELP, YLMF_PHYS_STATE%T, YLMF_PHYS_STATE%U, YLMF_PHYS_STATE%V, YDCPG_SL1%ZVIEW, &
...
IF ((.NOT.LSFORCS)) THEN
  ...
  IF(LNUDG)THEN
    ...
    CALL CPNUDG ( YDCPG_DIM%KLON, YDCPG_DIM%KIDIA,YDCPG_DIM%KFDIA, NFNUDG, YDCPG_DIM%KFLEVG, YDCPG_DIM%KBL,&
     ...
     & YDCPG_SL1%ZVIEW(:,ISLB1T9+1-NFLSA:),YDCPG_SL1%ZVIEW(:,ISLB1GFL9+IPQ+1-NFLSA:),&
     & YDCPG_SL1%ZVIEW(:,ISLB1U9+1-NFLSA:),YDCPG_SL1%ZVIEW(:,ISLB1V9+1-NFLSA:),&
     & YDCPG_SL1%ZVIEW(:,MSLB1SP9),&
...
IF (L3DTURB) THEN
  DO JLEV=1,YDCPG_DIM%KFLEVG
    YDCPG_SL2%ZVIEW(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,MSLB2KAPPAM+JLEV-1)=YDAPLPAR_TMP%KUR%KUROV_H(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,JLEV)
    YDCPG_SL2%ZVIEW(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,MSLB2KAPPAH+JLEV-1)=YDAPLPAR_TMP%KUR%KTROV_H(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,JLEV)
  ENDDO
ENDIF
