...
& YDCPG_GPAR, YDCPG_PHY0, YDCPG_PHY9, YDMF_PHYS, YDCPG_DYN0, YDCPG_DYN9, YDMF_PHYS_SURF, YDCPG_SL1, &
& YDCPG_SL2, YDVARS, YDGMV, YDSURF, YDCFU, YDXFU, YDMODEL, LDCONFX, PDTPHY, PGFL, PGMVT1, PGFLT1, &
& PTRAJ_PHYS, YDDDH)
