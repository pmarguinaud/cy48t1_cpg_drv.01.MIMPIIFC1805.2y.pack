...
IF (LL_SAVE_PHSURF) THEN
  CALL MF_PHYS_SAVE_PHSURF_PART1 (YDCPG_DIM, YDMF_PHYS_TMP%SAV%DDAL, YDMF_PHYS_TMP%SAV%DDOM, YDMF_PHYS_TMP%SAV%ENTCH, YDMF_PHYS_TMP%SAV%FHPS, YDMF_PHYS_TMP%SAV%GZ0F, YDMF_PHYS_TMP%SAV%GZ0HF, YDMF_PHYS_TMP%SAV%HV, YDMF_PHYS_TMP%SAV%PBLH, YDMF_PHYS_TMP%SAV%QSH, YDMF_PHYS_TMP%SAV%UDAL, YDMF_PHYS_TMP%SAV%UDGRO, YDMF_PHYS_TMP%SAV%UDOM, YDMF_PHYS_TMP%SAV%UNEBH, YDMF_PHYS_SURF, YDVARS, YDSURF, YDMODEL)
ENDIF
...
!   if relevant.
IF (LL_SAVE_PHSURF) THEN
  CALL MF_PHYS_SAVE_PHSURF_PART2 (YDCPG_DIM, YDMF_PHYS_TMP%SAV%DDAL, YDMF_PHYS_TMP%SAV%DDOM, YDMF_PHYS_TMP%SAV%ENTCH, YDMF_PHYS_TMP%SAV%FHPS, YDMF_PHYS_TMP%SAV%GZ0F, YDMF_PHYS_TMP%SAV%GZ0HF, YDMF_PHYS_TMP%SAV%HV, YDMF_PHYS_TMP%SAV%PBLH, YDMF_PHYS_TMP%SAV%QSH, YDMF_PHYS_TMP%SAV%UDAL, YDMF_PHYS_TMP%SAV%UDGRO, YDMF_PHYS_TMP%SAV%UDOM, YDMF_PHYS_TMP%SAV%UNEBH, YDMF_PHYS_SURF, YDVARS, YDSURF, YDMODEL)
ENDIF
