...
CALL MF_PHYS_INIT (YDCPG_DIM, YDMF_PHYS, YDCPG_MISC, YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA, YDCPG_DIM%KLON, YDCPG_DIM%KFLEVG,                  &
& YDCPG_DIM%KTSSG, YSP_SBD%NLEVS, YDMF_PHYS%OUT%DIFCQ, YDMF_PHYS%OUT%DIFCQN, YDMF_PHYS%OUT%DIFCQL, YDMF_PHYS%OUT%DIFCS,           &
