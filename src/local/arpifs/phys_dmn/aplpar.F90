    ...
    ELSEIF((CGMIXLEN(1:2) == 'EL').AND.LPTKE) THEN
      ...
      IF( LCOEFK_RIS) THEN
        ...
        CALL ACMIXELEN(YGFL,YDPHY,YDPHY0,&
         & YDCPG_DIM%KIDIA,YDCPG_DIM%KFDIA,YDCPG_DIM%KLON,KTDIA,YDCPG_DIM%KFLEVG,YDCPG_DIM%KSTEP,IMLTYPE,&
    ...
    ELSE
      ...
      IF ( LPTKE ) THEN
        ...
        CALL ACPTKE(YGFL,YDLDDH,YDMODEL%YRML_PHY_MF,&
          & YDCPG_DIM%KIDIA,YDCPG_DIM%KFDIA,YDCPG_DIM%KLON,KTDIA,YDCPG_DIM%KFLEVG,YDCPG_DIM%KSTEP,&
...
! calculation of variables for the old "ISBA" atmosphere scheme
      ...
      IF (LCOEFKTKE) THEN
        ...
        ELSEIF (NDIFFNEB == 4) THEN
          ZCOEFA(:,:) = ZBNEBCVPP(:,:)
        ENDIF
        CALL ACDIFV3 ( YDMODEL%YRML_PHY_MF,YDCPG_DIM%KIDIA,YDCPG_DIM%KFDIA,YDCPG_DIM%KLON,KTDIA,YDCPG_DIM%KFLEVG,YDCPG_DIM%KSTEP,&
