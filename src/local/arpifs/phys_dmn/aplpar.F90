...
!-------------------------------------------------
!
IF(LGCHECKMV) CALL CHECKMV(YDRIP,YDPHY0,YDPHY2,YDCPG_DIM%KIDIA,YDCPG_DIM%KFDIA,YDCPG_DIM%KLON,YDCPG_DIM%KFLEVG,KSTEP,YDMF_PHYS_STATE%YCPG_DYN%PHI,YDMF_PHYS_STATE%YCPG_DYN%PHIF &
...
!       Computation of ZRTI
  ...
  IF ( (LVDIF.OR.LGWD).AND.(.NOT.(LNEBR.OR.LECT)) ) THEN
    ...
    ELSEIF((CGMIXLEN(1:2) == 'EL').AND.LPTKE) THEN
      ...
      IF( LCOEFK_RIS) THEN
        ...
        CALL ACMIXELEN(YGFL,YDPHY,YDPHY0,&
         & YDCPG_DIM%KIDIA,YDCPG_DIM%KFDIA,YDCPG_DIM%KLON,KTDIA,YDCPG_DIM%KFLEVG,KSTEP,IMLTYPE,&
    ...
    IF(LCOEFKTKE) THEN
      ...
      CALL ACMRIP(YDMODEL%YRML_PHY_MF,YDCPG_DIM%KIDIA,YDCPG_DIM%KFDIA,YDCPG_DIM%KLON,NTCOEF,YDCPG_DIM%KFLEVG,KSTEP,&
...
!     ------------------------------------------------------------------
  ...
  IF (LEDKF) THEN
    ...
    CALL ARP_SHALLOW_MF( YDCPG_DIM%KIDIA,YDCPG_DIM%KFDIA,YDCPG_DIM%KLON,KTDIA,YDCPG_DIM%KFLEVG,ZIMPL,TSPHY,YDMF_PHYS_STATE%YCPG_DYN%PHI,YDMF_PHYS_STATE%YCPG_DYN%PHIF,YDMF_PHYS_STATE%YCPG_DYN%RCP%R,YDMF_PHYS_STATE%YCPG_DYN%RCP%CP, &
...
!           radiation scheme
  ...
  IF ( LRAYSP .AND.(KSTEP == 1).AND.LRCOEF ) THEN
    ...
    CALL ACRADCOEF ( YDRCOEF,YDPHY3,YDCPG_DIM%KIDIA,YDCPG_DIM%KFDIA,YDCPG_DIM%KLON,KTDIA,YDCPG_DIM%KFLEVG,&
...
!DEC$ IVDEP
      ...
      CASE(2)
        CALL ACRANEB2(YDERDI,YDRIP,YDMODEL%YRML_PHY_MF,&
         & YDCPG_DIM%KIDIA,YDCPG_DIM%KFDIA,YDCPG_DIM%KLON,NTRADI,YDCPG_DIM%KFLEVG,IJN,KSTEP,KNFRRC,&
    ...
    ELSE
      ...
      IF ( LPTKE ) THEN
        ...
        CALL ACPTKE(YGFL,YDLDDH,YDMODEL%YRML_PHY_MF,&
          & YDCPG_DIM%KIDIA,YDCPG_DIM%KFDIA,YDCPG_DIM%KLON,KTDIA,YDCPG_DIM%KFLEVG,KSTEP,&
      ...
      IF ( LMSE.AND.LCALLSFX ) THEN
        ...
        CALL ARO_GROUND_PARAM( YDCPG_DIM%KBL, YDCPG_DIM%KGPCOMP,&
          & YDCPG_DIM%KFDIA-YDCPG_DIM%KIDIA+1, YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA, KSTEP,&
...
! calculation of variables for the old "ISBA" atmosphere scheme
      ...
      IF (L3DTURB) THEN
        CALL ACTKECOEFKH(YDRIP,YDMODEL%YRML_PHY_MF,YDGEOMETRY%YREGEO,YDCPG_DIM%KIDIA,YDCPG_DIM%KFDIA,YDCPG_DIM%KLON,KTDIA,YDCPG_DIM%KFLEVG,&
      ...
      IF (LCOEFKTKE) THEN
        ...
        ELSEIF (NDIFFNEB == 4) THEN
          ZCOEFA(:,:) = ZBNEBCVPP(:,:)
        ENDIF
        CALL ACDIFV3 ( YDMODEL%YRML_PHY_MF,YDCPG_DIM%KIDIA,YDCPG_DIM%KFDIA,YDCPG_DIM%KLON,KTDIA,YDCPG_DIM%KFLEVG,KSTEP,&
...
!cdir unroll=8
  ...
  !  -------------------------
    ...
    IF (.NOT.LCVCSD) THEN
      CALL ACCVUD ( YDMODEL%YRML_PHY_EC%YRECUCONVCA,YDMODEL%YRML_PHY_MF,YDCPG_DIM%KIDIA,YDCPG_DIM%KFDIA,YDCPG_DIM%KLON,KTDIA,YDCPG_DIM%KFLEVG,&
...
! PASS T9 CONDENSATES TO ACCSU
      CALL ACCSU ( YDMODEL%YRML_PHY_EC%YRECUCONVCA,YDMODEL%YRML_PHY_EC%YRECUMF,YDMODEL%YRML_PHY_MF, &
        & YDCPG_DIM%KIDIA,YDCPG_DIM%KFDIA,YDCPG_DIM%KLON,KTDIA,YDCPG_DIM%KFLEVG,&
        & YDMF_PHYS_STATE%YCPG_PHY%XYB%ALPH, YDMF_PHYS_STATE%YCPG_DYN%PHI, YDMF_PHYS_STATE%YCPG_DYN%PHIF, YDMF_PHYS_STATE%YCPG_PHY%PREHYD, YDMF_PHYS_STATE%YCPG_PHY%PREHYDF, YDMF_PHYS_STATE%YCPG_DYN%RCP%CP,YDMF_PHYS_STATE%YCPG_DYN%RCP%R,&
        & YDMF_PHYS%TMP%APLPAR%MSC%CVGQ, YDMF_PHYS_STATE%YCPG_PHY%XYB%DELP, YDMF_PHYS_STATE%YCPG_PHY%XYB%LNPR,&
    ...
    CALL ACUPU(YDPHY,YDPHY0,YDCPG_DIM%KIDIA,YDCPG_DIM%KFDIA,YDCPG_DIM%KLON,KTDIA,YDCPG_DIM%KFLEVG,&
...
!rb store "-B" state: no protection of Ncv
  ...
  !  ---------------------------------------------------------
    ...
    CALL APLMPHYS( YDMODEL%YRML_PHY_MF,YDCPG_DIM%KIDIA,YDCPG_DIM%KFDIA,YDCPG_DIM%KLON,KTDIA,YDCPG_DIM%KFLEVG,&
   ...
   CALL ACUPM( YDMODEL%YRML_PHY_MF,YDCPG_DIM%KIDIA,YDCPG_DIM%KFDIA,YDCPG_DIM%KLON,KTDIA,YDCPG_DIM%KFLEVG,&
...
! input/output  2d .
  ...
  !  -------------------------
    ...
    IF (LNSDO) THEN
      CALL ACNSDO(YDMODEL%YRML_PHY_MF,YDCPG_DIM%KIDIA,YDCPG_DIM%KFDIA,YDCPG_DIM%KLON,KTDIA,YDCPG_DIM%KFLEVG,&
    ...
    ELSE
      CALL ACMODO(YDMODEL%YRML_PHY_MF,YDCPG_DIM%KIDIA,YDCPG_DIM%KFDIA,YDCPG_DIM%KLON,KTDIA,YDCPG_DIM%KFLEVG,&
       & YDMF_PHYS_STATE%YCPG_PHY%XYB%ALPH,YDMF_PHYS_STATE%YCPG_DYN%PHIF,YDMF_PHYS_STATE%YCPG_PHY%PREHYD,YDMF_PHYS_STATE%YCPG_PHY%PREHYDF,YDMF_PHYS_STATE%YCPG_DYN%RCP%CP,&
  ...
  !  ---------------------------------------------
    ...
    CALL ACUPD(YDMODEL%YRML_PHY_MF,YDCPG_DIM%KIDIA,YDCPG_DIM%KFDIA,YDCPG_DIM%KLON,KTDIA,YDCPG_DIM%KFLEVG,&
! input  2d .
...
! -----------------------------------------------------
  ...
  IF ( LPROCLD ) THEN
    IF(LGPCMT) THEN
      ...
      ZNEBS(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,KTDIA:YDCPG_DIM%KFLEVG)=1._JPRB-(1._JPRB-ZNEBS(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,KTDIA:YDCPG_DIM%KFLEVG))&
        & *(1._JPRB-ZCSGC(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,KTDIA:YDCPG_DIM%KFLEVG))
      ...
      ZQMIC(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,KTDIA:YDCPG_DIM%KFLEVG)=ZCSGC(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,KTDIA:YDCPG_DIM%KFLEVG)&
        & *YDMF_PHYS%TMP%APLPAR%FLU%QSAT(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,KTDIA:YDCPG_DIM%KFLEVG)&
        & +(1._JPRB-ZCSGC(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,KTDIA:YDCPG_DIM%KFLEVG))*ZQV(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,KTDIA:YDCPG_DIM%KFLEVG)
      ZQLIS(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,KTDIA:YDCPG_DIM%KFLEVG)=MAX(ZQLIS(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,KTDIA:YDCPG_DIM%KFLEVG),&
        & ZCSGC(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,KTDIA:YDCPG_DIM%KFLEVG)&
        & *(ZQL(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,KTDIA:YDCPG_DIM%KFLEVG)+ZQI(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,KTDIA:YDCPG_DIM%KFLEVG))&
        & +(1._JPRB-ZCSGC(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,KTDIA:YDCPG_DIM%KFLEVG))*ZQLIS(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,KTDIA:YDCPG_DIM%KFLEVG))
...
!           DIFFUSION TURBULENTE/DEPOT SEC DE L'OZONE
    ...
    CALL ACDIFOZ ( YDRIP,YDPHY2,YDMODEL%YRML_PHY_MF%YRVDOZ,YDCPG_DIM%KIDIA,YDCPG_DIM%KFDIA,YDCPG_DIM%KLON,KTDIA,YDCPG_DIM%KFLEVG,&
