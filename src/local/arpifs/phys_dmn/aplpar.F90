...
CALL MF_PHYS_FPL_PART1 (YDCPG_DIM, YDAPLPAR_TMP%PFL%FPLCH, YDAPLPAR_TMP%PFL%FPLSH, YDVARS, YDMODEL)
...
!             --------------------------
CALL MF_PHYS_MOCON (YDCPG_DIM, YDMF_PHYS, YDMF_PHYS_TMP%RDG%LCVQ, YDAPLPAR_TMP%MOC%CLPH, YLMF_PHYS_BASE_STATE)
...
CALL MF_PHYS_FPL_PART2 (YDCPG_DIM, YDAPLPAR_TMP%PFL%FPLCH, YDAPLPAR_TMP%PFL%FPLSH, YDVARS, YDMODEL)
...
CALL MF_PHYS_BAYRAD (YDCPG_DIM, YDAPLPAR_TMP%BAY%QRCONV, YDAPLPAR_TMP%BAY%QSCONV, YDVARS, YDMODEL, LAROME)
...
IF(LGSCM.OR.LMUSCLFA) THEN
  ...
  & OROG, YDGSGEOM%RCORI, YDCSGEOM%RATATH, YDCSGEOM%RATATX, YDGSGEOM%GECLO, YDGSGEOM%GESLO, &
  & YDMF_PHYS_TMP%RDG%CVGQ, YDMF_PHYS_TMP%RDG%LCVQ, YDMF_PHYS_TMP%RDG%MU0, YDAPLPAR_TMP%DSA%C1, YDAPLPAR_TMP%DSA%C2, YDAPLPAR_TMP%DSA%CPS, &
  & YDAPLPAR_TMP%DSA%LHS, YDAPLPAR_TMP%DSA%RS, YDAPLPAR_TMP%FLU%CD, YDAPLPAR_TMP%FLU%CDN, YDAPLPAR_TMP%FLU%CH, YDAPLPAR_TMP%FLU%EMIS, &
  & YDAPLPAR_TMP%FLU%FEVI, YDAPLPAR_TMP%FLU%NEIJ, YDAPLPAR_TMP%FLU%QSAT, YDAPLPAR_TMP%FLU%QSATS, YDAPLPAR_TMP%FLU%VEG, YDAPLPAR_TMP%MOC%CLPH, &
  & YDAPLPAR_TMP%MSC%FRMQ, YDAPLPAR_TMP%MSC%LH, YDAPLPAR_TMP%MSC%LSCPE, YDAPLPAR_TMP%MSC%QW, YDAPLPAR_TMP%MSC%TW, YDAPLPAR_TMP%PFL%FEFB1, &
  & YDAPLPAR_TMP%PFL%FEFB2, YDAPLPAR_TMP%PFL%FEFB3, YDAPLPAR_TMP%PFL%FPLCH, YDAPLPAR_TMP%PFL%FPLSH, YDAPLPAR_TMP%PFL%FTKE  )
ENDIF
