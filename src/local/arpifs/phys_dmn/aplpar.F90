...
REAL(KIND=JPRB)   ,INTENT(INOUT) :: PWP2(KLON)
REAL(KIND=JPRB)   ,INTENT(INOUT) :: PWS2(KLON)
REAL(KIND=JPRB)   ,INTENT(INOUT) :: PWPI2(KLON)
...
! calculation of variables for the old "ISBA" atmosphere scheme
        IF (.NOT. LELAM) THEN
          CALL ARO_GROUND_DIAG_2ISBA( KBL, KGPCOMP, &
            ...
            & PTP2(KIDIA:KFDIA,1), PWS2(KIDIA:KFDIA), PWP2(KIDIA:KFDIA), &
            & PWSI2(KIDIA:KFDIA), PWPI2(KIDIA:KFDIA), PWR2(KIDIA:KFDIA), &
