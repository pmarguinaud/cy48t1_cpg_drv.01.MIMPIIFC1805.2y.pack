...
IF (LSLAG) CALL CP_PTRSLB1(YDMODEL%YRML_DYN%YRDYN,YDPTRSLB1,ISLB1U9,ISLB1V9,ISLB1T9,ISLB1VD9,ISLB1GFL9)
CALL CPUTQY_APLPAR_LOOP(YDGEOMETRY%YRDIMV, YDGMV, YGFL, YDPTRSLB1, YDPHY, YDCPG_DIM%KLON, YDCPG_DIM%KIDIA, &
& YDCPG_DIM%KFDIA, YDCPG_DIM%KFLEVG, PDTPHY, IPGFL, ISLB1GFL9, ZTENDGFL, YDCPG_SL1%ZVIEW, PGMVT1, PGFLT1)
