SUBROUTINE APLPAR_FLEXDIA (YDCPG_DIM, YDCPG_OPTS, YDCPG_MISC, YDMF_PHYS, YDMF_PHYS_SURF, &
...
IF (YDMODEL%YRML_DIAG%YRLDDH%LDDH_OMP) THEN
  ...
  ZTMPAF(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)=YDMF_PHYS_BASE_STATE%YCPG_PHY%XYB%DELP(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)*YDCPG_MISC%QICE(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)
  CALL NEW_ADD_FIELD_3D(YDMODEL%YRML_DIAG%YRMDDH, ZTMPAF, 'VIR', YDDDH)
  ZTMPAF(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)=YDMF_PHYS_BASE_STATE%YCPG_PHY%XYB%DELP(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)*YDCPG_MISC%QLI(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)
  CALL NEW_ADD_FIELD_3D(YDMODEL%YRML_DIAG%YRMDDH, ZTMPAF, 'VLR', YDDDH)
  ZTMPAF(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)=YDMF_PHYS_BASE_STATE%YCPG_PHY%XYB%DELP(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)*YDCPG_MISC%NEB(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,1:YDCPG_OPTS%KFLEVG)
  ...
  ZTMPAS(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA)=YDMF_PHYS_SURF%GSD_VF%PLSM(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA)*YDMODEL%YRML_PHY_MF%YRPHY1%RTINER*YDMF_PHYS_BASE_STATE%YGSP_SB%T(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,YDCPG_OPTS%YRSURF_DIMS%YSP_SBD%NLEVS)/YDMF_PHYS%OUT%CT(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA)
  ...
  & )
  ZTMPAS(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA)=YDMF_PHYS_BASE_STATE%YCPG_DYN%PHI(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG)
  ...
  ZTMPAS(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA)=YDMF_PHYS_SURF%GSD_VF%PLSM(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA)*YDMF_PHYS%OUT%FRSO(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG,1)
  CALL NEW_ADD_FIELD_2D(YDMODEL%YRML_DIAG%YRMDDH, ZTMPAS, 'FSRAYSODW', YDDDH)
  ZTMPAS(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA)=YDMF_PHYS_SURF%GSD_VF%PLSM(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA)*YDMF_PHYS%OUT%FRTH(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG,1)
  ...
  ZTMPAS(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA)=YDMF_PHYS_SURF%GSD_VF%PLSM(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA)*YDMF_PHYS%OUT%FCHSP(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,YDCPG_OPTS%YRSURF_DIMS%YSP_SBD%NLEVS)
  ...
  ZTMPAS(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA)=YDMF_PHYS_SURF%GSD_VF%PLSM(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA)*YDMF_PHYS%OUT%FPLSL(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG)
  CALL NEW_ADD_FIELD_2D(YDMODEL%YRML_DIAG%YRMDDH, ZTMPAS, 'FSPRELIGE', YDDDH)
  ZTMPAS(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA)=YDMF_PHYS_SURF%GSD_VF%PLSM(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA)*YDMF_PHYS%OUT%FPLSN(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG)
  CALL NEW_ADD_FIELD_2D(YDMODEL%YRML_DIAG%YRMDDH, ZTMPAS, 'FSPRENEGE', YDDDH)
  ZTMPAS(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA)=YDMF_PHYS_SURF%GSD_VF%PLSM(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA)*YDMF_PHYS%OUT%FPLCL(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG)
  CALL NEW_ADD_FIELD_2D(YDMODEL%YRML_DIAG%YRMDDH, ZTMPAS, 'FSPRELICO', YDDDH)
  ZTMPAS(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA)=YDMF_PHYS_SURF%GSD_VF%PLSM(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA)*YDMF_PHYS%OUT%FPLCN(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,YDCPG_OPTS%KFLEVG)
