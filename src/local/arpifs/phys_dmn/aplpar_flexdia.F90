SUBROUTINE APLPAR_FLEXDIA (YDCPG_DIM, YDCPG_MISC, YDMF_PHYS, YDMF_PHYS_SURF, &
                         & YDSURF, YDMODEL, YDDDH, YDMF_PHYS_BASE_STATE)
...
TYPE (MF_PHYS_BASE_STATE_TYPE) :: YDMF_PHYS_BASE_STATE
...
IF (YDMODEL%YRML_DIAG%YRLDDH%LDDH_OMP) THEN
  ...
  ZTMPAS(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA)=YDMF_PHYS_SURF%GSD_VF%PLSM(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA)*YDMODEL%YRML_PHY_MF%YRPHY1%RTINER*YDMF_PHYS_BASE_STATE%YGSP_SB%T(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,YDSURF%YSP_SBD%NLEVS)/YDMF_PHYS%OUT%CT(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA)
  ...
  ZTMPAS(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA)=YDMF_PHYS_SURF%GSD_VF%PLSM(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA)*YDMF_PHYS%OUT%FCHSP(YDCPG_DIM%KIDIA:YDCPG_DIM%KFDIA,YDSURF%YSP_SBD%NLEVS)
