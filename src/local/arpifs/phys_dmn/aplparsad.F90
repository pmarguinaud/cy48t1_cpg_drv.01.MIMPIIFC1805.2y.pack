...
& WCRIN=>YDPHY1%WCRIN,   RMESOT=>YDTOPH%RMESOT, RMESOU=>YDTOPH%RMESOU,   LCVRASBM=>YDSIMPHL%LCVRASBM,                     &
& LPROCLDTL=>YDSIMPHL%LPROCLDTL,   LSTRASP=>YDSIMPHL%LSTRASP, LSTRASPN=>YDSIMPHL%LSTRASPN,   LRRMESSP=>YDSIMPHL%LRRMESSP, &
& LGWDSP=>YDSIMPHL%LGWDSP,   LVDIFSP=>YDSIMPHL%LVDIFSP, LCVRASP=>YDSIMPHL%LCVRASP,   LRAYSP=>YDSIMPHL%LRAYSP,             &
