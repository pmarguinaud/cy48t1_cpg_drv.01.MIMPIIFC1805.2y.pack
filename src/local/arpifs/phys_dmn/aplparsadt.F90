...
& WCRIN=>YDPHY1%WCRIN,   LSTRASP=>YDSIMPHL%LSTRASP, LSMOOTHA=>YDSIMPHL%LSMOOTHA,   LRRMESSP=>YDSIMPHL%LRRMESSP,   &
& LGWDSP=>YDSIMPHL%LGWDSP,   LSMOOTHD=>YDSIMPHL%LSMOOTHD, LVDIFSP=>YDSIMPHL%LVDIFSP,   LCVRASP=>YDSIMPHL%LCVRASP, &
& LRAYSP=>YDSIMPHL%LRAYSP,   LCONDWT=>YDPHY%LCONDWT, LNEIGE=>YDPHY%LNEIGE)
!     ------------------------------------------------------------------
...
IF ( LRRMESSP ) THEN
  CALL ACDRME(YDCST,YDSTA,YDML_PHY_MF%YRPHY2,YDTOPH,KIDIA,KFDIA,KLON,KTDIA,KLEV,&
