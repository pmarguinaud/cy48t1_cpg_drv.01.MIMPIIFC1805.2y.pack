...
CALL APLPARS(YDCPG_BNDS, YDCPG_OPTS, YDMF_PHYS_BASE_STATE, YDCPG_MISC, YDMF_PHYS_SURF, YDMF_PHYS,                                      &
& YDGEOMETRY, YDRCOEF, YDMODEL%YRCST, YDMODEL%YRML_PHY_MF, 1, NTSSG, ZRDG_CVGQ, ZQS1, ZRDG_MU0, YDVARS%GEOMETRY%GM%T0, ZAC_HC,         &
