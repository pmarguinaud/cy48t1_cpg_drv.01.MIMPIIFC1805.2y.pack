...
CALL CPUTQYS(YLMF_PHYS_BASE_STATE, YLMF_PHYS_NEXT_STATE, YDSTOPH, YDPHY2, YDCPG_DIM%KLON, YDCPG_DIM%KIDIA,                   &
& YDCPG_DIM%KFDIA, YDCPG_DIM%KFLEVG, PDTPHY, ZTENDH, ZTENDQ, YDMF_PHYS%OUT%TENDU,     &
