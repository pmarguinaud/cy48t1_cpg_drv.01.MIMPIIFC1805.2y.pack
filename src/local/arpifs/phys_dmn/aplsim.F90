...
& YLMF_PHYS_BASE_STATE%Q, YLMF_PHYS_BASE_STATE%YCPG_DYN%RCP%CP, YDMF_PHYS_TMP%RDG%CVGQ, YLMF_PHYS_BASE_STATE%YGSP_SG%F, &
...
& YDMF_PHYS_SURF%GSD_VF%PALBF, YDMF_PHYS_TMP%RDG%MU0, YDGSGEOM%GM, ZAC_HC, ZCOR, ZRAB3C, ZRAB3N,                        &
