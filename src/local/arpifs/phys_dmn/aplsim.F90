...
& NTSSG, YDCPG_DIM%YRSURF%YSP_SBD%NLEVS, YDMF_PHYS%OUT%DIFCQ, YDMF_PHYS%OUT%DIFCQN, YDMF_PHYS%OUT%DIFCQL, YDMF_PHYS%OUT%DIFCS,       &
...
CALL CPUTQYS(YDCPG_DIM, YDMF_PHYS_BASE_STATE, YDMF_PHYS_NEXT_STATE, YDSTOPH, YDPHY2, PDTPHY, ZTENDH,   &
& ZTENDQ, YDMF_PHYS%OUT%TENDU, YDMF_PHYS%OUT%TENDV, YDMF_PHYS%FOR%U, YDMF_PHYS%FOR%V, YDMF_PHYS%FOR%T, &
& YDMF_PHYS%FOR%Q, YDMF_PHYS%OUT%FDIS)
