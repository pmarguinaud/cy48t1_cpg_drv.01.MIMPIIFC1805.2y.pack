...
& YGFL=>YDMODEL%YRML_GCONF%YGFL, YDSTOPH=>YDMODEL%YRML_PHY_STOCH%YRSTOPH)
...
IF (LRAYSP.AND.(YDCPG_DIM%KSTEP >= INSTEP_DEB .AND. YDCPG_DIM%KSTEP <= INSTEP_FIN)) THEN  
  CALL CPPSOLAN(YDGEOMETRY%YRDIM, YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA, YDVARS%GEOMETRY%GEMU%T0, YDVARS%GEOMETRY%GELAM%T0, ZRDG_MMU0&
  &     )
  IF (.NOT.LSDDH) THEN
...
& YDVARS%V%T0, YDVARS%Q%T0, YDVARS%Q%DL, YDVARS%Q%DM, YDVARS%CVGQ%DL, YDVARS%CVGQ%DM, YDCPG_PHY0%XYB%RDELP, YDCPG_DYN0%CTY%EVEL, &
& YDVARS%CVGQ%T0, ZRDG_MU0, ZRDG_MU0LU, ZRDG_MU0M,  ZRDG_MU0N, ZRDG_CVGQ)
...
& YDCPG_DIM%KTSSG, YDCPG_DIM%YRSURF%YSP_SBD%NLEVS, YDMF_PHYS%OUT%DIFCQ, YDMF_PHYS%OUT%DIFCQN, YDMF_PHYS%OUT%DIFCQL, YDMF_PHYS%OUT%DIFCS,       &
...
& YDMF_PHYS_BASE_STATE%YCPG_PHY%PREHYD, YDMF_PHYS_BASE_STATE%Q, YDMF_PHYS_SURF%GSP_SG%PF_T1, YDMF_PHYS_SURF%GSP_RR%PT_T1, &
& YDMF_PHYS_SURF%GSP_RR%PW_T1, YDMF_PHYS_SURF%GSD_VF%PLSM, YDMF_PHYS_SURF%GSD_VF%PVEG, ZQS1)  

CALL APLPASSH (YDPHY, YDMODEL%YRML_PHY_MF%YRPHY1, YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA, YDCPG_DIM%KLON, YDCPG_DIM%KFLEVG,           &
& YDMF_PHYS_BASE_STATE%YCPG_PHY%PREHYD, YDMF_PHYS_BASE_STATE%Q, YDMF_PHYS_BASE_STATE%YGSP_SG%F, YDMF_PHYS_BASE_STATE%YGSP_RR%T, &
& YDMF_PHYS_BASE_STATE%YGSP_RR%W, YDMF_PHYS_SURF%GSD_VF%PLSM, YDMF_PHYS_SURF%GSD_VF%PVEG, YDCPG_MISC%QS                         &
&                            )  
...
& 1, YDCPG_DIM%KFLEVG, NTSSG, YDCPG_DIM%KSTEP, YDMF_PHYS_BASE_STATE%YCPG_DYN%PHI, YDMF_PHYS_BASE_STATE%YCPG_PHY%PREHYD, &
& YDMF_PHYS_BASE_STATE%YCPG_DYN%PHIF, YDMF_PHYS_BASE_STATE%YCPG_PHY%PREHYDF, YDMF_PHYS_BASE_STATE%YCPG_PHY%XYB%DELP,    &
& YDMF_PHYS_BASE_STATE%YCPG_PHY%XYB%RDELP, YDMF_PHYS_BASE_STATE%U, YDMF_PHYS_BASE_STATE%V, YDMF_PHYS_BASE_STATE%T,      &
& YDMF_PHYS_BASE_STATE%Q, YDMF_PHYS_BASE_STATE%YCPG_DYN%RCP%CP, ZRDG_CVGQ, YDMF_PHYS_BASE_STATE%YGSP_SG%F, &
& YDMF_PHYS_BASE_STATE%YGSP_RR%T, YDCPG_MISC%QS, YDMF_PHYS_SURF%GSP_RR%PT_T1, ZQS1, YDMF_PHYS_SURF%GSD_VF%PGETRL,       &
& YDMF_PHYS_SURF%GSD_VF%PLSM, YDMF_PHYS_SURF%GSD_VF%PZ0F, YDMF_PHYS_SURF%GSD_VF%PVRLAN, YDMF_PHYS_SURF%GSD_VF%PVRLDI,   &
& YDMF_PHYS_SURF%GSD_VF%PALBF, ZRDG_MU0, YDVARS%GEOMETRY%GM%T0, ZAC_HC, ZCOR, ZRAB3C, ZRAB3N,                        &
& ZRAB4C, ZRAB4N, ZRAB6C, ZRAB6N, ZRAT1C, ZRAT1N, ZRAT2C, ZRAT2N, ZRAT3C, ZRAT3N, ZRAT4C, ZRAT4N,                       &
& ZRAT5C, ZRAT5N, YDMF_PHYS%OUT%DIFCQ, YDMF_PHYS%OUT%DIFCS, YDMF_PHYS%OUT%DIFTQ, YDMF_PHYS%OUT%DIFTS,                   &
...
& YDMF_PHYS_BASE_STATE%YGSP_RR%T, YDVARS%GEOMETRY%OROG%T0, YDMF_PHYS%OUT%TENDU, YDMF_PHYS%OUT%TENDV, ZTENDH,            &
& ZTENDQ, YDMF_PHYS%OUT%FHPCL, YDMF_PHYS%OUT%FHPCN, YDMF_PHYS%OUT%FHPSL, YDMF_PHYS%OUT%FHPSN, YDMF_PHYS%OUT%FHSCL,      &
& YDMF_PHYS%OUT%FHSCN, YDMF_PHYS%OUT%FHSSL, YDMF_PHYS%OUT%FHSSN)  
!=END PARALLEL
...
CALL CPUTQYS (YDCPG_DIM, YDMF_PHYS_BASE_STATE, YDMF_PHYS_NEXT_STATE, &
            & YDMF_PHYS, YDSTOPH, YDPHY2, PDTPHY, ZTENDH, ZTENDQ)
