...
@PROCESS NOCHECK
#endif
SUBROUTINE APLSIM(YDMF_PHYS_BASE_STATE, YDMF_PHYS_NEXT_STATE, YDGEOMETRY, YDCPG_DIM, &
& YDCPG_MISC, YDCPG_PHY0, YDCPG_PHY9, YDMF_PHYS, YDCPG_DYN0, YDCPG_DYN9, YDMF_PHYS_SURF, &
& YDVARS, YDMODEL, PDTPHY, YDCPG_SL1, PTRAJ_PHYS)
