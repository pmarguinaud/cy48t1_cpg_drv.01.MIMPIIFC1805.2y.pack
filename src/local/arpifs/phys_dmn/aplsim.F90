...
& YDMF_PHYS, YDCPG_DYN0, YDCPG_DYN9, YDMF_PHYS_SURF, YDVARS, YDMODEL, PDTPHY, &
& YDCPG_SL1, PTRAJ_PHYS)
...
& YLMF_PHYS_BASE_STATE%YCPG_PHY%XYB%RDELP, YLMF_PHYS_BASE_STATE%U, YLMF_PHYS_BASE_STATE%V, YLMF_PHYS_BASE_STATE%T,      &
& YLMF_PHYS_BASE_STATE%Q, YLMF_PHYS_BASE_STATE%YCPG_DYN%RCP%CP, ZRDG_CVGQ, YLMF_PHYS_BASE_STATE%YGSP_SG%F, &
& YLMF_PHYS_BASE_STATE%YGSP_RR%T, YDCPG_MISC%QS, YDMF_PHYS_SURF%GSP_RR%PT_T1, ZQS1, YDMF_PHYS_SURF%GSD_VF%PGETRL,       &
...
& YLMF_PHYS_BASE_STATE%U, YLMF_PHYS_BASE_STATE%V, YLMF_PHYS_BASE_STATE%T, YLMF_PHYS_BASE_STATE%Q, YDCPG_MISC%QS,        &
& YLMF_PHYS_BASE_STATE%YGSP_RR%T, YDVARS%GEOMETRY%OROG%T0, YDMF_PHYS%OUT%TENDU, YDMF_PHYS%OUT%TENDV, ZTENDH,                        &
...
CALL CPUTQYS(YDCPG_DIM, YLMF_PHYS_BASE_STATE, YLMF_PHYS_NEXT_STATE, YDSTOPH, YDPHY2, PDTPHY, ZTENDH,   &
