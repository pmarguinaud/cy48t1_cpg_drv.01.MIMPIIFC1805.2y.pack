...
@PROCESS NOCHECK
#endif
SUBROUTINE APLSIM(YDMF_PHYS_BASE_STATE, YDMF_PHYS_NEXT_STATE, YDGEOMETRY, YDCPG_DIM, YDCPG_OPTS, YDCPG_MISC, &
...
IF (LRAYSP.AND.(YDCPG_OPTS%KSTEP >= INSTEP_DEB .AND. YDCPG_OPTS%KSTEP <= INSTEP_FIN)) THEN  
  CALL CPPSOLAN(YDMODEL%YRCST, YDCPG_OPTS%KLON, YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA, YDVARS%GEOMETRY%GEMU%T0, YDVARS%GEOMETRY%GELAM%T0, &
  & ZRDG_MMU0)
  IF (.NOT.LSDDH) THEN
...
CALL APLPASSH (YDMODEL%YRCST, YDMODEL%YRML_PHY_MF%YRPHY, YDMODEL%YRML_PHY_MF%YRPHY1, YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA, YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDMF_PHYS_BASE_STATE%YCPG_PHY%PREHYD, &
...
CALL APLPARS(YDGEOMETRY, YDRCOEF, YDMODEL%YRCST, YDMODEL%YRML_PHY_MF, YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA, YDCPG_OPTS%KLON, 1, YDCPG_OPTS%KFLEVG,           &
& NTSSG, YDCPG_OPTS%KSTEP, YDMF_PHYS_BASE_STATE%YCPG_DYN%PHI, YDMF_PHYS_BASE_STATE%YCPG_PHY%PREHYD, YDMF_PHYS_BASE_STATE%YCPG_DYN%PHIF,  &
...
!=PARALLEL
CALL CPTENDSM (YDMODEL%YRCST, YDPHY, YDCPG_OPTS%KLON, YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA, YDCPG_OPTS%KFLEVG, YDMF_PHYS%OUT%DIFCQ,          &
...
CALL CPUTQYS (YDGEOMETRY, YDCPG_DIM, YDCPG_OPTS, YDMF_PHYS_BASE_STATE, YDMF_PHYS_NEXT_STATE, YDMF_PHYS, &
