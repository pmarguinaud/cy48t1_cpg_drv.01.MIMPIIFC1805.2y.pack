...
& YDCPG_MISC, YDCPG_PHY0, YDMF_PHYS, YDCPG_DYN0, YDMF_PHYS_SURF, YDVARS, YDMODEL, PDTPHY, PTRAJ_PHYS&
& )
...
CALL APLPARS(YDGEOMETRY, YDRCOEF, YDMODEL%YRCST, YDMODEL%YRML_PHY_MF, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA,                   &
& YDCPG_OPTS%KLON, 1, YDCPG_OPTS%KFLEVG, NTSSG, YDCPG_OPTS%KSTEP, YDMF_PHYS_BASE_STATE%YCPG_DYN%PHI,                        &
& YDMF_PHYS_BASE_STATE%YCPG_PHY%PREHYD, YDMF_PHYS_BASE_STATE%YCPG_DYN%PHIF, YDMF_PHYS_BASE_STATE%YCPG_PHY%PREHYDF,          &
& YDMF_PHYS_BASE_STATE%YCPG_PHY%XYB%DELP, YDMF_PHYS_BASE_STATE%YCPG_PHY%XYB%RDELP, YDMF_PHYS_BASE_STATE%U,                  &
& YDMF_PHYS_BASE_STATE%V, YDMF_PHYS_BASE_STATE%T, YDMF_PHYS_BASE_STATE%Q, YDMF_PHYS_BASE_STATE%YCPG_DYN%RCP%CP,             &
...
& YDMF_PHYS, YDMODEL%YRCST, YDSTOPH, YDPHY2, PDTPHY, ZTENDH, ZTENDQ)
