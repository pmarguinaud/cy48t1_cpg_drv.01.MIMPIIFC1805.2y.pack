...
@PROCESS NOCHECK
#endif
SUBROUTINE APLSIM(YDMF_PHYS_BASE_STATE, YDMF_PHYS_NEXT_STATE, YDGEOMETRY, YDCPG_BNDS, YDCPG_OPTS, YDCPG_MISC, &
...
IF (LRAYSP.AND.(YDCPG_OPTS%KSTEP >= INSTEP_DEB .AND. YDCPG_OPTS%KSTEP <= INSTEP_FIN)) THEN  
  CALL CPPSOLAN(YDMODEL%YRCST, YDCPG_OPTS%KLON, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDVARS%GEOMETRY%GEMU%T0, YDVARS%GEOMETRY%GELAM%T0, &
  & ZRDG_MMU0)
  IF (.NOT.LSDDH) THEN
...
IF (LRAYSP.AND.LRCOEF.AND.(YDCPG_OPTS%KSTEP > 1.OR.LTLADDIA)) THEN
  ...
  CALL RDRADCOEF(YDGEOMETRY, YDRCOEF, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_BNDS%KSTGLO, IFIELDSS, &
...
CALL APLPASSH (YDMODEL%YRCST, YDMODEL%YRML_PHY_MF%YRPHY, YDMODEL%YRML_PHY_MF%YRPHY1, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDMF_PHYS_BASE_STATE%YCPG_PHY%PREHYD, &
...
CALL APLPARS(YDGEOMETRY, YDRCOEF, YDMODEL%YRCST, YDMODEL%YRML_PHY_MF, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_OPTS%KLON, 1, YDCPG_OPTS%KFLEVG,           &
...
!=PARALLEL
CALL CPTENDSM (YDMODEL%YRCST, YDPHY, YDCPG_OPTS%KLON, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_OPTS%KFLEVG, YDMF_PHYS%OUT%DIFCQ,          &
...
CALL CPUTQYS (YDGEOMETRY, YDCPG_BNDS, YDCPG_OPTS, YDMF_PHYS_BASE_STATE, YDMF_PHYS_NEXT_STATE, YDMF_PHYS, &
