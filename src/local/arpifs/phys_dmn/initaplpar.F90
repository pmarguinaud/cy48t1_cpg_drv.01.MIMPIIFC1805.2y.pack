SUBROUTINE INITAPLPAR &
 ...
 & PVISICLD, PVISIHYDRO, PMXCLWC, LDAPLPAR)
...
PFPEVPCN(:,:) = 0.0_JPRB
PFPEVPCG(:,:) = 0.0_JPRB
IF (LDAPLPAR) PFTKE   (:,:) = 0.0_JPRB
IF (LDAPLPAR) PFTKEI  (:,:) = 0.0_JPRB
IF (LDAPLPAR) PFEFB1  (:,:) = 0.0_JPRB
IF (LDAPLPAR) PFEFB2  (:,:) = 0.0_JPRB
IF (LDAPLPAR) PFEFB3  (:,:) = 0.0_JPRB
PDIFCQLC(:,:) = 0.0_JPRB
PDIFCQIC(:,:) = 0.0_JPRB
PFIMCC (:,:) = 0.0_JPRB
PFEDQLC(:,:) = 0.0_JPRB
...
PQICE  (:,:) = 0.0_JPRB
PQLI   (:,:) = 0.0_JPRB
IF (LDAPLPAR) PQSAT  (:,:) = 0.0_JPRB
PRH    (:,:) = 0.0_JPRB
IF (LDAPLPAR) PLSCPE (:,:) = 0.0_JPRB
IF (LDAPLPAR) PQW    (:,:) = 0.0_JPRB
IF (LDAPLPAR) PTW    (:,:) = 0.0_JPRB
IF (LDAPLPAR) PLH    (:,:) = 0.0_JPRB
PTDISS (:,:) = 0.0_JPRB

IF (.NOT.LAROME) THEN
  IF (LDAPLPAR) PVEG    (:) = PVEG0(:)
ELSE
  IF (LDAPLPAR) PVEG    (:) = 0.0_JPRB
ENDIF

PALB    (:) = 0.0_JPRB
IF (LDAPLPAR) PCD     (:) = 0.001_JPRB
IF (LDAPLPAR) PCDN    (:) = 0.0_JPRB
IF (LDAPLPAR) PCH     (:) = 0.0_JPRB
IF (LDAPLPAR) PEMIS   (:) = 0.0_JPRB
PFEVV   (:) = 0.0_JPRB
PFLASH  (:) = 0.0_JPRB
PFTR    (:) = 0.0_JPRB
PFLWSP  (:) = 0.0_JPRB
...
PGZ0    (:) = 0.0_JPRB
PGZ0H   (:) = 0.0_JPRB
IF (LDAPLPAR) PNEIJ   (:) = 0.0_JPRB
PQS     (:) = 0.0_JPRB
IF (LDAPLPAR) PQSATS  (:) = 0.0_JPRB
PRUISP  (:) = 0.0_JPRB
PRUISL  (:) = 0.0_JPRB
PRUISS  (:) = 0.0_JPRB
PFGEL   (:) = 0.0_JPRB
...
PCLCL   (:) = 0.0_JPRB
PCLCC   (:) = 0.0_JPRB
IF (LDAPLPAR) PCPS    (:) = 0.0_JPRB
IF (LDAPLPAR) PC1     (:) = 0.0_JPRB
IF (LDAPLPAR) PC2     (:) = 0.0_JPRB
PCT     (:) = 0.0_JPRB
IF (LDAPLPAR) PLHS    (:) = 0.0_JPRB
IF (LDAPLPAR) PRS     (:) = 0.0_JPRB
PCAPE   (:) = 0.0_JPRB
PCTOP   (:) = 0.0_JPRB
PCLPH   (:) = 0.0_JPRB
PVEIN   (:) = 0.0_JPRB
...
IF (LDAPLPAR) KCLPH(:) = KLEV

PFCLL (:,:) = 0.0_JPRB
PFCLN (:,:) = 0.0_JPRB
PFCS  (:,:) = 0.0_JPRB
IF (LDAPLPAR) PFEVI (:,:) = 0.0_JPRB
PFEVL (:,:) = 0.0_JPRB
PFEVN (:,:) = 0.0_JPRB
