...
TYPE(CPG_SL2_TYPE),     INTENT(INOUT), TARGET :: YDCPG_SL2
...
IF (LNHQE) THEN
  CALL MF_PHYS_NHQE_PART1 (YDGEOMETRY, YDCPG_DIM, ZNHQ_TT0, ZNHQ_TT0L, &
                         & ZNHQ_TT0M, ZNHQ_TT9, YDVARS, YDMODEL, PGFL)
ENDIF
!=END SKIP
...
IF (YDMODEL%YRML_PHY_MF%YRSIMPHL%LSIMPH) THEN
  ...
  CALL APLSIM(YLMF_PHYS_BASE_STATE, YLMF_PHYS_NEXT_STATE, YDGEOMETRY, YDCPG_DIM, YDCPG_MISC, YDCPG_PHY0, &
  & YDMF_PHYS, YDCPG_DYN0, YDMF_PHYS_SURF, YDVARS, YDMODEL, PDTPHY, PTRAJ_PHYS)

ELSEIF (YDMODEL%YRML_PHY_MF%YRARPHY%LMPA) THEN
!=SKIP
  CALL APL_AROME(YLMF_PHYS_BASE_STATE, YLMF_PHYS_NEXT_STATE, YDGEOMETRY, YDCPG_DIM, YDCPG_MISC, YDCPG_GPAR, &
  & YDCPG_PHY0, YDCPG_PHY9, YDMF_PHYS, YDCPG_DYN0, YDCPG_DYN9, YDMF_PHYS_SURF, YDCPG_SL1, YDVARS, &
  & YDFIELDS%YRGMV, YDFIELDS%YRSURF, YDFIELDS%YRCFU, YDFIELDS%YRXFU, YDMODEL, LDCONFX, PDTPHY, PGFL, PGPSDT2D, &
  & PGMVT1, PGFLT1, PTRAJ_PHYS, YDDDH)
!=END SKIP
ELSE
!=SKIP
  CLNEW = ''
  ...
  CALL APLPAR_NEW 
  ELSE
  CALL APLPAR (YLMF_PHYS_BASE_STATE, YLMF_PHYS_NEXT_STATE, YDGEOMETRY, YDCPG_DIM, YDCPG_MISC, YDCPG_GPAR,    &
  & YDCPG_PHY0, YDMF_PHYS, YDCPG_DYN0, YDMF_PHYS_SURF, YDCPG_SL1, YDCPG_SL2, YDVARS, YDFIELDS%YRGMV,         &
...
IF (LNHQE) THEN
  CALL MF_PHYS_NHQE_PART2 (YDGEOMETRY, YDCPG_DIM, ZNHQ_TT0, ZNHQ_TT0L, &
                         & ZNHQ_TT0M, ZNHQ_TT9, YDVARS)
ENDIF
!=END SKIP
