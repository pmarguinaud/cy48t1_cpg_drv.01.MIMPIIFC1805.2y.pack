...
CALL INITAPLPAR ( YGFL, YDARPHY, YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA, YDCPG_DIM%KLON, YDCPG_DIM%KFLEVG, NTSSG, YSP_SBD%NLEVS,&
  ...
  & YDMF_PHYS%OUT%STRTV , YDMF_PHYS%OUT%STRMU , YDMF_PHYS%OUT%STRMV , YDMF_PHYS%OUT%FRMH  , YDMF_PHYS%TMP%APLPAR%MSC%FRMQ  ,&
  ...
  & YDMF_PHYS%OUT%FCHOZ , YDMF_PHYS%TMP%APLPAR%DSA%CPS   , YDMF_PHYS%TMP%APLPAR%DSA%LHS   ,&
  & YDMF_PHYS%TMP%APLPAR%DSA%RS    , YDMF_PHYS%TMP%APLPAR%MSC%LH    , YDMF_PHYS%TMP%APLPAR%MSC%LSCPE , YDCPG_MISC%NEB   , YDCPG_MISC%QICE  , YDCPG_MISC%QLI   , YDMF_PHYS%TMP%APLPAR%FLU%QSAT  ,&
  & YDMF_PHYS%TMP%APLPAR%MSC%QW    , YDCPG_MISC%RH    , YDMF_PHYS%TMP%APLPAR%MSC%TW    , YDMF_PHYS%OUT%ALB , YDMF_PHYS%TMP%APLPAR%FLU%CD    , YDMF_PHYS%TMP%APLPAR%FLU%CDN   , YDMF_PHYS%TMP%APLPAR%FLU%CH    ,&
  & YDMF_PHYS%TMP%APLPAR%DSA%C1    , YDMF_PHYS%TMP%APLPAR%DSA%C2    , YDMF_PHYS%OUT%CT    , YDMF_PHYS%TMP%APLPAR%FLU%EMIS  , YDMF_PHYS%OUT%FCHSP , YDMF_PHYS%OUT%FCLL  , YDMF_PHYS%OUT%FCLN  ,&
  & YDMF_PHYS%OUT%FCS   , YDMF_PHYS%TMP%APLPAR%FLU%FEVI  , YDMF_PHYS%OUT%FEVL  , YDMF_PHYS%OUT%FEVN  , YDMF_PHYS%OUT%FEVV  , YDMF_PHYS%OUT%FLASH , YDMF_PHYS%OUT%FTR   , YDMF_PHYS%OUT%FLWSP ,&
  ...
  & YDMF_PHYS%OUT%FPEVPCN,YDMF_PHYS%OUT%FPEVPCG,YDMF_PHYS%TMP%APLPAR%PFL%FTKE  , YDMF_PHYS%TMP%APLPAR%PFL%FTKEI , YDMF_PHYS%TMP%APLPAR%PFL%FEFB1 , YDMF_PHYS%TMP%APLPAR%PFL%FEFB2   , YDMF_PHYS%TMP%APLPAR%PFL%FEFB3,&
  & YDMF_PHYS%OUT%GZ0   , YDMF_PHYS%OUT%GZ0H  , YDMF_PHYS%TMP%APLPAR%FLU%NEIJ  , YDMF_PHYS%TMP%APLPAR%FLU%VEG   , YDCPG_MISC%QS    , YDMF_PHYS%TMP%APLPAR%FLU%QSATS , YDMF_PHYS%OUT%RUISL ,&
  ...
  & YDMF_PHYS%OUT%CAPE  , YDMF_PHYS%OUT%CTOP  , YDMF_PHYS%TMP%APLPAR%MOC%CLPH  , YDMF_PHYS%OUT%CLPH  , YDMF_PHYS%OUT%VEIN  , YDMF_PHYS%OUT%UGST  , YDMF_PHYS%OUT%VGST  ,&
  & YDMF_PHYS%OUT%DIAGH , ZEDR, YDMF_PHYS%OUT%VISICLD, YDMF_PHYS%OUT%VISIHYD, YDMF_PHYS%OUT%MXCLWC, LDAPLPAR=.NOT.LMPA)
...
IF (LLDIAB.AND.(.NOT.LSIMPH).AND.(.NOT.LMPA)) THEN
  ...
  ELSE
    CALL CPTEND_NEW( YDMODEL, YDCPG_DIM%KLON, YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA, YDCPG_DIM%KFLEVG, YDGSGEOM%GNORDL,YDGSGEOM%GNORDM,&
     ...
     & YDMF_PHYS%OUT%DIFCQLC,YDMF_PHYS%OUT%DIFCQIC,YDMF_PHYS%OUT%FIMCC,&
     & YDMF_PHYS%OUT%FEDQLC, YDMF_PHYS%OUT%FEDQIC, YDMF_PHYS%OUT%FEDQRC, YDMF_PHYS%OUT%FEDQSC, YDMF_PHYS%OUT%FCNEGQLC,YDMF_PHYS%OUT%FCNEGQIC,YDMF_PHYS%OUT%FCNEGQRC,YDMF_PHYS%OUT%FCNEGQSC,&
     & YDMF_PHYS%TMP%APLPAR%PFL%FTKE, YDMF_PHYS%TMP%APLPAR%PFL%FTKEI,  YDMF_PHYS%TMP%APLPAR%PFL%FEFB1 , YDMF_PHYS%TMP%APLPAR%PFL%FEFB2, YDMF_PHYS%TMP%APLPAR%PFL%FEFB3 ,YLMF_PHYS_STATE%YCPG_PHY%XYB%DELP ,&
     ...
     & YDMF_PHYS%TMP%APLPAR%DSA%CPS, YLMF_PHYS_STATE%YGSP_RR%T  ,&
     ...
     & YDMF_PHYS%TMP%APLPAR%MSC%FHP   ,YDMF_PHYS%TMP%APLPAR%PFL%FP   ,  YDMF_PHYS%OUT%FEPFP, YDMF_PHYS%OUT%FCMPCQ, YDMF_PHYS%OUT%FCMPSN, YDMF_PHYS%OUT%FCMPSL,&
