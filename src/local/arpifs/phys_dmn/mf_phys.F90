SUBROUTINE MF_PHYS (YDGEOMETRY, YDCPG_DIM, YDCPG_OPTS, YDCPG_MISC, YDCPG_GPAR, YDCPG_PHY0, YDCPG_PHY9,  &
...
REAL(KIND=JPRB),        INTENT(INOUT), OPTIONAL :: PGMVT1(YDCPG_DIM%KLON,YDCPG_DIM%KFLEVG,YDFIELDS%YRGMV%YT1%NDIM)
REAL(KIND=JPRB),        INTENT(INOUT), OPTIONAL :: PGFLT1(YDCPG_DIM%KLON,YDCPG_DIM%KFLEVG,YDMODEL%YRML_GCONF%YGFL%NDIM1)
...
CALL MF_PHYS_PREP (YDGEOMETRY, YDCPG_DIM, YDCPG_OPTS, YDMODEL%YRML_PHY_MF%YRARPHY, YDCPG_DYN0, YDCPG_DYN9, YDCPG_PHY0, YDCPG_PHY9, YDVARS)

CALL MF_PHYS_INIT (YDCPG_DIM, YDCPG_OPTS, YDMF_PHYS, YDCPG_MISC)
...
IF (LNHQE) THEN
  CALL MF_PHYS_NHQE_PART1 (YDGEOMETRY, YDCPG_DIM, YDCPG_OPTS, ZNHQ_TT0, ZNHQ_TT0L, ZNHQ_TT0M, ZNHQ_TT9, YDVARS, &
  & YDMODEL, PGFL)
ENDIF
!=END SKIP
...
IF (YDMODEL%YRML_PHY_MF%YRSIMPHL%LSIMPH) THEN
  ...
  CALL APLSIM(YLMF_PHYS_BASE_STATE, YLMF_PHYS_NEXT_STATE, YDGEOMETRY, YDCPG_DIM, YDCPG_OPTS, YDCPG_MISC, &
...
!=SKIP
  CALL APL_AROME(YLMF_PHYS_BASE_STATE, YLMF_PHYS_NEXT_STATE, YDGEOMETRY, YDCPG_DIM, YDCPG_OPTS, YDCPG_MISC,       &
...
!=SKIP
  ...
  IF (LLNEW) THEN
  CALL APL_ARPEGE (YLMF_PHYS_BASE_STATE, YLMF_PHYS_NEXT_STATE, YDGEOMETRY, YDCPG_DIM, YDCPG_OPTS, YDCPG_MISC,      &
  & YDCPG_GPAR, YDCPG_PHY0, YDMF_PHYS, YDCPG_DYN0, YDMF_PHYS_SURF, YDCPG_SL2, YDVARS, YDFIELDS%YRSURF, &
  & YDFIELDS%YRCFU, YDFIELDS%YRXFU, YDMODEL, LDCONFX, PDTPHY, YDDDH)
  ELSE
  CALL APLPAR (YLMF_PHYS_BASE_STATE, YLMF_PHYS_NEXT_STATE, YDGEOMETRY, YDCPG_DIM, YDCPG_OPTS, YDCPG_MISC,                    &
...
IF (LNHQE) THEN
  CALL MF_PHYS_NHQE_PART2 (YDGEOMETRY, YDCPG_DIM, YDCPG_OPTS, ZNHQ_TT0, ZNHQ_TT0L, ZNHQ_TT0M, ZNHQ_TT9, YDVARS)
ENDIF
!=END SKIP
