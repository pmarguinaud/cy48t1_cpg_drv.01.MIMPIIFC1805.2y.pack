...
& KEND, NPROMA, NFLEVG, NTSSG, YSP_SBD%NLEVS, ZDIFEXT, YDMF_PHYS%TMP%APLPAR%MSC%FRMQ, YDMF_PHYS%TMP%APLPAR%DSA%CPS, YDMF_PHYS%TMP%APLPAR%DSA%LHS, YDMF_PHYS%TMP%APLPAR%DSA%RS, &
& YDMF_PHYS%TMP%APLPAR%MSC%LH, YDMF_PHYS%TMP%APLPAR%MSC%LSCPE, YDMF_PHYS%TMP%APLPAR%FLU%QSAT, YDMF_PHYS%TMP%APLPAR%MSC%QW, YDMF_PHYS%TMP%APLPAR%MSC%TW, YDMF_PHYS%TMP%APLPAR%FLU%CD, YDMF_PHYS%TMP%APLPAR%FLU%CDN, YDMF_PHYS%TMP%APLPAR%FLU%CH, YDMF_PHYS%TMP%APLPAR%DSA%C1, YDMF_PHYS%TMP%APLPAR%DSA%C2, YDMF_PHYS%TMP%APLPAR%FLU%EMIS, YDMF_PHYS%TMP%APLPAR%FLU%FEVI, YDMF_PHYS%TMP%APLPAR%PFL%FTKE, &
& YDMF_PHYS%TMP%APLPAR%PFL%FTKEI, YDMF_PHYS%TMP%APLPAR%PFL%FEFB1, YDMF_PHYS%TMP%APLPAR%PFL%FEFB2, YDMF_PHYS%TMP%APLPAR%PFL%FEFB3, YDMF_PHYS%TMP%APLPAR%FLU%NEIJ, YDMF_PHYS%TMP%APLPAR%FLU%VEG, YDMF_PHYS%TMP%APLPAR%FLU%QSATS, ICLPH, ZEDR)
...
IF (LLDIAB.AND.(.NOT.LMPA)) THEN
  ...
  ENDDO
   ...
   & ITDIA, NFLEVG, KSTGLO, NVCLIS, YSD_VVD%NUMFLDS, NSTEP, NTSSG, YSP_SBD%NLEVS, &
   & KBL, KGPCOMP, YDCFU%NFRRC, PDTPHY, YDCSGEOM%RINDX, YDCSGEOM%RINDY, LLXFUMSE, &
   & YDGSGEOM%RCORI, PGFL, YDMF_PHYS%TMP%APLPAR%MSC%CVGQ, PKOZO, YDMF_PHYS%TMP%APLPAR%PFL%FPLCH, YDMF_PHYS%TMP%APLPAR%PFL%FPLSH, PGPAR, YDMF_PHYS%TMP%RDG%MU0, YDMF_PHYS%TMP%RDG%MU0LU,     &
   & YDMF_PHYS%TMP%RDG%MU0M, YDMF_PHYS%TMP%RDG%MU0N, YDGSGEOM%GELAM, YDGSGEOM%GEMU, YDGSGEOM%GM, ZAC, ZAC_HC,       &
   & YDMF_PHYS%TMP%RDG%MMU0, YDOROG%OROG, ZDIFEXT, YDMF_PHYS%TMP%APLPAR%MSC%FRMQ, YDMF_PHYS%TMP%APLPAR%DSA%CPS, YDMF_PHYS%TMP%APLPAR%DSA%LHS, YDMF_PHYS%TMP%APLPAR%DSA%RS, YDMF_PHYS%TMP%APLPAR%MSC%LH, YDMF_PHYS%TMP%APLPAR%MSC%LSCPE, YDMF_PHYS%TMP%APLPAR%BAY%QRCONV,   &
   & YDMF_PHYS%TMP%APLPAR%BAY%QSCONV, YDMF_PHYS%TMP%APLPAR%FLU%QSAT, YDMF_PHYS%TMP%APLPAR%MSC%QW, YDMF_PHYS%TMP%APLPAR%MSC%TW, YDMF_PHYS%TMP%APLPAR%FLU%CD, YDMF_PHYS%TMP%APLPAR%FLU%CDN, YDMF_PHYS%TMP%APLPAR%FLU%CH, YDMF_PHYS%TMP%APLPAR%DSA%C1, YDMF_PHYS%TMP%APLPAR%DSA%C2, YDMF_PHYS%TMP%APLPAR%FLU%EMIS, YDMF_PHYS%TMP%APLPAR%FLU%FEVI, YDMF_PHYS%TMP%APLPAR%PFL%FTKE,     &
   & YDMF_PHYS%TMP%APLPAR%PFL%FTKEI, YDMF_PHYS%TMP%APLPAR%PFL%FEFB1, YDMF_PHYS%TMP%APLPAR%PFL%FEFB2, YDMF_PHYS%TMP%APLPAR%PFL%FEFB3, YDMF_PHYS%TMP%APLPAR%FLU%NEIJ, YDMF_PHYS%TMP%APLPAR%FLU%VEG, YDMF_PHYS%TMP%APLPAR%FLU%QSATS, ICLPH, YDMF_PHYS%TMP%PRC%DPRECIPS,       &
   & YDMF_PHYS%TMP%PRC%DPRECIPS2, ZP1EZDIAG, ZTENDPTKE, YDMF_PHYS%TMP%APLPAR%KUR%KUROV_H, YDMF_PHYS%TMP%APLPAR%KUR%KTROV_H, ZTENDEXT_DEP,          &
   & PTRAJ_PHYS, ZEDR, YDDDH, PFTCNS, ZGP2DSPP)
...
IF (LMPA) THEN
  ...
  ENDIF
   ...
   & ZTENDGFLR(:, :, IPTREXT), YDMF_PHYS%TMP%PRC%DPRECIPS, YDMF_PHYS%TMP%PRC%DPRECIPS2, ZP1EZDIAG, YLPROCSET,    &
   & YDDDH )
...
IF(LGSCM.OR.LMUSCLFA) THEN
  ...
  & YDGSGEOM%RCORI, YDCSGEOM%RATATH, YDCSGEOM%RATATX, YDMF_PHYS%TMP%APLPAR%MSC%CVGQ, YDMF_PHYS%TMP%APLPAR%MSC%LCVQ, YDGSGEOM%     &
  & GECLO, YDGSGEOM%GESLO, YDMF_PHYS%TMP%APLPAR%PFL%FTKE, YDMF_PHYS%TMP%APLPAR%PFL%FEFB1, YDMF_PHYS%TMP%APLPAR%PFL%FEFB2, YDMF_PHYS%TMP%APLPAR%PFL%FEFB3, YDMF_PHYS%TMP%APLPAR%MSC%FRMQ, YDMF_PHYS%TMP%APLPAR%FLU%FEVI, YDMF_PHYS%TMP%APLPAR%FLU%CD,      &
  & YDMF_PHYS%TMP%APLPAR%FLU%CDN, YDMF_PHYS%TMP%APLPAR%FLU%CH, YDMF_PHYS%TMP%APLPAR%DSA%C1, YDMF_PHYS%TMP%APLPAR%DSA%C2, YDMF_PHYS%TMP%APLPAR%FLU%EMIS, YDMF_PHYS%TMP%APLPAR%FLU%NEIJ, YDMF_PHYS%TMP%APLPAR%FLU%VEG, YDMF_PHYS%TMP%APLPAR%DSA%CPS, YDMF_PHYS%TMP%APLPAR%DSA%LHS, YDMF_PHYS%TMP%APLPAR%DSA%RS, YDMF_PHYS%TMP%APLPAR%MSC%LH, YDMF_PHYS%TMP%APLPAR%MSC%LSCPE, YDMF_PHYS%TMP%APLPAR%FLU%QSAT, &
  & YDMF_PHYS%TMP%APLPAR%MSC%QW, YDMF_PHYS%TMP%APLPAR%MSC%TW, YDMF_PHYS%TMP%APLPAR%FLU%QSATS, ICLPH, YDMF_PHYS%TMP%APLPAR%PFL%FPLCH, YDMF_PHYS%TMP%APLPAR%PFL%FPLSH  )
ENDIF
