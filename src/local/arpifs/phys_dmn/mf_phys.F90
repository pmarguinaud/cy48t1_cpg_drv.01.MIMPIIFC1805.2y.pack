  ...
  ENDDO
    ...
    IF (LTWOTL) THEN
      ...
      IF (LAJUCV) THEN
        ...
        CALL ACAJUCV(YDMODEL%YRML_PHY_MF%YRPHY0,KST,KEND,NPROMA,NTPLUI,NFLEVG,NTAJUC,&
         & YDCPG_PHY0%PREHYD,PXYB0(1,1,YYTXYB0_PHY%M_ALPH),PXYB0(1,1,YYTXYB0_PHY%M_DELP),&
      ...
      CALL APLPAR(YDGEOMETRY,YDMF_PHYS,YDCPG_DYN0,YDMF_PHYS_SURF,YDVARS,YDSURF, YDXFU, YDCFU, YDMODEL, KST    , KEND   , NPROMA ,&
       ...
       & YDCPG_DYN0%PHI  , YDCPG_PHY0%PREHYD  , YDCPG_DYN0%PHIF , YDCPG_PHY0%PREHYDF ,PXYB0(1,1,YYTXYB0_PHY%M_ALPH),&
    ...
    ELSE
      ...
      CALL APLPAR(YDGEOMETRY,YDMF_PHYS,YDCPG_DYN9,YDMF_PHYS_SURF,YDVARS,YDSURF,  YDXFU, YDCFU,YDMODEL,  KST,    KEND   , NPROMA ,&
       ...
       & NTSSG  , YSP_SBD%NLEVS   ,&
       & KBL    , KGPCOMP, YDCFU%NFRRC, PDTPHY,YDCSGEOM%RINDX,YDCSGEOM%RINDY, LLXFUMSE,&
       & YDCPG_DYN9%PHI  , YDCPG_PHY9%PREHYD  , YDCPG_DYN9%PHIF , YDCPG_PHY9%PREHYDF , PXYB9(1,1,YYTXYB9_PHY%M_ALPH) , &
  ...
  IF (LTWOTL) THEN
    ...
    ELSE
      CALL CPTEND_NEW( YDMODEL, NPROMA, KST, KEND, NFLEVG,YDGSGEOM%GNORDL,YDGSGEOM%GNORDM,&
       ...
       & PXYB0(1,1,YYTXYB0_PHY%M_RDELP), YDCPG_DYN0%PHIF  , PRCP0(1,1,YYTRCP0%M_CP),&
       & YDVARS%U%T0,YDVARS%V%T0,YDVARS%T%T0,&
       & YDVARS%Q%T0,YDVARS%I%T0,YDVARS%L%T0,&
  ...
  ELSE
    ...
    ELSE
      ...
      & YDMF_PHYS%FPEVPSL,YDMF_PHYS%FPEVPSN,YDMF_PHYS%FPEVPSG,YDMF_PHYS%FPEVPCL,YDMF_PHYS%FPEVPCN,YDMF_PHYS%FPEVPCG,&
       ...
       & PXYB9(1,1,YYTXYB9_PHY%M_RDELP), YDCPG_DYN9%PHIF  , PRCP9(1,1,YYTRCP9%M_CP),&
       & YDVARS%U%T9,YDVARS%V%T9,YDVARS%T%T9,&
       & YDVARS%Q%T9,YDVARS%I%T9,YDVARS%L%T9,&
       & YDVARS%LCONV%T0,YDVARS%ICONV%T0,YDVARS%RCONV%T0,YDVARS%SCONV%T0,&
...
IF (LSIMPH) THEN
  ...
  IF (LTWOTL) THEN
    ...
    CALL APLPARS(YDGEOMETRY,YDRCOEF,YDMODEL%YRML_PHY_MF,KST,KEND,NPROMA,1,NFLEVG,NTSSG,NSTEP,&
     & YDCPG_DYN0%PHI,YDCPG_PHY0%PREHYD,YDCPG_DYN0%PHIF,YDCPG_PHY0%PREHYDF,PXYB0(1,1,YYTXYB0_PHY%M_DELP),PXYB0(1,1,YYTXYB0_PHY%M_RDELP),&
  ...
  ELSE
    ...
    CALL APLPARS(YDGEOMETRY,YDRCOEF,YDMODEL%YRML_PHY_MF,KST,KEND,NPROMA,1,NFLEVG,NTSSG,NSTEP,&
     & YDCPG_DYN9%PHI,YDCPG_PHY9%PREHYD,YDCPG_DYN9%PHIF,YDCPG_PHY9%PREHYDF,PXYB9(1,1,YYTXYB9_PHY%M_DELP),PXYB9(1,1,YYTXYB9_PHY%M_RDELP),&
...
IF (LSIMPH) THEN
  ...
  IF (LTWOTL) THEN
    CALL CPTENDSM (YDPHY,NPROMA,KST,KEND,NFLEVG,&
     ...
     & YDMF_PHYS%STRMU,YDMF_PHYS%STRMV,YDMF_PHYS%FRMH,&
     & PXYB0(1,1,YYTXYB0_PHY%M_RDELP),YDCPG_DYN0%PHIF,&
  ...
  ELSE
    CALL CPTENDSM (YDPHY,NPROMA,KST,KEND,NFLEVG,&
     ...
     & YDMF_PHYS%STRTU,YDMF_PHYS%STRTV,&
     & YDMF_PHYS%STRMU,YDMF_PHYS%STRMV,YDMF_PHYS%FRMH,&
     & PXYB9(1,1,YYTXYB9_PHY%M_RDELP),YDCPG_DYN9%PHIF,&
...
IF (LMPA) THEN
  ...
  IF(LTWOTL) THEN
    CALL APL_AROME(YDGEOMETRY,YDMF_PHYS,YDCPG_DYN0,YDMF_PHYS_SURF,YDVARS,YDSURF,YDCFU,YDXFU,YDMODEL, KBL, KGPCOMP, KST  , KEND   , NPROMA ,&
     ...
     & PGP2DSDT, ZGP2DSPP, &
     & YDCPG_DYN0%PHI,YDCPG_DYN0%PHIF,YDCPG_PHY0%PRE,YDCPG_PHY0%PREF,PXYB0(1,1,YYTXYB0_PHY%M_RDELP),PXYB0(1,1,YYTXYB0_PHY%M_DELP),&
  ...
  ELSE    
    CALL APL_AROME(YDGEOMETRY,YDMF_PHYS,YDCPG_DYN9,YDMF_PHYS_SURF,YDVARS,YDSURF,YDCFU,YDXFU,YDMODEL, KBL, KGPCOMP, KST  , KEND   , NPROMA ,&
     ...
     & YDGSGEOM%GECLO,YDGSGEOM%GESLO,&
     & PGP2DSDT, ZGP2DSPP, &
     & YDCPG_DYN9%PHI,YDCPG_DYN9%PHIF,YDCPG_PHY9%PRE,YDCPG_PHY9%PREF,PXYB9(1,1,YYTXYB9_PHY%M_RDELP),PXYB9(1,1,YYTXYB9_PHY%M_DELP),&
  ...
  IF(LNHDYN) THEN
    ...
    ELSE
      ...
      ! * Do conversion:
      IF (LSLAG.AND.LTWOTL) THEN
        CALL GNHGW2SVDAROME(YDGEOMETRY,KST,KEND,YDCPG_PHY0%PREHYDF,PXYB0(1,1,YYTXYB0_PHY%M_LNPR),ZRTT1,YDCPG_PHY0%PREF,ZGWT1,&
         & ZTENDD)  
      ELSE
        CALL GNHGW2SVDAROME(YDGEOMETRY,KST,KEND,YDCPG_PHY9%PREHYDF,PXYB9(1,1,YYTXYB9_PHY%M_LNPR),ZRTT1,YDCPG_PHY9%PREF,ZGWT1,&
         & ZTENDD)  
      ENDIF
...
IF(LGSCM.OR.LMUSCLFA) THEN
  ...
  CALL WRITEPHYSIO(YDGEOMETRY,YDSURF,YDDPHY,YDRIP,YDMODEL%YRML_PHY_MF,&
       ...
       & YDGSGEOM%GELAM,YDGSGEOM%GEMU,&
       & YDGSGEOM%GM, ZMU0,YDOROG%OROG,YDCPG_DYN0%OROGL,YDCPG_DYN0%OROGM,YDGSGEOM%RCORI,YDCSGEOM%RATATH,YDCSGEOM%RATATX,&
       & YDCPG_DYN0%PHI  , YDCPG_PHY0%PREHYD  , YDCPG_DYN0%PHIF , YDCPG_PHY0%PREHYDF , PXYB0(1,1,YYTXYB0_PHY%M_ALPH), PXYB0(1,1,YYTXYB0_PHY%M_DELP),&
       & PXYB0(1,1,YYTXYB0_PHY%M_LNPR), PXYB0(1,1,YYTXYB0_PHY%M_RDELP),&
