...
ELSEIF (YDMODEL%YRML_PHY_MF%YRARPHY%LMPA) THEN
  ...
  & YDCPG_DYN0, YDCPG_DYN9, YDMF_PHYS_SURF, YDVARS, YDFIELDS%YRGMV, YDFIELDS%YRSURF, YDFIELDS%YRCFU,    &
  & YDFIELDS%YRXFU, YDMODEL, LDCONFX, PDTPHY, PGFL, PGPSDT2D, YDCPG_SL1%ZVIEW, YDCPG_SL2%ZVIEW, PGMVT1, &
