  ...
  ENDDO
    ...
    IF (LTWOTL) THEN
      ...
      CALL APLPAR(YDGEOMETRY,YDMF_PHYS,YDCPG_DYN0,YDMF_PHYS_SURF,YDVARS,YDSURF, YDXFU, YDCFU, YDMODEL, KST    , KEND   , NPROMA ,&
       ...
       & YDCPG_DYN0%PHI  , YDCPG_PHY0%PREHYD  , YDCPG_DYN0%PHIF , YDCPG_PHY0%PREHYDF ,YDCPG_PHY0%XYB%ALPH,&
       & YDCPG_PHY0%XYB%DELP,&
       ...
       & YDVARS%VOR%T0,&
       & YDCPG_DYN0%RCP%CP, ZCVGQ  ,YDCPG_DYN0%RCP%R, PKOZO  , ZFPLCH , ZFPLSH ,&
       & YDCPG_DYN0%CTY%EVEL,&
       & PGPAR , &
    ...
    ELSE
      ...
      CALL APLPAR(YDGEOMETRY,YDMF_PHYS,YDCPG_DYN9,YDMF_PHYS_SURF,YDVARS,YDSURF,  YDXFU, YDCFU,YDMODEL,  KST,    KEND   , NPROMA ,&
       ...
       & NTSSG  , YSP_SBD%NLEVS   ,&
       & KBL    , KGPCOMP, YDCFU%NFRRC, PDTPHY,YDCSGEOM%RINDX,YDCSGEOM%RINDY, LLXFUMSE,&
       & YDCPG_DYN9%PHI  , YDCPG_PHY9%PREHYD  , YDCPG_DYN9%PHIF , YDCPG_PHY9%PREHYDF , YDCPG_PHY9%XYB%ALPH , &
       & YDCPG_PHY9%XYB%DELP,&
       & YDCPG_PHY9%XYB%LNPR,YDCPG_PHY9%XYB%RDELP,&
       ...
       & YDVARS%VOR%T9,&
       & YDCPG_DYN9%RCP%CP, ZCVGQ  ,YDCPG_DYN9%RCP%R, PKOZO  , ZFPLCH, ZFPLSH  ,&
       & YDCPG_DYN0%CTY%EVEL,&
       & PGPAR , &
