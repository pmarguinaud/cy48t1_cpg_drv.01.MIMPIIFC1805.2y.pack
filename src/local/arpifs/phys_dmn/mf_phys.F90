  ...
  IF (.NOT.LDCONFX) THEN
    ...
    IF (GCHETN%LPROFV)&
     & CALL PROFILECHET(YDGEOMETRY, YDCPG_MISC, YDMF_PHYS, YDCPG_DYN0, YDMF_PHYS_SURF, YDVARS,     &
       ...
       & GM, YDMF_PHYS_TMP%RDG%MU0, YDOROG%OROG, YDGSGEOM%RCORI, YDCSGEOM%RATATH, YDCSGEOM%RATATX, &
       & YDMF_PHYS_TMP%RDG%CVGQ, YDMF_PHYS_TMP%RDG%LCVQ, YDAPLPAR_TMP%PFL%   &
       & FPLCH, YDAPLPAR_TMP%PFL%FPLSH  )
