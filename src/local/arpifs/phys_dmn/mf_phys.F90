...
IF (LLDIAB.AND.(.NOT.LMPA)) THEN
  ...
  ENDDO
   ...
   & YDMF_PHYS%TMP%APLPAR%PFL%FTKEI, YDMF_PHYS%TMP%APLPAR%PFL%FEFB1, YDMF_PHYS%TMP%APLPAR%PFL%FEFB2, YDMF_PHYS%TMP%APLPAR%PFL%FEFB3, YDMF_PHYS%TMP%APLPAR%FLU%NEIJ, YDMF_PHYS%TMP%APLPAR%FLU%VEG, YDMF_PHYS%TMP%APLPAR%FLU%QSATS, ICLPH, ZDPRECIPS,       &
   & ZDPRECIPS2, ZP1EZDIAG, ZTENDPTKE, YDMF_PHYS%TMP%APLPAR%KUR%KUROV_H, YDMF_PHYS%TMP%APLPAR%KUR%KTROV_H, ZTENDEXT_DEP,          &
...
IF (LMPA) THEN
  ...
  ENDIF
   ...
   & ZTENDGFLR(:, :, IPTREXT), ZDPRECIPS, ZDPRECIPS2, ZP1EZDIAG, YLPROCSET,    &
   & YDDDH )
