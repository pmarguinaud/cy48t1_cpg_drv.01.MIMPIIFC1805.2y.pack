...
IF (LLDIAB.OR.LSIMPH) THEN
  CALL CPPHINP(YDGEOMETRY,YDMODEL,KST,KEND,&
   ...
   & YDMF_PHYS%TMP%RDG%MU0,YDMF_PHYS%TMP%RDG%MU0LU,YDMF_PHYS%TMP%RDG%MU0M,YDMF_PHYS%TMP%RDG%MU0N,ZCVGQ)
...
& ZLH, ZLSCPE, YDMF_PHYS%TMP%APLPAR%FLU%QSAT, ZQW, ZTW, YDMF_PHYS%TMP%APLPAR%FLU%CD, YDMF_PHYS%TMP%APLPAR%FLU%CDN, YDMF_PHYS%TMP%APLPAR%FLU%CH, ZC1, ZC2, YDMF_PHYS%TMP%APLPAR%FLU%EMIS, YDMF_PHYS%TMP%APLPAR%FLU%FEVI, ZFTKE, &
& ZFTKEI, ZFEFB1, ZFEFB2, ZFEFB3, YDMF_PHYS%TMP%APLPAR%FLU%NEIJ, YDMF_PHYS%TMP%APLPAR%FLU%VEG, YDMF_PHYS%TMP%APLPAR%FLU%QSATS, ICLPH, ZEDR)
...
IF (LLDIAB.AND.(.NOT.LMPA)) THEN
  ...
  ENDDO
   ...
   & YDGSGEOM%RCORI, PGFL, ZCVGQ, PKOZO, ZFPLCH, ZFPLSH, PGPAR, YDMF_PHYS%TMP%RDG%MU0, YDMF_PHYS%TMP%RDG%MU0LU,     &
   & YDMF_PHYS%TMP%RDG%MU0M, YDMF_PHYS%TMP%RDG%MU0N, YDGSGEOM%GELAM, YDGSGEOM%GEMU, YDGSGEOM%GM, ZAC, ZAC_HC,       &
   & YDMF_PHYS%TMP%RDG%MMU0, YDOROG%OROG, ZDIFEXT, ZFRMQ, ZCPS, ZLHS, ZRS, ZLH, ZLSCPE, ZQRCONV,   &
   & ZQSCONV, YDMF_PHYS%TMP%APLPAR%FLU%QSAT, ZQW, ZTW, YDMF_PHYS%TMP%APLPAR%FLU%CD, YDMF_PHYS%TMP%APLPAR%FLU%CDN, YDMF_PHYS%TMP%APLPAR%FLU%CH, ZC1, ZC2, YDMF_PHYS%TMP%APLPAR%FLU%EMIS, YDMF_PHYS%TMP%APLPAR%FLU%FEVI, ZFTKE,     &
   & ZFTKEI, ZFEFB1, ZFEFB2, ZFEFB3, YDMF_PHYS%TMP%APLPAR%FLU%NEIJ, YDMF_PHYS%TMP%APLPAR%FLU%VEG, YDMF_PHYS%TMP%APLPAR%FLU%QSATS, ICLPH, ZDPRECIPS,       &
...
IF (LMPA) THEN
  ...
  ENDIF
   ...
   & YDOROG%OROG, YDGSGEOM%GM, YDMF_PHYS%TMP%RDG%MU0, YDMF_PHYS%TMP%RDG%MU0LU, YDMF_PHYS%TMP%RDG%MU0M, YDMF_PHYS%TMP%RDG%MU0N, YDGSGEOM%GECLO,     &
...
IF(LGSCM.OR.LMUSCLFA) THEN
  ...
  & NLEVS, YDGSGEOM%GELAM, YDGSGEOM%GEMU, YDGSGEOM%GM, YDMF_PHYS%TMP%RDG%MU0, YDOROG%OROG,         &
  & YDGSGEOM%RCORI, YDCSGEOM%RATATH, YDCSGEOM%RATATX, ZCVGQ, ZLCVQ, YDGSGEOM%     &
  & GECLO, YDGSGEOM%GESLO, ZFTKE, ZFEFB1, ZFEFB2, ZFEFB3, ZFRMQ, YDMF_PHYS%TMP%APLPAR%FLU%FEVI, YDMF_PHYS%TMP%APLPAR%FLU%CD,      &
  & YDMF_PHYS%TMP%APLPAR%FLU%CDN, YDMF_PHYS%TMP%APLPAR%FLU%CH, ZC1, ZC2, YDMF_PHYS%TMP%APLPAR%FLU%EMIS, YDMF_PHYS%TMP%APLPAR%FLU%NEIJ, YDMF_PHYS%TMP%APLPAR%FLU%VEG, ZCPS, ZLHS, ZRS, ZLH, ZLSCPE, YDMF_PHYS%TMP%APLPAR%FLU%QSAT, &
  & ZQW, ZTW, YDMF_PHYS%TMP%APLPAR%FLU%QSATS, ICLPH, ZFPLCH, ZFPLSH  )
ENDIF
