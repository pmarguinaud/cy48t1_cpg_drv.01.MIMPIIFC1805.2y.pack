...
CALL INITAPLPAR ( YGFL, YDARPHY, KST, KEND, NPROMA, NFLEVG, NTSSG, YSP_SBD%NLEVS,&
  ...
  & ZQW    , PRH    , ZTW    , YDMF_PHYS%OUT%ALB , ZCD    , ZCDN   , ZCH    ,&
  ...
  & YDMF_PHYS%OUT%GZ0   , YDMF_PHYS%OUT%GZ0H  , ZNEIJ  , ZVEG   , PQS    , ZQSATS , YDMF_PHYS%OUT%RUISL ,&
  ...
  & YDMF_PHYS%OUT%QCLS  , YDMF_PHYS%OUT%RHCLS , PCLCT  , YDMF_PHYS%OUT%CLCH  , YDMF_PHYS%OUT%CLCM  , YDMF_PHYS%OUT%CLCL  , YDMF_PHYS%OUT%CLCC  ,&
...
!               ----------------------------------
  ...
  IF (.NOT.LDCONFX) THEN
    ...
    IF (GCHETN%LPROFV)&
     ...
     & YDMF_PHYS%OUT%FRMH, YDMF_PHYS%OUT%FCHOZ, PNEB, PQICE, PQLI, PRH,&
     ...
     & PQS, YDMF_PHYS%OUT%RUISL, YDMF_PHYS%OUT%RUISP, YDMF_PHYS%OUT%RUISS,&
     & YDMF_PHYS%OUT%UCLS, YDMF_PHYS%OUT%VCLS, YDMF_PHYS%OUT%TCLS, YDMF_PHYS%OUT%QCLS, YDMF_PHYS%OUT%RHCLS,&
     & PCLCT, YDMF_PHYS%OUT%CLCH, YDMF_PHYS%OUT%CLCM, YDMF_PHYS%OUT%CLCL, YDMF_PHYS%OUT%CLCC,&
     & ZFPLCH, ZFPLSH,&
...
IF(LGSCM.OR.LMUSCLFA) THEN
  ...
  CALL WRITEPHYSIO(YDGEOMETRY,YDSURF,YDDPHY,YDRIP,YDMODEL%YRML_PHY_MF,&
       ...
       & YDMF_PHYS%OUT%STRCU, YDMF_PHYS%OUT%STRCV, YDMF_PHYS%OUT%STRDU, YDMF_PHYS%OUT%STRDV, YDMF_PHYS%OUT%STRTU, YDMF_PHYS%OUT%STRTV, YDMF_PHYS%OUT%STRMU, YDMF_PHYS%OUT%STRMV,&
       & YDMF_PHYS%OUT%FRMH, ZFRMQ, YDMF_PHYS%OUT%FCHOZ, PNEB, PQICE, PQLI, PRH,&
       ...
       & PQS, ZQSATS, YDMF_PHYS%OUT%RUISL, YDMF_PHYS%OUT%RUISP, YDMF_PHYS%OUT%RUISS,&
       & YDMF_PHYS%OUT%UCLS, YDMF_PHYS%OUT%VCLS, YDMF_PHYS%OUT%TCLS, YDMF_PHYS%OUT%QCLS, YDMF_PHYS%OUT%RHCLS,&
       & PCLCT, YDMF_PHYS%OUT%CLCH, YDMF_PHYS%OUT%CLCM, YDMF_PHYS%OUT%CLCL, YDMF_PHYS%OUT%CLCC,&
