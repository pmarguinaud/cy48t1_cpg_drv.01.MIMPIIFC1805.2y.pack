...
IF (LLDIAB.AND.(.NOT.LMPA)) THEN
  ...
  ENDDO
   ...
   & YDVARS, YDSURF, YDXFU, YDCFU, YDMODEL, YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA, YDCPG_DIM%KLON, ITDIA, YDCPG_DIM%KFLEVG, YDCPG_DIM%KSTGLO, NVCLIS,         &
...
IF (LCORWAT) THEN
  CALL MF_PHYS_CORWAT (YDMF_PHYS, YDMF_PHYS_SURF, YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA, YDCPG_DIM%KFLEVG)
ENDIF
...
IF (LMPA) THEN
  ...
  ENDIF
   ...
   & YDCFU, YDXFU, YDMODEL, YDCPG_DIM%KBL, YDCPG_DIM%KGPCOMP, YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA, YDCPG_DIM%KLON, 1, YDCPG_DIM%KFLEVG, NSTEP, IMAXDRAFT, NTSSG,      &
