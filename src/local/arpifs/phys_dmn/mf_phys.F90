...
CALL SC2PRG(1,YEXT(:)%MP,PGFL   ,ZP1EXT0)     !  YDVARS%EXT(1)%T0
  ...
  ENDDO
    ...
    IF (LTWOTL) THEN
      ...
      CALL APLPAR(YDGEOMETRY,YDCPG_OPT,YDCPG_MISC,YDMF_PHYS,YDMF_PHYS_SURF,YDVARS,YDSURF, YDXFU, YDCFU, YDMODEL, KST    , KEND   , NPROMA ,&
       ...
       & YDVARS%CVV%T0,YDVARS%O3%T0,ZP1CHEM0,ZP1NOGW0,ZP2NOGW0, PGFL, &
       & YDVARS%VOR%T0,&
    ...
    ELSE
      ...
      CALL APLPAR(YDGEOMETRY,YDCPG_OPT,YDCPG_MISC,YDMF_PHYS,YDMF_PHYS_SURF,YDVARS,YDSURF,  YDXFU, YDCFU,YDMODEL,  KST,    KEND   , NPROMA ,&
       ...
       & ZMRAT5C,ZMRAT5N,&
       & YDOROG%OROG,&
       & YDCPG_PHY9%W,YDVARS%DIV%T9,YDVARS%U%DL,YDVARS%V%DL,YDCPG_PHY9%WL,YDCPG_PHY9%WM,&
       & ZDIFEXT, &
       & ZFRMQ  ,&
       & ZCPS   , ZLHS   ,&
       & ZRS    , ZLH    , ZLSCPE , &
