...
CALL APLPAR_INIT ( YGFL, YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA, YDCPG_DIM%KLON, YDCPG_DIM%KFLEVG, NTSSG, YSP_SBD%NLEVS,&
  ...
  & YDMF_PHYS%TMP%APLPAR%MSC%FRMQ  ,&
  & YDMF_PHYS%TMP%APLPAR%DSA%CPS   , YDMF_PHYS%TMP%APLPAR%DSA%LHS   ,&
  & YDMF_PHYS%TMP%APLPAR%DSA%RS    , YDMF_PHYS%TMP%APLPAR%MSC%LH    , YDMF_PHYS%TMP%APLPAR%MSC%LSCPE , YDMF_PHYS%TMP%APLPAR%FLU%QSAT  ,&
  & YDMF_PHYS%TMP%APLPAR%MSC%QW    , YDMF_PHYS%TMP%APLPAR%MSC%TW    , YDMF_PHYS%TMP%APLPAR%FLU%CD    , YDMF_PHYS%TMP%APLPAR%FLU%CDN   , YDMF_PHYS%TMP%APLPAR%FLU%CH    ,&
  & YDMF_PHYS%TMP%APLPAR%DSA%C1    , YDMF_PHYS%TMP%APLPAR%DSA%C2    , YDMF_PHYS%TMP%APLPAR%FLU%EMIS  , &
  & YDMF_PHYS%TMP%APLPAR%FLU%FEVI  , &
  & YDMF_PHYS%TMP%APLPAR%PFL%FTKE  , YDMF_PHYS%TMP%APLPAR%PFL%FTKEI , YDMF_PHYS%TMP%APLPAR%PFL%FEFB1 , YDMF_PHYS%TMP%APLPAR%PFL%FEFB2   , YDMF_PHYS%TMP%APLPAR%PFL%FEFB3,&
  & YDMF_PHYS%TMP%APLPAR%FLU%NEIJ  , YDMF_PHYS%TMP%APLPAR%FLU%VEG   , YDMF_PHYS%TMP%APLPAR%FLU%QSATS , &
  & YDMF_PHYS%TMP%APLPAR%MOC%CLPH)
