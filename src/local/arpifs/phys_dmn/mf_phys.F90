...
IF (YDMODEL%YRML_PHY_MF%YRSIMPHL%LSIMPH) THEN
  ...
  & YDMF_PHYS_TMP, YDCPG_DYN0, YDCPG_DYN9, YDMF_PHYS_SURF, YDVARS, YDMODEL, PDTPHY, &
...
ELSEIF (YDMODEL%YRML_PHY_MF%YRARPHY%LMPA) THEN
  ...
  & YDFIELDS%YRCFU, YDFIELDS%YRXFU, YDMODEL, LDCONFX, PDTPHY, PGFL, PGPSDT2D,                       &
  & YDCPG_SL1%ZVIEW, YDCPG_SL2%ZVIEW, PGMVT1, PGFLT1, PTRAJ_PHYS, YDDDH)
ELSE
  CLNEW = ''
  ...
  IF (LLNEW) THEN
  ELSE
  CALL APLPAR (YDGEOMETRY, YDCPG_DIM, YDCPG_MISC, YDCPG_GPAR, YDCPG_PHY0, YDCPG_PHY9, YDMF_PHYS, YDMF_PHYS_TMP, &
  & YDCPG_DYN0, YDCPG_DYN9, YDMF_PHYS_SURF, YDCPG_SL1, YDCPG_SL2, YDVARS, YDFIELDS%YRGMV, YDFIELDS%YRSURF,      &
  & YDFIELDS%YRCFU, YDFIELDS%YRXFU, YDMODEL, LDCONFX, PDTPHY, PGFL, PGMVT1, PGFLT1, PTRAJ_PHYS, YDDDH)
  ENDIF
