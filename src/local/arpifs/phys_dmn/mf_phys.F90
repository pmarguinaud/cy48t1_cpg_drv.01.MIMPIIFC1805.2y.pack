...
@PROCESS NOCHECK
#endif
SUBROUTINE MF_PHYS(YDGEOMETRY,YDMF_PHYS_SURF,YDSURFVARS,YDVARS,YDGMV,YDSURF,YDCFU,YDXFU,YDMODEL,&
 !---------------------------------------------------------------------
 ! - INPUT and INOUT.
...
ZVADES      => YDSURFVARS%GSD_VA%VDES%FT0%DATA (:, KBL)
ZVALAN      => YDSURFVARS%GSD_VA%VLAN%FT0%DATA (:, KBL)
ZVASEA      => YDSURFVARS%GSD_VA%VSEA%FT0%DATA (:, KBL)
ZVASOO      => YDSURFVARS%GSD_VA%VSOO%FT0%DATA (:, KBL)
ZVASUL      => YDSURFVARS%GSD_VA%VSUL%FT0%DATA (:, KBL)
ZVAVOL      => YDSURFVARS%GSD_VA%VVOL%FT0%DATA (:, KBL)
CALL SC2PRG(1,YSD_VC%YVC(:)%MP,PSD_VC,ZVCVC1)
ZVDSUND     => YDSURFVARS%GSD_VD%VSUND%FT0%DATA (:, KBL)
ZVFALBF     => YDSURFVARS%GSD_VF%VALBF%FT0%DATA (:, KBL)
ZVFALBSF    => YDSURFVARS%GSD_VF%VALBSF%FT0%DATA (:, KBL)
ZVFEMISF    => YDSURFVARS%GSD_VF%VEMISF%FT0%DATA (:, KBL)
ZVFGETRL    => YDSURFVARS%GSD_VF%VGETRL%FT0%DATA (:, KBL)
ZVFLSM      => YDSURFVARS%GSD_VF%VLSM%FT0%DATA (:, KBL)
ZVFNUDM     => YDSURFVARS%GSD_VF%VNUDM%FT0%DATA (:, KBL)
ZVFVEG      => YDSURFVARS%GSD_VF%VVEG%FT0%DATA (:, KBL)
ZVFVRLAN    => YDSURFVARS%GSD_VF%VVRLAN%FT0%DATA (:, KBL)
ZVFVRLDI    => YDSURFVARS%GSD_VF%VVRLDI%FT0%DATA (:, KBL)
ZVFZ0F      => YDSURFVARS%GSD_VF%VZ0F%FT0%DATA (:, KBL)
ZVFZ0RLF    => YDSURFVARS%GSD_VF%VZ0RLF%FT0%DATA (:, KBL)
ZVHBCCH     => YDSURFVARS%GSD_VH%VBCCH%FT0%DATA (:, KBL)
ZVHPBLH     => YDSURFVARS%GSD_VH%VPBLH%FT0%DATA (:, KBL)
ZVHQSH      => YDSURFVARS%GSD_VH%VQSH%FT0%DATA (:, KBL)
ZVHSCCH     => YDSURFVARS%GSD_VH%VSCCH%FT0%DATA (:, KBL)
ZVHSPSH     => YDSURFVARS%GSD_VH%VSPSH%FT0%DATA (:, KBL)
ZVHTCCH     => YDSURFVARS%GSD_VH%VTCCH%FT0%DATA (:, KBL)
ZVKUDGRO    => YDSURFVARS%GSD_VK%VUDGRO%FT0%DATA (:, KBL)
ZVPTPC      => YDSURFVARS%GSD_VP%VTPC%FT0%DATA (:, KBL)
ZVPWPC      => YDSURFVARS%GSD_VP%VWPC%FT0%DATA (:, KBL)
ZVVALV      => YDSURFVARS%GSD_VV%VALV%FT0%DATA (:, KBL)
ZVVARG      => YDSURFVARS%GSD_VV%VARG%FT0%DATA (:, KBL)
ZVVD2       => YDSURFVARS%GSD_VV%VD2%FT0%DATA (:, KBL)
ZVVHV       => YDSURFVARS%GSD_VV%VHV%FT0%DATA (:, KBL)
ZVVIVEG     => YDSURFVARS%GSD_VV%VIVEG%FT0%DATA (:, KBL)
ZVVLAI      => YDSURFVARS%GSD_VV%VLAI%FT0%DATA (:, KBL)
ZVVRSMIN    => YDSURFVARS%GSD_VV%VRSMIN%FT0%DATA (:, KBL)
ZVVSAB      => YDSURFVARS%GSD_VV%VSAB%FT0%DATA (:, KBL)
ZVVZ0H      => YDSURFVARS%GSD_VV%VZ0H%FT0%DATA (:, KBL)

! ZRRFC0      => YDSURFVARS%GSP_RR%VFC%FT0%DATA (:, KBL)
! ZRRFC1      => YDSURFVARS%GSP_RR%VFC%FT1%DATA (:, KBL)
! ZRRFC9      => YDSURFVARS%GSP_RR%VFC%FT9%DATA (:, KBL)
! ZRRIC0      => YDSURFVARS%GSP_RR%VIC%FT0%DATA (:, KBL)
! ZRRIC1      => YDSURFVARS%GSP_RR%VIC%FT1%DATA (:, KBL)
! ZRRIC9      => YDSURFVARS%GSP_RR%VIC%FT9%DATA (:, KBL)
! ZRRT0       => YDSURFVARS%GSP_RR%VT%FT0%DATA (:, KBL)
! ZRRT1       => YDSURFVARS%GSP_RR%VT%FT1%DATA (:, KBL)
! ZRRT9       => YDSURFVARS%GSP_RR%VT%FT9%DATA (:, KBL)
! ZRRW0       => YDSURFVARS%GSP_RR%VW%FT0%DATA (:, KBL)
! ZRRW1       => YDSURFVARS%GSP_RR%VW%FT1%DATA (:, KBL)
! ZRRW9       => YDSURFVARS%GSP_RR%VW%FT9%DATA (:, KBL)
...
ZSBQ1       => YDSURFVARS%GSP_SB%VQ%FT1%DATA (:, :, KBL)
ZSBQ9       => YDSURFVARS%GSP_SB%VQ%FT9%DATA (:, :, KBL)
ZSBTL0      => YDSURFVARS%GSP_SB%VTL%FT0%DATA (:, :, KBL)
ZSBTL1      => YDSURFVARS%GSP_SB%VTL%FT1%DATA (:, :, KBL)
ZSBTL9      => YDSURFVARS%GSP_SB%VTL%FT9%DATA (:, :, KBL)
ZSBT0       => YDSURFVARS%GSP_SB%VT%FT0%DATA (:, :, KBL)
ZSBT1       => YDSURFVARS%GSP_SB%VT%FT1%DATA (:, :, KBL)
ZSBT9       => YDSURFVARS%GSP_SB%VT%FT9%DATA (:, :, KBL)
ZSGA0       => YDSURFVARS%GSP_SG%VA%FT0%DATA (:, :, KBL)
ZSGA1       => YDSURFVARS%GSP_SG%VA%FT1%DATA (:, :, KBL)
ZSGA9       => YDSURFVARS%GSP_SG%VA%FT9%DATA (:, :, KBL)
ZSGF0       => YDSURFVARS%GSP_SG%VF%FT0%DATA (:, :, KBL)
ZSGF1       => YDSURFVARS%GSP_SG%VF%FT1%DATA (:, :, KBL)
ZSGF9       => YDSURFVARS%GSP_SG%VF%FT9%DATA (:, :, KBL)
ZSGR0       => YDSURFVARS%GSP_SG%VR%FT0%DATA (:, :, KBL)
ZSGR1       => YDSURFVARS%GSP_SG%VR%FT1%DATA (:, :, KBL)
ZSGR9       => YDSURFVARS%GSP_SG%VR%FT9%DATA (:, :, KBL)
ZSGT1       => YDSURFVARS%GSP_SG%VT%FT1%DATA (:, :, KBL)
...
IF (LLDIAB.AND.(.NOT.LMPA)) THEN
  ...
  ENDDO
    ...
    IF (LTWOTL) THEN
      ...
      ITDIA=1_JPIM
      CALL APLPAR(YDGEOMETRY,YDMF_PHYS_SURF,YDSURFVARS,YDVARS,YDSURF, YDXFU, YDCFU, YDMODEL, KST    , KEND   , NPROMA ,&
       & ITDIA  , NFLEVG  , KSTGLO,&
...
IF (LMPA) THEN
  ...
  IF(LTWOTL) THEN
    CALL APL_AROME(YDGEOMETRY,YDMF_PHYS_SURF,YDSURFVARS,YDVARS,YDSURF,YDCFU,YDXFU,YDMODEL, KBL, KGPCOMP, KST  , KEND   , NPROMA ,&
     & 1      , NFLEVG , NSTEP  ,&
