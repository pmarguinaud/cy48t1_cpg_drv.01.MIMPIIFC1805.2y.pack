...
IF (LLDIAB.AND.(.NOT.LMPA)) THEN
  ...
  ENDDO
   ...
   ITDIA=1_JPIM
   CALL APLPAR(YDGEOMETRY,YLAPLPAR,YDCPG_DYN0,YDCPG_MISC,YDMF_PHYS,YDMF_PHYS_SURF,YDVARS,YDSURF, YDXFU, YDCFU, YDMODEL, KST    , KEND   , NPROMA ,&
    & ITDIA  , NFLEVG  , KSTGLO,&
...
IF (LMPA) THEN
  ...
  IF(LTWOTL) THEN
    CALL APL_AROME(YDGEOMETRY,YLAPLPAR,YDCPG_MISC,YDMF_PHYS,YDMF_PHYS_SURF,YDVARS,YDSURF,YDCFU,YDXFU,YDMODEL, KBL, KGPCOMP, KST  , KEND   , NPROMA ,&
     & 1      , NFLEVG , NSTEP  ,&
     ...
     & PGP2DSDT, ZGP2DSPP, &
     & YLAPLPAR%YCPG_DYN%PHI,YLAPLPAR%YCPG_DYN%PHIF,YLAPLPAR%YCPG_PHY%PRE,YLAPLPAR%YCPG_PHY%PREF,YLAPLPAR%YCPG_PHY%XYB%RDELP,YLAPLPAR%YCPG_PHY%XYB%DELP,&
     & YLAPLPAR%T,YLAPLPAR%Q,&
     & YLAPLPAR%YCPG_DYN%RCP%CP,YLAPLPAR%YCPG_DYN%RCP%R,YLAPLPAR%YCPG_PHY%XYB%ALPH,YLAPLPAR%YCPG_PHY%XYB%LNPR,&
     & YLAPLPAR%L,YLAPLPAR%I,YLAPLPAR%R,YLAPLPAR%S,&
     & YLAPLPAR%G,YLAPLPAR%H,YLAPLPAR%P1LIMA,YLAPLPAR%TKE,&
     & YLAPLPAR%EFB1,YLAPLPAR%EFB2,YLAPLPAR%EFB3,&
     & YLAPLPAR%SRC,YLAPLPAR%P1EXT,&
     & YLAPLPAR%U,YLAPLPAR%V, YLAPLPAR%YCPG_PHY%W,ZEDR,&
     & PGPAR,&
     ! outputs
