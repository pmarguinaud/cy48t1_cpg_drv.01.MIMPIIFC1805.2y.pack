...
IF (LLDIAB.AND.(.NOT.LMPA)) THEN
  ...
  ENDDO
   ...
   & YDMF_PHYS%TMP%RDG%MMU0, YDOROG%OROG, ZDIFEXT, YDMF_PHYS%TMP%APLPAR%MSC%FRMQ, YDMF_PHYS%TMP%APLPAR%DSA%CPS, YDMF_PHYS%TMP%APLPAR%DSA%LHS, YDMF_PHYS%TMP%APLPAR%DSA%RS, YDMF_PHYS%TMP%APLPAR%MSC%LH, YDMF_PHYS%TMP%APLPAR%MSC%LSCPE, ZQRCONV,   &
   & ZQSCONV, YDMF_PHYS%TMP%APLPAR%FLU%QSAT, YDMF_PHYS%TMP%APLPAR%MSC%QW, YDMF_PHYS%TMP%APLPAR%MSC%TW, YDMF_PHYS%TMP%APLPAR%FLU%CD, YDMF_PHYS%TMP%APLPAR%FLU%CDN, YDMF_PHYS%TMP%APLPAR%FLU%CH, YDMF_PHYS%TMP%APLPAR%DSA%C1, YDMF_PHYS%TMP%APLPAR%DSA%C2, YDMF_PHYS%TMP%APLPAR%FLU%EMIS, YDMF_PHYS%TMP%APLPAR%FLU%FEVI, YDMF_PHYS%TMP%APLPAR%PFL%FTKE,     &
