...
IF (LSIMPH) THEN
  ...
  IF (LTWOTL) THEN
    ...
    CALL APLPASSH (YDPHY,YDMODEL%YRML_PHY_MF%YRPHY1,KST,KEND,NPROMA,NFLEVG,&
     & YLMF_PHYS_STATE%YCPG_PHY%PREHYD,YDVARS%Q%T0,&
    ...
    CALL APLPARS(YDGEOMETRY,YDRCOEF,YDMODEL%YRML_PHY_MF,KST,KEND,NPROMA,1,NFLEVG,NTSSG,NSTEP,&
     & YLMF_PHYS_STATE%YCPG_DYN%PHI,YLMF_PHYS_STATE%YCPG_PHY%PREHYD,YLMF_PHYS_STATE%YCPG_DYN%PHIF,YLMF_PHYS_STATE%YCPG_PHY%PREHYDF,YLMF_PHYS_STATE%YCPG_PHY%XYB%DELP,YLMF_PHYS_STATE%YCPG_PHY%XYB%RDELP,&
     & YDVARS%U%T0,YDVARS%V%T0,YDVARS%T%T0,YDVARS%Q%T0,YLMF_PHYS_STATE%YCPG_DYN%RCP%CP,ZCVGQ,&
  ...
  ELSE
    ...
    CALL APLPASSH (YDPHY,YDMODEL%YRML_PHY_MF%YRPHY1,KST,KEND,NPROMA,NFLEVG,&
     & YLMF_PHYS_STATE%YCPG_PHY%PREHYD,YDVARS%Q%T9,&
     & YDMF_PHYS_SURF%GSP_SG%PF_T1,YDMF_PHYS_SURF%GSP_RR%PT_T1,YDMF_PHYS_SURF%GSP_RR%PW_T1,&
     & YDMF_PHYS_SURF%GSD_VF%PLSM,YDMF_PHYS_SURF%GSD_VF%PVEG,&
     & ZQS1)  
    ...
    IF (.NOT.LLDIAB) THEN
      CALL APLPASSH (YDPHY,YDMODEL%YRML_PHY_MF%YRPHY1,KST,KEND,NPROMA,NFLEVG,&
       & YLMF_PHYS_STATE%YCPG_PHY%PREHYD,YDVARS%Q%T9,&
       & YDMF_PHYS_SURF%GSP_SG%PF_T9,YDMF_PHYS_SURF%GSP_RR%PT_T9,YDMF_PHYS_SURF%GSP_RR%PW_T9,&
       & YDMF_PHYS_SURF%GSD_VF%PLSM,YDMF_PHYS_SURF%GSD_VF%PVEG,&
       & YDCPG_MISC%QS)  
    ENDIF
    ...
    CALL APLPARS(YDGEOMETRY,YDRCOEF,YDMODEL%YRML_PHY_MF,KST,KEND,NPROMA,1,NFLEVG,NTSSG,NSTEP,&
     & YLMF_PHYS_STATE%YCPG_DYN%PHI,YLMF_PHYS_STATE%YCPG_PHY%PREHYD,YLMF_PHYS_STATE%YCPG_DYN%PHIF,YLMF_PHYS_STATE%YCPG_PHY%PREHYDF,YLMF_PHYS_STATE%YCPG_PHY%XYB%DELP,YLMF_PHYS_STATE%YCPG_PHY%XYB%RDELP,&
     & YDVARS%U%T9,YDVARS%V%T9,YDVARS%T%T9,YDVARS%Q%T9,YLMF_PHYS_STATE%YCPG_DYN%RCP%CP,ZCVGQ,&
