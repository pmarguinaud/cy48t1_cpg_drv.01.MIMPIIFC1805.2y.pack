...
IF (LNHQE) THEN
  CALL MF_PHYS_NHQE_PART1 (YDGEOMETRY, YDCPG_DIM, YDMF_PHYS, YDVARS, YDMODEL, YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA, PGFL)
ENDIF
...
IF (LCORWAT) THEN
  CALL MF_PHYS_CORWAT (YDCPG_DIM, YDMF_PHYS, YDMF_PHYS_SURF, YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA, YDCPG_DIM%KFLEVG)
ENDIF
...
CALL MF_PHYS_TRANSFER (YDGEOMETRY, YDCPG_DIM, YDVARS, YDMODEL, YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA)
...
IF (LNHQE) THEN
  CALL MF_PHYS_NHQE_PART2 (YDGEOMETRY, YDCPG_DIM, YDMF_PHYS, YDVARS, YDCPG_DIM%KIDIA, YDCPG_DIM%KFDIA)
ENDIF
