...
& ZLH, ZLSCPE, YDMF_PHYS%TMP%APLPAR%FLU%QSAT, ZQW, ZTW, YDMF_PHYS%TMP%APLPAR%FLU%CD, YDMF_PHYS%TMP%APLPAR%FLU%CDN, YDMF_PHYS%TMP%APLPAR%FLU%CH, YDMF_PHYS%TMP%APLPAR%DSA%C1, YDMF_PHYS%TMP%APLPAR%DSA%C2, YDMF_PHYS%TMP%APLPAR%FLU%EMIS, YDMF_PHYS%TMP%APLPAR%FLU%FEVI, ZFTKE, &
...
IF (LLDIAB.AND.(.NOT.LMPA)) THEN
  ...
  ENDDO
   ...
   & ZQSCONV, YDMF_PHYS%TMP%APLPAR%FLU%QSAT, ZQW, ZTW, YDMF_PHYS%TMP%APLPAR%FLU%CD, YDMF_PHYS%TMP%APLPAR%FLU%CDN, YDMF_PHYS%TMP%APLPAR%FLU%CH, YDMF_PHYS%TMP%APLPAR%DSA%C1, YDMF_PHYS%TMP%APLPAR%DSA%C2, YDMF_PHYS%TMP%APLPAR%FLU%EMIS, YDMF_PHYS%TMP%APLPAR%FLU%FEVI, ZFTKE,     &
...
IF (LLDIAB.AND.(.NOT.LSIMPH).AND.(.NOT.LMPA)) THEN
  ...
  ELSE
    ...
    & ZFTKEI, ZFEFB1, ZFEFB2, ZFEFB3, YDMF_PHYS%TMP%APLPAR%DSA%CPS, ZFHP, ZFP, ZTENDU, ZTENDV, ZTENDH,   &
