...
IF (LLDIAB.AND.(.NOT.LMPA)) THEN
  ...
  ENDDO
    ...
    IF (LTWOTL) THEN
      ...
      ITDIA=1_JPIM
      CALL APLPAR(YDGEOMETRY,YDCPG_MISC,YDMF_PHYS,YDCPG_DYN0,YDMF_PHYS_SURF,YDVARS,YDSURF, YDXFU, YDCFU, YDMODEL, KST    , KEND   , NPROMA ,&
       & ITDIA  , NFLEVG  , KSTGLO,&
       ...
       & ZAC    , ZAC_HC , ZMCOR , ZMMU0  , YDCPG_MISC%DHSF  ,&
       & ZMRAB3C,ZMRAB3N,&
       & ZMRAB4C,ZMRAB4N,&
       & ZMRAB6C,ZMRAB6N,&
       & ZMRAT1C,ZMRAT1N,&
       ...
       & ZFRMQ  ,&
       & ZCPS   , ZLHS   ,&
       & ZRS    , ZLH    , ZLSCPE , YDCPG_MISC%NEB   , YDCPG_MISC%QICE  , YDCPG_MISC%QLI   ,&
       & ZQRCONV, ZQSCONV,&
       & ZQSAT  ,&
       & ZQW    , YDCPG_MISC%RH    , ZTW    , ZCD    , ZCDN   ,&
       & ZCH    ,&
       & ZC1    , ZC2    , ZEMIS  , &
       & ZFEVI  , &
       & ZFTKE  , ZFTKEI,  ZFEFB1 , ZFEFB2 , ZFEFB3  ,&
       & ZNEIJ  , ZVEG   , YDCPG_MISC%QS,&
       & ZQSATS , &
       & YDCPG_MISC%CLCT  , &
       & ICLPH  , &
    ...
    ELSE
      ...
      ITDIA=1_JPIM
      CALL APLPAR(YDGEOMETRY,YDCPG_MISC,YDMF_PHYS,YDCPG_DYN9,YDMF_PHYS_SURF,YDVARS,YDSURF,  YDXFU, YDCFU,YDMODEL,  KST,    KEND   , NPROMA ,&
       & ITDIA  , NFLEVG  , KSTGLO ,&
       & NVCLIS , YSD_VVD%NUMFLDS ,&
       & NSTEP  ,&
       & NTSSG  , YSP_SBD%NLEVS   ,&
...
IF (LMPA) THEN
  ...
  IF(LTWOTL) THEN
    CALL APL_AROME(YDGEOMETRY,YDCPG_MISC,YDMF_PHYS,YDCPG_DYN0,YDMF_PHYS_SURF,YDVARS,YDSURF,YDCFU,YDXFU,YDMODEL, KBL, KGPCOMP, KST  , KEND   , NPROMA ,&
     & 1      , NFLEVG , NSTEP  ,&
     ...
     & YLPROCSET,YDDDH )
  ELSE    
    CALL APL_AROME(YDGEOMETRY,YDCPG_MISC,YDMF_PHYS,YDCPG_DYN9,YDMF_PHYS_SURF,YDVARS,YDSURF,YDCFU,YDXFU,YDMODEL, KBL, KGPCOMP, KST  , KEND   , NPROMA ,&
     & 1      , NFLEVG , NSTEP  ,&
     & IMAXDRAFT, NTSSG, YDCFU%NFRRC, PDTPHY, LLXFUMSE,YDCSGEOM%RINDX,YDCSGEOM%RINDY,&
     & YDGSGEOM%GEMU,YDGSGEOM%GELAM,YDOROG%OROG,YDGSGEOM%GM,&
     & ZMU0,ZMU0LU,ZMU0M,ZMU0N,&
