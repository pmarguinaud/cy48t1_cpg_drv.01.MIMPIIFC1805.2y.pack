...
IF (LL_SAVE_PHSURF) THEN
  CALL MF_PHYS_SAVE_PHSURF_PART1 (YDCPG_DIM, YDMF_PHYS, YDMF_PHYS_SURF, YDVARS, YDSURF, YDMODEL)
ENDIF
...
!   if relevant.
IF (LL_SAVE_PHSURF) THEN
  CALL MF_PHYS_SAVE_PHSURF_PART2 (YDCPG_DIM, YDMF_PHYS, YDMF_PHYS_SURF, YDVARS, YDSURF, YDMODEL)
ENDIF
