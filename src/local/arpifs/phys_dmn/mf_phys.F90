SUBROUTINE MF_PHYS (YDGEOMETRY, YDCPG_DIM, YDCPG_MISC, YDCPG_PHY0, YDCPG_PHY9, YDMF_PHYS, YDMF_PHYS_TMP, YDAPLPAR_TMP, YDCPG_DYN0, YDCPG_DYN9, YDMF_PHYS_SURF, YDVARS, YDMODEL, YDFIELDS, LDCONFX, PDTPHY, PGPSDT2D, PGFL, PB2, PGMVT1, PGFLT1, PTRAJ_PHYS, YDDDH, PSLBUF1AU)
...
REAL(KIND=JPRB),  INTENT(INOUT) :: PSLBUF1AU(YDCPG_DIM%KLON,YDMODEL%YRML_DYN%YRPTRSLB1%NFLDSLB1)
...
IF (YDMODEL%YRML_PHY_MF%YRSIMPHL%LSIMPH) THEN
  ...
  & PSLBUF1AU, PB2, PGMVT1, PGFLT1, YDCPG_MISC%GPAR, PTRAJ_PHYS, YDDDH, YDCPG_MISC%FTCNS)
