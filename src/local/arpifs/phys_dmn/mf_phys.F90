SUBROUTINE MF_PHYS (YDGEOMETRY, YDCPG_BNDS, YDCPG_OPTS, YDCPG_MISC, YDCPG_GPAR, YDCPG_PHY0, YDCPG_PHY9,  &
...
CALL MF_PHYS_PREP (YDGEOMETRY, YDCPG_BNDS, YDCPG_OPTS, YDMODEL%YRML_PHY_MF%YRARPHY, YDCPG_DYN0, YDCPG_DYN9, YDCPG_PHY0, YDCPG_PHY9, YDVARS)
...
IF (LNHQE) THEN
  CALL MF_PHYS_NHQE_PART1 (YDGEOMETRY, YDCPG_BNDS, YDCPG_OPTS, ZNHQ_TT0, ZNHQ_TT0L, ZNHQ_TT0M, ZNHQ_TT9, YDVARS, &
  & YDMODEL, PGFL)
ENDIF
!=END SKIP
...
!=SKIP
  CALL APL_AROME(YLMF_PHYS_BASE_STATE, YLMF_PHYS_NEXT_STATE, YDGEOMETRY, YDCPG_BNDS, YDCPG_OPTS, YDCPG_MISC,       &
...
!=SKIP
  ...
  IF (LLNEW) THEN
  CALL APL_ARPEGE (YLMF_PHYS_BASE_STATE, YLMF_PHYS_NEXT_STATE, YDGEOMETRY, YDCPG_BNDS, YDCPG_OPTS, YDCPG_MISC,      &
  ...
  ELSE
  CALL APLPAR (YLMF_PHYS_BASE_STATE, YLMF_PHYS_NEXT_STATE, YDGEOMETRY, YDCPG_BNDS, YDCPG_OPTS, YDCPG_MISC,                    &
...
IF (LNHQE) THEN
  CALL MF_PHYS_NHQE_PART2 (YDGEOMETRY, YDCPG_BNDS, YDCPG_OPTS, ZNHQ_TT0, ZNHQ_TT0L, ZNHQ_TT0M, ZNHQ_TT9, YDVARS)
ENDIF
!=END SKIP
