...
& YDMF_PHYS_TMP, YDAPLPAR_TMP, YDCPG_DYN0, YDCPG_DYN9, YDMF_PHYS_SURF, YDVARS, YDMODEL, YDFIELDS, &
& LDCONFX, PDTPHY, PGPSDT2D, PGFL, PB2, PGMVT1, PGFLT1, PTRAJ_PHYS, YDDDH, PSLBUF1AU)
