...
ELSEIF (YDMODEL%YRML_PHY_MF%YRARPHY%LMPA) THEN
  CALL APL_AROME(YDGEOMETRY, YDCPG_DIM, YDCPG_MISC, YDCPG_GPAR, YDCPG_PHY0, YDCPG_PHY9, YDMF_PHYS,      &
  & YDCPG_DYN0, YDCPG_DYN9, YDMF_PHYS_SURF, YDCPG_SL1, YDVARS, YDFIELDS%YRGMV, YDFIELDS%YRSURF, YDFIELDS%YRCFU,    &
  & YDFIELDS%YRXFU, YDMODEL, LDCONFX, PDTPHY, PGFL, PGPSDT2D, PGMVT1, &
