...
ASSOCIATE(MVTS=>YDPARAR%MVTS, CMF_UPDRAFT=>YDPARAR%CMF_UPDRAFT,&
 ...
 & YEFB3=>YGFL%YEFB3, YEFB2=>YGFL%YEFB2, YEFB1=>YGFL%YEFB1, &
 & YO3=>YGFL%YO3, YNOGW=>YGFL%YNOGW, &
 & LCHEM_ARPCLIM=>YDMODEL%YRML_CHEM%YRCHEM%LCHEM_ARPCLIM,&
 & YCHEM=>YGFL%YCHEM, NGFL_EXT=>YGFL%NGFL_EXT, YTKE=>YGFL%YTKE, &
 & YCOMP=>YGFL%YCOMP, &
 & YLCONV=>YGFL%YLCONV, &
 ...
 & LNEBR=>YDPHY%LNEBR, LNEBN=>YDPHY%LNEBN, &
 & LMPHYS=>YDPHY%LMPHYS, &
