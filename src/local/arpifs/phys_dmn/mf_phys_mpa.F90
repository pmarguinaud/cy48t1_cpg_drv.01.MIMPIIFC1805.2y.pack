...
REAL(KIND=JPRB) :: ZMF_UP(YDCPG_DIM%KLON,0:YDCPG_DIM%KFLEVG,YDMF_PHYS%DIM%IMAXDRAFT)
REAL(KIND=JPRB) :: ZTHETAL_UP(YDCPG_DIM%KLON,0:YDCPG_DIM%KFLEVG,YDMF_PHYS%DIM%IMAXDRAFT)
REAL(KIND=JPRB) :: ZQT_UP(YDCPG_DIM%KLON,0:YDCPG_DIM%KFLEVG,YDMF_PHYS%DIM%IMAXDRAFT)
REAL(KIND=JPRB) :: ZTHTV_UP(YDCPG_DIM%KLON,0:YDCPG_DIM%KFLEVG,YDMF_PHYS%DIM%IMAXDRAFT)
REAL(KIND=JPRB) :: ZQC_UP(YDCPG_DIM%KLON,0:YDCPG_DIM%KFLEVG,YDMF_PHYS%DIM%IMAXDRAFT)
REAL(KIND=JPRB) :: ZQI_UP(YDCPG_DIM%KLON,0:YDCPG_DIM%KFLEVG,YDMF_PHYS%DIM%IMAXDRAFT)
REAL(KIND=JPRB) :: ZU_UP(YDCPG_DIM%KLON,0:YDCPG_DIM%KFLEVG,YDMF_PHYS%DIM%IMAXDRAFT)
REAL(KIND=JPRB) :: ZV_UP(YDCPG_DIM%KLON,0:YDCPG_DIM%KFLEVG,YDMF_PHYS%DIM%IMAXDRAFT)
...
ASSOCIATE(YDDIM=>YDGEOMETRY%YRDIM,YDGEM=>YDGEOMETRY%YRGEM, &
 ...
 & YDPTRSLB1=>YDMODEL%YRML_DYN%YRPTRSLB1, YDMDDH=>YDMODEL%YRML_DIAG%YRMDDH,  &
...
ASSOCIATE(MINPRR=>YDPARAR%MINPRR, MINPRS=>YDPARAR%MINPRS, MVQS=>YDPARAR%MVQS, &
 ...
 & NTSSG=>YDDPHY%NTSSG, &
 & YEZDIAG=>YGFL%YEZDIAG, YEXT=>YGFL%YEXT, YNOGW=>YGFL%YNOGW, YCHEM=>YGFL%YCHEM, &
...
IF (LMFSHAL) THEN
  IF (CMF_UPDRAFT=='DUAL') THEN
    ...
    IF (YDMF_PHYS%DIM%IMAXDRAFT < INDRAFT) THEN
