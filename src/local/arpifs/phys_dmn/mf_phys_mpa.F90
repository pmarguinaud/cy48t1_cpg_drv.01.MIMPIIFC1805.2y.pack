...
REAL(KIND=JPRB) :: ZTENDGFLR(YDCPG_DIM%KLON,YDCPG_DIM%KFLEVG,0:YDMODEL%YRML_GCONF%YGFL%NUMFLDS)
...
ELSE
  ...
  CALL CPUTQY_AROME(YDGEOMETRY%YRDIMV,YDGMV,YGFL,YDPTRSLB1,YDCPG_DIM%KLON,YDCPG_DIM%KIDIA,YDCPG_DIM%KFDIA,YDCPG_DIM%KFLEVG,PDTPHY,IPGFL,IPTR,&
