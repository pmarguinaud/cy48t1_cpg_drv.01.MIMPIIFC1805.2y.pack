...
USE YOMCT0             , ONLY : LSLAG, LTWOTL, LNHDYN, LAROME, LNHQE,LCORWAT
...
& YDERDI=>YDMODEL%YRML_PHY_RAD%YRERDI, YDMCC=>YDMODEL%YRML_AOC%YRMCC,  &
& YDERAD=>YDMODEL%YRML_PHY_RAD%YRERAD,  &
& YDPHY3=>YDMODEL%YRML_PHY_MF%YRPHY3, YDPHY1=>YDMODEL%YRML_PHY_MF%YRPHY1, &
& YDPHY0=>YDMODEL%YRML_PHY_MF%YRPHY0, YDNORGWD=>YDMODEL%YRML_PHY_MF%YRNORGWD, &
...
& RTINER=>YDPHY1%RTINER, EMMGLA=>YDPHY1%EMMGLA, LRAFTKE=>YDPHY2%LRAFTKE, LRAFTUR=>YDPHY2%LRAFTUR,            &
...
& LSURFEX_KFROM=>YDARPHY%LSURFEX_KFROM, YA=>YGFL%YA, NGFL_EZDIAG=>YGFL%NGFL_EZDIAG,   &
& YFQTUR=>YGFL%YFQTUR, YFSTUR=>YGFL%YFSTUR, YIRAD=>YGFL%YIRAD, YLRAD=>YGFL%YLRAD, XZSEPS=>YDMSE%XZSEPS,                           &
& LVDIFSPNL=>YDSIMPHL%LVDIFSPNL, LGWDSPNL=>YDSIMPHL%LGWDSPNL, LRAYSP=>YDSIMPHL%LRAYSP,                 &
...
& LCOEFK_RIS=>YDPHY%LCOEFK_RIS, LAEROLAN=>YDPHY%LAEROLAN, LNEBECT=>YDPHY%LNEBECT,                             &
& LAERODES=>YDPHY%LAERODES, LNEWSTAT=>YDPHY%LNEWSTAT, LTHERMO=>YDPHY%LTHERMO, LO3FL=>YDPHY%LO3FL,           &
& LPHSPSH=>YDPHY%LPHSPSH, LSNV=>YDPHY%LSNV, LECSHAL=>YDPHY%LECSHAL, LECT=>YDPHY%LECT,                     &
& LDIFCONS=>YDPHY%LDIFCONS, LNODIFQC=>YDPHY%LNODIFQC, LAEROVOL=>YDPHY%LAEROVOL, &
& LRSTAER=>YDPHY%LRSTAER, NCALLRAD=>YDPHY%NCALLRAD, LNCVPGY=>YDPHY%LNCVPGY, LRAYLU=>YDPHY%LRAYLU,           &
...
& LMPHYS=>YDPHY%LMPHYS, LZ0HSREL=>YDPHY%LZ0HSREL, LCAMOD=>YDPHY%LCAMOD, &
& LCOMOD=>YDPHY%LCOMOD, LCONDWT=>YDPHY%LCONDWT, LCVCSD=>YDPHY%LCVCSD, LNSDO=>YDPHY%LNSDO, LUDEVOL=>YDPHY%LUDEVOL,                 &
& LRAY=>YDPHY%LRAY, LGWD=>YDPHY%LGWD, LCOEFKTKE=>YDPHY%LCOEFKTKE, LRAYFM=>YDPHY%LRAYFM,                         &
...
& NRAY=>YDPHY%NRAY, LDAYD=>YDPHY%LDAYD, LEDMFI=>YDPHY%LEDMFI, LFPCOR=>YDPHY%LFPCOR, &
...
& LGRAPRO=>YDPHY%LGRAPRO, RDECLI=>YDRIP%RDECLI, MALBSCA=>YDPARAR%MALBSCA, MVQS=>YDPARAR%MVQS,                 &
...
& MSWDIR=>YDPARAR%MSWDIR, LMIXUV=>YDPARAR%LMIXUV, MSWDIF=>YDPARAR%MSWDIF, MSNOW=>YDPARAR%MSNOW, &
& NTRADI=>YDTOPH%NTRADI, NTNEBU=>YDTOPH%NTNEBU, NTDIFU=>YDTOPH%NTDIFU, NTOZON=>YDTOPH%NTOZON,              &
...
& LMCC03=>YDMCC%LMCC03, NSTOP=>YDRIP%NSTOP, RCODEC=>YDRIP%RCODEC, RHGMT=>YDRIP%RHGMT,                     &
& RSIDEC=>YDRIP%RSIDEC, RSOVR=>YDRIP%RSOVR, RSTATI=>YDRIP%RSTATI, TSTEP=>YDRIP%TSTEP,                 &
