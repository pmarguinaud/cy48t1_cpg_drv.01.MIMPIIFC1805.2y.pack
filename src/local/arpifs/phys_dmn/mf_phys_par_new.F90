...
@PROCESS NOCHECK
#endif
SUBROUTINE MF_PHYS_PAR_NEW(YDGEOMETRY, YDCPG_DIM, YDCPG_MISC, YDCPG_PHY0, YDCPG_PHY9, YDMF_PHYS,         &
...
INTEGER(KIND=JPIM) :: IJN, JCHA, JLEV, JLON, JSG, JGFL
...
!     ------------------------------------------------------------------
IF (LHOOK) CALL DR_HOOK('MF_PHYS_PAR_NEW',0,ZHOOK_HANDLE)
...
! -----------------------------------------------------
  ...
  ENDIF
    ...
    & ZQLI_CVPP, ZQC_DET_PCMT, ZTENHA, ZTENQVA, .TRUE., YLMF_PHYS_STATE%YCPG_DYN%PHI, YLMF_PHYS_STATE%YGSP_RR%T,       &
...
END ASSOCIATE
END ASSOCIATE
IF (LHOOK) CALL DR_HOOK('MF_PHYS_PAR_NEW',1,ZHOOK_HANDLE)
END SUBROUTINE MF_PHYS_PAR_NEW
