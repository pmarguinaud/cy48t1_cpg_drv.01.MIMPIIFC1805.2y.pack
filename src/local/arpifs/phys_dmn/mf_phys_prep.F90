SUBROUTINE MF_PHYS_PREP(YDGEOMETRY,YDCPG_BNDS, YDCPG_OPTS,YDARPHY,YDCPG_DYN0,YDCPG_DYN9,YDCPG_PHY0,YDCPG_PHY9,YDVARS)
...
YDCPG_PHY0%W(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDCPG_DYN0%GWFT(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)*ZUSG
...
IF (LMPA.AND.(.NOT.LTWOTL)) THEN
  YDCPG_PHY9%W(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDCPG_DYN9%GWFT(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)*ZUSG
  IF (LNHDYN .AND. (NVDVAR==5)) THEN
    ! compute w from W:
    DO JLEV=1,NFLEVG
      DO JROF=YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA
...
IF (LNHDYN) THEN
  YDCPG_PHY0%WL(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDCPG_DYN0%GWFL(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)*ZUSG
  YDCPG_PHY0%WM(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDCPG_DYN0%GWFM(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)*ZUSG
...
IF (LMPA) THEN
  IF (LNHDYN.AND.LTWOTL) THEN
    YDCPG_PHY0%PREF(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDCPG_DYN0%NHPREF(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
    YDCPG_PHY0%PRE(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,0:NFLEVG)=YDCPG_DYN0%NHPREH(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,0:NFLEVG)
  ELSEIF (LNHDYN.AND.(.NOT.LTWOTL)) THEN
    YDCPG_PHY9%PREF(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDCPG_DYN9%NHPREF(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
    YDCPG_PHY9%PRE(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,0:NFLEVG)=YDCPG_DYN9%NHPREH(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,0:NFLEVG)
  ELSEIF ((.NOT.LNHDYN).AND.LTWOTL) THEN
    YDCPG_PHY0%PREF(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDCPG_DYN0%PREF(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
    YDCPG_PHY0%PRE(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,0:NFLEVG)=YDCPG_DYN0%PRE(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,0:NFLEVG)
  ELSEIF ((.NOT.LNHDYN).AND.(.NOT.LTWOTL)) THEN
    YDCPG_PHY9%PREF(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDCPG_DYN9%PREF(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
    YDCPG_PHY9%PRE(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,0:NFLEVG)=YDCPG_DYN9%PRE(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,0:NFLEVG)
  ENDIF
ENDIF
...
! "t" variables.
YDCPG_PHY0%PREHYDF(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDCPG_DYN0%PREF(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
YDCPG_PHY0%PREHYD(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,0:NFLEVG)=YDCPG_DYN0%PRE(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,0:NFLEVG)
YDCPG_PHY0%XYB%DELP (YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDCPG_DYN0%XYB%DELP (YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
YDCPG_PHY0%XYB%RDELP(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDCPG_DYN0%XYB%RDELP(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
YDCPG_PHY0%XYB%LNPR (YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDCPG_DYN0%XYB%LNPR (YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
YDCPG_PHY0%XYB%ALPH (YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDCPG_DYN0%XYB%ALPH (YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)

! "t-dt" variables.
IF (.NOT.LTWOTL) THEN
  YDCPG_PHY9%PREHYDF(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDCPG_DYN9%PREF(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
  YDCPG_PHY9%PREHYD(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,0:NFLEVG)=YDCPG_DYN9%PRE(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,0:NFLEVG)
  YDCPG_PHY9%XYB%DELP (YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDCPG_DYN9%XYB%DELP (YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
  YDCPG_PHY9%XYB%RDELP(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDCPG_DYN9%XYB%RDELP(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
  YDCPG_PHY9%XYB%LNPR (YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDCPG_DYN9%XYB%LNPR (YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
  YDCPG_PHY9%XYB%ALPH (YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)=YDCPG_DYN9%XYB%ALPH (YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,1:NFLEVG)
ENDIF
