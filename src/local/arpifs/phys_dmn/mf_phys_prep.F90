...
PDELP0_PHY (KST:KEND,1:NFLEVG)=PDELP0 (KST:KEND,1:NFLEVG)
PRDELP0_PHY(KST:KEND,1:NFLEVG)=PRDELP0(KST:KEND,1:NFLEVG)
PLNPR0_PHY (KST:KEND,1:NFLEVG)=PLNPR0 (KST:KEND,1:NFLEVG)
PALPH0_PHY (KST:KEND,1:NFLEVG)=PALPH0 (KST:KEND,1:NFLEVG)

! "t-dt" variables.
IF (.NOT.LTWOTL) THEN
  PREHYD9F_PHY(KST:KEND,1:NFLEVG)=PRE9F(KST:KEND,1:NFLEVG)
  PREHYD9_PHY(KST:KEND,0:NFLEVG)=PRE9(KST:KEND,0:NFLEVG)
  PDELP9_PHY (KST:KEND,1:NFLEVG)=PDELP9 (KST:KEND,1:NFLEVG)
  PRDELP9_PHY(KST:KEND,1:NFLEVG)=PRDELP9(KST:KEND,1:NFLEVG)
  PLNPR9_PHY (KST:KEND,1:NFLEVG)=PLNPR9 (KST:KEND,1:NFLEVG)
  PALPH9_PHY (KST:KEND,1:NFLEVG)=PALPH9 (KST:KEND,1:NFLEVG)
ENDIF
