...
ASSOCIATE(YDDIM=>YDGEOMETRY%YRDIM, YDDIMV=>YDGEOMETRY%YRDIMV, YDGSGEOM=>YDGEOMETRY%YRGSGEOM(YDCPG_DIM%KBL), YDOROG=>YDGEOMETRY%YROROG(YDCPG_DIM%KBL),  &
...
& YDMDDH=>YDMODEL%YRML_DIAG%YRMDDH, YDRCOEF=>YDMODEL%YRML_PHY_RAD% &
...
& LTRAJPS=>YDSIMPHL%LTRAJPS, LRAYSP=>YDSIMPHL%LRAYSP, &
& LEDR=>YDPHY%LEDR, &
& LSDDH=>YDLDDH%LSDDH, HDSF=>YDMDDH%HDSF, LRCOEF  &
& =>YDRCOEF%LRCOEF, LTLADDIA=>YDRCOEF%LTLADDIA, NG3SR=>YDRCOEF%NG3SR)
...
CALL CPUTQYS(YDGEOMETRY%YRDIMV,YDGMV,YGFL,YDPTRSLB1,&
 & YDSTOPH, YDPHY2, &
 & YDCPG_DIM%KLON,YDCPG_DIM%KIDIA,YDCPG_DIM%KFDIA,YDCPG_DIM%KFLEVG,PDTPHY,&
