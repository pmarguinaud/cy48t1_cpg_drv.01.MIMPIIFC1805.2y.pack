SUBROUTINE PROFILECHET(YDGEOMETRY,&
 & YDCPG_MISC,YDMF_PHYS,YDMF_PHYS_TMP,YDAPLPAR_TMP,YDCPG_DYN0,YDMF_PHYS_SURF,YDVARS,&
 & YDSURF,&
...
DO J = 1, GCHET%NPHTEXTH
  ...
  & GCHET%APOINT(J)%ALAT, GCHET%APOINT(J)%ALONG, 0._JPRB, PGELAM, PGEMU, PGM, YDMF_PHYS_TMP%RDG%MU0, POROG, YDCPG_DYN0%OROGL,                   &
  ...
  & YDVARS%VOR%T0, YDVARS%DIV%T0, YDMF_PHYS_TMP%RDG%CVGQ, YDMF_PHYS_TMP%RDG%LCVQ, YDMF_PHYS_SURF%GSP_RR%PT_T9, YDMF_PHYS_SURF%GSP_SB%PT_T9,                      &
  ...
  & YDMF_PHYS%OUT%CLCC, YDAPLPAR_TMP%PFL%FPLCH, YDAPLPAR_TMP%PFL%FPLSH, YDMF_PHYS_SURF%GSD_VH%PTCCH, YDMF_PHYS_SURF%GSD_VH%PSCCH, YDMF_PHYS_SURF%GSD_VH%PBCCH, &
