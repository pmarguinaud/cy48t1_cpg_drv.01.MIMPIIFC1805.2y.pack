...
& PGEMU,PGM,YDMF_PHYS%TMP%RDG%MU0,&
...
& YDVARS%DIV%T0,YDMF_PHYS%TMP%APLPAR%MSC%CVGQ,YDMF_PHYS%TMP%APLPAR%MSC%LCVQ,YDMF_PHYS_SURF%GSP_RR%PT_T9,YDMF_PHYS_SURF%GSP_SB%PT_T9,YDMF_PHYS_SURF%GSP_RR%PFC_T9,YDMF_PHYS_SURF%GSP_RR%PW_T9,YDMF_PHYS_SURF%GSP_RR%PIC_T9,YDMF_PHYS_SURF%GSP_SB%PQ_T9,YDMF_PHYS_SURF%GSP_SB%PTL_T9,YDMF_PHYS_SURF%GSP_SG%PF_T9,YDMF_PHYS%OUT%DIFCQ,YDMF_PHYS%OUT%DIFCQN,YDMF_PHYS%OUT%DIFCQL,YDMF_PHYS%OUT%DIFCS,YDMF_PHYS%OUT%DIFTQ,YDMF_PHYS%OUT%DIFTQN,YDMF_PHYS%OUT%DIFTQL,YDMF_PHYS%OUT%DIFTS, &
& YDMF_PHYS%OUT%FCCQL,&
...
& YDMF_PHYS_SURF%GSD_VF%PZ0F,YDMF_PHYS_SURF%GSD_VF%PZ0RLF,YDMF_PHYS_SURF%GSD_VF%PVRLAN,YDMF_PHYS_SURF%GSD_VF%PVRLDI,YDMF_PHYS%TMP%RDG%MU0,PGELAM,PGEMU,PGM,POROG,YDMF_PHYS%OUT%DIFCQ,YDMF_PHYS%OUT%DIFCQN,YDMF_PHYS%OUT%DIFCQL,YDMF_PHYS%OUT%DIFCS,YDMF_PHYS%OUT%DIFTQ,YDMF_PHYS%OUT%DIFTQN,YDMF_PHYS%OUT%DIFTQL,YDMF_PHYS%OUT%DIFTS, &
...
& YDMF_PHYS%OUT%STRDV,YDMF_PHYS%OUT%STRTU,YDMF_PHYS%OUT%STRTV,YDMF_PHYS%OUT%STRMU,YDMF_PHYS%OUT%STRMV,YDMF_PHYS%OUT%FRMH,YDMF_PHYS%TMP%APLPAR%MSC%FRMQ,YDMF_PHYS%OUT%FCHOZ,YDMF_PHYS%TMP%APLPAR%DSA%CPS,YDMF_PHYS%TMP%APLPAR%DSA%LHS,YDMF_PHYS%TMP%APLPAR%DSA%RS,YDMF_PHYS%TMP%APLPAR%MSC%LH,YDMF_PHYS%TMP%APLPAR%MSC%LSCPE,YDCPG_MISC%NEB,YDCPG_MISC%QICE,YDCPG_MISC%QLI,YDMF_PHYS%TMP%APLPAR%FLU%QSAT,YDMF_PHYS%TMP%APLPAR%MSC%QW,YDCPG_MISC%RH,YDMF_PHYS%TMP%APLPAR%MSC%TW,YDMF_PHYS%OUT%ALB,YDMF_PHYS%TMP%APLPAR%FLU%CD, &
& YDMF_PHYS%TMP%APLPAR%FLU%CDN,YDMF_PHYS%TMP%APLPAR%FLU%CH,YDMF_PHYS%TMP%APLPAR%DSA%C1,&
& YDMF_PHYS%TMP%APLPAR%DSA%C2,YDMF_PHYS%OUT%CT,YDMF_PHYS%TMP%APLPAR%FLU%EMIS,YDMF_PHYS%OUT%FCHSP,YDMF_PHYS%OUT%FCLL,YDMF_PHYS%OUT%FCLN,YDMF_PHYS%OUT%FCS,YDMF_PHYS%TMP%APLPAR%FLU%FEVI,YDMF_PHYS%OUT%FEVL,YDMF_PHYS%OUT%FEVN,YDMF_PHYS%OUT%FEVV,YDMF_PHYS%OUT%FTR,YDMF_PHYS%OUT%FLWSP,YDMF_PHYS%OUT%FONTE,YDMF_PHYS_SURF%GSP_SG%PT_T1,YDMF_PHYS%OUT%FGEL,YDMF_PHYS%OUT%FGELS,YDMF_PHYS%OUT%FRSODS,YDMF_PHYS%OUT%FRSOPS, &
& YDMF_PHYS%OUT%FRSOPT,YDMF_PHYS%OUT%FRSOLU,&
& YDMF_PHYS%OUT%FRTHDS,YDMF_PHYS%OUT%FPFPSL,YDMF_PHYS%OUT%FPFPSN,YDMF_PHYS%OUT%FPFPCL,YDMF_PHYS%OUT%FPFPCN,YDMF_PHYS%OUT%FPEVPSL,YDMF_PHYS%OUT%FPEVPSN,YDMF_PHYS%OUT%FPEVPCL,YDMF_PHYS%OUT%FPEVPCN,YDMF_PHYS%TMP%APLPAR%PFL%FTKE,YDMF_PHYS%TMP%APLPAR%PFL%FEFB1,YDMF_PHYS%TMP%APLPAR%PFL%FEFB2,YDMF_PHYS%TMP%APLPAR%PFL%FEFB3,YDMF_PHYS%OUT%GZ0,YDMF_PHYS%OUT%GZ0H,YDMF_PHYS%TMP%APLPAR%FLU%NEIJ, &
& YDMF_PHYS%TMP%APLPAR%FLU%VEG,YDCPG_MISC%QS,YDMF_PHYS%TMP%APLPAR%FLU%QSATS,&
& YDMF_PHYS%OUT%RUISL,YDMF_PHYS%OUT%RUISP,YDMF_PHYS%OUT%RUISS,YDMF_PHYS%OUT%UCLS,YDMF_PHYS%OUT%VCLS,YDMF_PHYS%OUT%TCLS,YDMF_PHYS%OUT%QCLS,YDMF_PHYS%OUT%RHCLS,YDCPG_MISC%CLCT,YDMF_PHYS%OUT%CLCH,YDMF_PHYS%OUT%CLCM,YDMF_PHYS%OUT%CLCL,YDMF_PHYS%OUT%CLCC,YDMF_PHYS%OUT%CAPE,YDMF_PHYS%OUT%CTOP,YDMF_PHYS%TMP%APLPAR%MOC%CLPH,YDMF_PHYS%OUT%CLPH,YDMF_PHYS%OUT%UGST,YDMF_PHYS%OUT%VGST,'WRITEMUSC')
