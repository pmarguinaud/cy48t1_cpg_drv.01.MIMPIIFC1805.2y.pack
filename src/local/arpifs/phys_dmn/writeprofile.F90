...
ENDIF
      ...
      ! -------------------------------------------------
      !
CALL ECR2DV(IULLFA,'PCVGQ',YDMF_PHYS_TMP%RDG%CVGQ,KLON,NPROMA,NFLEVG)
CALL ECR2DV(IULLFA,'PCVGQDY',YDMF_PHYS_TMP%RDG%LCVQ,KLON,NPROMA,NFLEVG)
      !
      ! -------------------------------------------------
...
!     Split of old PNEBH      
CALL ECR2DF(IULLFA,'PFPLCH',YDAPLPAR_TMP%PFL%FPLCH,KLON,NPROMA,NFLEVG)
CALL ECR2DF(IULLFA,'PFPLSH',YDAPLPAR_TMP%PFL%FPLSH,KLON,NPROMA,NFLEVG)
...
CALL ECR1D(IULLFA,'PMU0',YDMF_PHYS_TMP%RDG%MU0,KLON,NPROMA)
      !
      ! -------------------------------------------------
      ! Close SCM file.
      ! -------------------------------------------------
