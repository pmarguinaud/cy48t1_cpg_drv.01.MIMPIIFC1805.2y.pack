...
ASSOCIATE(LCOMPO_DCBB=>YDCOMPO%LCOMPO_DCBB,LCOMPO_DCANT=>YDCOMPO%LCOMPO_DCANT, LFIRE=>YDCOMPO%LFIRE,                                 &
& LINJ=>YDCOMPO%LINJ,   NACTAERO=>YGFL%NACTAERO, NDGLG=>YDGEOMETRY%YRDIM%NDGLG,   LAERCLIST=>YDEAERATM%LAERCLIST,                    &
& LAERELVS=>YDEAERATM%LAERELVS,   LAERVOL=>YDEAERATM%LAERVOL,   NDUSRCP=>YDEAERMAP%NDUSRCP, RDDUAER=>YDEAERMAP%RDDUAER,              &
& RDUSRCP=>YDEAERMAP%RDUSRCP,   RRHO_DD=>YDEAERSNK%RRHO_DD,   LOCNDMS=>YDEAERSRC%LOCNDMS, NAERWND=>YDEAERSRC%NAERWND,                &
& LVOLC_ALTI=>YDCOMPO%LVOLC_ALTI,   LAERNITRATE=>YDCOMPO%LAERNITRATE,   LAERSOA=>YDCOMPO%LAERSOA,   NDDUST=>YDEAERSRC%NDDUST,        &
& NDMSO=>YDEAERSRC%NDMSO, NSSALT=>YDEAERSRC%NSSALT,   NTYPAER=>YDEAERATM%NTYPAER, RAERDUB=>YDEAERSRC%RAERDUB,                        &
& RBCPHIL=>YDEAERSRC%RBCPHIL, RBCPHOB=>YDEAERSRC%RBCPHOB,   RCODECA=>YDEAERSRC%RCODECA, RCOVSRA=>YDEAERSRC%RCOVSRA,                  &
& RDDUSRC=>YDEAERSRC%RDDUSRC, RFCTSS=>YDEAERSRC%RFCTSS, ROMPHIL=>YDEAERSRC%ROMPHIL,   ROMPHOB=>YDEAERSRC%ROMPHOB,                    &
& RSIDECA=>YDEAERSRC%RSIDECA,   RSIVSRA=>YDEAERSRC%RSIVSRA,   NAERVOLC=>YDEAERVOL%NAERVOLC, NAERVOLE=>YDEAERVOL%NAERVOLE,            &
& NVOLDATS=>YDEAERVOL%NVOLDATS, NVOLERUP=>YDEAERVOL%NVOLERUP,   NVOLDATE=>YDEAERVOL%NVOLDATE,   RAERVOLC=>YDEAERVOL%RAERVOLC,        &
& RAERVOLE=>YDEAERVOL%RAERVOLE,   NALBEDOSCHEME=>YDEPHY%NALBEDOSCHEME, LVDFTRAC=>YDEPHY%LVDFTRAC, YSURF=>YDEPHY%YSURF,               &
& NLOENG=>YDGEOMETRY%YRGEM%NLOENG,   NGLOBALAT=>YDGEOMETRY%YRMP%NGLOBALAT,   NSTASS=>YDRIP%NSTASS, RSTATI=>YDRIP%RSTATI,             &
& NDRYDEPVEL_DYN=> YDEAERSNK%NDRYDEPVEL_DYN,   LAERSOA_CHEM=>YDEAERATM%LAERSOA_CHEM,   LAERDUST_NEWBIN=>YDEAERATM%LAERDUST_NEWBIN,   &
& LAERSOAEMIS_FLUX=>YDEAERATM%LAERSOAEMIS_FLUX,   LAERDUSTSOURCE=>YDEAERATM%LAERDUSTSOURCE,   LAERCHEM=>YGFL%LAERCHEM                &
& )
