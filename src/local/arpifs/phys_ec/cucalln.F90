...
DO JK=1,KLEV
  DO JL=KIDIA,KFDIA
    ZUP1(JL,JK)=PUM1(JL,JK)+TENDENCY_TMP%U(JL,JK)*PTSPHY
    ZVP1(JL,JK)=PVM1(JL,JK)+TENDENCY_TMP%V(JL,JK)*PTSPHY
    ZTP1(JL,JK)=PTM1(JL,JK)+TENDENCY_TMP%T(JL,JK)*PTSPHY
    ZQP1(JL,JK)=PQM1(JL,JK)+TENDENCY_TMP%Q(JL,JK)*PTSPHY
...
CALL CUMASTRN &
 ...
 & KIDIA,    KFDIA,    KLON,    KLEV, ZDX, LLTDKMF, KSPPN2D, &
 & LDLAND,   PTSPHY,&
