...
ASSOCIATE(YDDIM=>YDGEOMETRY%YRDIM,YDDIMV=>YDGEOMETRY%YRDIMV, YDSTA=>YDGEOMETRY%YRSTA, YDVAB=>YDGEOMETRY%YRVAB, &
& YDPHY=>YDMODEL%YRML_PHY_MF%YRPHY,   YDMCC=>YDMODEL%YRML_AOC%YRMCC,YDDPHY=>YDMODEL%YRML_PHY_G%YRDPHY,         &
& YDERAD=>YDMODEL%YRML_PHY_RAD%YRERAD,   YDEPHY=>YDMODEL%YRML_PHY_EC%YREPHY,   YGFL=>YDMODEL%YRML_GCONF%YGFL   &
& )

ASSOCIATE(NDGLG=>YDDIM%NDGLG, NSMAX=>YDDIM%NSMAX,   NFLEVG=>YDDIMV%NFLEVG,   NCOM=>YDDPHY%NCOM, NCSS=>YDDPHY%NCSS,            &
& NTILES=>YDDPHY%NTILES, NCSNEC=>YDDPHY%NCSNEC,  LEAGS=>YDEPHY%LEAGS, LECTESSEL=>YDEPHY%LECTESSEL, LEFLAKE=>YDEPHY%LEFLAKE,   &
& LELAIV=>YDEPHY%LELAIV, LEOCCO=>YDEPHY%LEOCCO, LEOCLA=>YDEPHY%LEOCLA,   LEOCML=>YDEPHY%LEOCML, LEOCSA=>YDEPHY%LEOCSA,        &
& LEOCWA=>YDEPHY%LEOCWA,   LEPHYS=>YDEPHY%LEPHYS, LESN09=>YDEPHY%LESN09, LESSRO=>YDEPHY%LESSRO, LESNML => YDEPHY%LESNML,      &
& LEVGEN=>YDEPHY%LEVGEN, LOCMLTKE=>YDEPHY%LOCMLTKE, RLAIINT=>YDEPHY%RLAIINT,   RTHRFRTI=>YDEPHY%RTHRFRTI,                     &
& YSURF=>YDEPHY%YSURF,   LCCNL=>YDERAD%LCCNL, LCCNO=>YDERAD%LCCNO, NALBEDOSCHEME=>YDEPHY%NALBEDOSCHEME,                       &
& NEMISSSCHEME=>YDEPHY%NEMISSSCHEME, NLWEMISS=>YDERAD%NLWEMISS,   RALFMINPSN=>YDEPHY%RALFMINPSN,NSW=>YDERAD%NSW,              &
& NTSW=>YDERAD%NTSW, NAERMACC=>YDERAD%NAERMACC, RCCNLND=>YDERAD%RCCNLND,   RCCNSEA=>YDERAD%RCCNSEA,                           &
& RCIMIN=>YDEPHY%RCIMIN,LMCCDYNSEAICE=>YDMCC%LMCCDYNSEAICE,  LNEMO1WAY=>YDMCC%LNEMO1WAY,   LRAY=>YDPHY%LRAY,                  &
& LRAYFM15=>YDPHY%LRAYFM15,   NACTAERO=>YGFL%NACTAERO, NSNMLWS=>YDEPHY%NSNMLWS)
!     ------------------------------------------------------------------
