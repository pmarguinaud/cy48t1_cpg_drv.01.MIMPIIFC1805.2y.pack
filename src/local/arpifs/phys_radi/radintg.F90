...
& YDHSLMER=>YDGEOMETRY%YRHSLMER,  YDLAP=>YDGEOMETRY%YRLAP,    YDCSGLEG=>YDGEOMETRY%YRCSGLEG, YDPHY=>YDMODEL%YRML_PHY_MF%YRPHY,   &
& YDEPHLI=>YDMODEL%YRML_PHY_SLIN%YREPHLI,    YDERDI=>YDMODEL%YRML_PHY_RAD%YRERDI,YDERAD=>YDMODEL%YRML_PHY_RAD%YRERAD,            &
& YDPHY3=>YDMODEL%YRML_PHY_MF%YRPHY3,   YDRIP=>YDMODEL%YRML_GCONF%YRRIP,   YDCOMPO=>YDMODEL%YRML_CHEM%YRCOMPO,                   &
& YGFL=>YDMODEL%YRML_GCONF%YGFL,YDEPHY=>YDMODEL%YRML_PHY_EC%YREPHY,YDEAERATM=>YDMODEL%YRML_PHY_RAD%YREAERATM,                    &
& YDEAERD=>YDMODEL%YRML_PHY_RAD%YREAERD,   RADGRID=>YDMODEL%YRML_PHY_RAD%RADGRID, YDRI=>YDMODEL%YRML_PHY_RAD%YRRI,               &
& YDRO=>YDMODEL%YRML_PHY_RAD%YRRO)

ASSOCIATE(NACTAERO=>YGFL%NACTAERO, NAERO=>YGFL%NAERO, YO3=>YGFL%YO3,   NRESOL=>YDDIM%NRESOL, NSMAX=>YDDIM%NSMAX,               &
& NSPEC2=>YDDIM%NSPEC2, NUMP=>YDDIM%NUMP,   REPSCAER=>YDEAERATM%REPSCAER,   RSS_RH80_MASSFAC=>YDEAERATM%RSS_RH80_MASSFAC,      &
& NTYPAER=>YDEAERATM%NTYPAER,   LAERCHEM=>YGFL%LAERCHEM,   RCAEROS=>YDEAERD%RCAEROS,   LPHYLIN=>YDEPHLI%LPHYLIN,               &
& YSURF=>YDEPHY%YSURF,   LAERNITRATE=>YDCOMPO%LAERNITRATE,   LAERSOA=>YDCOMPO%LAERSOA,   LAERVOL=>YDEAERATM%LAERVOL,           &
& LAPPROXLWUPDATE=>YDERAD%LAPPROXLWUPDATE,   LAPPROXSWUPDATE=>YDERAD%LAPPROXSWUPDATE, LDIAGFORCING=>YDERAD%LDIAGFORCING,       &
& LEPO3RA=>YDERAD%LEPO3RA, LHVOLCA=>YDERAD%LHVOLCA,   LNOTROAER=>YDERAD%LNOTROAER, LSRTM=>YDERAD%LSRTM,                        &
& NAER=>YDERAD%NAER,   NAERMACC=>YDERAD%NAERMACC, NGHGRAD=>YDERAD%NGHGRAD, NOZOCL=>YDERAD%NOZOCL,   NPERTAER=>YDERAD%NPERTAER, &
& NPERTOZ=>YDERAD%NPERTOZ, NRADINT=>YDERAD%NRADINT,   NRADRES=>YDERAD%NRADRES, NRPROMA=>YDERAD%NRPROMA,                        &
& NSW=>YDERAD%NSW,   NLWEMISS=>YDERAD%NLWEMISS, NLWOUT=>YDERAD%NLWOUT,   RCCL4=>YDERDI%RCCL4, RCFC11=>YDERDI%RCFC11,           &
& RCFC12=>YDERDI%RCFC12,   RCFC22=>YDERDI%RCFC22, RCH4=>YDERDI%RCH4, REPCLC=>YDERDI%REPCLC,   REPH2O=>YDERDI%REPH2O,           &
& RN2O=>YDERDI%RN2O, RNO2=>YDERDI%RNO2,   RRAE=>YDERDI%RRAE,   NGPTOT=>YDGEM%NGPTOT, R4JP=>YDGEM%R4JP,                         &
& MYMS=>YDLAP%MYMS, NASM0=>YDLAP%NASM0,   NGLOBALINDEX=>YDMP%NGLOBALINDEX,   LRAYFM=>YDPHY%LRAYFM,                             &
& RII0=>YDPHY3%RII0,   NSTART=>YDRIP%NSTART, NFSD=>YGFL%NFSD)
!     ------------------------------------------------------------------
