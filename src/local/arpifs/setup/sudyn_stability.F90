...
DO IMM = 1,KDIM
  ...
  CALL SITNU(YDCST, YDGEOMETRY,YDDYN,1,1,ZMDIV,ZSPT_SI,ZSPSP_SI,1)
  CALL SIGAM(YDCST, YDGEOMETRY,YDDYN,1,1,ZSPDIV_SI,ZMTL,ZMSPL,1,KFLEV)
...
DO IMM = 1,KDIM
  ...
  CALL SIDD(YDCST, YDGEOMETRY,YDDYN,IPROMA,1,ZSPDIV_SI,ZDUM,ZMSPDL,ZMTL,ZMSPL,IPROFS)
