...
USE YOMCVER      , ONLY : NVFE_TYPE, RVFE_ALPHA, RVFE_BETA, LVERTFE, LVFE_LAPL_BC
...
IF (LNHDYN) THEN
  ...
  CALL SISEVE(LVERTFE, LVFE_LAPL_BC, YRDYNA,YDGEOMETRY,YDDYN,1,NFLEVG,ZID,ZLAPL,NFLEVG,LD_LSTAR=.TRUE.)
...
DO IMM = 1,KDIM
  ...
  CALL SIDD(LVFE_LAPL_BC, LVERTFE, YRDYNA, YDCST, YDGEOMETRY,YDDYN,IPROMA,1,ZSPDIV_SI,ZDUM,ZMSPDL,ZMTL,ZMSPL,IPROFS)

  ! - Computation of SI terms for rescaled "pseudo" vertical divergence eqn.
  CALL SISEVE(LVERTFE, LVFE_LAPL_BC, YRDYNA,YDGEOMETRY,YDDYN,IPROMA,1,ZMSPD,ZSPSVD_SI,IPROFS)
