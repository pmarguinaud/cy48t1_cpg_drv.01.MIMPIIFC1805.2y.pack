SUBROUTINE SUDYN_STABILITY(YDGEOMETRY,YDDYN,KULOUT)
...
USE YOMCVER      , ONLY : NVFE_TYPE, RVFE_ALPHA, RVFE_BETA
USE YOMDYN       , ONLY : TDYN
USE YOMDYNA      , ONLY : LNESC
...
DO IMM = 1,KDIM
  ...
  CALL SITNU(YDGEOMETRY,YDDYN,1,1,ZMDIV,ZSPT_SI,ZSPSP_SI,1)
  CALL SIGAM(YDGEOMETRY,YDDYN,1,1,ZSPDIV_SI,ZMTL,ZMSPL,1,KFLEV)
...
DO IMM = 1,KDIM
  ...
  CALL SIPTP(YDGEOMETRY,YDDYN,IPROMA,1,ZMDIV,ZMSVD,ZSPSPD_SI,ZSPT_SI, &
   & ZSPSP_SI,IPROFS)

  ! - Computation of SI terms for momentum equation.
  CALL SIDD(YDGEOMETRY,YDDYN,IPROMA,1,ZSPDIV_SI,ZDUM,ZMSPDL,ZMTL,ZMSPL,IPROFS)

  ! - Computation of SI terms for rescaled "pseudo" vertical divergence eqn.
  CALL SISEVE(YDGEOMETRY,YDDYN,IPROMA,1,ZMSPD,ZSPSVD_SI,IPROFS)
