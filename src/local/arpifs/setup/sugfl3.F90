...
ASSOCIATE(YDDYN=>YDMODEL%YRML_DYN%YRDYN,YGFL=>YDMODEL%YRML_GCONF%YGFL,YDEPHY=>YDMODEL%YRML_PHY_EC%YREPHY, &
 & YDPHY=>YDMODEL%YRML_PHY_MF%YRPHY,YDSIMPHL=>YDMODEL%YRML_PHY_MF%YRSIMPHL)
ASSOCIATE(LSPLTHOIGFL=>YDDYN%LSPLTHOIGFL, &
 ...
 & LMPHYS=>YDPHY%LMPHYS, LTRCMFP=>YGFL%LTRCMFP, NCRM=>YGFL%NCRM, &
 & NOPTMFPR=>YGFL%NOPTMFPR, NUMFLDS=>YGFL%NUMFLDS, YCRM=>YGFL%YCRM, &
...
IF (YDMODEL%YRML_DYN%YRDYNA%LPC_FULL.AND..NOT.YDMODEL%YRML_DYN%YRDYNA%LPC_CHEAP) THEN
  ! EUL: true; SL3TL: not yet coded; SL2TL: false.
  LLPC0=.NOT.LTWOTL
ELSEIF (YDMODEL%YRML_DYN%YRDYNA%LPC_FULL.AND.YDMODEL%YRML_DYN%YRDYNA%LPC_CHEAP.AND.LTWOTL) THEN
  ! EUL: not coded; SL3TL: not yet coded; SL2TL: true.
  LLPC0=.TRUE.
ELSE
  LLPC0=.FALSE.
ENDIF
LLT9 = (.NOT. LTWOTL) .OR. YDMODEL%YRML_DYN%YRDYNA%LPC_FULL
...
IF(YO3%LACTIVE) THEN
  ...
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. LSLAG .AND. YO3_NL%LPT
  LLPC = LLPC0.AND.YO3_NL%LPC
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YO3,LDADV=YO3_NL%LADV,LDMGRID=YO3_NL%LMGRID,&
   & LDADV5=YO3_NL%LADV5,&
...
IF(YQ%LACTIVE) THEN
  ...
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. LSLAG .AND. YQ_NL%LPT
  LLPC = LLPC0.AND.YQ_NL%LPC 
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YQ,LDADV=YQ_NL%LADV,LDMGRID=YQ_NL%LMGRID,&
   & LDADV5=YQ_NL%LADV5,&
...
IF(YA%LACTIVE) THEN
  ...
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. LSLAG .AND. YA_NL%LPT
  LLPC = LLPC0.AND.YA_NL%LPC
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YA,LDADV=YA_NL%LADV,LDMGRID=YA_NL%LMGRID,&
   & LDADV5=YA_NL%LADV5,&
...
IF(YSRC%LACTIVE) THEN
  ...
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. YSRC_NL%LPT.AND.LSLAG
  LLPC = LLPC0.AND.YSRC_NL%LPC
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YSRC,LDADV=YSRC_NL%LADV,LDMGRID=YSRC_NL%LMGRID,&
...
IF(YL%LACTIVE) THEN
  ...
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. LSLAG .AND. YL_NL%LPT
  LLPC = LLPC0.AND.YL_NL%LPC
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YL,LDADV=YL_NL%LADV,LDMGRID=YL_NL%LMGRID,&
   & LDADV5=YL_NL%LADV5,&
...
IF(YLCONV%LACTIVE) THEN
  ...
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. LSLAG .AND. YLCONV_NL%LPT
  LLPC = LLPC0.AND.YLCONV_NL%LPC
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YLCONV,LDADV=YLCONV_NL%LADV,LDMGRID=YLCONV_NL%LMGRID,&
...
IF(YICONV%LACTIVE) THEN
  ...
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. LSLAG .AND. YICONV_NL%LPT
  LLPC = LLPC0.AND.YICONV_NL%LPC
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YICONV,LDADV=YICONV_NL%LADV,LDMGRID=YICONV_NL%LMGRID,&
...
IF(YRCONV%LACTIVE) THEN
  ...
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. LSLAG .AND. YRCONV_NL%LPT
  LLPC = LLPC0.AND.YRCONV_NL%LPC
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YRCONV,LDADV=YRCONV_NL%LADV,LDMGRID=YRCONV_NL%LMGRID,&
...
IF(YSCONV%LACTIVE) THEN
  ...
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. LSLAG .AND. YSCONV_NL%LPT
  LLPC = LLPC0.AND.YSCONV_NL%LPC
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YSCONV,LDADV=YSCONV_NL%LADV,LDMGRID=YSCONV_NL%LMGRID,&
...
IF(YLRAD%LACTIVE) THEN
  ...
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. LSLAG .AND. YLRAD_NL%LPT
  LLPC = LLPC0.AND.YLRAD_NL%LPC
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YLRAD,LDADV=YLRAD_NL%LADV,LDMGRID=YLRAD_NL%LMGRID,&
...
IF(YI%LACTIVE) THEN
  ...
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. LSLAG .AND. YI_NL%LPT
  LLPC = LLPC0.AND.YI_NL%LPC
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YI,LDADV=YI_NL%LADV,LDMGRID=YI_NL%LMGRID,&
   & LDADV5=YI_NL%LADV5,&
...
IF(YIRAD%LACTIVE) THEN
  ...
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. LSLAG .AND. YIRAD_NL%LPT
  LLPC = LLPC0.AND.YIRAD_NL%LPC
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YIRAD,LDADV=YIRAD_NL%LADV,LDMGRID=YIRAD_NL%LMGRID,&
...
IF(YS%LACTIVE) THEN
  ...
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. YS_NL%LPT.AND.LSLAG
  LLPC = LLPC0.AND.YS_NL%LPC
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YS,LDADV=YS_NL%LADV,LDMGRID=YS_NL%LMGRID,&
   & LDADV5=YS_NL%LADV5,&
...
IF(YR%LACTIVE) THEN
  ...
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. YR_NL%LPT.AND.LSLAG
  LLPC = LLPC0.AND.YR_NL%LPC
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YR,LDADV=YR_NL%LADV,LDMGRID=YR_NL%LMGRID,&
   & LDADV5=YR_NL%LADV5, &
...
IF(YG%LACTIVE) THEN
  ...
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. YG_NL%LPT.AND.LSLAG
  LLPC = LLPC0.AND.YG_NL%LPC
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YG,LDADV=YG_NL%LADV,LDMGRID=YG_NL%LMGRID,&
   & LDADV5=YG_NL%LADV5,&
...
IF(YH%LACTIVE) THEN
  ...
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. YH_NL%LPT.AND.LSLAG
  LLPC = LLPC0.AND.YH_NL%LPC
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YH,LDADV=YH_NL%LADV,LDMGRID=YH_NL%LMGRID,&
   & LDADV5=YH_NL%LADV5,&
...
IF(YCVGQ%LACTIVE) THEN
  ...
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. YCPF_NL%LPT.AND.LSLAG
  LLPC = LLPC0.AND.YCPF_NL%LPC
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YCVGQ,LDADV=LLAD,LDMGRID=YCVGQ_NL%LMGRID,&
...
IF(YTKE%LACTIVE) THEN
  ...
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. YTKE_NL%LPT.AND.LSLAG
  LLPC = LLPC0.AND.YTKE_NL%LPC
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YTKE,LDADV=YTKE_NL%LADV,LDMGRID=YTKE_NL%LMGRID,&
...
IF(YEFB1%LACTIVE) THEN
  ...
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. YEFB1_NL%LPT.AND.LSLAG
  LLPC = LLPC0.AND.YEFB1_NL%LPC
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YEFB1,LDADV=YEFB1_NL%LADV,LDMGRID=YEFB1_NL%LMGRID,&
...
IF(YEFB2%LACTIVE) THEN
  ...
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. YEFB2_NL%LPT.AND.LSLAG
  LLPC = LLPC0.AND.YEFB2_NL%LPC
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YEFB2,LDADV=YEFB2_NL%LADV,LDMGRID=YEFB2_NL%LMGRID,&
...
IF(YEFB3%LACTIVE) THEN
  ...
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. YEFB3_NL%LPT.AND.LSLAG
  LLPC = LLPC0.AND.YEFB3_NL%LPC
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YEFB3,LDADV=YEFB3_NL%LADV,LDMGRID=YEFB3_NL%LMGRID,&
...
IF(YCPF%LACTIVE) THEN
  ...
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. YCPF_NL%LPT.AND.LSLAG
  LLPC = LLPC0.AND.YCPF_NL%LPC
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YCPF,LDADV=.FALSE.,LDMGRID=.FALSE.,&
...
IF(YSPF%LACTIVE) THEN
  ...
  ! Notice : this field is not supposed to be pronostic !
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. YSPF_NL%LPT.AND.LSLAG
  LLPC = LLPC0.AND.YSPF_NL%LPC
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YSPF,LDADV=.FALSE.,LDMGRID=.FALSE.,&
...
IF(YSDSAT%LACTIVE) THEN
  ...
  ! Notice : this field is not supposed to be pronostic !
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. YSDSAT_NL%LPT.AND.LSLAG
  LLPC = LLPC0.AND.YSDSAT_NL%LPC
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YSDSAT,&
...
IF(YCVV%LACTIVE) THEN
  ...
  ! Notice : this field is not supposed to be pronostic !
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. YCVV_NL%LPT.AND.LSLAG
  LLPC = LLPC0.AND.YCVV_NL%LPC
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YCVV,LDADV=YCVV_NL%LADV,&
...
IF(YQVA%LACTIVE) THEN
  ...
  ! Notice : this field is not supposed to be pronostic 
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. YQVA_NL%LPT.AND.LSLAG
  LLPC = LLPC0.AND.YQVA_NL%LPC
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YQVA,LDADV=.FALSE.,LDMGRID=.FALSE.,&
...
IF(YUOM%LACTIVE) THEN
  ...
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. YUOM_NL%LPT.AND.LSLAG
  LLPC = LLPC0.AND.YUOM_NL%LPC 
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YUOM,LDADV=YUOM_NL%LADV,&
...
IF(YUAL%LACTIVE) THEN
  ...
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. YUAL_NL%LPT.AND.LSLAG
  LLPC = LLPC0.AND.YUAL_NL%LPC 
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YUAL,LDADV=YUAL_NL%LADV,&
...
IF(YDOM%LACTIVE) THEN
  ...
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. YDOM_NL%LPT.AND.LSLAG
  LLPC = LLPC0.AND.YDOM_NL%LPC 
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YDOM,LDADV=YDOM_NL%LADV,&
...
IF(YDAL%LACTIVE) THEN
  ...
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. YDAL_NL%LPT.AND.LSLAG
  LLPC = LLPC0.AND.YDAL_NL%LPC 
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YDAL,LDADV=YDAL_NL%LADV,&
...
IF(YUEN%LACTIVE) THEN
  ...
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. YUEN_NL%LPT.AND.LSLAG
  LLPC = LLPC0.AND.YUEN_NL%LPC 
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YUEN,LDADV=YUEN_NL%LADV,&
...
IF(YUNEBH%LACTIVE) THEN
  ...
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. YUNEBH_NL%LPT.AND.LSLAG
  LLPC = LLPC0.AND.YUNEBH_NL%LPC 
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YUNEBH,LDADV=YUNEBH_NL%LADV,&
...
IF(YTTE%LACTIVE) THEN
  ...
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. YTTE_NL%LPT.AND.LSLAG
  LLPC = LLPC0.AND.YTTE_NL%LPC 
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YTTE,LDADV=YTTE_NL%LADV,&
...
IF(YMXL%LACTIVE) THEN
  ...
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. YMXL_NL%LPT.AND.LSLAG
  LLPC = LLPC0.AND.YMXL_NL%LPC 
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YMXL,LDADV=YMXL_NL%LADV,&
...
IF(YSHTUR%LACTIVE) THEN
  ...
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. YSHTUR_NL%LPT.AND.LSLAG
  LLPC = LLPC0.AND.YSHTUR_NL%LPC 
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YSHTUR,LDADV=YSHTUR_NL%LADV,&
...
IF(YFQTUR%LACTIVE) THEN
  ...
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. YFQTUR_NL%LPT.AND.LSLAG
  LLPC = LLPC0.AND.YFQTUR_NL%LPC 
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YFQTUR,LDADV=YFQTUR_NL%LADV,&
...
IF(YFSTUR%LACTIVE) THEN
  ...
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. YFSTUR_NL%LPT.AND.LSLAG
  LLPC = LLPC0.AND.YFSTUR_NL%LPC 
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YFSTUR,LDADV=YFSTUR_NL%LADV,&
...
IF(YRKTH%LACTIVE) THEN
  ...
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. YRKTH_NL%LPT.AND.LSLAG
  LLPC = LLPC0.AND.YRKTH_NL%LPC
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YRKTH,LDADV=YRKTH_NL%LADV,&
...
IF(YRKTQV%LACTIVE) THEN
  ...
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. YRKTQV_NL%LPT.AND.LSLAG
  LLPC = LLPC0.AND.YRKTQV_NL%LPC
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YRKTQV,LDADV=YRKTQV_NL%LADV,&
...
IF(YRKTQC%LACTIVE) THEN
  ...
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. YRKTQC_NL%LPT.AND.LSLAG
  LLPC = LLPC0.AND.YRKTQC_NL%LPC
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YRKTQC,LDADV=YRKTQC_NL%LADV,&
...
IF(YPHYCTY%LACTIVE) THEN
  ...
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. YPHYCTY_NL%LPT.AND.LSLAG
  LLPC = LLPC0.AND.YPHYCTY_NL%LPC
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YPHYCTY,LDADV=YPHYCTY_NL%LADV,&
...
IF(NGHG > 0 .AND. YLRCH4%LACTIVE) THEN
  ...
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL.AND.LLDIAB.AND.LSLAG.AND.YLRCH4_NL%LPT
  LLPC = LLPC0.AND.YLRCH4_NL%LPC
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YLRCH4,LDADV=YLRCH4_NL%LADV,LDMGRID=YLRCH4_NL%LMGRID,&
...
IF(NFSD > 0) THEN
  ...
  LLPC = .FALSE.
  LLT9 = .FALSE.
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YFSD,LDADV=.FALSE.,LDT9=LLT9,&
...
DO JGFL=1,NAERO
  ...
  LLPT = YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. YAERO_NL(JGFL)%LPT .AND. LSLAG
  LLPC = LLPC0.AND.YAERO_NL(JGFL)%LPC
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YAERO(JGFL),LDADV=YAERO_NL(JGFL)%LADV,&
...
DO JGFL=1,NGHG
  ...
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. YGHG_NL(JGFL)%LPT.AND.LSLAG
  LLPC = LLPC0.AND.YGHG_NL(JGFL)%LPC
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YGHG(JGFL),LDADV=YGHG_NL(JGFL)%LADV,&
...
DO JGFL=1,NCHEM
  ...
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. YCHEM_NL(JGFL)%LPT.AND.LSLAG
  LLPC = LLPC0.AND.YCHEM_NL(JGFL)%LPC
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YCHEM(JGFL),LDADV=YCHEM_NL(JGFL)%LADV,&
...
DO JGFL=1,NERA40
  ...
  LLPC = .FALSE. 
  LLT9 = .FALSE.
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YERA40(JGFL),LDADV=.FALSE.,LDMGRID=.FALSE.,&
...
DO JGFL=1,NNOGW
  ...
  LLPC = .FALSE.
  LLT9 = .FALSE.
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YNOGW(JGFL),LDADV=.FALSE.,&
...
DO JGFL=1,NEDRP
  ...
  LLPC = .FALSE.
  LLT9 = .FALSE.
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YEDRP(JGFL),LDADV=.FALSE.,&
   & LDMGRID=.FALSE.,LDT9=LLT9,&
...
DO JGFL=1,NUVP
  ...
  LLPC = .FALSE.
  LLT9 = .FALSE.
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YUVP(JGFL),LDADV=.FALSE.,&
   & LDMGRID=.FALSE.,LDT9=LLT9,&
...
IF (LAERAOT .AND. NAERO > 0) THEN
  ...
  DO JGFL=1,NPAERAOT
    ...
    LLPC = .FALSE.
    LLT9 = .FALSE.
    CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YAERAOT(JGFL),LDADV=.FALSE.,LDT9=LLT9,&
...
IF (LAERLISI) THEN
  ...
  DO JVAR=1,NPAERLISI_VAR
    ...
    LLPC = .FALSE.
    LLT9 = .FALSE.
    CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YAERLISI(JGFL),LDADV=.FALSE.,LDT9=LLT9,&
...
DO JGFL=1,NAEROUT
  ...
  LLPC = .FALSE.
  LLT9 = .FALSE.
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YAEROUT(JGFL),LDADV=.FALSE.,&
   & LDMGRID=.FALSE.,LDT9=LLT9,&
...
DO JGFL=1,NAEROCLIM
  ...
  LLPC = .FALSE.
  LLT9 = .FALSE.
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YAEROCLIM(JGFL),LDADV=.FALSE.,LDT9=LLT9,&
...
DO JGFL=1,NSLDIA
  ...
  LLPC = .FALSE. 
  LLT9 = .FALSE.
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YSLDIA(JGFL),LDADV=.FALSE.,&
   & LDMGRID=.FALSE.,LDT9=LLT9,&
...
DO JGFL=1,NGFL_FORC
  ...
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. LSLAG .AND. YFORC_NL(JGFL)%LPT
  LLPC = LLPC0.AND.YFORC_NL(JGFL)%LPC
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YFORC(JGFL),LDADV=YFORC_NL(JGFL)%LADV,&
...
DO JGFL=1,NGFL_EZDIAG
  ...
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. LSLAG .AND. YEZDIAG_NL(JGFL)%LPT
  LLPC = LLPC0.AND.YEZDIAG_NL(JGFL)%LPC
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YEZDIAG(JGFL),LDADV=YEZDIAG_NL(JGFL)%LADV,&
...
DO JGFL=1,NGFL_EXT
  ...
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. LSLAG .AND. YEXT_NL(JGFL)%LPT
  LLPC = LLPC0.AND.YEXT_NL(JGFL)%LPC
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YEXT(JGFL),LDADV=YEXT_NL(JGFL)%LADV,&
...
! * CRM fields: these variables are currently used for ECMWF applications.
DO JGFL=1,NCRM
  LLPT = .FALSE.
  LLPC = .FALSE.
  LLT9 = .FALSE.
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YCRM(JGFL),LDADV=.FALSE.,&
   & LDMGRID=.FALSE.,LDT9=LLT9,&
   & LDPHY=YCRM_NL(JGFL)%LPHY,LDPT=LLPT, LDPC=LLPC,&
   & KCOUPLING=YCRM_NL(JGFL)%NCOUPLING,&
   & PREFVALC=YCRM_NL(JGFL)%REFVALC)
ENDDO
...
DO JGFL=1,NLIMA
  ...
  LLPT=YDMODEL%YRML_DYN%YRDYNA%LPC_FULL .AND. LLDIAB .AND. LSLAG .AND. YLIMA_NL(JGFL)%LPT
  LLPC = LLPC0.AND.YLIMA_NL(JGFL)%LPC
  CALL SET_GFL_ATTR(YDDIMV,YDMODEL%YRML_PHY_G%YRSLPHY,YGFL,YLIMA(JGFL),LDADV=YLIMA_NL(JGFL)%LADV,LDADV5=YLIMA_NL(JGFL)%LADV5,&
