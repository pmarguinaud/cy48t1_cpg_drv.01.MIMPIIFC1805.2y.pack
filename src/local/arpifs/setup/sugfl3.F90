...
IF (LPC_FULL.AND..NOT.LPC_CHEAP) THEN
  ...
  LLPC0=.NOT.LTWOTL
ELSEIF (LPC_FULL.AND.LPC_CHEAP.AND.LTWOTL) THEN
  ! EUL: not coded; SL3TL: not yet coded; SL2TL: true.
  LLPC0=.TRUE.
ELSE
  LLPC0=.FALSE.
ENDIF
LLT9 = (.NOT. LTWOTL) .OR. LPC_FULL
...
IF(YO3%LACTIVE) THEN
  ...
  LLPT=LPC_FULL .AND. LLDIAB .AND. LSLAG .AND. YO3_NL%LPT
...
IF(YQ%LACTIVE) THEN
  ...
  LLPT=LPC_FULL .AND. LLDIAB .AND. LSLAG .AND. YQ_NL%LPT
...
IF(YA%LACTIVE) THEN
  ...
  LLPT=LPC_FULL .AND. LLDIAB .AND. LSLAG .AND. YA_NL%LPT
...
IF(YSRC%LACTIVE) THEN
  ...
  LLPT=LPC_FULL .AND. LLDIAB .AND. YSRC_NL%LPT.AND.LSLAG
...
IF(YL%LACTIVE) THEN
  ...
  LLPT=LPC_FULL .AND. LLDIAB .AND. LSLAG .AND. YL_NL%LPT
...
IF(YLCONV%LACTIVE) THEN
  ...
  LLPT=LPC_FULL .AND. LLDIAB .AND. LSLAG .AND. YLCONV_NL%LPT
...
IF(YICONV%LACTIVE) THEN
  ...
  LLPT=LPC_FULL .AND. LLDIAB .AND. LSLAG .AND. YICONV_NL%LPT
...
IF(YRCONV%LACTIVE) THEN
  ...
  LLPT=LPC_FULL .AND. LLDIAB .AND. LSLAG .AND. YRCONV_NL%LPT
...
IF(YSCONV%LACTIVE) THEN
  ...
  LLPT=LPC_FULL .AND. LLDIAB .AND. LSLAG .AND. YSCONV_NL%LPT
...
IF(YLRAD%LACTIVE) THEN
  ...
  LLPT=LPC_FULL .AND. LLDIAB .AND. LSLAG .AND. YLRAD_NL%LPT
...
IF(YI%LACTIVE) THEN
  ...
  LLPT=LPC_FULL .AND. LLDIAB .AND. LSLAG .AND. YI_NL%LPT
...
IF(YIRAD%LACTIVE) THEN
  ...
  LLPT=LPC_FULL .AND. LLDIAB .AND. LSLAG .AND. YIRAD_NL%LPT
...
IF(YS%LACTIVE) THEN
  ...
  LLPT=LPC_FULL .AND. LLDIAB .AND. YS_NL%LPT.AND.LSLAG
...
IF(YR%LACTIVE) THEN
  ...
  LLPT=LPC_FULL .AND. LLDIAB .AND. YR_NL%LPT.AND.LSLAG
...
IF(YG%LACTIVE) THEN
  ...
  LLPT=LPC_FULL .AND. LLDIAB .AND. YG_NL%LPT.AND.LSLAG
...
IF(YH%LACTIVE) THEN
  ...
  LLPT=LPC_FULL .AND. LLDIAB .AND. YH_NL%LPT.AND.LSLAG
...
IF(YCVGQ%LACTIVE) THEN
  ...
  LLPT=LPC_FULL .AND. LLDIAB .AND. YCPF_NL%LPT.AND.LSLAG
...
IF(YTKE%LACTIVE) THEN
  ...
  LLPT=LPC_FULL .AND. LLDIAB .AND. YTKE_NL%LPT.AND.LSLAG
...
IF(YEFB1%LACTIVE) THEN
  ...
  LLPT=LPC_FULL .AND. LLDIAB .AND. YEFB1_NL%LPT.AND.LSLAG
...
IF(YEFB2%LACTIVE) THEN
  ...
  LLPT=LPC_FULL .AND. LLDIAB .AND. YEFB2_NL%LPT.AND.LSLAG
...
IF(YEFB3%LACTIVE) THEN
  ...
  LLPT=LPC_FULL .AND. LLDIAB .AND. YEFB3_NL%LPT.AND.LSLAG
...
IF(YSPF%LACTIVE) THEN
  ...
  ! Notice : this field is not supposed to be pronostic !
  LLPT=LPC_FULL .AND. LLDIAB .AND. YSPF_NL%LPT.AND.LSLAG
...
IF(YSDSAT%LACTIVE) THEN
  ...
  ! Notice : this field is not supposed to be pronostic !
  LLPT=LPC_FULL .AND. LLDIAB .AND. YSDSAT_NL%LPT.AND.LSLAG
...
IF(YQVA%LACTIVE) THEN
  ...
  ! Notice : this field is not supposed to be pronostic 
  LLPT=LPC_FULL .AND. LLDIAB .AND. YQVA_NL%LPT.AND.LSLAG
...
IF(YUOM%LACTIVE) THEN
  ...
  LLPT=LPC_FULL .AND. LLDIAB .AND. YUOM_NL%LPT.AND.LSLAG
...
IF(YUAL%LACTIVE) THEN
  ...
  LLPT=LPC_FULL .AND. LLDIAB .AND. YUAL_NL%LPT.AND.LSLAG
...
IF(YDOM%LACTIVE) THEN
  ...
  LLPT=LPC_FULL .AND. LLDIAB .AND. YDOM_NL%LPT.AND.LSLAG
...
IF(YDAL%LACTIVE) THEN
  ...
  LLPT=LPC_FULL .AND. LLDIAB .AND. YDAL_NL%LPT.AND.LSLAG
...
IF(YUEN%LACTIVE) THEN
  ...
  LLPT=LPC_FULL .AND. LLDIAB .AND. YUEN_NL%LPT.AND.LSLAG
...
IF(YUNEBH%LACTIVE) THEN
  ...
  LLPT=LPC_FULL .AND. LLDIAB .AND. YUNEBH_NL%LPT.AND.LSLAG
...
IF(YTTE%LACTIVE) THEN
  ...
  LLPT=LPC_FULL .AND. LLDIAB .AND. YTTE_NL%LPT.AND.LSLAG
...
IF(YMXL%LACTIVE) THEN
  ...
  LLPT=LPC_FULL .AND. LLDIAB .AND. YMXL_NL%LPT.AND.LSLAG
...
IF(YSHTUR%LACTIVE) THEN
  ...
  LLPT=LPC_FULL .AND. LLDIAB .AND. YSHTUR_NL%LPT.AND.LSLAG
...
IF(YFQTUR%LACTIVE) THEN
  ...
  LLPT=LPC_FULL .AND. LLDIAB .AND. YFQTUR_NL%LPT.AND.LSLAG
...
IF(YFSTUR%LACTIVE) THEN
  ...
  LLPT=LPC_FULL .AND. LLDIAB .AND. YFSTUR_NL%LPT.AND.LSLAG
...
IF(YRKTH%LACTIVE) THEN
  ...
  LLPT=LPC_FULL .AND. LLDIAB .AND. YRKTH_NL%LPT.AND.LSLAG
...
IF(YRKTQV%LACTIVE) THEN
  ...
  LLPT=LPC_FULL .AND. LLDIAB .AND. YRKTQV_NL%LPT.AND.LSLAG
...
IF(YRKTQC%LACTIVE) THEN
  ...
  LLPT=LPC_FULL .AND. LLDIAB .AND. YRKTQC_NL%LPT.AND.LSLAG
...
IF(YPHYCTY%LACTIVE) THEN
  ...
  LLPT=LPC_FULL .AND. LLDIAB .AND. YPHYCTY_NL%LPT.AND.LSLAG
...
IF(NGHG > 0 .AND. YLRCH4%LACTIVE) THEN
  ...
  LLPT=LPC_FULL.AND.LLDIAB.AND.LSLAG.AND.YLRCH4_NL%LPT
...
DO JGFL=1,NAERO
  ...
  LLPT = LPC_FULL .AND. LLDIAB .AND. YAERO_NL(JGFL)%LPT .AND. LSLAG
...
DO JGFL=1,NGHG
  ...
  LLPT=LPC_FULL .AND. LLDIAB .AND. YGHG_NL(JGFL)%LPT.AND.LSLAG
...
DO JGFL=1,NCHEM
  ...
  LLPT=LPC_FULL .AND. LLDIAB .AND. YCHEM_NL(JGFL)%LPT.AND.LSLAG
...
DO JGFL=1,NGFL_FORC
  ...
  LLPT=LPC_FULL .AND. LLDIAB .AND. LSLAG .AND. YFORC_NL(JGFL)%LPT
...
DO JGFL=1,NGFL_EZDIAG
  ...
  LLPT=LPC_FULL .AND. LLDIAB .AND. LSLAG .AND. YEZDIAG_NL(JGFL)%LPT
...
DO JGFL=1,NGFL_EXT
  ...
  LLPT=LPC_FULL .AND. LLDIAB .AND. LSLAG .AND. YEXT_NL(JGFL)%LPT
...
DO JGFL=1,NLIMA
  ...
  LLPT=LPC_FULL .AND. LLDIAB .AND. LSLAG .AND. YLIMA_NL(JGFL)%LPT
