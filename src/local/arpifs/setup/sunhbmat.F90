...
CALL SISEVE(YRDYNA,YDGEOMETRY,YDDYN,1,NFLEVG,ZD,SIFAC,NFLEVG)
...
ELSE
  ...
  CALL SISEVE(YRDYNA,YDGEOMETRY,YDDYN,1,NFLEVG,ZSIBIN,ZSIBOUT,NFLEVG)
...
IF (LVERTFE .AND. LOUTPUT .AND. NPRINTLEV>=1) THEN
  ...
  CALL SISEVE(YRDYNA,YDGEOMETRY,YDDYN,1,NFLEVG,ZFUNC,ZVFE,1)
