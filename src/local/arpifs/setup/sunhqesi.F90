...
IF(SITIME /= TDT)THEN
  ...
  IF (NFLEVG <= 15) THEN
    ...
    IF (.NOT.LVERTFE) THEN
      CALL SISKAP(LVERTFE, YDCST, YDGEOMETRY,YDDYN,1,NFLEVG,NFLEVG,ZIDI,ZSKAP)
    ...
    IF (YRDYNA%LNHQE_C2) THEN
      CALL SILKAP(LVERTFE, LVFE_LAPL_BC, YDCST, YDGEOMETRY,YDDYN,.TRUE.,1,NFLEVG,NFLEVG,ZIDI,ZLAPKAP_C2)
      CALL SILKAP(LVERTFE, LVFE_LAPL_BC, YDCST, YDGEOMETRY,YDDYN,.FALSE.,1,NFLEVG,NFLEVG,ZIDI,ZLAPKAP_GE)
      WRITE(KULOUT,*) ''
    ...
    CALL SILKAP(LVERTFE, LVFE_LAPL_BC, YDCST, YDGEOMETRY,YDDYN,YRDYNA%LNHQE_C2,1,NFLEVG,NFLEVG,ZIDI,ZLAPKAP)
