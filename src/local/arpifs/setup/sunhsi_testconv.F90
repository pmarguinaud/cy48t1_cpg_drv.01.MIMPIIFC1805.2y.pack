...
CALL SIGAM(YDCST, YDGEOMETRY,YDDYN,1,NFLEVG,ZGAM,ZID,ZSP,NFLEVG,NFLEVG)
CALL SITNU(YDCST, YDGEOMETRY,YDDYN,1,NFLEVG,ZID,ZTAU,ZNU,NFLEVG)
...
DO JL1=1,NFLEVG
  ...
  ENDDO
ENDDO
CALL SISEVE(YRDYNA,YDGEOMETRY,YDDYN,1,NFLEVG,ZMFG,ZMF,NFLEVG)
