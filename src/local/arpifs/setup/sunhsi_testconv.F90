SUBROUTINE SUNHSI_TESTCONV(YDGEOMETRY,YDRIP,YDDYN)
...
USE YOMCST   , ONLY : RG       ,RD       ,RCPD     ,RCVD
...
CALL SIGAM(YDGEOMETRY,YDDYN,1,NFLEVG,ZGAM,ZID,ZSP,NFLEVG,NFLEVG)
CALL SITNU(YDGEOMETRY,YDDYN,1,NFLEVG,ZID,ZTAU,ZNU,NFLEVG)
...
DO JL1=1,NFLEVG
  DO JL2=1,NFLEVG
    ...
    ZMFG(JL1,JL2) = ZBT2*ZRH2*ZM2*&
     & (ZC2*ZID(JL1,JL2)-RCPD*ZTAU(JL1,JL2))
  ENDDO
ENDDO
CALL SISEVE(YDGEOMETRY,YDDYN,1,NFLEVG,ZMFG,ZMF,NFLEVG)
CALL SI_CCCOR(YDGEOMETRY,YDDYN,1,NFLEVG,NFLEVG,ZID,ZCOR)
