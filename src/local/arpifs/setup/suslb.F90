...
USE YOMDYNA  , ONLY : LSLHD, LRDBBC, NVDVAR, LGWADV, L3DTURB, LCOMAD, LSLINL,&
 &                    LSLINLC2, LSETTLS, LPC_CHEAP
...
LLSLIN_SI= LRSIDDH .OR. LSLINL
LLSETTLS = LSETTLS .AND. LPC_CHEAP
IU = NULOUT
IF (LLP) WRITE (IU,*)
...
IF (LNHDYN.AND.LGWADV.AND.LVERTFE.AND.LVFE_GW) THEN
  MSLB2GWF = IPTX
...
!        2.13 Computation of RPARSL1 for 2D continuity equation terms.
  ...
  ! diagnostic LRDBBC
  IF (LRDBBC) YDMODEL%YRML_DYN%YRPTRSLB1%RPARSL1(MSLB1GWS9)=1.0_JPRB
