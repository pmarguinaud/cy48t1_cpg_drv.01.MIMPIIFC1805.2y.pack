...
ASSOCIATE(NFLEVG=>YDGEOMETRY%YRDIMV%NFLEVG,   STDEN=>YDSTA%STDEN,   STPHI=>YDSTA%STPHI, STPRE=>YDSTA%STPRE, &
& STPREH=>YDSTA%STPREH,   STTEM=>YDSTA%STTEM, STZ=>YDSTA%STZ, SVETAH=>YDSTA%SVETAH, SVETAF=>YDSTA%SVETAF    &
& )
!*       1.    Initialize YRSTA.
!              ------------------
